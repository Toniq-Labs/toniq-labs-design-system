...
export abstract class SignerClient {
    ...
    public connectedUser: {principal: Principal; subAccount?: SubAccount | undefined} | undefined;
    ...
    protected registerDefaultIdleCallback() {
        /**
         * Default behavior is to clear stored identity and reload the page. By either setting the
         * disableDefaultIdleCallback flag or passing in a custom idle callback, we will ignore this
         * config
         */
