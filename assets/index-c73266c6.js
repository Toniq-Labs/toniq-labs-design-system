 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Cl=(e,t,r)=>{const n=new Map;for(let o=t;o<=r;o++)n.set(e[o],o);return n},km=Ct(class extends lt{constructor(e){if(super(e),e.type!==cn.CHILD)throw Error("repeat() can only be used in text expressions")}ct(e,t,r){let n;r===void 0?r=t:t!==void 0&&(n=t);const o=[],i=[];let a=0;for(const s of e)o[a]=n?n(s,a):a,i[a]=r(s,a),a++;return{values:i,keys:o}}render(e,t,r){return this.ct(e,t,r).values}update(e,[t,r,n]){var o;const i=bm(e),{values:a,keys:s}=this.ct(t,r,n);if(!Array.isArray(i))return this.ut=s,a;const l=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],c=[];let u,d,h=0,g=i.length-1,p=0,w=a.length-1;for(;h<=g&&p<=w;)if(i[h]===null)h++;else if(i[g]===null)g--;else if(l[h]===s[p])c[p]=Pt(i[h],a[p]),h++,p++;else if(l[g]===s[w])c[w]=Pt(i[g],a[w]),g--,w--;else if(l[h]===s[w])c[w]=Pt(i[h],a[w]),Er(e,c[w+1],i[h]),h++,w--;else if(l[g]===s[p])c[p]=Pt(i[g],a[p]),Er(e,i[h],i[g]),g--,p++;else if(u===void 0&&(u=Cl(s,p,w),d=Cl(l,h,g)),u.has(l[h]))if(u.has(l[g])){const y=d.get(s[p]),k=y!==void 0?i[y]:null;if(k===null){const S=Er(e,i[h]);Pt(S,a[p]),c[p]=S}else c[p]=Pt(k,a[p]),Er(e,i[h],k),i[y]=null;p++}else gi(i[g]),g--;else gi(i[h]),h++;for(;p<=w;){const y=Er(e,c[w+1]);Pt(y,a[p]),c[p++]=y}for(;h<=g;){const y=i[h++];y!==null&&gi(y)}return this.ut=s,ym(e,c),Me}});/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,r2=b({name:"LoaderAnimated24Icon",svgTemplate:f`
    ...
    `});const{defineElement:Ve,defineElementNoInputs:R3}=bs(),De=Ve()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>v`
        a {
            box-sizing: border-box;
            display: block;
...
`,Hv=b({name:"CryptoIcp16Icon",svgTemplate:f`
    ...
    `}),Vv=b({name:"BrandDistrikt24Icon",svgTemplate:f`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),jv=b({name:"BrandDscvr24Icon",svgTemplate:f`
    ...
    `}),Fv=b({name:"BrandFacebookLogo24Icon",svgTemplate:f`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),Wv=b({name:"BrandIcScan24Icon",svgTemplate:f`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),Gv=b({name:"BrandMedium24Icon",svgTemplate:f`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${W["toniq-icon-fill-color"]("#000")}
    ...
    `}),Yv=b({name:"BrandNftgeek24Icon",svgTemplate:f`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),Qv=b({name:"BrandTiktokFlat24Icon",svgTemplate:f`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${W["toniq-icon-fill-color"]("#000")}
    ...
    `}),pt={"core-16":[I2,P2,cr],"core-24":[L2,B2,Is,D2,O2,Ps,Ef,N2,R2,H2,q2,z2,V2,j2,Mf,If,F2,Z2,Pf,W2,U2,G2,Lf,Bf,Y2,Q2,J2,X2,Df,K2,_2,ev,tv,rv,nv,ov,iv,av,sv,lv,cv,Ls,uv,dv,fv,hv,mv,gv,pv,vv,Of,Nf,wv,yv,bv,kv,Cv,eo,Ev,Mv,Iv,Pv],"core-48":[Lv,qf,Bv],"core-64":[zf,Dv,Ov],cryptocurrencies:[Nv,Rv,Hv,qv],logos:[zv],"third-party-brands":[Ff,Vv,jv,Fv,Zv,Wv,Zf,Uv,Gv,Yv,Wf,Uf,Qv,Gf,Yf]},Jv=fn({Discord:Lt(void 0,""),Instagram:Lt(void 0,""),Telegram:Lt(void 0,""),TikTok:Lt(void 0,""),Twitch:Lt(void 0,""),Twitter:Lt(void 0,""),website:Lt(void 0,"")}),Xv=Jv.defaultValue,Qf={Discord:Ff,Instagram:Zf,Telegram:Wf,TikTok:Uf,Twitch:Gf,Twitter:Yf,website:Lf},jc="toniq-",{defineElement:re,defineElementNoInputs:Kv}=bs({assertInputs:e=>{if(!e.tagName.startsWith(jc))throw new Error(`Tag name should start with '${jc}' but got '${e.tagName}'`)}}),Vt=re()({tagName:"toniq-bold-space",styles:v`
        :host {
            display: inline-block;
            position: relative;
            vertical-align: top;
    ...
    `,renderCallback({inputs:e}){const t=e.icon?f`
        ...
        `}});function _v(e,t,r={behavior:"smooth"}){let n=2;const o=t==="up"||t==="down"?"y":"x",i=t==="right"||t==="down"?"+":"-",a=o==="x"?e.scrollWidth-e.offsetWidth:e.scrollHeight-e.offsetHeight,s=Os(e)[o];i==="-"&&(n*=-1);const l=e[o==="x"?"scrollLeft":"scrollTop"]+n,c=s.filter(d=>i==="+"?d>l:d<l).sort((d,h)=>i==="+"?d-h:h-d);let u;return c.length>0?u=c[0]:i==="+"?u=a:u=0,e.scrollTo({...r,[o==="x"?"left":"top"]:u})}function ew(e){const t=window.getComputedStyle(e),r=e.getBoundingClientRect();let n=t.getPropertyValue("scroll-padding-left").replace("auto","0px"),o=t.getPropertyValue("scroll-padding-top").replace("auto","0px"),i=t.getPropertyValue("scroll-padding-right").replace("auto","0px"),a=t.getPropertyValue("scroll-padding-bottom").replace("auto","0px");function s(h,g){let p=parseFloat(h);return/%/.test(h)&&(p/=100,p*=g),p}let l=s(n,r.width),c=s(o,r.height),u=s(i,r.width),d=s(a,r.height);return{x:{before:l,after:u},y:{before:c,after:d}}}function tw(e,t,r="both"){return r==="x"&&e.right>=t.left&&e.left<=t.right||r==="y"&&e.bottom>=t.top&&e.top<=t.bottom||r==="both"&&e.right>=t.left&&e.left<=t.right&&e.bottom>=t.top&&e.top<=t.bottom}function Jf(e){let t=[];for(const r of e.children)t=t.concat(r,Jf(r));return t}function rw(e,t=!0){const r=e.getBoundingClientRect(),n={x:{start:[],center:[],end:[]},y:{start:[],center:[],end:[]}},o=Jf(e);for(const i of["x","y"]){const a=i==="x"?"y":"x",s=i==="x"?"left":"top",l=i==="x"?"width":"height",c=i==="x"?"scrollLeft":"scrollTop";for(const u of o){const d=u.getBoundingClientRect();if(t&&!tw(r,d,a))continue;const h=window.getComputedStyle(u);let[g,p]=h.getPropertyValue("scroll-snap-align").split(" ");typeof p>"u"&&(p=g);const w=i==="x"?p:g,y=d[s]-r[s]+e[c];switch(w){case"none":break;case"start":n[i].start.push(y);break;case"center":n[i].center.push(y+d[l]/2);break;case"end":n[i].end.push(y+d[l]);break}}}return n}function Os(e){const t=e.getBoundingClientRect(),r=ew(e),n=rw(e),o={x:e.scrollWidth-e.offsetWidth,y:e.scrollHeight-e.offsetHeight},i=(a,s)=>l=>Math.max(a,Math.min(s,l));return{x:Fc([...n.x.start.map(a=>a-r.x.before),...n.x.center.map(a=>a-t.width/2),...n.x.end.map(a=>a-t.width+r.x.after)].map(i(0,o.x))),y:Fc([...n.y.start.map(a=>a-r.y.before),...n.y.center.map(a=>a-t.height/2),...n.y.end.map(a=>a-t.height+r.y.after)].map(i(0,o.y)))}}function Fc(e){return Array.from(new Set(e))}const to="templates-container",nw=4e3;var La=(e=>(e.Default="default",e.BannerStyle="banner-style",e))(La||{});const Ae=re()({tagName:"toniq-carousel",cssVars:{"toniq-carousel-arrow-margin":"40px"},hostClasses:{"toniq-carousel-banner-style":({inputs:e})=>e.style==="banner-style"},stateInitStatic:{currentScrollPosition:{left:0,right:1/0},scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({cssVars:e,hostClasses:t})=>v`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
    ...
    `,events:{footerViewMoreButtonClick:K(),footerFlipCardButtonClick:K()},renderCallback({inputs:e,dispatch:t,events:r}){const n=e.socialUrls,o=n?et(n).map(i=>{const a=n[i];if(!a)return;const s=Qf[i];return f`
        ...
        `}});function Cy(e){return!!e}function _h(e){return e.replace(/\n/g," ").trim().replace(/\s{2,}/g," ")}function Ey({value:e,min:t,max:r}){return Math.max(Math.min(e,r),t)}function e0(e){return e?e instanceof Error?e.message:Oo(e,"message")?String(e.message):String(e):""}function Zi(e){return e instanceof Error?e:new Error(e0(e))}function My(e){return!!e&&typeof e=="object"}const Iy=[(e,t)=>t in e,(e,t)=>t in e.constructor.prototype];function Oo(e,t){return e?Iy.some(r=>{try{return r(e,t)}catch{return!1}}):!1}function an(e){let t;try{t=Reflect.ownKeys(e)}catch{}return t??[...Object.keys(e),...Object.getOwnPropertySymbols(e)]}function t0(e,t,r=!1,n={}){const o=an(e),i=new Set(an(t));if(!r){const a=o.filter(s=>!i.has(s));if(a.length)throw new Error(`Test object has extra keys: ${a.join(", ")}`)}i.forEach(a=>{if(!Oo(e,a))throw new Error(`test object does not have key "${String(a)}" from expected shape.`);function s(u){throw new Error(`test object value at key "${String(a)}" did not match expected shape: ${u}`)}const l=e[a],c=t[a];n[a]||r0(l,c,s,r,n[a]??{})})}function r0(e,t,r,n,o){var s;const i=typeof e,a=typeof t;i!==a&&r(`type "${i}" did not match expected type "${a}"`);try{Oo(t,"constructor")&&(!Oo(e,"constructor")||e.constructor!==t.constructor)&&r(`constructor "${(s=e==null?void 0:e.constructor)==null?void 0:s.name}" did not match expected constructor "${t.constructor}"`)}catch(l){if(l instanceof r)throw l}Array.isArray(t)?(Array.isArray(e)||r("expected an array"),e.forEach((l,c)=>{if(t.map(d=>{try{r0(l,d,r,n,o);return}catch(h){return new Error(`entry at index "${c}" did not match expected shape: ${e0(h)}`)}}).filter(Cy).length===t.length)throw new Error(`entry at index "${c}" did not match any of the possible types from "${t.join(", ")}"`)})):My(t)&&t0(e,t,n,o)}function Zs(e){return Array.isArray(e)?"array":typeof e}function No(e,t){return Zs(e)===t}function Py(e,t,r){if(!No(e,t))throw new TypeError(`'${r}' is of type '${Zs(e)}' but type '${t}' was expected.`)}function Su({jsonString:e,errorHandler:t,shapeMatcher:r}){try{const n=JSON.parse(e);return r!=null&&(No(r,"object")?t0(n,r):Py(n,Zs(r),"parsedJson")),n}catch(n){if(t)return t(n);throw n}}function Ly(e,t){return an(e).filter(n=>{const o=e[n];return t(n,o,e)}).reduce((n,o)=>(n[o]=e[o],n),{})}function By(e,t){return Ly(e,r=>!t.includes(r))}function n0(e,t){let r=!1;const n=an(e).reduce((o,i)=>{const a=t(i,e[i],e);return a instanceof Promise&&(r=!0),{...o,[i]:a}},{});return r?new Promise(async(o,i)=>{try{await Promise.all(an(n).map(async a=>{const s=await n[a];n[a]=s})),o(n)}catch(a){i(a)}}):n}function Dy(e){const t=ni();return e!==1/0&&setTimeout(()=>{t.resolve()},e<=0?0:e),t.promise}class Oy extends Error{constructor(t,r=`Promised timed out after ${t} ms.`){super(r),this.durationMs=t,this.message=r,this.name="PromiseTimeoutError"}}function Ny(e,t){return new Promise(async(r,n)=>{const o=e===1/0?void 0:setTimeout(()=>{n(new Oy(e))},e);try{const i=await t;r(i)}catch(i){n(i)}finally{clearTimeout(o)}})}function ni(){let e,t,r=!1;const n=new Promise((o,i)=>{e=a=>(r=!0,o(a)),t=a=>{r=!0,i(a)}});if(!e||!t)throw new Error(`Reject and resolve callbacks were not set by the promise constructor for ${ni.name}.`);return{promise:n,resolve:e,reject:t,isSettled(){return r}}}const Ry="px";function zn(e){return Hy(e,Ry)}function Hy(e,t){return String(e).endsWith(t)?String(e):`${String(e)}${t}`}function qy(e,t){return e<t}function zy(e,t){return e>t}const $u={width:250,height:250};function Vy({constraint:e,box:t,constraintType:r="max"}){return(r==="max"?zy:qy)(t.width/t.height,e.width/e.height)?"width":"height"}function Wi({box:e,constraint:t,constraintType:r}){const n=Vy({box:e,constraint:t,constraintType:r});return t[n]/e[n]}function o0({box:e,ratio:t}){return n0(e,(r,n)=>n*t)}function Fa({box:e,min:t,max:r}){return n0(e,(n,o)=>Ey({value:o,min:(t==null?void 0:t[n])??0,max:(r==null?void 0:r[n])??1/0}))}function i0({min:e,max:t,box:r}){const n=a0({min:e,max:t,box:r}),o=o0({box:r,ratio:n});return{height:Math.floor(o.height||(e==null?void 0:e.height)||$u.height),width:Math.floor(o.width||(e==null?void 0:e.width)||$u.width)}}function a0({min:e,max:t,box:r}){if(!e&&!t)return 1;const n=e?Wi({box:r,constraint:e,constraintType:"min"}):1,o=t?Wi({box:r,constraint:t,constraintType:"max"}):1,i=n>1?n:o<1?o:1,a=o0({ratio:i,box:r});return(e?Wi({box:a,constraint:e,constraintType:"min"}):1)>1?n:i}function jy(e){const t=Fy(e);return No(t,"object")||No(t,"array")}function Fy(e){const t=Su({jsonString:e,errorHandler:()=>{}});if(t)return t;const r=Zy(e);return Su({jsonString:r,errorHandler:()=>{}})}function Zy(e){return _h(e).replace(/,\s*([}\]])/,"$1")}const Ws="vir-resizable-image";function Wy(){try{if(typeof indexedDB<"u")return indexedDB;if(typeof webkitIndexedDB<"u")return webkitIndexedDB;if(typeof mozIndexedDB<"u")return mozIndexedDB;if(typeof OIndexedDB<"u")return OIndexedDB;if(typeof msIndexedDB<"u")return msIndexedDB}catch{return}}var wr=Wy();function Uy(){try{if(!wr||!wr.open)return!1;var e=typeof openDatabase<"u"&&/(Safari|iPhone|iPad|iPod)/.test(navigator.userAgent)&&!/Chrome/.test(navigator.userAgent)&&!/BlackBerry/.test(navigator.platform),t=typeof fetch=="function"&&fetch.toString().indexOf("[native code")!==-1;return(!e||t)&&typeof indexedDB<"u"&&typeof IDBKeyRange<"u"}catch{return!1}}function Us(e,t){e=e||[],t=t||{};try{return new Blob(e,t)}catch(i){if(i.name!=="TypeError")throw i;for(var r=typeof BlobBuilder<"u"?BlobBuilder:typeof MSBlobBuilder<"u"?MSBlobBuilder:typeof MozBlobBuilder<"u"?MozBlobBuilder:WebKitBlobBuilder,n=new r,o=0;o<e.length;o+=1)n.append(e[o]);return n.getBlob(t.type)}}typeof Promise>"u"&&require("lie/polyfill");const E=Promise;function Y(e,t){t&&e.then(function(r){t(null,r)},function(r){t(r)})}function ir(e,t,r){typeof t=="function"&&e.then(t),typeof r=="function"&&e.catch(r)}function ut(e){return typeof e!="string"&&(console.warn(`${e} used as a key, but it is not a string.`),e=String(e)),e}function Gs(){if(arguments.length&&typeof arguments[arguments.length-1]=="function")return arguments[arguments.length-1]}const Za="local-forage-detect-blob-support";let Vn;const qe={},Gy=Object.prototype.toString,xn="readonly",oi="readwrite";function Yy(e){for(var t=e.length,r=new ArrayBuffer(t),n=new Uint8Array(r),o=0;o<t;o++)n[o]=e.charCodeAt(o);return r}function Qy(e){return new E(function(t){var r=e.transaction(Za,oi),n=Us([""]);r.objectStore(Za).put(n,"key"),r.onabort=function(o){o.preventDefault(),o.stopPropagation(),t(!1)},r.oncomplete=function(){var o=navigator.userAgent.match(/Chrome\/(\d+)/),i=navigator.userAgent.match(/Edge\//);t(i||!o||parseInt(o[1],10)>=43)}}).catch(function(){return!1})}function Jy(e){return typeof Vn=="boolean"?E.resolve(Vn):Qy(e).then(function(t){return Vn=t,Vn})}function Ro(e){var t=qe[e.name],r={};r.promise=new E(function(n,o){r.resolve=n,r.reject=o}),t.deferredOperations.push(r),t.dbReady?t.dbReady=t.dbReady.then(function(){return r.promise}):t.dbReady=r.promise}function Wa(e){var t=qe[e.name],r=t.deferredOperations.pop();if(r)return r.resolve(),r.promise}function Ua(e,t){var r=qe[e.name],n=r.deferredOperations.pop();if(n)return n.reject(t),n.promise}function s0(e,t){return new E(function(r,n){if(qe[e.name]=qe[e.name]||d0(),e.db)if(t)Ro(e),e.db.close();else return r(e.db);var o=[e.name];t&&o.push(e.version);var i=wr.open.apply(wr,o);t&&(i.onupgradeneeded=function(a){var s=i.result;try{s.createObjectStore(e.storeName),a.oldVersion<=1&&s.createObjectStore(Za)}catch(l){if(l.name==="ConstraintError")console.warn('The database "'+e.name+'" has been upgraded from version '+a.oldVersion+" to version "+a.newVersion+', but the storage "'+e.storeName+'" already exists.');else throw l}}),i.onerror=function(a){a.preventDefault(),n(i.error)},i.onsuccess=function(){var a=i.result;a.onversionchange=function(s){s.target.close()},r(a),Wa(e)}})}function Ys(e){return s0(e,!1)}function Qs(e){return s0(e,!0)}function l0(e,t){if(!e.db)return!0;var r=!e.db.objectStoreNames.contains(e.storeName),n=e.version<e.db.version,o=e.version>e.db.version;if(n&&(e.version!==t&&console.warn('The database "'+e.name+`" can't be downgraded from version `+e.db.version+" to version "+e.version+"."),e.version=e.db.version),o||r){if(r){var i=e.db.version+1;i>e.version&&(e.version=i)}return!0}return!1}function Xy(e){return new E(function(t,r){var n=new FileReader;n.onerror=r,n.onloadend=function(o){var i=btoa(o.target.result||"");t({__local_forage_encoded_blob:!0,data:i,type:e.type})},n.readAsBinaryString(e)})}function c0(e){var t=Yy(atob(e.data));return Us([t],{type:e.type})}function u0(e){return e&&e.__local_forage_encoded_blob}function Ky(e){var t=this,r=t._initReady().then(function(){var n=qe[t._dbInfo.name];if(n&&n.dbReady)return n.dbReady});return ir(r,e,e),r}function _y(e){Ro(e);for(var t=qe[e.name],r=t.forages,n=0;n<r.length;n++){const o=r[n];o._dbInfo.db&&(o._dbInfo.db.close(),o._dbInfo.db=null)}return e.db=null,Ys(e).then(o=>(e.db=o,l0(e)?Qs(e):o)).then(o=>{e.db=t.db=o;for(var i=0;i<r.length;i++)r[i]._dbInfo.db=o}).catch(o=>{throw Ua(e,o),o})}function dt(e,t,r,n){n===void 0&&(n=1);try{var o=e.db.transaction(e.storeName,t);r(null,o)}catch(i){if(n>0&&(!e.db||i.name==="InvalidStateError"||i.name==="NotFoundError"))return E.resolve().then(()=>{if(!e.db||i.name==="NotFoundError"&&!e.db.objectStoreNames.contains(e.storeName)&&e.version<=e.db.version)return e.db&&(e.version=e.db.version+1),Qs(e)}).then(()=>_y(e).then(function(){dt(e,t,r,n-1)})).catch(r);r(i)}}function d0(){return{forages:[],db:null,dbReady:null,deferredOperations:[]}}function eb(e){var t=this,r={db:null};if(e)for(var n in e)r[n]=e[n];var o=qe[r.name];o||(o=d0(),qe[r.name]=o),o.forages.push(t),t._initReady||(t._initReady=t.ready,t.ready=Ky);var i=[];function a(){return E.resolve()}for(var s=0;s<o.forages.length;s++){var l=o.forages[s];l!==t&&i.push(l._initReady().catch(a))}var c=o.forages.slice(0);return E.all(i).then(function(){return r.db=o.db,Ys(r)}).then(function(u){return r.db=u,l0(r,t._defaultConfig.version)?Qs(r):u}).then(function(u){r.db=o.db=u,t._dbInfo=r;for(var d=0;d<c.length;d++){var h=c[d];h!==t&&(h._dbInfo.db=r.db,h._dbInfo.version=r.version)}})}function tb(e,t){var r=this;e=ut(e);var n=new E(function(o,i){r.ready().then(function(){dt(r._dbInfo,xn,function(a,s){if(a)return i(a);try{var l=s.objectStore(r._dbInfo.storeName),c=l.get(e);c.onsuccess=function(){var u=c.result;u===void 0&&(u=null),u0(u)&&(u=c0(u)),o(u)},c.onerror=function(){i(c.error)}}catch(u){i(u)}})}).catch(i)});return Y(n,t),n}function rb(e,t){var r=this,n=new E(function(o,i){r.ready().then(function(){dt(r._dbInfo,xn,function(a,s){if(a)return i(a);try{var l=s.objectStore(r._dbInfo.storeName),c=l.openCursor(),u=1;c.onsuccess=function(){var d=c.result;if(d){var h=d.value;u0(h)&&(h=c0(h));var g=e(h,d.key,u++);g!==void 0?o(g):d.continue()}else o()},c.onerror=function(){i(c.error)}}catch(d){i(d)}})}).catch(i)});return Y(n,t),n}function nb(e,t,r){var n=this;e=ut(e);var o=new E(function(i,a){var s;n.ready().then(function(){return s=n._dbInfo,Gy.call(t)==="[object Blob]"?Jy(s.db).then(function(l){return l?t:Xy(t)}):t}).then(function(l){dt(n._dbInfo,oi,function(c,u){if(c)return a(c);try{var d=u.objectStore(n._dbInfo.storeName);l===null&&(l=void 0);var h=d.put(l,e);u.oncomplete=function(){l===void 0&&(l=null),i(l)},u.onabort=u.onerror=function(){var g=h.error?h.error:h.transaction.error;a(g)}}catch(g){a(g)}})}).catch(a)});return Y(o,r),o}function ob(e,t){var r=this;e=ut(e);var n=new E(function(o,i){r.ready().then(function(){dt(r._dbInfo,oi,function(a,s){if(a)return i(a);try{var l=s.objectStore(r._dbInfo.storeName),c=l.delete(e);s.oncomplete=function(){o()},s.onerror=function(){i(c.error)},s.onabort=function(){var u=c.error?c.error:c.transaction.error;i(u)}}catch(u){i(u)}})}).catch(i)});return Y(n,t),n}function ib(e){var t=this,r=new E(function(n,o){t.ready().then(function(){dt(t._dbInfo,oi,function(i,a){if(i)return o(i);try{var s=a.objectStore(t._dbInfo.storeName),l=s.clear();a.oncomplete=function(){n()},a.onabort=a.onerror=function(){var c=l.error?l.error:l.transaction.error;o(c)}}catch(c){o(c)}})}).catch(o)});return Y(r,e),r}function ab(e){var t=this,r=new E(function(n,o){t.ready().then(function(){dt(t._dbInfo,xn,function(i,a){if(i)return o(i);try{var s=a.objectStore(t._dbInfo.storeName),l=s.count();l.onsuccess=function(){n(l.result)},l.onerror=function(){o(l.error)}}catch(c){o(c)}})}).catch(o)});return Y(r,e),r}function sb(e,t){var r=this,n=new E(function(o,i){if(e<0){o(null);return}r.ready().then(function(){dt(r._dbInfo,xn,function(a,s){if(a)return i(a);try{var l=s.objectStore(r._dbInfo.storeName),c=!1,u=l.openKeyCursor();u.onsuccess=function(){var d=u.result;if(!d){o(null);return}e===0||c?o(d.key):(c=!0,d.advance(e))},u.onerror=function(){i(u.error)}}catch(d){i(d)}})}).catch(i)});return Y(n,t),n}function lb(e){var t=this,r=new E(function(n,o){t.ready().then(function(){dt(t._dbInfo,xn,function(i,a){if(i)return o(i);try{var s=a.objectStore(t._dbInfo.storeName),l=s.openKeyCursor(),c=[];l.onsuccess=function(){var u=l.result;if(!u){n(c);return}c.push(u.key),u.continue()},l.onerror=function(){o(l.error)}}catch(u){o(u)}})}).catch(o)});return Y(r,e),r}function cb(e,t){t=Gs.apply(this,arguments);var r=this.config();e=typeof e!="function"&&e||{},e.name||(e.name=e.name||r.name,e.storeName=e.storeName||r.storeName);var n=this,o;if(!e.name)o=E.reject("Invalid arguments");else{const a=e.name===r.name&&n._dbInfo.db?E.resolve(n._dbInfo.db):Ys(e).then(s=>{const l=qe[e.name],c=l.forages;l.db=s;for(var u=0;u<c.length;u++)c[u]._dbInfo.db=s;return s});e.storeName?o=a.then(s=>{if(!s.objectStoreNames.contains(e.storeName))return;const l=s.version+1;Ro(e);const c=qe[e.name],u=c.forages;s.close();for(let h=0;h<u.length;h++){const g=u[h];g._dbInfo.db=null,g._dbInfo.version=l}return new E((h,g)=>{const p=wr.open(e.name,l);p.onerror=w=>{p.result.close(),g(w)},p.onupgradeneeded=()=>{var w=p.result;w.deleteObjectStore(e.storeName)},p.onsuccess=()=>{const w=p.result;w.close(),h(w)}}).then(h=>{c.db=h;for(let g=0;g<u.length;g++){const p=u[g];p._dbInfo.db=h,Wa(p._dbInfo)}}).catch(h=>{throw(Ua(e,h)||E.resolve()).catch(()=>{}),h})}):o=a.then(s=>{Ro(e);const l=qe[e.name],c=l.forages;s.close();for(var u=0;u<c.length;u++){const h=c[u];h._dbInfo.db=null}return new E((h,g)=>{var p=wr.deleteDatabase(e.name);p.onerror=()=>{const w=p.result;w&&w.close(),g(p.error)},p.onblocked=()=>{console.warn('dropInstance blocked for database "'+e.name+'" until all open connections are closed')},p.onsuccess=()=>{const w=p.result;w&&w.close(),h(w)}}).then(h=>{l.db=h;for(var g=0;g<c.length;g++){const p=c[g];Wa(p._dbInfo)}}).catch(h=>{throw(Ua(e,h)||E.resolve()).catch(()=>{}),h})})}return Y(o,t),o}var ub={_driver:"asyncStorage",_initStorage:eb,_support:Uy(),iterate:rb,getItem:tb,setItem:nb,removeItem:ob,clear:ib,length:ab,key:sb,keys:lb,dropInstance:cb};function db(){return typeof openDatabase=="function"}var yt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",fb="~~local_forage_type~",Tu=/^~~local_forage_type~([^~]+)~/,Ho="__lfsc__:",Ga=Ho.length,Js="arbf",Ya="blob",f0="si08",h0="ui08",m0="uic8",g0="si16",p0="si32",v0="ur16",w0="ui32",y0="fl32",b0="fl64",Cu=Ga+Js.length,Eu=Object.prototype.toString;function k0(e){var t=e.length*.75,r=e.length,n,o=0,i,a,s,l;e[e.length-1]==="="&&(t--,e[e.length-2]==="="&&t--);var c=new ArrayBuffer(t),u=new Uint8Array(c);for(n=0;n<r;n+=4)i=yt.indexOf(e[n]),a=yt.indexOf(e[n+1]),s=yt.indexOf(e[n+2]),l=yt.indexOf(e[n+3]),u[o++]=i<<2|a>>4,u[o++]=(a&15)<<4|s>>2,u[o++]=(s&3)<<6|l&63;return c}function Qa(e){var t=new Uint8Array(e),r="",n;for(n=0;n<t.length;n+=3)r+=yt[t[n]>>2],r+=yt[(t[n]&3)<<4|t[n+1]>>4],r+=yt[(t[n+1]&15)<<2|t[n+2]>>6],r+=yt[t[n+2]&63];return t.length%3===2?r=r.substring(0,r.length-1)+"=":t.length%3===1&&(r=r.substring(0,r.length-2)+"=="),r}function hb(e,t){var r="";if(e&&(r=Eu.call(e)),e&&(r==="[object ArrayBuffer]"||e.buffer&&Eu.call(e.buffer)==="[object ArrayBuffer]")){var n,o=Ho;e instanceof ArrayBuffer?(n=e,o+=Js):(n=e.buffer,r==="[object Int8Array]"?o+=f0:r==="[object Uint8Array]"?o+=h0:r==="[object Uint8ClampedArray]"?o+=m0:r==="[object Int16Array]"?o+=g0:r==="[object Uint16Array]"?o+=v0:r==="[object Int32Array]"?o+=p0:r==="[object Uint32Array]"?o+=w0:r==="[object Float32Array]"?o+=y0:r==="[object Float64Array]"?o+=b0:t(new Error("Failed to get type for BinaryArray"))),t(o+Qa(n))}else if(r==="[object Blob]"){var i=new FileReader;i.onload=function(){var a=fb+e.type+"~"+Qa(this.result);t(Ho+Ya+a)},i.readAsArrayBuffer(e)}else try{t(JSON.stringify(e))}catch(a){console.error("Couldn't convert value into a JSON string: ",e),t(null,a)}}function mb(e){if(e.substring(0,Ga)!==Ho)return JSON.parse(e);var t=e.substring(Cu),r=e.substring(Ga,Cu),n;if(r===Ya&&Tu.test(t)){var o=t.match(Tu);n=o[1],t=t.substring(o[0].length)}var i=k0(t);switch(r){case Js:return i;case Ya:return Us([i],{type:n});case f0:return new Int8Array(i);case h0:return new Uint8Array(i);case m0:return new Uint8ClampedArray(i);case g0:return new Int16Array(i);case v0:return new Uint16Array(i);case p0:return new Int32Array(i);case w0:return new Uint32Array(i);case y0:return new Float32Array(i);case b0:return new Float64Array(i);default:throw new Error("Unkown type: "+r)}}var Xs={serialize:hb,deserialize:mb,stringToBuffer:k0,bufferToString:Qa};function x0(e,t,r,n){e.executeSql(`CREATE TABLE IF NOT EXISTS ${t.storeName} (id INTEGER PRIMARY KEY, key unique, value)`,[],r,n)}function gb(e){var t=this,r={db:null};if(e)for(var n in e)r[n]=typeof e[n]!="string"?e[n].toString():e[n];var o=new E(function(i,a){try{r.db=openDatabase(r.name,String(r.version),r.description,r.size)}catch(s){return a(s)}r.db.transaction(function(s){x0(s,r,function(){t._dbInfo=r,i()},function(l,c){a(c)})},a)});return r.serializer=Xs,o}function Mt(e,t,r,n,o,i){e.executeSql(r,n,o,function(a,s){s.code===s.SYNTAX_ERR?a.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name = ?",[t.storeName],function(l,c){c.rows.length?i(l,s):x0(l,t,function(){l.executeSql(r,n,o,i)},i)},i):i(a,s)},i)}function pb(e,t){var r=this;e=ut(e);var n=new E(function(o,i){r.ready().then(function(){var a=r._dbInfo;a.db.transaction(function(s){Mt(s,a,`SELECT * FROM ${a.storeName} WHERE key = ? LIMIT 1`,[e],function(l,c){var u=c.rows.length?c.rows.item(0).value:null;u&&(u=a.serializer.deserialize(u)),o(u)},function(l,c){i(c)})})}).catch(i)});return Y(n,t),n}function vb(e,t){var r=this,n=new E(function(o,i){r.ready().then(function(){var a=r._dbInfo;a.db.transaction(function(s){Mt(s,a,`SELECT * FROM ${a.storeName}`,[],function(l,c){for(var u=c.rows,d=u.length,h=0;h<d;h++){var g=u.item(h),p=g.value;if(p&&(p=a.serializer.deserialize(p)),p=e(p,g.key,h+1),p!==void 0){o(p);return}}o()},function(l,c){i(c)})})}).catch(i)});return Y(n,t),n}function A0(e,t,r,n){var o=this;e=ut(e);var i=new E(function(a,s){o.ready().then(function(){t===void 0&&(t=null);var l=t,c=o._dbInfo;c.serializer.serialize(t,function(u,d){d?s(d):c.db.transaction(function(h){Mt(h,c,`INSERT OR REPLACE INTO ${c.storeName} (key, value) VALUES (?, ?)`,[e,u],function(){a(l)},function(g,p){s(p)})},function(h){if(h.code===h.QUOTA_ERR){if(n>0){a(A0.apply(o,[e,l,r,n-1]));return}s(h)}})})}).catch(s)});return Y(i,r),i}function wb(e,t,r){return A0.apply(this,[e,t,r,1])}function yb(e,t){var r=this;e=ut(e);var n=new E(function(o,i){r.ready().then(function(){var a=r._dbInfo;a.db.transaction(function(s){Mt(s,a,`DELETE FROM ${a.storeName} WHERE key = ?`,[e],function(){o()},function(l,c){i(c)})})}).catch(i)});return Y(n,t),n}function bb(e){var t=this,r=new E(function(n,o){t.ready().then(function(){var i=t._dbInfo;i.db.transaction(function(a){Mt(a,i,`DELETE FROM ${i.storeName}`,[],function(){n()},function(s,l){o(l)})})}).catch(o)});return Y(r,e),r}function kb(e){var t=this,r=new E(function(n,o){t.ready().then(function(){var i=t._dbInfo;i.db.transaction(function(a){Mt(a,i,`SELECT COUNT(key) as c FROM ${i.storeName}`,[],function(s,l){var c=l.rows.item(0).c;n(c)},function(s,l){o(l)})})}).catch(o)});return Y(r,e),r}function xb(e,t){var r=this,n=new E(function(o,i){r.ready().then(function(){var a=r._dbInfo;a.db.transaction(function(s){Mt(s,a,`SELECT key FROM ${a.storeName} WHERE id = ? LIMIT 1`,[e+1],function(l,c){var u=c.rows.length?c.rows.item(0).key:null;o(u)},function(l,c){i(c)})})}).catch(i)});return Y(n,t),n}function Ab(e){var t=this,r=new E(function(n,o){t.ready().then(function(){var i=t._dbInfo;i.db.transaction(function(a){Mt(a,i,`SELECT key FROM ${i.storeName}`,[],function(s,l){for(var c=[],u=0;u<l.rows.length;u++)c.push(l.rows.item(u).key);n(c)},function(s,l){o(l)})})}).catch(o)});return Y(r,e),r}function Sb(e){return new E(function(t,r){e.transaction(function(n){n.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name <> '__WebKitDatabaseInfoTable__'",[],function(o,i){for(var a=[],s=0;s<i.rows.length;s++)a.push(i.rows.item(s).name);t({db:e,storeNames:a})},function(o,i){r(i)})},function(n){r(n)})})}function $b(e,t){t=Gs.apply(this,arguments);var r=this.config();e=typeof e!="function"&&e||{},e.name||(e.name=e.name||r.name,e.storeName=e.storeName||r.storeName);var n=this,o;return e.name?o=new E(function(i){var a;e.name===r.name?a=n._dbInfo.db:a=openDatabase(e.name,"","",0),e.storeName?i({db:a,storeNames:[e.storeName]}):i(Sb(a))}).then(function(i){return new E(function(a,s){i.db.transaction(function(l){function c(g){return new E(function(p,w){l.executeSql(`DROP TABLE IF EXISTS ${g}`,[],function(){p()},function(y,k){w(k)})})}for(var u=[],d=0,h=i.storeNames.length;d<h;d++)u.push(c(i.storeNames[d]));E.all(u).then(function(){a()}).catch(function(g){s(g)})},function(l){s(l)})})}):o=E.reject("Invalid arguments"),Y(o,t),o}var Tb={_driver:"webSQLStorage",_initStorage:gb,_support:db(),iterate:vb,getItem:pb,setItem:wb,removeItem:yb,clear:bb,length:kb,key:xb,keys:Ab,dropInstance:$b};function Cb(){try{return typeof localStorage<"u"&&"setItem"in localStorage&&!!localStorage.setItem}catch{return!1}}function S0(e,t){var r=e.name+"/";return e.storeName!==t.storeName&&(r+=e.storeName+"/"),r}function Eb(){var e="_localforage_support_test";try{return localStorage.setItem(e,!0),localStorage.removeItem(e),!1}catch{return!0}}function Mb(){return!Eb()||localStorage.length>0}function Ib(e){var t=this,r={};if(e)for(var n in e)r[n]=e[n];return r.keyPrefix=S0(e,t._defaultConfig),Mb()?(t._dbInfo=r,r.serializer=Xs,E.resolve()):E.reject()}function Pb(e){var t=this,r=t.ready().then(function(){for(var n=t._dbInfo.keyPrefix,o=localStorage.length-1;o>=0;o--){var i=localStorage.key(o);i.indexOf(n)===0&&localStorage.removeItem(i)}});return Y(r,e),r}function Lb(e,t){var r=this;e=ut(e);var n=r.ready().then(function(){var o=r._dbInfo,i=localStorage.getItem(o.keyPrefix+e);return i&&(i=o.serializer.deserialize(i)),i});return Y(n,t),n}function Bb(e,t){var r=this,n=r.ready().then(function(){for(var o=r._dbInfo,i=o.keyPrefix,a=i.length,s=localStorage.length,l=1,c=0;c<s;c++){var u=localStorage.key(c);if(u.indexOf(i)===0){var d=localStorage.getItem(u);if(d&&(d=o.serializer.deserialize(d)),d=e(d,u.substring(a),l++),d!==void 0)return d}}});return Y(n,t),n}function Db(e,t){var r=this,n=r.ready().then(function(){var o=r._dbInfo,i;try{i=localStorage.key(e)}catch{i=null}return i&&(i=i.substring(o.keyPrefix.length)),i});return Y(n,t),n}function Ob(e){var t=this,r=t.ready().then(function(){for(var n=t._dbInfo,o=localStorage.length,i=[],a=0;a<o;a++){var s=localStorage.key(a);s.indexOf(n.keyPrefix)===0&&i.push(s.substring(n.keyPrefix.length))}return i});return Y(r,e),r}function Nb(e){var t=this,r=t.keys().then(function(n){return n.length});return Y(r,e),r}function Rb(e,t){var r=this;e=ut(e);var n=r.ready().then(function(){var o=r._dbInfo;localStorage.removeItem(o.keyPrefix+e)});return Y(n,t),n}function Hb(e,t,r){var n=this;e=ut(e);var o=n.ready().then(function(){t===void 0&&(t=null);var i=t;return new E(function(a,s){var l=n._dbInfo;l.serializer.serialize(t,function(c,u){if(u)s(u);else try{localStorage.setItem(l.keyPrefix+e,c),a(i)}catch(d){(d.name==="QuotaExceededError"||d.name==="NS_ERROR_DOM_QUOTA_REACHED")&&s(d),s(d)}})})});return Y(o,r),o}function qb(e,t){if(t=Gs.apply(this,arguments),e=typeof e!="function"&&e||{},!e.name){var r=this.config();e.name=e.name||r.name,e.storeName=e.storeName||r.storeName}var n=this,o;return e.name?o=new E(function(i){e.storeName?i(S0(e,n._defaultConfig)):i(`${e.name}/`)}).then(function(i){for(var a=localStorage.length-1;a>=0;a--){var s=localStorage.key(a);s.indexOf(i)===0&&localStorage.removeItem(s)}}):o=E.reject("Invalid arguments"),Y(o,t),o}var zb={_driver:"localStorageWrapper",_initStorage:Ib,_support:Cb(),iterate:Bb,getItem:Lb,setItem:Hb,removeItem:Rb,clear:Pb,length:Nb,key:Db,keys:Ob,dropInstance:qb};const Vb=(e,t)=>e===t||typeof e=="number"&&typeof t=="number"&&isNaN(e)&&isNaN(t),jb=(e,t)=>{const r=e.length;let n=0;for(;n<r;){if(Vb(e[n],t))return!0;n++}return!1},$0=Array.isArray||function(e){return Object.prototype.toString.call(e)==="[object Array]"},Pr={},Mu={},dr={INDEXEDDB:ub,WEBSQL:Tb,LOCALSTORAGE:zb},Fb=[dr.INDEXEDDB._driver,dr.WEBSQL._driver,dr.LOCALSTORAGE._driver],oo=["dropInstance"],Ui=["clear","getItem","iterate","key","keys","length","removeItem","setItem"].concat(oo),Zb={description:"",driver:Fb.slice(),name:"localforage",size:4980736,storeName:"keyvaluepairs",version:1};function Wb(e,t){e[t]=function(){const r=arguments;return e.ready().then(function(){return e[t].apply(e,r)})}}function Gi(){for(let e=1;e<arguments.length;e++){const t=arguments[e];if(t)for(let r in t)t.hasOwnProperty(r)&&($0(t[r])?arguments[0][r]=t[r].slice():arguments[0][r]=t[r])}return arguments[0]}class Ks{constructor(t){for(let r in dr)if(dr.hasOwnProperty(r)){const n=dr[r],o=n._driver;this[r]=o,Pr[o]||this.defineDriver(n)}this._defaultConfig=Gi({},Zb),this._config=Gi({},this._defaultConfig,t),this._driverSet=null,this._initDriver=null,this._ready=!1,this._dbInfo=null,this._wrapLibraryMethodsWithReady(),this.setDriver(this._config.driver).catch(()=>{})}config(t){if(typeof t=="object"){if(this._ready)return new Error("Can't call config() after localforage has been used.");for(let r in t){if(r==="storeName"&&(t[r]=t[r].replace(/\W/g,"_")),r==="version"&&typeof t[r]!="number")return new Error("Database version must be a number.");this._config[r]=t[r]}return"driver"in t&&t.driver?this.setDriver(this._config.driver):!0}else return typeof t=="string"?this._config[t]:this._config}defineDriver(t,r,n){const o=new E(function(i,a){try{const s=t._driver,l=new Error("Custom driver not compliant; see https://mozilla.github.io/localForage/#definedriver");if(!t._driver){a(l);return}const c=Ui.concat("_initStorage");for(let h=0,g=c.length;h<g;h++){const p=c[h];if((!jb(oo,p)||t[p])&&typeof t[p]!="function"){a(l);return}}(function(){const h=function(g){return function(){const p=new Error(`Method ${g} is not implemented by the current driver`),w=E.reject(p);return Y(w,arguments[arguments.length-1]),w}};for(let g=0,p=oo.length;g<p;g++){const w=oo[g];t[w]||(t[w]=h(w))}})();const d=function(h){Pr[s]&&console.info(`Redefining LocalForage driver: ${s}`),Pr[s]=t,Mu[s]=h,i()};"_support"in t?t._support&&typeof t._support=="function"?t._support().then(d,a):d(!!t._support):d(!0)}catch(s){a(s)}});return ir(o,r,n),o}driver(){return this._driver||null}getDriver(t,r,n){const o=Pr[t]?E.resolve(Pr[t]):E.reject(new Error("Driver not found."));return ir(o,r,n),o}getSerializer(t){const r=E.resolve(Xs);return ir(r,t),r}ready(t){const r=this,n=r._driverSet.then(()=>(r._ready===null&&(r._ready=r._initDriver()),r._ready));return ir(n,t,t),n}setDriver(t,r,n){const o=this;$0(t)||(t=[t]);const i=this._getSupportedDrivers(t);function a(){o._config.driver=o.driver()}function s(u){return o._extend(u),a(),o._ready=o._initStorage(o._config),o._ready}function l(u){return function(){let d=0;function h(){for(;d<u.length;){let p=u[d];return d++,o._dbInfo=null,o._ready=null,o.getDriver(p).then(s).catch(h)}a();const g=new Error("No available storage method found.");return o._driverSet=E.reject(g),o._driverSet}return h()}}const c=this._driverSet!==null?this._driverSet.catch(()=>E.resolve()):E.resolve();return this._driverSet=c.then(()=>{const u=i[0];return o._dbInfo=null,o._ready=null,o.getDriver(u).then(d=>{o._driver=d._driver,a(),o._wrapLibraryMethodsWithReady(),o._initDriver=l(i)})}).catch(()=>{a();const u=new Error("No available storage method found.");return o._driverSet=E.reject(u),o._driverSet}),ir(this._driverSet,r,n),this._driverSet}supports(t){return!!Mu[t]}_extend(t){Gi(this,t)}_getSupportedDrivers(t){const r=[];for(let n=0,o=t.length;n<o;n++){const i=t[n];this.supports(i)&&r.push(i)}return r}_wrapLibraryMethodsWithReady(){for(let t=0,r=Ui.length;t<r;t++)Wb(this,Ui[t])}createInstance(t){return new Ks(t)}}const Ub=new Ks,Gb=Ub;async function T0(){return await caches.open(Ws)}async function Yb(e){return await(await T0()).match(e)}const Iu=Gb.createInstance({name:Ws});async function Qb(e,t){await(await T0()).put(e,t)}const Yi=new Map;async function Jb(e,t){var n;if(t=t,!Yi.has(e)){const o=ni();Yi.set(e,o.promise);try{const i=new Request(e),a=t?await Yb(i):void 0,s=a??await fetch(i),l=t?await Iu.getItem(e)??void 0:void 0,c=l??{contentType:((n=s.headers.get("Content-Type"))==null?void 0:n.toLowerCase())||"",ok:s.ok,text:await s.clone().text()??""};if(!l&&t)try{Iu.setItem(e,c)}catch{}const u={blobUrl:URL.createObjectURL(await s.clone().blob()),...c};if(!a&&t)try{Qb(i,s)}catch{}o.resolve(u)}catch(i){throw o.reject(i),i}}const r=await Yi.get(e);if(!r)throw new Error("Stored a cached response but couldn't find it afterwards.");return r}var C;(function(e){e.Html="html",e.Text="text",e.Json="json",e.Svg="svg",e.Image="image",e.Video="video",e.Audio="audio",e.Pdf="pdf"})(C||(C={}));const Xb=[C.Text,C.Json],Kb=[C.Audio];function Pu(e){return Xb.includes(e)}function _b(e){return Kb.includes(e)}async function e4(e,t){return e.includes("video")?C.Video:e.includes("svg")||t.includes("<svg")?C.Svg:e.includes("html")||t.includes("<html")?C.Html:jy(t)?C.Json:e.includes("json")||e.includes("yaml")||e.includes("yml")||e.includes("pgp-signature")||e.includes("text")||e.includes("txt")?C.Text:e.includes("audio")?C.Audio:e.includes("pdf")?C.Pdf:C.Image}function t4({imageType:e,imageText:t,imageUrl:r,blockAutoPlay:n}){return e===C.Image?Ht(f`
            <img src=${r} />
        `):e===C.Video?Ht(f`
            <video
                ${n?"":"autoplay"}
        ...
        `):e===C.Text||e===C.Json?Ht(f`
            ...
            `):t}function r4(e,t,r){if(t===C.Json)try{return JSON.stringify(JSON.parse(e),null,4)}catch{}else if(t===C.Html&&r)return e.replaceAll(/console\.\w+/g,"doNothing");return e}async function Lu({imageUrl:e,blockAutoPlay:t,textTransformer:r=i=>i,allowPersistentCache:n,removeConsoleLogs:o}){const i=await Jb(e,n);if(!i.ok)throw new Error(`Failed to load '${e}'`);const a=await e4(i.contentType,i.text),s=r(r4(i.text,a,o));return{templateString:t4({imageText:s,imageType:a,imageUrl:i.blobUrl,blockAutoPlay:t}),imageUrl:i.blobUrl,imageType:a}}class Ja extends Error{constructor(){super("Iframe is no longer attached to the DOM."),this.name="IframeDisconnectedError"}}let n4=!1;function o4(){return n4}function i4(e){return e?e instanceof Error?e.message:c4(e,"message")?String(e.message):String(e):""}function a4(e){return e instanceof Error?e:new Error(i4(e))}function s4(e){try{return e.callback()}catch(t){return e.catchCallback?e.catchCallback(t):e.fallbackValue}}const l4=[(e,t)=>t in e,(e,t)=>t in e.constructor.prototype];function c4(e,t){return e?l4.some(r=>{try{return r(e,t)}catch{return!1}}):!1}function u4(e){const t=C0();return e!==1/0&&setTimeout(()=>{t.resolve()},e<=0?0:e),t.promise}function C0(){let e,t,r=!1;const n=new Promise((o,i)=>{e=a=>(r=!0,o(a)),t=a=>{r=!0,i(a)}});if(!e||!t)throw new Error(`Reject and resolve callbacks were not set by the promise constructor for ${C0.name}.`);return{promise:n,resolve:e,reject:t,isSettled(){return r}}}function E0(e,t,r){return s4({callback(){return d4(e,t,r),!0},fallbackValue:!1})}function d4(e,t,r){if(e==="*")r||console.warn("Security warning: iFrame messenger is allowing messages from any origin with '*'");else if(!e||t.origin!==e)throw new Error(`Received message from invalid origin: ${t.origin}. Expected '${e}'`)}var Gt;(function(e){e.FromParent="from-parent",e.FromChild="from-child"})(Gt||(Gt={}));const f4=globalThis.crypto;function h4(e=16){const t=Math.ceil(e/2),r=new Uint8Array(t);return f4.getRandomValues(r),Array.from(r).map(n=>n.toString(16).padStart(2,"0")).join("").substring(0,e)}function m4(e,t,r){return r.type===e&&r.direction===t}function g4(e){return e<2?10:e<5?100:e<10?1e3:5e3}async function p4({message:e,verifyChildData:t,iframeElement:r},n,o,i,a){if(!r)throw new Error("No iframe element was provided.");let s=0,l=!1,c,u,d,h=!1;const g={...e,direction:Gt.FromParent,messageId:h4(32)},p=e.type;function w(k){try{if(!E0(n,k,!1))return;const S=k.data;if(S.type==="error")throw new Error(`Child threw an error: ${S.data}`);if(o4(),S&&h&&m4(p,Gt.FromChild,S)&&S.messageId===g.messageId){let P=!1;try{P=t?t(S.data):!0}catch{}if(!P)return;l=!0,u=k,c=S}}catch(S){d=a4(S)}}a.addEventListener("message",w);const y=Date.now();for(;!l&&Date.now()-y<o&&!d;){if(!r.isConnected)throw new Ja;const k=r.contentWindow;k&&(h=!0,k.postMessage(g,{targetOrigin:n})),await u4(i||g4(s)),s++}if(a.removeEventListener("message",w),d)throw d;if(!l)throw new Error(`Failed to receive response from the iframe for message '${e.type}' after '${Math.ceil(o/1e3)}' seconds).`);if(!u)throw new Error("Never got message event from child but received a valid response");return{data:c==null?void 0:c.data,event:u}}function v4({timeoutMs:e=1e4}={timeoutMs:1e4}){return{async sendMessageToChild(t){if(t.message.type==="error")throw new Error("Cannot send message to child with type 'error'. 'error' is reserved for internal error messaging.");return await p4(t,t.childOrigin,t.timeoutMs||e,t.intervalMs,t.globalObject??globalThis)},listenForParentMessages(t){const r=t.globalObject??globalThis;async function n(o){var l;if(!E0(t.parentOrigin,o,!!((l=t._options)!=null&&l._DANGER_ignoreAnyOriginWarning)))return;const i=o.data,a=await t.listener({...i,originalEvent:o},()=>{r.removeEventListener("message",n)}),s={type:i.type,direction:Gt.FromChild,data:a,messageId:i.messageId};r.parent.postMessage(s,{targetOrigin:t.parentOrigin})}r.addEventListener("message",n)}}}var $e;(function(e){e.VerticallyCenter="vertically-center",e.HideLoading="hide-loading"})($e||($e={}));var de;(function(e){e.FrameReady="frame-ready",e.SendSize="send-size",e.SendScale="set-scale",e.SendScalingMethod="set-scaling-method",e.ForceSize="force-size",e.SizeDetermined="size-determined",e.ImageElementLoaded="image-element-loaded"})(de||(de={}));const Xe=v4({});async function w4(e,t){const r=ni();e.onload=()=>{r.resolve()};try{await Xe.sendMessageToChild({childOrigin:window.location.origin,message:{type:de.FrameReady},iframeElement:e,timeoutMs:t})}catch{await r.promise,await Xe.sendMessageToChild({childOrigin:window.location.origin,message:{type:de.FrameReady},iframeElement:e,timeoutMs:t})}}async function y4({min:e,max:t,host:r,iframeElement:n,imageData:o,forcedFinalImageSize:i,forcedOriginalImageSize:a,timeoutMs:s}){var c;await w4(n,s),i&&await Xe.sendMessageToChild({childOrigin:window.location.origin,message:{type:de.ForceSize,data:i},iframeElement:n,timeoutMs:s});const l=a??(await Xe.sendMessageToChild({childOrigin:window.location.origin,message:{type:de.SendSize},iframeElement:n,timeoutMs:s,verifyChildData(u){return!!(u&&!isNaN(u.width)&&!isNaN(u.height)&&u.width&&u.height)}})).data;return await M0({min:e,max:t,imageDimensions:l,host:r,iframeElement:n,imageData:o,forcedFinalImageSize:i,sendSizeMessage:!0,timeoutMs:s}),await Xe.sendMessageToChild({childOrigin:window.location.origin,message:{type:de.ImageElementLoaded},iframeElement:n,timeoutMs:s}),((c=n.contentWindow)==null?void 0:c.document.documentElement.outerHTML)??""}async function M0({min:e,max:t,imageDimensions:r,host:n,iframeElement:o,imageData:i,forcedFinalImageSize:a,sendSizeMessage:s,timeoutMs:l}){const c=n.shadowRoot.querySelector(".frame-constraint");if(!(c instanceof HTMLElement))throw new Error("Could not find frame constraint div.");const u={min:e,max:t,box:a??r},d=Pu(i.imageType)||_b(i.imageType)?Fa(u):i0(u);c.style.width=zn(Math.floor(d.width)),c.style.height=zn(Math.floor(d.height));const h=Fa({min:e,max:t,box:d});d.height<h.height?n.classList.add($e.VerticallyCenter):n.classList.remove($e.VerticallyCenter),n.style.width=zn(h.width),n.style.height=zn(h.height);const g=a0({min:e,max:t,box:a??r});if(s){if(g>3?await Xe.sendMessageToChild({childOrigin:window.location.origin,message:{type:de.SendScalingMethod,data:"pixelated"},iframeElement:o,timeoutMs:l}):await Xe.sendMessageToChild({childOrigin:window.location.origin,message:{type:de.SendScalingMethod,data:"default"},iframeElement:o,timeoutMs:l}),await Xe.sendMessageToChild({childOrigin:window.location.origin,message:{type:de.SizeDetermined,data:d},iframeElement:o,timeoutMs:l}),i.imageType===C.Html){const p=a?{width:a.width/r.width,height:a.height/r.height}:{width:1,height:1},w={width:g*p.width,height:g*p.height};await Xe.sendMessageToChild({childOrigin:window.location.origin,message:{type:de.SendScale,data:w},iframeElement:o,timeoutMs:l})}else if(Pu(i.imageType)){const p=a??r;if(p.height<d.height){const w=d.width/p.width,y=d.height/p.height,k=Math.min(w,y);await Xe.sendMessageToChild({childOrigin:window.location.origin,message:{type:de.SendScale,data:{height:k,width:k}},iframeElement:o,timeoutMs:l})}}}}const jn={x:16,y:8};var Zu,Wu;function b4(e,t,r,n){const o=Math.random(),i=f(Zu||(Zu=li([`
        <script>
            const imageType = '`,`';
...
${e.templateString}
`)}const k4=[C.Html,C.Video,C.Audio,C.Pdf],x4=[C.Html,C.Text,C.Json];function Bu({blockInteractionInput:e,imageType:t,allowScrolling:r}){return typeof e=="boolean"?!e:k4.includes(t)?!0:!!(r&&x4.includes(t))}const A4=1e4,S4={imageData:xg({async updateCallback(e,t){if(t.updateTriggered(),!e.imageUrl)return new Promise(()=>{});const r={imageUrl:e.imageUrl,blockAutoPlay:!!e.blockAutoPlay,textTransformer:t.textTransformer,allowPersistentCache:!e.blockPersistentCache,removeConsoleLogs:!e.allowConsoleLogs};let n;try{n=await Ny(e.timeoutMs,Lu(r))}catch{await Dy(1e3);try{n=await Lu(r)}catch(i){throw i}}if(n)return n;throw new Error("no image data result")}}),error:void 0},Fn=ws()({tagName:Ws,stateInitStatic:S4,events:{settled:K(),imageDataCalculated:K(),errored:K()},styles:v`
        :host {
            position: relative;
    ...
    `,cleanupCallback({host:e}){const t=e.shadowRoot.querySelector("iframe"),r=e[Qi];t&&r&&(t.srcdoc=r)},renderCallback({state:e,inputs:t,updateState:r,host:n,dispatch:o,events:i}){const a=t.timeoutMs??A4;e.imageData.updateTrigger(By({...t,timeoutMs:a},["textTransformer"]),{textTransformer:t.textTransformer,updateTriggered(){e.error&&r({error:void 0}),n.classList.remove($e.HideLoading),o(new i.settled(!1)),n.classList.remove($e.VerticallyCenter)}});const s=t.min&&t.max?Fa({box:t.min,max:t.max}):t.min,l=t.max,c=t.forcedOriginalImageSize?i0({min:s,max:l,box:t.forcedOriginalImageSize}):void 0,u=zl(e.imageData,"",y=>{if(o(new i.imageDataCalculated(y)),y.imageType===C.Pdf)return f`
                        <iframe
                            src=${y.imageUrl}
                    ...
                    `;{const k=Bu({allowScrolling:t.allowScrolling,blockInteractionInput:t.blockInteraction,imageType:y.imageType})&&!!t.allowScrolling;return f`
                        <iframe
                            ...
                            srcdoc=${b4(y,t.extraHtml,t.htmlSizeQuerySelector,k)}
                            ${po(async S=>{try{const P=await y4({min:s,max:l,host:n,iframeElement:S,imageData:y,forcedFinalImageSize:t.forcedFinalImageSize,forcedOriginalImageSize:c,timeoutMs:a});n[Qi]=P,o(new i.settled(!0)),n.classList.add($e.HideLoading)}catch(P){const R=Zi(P);if(R instanceof Ja)return;console.error(R),r({error:R}),o(new i.errored(R))}})}
                        ></iframe>
                        <slot name="loaded"></slot>
                    `}},y=>{r({error:y}),o(new i.errored(Zi(y)))}),d=zl(e.imageData,Du,y=>Bu({allowScrolling:t.allowScrolling,blockInteractionInput:t.blockInteraction,imageType:y.imageType})?"":Du,()=>""),h=e.imageData instanceof Error?e.imageData:e.error,g=h?v`
                  max-width: 100%;
                  max-height: 100%;
              `:c?v`
                  width: ${c.width}px;
...
`,Qi="latest-frame-srcdoc",zt=re()({tagName:"toniq-flip-card",events:{flippedChange:K()},styles:v`
    ...
    `,renderCallback:({inputs:e})=>f`
        ...
        `});async function $4(e){return navigator.clipboard.writeText(e)}const T4="…";function C4(e,t){const r=e.slice(0,t).trim(),n=e.slice(-1*t).trim();return`${r}${T4}${n}`}function E4(e){return!(e%1)}function M4(e){return e.letterCount==null?4:E4(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const ve=re()({tagName:"toniq-middle-ellipsis",events:{copied:K()},cssVars:{"toniq-middle-ellipsis-text-color":x.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":x.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":x.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":x.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>v`
        :host {
            /* 5 frames at 60 fps */
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:r,state:n,updateState:o}){if(!e.text)return f``;const i=e.text,a=M4(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,u=c?C4(i,a):i,d=c?i:"",h=s?Df:l?Bf:void 0,g=h?f`
                  <${T.assign({icon:h})}></${T}>
              `:"",p=f`
        ...
        `;return u?s?f`
                ...
                `:l?f`
                    <button
                        ...
                        ${$("click",async()=>{await $4(i),t(new r.copied),n.showCopiedTextTimeoutId!=null&&window.clearTimeout(n.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${p} ${g}
                    </button>
                `:f`
                    ${p}
                `:f``}}),Nu="...";function I4(e,t,r=7,n=5){let o;e=Fr(e,1,t),r=Fr(r,n,t);const i=r-5,a=r-3;t<=r?o=r:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>r?Xi(t-o,t):e>o?Xi(Math.min(s.start,t-o),Math.min(s.end,t)):Xi(1,Math.min(t,o+1));function c(d,h){return l.length+1!==t?h:[d]}const u=l[l.length-1];if(u&&u<t){const d=c(t,[Nu,t]);return[...l,...d]}else return l[0]!==1?c(1,[1,Nu]).concat(l):l}function Xi(e,t){const r=t-e+1;return Array.from({length:r},(n,o)=>e+o)}re()({tagName:"toniq-pagination",styles:v`
        :host {
            display: flex;
        }
    ...
    `,events:{pageChange:K()},renderCallback({inputs:e,events:t,dispatch:r}){return e.pageCount<=1?f``:f`
                ...
                ${I4(e.currentPage,e.pageCount,e.pagesShown).map(n=>typeof n=="string"?f`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:x2()})},renderCallback({inputs:e,dispatch:t,events:r,state:n}){return P4(e.entries).map(i=>L4(e.groupName||n.randomGroupName,e.value,i,()=>{t(new r.valueChange(i.value))}))}});function P4(e){const t=Object.fromEntries(e.map(n=>[n.value,n]));return Object.values(t).length!==e.length&&console.error(`${Q.tagName} was given duplicate entry values.`),Object.values(t)}function L4(e,t,r,n){const o=t===r.value,i=f`
    ...
    `}const O={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},Lr={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"};function B4(e){var n,o;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${O.lowerLabelWrapper} .${O.labelPercentMarginWrapper}`),r=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${O.upperLabelWrapper} .${O.labelPercentMarginWrapper}`);if(r instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),a=r.getBoundingClientRect();return{lower:i,upper:a}}else return}function D4(e,t=8){const r=B4(e);if(!r)return 0;const n=r.lower.right-r.upper.left+t;return Math.max(0,n)}function Ki({value:e,limits:t,flip:r}){const o=(t.max-e)/(t.max-t.min)*100;return-(r?100-o:o)}function sn(e){return p2(e)&&e.min!==void 0&&e.max!==void 0}function _a(e){var r;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${O.range}`);return(t==null?void 0:t.clientWidth)??0}function _i(e,t,r){return`${r?M2(e):e} ${t}`}function O4({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function N4({value:e,double:t,min:r,max:n}){return t?sn(e)?{min:Fr(e.min,r,Math.min(e.max,n)),max:Fr(e.max,Math.max(e.min,r),n)}:{min:r,max:n}:sn(e)?r:Fr(e,r,n)}function R4({actualValue:e,actualLimits:t,logScale:r,logRange:n}){return r?{elementValue:sn(e)?{min:Bi(n,e.min),max:Bi(n,e.max)}:Bi(n,e),elementLimits:{min:0,max:n.length-1}}:{elementValue:e,elementLimits:t}}function ea(e,t,r){return r?t[e]||0:e}function H4(e){return{actualLimits:O4(e),actualValue:N4(e)}}function q4(e,t){var n,o,i;let r=!1;if(sn(e)){const a=(n=t.shadowRoot)==null?void 0:n.querySelector(`.${O.lowerSlider}`),s=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${O.upperSlider}`);a instanceof HTMLInputElement&&s instanceof HTMLInputElement&&(Number(a.value)!==e.min&&(a.value=String(e.min),r=!0),Number(s.value)!==e.max&&(s.value=String(e.max),r=!0))}else{const a=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${O.slider}`);a instanceof HTMLInputElement&&Number(a.value)!==e&&(a.value=String(e),r=!0)}return r}function P0(e,t){const{actualValue:r,actualLimits:n}=H4({...e}),o=Av(n.min,n.max),i=e.logScale??!1,a=e.suffix??"",{elementValue:s,elementLimits:l}=R4({actualValue:r,actualLimits:n,logScale:i,logRange:o}),c=_a(t);return{actualValue:r,elementLimits:l,elementValue:s,isLogScale:i,logRange:o,rangeWidth:c,suffix:a}}const Ot=16,Ru=v`
    ${Ot}px
`,Hu=v`
...
`,qu=v`
    transform: scale(1.2);
`;function qr(e){requestAnimationFrame(()=>{const t=P0(e.instanceInputs,e).elementValue;q4(t,e)&&(e.setAttribute("disabled","true"),qr(e))})}const j=re()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:K()},styles:v`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{qr(e)}),e.addEventListener("keydown",()=>{qr(e)}),e.addEventListener("keyup",()=>{qr(e)})},renderCallback({inputs:e,host:t,events:r,dispatch:n,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:u,elementLimits:d,rangeWidth:h}=P0({...e},t);if(qr(t),sn(u))return g(a,u,d);return w(a,u,d);function g(y,k,S){const P={left:nr((h-Ot)*(k.min-S.min)/(S.max-S.min)+Ot/2),right:nr((h-Ot)*(S.max-k.max)/(S.max-S.min)+Ot/2)},R=_i(y.min,c,l),ae=_i(y.max,c,l);requestAnimationFrame(()=>{const Ie=D4(t);Ie!==o.labelOverlap&&i({labelOverlap:Ie})});const he=(S.max-k.max)/(S.max-S.min)>.5,ne=Ki({value:k.min,limits:{min:S.min,max:k.max},flip:!0}),q=Ki({value:k.max,limits:{min:k.min,max:S.max},flip:!1}),ue=o.labelOverlap&&he?o.labelOverlap:0,Sr=o.labelOverlap&&!he?o.labelOverlap:0;return f`
                <div
                    class="range"
            ...
            `}function p(y){i({internalValue:y}),e.disabled||n(new r.valueChange(y))}function w(y,k,S){const P=nr((h-Ot)*(S.max-k)/(S.max-S.min)+Ot/2),R=_i(y,c,l),ae=Ki({value:k,limits:S,flip:!1});return f`
                <div
                    class="range"
                    ${Xr(()=>{i({rangeWidth:_a(t)})})}
                >
    ...
    `,renderCallback({inputs:e}){const t=e.icon?f`
        ...
        `}}),Ur=Kv({tagName:"toniq-tooltip",styles:v`
        :host {
            display: block;
            padding: 4px 8px;
            border-radius: 8px;
    ...
    `,renderCallback({inputs:e}){return f`
            <${T.assign({icon:e.icon})}></${T}>
        `}}),ii=Object.values(pt).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),z4=Object.keys(ii).sort();function _s(e){return{controlType:H.Dropdown,initValue:e,options:["None",...z4]}}const D0={"CSS color":{controlType:H.Color,initValue:""},[String(m["toniq-icon-stroke-color"].name)]:{controlType:H.Color,initValue:""},[String(m["toniq-icon-fill-color"].name)]:{controlType:H.Color,initValue:""},[String(m["toniq-icon-stroke-width"].name)]:{controlType:H.Color,initValue:""},[String(m["toniq-icon-stroke-width"].name)]:{controlType:H.Number,initValue:2}};function so(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),w2(n,"number")&&(n=A2({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
`)}const V4=G({title:"Social Urls",parent:B0,elementExamplesCallback({defineExample:e}){function t({socialName:r,icon:n}){e({title:r,renderCallback(){return f`
                        <${qo.assign({icon:n})}></${qo}>
                    `}})}Object.entries(Qf).forEach(([r,n])=>{t({socialName:r,icon:n})})}}),ie=G({title:"Elements",parent:void 0}),j4=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:v`
            ${Vt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],F4=G({title:Vt.tagName,parent:ie,elementExamplesCallback({defineExample:e}){j4.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:v`
                    .bold {
                        ${J.boldFont}
                    }
                ...
                `,renderCallback({state:r,updateState:n}){return f`
                        ...
                        ></${Vt}>
                        More text
                    `}})})}}),Z4=G({parent:ie,title:oe.tagName,elementExamplesCallback({defineExample:e}){[{name:"default",inputs:{}},{name:"Secondary",inputs:{buttonStyle:on.Secondary}},{name:"Outline",inputs:{buttonStyle:on.Outline}},{name:"Disabled",inputs:{disabled:!0}}].forEach(r=>{e({title:r.name,stateInitStatic:{showIcon:!1,timeoutId:void 0},styles:v`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
...
`,W4=G({parent:ie,title:Ae.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:zu,renderCallback(){return f`
                ...
                `}}),e({title:"banner style",styles:zu,renderCallback(){return f`
                    ...
                    ></${Ae}>
                `}})}});function U4(e){const t=Object.keys(e.cssVars).map(r=>[`--${r}`,{controlType:H.Color,initValue:""}]);return Object.fromEntries(t)}function G4(e){const t=Object.entries(e).map(([r,n])=>{if(r.startsWith("--"))return typeof n!="string"||!n?void 0:`${r}: ${n};`}).filter(vn);return D(t.join(`
`))}const Y4=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],ra=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],Q4=G({parent:ie,title:ft.tagName,controls:{Text:{controlType:H.Text,initValue:"Text"},...U4(ft)},elementExamplesCallback({defineExample:e}){Y4.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:ra.map(r=>!!r.inputs.checked),extraEntryStatuses:ra.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:v`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return ra.map((i,a)=>{const s=(i.extraEntries??[]).map((c,u)=>{var d;return f`
                        ...
                        `})}})})}}),J4=G({parent:ie,title:Oi.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:cr}},{inputs:{icon:cr}},{inputs:{},template:f`
                    HTML child
                ...
                `,inputs:{text:"custom size"}}];[{title:"default",inputs:{style:Da.Default}},{title:"secondary style",inputs:{style:Da.Secondary}}].forEach(n=>{e({title:n.title,renderCallback(){return t.map(o=>f`
                    ...
                    `)}})})}}),X4=G({title:Fi.tagName,parent:ie,descriptionParagraphs:["Display a date and / or time in a consistent manner."],elementExamplesCallback({defineExample:e}){const t=[{title:"date and time",inputs:{parts:{date:!0,time:!0}}},{title:"date only",inputs:{parts:{date:!0,time:!1}}},{title:"time only",inputs:{parts:{date:!1,time:!0}}}],r=ky();t.forEach(n=>{e({title:n.title,renderCallback(){return f`
                        <${Fi.assign({fullDate:r,...n.inputs})}></${Fi}>
                    `}})})}}),Wn=[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3},{label:"Really really super duper long option",value:4}],K4=[{title:"default"},{title:"transparent background",customStyle:v`
        ...
        `},{customStyle:v`
            max-height: 30px;
            min-height: 30px;
        `}],_4=G({title:qn.tagName,parent:ie,controls:{Selected:{controlType:H.Dropdown,initValue:Wn[0].label,options:Wn.map(e=>e.label)},Direction:{controlType:H.Dropdown,initValue:"Down",options:y2(Va)},Icon:_s(Ef.name),Prefix:{controlType:H.Text,initValue:"Sort by: "},"Force open":{controlType:H.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){K4.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Vu.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:v`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Vu.map((i,a)=>{const s=v`
                        ...
                        `;return f`
                            ...
                            ></${qn}>
                        `})}})})}}),ju="/toniq-labs-design-system";function e3(...e){const r=[globalThis.location.pathname.startsWith(ju)?ju:"",...e].filter(vn);return S2(...r)}const na=Array(30).fill(e3("/toniq-labs-logo.png")),es=["Hello there.","There is stuff here."],Un=es.concat(Array(30).fill(es)),t3=G({title:pe.tagName,parent:ie,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return f`
                    <${pe.assign({infoParagraphs:Un,imageUrls:na,socialUrls:Xv,title:"Featured Stuff",viewButtonTitle:"Stuff"})}></${pe}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return f`
                ...
                `}})}}),r3=G({title:zt.tagName,parent:ie,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:v`
                .front,
                .back {
                    padding: 32px;
                }
            ...
            `,renderCallback({controls:r}){return f`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),f`
                            ...
                            ></${Zn}>
                        `))}})})}}),a3=G({title:Ji.tagName,parent:ie,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:io.Small}},{title:"large",inputs:{size:io.Large}},{title:"whole page",inputs:{size:io.WholePage},styles:v`
                    :host {
                        width: 500px;
                    }
                `}].forEach(r=>{e({title:r.title,styles:r.styles??v``,renderCallback(){return f`
                        <${Ji.assign(r.inputs)}></${Ji}>
                    `}})})}}),s3=G({title:ve.tagName,parent:ie,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return f`
...
`,oa={min:10,max:50},c3=G({title:j.tagName,parent:ie,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:v`
                ${nt}
            `,renderCallback({state:t,updateState:r}){return f`
            ...
            `,renderCallback({state:t,updateState:r}){return f`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Fu.map((i,a)=>f`
                            ...
                            ></${ta}>
                        `)}})})}}),f3=G({parent:ie,title:ao.tagName,elementExamplesCallback({defineExample:e}){function t({title:r,tooltipContent:n,forceShow:o}){e({title:r,styles:v`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),h3=G({parent:ie,title:Ur.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${ao.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return f`
                    <${Ur}>This is a tooltip.</${Ur}>
                `}})}}),m3=[f3,h3],g3=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:v`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:v``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}}],p3=G({title:zr.tagName,parent:ie,elementExamplesCallback({defineExample:e}){g3.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:v`
                    ${t.extraStyles??v``}
                `,renderCallback({state:r,updateState:n}){return f`
                        ...
                        ></${zr}>
                    `}})})}}),O0=G({title:"Icons",parent:void 0,controls:D0}),v3=Object.entries(pt).map(([e,t])=>G({title:e,parent:O0,elementExamplesCallback({defineExample:r}){t.map(n=>r({title:n.name,renderCallback({controls:o}){return f`
                                <${qo.assign({icon:n})}
                                    style=${so(o)}
                                ></${qo}>
                            `}}))}}));function N0(e){const t=w3(e),r=pr(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return et(r).reduce((o,i)=>{const a=r[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function w3(e){typeof e!="string"&&(e=String(e));const n=`{"${u2(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const el=G({title:"Styles",parent:void 0}),y3=v`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function b3(e,t,r){const n=N0(Z(r));return e({title:t,styles:y3,renderCallback(){return f`
            ...
            `}})}const k3=G({title:"Colors",parent:el,elementExamplesCallback({defineExample:e}){et(x).map(t=>b3(e,t,x[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),x3=v`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function A3(e,t,r){const n=N0(r);return e({title:t,styles:x3,renderCallback(){return f`
            ...
            `}})}const S3=G({title:"Fonts",parent:el,elementExamplesCallback({defineExample:e}){et(J).map(t=>{const r=J[t];return A3(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),$3=[ie,O0,el,B0],T3=[...v3,...m3,V4,F4,Z4,W4,Q4,J4,k3,X4,_4,t3,r3,S3,n3,o3,i3,a3,s3,l3,c3,d3,p3].sort((e,t)=>e.title.localeCompare(t.title)),C3=[...$3,...T3];Uo({tagName:"toniq-design-system-app",styles:v`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return f`
            <${Mi.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:C3,themeColor:"#00D093"})}>
