 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const or=(e,t)=>{var r;const n=e._$AN;if(n===void 0)return!1;for(const o of n)(r=o._$AO)==null||r.call(o,t,!1),or(o,t);return!0},So=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while((n==null?void 0:n.size)===0)},Cu=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),Vf(t)}};function Hf(e){this._$AN!==void 0?(So(this),this._$AM=e,Cu(this)):this._$AM=e}function Uf(e,t=!1,n=0){const r=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(t)if(Array.isArray(r))for(let i=n;i<r.length;i++)or(r[i],!1),So(r[i]);else r!=null&&(or(r,!1),So(r));else or(this,e)}const Vf=e=>{e.type==Ln.CHILD&&(e._$AP??(e._$AP=Uf),e._$AQ??(e._$AQ=Hf))};class Wf extends ct{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,n,r){super._$AT(t,n,r),Cu(this),this.isConnected=t._$AU}_$AO(t,n=!0){var r,o;t!==this.isConnected&&(this.isConnected=t,t?(r=this.reconnected)==null||r.call(this):(o=this.disconnected)==null||o.call(this)),n&&(or(this,t),So(this))}setValue(t){if(Nf(this._$Ct))this._$Ct._$AI(t,this);else{const n=[...this._$Ct._$AH];n[this._$Ci]=t,this._$Ct._$AI(n,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Bd=w({name:"LoaderAnimated24Icon",svgTemplate:c`
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{Jl(e,wa(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:n,updateState:r,dispatch:o,events:i})=>{var p,h,m,g,v,k,$;t._debug&&console.info("rendering element-book app");function a(C){return{...e.currentRoute,...C}}function s(C){const S=a(C);return!at(e.currentRoute,S)}function l(C){t.preventWindowTitleChange||(e.originalWindowTitle||r({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,C].filter(be).join(" - "))}function u(C){if(!s(C))return;const S=a(C);e.router?e.router.setRoutes(S):r({currentRoute:{...e.currentRoute,...S}}),t.elementBookRoutePaths&&!at(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(S.paths??[]))}try{if(t.elementBookRoutePaths&&!at(t.elementBookRoutePaths,e.currentRoute.paths)&&u({paths:t.elementBookRoutePaths}),(p=t.internalRouterConfig)!=null&&p.useInternalRouter&&!e.router){const V=sp(t.internalRouterConfig.basePath);r({router:V}),V.addRouteListener(!0,Q=>{r({currentRoute:Q})})}else!((h=t.internalRouterConfig)!=null&&h.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const C={themeColor:t.themeColor};if(!at(C,(m=e.colors)==null?void 0:m.config)){const V=Ul(C);r({colors:{config:C,theme:V}}),up(n,V)}const S=t._debug??!1,N=W1({entries:t.entries,debug:S});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),r({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:Yu(N.tree,{children:(v=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:v.children,controls:t.globalValues})}}));const F=wa(e.currentRoute.paths),le=(F?J1({flattenedNodes:N.flattenedNodes,searchQuery:F}):void 0)??tg(N.flattenedNodes,e.currentRoute.paths,u);l((k=le[0])==null?void 0:k.entry.title);const ce=($=e.treeBasedControls)==null?void 0:$.controls;return ce?(t._debug&&console.info({currentControls:ce}),c`
                <div
                    ...
                    ${x(Ar.events.controlValueChange,V=>{if(!e.treeBasedControls)return;const Q=Z1(ce,V.detail.fullUrlBreadcrumbs,V.detail.newValues);r({treeBasedControls:{...e.treeBasedControls,controls:Q}})})}
                >
                    ...
                    <${sn.assign({controls:ce,currentNodes:le,currentRoute:e.currentRoute,debug:S,originalTree:N.tree,router:e.router,showLoading:e.loading})}
                        ${x(sn.events.loadingRender,async V=>{await ua();const Q=n.shadowRoot.querySelector(sn.tagName);Q?Q.scroll({top:0,behavior:"instant"}):console.error(`Failed to find '${sn.tagName}' for scrolling.`),await ua(),r({loading:!V.detail})})}
                    >
                        <slot
                            name=${st.Footer}
                            slot=${st.Footer}
    ...
    opacity: 0.3;
    ${Ye};
`;function Rt({mainSelector:e,elementBorderSize:t,outlineGap:n=2,outlineWidth:r=3}){const o=T(Wt(r+n+t));return f`
        ${T(e)}::after {
            content: '';
            top: calc(${o} * -1);
            left: calc(${o} * -1);
...
`))}const O=(()=>{const e=f`
    ...
    `}),Vg=w({name:"Heart24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
...
`,I2=w({name:"CryptoIcp16Icon",svgTemplate:c`
    ...
    `}),V2=w({name:"WalletXverse64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),it={"core-16":[ng,Rd,ag,sg,lg,It,cg,ug],"core-24":[dg,hg,ws,fg,pg,vs,Fd,mg,gg,wg,vg,bg,yg,kg,xg,$g,bs,jd,Ag,Cg,Hd,Sg,Tg,Mg,Eg,Ig,Ud,Bg,qg,Lg,Pg,Og,Vd,Dg,Ng,Rg,Fg,jg,Hg,Ug,Vg,Ea,Wd,Wg,zg,Zg,Yg,Gg,Qg,ys,Kg,Jg,Xg,_g,e2,t2,n2,r2,o2,zd,Zd,i2,a2,s2,l2,c2,u2,d2,po,h2,f2,p2,Yd,m2,g2,Gd],"core-48":[w2,v2,Qd,b2,y2,k2,x2,$2,A2],"core-64":[Kd,C2,S2],cryptocurrencies:[T2,oi,M2,E2,I2,B2],"external-wallets":[q2,L2,P2,O2,D2,N2,R2,F2,j2,H2,U2,V2],"third-party-brands":[_d,e0,t0,W2,z2,Z2,n0,Y2,r0,G2,o0,i0,Q2,a0,s0],toniq:[K2,J2]},X2=Br({discord:nt(void 0,""),distrikt:nt(void 0,""),dscvr:nt(void 0,""),instagram:nt(void 0,""),medium:nt(void 0,""),telegram:nt(void 0,""),tikTok:nt(void 0,""),twitch:nt(void 0,""),twitter:nt(void 0,""),website:nt(void 0,"")}),_2=X2.defaultValue,l0={discord:_d,instagram:n0,telegram:o0,tikTok:i0,distrikt:e0,twitch:a0,dscvr:t0,medium:r0,twitter:s0,website:Yd},ec="toniq-",{defineElement:ie,defineElementNoInputs:ks}=ss({assertInputs:e=>{if(!e.tagName.startsWith(ec))throw new Error(`Tag name should start with '${ec}' but got '${e.tagName}'`)}}),y=ie()({tagName:"toniq-icon",styles:f`
        :host {
            display: flex;
                        ...
                        `;return c`
                            ...
                            >
                                <div
                                    ...
                                    ${Bt(ce=>{var nn,Fn;const V=ce.target;if(!(V instanceof HTMLElement))throw new Error("onResize event had no target");const Q=V.closest(".table-list"),Se=Q==null?void 0:Q.getBoundingClientRect().left,ve=Q==null?void 0:Q.querySelectorAll(".row-item")[$],ut=ve==null?void 0:ve.getBoundingClientRect().left,yt=V.getBoundingClientRect().width;(!((nn=t.rowStyles[k.key])!=null&&nn.width)||yt>((Fn=t.rowStyles[k.key])==null?void 0:Fn.width))&&n({rowStyles:{...t.rowStyles,[k.key]:{width:yt,left:Se?ut-Se:ut}}}),e.nonBlocking||n({itemsPainted:t.itemsPainted+1})})}
                                >
                                    ${we(v===0,c`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:du()})},renderCallback({inputs:e,dispatch:t,events:n,state:r}){return Uv(e.entries).map(i=>Vv(e.groupName||r.randomGroupName,e.value,i,()=>{t(new n.valueChange(i.value))}))}});function Uv(e){const t=Object.fromEntries(e.map(r=>[r.value,r]));return Object.values(t).length!==e.length&&console.error(`${_.tagName} was given duplicate entry values.`),Object.values(t)}function Vv(e,t,n,r){const o=t===n.value,i=c`
...
`;function _v(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function _n(e){requestAnimationFrame(()=>{const t=wh(e.instanceInputs,e).elementValue;Xv(t,e)&&(e.setAttribute("disabled","true"),_n(e))})}const j=ie()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:oe()},styles:f`
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{_n(e)}),e.addEventListener("keydown",()=>{_n(e)}),e.addEventListener("keyup",()=>{_n(e)})},renderCallback({inputs:e,host:t,events:n,dispatch:r,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:u,elementValue:p,elementLimits:h,rangeWidth:m}=wh({...e},t);if(_n(t),Tr(p))return g(a,p,h);return k(a,p,h);function g($,C,S){const N={left:Wt((m-Vt)*(C.min-S.min)/(S.max-S.min)+Vt/2),right:Wt((m-Vt)*(S.max-C.max)/(S.max-S.min)+Vt/2)},F=ea($.min,u,l),X=ea($.max,u,l);requestAnimationFrame(()=>{const ve=Yv(t);ve!==o.labelOverlap&&i({labelOverlap:ve})});const le=(S.max-C.max)/(S.max-S.min)>.5,ce=_i({value:C.min,limits:{min:S.min,max:C.max},flip:!0}),V=_i({value:C.max,limits:{min:C.min,max:S.max},flip:!1}),Q=o.labelOverlap&&le?o.labelOverlap:0,Se=o.labelOverlap&&!le?o.labelOverlap:0;return c`
                <div
                    class="range"
            ...
            `}function v($){i({internalValue:$}),e.disabled||r(new n.valueChange($))}function k($,C,S){const N=Wt((m-Vt)*(S.max-C)/(S.max-S.min)+Vt/2),F=ea($,u,l),X=_i({value:C,limits:S,flip:!1});return c`
                <div
    ...
    `,renderCallback({inputs:e,dispatch:t,events:n}){const r=e.tabs.map(o=>{var l;const i=o.value===e.value,a=o.icon?c`
        ...
        `}}),yh=U({title:"Data",parent:void 0}),Wo=ie()({tagName:"toniq-icon-book-viewer",styles:f`
        :host {
            display: inline-flex;
            padding: 8px;
            border-radius: 8px;
...
`,aa={min:10,max:50},N5=U({title:j.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:f`
            ...
            `,forceShow:!1}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!1})}}),H5=U({parent:te,title:hr.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${bo.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return c`
                ...
                `}})}}),U5=[j5,H5],V5=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:f`
            :host {
                width: 500px;
            }
...
`;function J5(e,t,n){const r=Sh(n);return e({title:t,styles:K5,renderCallback(){return c`
            ...
            `}})}const X5=U({title:"Fonts",parent:di,elementExamplesCallback({defineExample:e}){se(O).map(t=>{const n=O[t];return J5(e,t,n)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),_5=U({title:"Shadows",parent:di,elementExamplesCallback({defineExample:e}){Oh(Cr).forEach(([t,n])=>{e({title:t,styles:f`
                    ...
                    `,renderCallback(){return c`
                            <div></div>
                        `}})})}}),eb=[te,Ch,di,yh],tb=[...z5,...U5,t5,o5,n5,i5,a5,u5,d5,Q5,h5,p5,g5,w5,v5,X5,b5,y5,k5,x5,L5,P5,O5,D5,_5,N5,F5,W5,q5].sort((e,t)=>e.title.localeCompare(t.title)),nb=[...eb,...tb];Xo({tagName:"toniq-design-system-app",styles:f`
        :host {
            display: block;
            height: 100%;
            width: 100%;
