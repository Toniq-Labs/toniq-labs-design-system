 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $n={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Dt=e=>(...t)=>({_$litDirective$:e,values:t});class wt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,n){this._$Ct=t,this._$AM=r,this._$Ci=n}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const fe=Dt(class extends wt{constructor(e){var t;if(super(e),e.type!==$n.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var n,o;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!((n=this.nt)!=null&&n.has(i))&&this.st.add(i);return this.render(t)}const r=e.element.classList;for(const i of this.st)i in t||(r.remove(i),this.st.delete(i));for(const i in t){const a=!!t[i];a===this.st.has(i)||(o=this.nt)!=null&&o.has(i)||(a?(r.add(i),this.st.add(i)):(r.remove(i),this.st.delete(i)))}return Pe}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const sa=e=>e??ee;/**
...
`,he=Ir()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:e})=>!!e.fitContainer},styles:({hostClasses:e})=>f`
    ...
    `,renderCallback:({inputs:e})=>{const t=e.icon?c`
        ...
        `}});var $a;(function(e){e.Header="header"})($a||($a={}));Ir()({tagName:"vira-collapsible-wrapper",hostClasses:{"vira-collapsible-wrapper-expanded":({inputs:e})=>e.expanded},styles:({hostClasses:e})=>f`
        :host {
            display: flex;
...
`,Td=v({name:"LoaderAnimated24Icon",svgTemplate:c`
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{Yl(e,fa(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:r,updateState:n,dispatch:o,events:i})=>{var p,h,m,g,w,$,x;t._debug&&console.info("rendering element-book app");function a(C){return{...e.currentRoute,...C}}function s(C){const S=a(C);return!at(e.currentRoute,S)}function l(C){t.preventWindowTitleChange||(e.originalWindowTitle||n({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,C].filter(ve).join(" - "))}function u(C){if(!s(C))return;const S=a(C);e.router?e.router.setRoutes(S):n({currentRoute:{...e.currentRoute,...S}}),t.elementBookRoutePaths&&!at(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(S.paths??[]))}try{if(t.elementBookRoutePaths&&!at(t.elementBookRoutePaths,e.currentRoute.paths)&&u({paths:t.elementBookRoutePaths}),(p=t.internalRouterConfig)!=null&&p.useInternalRouter&&!e.router){const V=Y1(t.internalRouterConfig.basePath);n({router:V}),V.addRouteListener(!0,ne=>{n({currentRoute:ne})})}else!((h=t.internalRouterConfig)!=null&&h.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const C={themeColor:t.themeColor};if(!at(C,(m=e.colors)==null?void 0:m.config)){const V=Fl(C);n({colors:{config:C,theme:V}}),J1(r,V)}const S=t._debug??!1,N=B1({entries:t.entries,debug:S});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),n({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:Wu(N.tree,{children:(w=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:w.children,controls:t.globalValues})}}));const R=fa(e.currentRoute.paths),ce=(R?R1({flattenedNodes:N.flattenedNodes,searchQuery:R}):void 0)??Um(N.flattenedNodes,e.currentRoute.paths,u);l(($=ce[0])==null?void 0:$.entry.title);const X=(x=e.treeBasedControls)==null?void 0:x.controls;return X?(t._debug&&console.info({currentControls:X}),c`
            ...
            `}}});async function Yl(e,t,r){if(t||r.paths.length<=1)return;const n=e.shadowRoot.querySelector(ft.tagName);if(!(n instanceof ft))throw new Error(`Failed to find child '${ft.tagName}'`);await Fm(n)}function ir(e){return{foregroundColor:e.backgroundColor,backgroundColor:e.foregroundColor}}const Wm=(()=>{const e={backgroundColor:f`#ffffff`,foregroundColor:f`#000000`},t={...e,foregroundColor:f`#00D093`},r={...e,foregroundColor:f`#ACADAD`},n={...e,foregroundColor:f`#D6D6D6`},o={foregroundColor:f`#ffffff`,backgroundColor:f`#FF5357`},i={...ir(o),backgroundColor:f`transparent`},a={foregroundColor:f`#ffffff`,backgroundColor:f`#01C9A0`},s={...ir(a),backgroundColor:f`transparent`},l={foregroundColor:f`#ffffff`,backgroundColor:f`#FFAC00`},u={...ir(l),backgroundColor:f`transparent`},p={...t},h={...t,foregroundColor:f`#00A876`},m={...t,foregroundColor:f`#1D6852`},g={...n},w={...e,foregroundColor:f`rgba(0, 0, 0, 0.08)`},$={...e,backgroundColor:f`#D2EEFA`},x=ir(p),C=ir(h),S=ir(m),N=S,R={backgroundColor:f`#F1F3F6`,foregroundColor:e.foregroundColor},J={...R,foregroundColor:f`#9A9A9D`},ce={...e,backgroundColor:f`color(
...
`))}const D=(()=>{const e=f`
    ...
    `}),$g=v({name:"Gear24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Ag=v({name:"Geometry24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
...
`,l2=v({name:"CryptoIcp16Icon",svgTemplate:c`
    ...
    `}),$2=v({name:"BrandGoogleLogo24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),A2=v({name:"BrandIcScan24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `,cleanupCallback:({state:e})=>{window.clearInterval(e.rotationIntervalId)},renderCallback({inputs:e,state:t,updateState:r,host:n}){e.enableAutomaticCycling&&t.rotationIntervalId==null?r({rotationIntervalId:window.setInterval(()=>{Bi({host:n,direction:"right",allowWrapping:!0,blockIfHovering:!0})},e.cycleIntervalMs||D2)}):!e.enableAutomaticCycling&&t.rotationIntervalId!=null&&(window.clearInterval(t.rotationIntervalId),r({rotationIntervalId:void 0}));const o=_l(t.scrollSnapPositions,0),i=_l(t.scrollSnapPositions,-1);return c`
            <div>
                ...
                <div
                    ${Ar(()=>{r({scrollSnapPositions:vs(Ta(n)).x})})}
                    class=${co}
    ...
    `,renderCallback({inputs:e,state:t,updateState:r,host:n,dispatch:o,events:i}){var m,g,w,$;const a=e.mainImageSize||Oa,s=dh(a);ko({onElement:n,forCssVar:ot["main-image-size"],toValue:`${a}px`}),ko({onElement:n,forCssVar:ot["secondary-image-size"],toValue:`${s}px`});const l=["View",e.viewButtonTitle].filter(ve).join(" "),u=c`
            <h3>${e.cardTitle}</h3>
    ...
    `,stateInitStatic:{canScroll:!1,debouncedResize:b1(()=>Vh(sn.FirstThenWait,{milliseconds:30})),rowStyles:{},isPainting:!1,itemsPainted:0,pageCountKey:0},initCallback({inputs:e,state:t,updateState:r}){const n=e.columns.filter(o=>!o.disabled);r({rowStyles:n.reduce((o,i)=>(o[i.key]={width:void 0,left:void 0},o),t.rowStyles)})},renderCallback({inputs:e,state:t,updateState:r,events:n,dispatch:o}){var h;const i=e.columns.filter(m=>!m.disabled),a=[e.rows[0],...e.rows].filter(ve);function s(m){m instanceof HTMLElement&&t.debouncedResize(()=>{r({canScroll:m.scrollWidth>m.clientWidth})})}const l=e.pagination&&((h=e.pagination)==null?void 0:h.pageCount)>1?c`
                ...
                >
                    ${i.map((w,$)=>{var S,N,R,J;const x=m.cells[w.key],C=f`
...
`;function Bv(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Qr(e){requestAnimationFrame(()=>{const t=fh(e.instanceInputs,e).elementValue;Iv(t,e)&&(e.setAttribute("disabled","true"),Qr(e))})}const F=ae()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ie()},styles:f`
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Qr(e)}),e.addEventListener("keydown",()=>{Qr(e)}),e.addEventListener("keyup",()=>{Qr(e)})},renderCallback({inputs:e,host:t,events:r,dispatch:n,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:u,elementValue:p,elementLimits:h,rangeWidth:m}=fh({...e},t);if(Qr(t),kn(p))return g(a,p,h);return $(a,p,h);function g(x,C,S){const N={left:Wt((m-Ut)*(C.min-S.min)/(S.max-S.min)+Ut/2),right:Wt((m-Ut)*(S.max-C.max)/(S.max-S.min)+Ut/2)},R=Ki(x.min,u,l),J=Ki(x.max,u,l);requestAnimationFrame(()=>{const be=Cv(t);be!==o.labelOverlap&&i({labelOverlap:be})});const ce=(S.max-C.max)/(S.max-S.min)>.5,X=Qi({value:C.min,limits:{min:S.min,max:C.max},flip:!0}),V=Qi({value:C.max,limits:{min:C.min,max:S.max},flip:!1}),ne=o.labelOverlap&&ce?o.labelOverlap:0,Ce=o.labelOverlap&&!ce?o.labelOverlap:0;return c`
            ...
            `}function w(x){i({internalValue:x}),e.disabled||n(new r.valueChange(x))}function $(x,C,S){const N=Wt((m-Ut)*(S.max-C)/(S.max-S.min)+Ut/2),R=Ki(x,u,l),J=Qi({value:C,limits:S,flip:!1});return c`
                <div
...
`,ra={min:10,max:50},m5=U({title:F.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:f`
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:f``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:f``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:Ca},{label:"label here",value:2,icon:Ca},{label:"",value:3,icon:Et,disabled:!0},{label:"16px icon",value:4,icon:Et},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],x5=U({title:Kr.tagName,parent:re,elementExamplesCallback({defineExample:e}){k5.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:f`
                ...
                `,renderCallback({state:r,updateState:n}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return c`
                        ...
                        ></${Kr}>
                    `}})})}}),yh=U({title:"Icons",parent:void 0,controls:wh}),$5=Object.entries(it).map(([e,t])=>U({title:e,parent:yh,elementExamplesCallback({defineExample:r}){t.map(n=>r({title:n.name,renderCallback({controls:o}){return c`
                                <${Ro.assign({icon:n})}
                                    style=${mo(o)}
                                ></${Ro}>
                            `}}))}}));function kh(e){const t=A5(e),r=xe(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return le(r).reduce((o,i)=>{const a=r[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function A5(e){typeof e!="string"&&(e=String(e));const n=`{"${Jc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const ai=U({title:"Styles",parent:void 0}),C5=f`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function E5(e,t,r){const n=kh(r);return e({title:t,styles:M5,renderCallback(){return c`
            ...
            `}})}const I5=U({title:"Fonts",parent:ai,elementExamplesCallback({defineExample:e}){le(D).map(t=>{const r=D[t];return E5(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),B5=U({title:"Shadows",parent:ai,elementExamplesCallback({defineExample:e}){Ih(bn).forEach(([t,r])=>{e({title:t,styles:f`
                    ...
                    `,renderCallback(){return c`
                            <div></div>
                        `}})})}}),q5=[re,yh,ai,gh],L5=[...$5,...y5,Lv,Dv,Pv,Nv,Rv,Uv,Wv,T5,Vv,Zv,Yv,Qv,Kv,I5,Jv,Xv,_v,e5,d5,h5,f5,p5,B5,m5,w5,x5,u5].sort((e,t)=>e.title.localeCompare(t.title)),P5=[...q5,...L5];Zo({tagName:"toniq-design-system-app",styles:f`
        :host {
            display: block;
            height: 100%;
            width: 100%;
