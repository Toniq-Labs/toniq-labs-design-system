...
`,he=Br()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:e})=>!!e.fitContainer},styles:({hostClasses:e})=>f`
    ...
    `,events:{expandChange:ie()},stateInitStatic:{contentHeight:0},renderCallback({state:e,updateState:t,dispatch:r,events:n,inputs:o}){const i=o.expanded?f`
        ...
        `}});const L=vt({"vira-icon-stroke-color":"currentColor","vira-icon-fill-color":"none","vira-icon-stroke-width":"1px"});function w({name:e,svgTemplate:t}){return{name:e,svgTemplate:t}}const qm=w({name:"CloseX24Icon",svgTemplate:c`
    ...
    `}),Lm=w({name:"Element16Icon",svgTemplate:c`
    ...
    `});const Pm=w({name:"Loader24Icon",svgTemplate:c`
        <svg
...
`,Td=w({name:"LoaderAnimated24Icon",svgTemplate:c`
        <style>
            ${Om}
        </style>
        ${Pm.svgTemplate}
    `}),Dm=w({name:"Options24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <g
                fill=${L["vira-icon-fill-color"].value}
                stroke=${L["vira-icon-stroke-color"].value}
    ...
    `}),Md=w({name:"StatusFailure24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <circle
                cx="12"
                cy="12"
    ...
    `,events:{routeChange:ie()},renderCallback({inputs:e,dispatch:t,events:r}){var o,i;function n(a){e.route&&Yo(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new r.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return c`
            ...
            `}}});const{defineElement:Ye,defineElementNoInputs:G5}=ns(),je=Ye()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>f`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{Yl(e,fa(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:r,updateState:n,dispatch:o,events:i})=>{var p,h,m,g,v,$,x;t._debug&&console.info("rendering element-book app");function a(C){return{...e.currentRoute,...C}}function s(C){const S=a(C);return!at(e.currentRoute,S)}function l(C){t.preventWindowTitleChange||(e.originalWindowTitle||n({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,C].filter(ve).join(" - "))}function u(C){if(!s(C))return;const S=a(C);e.router?e.router.setRoutes(S):n({currentRoute:{...e.currentRoute,...S}}),t.elementBookRoutePaths&&!at(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(S.paths??[]))}try{if(t.elementBookRoutePaths&&!at(t.elementBookRoutePaths,e.currentRoute.paths)&&u({paths:t.elementBookRoutePaths}),(p=t.internalRouterConfig)!=null&&p.useInternalRouter&&!e.router){const V=Y1(t.internalRouterConfig.basePath);n({router:V}),V.addRouteListener(!0,ne=>{n({currentRoute:ne})})}else!((h=t.internalRouterConfig)!=null&&h.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const C={themeColor:t.themeColor};if(!at(C,(m=e.colors)==null?void 0:m.config)){const V=Fl(C);n({colors:{config:C,theme:V}}),J1(r,V)}const S=t._debug??!1,N=B1({entries:t.entries,debug:S});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),n({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:Wu(N.tree,{children:(v=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:v.children,controls:t.globalValues})}}));const F=fa(e.currentRoute.paths),ce=(F?R1({flattenedNodes:N.flattenedNodes,searchQuery:F}):void 0)??Um(N.flattenedNodes,e.currentRoute.paths,u);l(($=ce[0])==null?void 0:$.entry.title);const X=(x=e.treeBasedControls)==null?void 0:x.controls;return X?(t._debug&&console.info({currentControls:X}),c`
            ...
            `}}});async function Yl(e,t,r){if(t||r.paths.length<=1)return;const n=e.shadowRoot.querySelector(ft.tagName);if(!(n instanceof ft))throw new Error(`Failed to find child '${ft.tagName}'`);await Fm(n)}const d=vt({"toniq-icon-fill-color":L["vira-icon-fill-color"].default,"toniq-icon-stroke-color":L["vira-icon-stroke-color"].default,"toniq-icon-stroke-width":"2px"}),G=xe(d,(e,t)=>r=>T(`var(${t.name}, ${r})`)),Wm=w({name:"CheckMark16Icon",svgTemplate:c`
    ...
    `});function ir(e){return{foregroundColor:e.backgroundColor,backgroundColor:e.foregroundColor}}const Vm=(()=>{const e={backgroundColor:f`#ffffff`,foregroundColor:f`#000000`},t={...e,foregroundColor:f`#00D093`},r={...e,foregroundColor:f`#ACADAD`},n={...e,foregroundColor:f`#D6D6D6`},o={foregroundColor:f`#ffffff`,backgroundColor:f`#FF5357`},i={...ir(o),backgroundColor:f`transparent`},a={foregroundColor:f`#ffffff`,backgroundColor:f`#01C9A0`},s={...ir(a),backgroundColor:f`transparent`},l={foregroundColor:f`#ffffff`,backgroundColor:f`#FFAC00`},u={...ir(l),backgroundColor:f`transparent`},p={...t},h={...t,foregroundColor:f`#00A876`},m={...t,foregroundColor:f`#1D6852`},g={...n},v={...e,foregroundColor:f`rgba(0, 0, 0, 0.08)`},$={...e,backgroundColor:f`#D2EEFA`},x=ir(p),C=ir(h),S=ir(m),N=S,F={backgroundColor:f`#F1F3F6`,foregroundColor:e.foregroundColor},J={...F,foregroundColor:f`#9A9A9D`},ce={...e,backgroundColor:f`color(
            from ${p.backgroundColor} srgb r g b / 0.9
        )`};return{brandPrimary:t,pagePrimary:e,pageSecondary:r,pageTertiary:n,pageInteraction:p,pageInteractionHover:h,pageInteractionActive:m,divider:g,dividerFaint:v,dropShadow:$,pageDarkPrimary:N,accentPrimary:x,accentPrimaryHover:C,accentPrimaryActive:S,accentSecondary:F,accentTertiary:J,colorDanger:o,colorSuccess:a,colorWarning:l,alertDanger:i,alertWarning:u,alertSuccess:s,opaqueOverlay:ce}})(),qd=Vm;function Ql(e,t){return T(`--toniq-${wo(e)}-${wo(t)}`)}const hs=xe(qd,e=>({backgroundColor:Ql(e,"backgroundColor"),foregroundColor:Ql(e,"foregroundColor")}));function Xe(e,t){const r=qd[e][t],n=hs[e][t];return f`var(${n}, ${r})`}const b=xe(hs,e=>({foregroundColor:Xe(e,"foregroundColor"),backgroundColor:Xe(e,"backgroundColor")}));function R(e){return f`
...
`))}const O=(()=>{const e=f`
    ...
    `,g=f`
        ${Oe("monospaceFont")}
    `;return{toniqFont:e,normalWeightFont:t,boldFont:r,extraBoldFont:n,paragraphFont:o,boldParagraphFont:i,labelFont:a,boldLabelFont:s,h1Font:l,h2Font:u,h3Font:p,h4Font:h,h5Font:m,monospaceFont:g}})(),kn={popupShadow:f`
    ...
    `};function Zm(e,t=!0){const r=T(e),n=e===":host"?f`
        ...
        ${o}
    `}const Pd=w({name:"ChevronsRight16Icon",svgTemplate:c`
        <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
    ...
    `}),Gm=w({name:"CloseX16Icon",svgTemplate:c`
        <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
    ...
    `}),Ym=w({name:"Copy16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),Qm=w({name:"ExternalLink16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Et=w({name:"InfoCircle16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Km=w({name:"Refresh16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Jm=w({name:"ShootingStar16Icon",svgTemplate:c`
        <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
    ...
    `}),Xm=w({name:"ArrowBarUp24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),_m=w({name:"ArrowForwardUp24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),fs=w({name:"ArrowLeft24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),eg=w({name:"ArrowLoopLeft24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),tg=w({name:"ArrowLoopRight24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),ps=w({name:"ArrowRight24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Od=w({name:"ArrowsSort24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),rg=w({name:"ArrowsSortAscending24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),ng=w({name:"ArrowsSortDescending24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),og=w({name:"Bell24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),ig=w({name:"Bucket24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),ag=w({name:"BuildingStore24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),sg=w({name:"CalendarEvent24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),lg=w({name:"Cash24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),ms=w({name:"CheckMark24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Dd=w({name:"ChevronDown24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),ug=w({name:"ChevronUp24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),dg=w({name:"Circle24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Nd=w({name:"CircleDot24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),hg=w({name:"CirclePlus24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),fg=w({name:"CircleWavyCheck24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),pg=w({name:"Clock24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),gg=w({name:"Code24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Rd=w({name:"Copy24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),wg=w({name:"CreateFile24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),vg=w({name:"DotsVertical24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),yg=w({name:"Edit24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),kg=w({name:"Envelope24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Fd=w({name:"ExternalLink24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),xg=w({name:"Filter24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),$g=w({name:"Fire24Icon",svgTemplate:c`
        <svg
            width="14"
            height="24"
            viewBox="0 0 14 19"
    ...
    `}),Ag=w({name:"FrameBolt24",svgTemplate:c`
        <svg
            width="24"
            height="24"
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Cg=w({name:"Gear24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Sg=w({name:"Geometry24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Tg=w({name:"GridDots24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Mg=w({name:"Heart24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Ca=w({name:"Infinity24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),jd=w({name:"Info24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Eg=w({name:"LayersLinked24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Ig=w({name:"LayoutGrid24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Bg=w({name:"Lifebuoy24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),qg=w({name:"List24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Lg=w({name:"ListDetails24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Pg=w({name:"Loader24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),gs=w({name:"LoaderAnimated24Icon",svgTemplate:c`
        <style>
            @keyframes spin {
                0% {
                    transform: rotate(0deg);
    ...
    `}),Og=w({name:"Lock24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Dg=w({name:"LockOpen24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Ng=w({name:"Menu24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Rg=w({name:"Pamphlet24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),Fg=w({name:"Paper24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),jg=w({name:"People24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Hg=w({name:"Person24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Ug=w({name:"Photo24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Wg=w({name:"Refresh24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Hd=w({name:"Rocket24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Ud=w({name:"Search24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Vg=w({name:"Send24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),zg=w({name:"ShootingStar24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),Zg=w({name:"ShoppingCart24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Yg=w({name:"Square24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Qg=w({name:"SquareCheck24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Kg=w({name:"Tag24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),co=w({name:"Trash24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Jg=w({name:"Upload24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Xg=w({name:"Wallet24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Wd=w({name:"World24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),_g=w({name:"WorldUpload24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),e2=w({name:"X24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Vd=w({name:"XCircle24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),t2=w({name:"Fire48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),r2=w({name:"Folder48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),zd=w({name:"FolderOff48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),n2=w({name:"Kyc48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),o2=w({name:"Rocket48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),i2=w({name:"Tag48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${d["toniq-icon-fill-color"].value}
            stroke=${d["toniq-icon-stroke-color"].value}
    ...
    `}),s2=w({name:"Wallet48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${d["toniq-icon-fill-color"].value}
            stroke=${d["toniq-icon-stroke-color"].value}
    ...
    `}),Zd=w({name:"Api64Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),l2=w({name:"CircleDashes64Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),u2=w({name:"CryptoBtc16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),_o=w({name:"CryptoBtc24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),d2=w({name:"CryptoCkBtc16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),h2=w({name:"CryptoCkBtc24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
...
`,f2=w({name:"CryptoIcp16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),m2=w({name:"WalletBitfinity24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),g2=w({name:"WalletBitfinity64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),w2=w({name:"WalletLeather24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),v2=w({name:"WalletLeather64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),y2=w({name:"WalletPlug64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),k2=w({name:"WalletStoic24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),x2=w({name:"WalletStoic64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),$2=w({name:"WalletUnisat24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),A2=w({name:"WalletUnisat64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),C2=w({name:"WalletXverse24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),S2=w({name:"WalletXverse64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),Qd=w({name:"BrandDiscord24Icon",svgTemplate:c`
        <svg
    ...
    `}),Kd=w({name:"BrandDistrikt24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),Jd=w({name:"BrandDscvr24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            height="24"
    ...
    `}),T2=w({name:"BrandFacebookLogo24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),M2=w({name:"BrandGoogleLogo24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),E2=w({name:"BrandIcScan24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),Xd=w({name:"BrandInstagram24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill-rule="evenodd"
            width="24"
    ...
    `}),I2=w({name:"BrandInstagramFlat24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),_d=w({name:"BrandMedium24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${G["toniq-icon-fill-color"]("#000")}
    ...
    `}),B2=w({name:"BrandNftgeek24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),e0=w({name:"BrandTelegram24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),t0=w({name:"BrandTiktok24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),r0=w({name:"BrandTwitch24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),n0=w({name:"BrandTwitter24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),L2=w({name:"BioniqRobot100Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),P2=w({name:"EntrepotLogo144Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),it={"core-16":[Wm,Pd,Gm,Ym,Qm,Et,Km,Jm],"core-24":[Xm,_m,fs,eg,tg,ps,Od,rg,ng,og,ig,ag,sg,lg,cg,ms,Dd,ug,dg,Nd,hg,fg,pg,mg,gg,Rd,wg,vg,bg,yg,kg,Fd,xg,$g,Ag,Cg,Sg,Tg,Mg,Ca,jd,Eg,Ig,Bg,qg,Lg,Pg,gs,Og,Dg,Ng,Rg,Fg,jg,Hg,Ug,Wg,Hd,Ud,Vg,zg,Zg,Gg,Yg,Qg,Kg,co,Jg,Xg,Wd,_g,e2,Vd],"core-48":[t2,r2,zd,n2,o2,i2,a2,s2],"core-64":[Zd,l2,c2],cryptocurrencies:[u2,_o,d2,h2,f2,p2],"external-wallets":[m2,g2,w2,v2,b2,y2,k2,x2,$2,A2,C2,S2],"third-party-brands":[Qd,Kd,Jd,T2,M2,E2,Xd,I2,_d,B2,e0,t0,q2,r0,n0],toniq:[L2,P2]},O2=Mn({discord:rt(void 0,""),distrikt:rt(void 0,""),dscvr:rt(void 0,""),instagram:rt(void 0,""),medium:rt(void 0,""),telegram:rt(void 0,""),tikTok:rt(void 0,""),twitch:rt(void 0,""),twitter:rt(void 0,""),website:rt(void 0,"")}),D2=O2.defaultValue,o0={discord:Qd,instagram:Xd,telegram:e0,tikTok:t0,distrikt:Kd,twitch:r0,dscvr:Jd,medium:_d,twitter:n0,website:Wd},Jl="toniq-",{defineElement:ae,defineElementNoInputs:ws}=ns({assertInputs:e=>{if(!e.tagName.startsWith(Jl))throw new Error(`Tag name should start with '${Jl}' but got '${e.tagName}'`)}}),y=ae()({tagName:"toniq-icon",styles:f`
        :host {
            display: flex;
    ...
    `,renderCallback({inputs:e}){const t=e.iconPlacement??"left",r=e.icon?c`
        ...
        `}});function N2(e,t,r={behavior:"smooth"}){let n=2;const o=t==="up"||t==="down"?"y":"x",i=t==="right"||t==="down"?"+":"-",a=o==="x"?e.scrollWidth-e.offsetWidth:e.scrollHeight-e.offsetHeight,s=vs(e)[o];i==="-"&&(n*=-1);const l=e[o==="x"?"scrollLeft":"scrollTop"]+n,u=s.filter(h=>i==="+"?h>l:h<l).sort((h,m)=>i==="+"?h-m:m-h);let p;return u.length>0?p=u[0]:i==="+"?p=a:p=0,e.scrollTo({...r,[o==="x"?"left":"top"]:p})}function R2(e){const t=window.getComputedStyle(e),r=e.getBoundingClientRect();let n=t.getPropertyValue("scroll-padding-left").replace("auto","0px"),o=t.getPropertyValue("scroll-padding-top").replace("auto","0px"),i=t.getPropertyValue("scroll-padding-right").replace("auto","0px"),a=t.getPropertyValue("scroll-padding-bottom").replace("auto","0px");function s(m,g){let v=parseFloat(m);return/%/.test(m)&&(v/=100,v*=g),v}let l=s(n,r.width),u=s(o,r.height),p=s(i,r.width),h=s(a,r.height);return{x:{before:l,after:p},y:{before:u,after:h}}}function F2(e,t,r="both"){return r==="x"&&e.right>=t.left&&e.left<=t.right||r==="y"&&e.bottom>=t.top&&e.top<=t.bottom||r==="both"&&e.right>=t.left&&e.left<=t.right&&e.bottom>=t.top&&e.top<=t.bottom}function s0(e){let t=[];for(const r of e.children)t=t.concat(r,s0(r));return t}function j2(e,t=!0){const r=e.getBoundingClientRect(),n={x:{start:[],center:[],end:[]},y:{start:[],center:[],end:[]}},o=s0(e);for(const i of["x","y"]){const a=i==="x"?"y":"x",s=i==="x"?"left":"top",l=i==="x"?"width":"height",u=i==="x"?"scrollLeft":"scrollTop";for(const p of o){const h=p.getBoundingClientRect();if(t&&!F2(r,h,a))continue;const m=window.getComputedStyle(p);let[g,v]=m.getPropertyValue("scroll-snap-align").split(" ");typeof v>"u"&&(v=g);const $=i==="x"?v:g,x=h[s]-r[s]+e[u];switch($){case"none":break;case"start":n[i].start.push(x);break;case"center":n[i].center.push(x+h[l]/2);break;case"end":n[i].end.push(x+h[l]);break}}}return n}function vs(e){const t=e.getBoundingClientRect(),r=R2(e),n=j2(e),o={x:e.scrollWidth-e.offsetWidth,y:e.scrollHeight-e.offsetHeight},i=(a,s)=>l=>Math.max(a,Math.min(s,l));return{x:Xl([...n.x.start.map(a=>a-r.x.before),...n.x.center.map(a=>a-t.width/2),...n.x.end.map(a=>a-t.width+r.x.after)].map(i(0,o.x))),y:Xl([...n.y.start.map(a=>a-r.y.before),...n.y.center.map(a=>a-t.height/2),...n.y.end.map(a=>a-t.height+r.y.after)].map(i(0,o.y)))}}function Xl(e){return Array.from(new Set(e))}const uo="templates-container",H2=4e3;var ho=(e=>(e.Default="default",e.Banner="banner",e))(ho||{});const ye=ae()({tagName:"toniq-carousel",hostClasses:{"toniq-carousel-banner-variant":({inputs:e})=>e.variant==="banner","toniq-carousel-offset-arrows":({inputs:e})=>!!e.offsetArrows},stateInitStatic:{currentScrollPosition:{left:0,right:1/0},scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({hostClasses:e})=>f`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
    ...
    `,renderCallback({inputs:e,state:t,updateState:r,host:n,dispatch:o,events:i}){var m,g,v,$;const a=e.mainImageSize||Oa,s=dh(a);xo({onElement:n,forCssVar:ot["main-image-size"],toValue:`${a}px`}),xo({onElement:n,forCssVar:ot["secondary-image-size"],toValue:`${s}px`});const l=["View",e.viewButtonTitle].filter(ve).join(" "),u=c`
            <h3>${e.cardTitle}</h3>
    ...
    `,renderCallback:({inputs:e})=>c`
        ...
        `}),Rc="...";function bv(e,t,r=7,n=5){let o;e=vr({value:e,min:1,max:t}),r=vr({value:r,min:n,max:t});const i=r-5,a=r-3;t<=r?o=r:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>r?Vi(t-o,t):e>o?Vi(Math.min(s.start,t-o),Math.min(s.end,t)):Vi(1,Math.min(t,o+1));function u(h,m){return l.length+1!==t?m:[h]}const p=l[l.length-1];if(p&&p<t){const h=u(t,[Rc,t]);return[...l,...h]}else return l[0]!==1?u(1,[1,Rc]).concat(l):l}function Vi(e,t){const r=t-e+1;return Array.from({length:r},(n,o)=>e+o)}const zi=ae()({tagName:"toniq-pagination",styles:f`
        :host {
            display: flex;
        }
    ...
    `,events:{pageChange:ie()},renderCallback({inputs:e,events:t,dispatch:r}){return e.pageCount<=1?c``:c`
                ...
                ${bv(e.currentPage,e.pageCount,e.pagesShown).map(n=>typeof n=="string"?c`
    ...
    `,stateInitStatic:{canScroll:!1,debouncedResize:b1(()=>Vh(cn.FirstThenWait,{milliseconds:30})),rowStyles:{},isPainting:!1,itemsPainted:0,pageCountKey:0},initCallback({inputs:e,state:t,updateState:r}){const n=e.columns.filter(o=>!o.disabled);r({rowStyles:n.reduce((o,i)=>(o[i.key]={width:void 0,left:void 0},o),t.rowStyles)})},renderCallback({inputs:e,state:t,updateState:r,events:n,dispatch:o}){var h;const i=e.columns.filter(m=>!m.disabled),a=[e.rows[0],...e.rows].filter(ve);function s(m){m instanceof HTMLElement&&t.debouncedResize(()=>{r({canScroll:m.scrollWidth>m.clientWidth})})}const l=e.pagination&&((h=e.pagination)==null?void 0:h.pageCount)>1?c`
                      <${zi.assign({currentPage:e.pagination.currentPage,pageCount:e.pagination.pageCount})}
                          ...
                          ${k(zi.events.pageChange,m=>{var g,v;r({pageCountKey:(g=e.pagination)!=null&&g.pageCount?(v=e.pagination)==null?void 0:v.pageCount:t.pageCountKey+1}),o(new n.pageChange(m.detail))})}
                      ></${zi}>
                  `:ee;function u(m,g){return c`
                <div
                    class="row-wrapper"
                    ${g>0?k("click",v=>{var $,x;(x=($=m.rowActions)==null?void 0:$.click)==null||x.call($,{clickEvent:v,dispatch:o})}):ee}
                >
                        ...
                        `;return c`
                            ...
                            >
                                <div
                                    ...
                                    ${da(ce=>{var ct,bt;const X=ce.closest(".table-list"),V=X==null?void 0:X.getBoundingClientRect().left,ne=X==null?void 0:X.querySelectorAll(".row-item")[$],Ce=ne==null?void 0:ne.getBoundingClientRect().left,be=ce.getBoundingClientRect().width;(!((ct=t.rowStyles[v.key])!=null&&ct.width)||be>((bt=t.rowStyles[v.key])==null?void 0:bt.width))&&r({rowStyles:{...t.rowStyles,[v.key]:{width:be,left:V?Ce-V:Ce}}}),r({itemsPainted:t.itemsPainted+1})})}
                                >
                                    ${x}
                                </div>
                                ${we(g===0,c`
        ...
        `}});async function yv(e){return navigator.clipboard.writeText(e)}const kv="…";function xv(e,t){const r=e.slice(0,t).trim(),n=e.slice(-1*t).trim();return`${r}${kv}${n}`}function $v(e){return!(e%1)}function Av(e){return e.letterCount==null?4:$v(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const D=ae()({tagName:"toniq-middle-ellipsis",events:{copy:ie()},cssVars:{"toniq-middle-ellipsis-text-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":b.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":b.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>f`
        :host {
            /* 5 frames at 60 fps */
            transition: ${K.interaction};
            ${O.paragraphFont};
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:r,state:n,updateState:o}){if(!e.text)return c``;const i=e.text,a=Av(e),s=!!e.externalLink,l=!!e.copyOnClick,u=i.length>a*2+2,p=u?xv(i,a):i,h=u?i:"",m=s?Fd:l?Rd:void 0,g=m?c`
                  <${y.assign({icon:m})}></${y}>
              `:"",v=c`
        ...
        `;return p?s?c`
                ...
                `:l?c`
                    <button
                        ...
                        ${k("click",async()=>{await yv(i),t(new r.copy),n.showCopiedTextTimeoutId!=null&&window.clearTimeout(n.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${v} ${g}
                    </button>
                `:c`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:lu()})},renderCallback({inputs:e,dispatch:t,events:r,state:n}){return Cv(e.entries).map(i=>Sv(e.groupName||n.randomGroupName,e.value,i,()=>{t(new r.valueChange(i.value))}))}});function Cv(e){const t=Object.fromEntries(e.map(n=>[n.value,n]));return Object.values(t).length!==e.length&&console.error(`${_.tagName} was given duplicate entry values.`),Object.values(t)}function Sv(e,t,r,n){const o=t===r.value,i=c`
...
`,Uc=f`
    transform: scale(1.2);
`;function Dv(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Qr(e){requestAnimationFrame(()=>{const t=fh(e.instanceInputs,e).elementValue;Ov(t,e)&&(e.setAttribute("disabled","true"),Qr(e))})}const j=ae()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ie()},styles:f`
        :host {
            display: block;
        }
                ...
                >
                    ...
                    <div class="slider-wrapper">
                        <input
                            ...
                            .max=${S.max}
                            .value=${C.min}
                            ${k("input",be=>{const ct=be.target,bt={...x,min:Ji(Number(ct.value),s,l)};v(bt)})}
                        />
                        <input
                            ?disabled=${e.disabled??!1}
                            type="range"
                            ...
                            .value=${C.max}
                            ${hr(Ur.slider)}
                            ${k("input",be=>{const ct=be.target,bt={...x,max:Ji(Number(ct.value),s,l)};v(bt)})}
                        />
                    </div>
                </div>
            `}function v(x){i({internalValue:x}),e.disabled||n(new r.valueChange(x))}function $(x,C,S){const N=Wt((m-Ut)*(S.max-C)/(S.max-S.min)+Ut/2),F=Ki(x,u,l),J=Qi({value:C,limits:S,flip:!1});return c`
                <div
                ...
                >
                    ...
                    <input
                        ?disabled=${e.disabled??!1}
                        type="range"
                        class="${B.slider} ${e.colorTemperature?Dv(Math.abs(J)):""}"
                        step=${e.step}
                        .min=${S.min}
                        .max=${S.max}
                        .value=${C}
                        ${hr(Ur.slider)}
                        ${k("input",ce=>{const X=ce.target,V=Ji(Number(X.value),s,l);v(V)})}
                    />
                </div>
    ...
    `,renderCallback({inputs:e}){return c`
            <${y.assign({icon:e.icon})}></${y}>
        `}}),ii=Object.values(it).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),Nv=Object.keys(ii).sort();function Ms(e){return{controlType:H.Dropdown,initValue:e,options:["None",...Nv]}}const wh={"CSS color":{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Number,initValue:2}};function go(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),te(n,"number")&&(n=ja({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
`)}const Rv=U({title:"Social Urls",parent:gh,elementExamplesCallback({defineExample:e}){function t({socialName:r,icon:n}){e({title:r,renderCallback(){return c`
                        <${Fo.assign({icon:n})}></${Fo}>
                    `}})}Object.entries(o0).forEach(([r,n])=>{t({socialName:r,icon:n})})}}),re=U({title:"Elements",parent:void 0}),Fv=U({parent:re,title:rn.tagName,elementExamplesCallback({defineExample:e}){[{name:"danger",inputs:{variant:tn.Danger},slot:c`<strong>Alert!</strong>This is an alert, Please be very careful!`},{name:"warning",inputs:{variant:tn.Warning},slot:"This is a warning, proceed with caution 🚧"},{name:"success",inputs:{variant:tn.Success},slot:"You have successfully completed your task!"}].forEach(r=>{e({title:r.name,stateInitStatic:{},styles:f`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
                ...
                `,renderCallback(){return c`
                    ...
                    `}})})}}),jv=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:f`
            ${Yt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],Hv=U({title:Yt.tagName,parent:re,elementExamplesCallback({defineExample:e}){jv.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:f`
                    .bold {
                        ${O.boldFont}
                    }
...
`,Wv=U({parent:re,title:ye.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:_i,renderCallback(){return c`
                ...
                `;return c`
                    ...
                    <${ye.assign({enableAutomaticCycling:!1,offsetArrows:!0,variant:ho.Banner,templates:it["core-24"].map(r=>c`
                            ...
                            `)})}></${ye}>
                `}})}});function Vv(e){const t=Object.keys(e.cssVars).map(r=>[`--${r}`,{controlType:H.Color,initValue:""}]);return Object.fromEntries(t)}function zv(e){const t=Object.entries(e).map(([r,n])=>{if(r.startsWith("--"))return typeof n!="string"||!n?void 0:`${r}: ${n};`}).filter(ve);return T(t.join(`
`))}const Zv=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],ea=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],Gv=U({parent:re,title:yt.tagName,controls:{Text:{controlType:H.Text,initValue:"Text"},...Vv(yt)},elementExamplesCallback({defineExample:e}){Zv.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:ea.map(r=>!!r.inputs.checked),extraEntryStatuses:ea.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:f`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return ea.map((i,a)=>{const s=(i.extraEntries??[]).map((u,p)=>{var h;return c`
                        ...
                        `})}})})}}),Yv=U({parent:re,title:qi.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Et}},{inputs:{icon:Et}},{inputs:{},template:c`
                    HTML child
        ...
        `},{customStyle:f`
            max-height: 30px;
            min-height: 30px;
        `}],Jv=U({title:_n.tagName,parent:re,controls:{Selected:{controlType:H.Dropdown,initValue:to[0].label,options:to.map(e=>e.label)},Direction:{controlType:H.Dropdown,initValue:"Down",options:nu(Pa)},Icon:Ms(Od.name),Prefix:{controlType:H.Text,initValue:"Sort by: "},"Force open":{controlType:H.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){Kv.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Wc.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:f`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Wc.map((i,a)=>{const s=f`
                        ...
                        `;return c`
                            ...
                            ></${_n}>
                        `})}})})}}),Xv=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],_v=U({title:Wi.tagName,parent:re,elementExamplesCallback({defineExample:e}){Xv.forEach(t=>{e({title:t.title,renderCallback(){return c`
                        <${Wi}>${t.content}</${Wi}>
                    `}})})}}),Vc="/toniq-labs-design-system";function vh(...e){const r=[globalThis.location.pathname.startsWith(Vc)?Vc:"",...e].filter(ve);return dn(...r)}const cr=Array(30).fill(vh("/toniq-labs-logo.png")),gr=["Hello there.","There is stuff here."],ro=gr.concat(Array(30).fill(gr)),e5=U({title:oe.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${oe.assign({infoParagraphs:ro,imageUrls:cr,socialUrls:D2,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${oe}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${oe.assign({imageUrls:cr.map((t,r)=>r%2?"/invalid-image.png":t),infoParagraphs:gr,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return c`
                            ...
                            `}})}></${oe}>
                `}})}}),t5=U({title:Gt.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:f`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:r}){return c`
                ...
                `}})}}),r5=U({title:Ie.tagName,parent:re,elementExamplesCallback({defineExample:e}){ou(fr).forEach(t=>{e({title:t,renderCallback(){return c`
            ...
            `,renderCallback({controls:r}){return c`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),c`
                            ...
                            ></${eo}>
                        `))}})})}});function ai({entries:e,columns:t,createRowObject:r}){const n=Object.fromEntries(t.map(i=>[i.key,""]));return{rows:e.map((i,a)=>{const s=r(i,a);if(!at(Object.keys(n).sort(),Object.keys(s.cells).sort()))throw console.error("broken list table row",{cells:s.cells,columns:n}),new Error("List table row keys does not match expect column keys.");return s}),columns:t}}const bh="https://cdn-bitcoin.bioniq.io",a5=dn(bh,"content"),s5=dn(bh,"thumbnail"),wr={thumbnail(e){return dn(s5,e)},content(e){return dn(a5,e)}},l5=Array(5).fill({imageUrl:wr.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${f`
                display: flex;
                gap: 8px;
    ...
    `}),c5=[{imageUrl:wr.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Payment Sent",price:c`
            <div
                style=${f`
                    display: flex;
                    gap: 8px;
        ...
        `}],u5=[],d5=Array(5).fill({imageUrl:wr.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${f`
                display: flex;
                gap: 8px;
    ...
    `}),ta=ai({entries:l5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE",mobile:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${f`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),zc=ai({entries:c5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${f`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),h5=ai({entries:u5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${f`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),f5=ai({entries:d5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME",style:f`
                display: flex;
                justify-content: flex-end;
            `}],createRowObject:e=>({cells:{image:c`
                    <img
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),p5=[{title:"basic"},{title:"with pagination",inputs:{pagination:{currentPage:1,pageCount:10}}},{title:"squished horizontally",styles:f`
            :host {
                width: 200px;
            }
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Zc=ws({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const r=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(r)}})}},cleanupCallback({state:e,updateState:t}){var r;(r=e.cleanup)==null||r.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),m5=U({title:Re.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return c`
            ...
            `,stateInitStatic:{tableInputs:{...ta,rows:ta.rows.map(t=>({...t,cells:{...t.cells,date:c`
                ...
                `}})}}),g5=U({title:an.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:on.Small}},{title:"large",inputs:{size:on.Large}},{title:"whole page",inputs:{size:on.WholePage},styles:f`
                    :host {
                        width: 500px;
                    }
                `}].forEach(r=>{e({title:r.title,styles:r.styles??f``,renderCallback(){return c`
                        <${an.assign(r.inputs)}></${an}>
                    `}})})}}),w5=U({title:D.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return c`
            ...
            `,renderCallback(){return c`
                ...
                `}})}}),v5=U({title:Hr.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:f`
                ${Hr} {
                    height: 32px;
                }
...
`,ra={min:10,max:50},y5=U({title:j.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:f`
                ${nt}
            `,renderCallback({state:t,updateState:r}){return c`
            ...
            `,renderCallback({state:t,updateState:r}){return c`
                    <${j.assign({value:t.value,colorTemperature:!0,min:0,max:100})}
                        ${k(j.events.valueChange,n=>{if(typeof n.detail!="number")throw new Error("was expecting a single numeric slider value");r({value:n.detail})})}
                    ></${j}>
                `}})}}),k5=[{title:"default",inputs:{}},{title:"right icon",inputs:{iconPlacement:mh.Right}},{title:"text only",inputs:{variant:ph.TextOnly}},{title:"disabled",inputs:{disabled:!0}}],Gc=[{inputs:{icon:void 0}},{inputs:{toggled:!0}},{inputs:{}},{inputs:{text:void 0}}],x5=U({title:Xi.tagName,parent:re,controls:{Text:{controlType:H.Text,initValue:"Toggle Button"},Icon:Ms(Hd.name)},elementExamplesCallback({defineExample:e}){k5.forEach(t=>{e({title:t.title,stateInitStatic:{buttonStates:Gc.map(r=>!!r.inputs.toggled)},styles:f`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Gc.map((i,a)=>c`
                            ...
                            ></${Xi}>
                        `)}})})}}),$5=U({parent:re,title:mo.tagName,elementExamplesCallback({defineExample:e}){function t({title:r,tooltipContent:n,forceShow:o}){e({title:r,styles:f`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),A5=U({parent:re,title:ln.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${mo.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return c`
                    <${ln}>This is a tooltip.</${ln}>
                `}})}}),C5=[$5,A5],S5=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:f`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:f``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:f``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:Ca},{label:"label here",value:2,icon:Ca},{label:"",value:3,icon:Et,disabled:!0},{label:"16px icon",value:4,icon:Et},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],T5=U({title:Kr.tagName,parent:re,elementExamplesCallback({defineExample:e}){S5.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:f`
                ...
                `,renderCallback({state:r,updateState:n}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return c`
                        ...
                        ></${Kr}>
                    `}})})}}),yh=U({title:"Icons",parent:void 0,controls:wh}),M5=Object.entries(it).map(([e,t])=>U({title:e,parent:yh,elementExamplesCallback({defineExample:r}){t.map(n=>r({title:n.name,renderCallback({controls:o}){return c`
                                <${Fo.assign({icon:n})}
                                    style=${go(o)}
                                ></${Fo}>
                            `}}))}}));function kh(e){const t=E5(e),r=xe(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return le(r).reduce((o,i)=>{const a=r[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function E5(e){typeof e!="string"&&(e=String(e));const n=`{"${Jc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const si=U({title:"Styles",parent:void 0}),I5=f`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function B5(e,t,r){const n=kh(R(r));return e({title:t,styles:I5,renderCallback(){return c`
            ...
            `}})}const q5=U({title:"Colors",parent:si,elementExamplesCallback({defineExample:e}){le(b).map(t=>B5(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),L5=f`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function P5(e,t,r){const n=kh(r);return e({title:t,styles:L5,renderCallback(){return c`
            ...
            `}})}const O5=U({title:"Fonts",parent:si,elementExamplesCallback({defineExample:e}){le(O).map(t=>{const r=O[t];return P5(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),D5=U({title:"Shadows",parent:si,elementExamplesCallback({defineExample:e}){Ih(kn).forEach(([t,r])=>{e({title:t,styles:f`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return c`
                            <div></div>
                        `}})})}}),N5=[re,yh,si,gh],R5=[...M5,...C5,Rv,Hv,Fv,Uv,Wv,Gv,Yv,q5,Qv,Jv,_v,e5,t5,O5,r5,n5,o5,i5,g5,w5,v5,b5,D5,y5,x5,T5,m5].sort((e,t)=>e.title.localeCompare(t.title)),F5=[...N5,...R5];Go({tagName:"toniq-design-system-app",styles:f`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return c`
            <${Mi.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:F5,themeColor:"#00D093"})}>
