...
`,u2=v({name:"CryptoIcp16Icon",svgTemplate:c`
    ...
    `}),it={"core-16":[Pd,Zm,Gm,Ym,Et,Qm,Km],"core-24":[Jm,Xm,fs,_m,eg,ps,Od,tg,rg,ng,og,ig,ag,sg,lg,ms,Dd,cg,ug,Nd,dg,hg,fg,pg,mg,Rd,gg,wg,vg,bg,yg,Fd,kg,xg,$g,Ag,Cg,Sg,Tg,Ca,jd,Mg,Eg,Ig,Bg,qg,Lg,gs,Pg,Og,Dg,Ng,Rg,Fg,jg,Hg,Ug,Hd,Ud,Wg,Vg,zg,Zg,Gg,Yg,Qg,so,Kg,Jg,Wd,Xg,_g,Vd],"core-48":[e2,zd,t2,r2,n2,o2],"core-64":[Zd,i2,a2],cryptocurrencies:[s2,Xo,l2,c2,u2,d2],"external-wallets":[h2,f2,p2,m2,g2,w2,v2,b2,y2,k2,x2,$2],"third-party-brands":[Qd,Kd,Jd,A2,C2,S2,Xd,T2,_d,M2,e0,t0,E2,r0,n0],toniq:[I2,B2]},q2=Sn({discord:rt(void 0,""),distrikt:rt(void 0,""),dscvr:rt(void 0,""),instagram:rt(void 0,""),medium:rt(void 0,""),telegram:rt(void 0,""),tikTok:rt(void 0,""),twitch:rt(void 0,""),twitter:rt(void 0,""),website:rt(void 0,"")}),L2=q2.defaultValue,o0={discord:Qd,instagram:Xd,telegram:e0,tikTok:t0,distrikt:Kd,twitch:r0,dscvr:Jd,medium:_d,twitter:n0,website:Wd},Jl="toniq-",{defineElement:ae,defineElementNoInputs:ws}=ns({assertInputs:e=>{if(!e.tagName.startsWith(Jl))throw new Error(`Tag name should start with '${Jl}' but got '${e.tagName}'`)}}),y=ae()({tagName:"toniq-icon",styles:f`
        :host {
            display: flex;
...
`,Uc=f`
    transform: scale(1.2);
`;function Lv(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Qr(e){requestAnimationFrame(()=>{const t=fh(e.instanceInputs,e).elementValue;qv(t,e)&&(e.setAttribute("disabled","true"),Qr(e))})}const F=ae()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ie()},styles:f`
        :host {
            display: block;
        }
    ...
    `,renderCallback({inputs:e}){return c`
            <${y.assign({icon:e.icon})}></${y}>
        `}}),oi=Object.values(it).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),Pv=Object.keys(oi).sort();function Ms(e){return{controlType:H.Dropdown,initValue:e,options:["None",...Pv]}}const wh={"CSS color":{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Number,initValue:2}};function mo(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),te(n,"number")&&(n=ja({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
`)}const Ov=U({title:"Social Urls",parent:gh,elementExamplesCallback({defineExample:e}){function t({socialName:r,icon:n}){e({title:r,renderCallback(){return c`
                        <${Ro.assign({icon:n})}></${Ro}>
                    `}})}Object.entries(o0).forEach(([r,n])=>{t({socialName:r,icon:n})})}}),re=U({title:"Elements",parent:void 0}),Dv=U({parent:re,title:Ii.tagName,elementExamplesCallback({defineExample:e}){[{name:"danger",inputs:{variant:lo.Danger},slot:c`<strong>Alert!</strong>This is an alert, Please be very careful!`},{name:"warning",inputs:{variant:lo.Warning},slot:"This is a warning, proceed with caution 🚧"},{name:"success",inputs:{variant:lo.Success},slot:"You have successfully completed your task!"}].forEach(r=>{e({title:r.name,stateInitStatic:{},styles:f`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
...
`))}const Wv=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],ea=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],Vv=U({parent:re,title:yt.tagName,controls:{Text:{controlType:H.Text,initValue:"Text"},...Hv(yt)},elementExamplesCallback({defineExample:e}){Wv.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:ea.map(r=>!!r.inputs.checked),extraEntryStatuses:ea.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:f`
                ...
                `,inputs:{text:"custom size"}}];[{title:"default",inputs:{variant:Zr.Default}},{title:"secondary style",inputs:{variant:Zr.Secondary}},{title:"warning style",inputs:{variant:Zr.Warning}},{title:"danger style",inputs:{variant:Zr.Danger}}].forEach(n=>{e({title:n.title,renderCallback(){return t.map(o=>c`
                    ...
                    `}})})}}),_n=[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3},{label:"Really really super duper long option",value:4}],Gv=[{title:"default"},{title:"transparent background",customStyle:f`
        ...
        `}],Yv=U({title:Jn.tagName,parent:re,controls:{Selected:{controlType:H.Dropdown,initValue:_n[0].label,options:_n.map(e=>e.label)},Direction:{controlType:H.Dropdown,initValue:"Down",options:nu(Pa)},Icon:Ms(Od.name),Prefix:{controlType:H.Text,initValue:"Sort by: "},"Force open":{controlType:H.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){Gv.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Wc.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:f`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Wc.map((i,a)=>{const s=f`
                        ...
                        <${Wi}>${t.content}</${Wi}>
                    `}})})}}),Vc="/toniq-labs-design-system";function vh(...e){const r=[globalThis.location.pathname.startsWith(Vc)?Vc:"",...e].filter(ve);return cn(...r)}const cr=Array(30).fill(vh("/toniq-labs-logo.png")),mr=["Hello there.","There is stuff here."],eo=mr.concat(Array(30).fill(mr)),Jv=U({title:oe.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${oe.assign({infoParagraphs:eo,imageUrls:cr,socialUrls:L2,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${oe}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:r}){return c`
                ...
                `}})}}),_v=U({title:Ie.tagName,parent:re,elementExamplesCallback({defineExample:e}){ou(hr).forEach(t=>{e({title:t,renderCallback(){return c`
            ...
            `,renderCallback({controls:r}){return c`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),c`
                            ...
                            ></${Xn}>
                        `))}})})}});function ii({entries:e,columns:t,createRowObject:r}){const n=Object.fromEntries(t.map(i=>[i.key,""]));return{rows:e.map((i,a)=>{const s=r(i,a);if(!at(Object.keys(n).sort(),Object.keys(s.cells).sort()))throw console.error("broken list table row",{cells:s.cells,columns:n}),new Error("List table row keys does not match expect column keys.");return s}),columns:t}}const bh="https://cdn-bitcoin.bioniq.io",n5=cn(bh,"content"),o5=cn(bh,"thumbnail"),gr={thumbnail(e){return cn(o5,e)},content(e){return cn(n5,e)}},i5=Array(5).fill({imageUrl:gr.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${f`
                display: flex;
                gap: 8px;
    ...
    `}),a5=[{imageUrl:gr.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Payment Sent",price:c`
            <div
                style=${f`
                    display: flex;
                    gap: 8px;
        ...
        `}],s5=[],l5=Array(5).fill({imageUrl:gr.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${f`
                display: flex;
                gap: 8px;
    ...
    `}),ta=ii({entries:i5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE",mobile:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${f`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),zc=ii({entries:a5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${f`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),c5=ii({entries:s5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${f`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),u5=ii({entries:l5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME",style:f`
                display: flex;
                justify-content: flex-end;
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Zc=ws({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const r=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(r)}})}},cleanupCallback({state:e,updateState:t}){var r;(r=e.cleanup)==null||r.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),h5=U({title:Re.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return c`
            ...
            `,stateInitStatic:{tableInputs:{...ta,rows:ta.rows.map(t=>({...t,cells:{...t.cells,date:c`
                ...
                `}})}}),f5=U({title:nn.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:rn.Small}},{title:"large",inputs:{size:rn.Large}},{title:"whole page",inputs:{size:rn.WholePage},styles:f`
                    :host {
                        width: 500px;
                    }
            ...
            `,renderCallback(){return c`
                ...
                `}})}}),m5=U({title:jr.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:f`
                ${jr} {
                    height: 32px;
                }
...
`,ra={min:10,max:50},w5=U({title:F.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:f`
                ${nt}
            `,renderCallback({state:t,updateState:r}){return c`
            ...
            `,renderCallback({state:t,updateState:r}){return c`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Gc.map((i,a)=>c`
                            ...
                            ></${Xi}>
                        `)}})})}}),y5=U({parent:re,title:po.tagName,elementExamplesCallback({defineExample:e}){function t({title:r,tooltipContent:n,forceShow:o}){e({title:r,styles:f`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),k5=U({parent:re,title:an.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${po.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return c`
...
`;function M5(e,t,r){const n=kh(j(r));return e({title:t,styles:T5,renderCallback(){return c`
            ...
            `}})}const E5=U({title:"Colors",parent:ai,elementExamplesCallback({defineExample:e}){le(b).map(t=>M5(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),I5=f`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function B5(e,t,r){const n=kh(r);return e({title:t,styles:I5,renderCallback(){return c`
            ...
            `}})}const q5=U({title:"Fonts",parent:ai,elementExamplesCallback({defineExample:e}){le(O).map(t=>{const r=O[t];return B5(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),L5=U({title:"Shadows",parent:ai,elementExamplesCallback({defineExample:e}){Ih(bn).forEach(([t,r])=>{e({title:t,styles:f`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return c`
                            <div></div>
                        `}})})}}),P5=[re,yh,ai,gh],O5=[...C5,...x5,Ov,Rv,Dv,Fv,jv,Vv,zv,E5,Zv,Yv,Kv,Jv,Xv,q5,_v,e5,t5,r5,f5,p5,m5,g5,L5,w5,b5,A5,h5].sort((e,t)=>e.title.localeCompare(t.title)),D5=[...P5,...O5];Zo({tagName:"toniq-design-system-app",styles:f`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return c`
            <${Ti.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:D5,themeColor:"#00D093"})}>
