...
`,ld=v({name:"LoaderAnimated24Icon",svgTemplate:u`
    ...
    `,events:{routeChange:ee()},renderCallback({inputs:e,dispatch:t,events:r}){var o,i;function n(a){e.route&&Bo(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new r.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return u`
            ...
            `}}});const{defineElement:ze,defineElementNoInputs:F5}=Da(),De=ze()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>p`
        a {
            box-sizing: border-box;
            display: block;
...
`))}const R=(()=>{const e=p`
    ...
    `}),Tp=v({name:"Tag48Icon",svgTemplate:u`
        <svg
            width="48"
            height="48"
            viewBox="0 0 48 48"
    ...
    `}),Sp=v({name:"CircleDashes64Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Cp=v({name:"Rocket64Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Mp=v({name:"CryptoBtc16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Ap=v({name:"CryptoBtc24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
...
`,Lp=v({name:"CryptoIcp16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Np=v({name:"BrandGoogleLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),Op=v({name:"BrandIcScan24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),Bp=v({name:"BrandInstagramFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),Dp=v({name:"BrandNftgeek24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),Rp=v({name:"BrandTiktokFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${Z["toniq-icon-fill-color"]("#000")}
    ...
    `}),_p=v({name:"BioniqRobot100Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),yt={"core-16":[vm,bm,Ct],"core-24":[ym,km,Wa,$m,xm,Ua,fd,Tm,Sm,Cm,Mm,Am,Em,Im,Lm,md,pd,qm,Pm,gd,Nm,Om,Bm,Dm,wd,Rm,_m,Hm,Fm,Vm,vd,jm,Zm,zm,Wm,Um,oa,Gm,Ym,Jm,Km,Xm,Qm,ep,Ga,tp,rp,np,op,ip,ap,sp,lp,bd,yd,cp,up,dp,hp,gp,wp,Jn,vp,bp,xd,yp,kp],"core-48":[$p,Td,xp,Tp],"core-64":[Sd,Sp,Cp],cryptocurrencies:[Mp,Ap,Ep,Ip,Lp,qp],"third-party-brands":[Ad,Ed,Id,Pp,Np,Op,Ld,Bp,qd,Dp,Pd,Nd,Rp,Od,Bd],toniq:[_p,Hp]},Fp=pn({discord:tt(void 0,""),distrikt:tt(void 0,""),dscvr:tt(void 0,""),instagram:tt(void 0,""),medium:tt(void 0,""),telegram:tt(void 0,""),tikTok:tt(void 0,""),twitch:tt(void 0,""),twitter:tt(void 0,""),website:tt(void 0,"")}),Vp=Fp.defaultValue,Dd={discord:Ad,instagram:Ld,telegram:Pd,tikTok:Nd,distrikt:Ed,twitch:Od,dscvr:Id,medium:qd,twitter:Bd,website:xd},ql="toniq-",{defineElement:te,defineElementNoInputs:Rd}=Da({assertInputs:e=>{if(!e.tagName.startsWith(ql))throw new Error(`Tag name should start with '${ql}' but got '${e.tagName}'`)}}),zt=te()({tagName:"toniq-bold-space",styles:p`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,renderCallback:({inputs:e})=>u`
        ...
        `});async function Sw(e){return navigator.clipboard.writeText(e)}const Cw="…";function Mw(e,t){const r=e.slice(0,t).trim(),n=e.slice(-1*t).trim();return`${r}${Cw}${n}`}function Aw(e){return!(e%1)}function Ew(e){return e.letterCount==null?4:Aw(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const we=te()({tagName:"toniq-middle-ellipsis",events:{copy:ee()},cssVars:{"toniq-middle-ellipsis-text-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":b.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":b.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>p`
        :host {
            /* 5 frames at 60 fps */
            transition: ${X.interaction};
            ${R.paragraphFont};
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:r,state:n,updateState:o}){if(!e.text)return u``;const i=e.text,a=Ew(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,f=c?Mw(i,a):i,h=c?i:"",m=s?vd:l?wd:void 0,g=m?u`
                  <${T.assign({icon:m})}></${T}>
              `:"",w=u`
        ...
        `;return f?s?u`
                ...
                `:l?u`
                    <button
                        ...
                        ${S("click",async()=>{await Sw(i),t(new r.copy),n.showCopiedTextTimeoutId!=null&&window.clearTimeout(n.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${w} ${g}
                    </button>
                `:u`
                    ${w}
                `:u``}}),bc="...";function Iw(e,t,r=7,n=5){let o;e=dr({value:e,min:1,max:t}),r=dr({value:r,min:n,max:t});const i=r-5,a=r-3;t<=r?o=r:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>r?Ii(t-o,t):e>o?Ii(Math.min(s.start,t-o),Math.min(s.end,t)):Ii(1,Math.min(t,o+1));function c(h,m){return l.length+1!==t?m:[h]}const f=l[l.length-1];if(f&&f<t){const h=c(t,[bc,t]);return[...l,...h]}else return l[0]!==1?c(1,[1,bc]).concat(l):l}function Ii(e,t){const r=t-e+1;return Array.from({length:r},(n,o)=>e+o)}te()({tagName:"toniq-pagination",styles:p`
        :host {
            display: flex;
        }
    ...
    `,events:{pageChange:ee()},renderCallback({inputs:e,events:t,dispatch:r}){return e.pageCount<=1?u``:u`
                ...
                ${Iw(e.currentPage,e.pageCount,e.pagesShown).map(n=>typeof n=="string"?u`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:Vc()})},renderCallback({inputs:e,dispatch:t,events:r,state:n}){return Lw(e.entries).map(i=>qw(e.groupName||n.randomGroupName,e.value,i,()=>{t(new r.valueChange(i.value))}))}});function Lw(e){const t=Object.fromEntries(e.map(n=>[n.value,n]));return Object.values(t).length!==e.length&&console.error(`${Y.tagName} was given duplicate entry values.`),Object.values(t)}function qw(e,t,r,n){const o=t===r.value,i=u`
    ...
    `}function Li(e,t){const r=e[0],n=e[e.length-1];if(r==null||n==null)return 0;if(t<r)return r;if(t>n)return n;const o=e.findIndex((c,f)=>{const h=e[f+1];return h==null?!0:c<=t&&h>=t});if(o<0)return r;const i=e[o];if(i==null)return r;const a=e[o+1];if(a==null)return i;const s=t-i,l=a-t;return s<l?o:o+1}function Pw(e,t,r=100){e>t&&([e,t]=[t,e]),r<2&&(r=2);let n=Nw(e);const o=[e];for(;n<t;){const i=Math.pow(10,String(n).length-1),a=n+i;a<t&&o.push(a),n=a}return o.push(t),o.length>r&&(yc(o,r),o.length>r&&yc(o,r)),o}function yc(e,t){const r=e.length-t,n=(e.length-2)/r;for(let o=e.length-2;o>=1;o-=n)e.splice(Math.floor(o),1)}function Nw(e){let t=1;if(!e)return e;e<0&&(t=-1,e=e*-1);const r=e.toFixed(0),n=Math.pow(10,r.length-1),o=Number(r[0]||1);return n*o*t}const P={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},Or={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"};function Ow(e){var n,o;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${P.lowerLabelWrapper} .${P.labelPercentMarginWrapper}`),r=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${P.upperLabelWrapper} .${P.labelPercentMarginWrapper}`);if(r instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),a=r.getBoundingClientRect();return{lower:i,upper:a}}else return}function Bw(e,t=8){const r=Ow(e);if(!r)return 0;const n=r.lower.right-r.upper.left+t;return Math.max(0,n)}function qi({value:e,limits:t,flip:r}){const o=(t.max-e)/(t.max-t.min)*100;return-(r?100-o:o)}function un(e){return je(e)&&e.min!==void 0&&e.max!==void 0}function ba(e){var r;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${P.range}`);return(t==null?void 0:t.clientWidth)??0}function Pi(e,t,r){return`${r?Hh(e):e} ${t}`}function Dw({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function Rw({value:e,double:t,min:r,max:n}){return t?un(e)?{min:dr({value:e.min,min:r,max:Math.min(e.max,n)}),max:dr({value:e.max,min:Math.max(e.min,r),max:n})}:{min:r,max:n}:un(e)?r:dr({value:e,min:r,max:n})}function _w({actualValue:e,actualLimits:t,logScale:r,logRange:n}){return r?{elementValue:un(e)?{min:Li(n,e.min),max:Li(n,e.max)}:Li(n,e),elementLimits:{min:0,max:n.length-1}}:{elementValue:e,elementLimits:t}}function Ni(e,t,r){return r?t[e]||0:e}function Hw(e){return{actualLimits:Dw(e),actualValue:Rw(e)}}function Fw(e,t){var n,o,i;let r=!1;if(un(e)){const a=(n=t.shadowRoot)==null?void 0:n.querySelector(`.${P.lowerSlider}`),s=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${P.upperSlider}`);a instanceof HTMLInputElement&&s instanceof HTMLInputElement&&(Number(a.value)!==e.min&&(a.value=String(e.min),r=!0),Number(s.value)!==e.max&&(s.value=String(e.max),r=!0))}else{const a=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${P.slider}`);a instanceof HTMLInputElement&&Number(a.value)!==e&&(a.value=String(e),r=!0)}return r}function z0(e,t){const{actualValue:r,actualLimits:n}=Hw({...e}),o=Pw(n.min,n.max),i=e.logScale??!1,a=e.suffix??"",{elementValue:s,elementLimits:l}=_w({actualValue:r,actualLimits:n,logScale:i,logRange:o}),c=ba(t);return{actualValue:r,elementLimits:l,elementValue:s,isLogScale:i,logRange:o,rangeWidth:c,suffix:a}}const _t=16,kc=p`
    ${_t}px
`,$c=p`
...
`,xc=p`
    transform: scale(1.2);
`;function Vr(e){requestAnimationFrame(()=>{const t=z0(e.instanceInputs,e).elementValue;Fw(t,e)&&(e.setAttribute("disabled","true"),Vr(e))})}const F=te()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ee()},styles:p`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Vr(e)}),e.addEventListener("keydown",()=>{Vr(e)}),e.addEventListener("keyup",()=>{Vr(e)})},renderCallback({inputs:e,host:t,events:r,dispatch:n,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:f,elementLimits:h,rangeWidth:m}=z0({...e},t);if(Vr(t),un(f))return g(a,f,h);return $(a,f,h);function g(k,x,C){const D={left:Ht((m-_t)*(x.min-C.min)/(C.max-C.min)+_t/2),right:Ht((m-_t)*(C.max-x.max)/(C.max-C.min)+_t/2)},U=Pi(k.min,c,l),se=Pi(k.max,c,l);requestAnimationFrame(()=>{const $e=Bw(t);$e!==o.labelOverlap&&i({labelOverlap:$e})});const fe=(C.max-x.max)/(C.max-C.min)>.5,de=qi({value:x.min,limits:{min:C.min,max:x.max},flip:!0}),W=qi({value:x.max,limits:{min:x.min,max:C.max},flip:!1}),le=o.labelOverlap&&fe?o.labelOverlap:0,We=o.labelOverlap&&!fe?o.labelOverlap:0;return u`
                <div
                    class="range"
    ...
    `,renderCallback({inputs:e}){return u`
            <${T.assign({icon:e.icon})}></${T}>
        `}}),Wo=Object.values(yt).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),Vw=Object.keys(Wo).sort();function as(e){return{controlType:O.Dropdown,initValue:e,options:["None",...Vw]}}const G0={"CSS color":{controlType:O.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:O.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:O.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:O.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:O.Number,initValue:2}};function ro(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),J(n,"number")&&(n=ka({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
`)}const jw=_({title:"Social Urls",parent:U0,elementExamplesCallback({defineExample:e}){function t({socialName:r,icon:n}){e({title:r,renderCallback(){return u`
                        <${Mo.assign({icon:n})}></${Mo}>
        ...
        `}],zw=_({title:zt.tagName,parent:re,elementExamplesCallback({defineExample:e}){Zw.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:p`
                    .bold {
                        ${R.boldFont}
                    }
                ...
                `,renderCallback({state:r,updateState:n}){return u`
                        ...
                        ></${zt}>
                        More text
                    `}})})}}),Ww=_({parent:re,title:he.tagName,elementExamplesCallback({defineExample:e}){[{name:"default",inputs:{}},{name:"Secondary",inputs:{variant:$o.Secondary}},{name:"Outline",inputs:{variant:$o.Outline}},{name:"Disabled",inputs:{disabled:!0}}].forEach(r=>{e({title:r.name,stateInitStatic:{showIcon:!1,timeoutId:void 0},styles:p`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
...
`,Uw=_({parent:re,title:Ae.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:Tc,renderCallback(){return u`
                ...
                `;return u`
                    ...
                    ></${Ae}>
                `}})}});function Gw(e){const t=Object.keys(e.cssVars).map(r=>[`--${r}`,{controlType:O.Color,initValue:""}]);return Object.fromEntries(t)}function Yw(e){const t=Object.entries(e).map(([r,n])=>{if(r.startsWith("--"))return typeof n!="string"||!n?void 0:`${r}: ${n};`}).filter(be);return N(t.join(`
`))}const Jw=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],Bi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],Kw=_({parent:re,title:gt.tagName,controls:{Text:{controlType:O.Text,initValue:"Text"},...Gw(gt)},elementExamplesCallback({defineExample:e}){Jw.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:Bi.map(r=>!!r.inputs.checked),extraEntryStatuses:Bi.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:p`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Bi.map((i,a)=>{const s=(i.extraEntries??[]).map((c,f)=>{var h;return u`
                        ...
                        `})}})})}}),Xw=_({parent:re,title:wi.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Ct}},{inputs:{icon:Ct}},{inputs:{},template:u`
                    HTML child
        ...
        `},{customStyle:p`
            max-height: 30px;
            min-height: 30px;
        `}],t5=_({title:Hn.tagName,parent:re,controls:{Selected:{controlType:O.Dropdown,initValue:Vn[0].label,options:Vn.map(e=>e.label)},Direction:{controlType:O.Dropdown,initValue:"Down",options:Dc(pa)},Icon:as(fd.name),Prefix:{controlType:O.Text,initValue:"Sort by: "},"Force open":{controlType:O.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){e5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Sc.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:p`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Sc.map((i,a)=>{const s=p`
                        ...
                        `;return u`
                            ...
                            ></${Hn}>
                        `})}})})}}),r5=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],n5=_({title:Ai.tagName,parent:re,elementExamplesCallback({defineExample:e}){r5.forEach(t=>{e({title:t.title,renderCallback(){return u`
                        <${Ai}>${t.content}</${Ai}>
                    `}})})}}),Cc="/toniq-labs-design-system";function Y0(...e){const r=[globalThis.location.pathname.startsWith(Cc)?Cc:"",...e].filter(be);return Oh(...r)}const ir=Array(30).fill(Y0("/toniq-labs-logo.png")),ur=["Hello there.","There is stuff here."],jn=ur.concat(Array(30).fill(ur)),o5=_({title:K.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${K.assign({infoParagraphs:jn,imageUrls:ir,socialUrls:Vp,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${K}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${K.assign({imageUrls:ir.map((t,r)=>r%2?"/invalid-image.png":t),infoParagraphs:ur,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return u`
                            ...
                            `}})}></${K}>
                `}})}}),i5=_({title:Zt.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:p`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:r}){return u`
                ...
                `}})}}),a5=_({title:Me.tagName,parent:re,elementExamplesCallback({defineExample:e}){Rc(lr).forEach(t=>{e({title:t,renderCallback(){return u`
            ...
            `,renderCallback({controls:r}){return u`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            ...
                            ></${Fn}>
                        `))}})})}}),u5=_({title:Ei.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:eo.Small}},{title:"large",inputs:{size:eo.Large}},{title:"whole page",inputs:{size:eo.WholePage},styles:p`
                    :host {
                        width: 500px;
                    }
                `}].forEach(r=>{e({title:r.title,styles:r.styles??p``,renderCallback(){return u`
                        <${Ei.assign(r.inputs)}></${Ei}>
                    `}})})}}),d5=_({title:we.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
            ...
            `,renderCallback(){return u`
                ...
                `}})}}),h5=_({title:Nr.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:p`
                ${Nr} {
                    height: 32px;
                }
...
`,Di={min:10,max:50},m5=_({title:F.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:p`
                ${st}
            `,renderCallback({state:t,updateState:r}){return u`
            ...
            `,renderCallback({state:t,updateState:r}){return u`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Mc.map((i,a)=>u`
                            ...
                            ></${Oi}>
                        `)}})})}}),w5=_({parent:re,title:to.tagName,elementExamplesCallback({defineExample:e}){function t({title:r,tooltipContent:n,forceShow:o}){e({title:r,styles:p`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),v5=_({parent:re,title:Yr.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${to.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return u`
                    <${Yr}>This is a tooltip.</${Yr}>
                `}})}}),b5=[w5,v5],y5=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:p`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:p``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:p``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:oa},{label:"label here",value:2,icon:oa},{label:"",value:3,icon:Ct,disabled:!0},{label:"16px icon",value:4,icon:Ct},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],k5=_({title:jr.tagName,parent:re,elementExamplesCallback({defineExample:e}){y5.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:p`
                ...
                `,renderCallback({state:r,updateState:n}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return u`
                        ...
                        ></${jr}>
                    `}})})}}),J0=_({title:"Icons",parent:void 0,controls:G0}),$5=Object.entries(yt).map(([e,t])=>_({title:e,parent:J0,elementExamplesCallback({defineExample:r}){t.map(n=>r({title:n.name,renderCallback({controls:o}){return u`
                                <${Mo.assign({icon:n})}
                                    style=${ro(o)}
                                ></${Mo}>
                            `}}))}}));function K0(e){const t=x5(e),r=ge(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return oe(r).reduce((o,i)=>{const a=r[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function x5(e){typeof e!="string"&&(e=String(e));const n=`{"${Lc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const Uo=_({title:"Styles",parent:void 0}),T5=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function S5(e,t,r){const n=K0(j(r));return e({title:t,styles:T5,renderCallback(){return u`
            ...
            `}})}const C5=_({title:"Colors",parent:Uo,elementExamplesCallback({defineExample:e}){oe(b).map(t=>S5(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),M5=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function A5(e,t,r){const n=K0(r);return e({title:t,styles:M5,renderCallback(){return u`
            ...
            `}})}const E5=_({title:"Fonts",parent:Uo,elementExamplesCallback({defineExample:e}){oe(R).map(t=>{const r=R[t];return A5(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),I5=_({title:"Shadows",parent:Uo,elementExamplesCallback({defineExample:e}){ah(ln).forEach(([t,r])=>{e({title:t,styles:p`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return u`
                            <div></div>
                        `}})})}}),L5=[re,J0,Uo,U0],q5=[...$5,...b5,jw,zw,Ww,Uw,Kw,Xw,C5,Qw,t5,n5,o5,i5,E5,a5,s5,l5,c5,u5,d5,h5,f5,I5,m5,g5,k5].sort((e,t)=>e.title.localeCompare(t.title)),P5=[...L5,...q5];Oo({tagName:"toniq-design-system-app",styles:p`
        :host {
            display: block;
            height: 100%;
            width: 100%;
