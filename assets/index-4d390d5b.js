...
`,Bd=v({name:"LoaderAnimated24Icon",svgTemplate:c`
    ...
    `,events:{routeChange:ie()},renderCallback({inputs:e,dispatch:t,events:n}){var o,i;function r(a){e.route&&_o(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new n.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return c`
            ...
            `}}});const{defineElement:Ge,defineElementNoInputs:fb}=ss(),Fe=Ge()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>h`
        a {
            box-sizing: border-box;
            display: block;
...
`))}const O=(()=>{const e=h`
    ...
    `}),jg=v({name:"Gear24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Hg=v({name:"Geometry24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Ug=v({name:"Gift24Icon",svgTemplate:c`
        <svg
            width="25"
            height="24"
            viewBox="0 0 25 24"
    ...
    `}),Wg=v({name:"GridDots24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Vg=v({name:"Heart24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Gg=v({name:"Lifebuoy24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Yg=v({name:"List24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Kg=v({name:"Loader24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Jg=v({name:"Lock24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Xg=v({name:"LockOpen24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),_g=v({name:"Menu24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),e2=v({name:"Pamphlet24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),t2=v({name:"Paper24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),n2=v({name:"People24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),r2=v({name:"Person24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),o2=v({name:"Photo24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),i2=v({name:"Refresh24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),a2=v({name:"Send24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),s2=v({name:"ShootingStar24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),l2=v({name:"ShoppingCart24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),c2=v({name:"Social24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),u2=v({name:"Square24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),d2=v({name:"SquareCheck24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),h2=v({name:"Tag24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),f2=v({name:"Upload24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),p2=v({name:"UploadCloud24",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),m2=v({name:"Wallet24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),g2=v({name:"WorldUpload24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),w2=v({name:"X24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),v2=v({name:"Fire48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),b2=v({name:"Folder48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),y2=v({name:"Kyc48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),k2=v({name:"Rocket48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),x2=v({name:"Sunrise48Icon",svgTemplate:c`
        <svg
            width="48"
            height="48"
            viewBox="0 0 48 48"
    ...
    `}),$2=v({name:"Tag48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${d["toniq-icon-fill-color"].value}
            stroke=${d["toniq-icon-stroke-color"].value}
    ...
    `}),A2=v({name:"Trophy48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),C2=v({name:"Wallet48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${d["toniq-icon-fill-color"].value}
            stroke=${d["toniq-icon-stroke-color"].value}
    ...
    `}),S2=v({name:"CircleDashes64Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),T2=v({name:"Rocket64Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),M2=v({name:"CryptoBtc16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),E2=v({name:"CryptoCkBtc16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),I2=v({name:"CryptoCkBtc24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
...
`,q2=v({name:"CryptoIcp16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),B2=v({name:"CryptoIcp24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),L2=v({name:"WalletBitfinity24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),P2=v({name:"WalletBitfinity64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),O2=v({name:"WalletLeather24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),D2=v({name:"WalletLeather64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),N2=v({name:"WalletPlug24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),R2=v({name:"WalletPlug64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),F2=v({name:"WalletStoic24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),j2=v({name:"WalletStoic64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),H2=v({name:"WalletUnisat24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),U2=v({name:"WalletUnisat64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),W2=v({name:"WalletXverse24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),V2=v({name:"WalletXverse64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),G2=v({name:"BrandIcScan24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),Y2=v({name:"BrandInstagramFlat24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),Q2=v({name:"BrandNftgeek24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),K2=v({name:"BrandTiktokFlat24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${Y["toniq-icon-fill-color"]("#000")}
    ...
    `}),J2=v({name:"BioniqRobot100Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),X2=v({name:"EntrepotLogo144Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),at={"core-16":[rg,Fd,sg,lg,cg,qt,ug,dg],"core-24":[hg,fg,ws,pg,mg,vs,jd,gg,wg,vg,bg,yg,kg,xg,$g,Ag,bs,Hd,Cg,Sg,Ud,Tg,Mg,Eg,Ig,qg,Wd,Bg,Lg,Pg,Og,Dg,Vd,Ng,Rg,Fg,jg,Hg,Ug,Wg,Vg,Ea,zd,zg,Zg,Gg,Yg,Qg,Kg,ys,Jg,Xg,_g,e2,t2,n2,r2,o2,i2,Zd,Gd,a2,s2,l2,c2,u2,d2,h2,fo,f2,p2,m2,Yd,g2,w2,Qd],"core-48":[v2,b2,Kd,y2,k2,x2,$2,A2,C2],"core-64":[Jd,S2,T2],cryptocurrencies:[M2,gt,E2,I2,q2,B2],"external-wallets":[L2,P2,O2,D2,N2,R2,F2,j2,H2,U2,W2,V2],"third-party-brands":[e0,t0,n0,z2,Z2,G2,r0,Y2,o0,Q2,i0,a0,K2,s0,l0],toniq:[J2,X2]},_2=Ir({discord:rt(void 0,""),distrikt:rt(void 0,""),dscvr:rt(void 0,""),instagram:rt(void 0,""),medium:rt(void 0,""),telegram:rt(void 0,""),tikTok:rt(void 0,""),twitch:rt(void 0,""),twitter:rt(void 0,""),website:rt(void 0,"")}),ew=_2.defaultValue,c0={discord:e0,instagram:r0,telegram:i0,tikTok:a0,distrikt:t0,twitch:s0,dscvr:n0,medium:o0,twitter:l0,website:Yd},tc="toniq-",{defineElement:ae,defineElementNoInputs:ks}=ss({assertInputs:e=>{if(!e.tagName.startsWith(tc))throw new Error(`Tag name should start with '${tc}' but got '${e.tagName}'`)}}),y=ae()({tagName:"toniq-icon",styles:h`
        :host {
            display: flex;
    ...
    `,renderCallback:({inputs:e})=>c`
        ...
        `}),Uc="...";function Nv(e,t,n=7,r=5){let o;e=yn({value:e,min:1,max:t}),n=yn({value:n,min:r,max:t});const i=n-5,a=n-3;t<=n?o=n:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>n?Yi(t-o,t):e>o?Yi(Math.min(s.start,t-o),Math.min(s.end,t)):Yi(1,Math.min(t,o+1));function u(f,m){return l.length+1!==t?m:[f]}const p=l[l.length-1];if(p&&p<t){const f=u(t,[Uc,t]);return[...l,...f]}else return l[0]!==1?u(1,[1,Uc]).concat(l):l}function Yi(e,t){const n=t-e+1;return Array.from({length:n},(r,o)=>e+o)}const Qi=ae()({tagName:"toniq-pagination",styles:h`
        :host {
            display: flex;
        }
    ...
    `,stateInitStatic:{canScroll:!1,debouncedResize:L1(()=>Jh(hr.FirstThenWait,{milliseconds:30})),rowStyles:{},isPainting:!1,isStillPainting:!0,pageCountKey:0,tableListLeft:0},initCallback({inputs:e,state:t,updateState:n}){const r=e.columns.filter(o=>!o.disabled);n({rowStyles:r.reduce((o,i)=>(o[i.key]={width:void 0,left:void 0},o),t.rowStyles)})},renderCallback({inputs:e,state:t,updateState:n,events:r,dispatch:o,host:i}){var m;const a=e.columns.filter(g=>!g.disabled),s=[e.rows[0],...e.rows].filter(ke);function l(g){g instanceof HTMLElement&&setTimeout(()=>{t.debouncedResize(()=>{n({canScroll:g.scrollWidth>g.clientWidth,tableListLeft:g.getBoundingClientRect().left})})},0)}const u=e.pagination&&((m=e.pagination)==null?void 0:m.pageCount)>1?c`
        ...
        `}});async function Rv(e){return navigator.clipboard.writeText(e)}const Fv="…";function jv(e,t){const n=e.slice(0,t).trim(),r=e.slice(-1*t).trim();return`${n}${Fv}${r}`}function Hv(e){return!(e%1)}function Uv(e){return e.letterCount==null?4:Hv(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const T=ae()({tagName:"toniq-middle-ellipsis",events:{copy:ie()},cssVars:{"toniq-middle-ellipsis-text-color":w.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":w.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":w.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":w.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>h`
        :host {
            /* 5 frames at 60 fps */
            transition: ${oe.interaction};
            ${O.paragraphFont};
        ...
        `;return p?s?c`
                ...
                `:l?c`
                    <button
                        ...
                        ${k("click",async()=>{await Rv(i),t(new n.copy),r.showCopiedTextTimeoutId!=null&&window.clearTimeout(r.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${b} ${g}
                    </button>
                `:c`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:hu()})},renderCallback({inputs:e,dispatch:t,events:n,state:r}){return Wv(e.entries).map(i=>Vv(e.groupName||r.randomGroupName,e.value,i,()=>{t(new n.valueChange(i.value))}))}});function Wv(e){const t=Object.fromEntries(e.map(r=>[r.value,r]));return Object.values(t).length!==e.length&&console.error(`${X.tagName} was given duplicate entry values.`),Object.values(t)}function Vv(e,t,n,r){const o=t===n.value,i=c`
    ...
    `}function Xi(e,t){const n=e[0],r=e[e.length-1];if(n==null||r==null)return 0;if(t<n)return n;if(t>r)return r;const o=e.findIndex((u,p)=>{const f=e[p+1];return f==null?!0:u<=t&&f>=t});if(o<0)return n;const i=e[o];if(i==null)return n;const a=e[o+1];if(a==null)return i;const s=t-i,l=a-t;return s<l?o:o+1}function zv(e,t,n=100){e>t&&([e,t]=[t,e]),n<2&&(n=2);let r=Zv(e);const o=[e];for(;r<t;){const i=Math.pow(10,String(r).length-1),a=r+i;a<t&&o.push(a),r=a}return o.push(t),o.length>n&&(Wc(o,n),o.length>n&&Wc(o,n)),o}function Wc(e,t){const n=e.length-t,r=(e.length-2)/n;for(let o=e.length-2;o>=1;o-=r)e.splice(Math.floor(o),1)}function Zv(e){let t=1;if(!e)return e;e<0&&(t=-1,e=e*-1);const n=e.toFixed(0),r=Math.pow(10,n.length-1),o=Number(n[0]||1);return r*o*t}const B={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},zn={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"},ur={hot:"rgb(200,0,0)",medium:"orange",cold:"rgb(0,200,0)"};function hn(e){return h`
        background-color: ${M(ur[e])};
        color: ${M(ur[e])};
    `}function Gv(e){var r,o;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${B.lowerLabelWrapper} .${B.labelPercentMarginWrapper}`),n=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${B.upperLabelWrapper} .${B.labelPercentMarginWrapper}`);if(n instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),a=n.getBoundingClientRect();return{lower:i,upper:a}}else return}function Yv(e,t=8){const n=Gv(e);if(!n)return 0;const r=n.lower.right-n.upper.left+t;return Math.max(0,r)}function _i({value:e,limits:t,flip:n}){const o=(t.max-e)/(t.max-t.min)*100;return-(n?100-o:o)}function Sr(e){return ze(e)&&e.min!==void 0&&e.max!==void 0}function Ua(e){var n;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${B.range}`);return(t==null?void 0:t.clientWidth)??0}function ea(e,t,n){return`${n?vf(e):e} ${t}`}function Qv({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function Kv({value:e,double:t,min:n,max:r}){return t?Sr(e)?{min:yn({value:e.min,min:n,max:Math.min(e.max,r)}),max:yn({value:e.max,min:Math.max(e.min,n),max:r})}:{min:n,max:r}:Sr(e)?n:yn({value:e,min:n,max:r})}function Jv({actualValue:e,actualLimits:t,logScale:n,logRange:r}){return n?{elementValue:Sr(e)?{min:Xi(r,e.min),max:Xi(r,e.max)}:Xi(r,e),elementLimits:{min:0,max:r.length-1}}:{elementValue:e,elementLimits:t}}function ta(e,t,n){return n?t[e]||0:e}function Xv(e){return{actualLimits:Qv(e),actualValue:Kv(e)}}function _v(e,t){var r,o,i;let n=!1;if(Sr(e)){const a=(r=t.shadowRoot)==null?void 0:r.querySelector(`.${B.lowerSlider}`),s=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${B.upperSlider}`);a instanceof HTMLInputElement&&s instanceof HTMLInputElement&&(Number(a.value)!==e.min&&(a.value=String(e.min),n=!0),Number(s.value)!==e.max&&(s.value=String(e.max),n=!0))}else{const a=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${B.slider}`);a instanceof HTMLInputElement&&Number(a.value)!==e&&(a.value=String(e),n=!0)}return n}function bh(e,t){const{actualValue:n,actualLimits:r}=Xv({...e}),o=zv(r.min,r.max),i=e.logScale??!1,a=e.suffix??"",{elementValue:s,elementLimits:l}=Jv({actualValue:n,actualLimits:r,logScale:i,logRange:o}),u=Ua(t);return{actualValue:n,elementLimits:l,elementValue:s,isLogScale:i,logRange:o,rangeWidth:u,suffix:a}}const Wt=16,Vc=h`
    ${Wt}px
`,zc=h`
...
`,Zc=h`
    transform: scale(1.2);
`;function e5(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Xn(e){requestAnimationFrame(()=>{const t=bh(e.instanceInputs,e).elementValue;_v(t,e)&&(e.setAttribute("disabled","true"),Xn(e))})}const j=ae()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ie()},styles:h`
        :host {
            display: block;
        }
            ...
            `}function b($){i({internalValue:$}),e.disabled||r(new n.valueChange($))}function x($,A,S){const D=Vt((m-Wt)*(S.max-A)/(S.max-S.min)+Wt/2),R=ea($,u,l),G=_i({value:A,limits:S,flip:!1});return c`
                ...
                >
                    ...
                    <input
                        ?disabled=${e.disabled??!1}
                        type="range"
                        class="${B.slider} ${e.colorTemperature?e5(Math.abs(G)):""}"
                        step=${e.step}
                        .min=${S.min}
                        .max=${S.max}
                        .value=${A}
    ...
    `,renderCallback({inputs:e}){return c`
            <${y.assign({icon:e.icon})}></${y}>
        `}}),ci=Object.values(at).reduce((e,t)=>(t.forEach(n=>{if(n.name in e)throw new Error(`Icon name duplicate: '${n.name}'`);e[n.name]=n}),e),{}),t5=Object.keys(ci).sort();function Bs(e){return{controlType:H.Dropdown,initValue:e,options:["None",...t5]}}const Ah={"CSS color":{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Number,initValue:2}};function bo(e){return Object.entries(e).filter(([,n])=>n!==""&&n!=null).map(([n,r])=>(n.toLowerCase()==="css color"&&(n="color"),ee(r,"number")&&(r=Va({value:r,suffix:"px"})),`${n}: ${r};`)).join(`
`)}const n5=U({title:"Social Urls",parent:$h,elementExamplesCallback({defineExample:e}){function t({socialName:n,icon:r}){e({title:n,renderCallback(){return c`
                        <${Vo.assign({icon:r})}></${Vo}>
                    `}})}Object.entries(c0).forEach(([n,r])=>{t({socialName:n,icon:r})})}}),te=U({title:"Elements",parent:void 0}),r5=U({parent:te,title:ar.tagName,elementExamplesCallback({defineExample:e}){[{name:"danger",inputs:{variant:ir.Danger},slot:c`<strong>Alert!</strong>This is an alert, Please be very careful!`},{name:"warning",inputs:{variant:ir.Warning},slot:"This is a warning, proceed with caution 🚧"},{name:"success",inputs:{variant:ir.Success},slot:"You have successfully completed your task!"}].forEach(n=>{e({title:n.name,stateInitStatic:{},styles:h`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
                ...
                `,renderCallback(){return c`
                    ...
                    `}})})}}),o5=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:h`
            ${Qt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],i5=U({title:Qt.tagName,parent:te,elementExamplesCallback({defineExample:e}){o5.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:h`
                    .bold {
                        ${O.boldFont}
                    }
...
`,s5=U({parent:te,title:ve.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:ra,renderCallback(){return c`
                ...
                `;return c`
                    ...
                    <${ve.assign({enableAutomaticCycling:!1,offsetArrows:!0,variant:mo.Banner,templates:at["core-24"].map(n=>c`
                            ...
                            `)})}></${ve}>
                `}})}});function l5(e){const t=Object.keys(e.cssVars).map(n=>[`--${n}`,{controlType:H.Color,initValue:""}]);return Object.fromEntries(t)}function c5(e){const t=Object.entries(e).map(([n,r])=>{if(n.startsWith("--"))return typeof r!="string"||!r?void 0:`${n}: ${r};`}).filter(ke);return M(t.join(`
`))}const u5=[{title:"default",inputs:{}},{title:"button",inputs:{variant:f0.Button}},{title:"disabled",inputs:{disabled:!0}}],oa=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],d5=U({parent:te,title:kt.tagName,controls:{Text:{controlType:H.Text,initValue:"Text"},...l5(kt)},elementExamplesCallback({defineExample:e}){u5.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:oa.map(n=>!!n.inputs.checked),extraEntryStatuses:oa.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:h`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return oa.map((i,a)=>{const s=(i.extraEntries??[]).map((u,p)=>{var f;return c`
                        ...
                        `})}})})}}),h5=U({parent:te,title:Di.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:qt}},{inputs:{icon:qt}},{inputs:{},template:c`
                    HTML child
                ...
                `,inputs:{text:"custom size"}}];[{title:"default",inputs:{variant:mn.Default}},{title:"secondary style",inputs:{variant:mn.Secondary}},{title:"warning style",inputs:{variant:mn.Warning}},{title:"danger style",inputs:{variant:mn.Danger}},{title:"outline style",inputs:{variant:mn.Outline}}].forEach(r=>{e({title:r.title,renderCallback(){return t.map(o=>c`
                    ...
                    `}})})}}),oo=[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3},{label:"Really really super duper long option",value:4}],p5=[{title:"default"},{title:"transparent background",customStyle:h`
        ...
        `},{customStyle:h`
            max-height: 30px;
            min-height: 30px;
        `}],m5=U({title:no.tagName,parent:te,controls:{Selected:{controlType:H.Dropdown,initValue:oo[0].label,options:oo.map(e=>e.label)},Direction:{controlType:H.Dropdown,initValue:"Down",options:su(Ra)},Icon:Bs(jd.name),Prefix:{controlType:H.Text,initValue:"Sort by: "},"Force open":{controlType:H.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){p5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Gc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:h`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Gc.map((i,a)=>{const s=h`
                        ...
                        `;return c`
                            ...
                            ></${no}>
                        `})}})})}}),g5=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],w5=U({title:Gi.tagName,parent:te,elementExamplesCallback({defineExample:e}){g5.forEach(t=>{e({title:t.title,renderCallback(){return c`
                        <${Gi}>${t.content}</${Gi}>
                    `}})})}}),Yc="/toniq-labs-design-system";function Ch(...e){const n=[globalThis.location.pathname.startsWith(Yc)?Yc:"",...e].filter(ke);return pr(...n)}const fn=Array(30).fill(Ch("/toniq-labs-logo.png")),bn=["Hello there.","There is stuff here."],io=bn.concat(Array(30).fill(bn)),v5=U({title:re.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${re.assign({infoParagraphs:io,imageUrls:fn,socialUrls:ew,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${re}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${re.assign({imageUrls:fn.map((t,n)=>n%2?"/invalid-image.png":t),infoParagraphs:bn,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return c`
                            ...
                            `}})}></${re}>
                `}})}}),b5=U({title:Yt.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:h`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:n}){return c`
                ...
                `}})}}),y5=U({title:qe.tagName,parent:te,elementExamplesCallback({defineExample:e}){lu(wn).forEach(t=>{e({title:t,renderCallback(){return c`
            ...
            `,renderCallback(){return c`
                ...
                `}})}}),k5=U({parent:te,title:Je.tagName,elementExamplesCallback({defineExample:e}){[{title:"default",inputs:{linkType:wt.ReplacePage}},{title:"new tab",inputs:{linkType:wt.NewTab}},{title:"hover styles",inputs:{withHoverStyles:!0,linkType:wt.NewTab}},{title:"route link",inputs:{linkType:wt.RouteLink}},{title:"link disabled",inputs:{linkType:wt.Disabled}}].forEach(n=>{e({title:n.title,descriptionParagraphs:n.descriptions,renderCallback(){return c`
                    ...
                    `}})})}}),x5=U({title:y.tagName,parent:te,controls:Ah,elementExamplesCallback({defineExample:e}){const t=[{icon:Jd},{icon:Kd},{icon:Ud},{icon:qt},{icon:void 0}];e({title:"sizes",styles:h`
                :host {
                    display: flex;
                    gap: 16px;
                    align-items: center;
            ...
            `,renderCallback({controls:n}){return c`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),c`
                            ...
                            ></${ro}>
                        `))}})})}}),Sh="https://cdn-bitcoin.bioniq.io",A5=pr(Sh,"content"),C5=pr(Sh,"thumbnail"),_e={thumbnail(e){return pr(C5,e)},content(e){return pr(A5,e)}},S5=[{imageUrl:_e.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
            <div
                style=${h`
                    display: flex;
                    gap: 8px;
        ...
        `}],T5=Array(50).fill({imageUrl:_e.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${h`
                display: flex;
                gap: 8px;
    ...
    `}),M5=[{imageUrl:_e.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Payment Sent",price:c`
            <div
                style=${h`
                    display: flex;
                    gap: 8px;
        ...
        `}],E5=[],I5=Array(5).fill({imageUrl:_e.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${h`
                display: flex;
                gap: 8px;
    ...
    `}),ia=Rr({entries:S5,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"price",title:"PRICE",option:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${h`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),q5=Rr({entries:T5,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"price",title:"PRICE LONG COLUMN NAME",option:{sticky:!0,spaceEvenly:!0}},{key:"from",title:"FROM",option:{spaceEvenly:!0}},{key:"to",title:"TO",option:{spaceEvenly:!0},style:h`
                width: 100%;
                display: flex;
                justify-content: flex-end;
            `}],createRowObject:e=>({cells:{image:c`
                ...
                `},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),Qc=Rr({entries:M5,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"type",title:"TYPE",option:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),B5=Rr({entries:E5,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"type",title:"TYPE",option:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${h`
                            width: 24px;
                            height: auto;
            ...
            `}],createRowObject:e=>({cells:{image:c`
                    <img
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),P5=[{title:"basic"},{title:"with pagination",inputs:{pagination:{currentPage:1,pageCount:10}}},{title:"squished horizontally",styles:h`
            :host {
                width: 200px;
            }
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Kc=ks({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const n=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(n)}})}},cleanupCallback({state:e,updateState:t}){var n;(n=e.cleanup)==null||n.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),O5=U({title:xe.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return c`
            ...
            `,renderCallback(){return c`
                    <${xe.assign({...q5,pagination:{currentPage:1,pageCount:5},nonBlocking:!0})}></${xe}>
                `}})}}),D5=U({title:cr.tagName,parent:te,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:lr.Small}},{title:"large",inputs:{size:lr.Large}},{title:"whole page",inputs:{size:lr.WholePage},styles:h`
                    :host {
                        width: 500px;
                    }
                `}].forEach(n=>{e({title:n.title,styles:n.styles??h``,renderCallback(){return c`
                        <${cr.assign(n.inputs)}></${cr}>
                    `}})})}}),N5=U({title:T.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return c`
            ...
            `,renderCallback(){return c`
                ...
                `}})}}),R5=U({title:Vn.tagName,parent:te,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:h`
                ${Vn} {
                    height: 32px;
                }
...
`,aa={min:10,max:50},j5=U({title:j.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:h`
                ${ot}
            `,renderCallback({state:t,updateState:n}){return c`
            ...
            `,renderCallback({state:t,updateState:n}){return c`
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Jc.map((i,a)=>c`
                            ...
                            ></${na}>
                        `)}})})}}),W5=U({parent:te,title:vo.tagName,elementExamplesCallback({defineExample:e}){function t({title:n,tooltipContent:r,forceShow:o}){e({title:n,styles:h`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!1}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!1})}}),V5=U({parent:te,title:dr.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${vo.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return c`
                    <${dr}>This is a tooltip.</${dr}>
                `}})}}),z5=[W5,V5],Z5=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:h`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:h``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:h``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:Ea},{label:"label here",value:2,icon:Ea},{label:"",value:3,icon:qt,disabled:!0},{label:"16px icon",value:4,icon:qt},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}},{title:"no bottom border",inputs:{value:"hi",tabs:["hi","bye","hello","so long"],variant:xh.Minimal}}],G5=U({title:_n.tagName,parent:te,elementExamplesCallback({defineExample:e}){Z5.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:h`
                ...
                `,renderCallback({state:n,updateState:r}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return c`
                        ...
                        ></${_n}>
                    `}})})}}),Th=U({title:"Icons",parent:void 0,controls:Ah}),Y5=Object.entries(at).map(([e,t])=>U({title:e,parent:Th,elementExamplesCallback({defineExample:n}){t.map(r=>n({title:r.name,renderCallback({controls:o}){return c`
                                <${Vo.assign({icon:r})}
                                    style=${bo(o)}
                                ></${Vo}>
                            `}}))}}));function Mh(e){const t=Q5(e),n=ye(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return ce(n).reduce((o,i)=>{const a=n[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function Q5(e){typeof e!="string"&&(e=String(e));const r=`{"${tu(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(r);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${r}`),o}}const ui=U({title:"Styles",parent:void 0}),K5=h`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function J5(e,t,n){const r=Mh(F(n));return e({title:t,styles:K5,renderCallback(){return c`
            ...
            `}})}const X5=U({title:"Colors",parent:ui,elementExamplesCallback({defineExample:e}){ce(w).map(t=>J5(e,t,w[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),_5=h`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function eb(e,t,n){const r=Mh(n);return e({title:t,styles:_5,renderCallback(){return c`
            ...
            `}})}const tb=U({title:"Fonts",parent:ui,elementExamplesCallback({defineExample:e}){ce(O).map(t=>{const n=O[t];return eb(e,t,n)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),nb=U({title:"Shadows",parent:ui,elementExamplesCallback({defineExample:e}){Nh(Ar).forEach(([t,n])=>{e({title:t,styles:h`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return c`
                            <div></div>
                        `}})})}}),rb=[te,Th,ui,$h],ob=[...Y5,...z5,n5,i5,r5,a5,s5,d5,h5,X5,f5,m5,w5,v5,b5,tb,y5,k5,x5,$5,D5,N5,R5,F5,nb,j5,U5,G5,O5].sort((e,t)=>e.title.localeCompare(t.title)),ib=[...rb,...ob];Xo({tagName:"toniq-design-system-app",styles:h`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return c`
            <${Bi.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:ib,themeColor:"#00D093"})}>
