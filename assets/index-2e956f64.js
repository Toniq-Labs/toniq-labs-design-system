...
`,Xu=v({name:"LoaderAnimated24Icon",svgTemplate:u`
    ...
    `,events:{routeChange:K()},renderCallback({inputs:e,dispatch:t,events:n}){var o,i;function r(a){e.route&&ko(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new n.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return u`
            ...
            `}}});const{defineElement:Ve,defineElementNoInputs:d4}=Ca(),Be=Ve()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>m`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `}),rm=v({name:"Bell24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),im=v({name:"BuildingStore24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),am=v({name:"CalendarEvent24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),sm=v({name:"Cash24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),cm=v({name:"ChevronUp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),um=v({name:"Circle24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),dm=v({name:"CirclePlus24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),hm=v({name:"CircleWavyCheck24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),fm=v({name:"Clock24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),mm=v({name:"CreateFile24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),pm=v({name:"DotsVertical24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),vm=v({name:"Filter24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),bm=v({name:"Gear24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),$m=v({name:"Heart24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Tm=v({name:"LayersLinked24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Sm=v({name:"LayoutGrid24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Cm=v({name:"Lifebuoy24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Mm=v({name:"List24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Em=v({name:"Loader24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Im=v({name:"Lock24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Lm=v({name:"LockOpen24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),qm=v({name:"Menu24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Nm=v({name:"Paper24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Pm=v({name:"People24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Dm=v({name:"Photo24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Om=v({name:"Refresh24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Rm=v({name:"Send24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),_m=v({name:"ShoppingCart24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Hm=v({name:"Social24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Fm=v({name:"Square24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),bl={interactionDuration:m`--toniq-interaction-transition-duration`,prettyDuration:m`--toniq-pretty-transition-duration`},X={interaction:m`var(${bl.interactionDuration}, 84ms)`,pretty:m`var(${bl.prettyDuration}, 300ms)`};function Qo(e){return{foregroundColor:e.backgroundColor,backgroundColor:e.foregroundColor}}const Vm=(()=>{const e={backgroundColor:m`#ffffff`,foregroundColor:m`#000000`},t={...e,foregroundColor:m`#00D093`},n={...e,foregroundColor:m`#ACADAD`},r={...e,foregroundColor:m`#D6D6D6`},o={...t},i={...t,foregroundColor:m`#00A876`},a={...t,foregroundColor:m`#1D6852`},s={...r},l={...e,foregroundColor:m`#EAFBF7`},c={...e,backgroundColor:m`#D2EEFA`},d=Qo(o),f=Qo(i),p=Qo(a),g=p,w={backgroundColor:m`#F1F3F6`,foregroundColor:e.foregroundColor},$={...w,foregroundColor:m`#9A9A9D`};return{brandPrimary:t,pagePrimary:e,pageSecondary:n,pageTertiary:r,pageInteraction:o,pageInteractionHover:i,pageInteractionActive:a,divider:s,dividerFaint:l,dropShadow:c,pageDarkPrimary:g,accentPrimary:d,accentPrimaryHover:f,accentPrimaryActive:p,accentSecondary:w,accentTertiary:$}})(),dd=Vm;function yl(e,t){return P(`--toniq-${Gr(e)}-${Gr(t)}`)}const Oa=ve(dd,e=>({backgroundColor:yl(e,"backgroundColor"),foregroundColor:yl(e,"foregroundColor")}));function Ge(e,t){const n=dd[e][t],r=Oa[e][t];return m`var(${r}, ${n})`}const b=ve(Oa,e=>({foregroundColor:Ge(e,"foregroundColor"),backgroundColor:Ge(e,"backgroundColor")}));function F(e){return m`
...
`))}const Y=(()=>{const e=m`
    ...
    `,menuShadow:m`
        ...
        */
        will-change: filter;
    `};function Zm(e,t=!0){const n=P(e),r=e===":host"?m`
                  :host(:hover);
              `:m`
                  ${n}:hover
              `,o=t?m`
        ...
        ${o}
    `}const jm=v({name:"SquareCheck24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Wm=v({name:"Upload24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Gm=v({name:"WorldUpload24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Ym=v({name:"X24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Xm=v({name:"Kyc48Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Km=v({name:"CircleDashes64Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),ep=v({name:"CryptoBtc16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),tp=v({name:"CryptoBtc24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),rp=v({name:"CryptoCkBtc24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
...
`,op=v({name:"CryptoIcp16Icon",svgTemplate:u`
    ...
    `}),sp=v({name:"BrandGoogleLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),lp=v({name:"BrandIcScan24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),cp=v({name:"BrandInstagramFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),up=v({name:"BrandNftgeek24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),vt={"core-16":[Y2,J2,Tt],"core-24":[X2,K2,Pa,Q2,em,Ba,nd,tm,nm,rm,om,im,am,sm,lm,rd,od,cm,um,id,dm,hm,fm,ad,sd,mm,pm,gm,wm,ld,vm,bm,ym,km,$m,zi,xm,Tm,Sm,Cm,Mm,Am,Em,Da,Im,Lm,qm,Nm,Pm,Bm,Dm,Om,cd,ud,Rm,_m,Hm,Fm,jm,Fr,Wm,Um,Gm,Ym],"core-48":[Jm,fd,Xm],"core-64":[md,Km,Qm],cryptocurrencies:[ep,tp,np,rp,op,ip],"third-party-brands":[wd,vd,bd,ap,sp,lp,yd,cp,kd,up,$d,xd,dp,Td,Sd],toniq:[hp,fp]},mp=sr({discord:Qe(void 0,""),distrikt:Qe(void 0,""),dscvr:Qe(void 0,""),instagram:Qe(void 0,""),medium:Qe(void 0,""),telegram:Qe(void 0,""),tikTok:Qe(void 0,""),twitch:Qe(void 0,""),twitter:Qe(void 0,""),website:Qe(void 0,"")}),pp=mp.defaultValue,Cd={discord:wd,instagram:yd,telegram:$d,tikTok:xd,distrikt:vd,twitch:Td,dscvr:bd,medium:kd,twitter:Sd,website:ad},kl="toniq-",{defineElement:ne,defineElementNoInputs:gp}=Ca({assertInputs:e=>{if(!e.tagName.startsWith(kl))throw new Error(`Tag name should start with '${kl}' but got '${e.tagName}'`)}}),Vt=ne()({tagName:"toniq-bold-space",styles:m`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,renderCallback({inputs:e}){const t=e.icon?u`
        ...
        `}});function wp(e,t,n={behavior:"smooth"}){let r=2;const o=t==="up"||t==="down"?"y":"x",i=t==="right"||t==="down"?"+":"-",a=o==="x"?e.scrollWidth-e.offsetWidth:e.scrollHeight-e.offsetHeight,s=Ra(e)[o];i==="-"&&(r*=-1);const l=e[o==="x"?"scrollLeft":"scrollTop"]+r,c=s.filter(f=>i==="+"?f>l:f<l).sort((f,p)=>i==="+"?f-p:p-f);let d;return c.length>0?d=c[0]:i==="+"?d=a:d=0,e.scrollTo({...n,[o==="x"?"left":"top"]:d})}function vp(e){const t=window.getComputedStyle(e),n=e.getBoundingClientRect();let r=t.getPropertyValue("scroll-padding-left").replace("auto","0px"),o=t.getPropertyValue("scroll-padding-top").replace("auto","0px"),i=t.getPropertyValue("scroll-padding-right").replace("auto","0px"),a=t.getPropertyValue("scroll-padding-bottom").replace("auto","0px");function s(p,g){let w=parseFloat(p);return/%/.test(p)&&(w/=100,w*=g),w}let l=s(r,n.width),c=s(o,n.height),d=s(i,n.width),f=s(a,n.height);return{x:{before:l,after:d},y:{before:c,after:f}}}function bp(e,t,n="both"){return n==="x"&&e.right>=t.left&&e.left<=t.right||n==="y"&&e.bottom>=t.top&&e.top<=t.bottom||n==="both"&&e.right>=t.left&&e.left<=t.right&&e.bottom>=t.top&&e.top<=t.bottom}function Md(e){let t=[];for(const n of e.children)t=t.concat(n,Md(n));return t}function yp(e,t=!0){const n=e.getBoundingClientRect(),r={x:{start:[],center:[],end:[]},y:{start:[],center:[],end:[]}},o=Md(e);for(const i of["x","y"]){const a=i==="x"?"y":"x",s=i==="x"?"left":"top",l=i==="x"?"width":"height",c=i==="x"?"scrollLeft":"scrollTop";for(const d of o){const f=d.getBoundingClientRect();if(t&&!bp(n,f,a))continue;const p=window.getComputedStyle(d);let[g,w]=p.getPropertyValue("scroll-snap-align").split(" ");typeof w>"u"&&(w=g);const $=i==="x"?w:g,k=f[s]-n[s]+e[c];switch($){case"none":break;case"start":r[i].start.push(k);break;case"center":r[i].center.push(k+f[l]/2);break;case"end":r[i].end.push(k+f[l]);break}}}return r}function Ra(e){const t=e.getBoundingClientRect(),n=vp(e),r=yp(e),o={x:e.scrollWidth-e.offsetWidth,y:e.scrollHeight-e.offsetHeight},i=(a,s)=>l=>Math.max(a,Math.min(s,l));return{x:$l([...r.x.start.map(a=>a-n.x.before),...r.x.center.map(a=>a-t.width/2),...r.x.end.map(a=>a-t.width+n.x.after)].map(i(0,o.x))),y:$l([...r.y.start.map(a=>a-n.y.before),...r.y.center.map(a=>a-t.height/2),...r.y.end.map(a=>a-t.height+n.y.after)].map(i(0,o.y)))}}function $l(e){return Array.from(new Set(e))}const Vr="templates-container",kp=4e3;var ji=(e=>(e.Default="default",e.Banner="banner",e))(ji||{});const Me=ne()({tagName:"toniq-carousel",hostClasses:{"toniq-carousel-banner-variant":({inputs:e})=>e.variant==="banner"},stateInitStatic:{currentScrollPosition:{left:0,right:1/0},scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({hostClasses:e})=>m`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:n,state:r,updateState:o}){if(!e.text)return u``;const i=e.text,a=r5(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,d=c?t5(i,a):i,f=c?i:"",p=s?ld:l?sd:void 0,g=p?u`
                  <${T.assign({icon:p})}></${T}>
              `:"",w=u`
        ...
        `;return d?s?u`
                ...
                `:l?u`
                    <button
                        ...
                        ${S("click",async()=>{await Qw(i),t(new n.copy),r.showCopiedTextTimeoutId!=null&&window.clearTimeout(r.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${w} ${g}
                    </button>
                `:u`
                    ${w}
                `:u``}}),lc="...";function o5(e,t,n=7,r=5){let o;e=On({value:e,min:1,max:t}),n=On({value:n,min:r,max:t});const i=n-5,a=n-3;t<=n?o=n:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>n?fi(t-o,t):e>o?fi(Math.min(s.start,t-o),Math.min(s.end,t)):fi(1,Math.min(t,o+1));function c(f,p){return l.length+1!==t?p:[f]}const d=l[l.length-1];if(d&&d<t){const f=c(t,[lc,t]);return[...l,...f]}else return l[0]!==1?c(1,[1,lc]).concat(l):l}function fi(e,t){const n=t-e+1;return Array.from({length:n},(r,o)=>e+o)}ne()({tagName:"toniq-pagination",styles:m`
        :host {
            display: flex;
        }
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:Ic()})},renderCallback({inputs:e,dispatch:t,events:n,state:r}){return i5(e.entries).map(i=>a5(e.groupName||r.randomGroupName,e.value,i,()=>{t(new n.valueChange(i.value))}))}});function i5(e){const t=Object.fromEntries(e.map(r=>[r.value,r]));return Object.values(t).length!==e.length&&console.error(`${G.tagName} was given duplicate entry values.`),Object.values(t)}function a5(e,t,n,r){const o=t===n.value,i=u`
    ...
    `}function mi(e,t){const n=e[0],r=e[e.length-1];if(n==null||r==null)return 0;if(t<n)return n;if(t>r)return r;const o=e.findIndex((c,d)=>{const f=e[d+1];return f==null?!0:c<=t&&f>=t});if(o<0)return n;const i=e[o];if(i==null)return n;const a=e[o+1];if(a==null)return i;const s=t-i,l=a-t;return s<l?o:o+1}function s5(e,t,n=100){e>t&&([e,t]=[t,e]),n<2&&(n=2);let r=l5(e);const o=[e];for(;r<t;){const i=Math.pow(10,String(r).length-1),a=r+i;a<t&&o.push(a),r=a}return o.push(t),o.length>n&&(cc(o,n),o.length>n&&cc(o,n)),o}function cc(e,t){const n=e.length-t,r=(e.length-2)/n;for(let o=e.length-2;o>=1;o-=r)e.splice(Math.floor(o),1)}function l5(e){let t=1;if(!e)return e;e<0&&(t=-1,e=e*-1);const n=e.toFixed(0),r=Math.pow(10,n.length-1),o=Number(n[0]||1);return r*o*t}const N={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},En={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"};function c5(e){var r,o;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${N.lowerLabelWrapper} .${N.labelPercentMarginWrapper}`),n=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${N.upperLabelWrapper} .${N.labelPercentMarginWrapper}`);if(n instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),a=n.getBoundingClientRect();return{lower:i,upper:a}}else return}function u5(e,t=8){const n=c5(e);if(!n)return 0;const r=n.lower.right-n.upper.left+t;return Math.max(0,r)}function pi({value:e,limits:t,flip:n}){const o=(t.max-e)/(t.max-t.min)*100;return-(n?100-o:o)}function nr(e){return Xe(e)&&e.min!==void 0&&e.max!==void 0}function oa(e){var n;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${N.range}`);return(t==null?void 0:t.clientWidth)??0}function gi(e,t,n){return`${n?kh(e):e} ${t}`}function d5({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function h5({value:e,double:t,min:n,max:r}){return t?nr(e)?{min:On({value:e.min,min:n,max:Math.min(e.max,r)}),max:On({value:e.max,min:Math.max(e.min,n),max:r})}:{min:n,max:r}:nr(e)?n:On({value:e,min:n,max:r})}function f5({actualValue:e,actualLimits:t,logScale:n,logRange:r}){return n?{elementValue:nr(e)?{min:mi(r,e.min),max:mi(r,e.max)}:mi(r,e),elementLimits:{min:0,max:r.length-1}}:{elementValue:e,elementLimits:t}}function wi(e,t,n){return n?t[e]||0:e}function m5(e){return{actualLimits:d5(e),actualValue:h5(e)}}function p5(e,t){var r,o,i;let n=!1;if(nr(e)){const a=(r=t.shadowRoot)==null?void 0:r.querySelector(`.${N.lowerSlider}`),s=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${N.upperSlider}`);a instanceof HTMLInputElement&&s instanceof HTMLInputElement&&(Number(a.value)!==e.min&&(a.value=String(e.min),n=!0),Number(s.value)!==e.max&&(s.value=String(e.max),n=!0))}else{const a=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${N.slider}`);a instanceof HTMLInputElement&&Number(a.value)!==e&&(a.value=String(e),n=!0)}return n}function N0(e,t){const{actualValue:n,actualLimits:r}=m5({...e}),o=s5(r.min,r.max),i=e.logScale??!1,a=e.suffix??"",{elementValue:s,elementLimits:l}=f5({actualValue:n,actualLimits:r,logScale:i,logRange:o}),c=oa(t);return{actualValue:n,elementLimits:l,elementValue:s,isLogScale:i,logRange:o,rangeWidth:c,suffix:a}}const Dt=16,uc=m`
    ${Dt}px
`,dc=m`
...
`,hc=m`
    transform: scale(1.2);
`;function Bn(e){requestAnimationFrame(()=>{const t=N0(e.instanceInputs,e).elementValue;p5(t,e)&&(e.setAttribute("disabled","true"),Bn(e))})}const _=ne()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:K()},styles:m`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Bn(e)}),e.addEventListener("keydown",()=>{Bn(e)}),e.addEventListener("keyup",()=>{Bn(e)})},renderCallback({inputs:e,host:t,events:n,dispatch:r,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:d,elementLimits:f,rangeWidth:p}=N0({...e},t);if(Bn(t),nr(d))return g(a,d,f);return $(a,d,f);function g(k,x,C){const O={left:Ot((p-Dt)*(x.min-C.min)/(C.max-C.min)+Dt/2),right:Ot((p-Dt)*(C.max-x.max)/(C.max-C.min)+Dt/2)},j=gi(k.min,c,l),re=gi(k.max,c,l);requestAnimationFrame(()=>{const $e=u5(t);$e!==o.labelOverlap&&i({labelOverlap:$e})});const he=(C.max-x.max)/(C.max-C.min)>.5,ce=pi({value:x.min,limits:{min:C.min,max:x.max},flip:!0}),Z=pi({value:x.max,limits:{min:x.min,max:C.max},flip:!1}),oe=o.labelOverlap&&he?o.labelOverlap:0,ze=o.labelOverlap&&!he?o.labelOverlap:0;return u`
                <div
                    class="range"
    ...
    `,renderCallback({inputs:e}){const t=e.icon?u`
        ...
        `}}),zn=gp({tagName:"toniq-tooltip",styles:m`
        :host {
            display: block;
            padding: 4px 8px;
            border-radius: 8px;
    ...
    `,renderCallback({inputs:e}){return u`
            <${T.assign({icon:e.icon})}></${T}>
        `}}),Lo=Object.values(vt).reduce((e,t)=>(t.forEach(n=>{if(n.name in e)throw new Error(`Icon name duplicate: '${n.name}'`);e[n.name]=n}),e),{}),g5=Object.keys(Lo).sort();function Ga(e){return{controlType:B.Dropdown,initValue:e,options:["None",...g5]}}const D0={"CSS color":{controlType:B.Color,initValue:""},[String(h["toniq-icon-stroke-color"].name)]:{controlType:B.Color,initValue:""},[String(h["toniq-icon-fill-color"].name)]:{controlType:B.Color,initValue:""},[String(h["toniq-icon-stroke-width"].name)]:{controlType:B.Color,initValue:""},[String(h["toniq-icon-stroke-width"].name)]:{controlType:B.Number,initValue:2}};function Ur(e){return Object.entries(e).filter(([,n])=>n!==""&&n!=null).map(([n,r])=>(n.toLowerCase()==="css color"&&(n="color"),we(r,"number")&&(r=aa({value:r,suffix:"px"})),`${n}: ${r};`)).join(`
`)}const w5=U({title:"Social Urls",parent:B0,elementExamplesCallback({defineExample:e}){function t({socialName:n,icon:r}){e({title:n,renderCallback(){return u`
                        <${wo.assign({icon:r})}></${wo}>
                    `}})}Object.entries(Cd).forEach(([n,r])=>{t({socialName:n,icon:r})})}}),ae=U({title:"Elements",parent:void 0}),v5=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:m`
            ${Vt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],b5=U({title:Vt.tagName,parent:ae,elementExamplesCallback({defineExample:e}){v5.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:m`
                    .bold {
                        ${Y.boldFont}
                    }
                ...
                `,renderCallback({state:n,updateState:r}){return u`
                        ...
                        ></${Vt}>
                        More text
                    `}})})}}),y5=U({parent:ae,title:ue.tagName,elementExamplesCallback({defineExample:e}){[{name:"default",inputs:{}},{name:"Secondary",inputs:{variant:ho.Secondary}},{name:"Outline",inputs:{variant:ho.Outline}},{name:"Disabled",inputs:{disabled:!0}}].forEach(n=>{e({title:n.name,stateInitStatic:{showIcon:!1,timeoutId:void 0},styles:m`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
...
`,k5=U({parent:ae,title:Me.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:fc,renderCallback(){return u`
                ...
                `;return u`
                    ...
                    ></${Me}>
                `}})}});function $5(e){const t=Object.keys(e.cssVars).map(n=>[`--${n}`,{controlType:B.Color,initValue:""}]);return Object.fromEntries(t)}function x5(e){const t=Object.entries(e).map(([n,r])=>{if(n.startsWith("--"))return typeof r!="string"||!r?void 0:`${n}: ${r};`}).filter(ke);return P(t.join(`
`))}const T5=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],bi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],S5=U({parent:ae,title:mt.tagName,controls:{Text:{controlType:B.Text,initValue:"Text"},...$5(mt)},elementExamplesCallback({defineExample:e}){T5.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:bi.map(n=>!!n.inputs.checked),extraEntryStatuses:bi.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:m`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return bi.map((i,a)=>{const s=(i.extraEntries??[]).map((c,d)=>{var f;return u`
                        ...
                        `})}})})}}),C5=U({parent:ae,title:ti.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Tt}},{inputs:{icon:Tt}},{inputs:{},template:u`
                    HTML child
        ...
        `},{customStyle:m`
            max-height: 30px;
            min-height: 30px;
        `}],E5=U({title:Lr.tagName,parent:ae,controls:{Selected:{controlType:B.Dropdown,initValue:Nr[0].label,options:Nr.map(e=>e.label)},Direction:{controlType:B.Dropdown,initValue:"Down",options:Cc(ea)},Icon:Ga(nd.name),Prefix:{controlType:B.Text,initValue:"Sort by: "},"Force open":{controlType:B.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){A5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:mc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:m`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return mc.map((i,a)=>{const s=m`
                        ...
                        `;return u`
                            ...
                            ></${Lr}>
                        `})}})})}}),pc="/toniq-labs-design-system";function I5(...e){const n=[globalThis.location.pathname.startsWith(pc)?pc:"",...e].filter(ke);return gh(...n)}const tn=Array(30).fill(I5("/toniq-labs-logo.png")),an=["Hello there.","There is stuff here."],Pr=an.concat(Array(30).fill(an)),L5=U({title:J.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${J.assign({infoParagraphs:Pr,imageUrls:tn,socialUrls:pp,title:"Featured Stuff",viewButtonTitle:"Stuff"})}></${J}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${J.assign({imageUrls:tn.map((t,n)=>n%2?"/invalid-image.png":t),infoParagraphs:an,title:"With custom Template Statuses",customTemplateCallback(t){return u`
                            ...
                            `}})}></${J}>
                `}})}}),q5=U({title:Ft.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:m`
                .front,
                .back {
                    padding: 32px;
                }
            ...
            `,renderCallback({controls:n}){return u`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            ...
                            ></${qr}>
                        `))}})})}}),D5=U({title:hi.tagName,parent:ae,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:jr.Small}},{title:"large",inputs:{size:jr.Large}},{title:"whole page",inputs:{size:jr.WholePage},styles:m`
                    :host {
                        width: 500px;
                    }
                `}].forEach(n=>{e({title:n.title,styles:n.styles??m``,renderCallback(){return u`
                        <${hi.assign(n.inputs)}></${hi}>
                    `}})})}}),O5=U({title:pe.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
...
`,yi={min:10,max:50},_5=U({title:_.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:m`
                ${at}
            `,renderCallback({state:t,updateState:n}){return u`
            ...
            `,renderCallback({state:t,updateState:n}){return u`
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return gc.map((i,a)=>u`
                            ...
                            ></${vi}>
                        `)}})})}}),V5=U({parent:ae,title:Wr.tagName,elementExamplesCallback({defineExample:e}){function t({title:n,tooltipContent:r,forceShow:o}){e({title:n,styles:m`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),z5=U({parent:ae,title:zn.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${Wr.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return u`
                    <${zn}>This is a tooltip.</${zn}>
                `}})}}),Z5=[V5,z5],j5=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:m`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:m``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:m``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:zi},{label:"label here",value:2,icon:zi},{label:"",value:3,icon:Tt,disabled:!0},{label:"16px icon",value:4,icon:Tt},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],W5=U({title:Dn.tagName,parent:ae,elementExamplesCallback({defineExample:e}){j5.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:m`
                ...
                `,renderCallback({state:n,updateState:r}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return u`
                        ...
                        ></${Dn}>
                    `}})})}}),O0=U({title:"Icons",parent:void 0,controls:D0}),U5=Object.entries(vt).map(([e,t])=>U({title:e,parent:O0,elementExamplesCallback({defineExample:n}){t.map(r=>n({title:r.name,renderCallback({controls:o}){return u`
                                <${wo.assign({icon:r})}
                                    style=${Ur(o)}
                                ></${wo}>
                            `}}))}}));function R0(e){const t=G5(e),n=ve(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return de(n).reduce((o,i)=>{const a=n[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function G5(e){typeof e!="string"&&(e=String(e));const r=`{"${bc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(r);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${r}`),o}}const Ya=U({title:"Styles",parent:void 0}),Y5=m`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function J5(e,t,n){const r=R0(F(n));return e({title:t,styles:Y5,renderCallback(){return u`
            ...
            `}})}const X5=U({title:"Colors",parent:Ya,elementExamplesCallback({defineExample:e}){de(b).map(t=>J5(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),K5=m`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function Q5(e,t,n){const r=R0(n);return e({title:t,styles:K5,renderCallback(){return u`
            ...
            `}})}const e4=U({title:"Fonts",parent:Ya,elementExamplesCallback({defineExample:e}){de(Y).map(t=>{const n=Y[t];return Q5(e,t,n)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),t4=[ae,O0,Ya,B0],n4=[...U5,...Z5,w5,b5,y5,k5,S5,C5,X5,M5,E5,L5,q5,e4,N5,P5,B5,D5,O5,R5,_5,F5,W5].sort((e,t)=>e.title.localeCompare(t.title)),r4=[...t4,...n4];yo({tagName:"toniq-design-system-app",styles:m`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return u`
            <${Ko.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:r4,themeColor:"#00D093"})}>
