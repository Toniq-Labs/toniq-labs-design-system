...
`,vd=v({name:"LoaderAnimated24Icon",svgTemplate:u`
    ...
    `,renderCallback({inputs:e,dispatch:t,events:r}){return Object.entries(e.config).length?Object.entries(e.config).map(([n,o],i)=>{if(o.controlType===B.Hidden)return"";const a=Am(e.currentValues[n],o,s=>{const l=X(e.fullUrlBreadcrumbs,"array")?e.fullUrlBreadcrumbs:e.fullUrlBreadcrumbs[n];if(!l)throw new Error(`Failed to find breadcrumbs from given control name: '${n}'`);t(new r.controlValueChange({fullUrlBreadcrumbs:l,newValues:{...e.currentValues,[n]:s}}))});return u`
    ...
    `,renderCallback({inputs:e}){return u`
        ...
        `}});function $d(e,t,r,n){const o=ta(r,n),i=[];if(o){const a=$d(e,t,o,n);a&&i.push(a)}if(mr(r,we.Page)&&!e.includes(r)){const a=Ya(t,r.fullUrlBreadcrumbs);i.push({config:r.entry.controls,current:a,breadcrumbs:ve(a,()=>r.fullUrlBreadcrumbs)})}return i.reduce((a,s)=>({config:{...a.config,...s.config},current:{...a.current,...s.current},breadcrumbs:{...a.breadcrumbs,...s.breadcrumbs}}),{config:{},current:{},breadcrumbs:{}})}function Em({currentNodes:e,isTopLevel:t,router:r,isSearching:n,controls:o,originalTree:i}){if(!e.length&&n)return[u`
            ...
            `];const a=Gi(e,1)?$d(e,o,e[0],i):void 0,s=a&&Object.values(a.config).length&&Gi(e,1)?u`
              ...
              `:K,l=Af(e,c=>c.fullUrlBreadcrumbs.join(">"),(c,h)=>{if(mr(c,we.Page))return u`
                    <${Pl.assign({isTopLevel:t,pageNode:c,controls:o,router:r})}
                        class="block-entry"
                    ></${Pl}>
                `;if(mr(c,we.ElementExample)){const f=Ya(o,c.fullUrlBreadcrumbs.slice(0,-1));return u`
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{Rl(e,ra(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:r,updateState:n,dispatch:o,events:i})=>{var h,f,m,g,w,k,y;t._debug&&console.info("rendering element-book app");function a(S){return{...e.currentRoute,...S}}function s(S){const C=a(S);return!ot(e.currentRoute,C)}function l(S){t.preventWindowTitleChange||(e.originalWindowTitle||n({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,S].filter(be).join(" - "))}function c(S){if(!s(S))return;const C=a(S);e.router?e.router.setRoutes(C):n({currentRoute:{...e.currentRoute,...C}}),t.elementBookRoutePaths&&!ot(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(C.paths??[]))}try{if(t.elementBookRoutePaths&&!ot(t.elementBookRoutePaths,e.currentRoute.paths)&&c({paths:t.elementBookRoutePaths}),(h=t.internalRouterConfig)!=null&&h.useInternalRouter&&!e.router){const W=B1(t.internalRouterConfig.basePath);n({router:W}),W.addRouteListener(!0,le=>{n({currentRoute:le})})}else!((f=t.internalRouterConfig)!=null&&f.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const S={themeColor:t.themeColor};if(!ot(S,(m=e.colors)==null?void 0:m.config)){const W=El(S);n({colors:{config:S,theme:W}}),_1(r,W)}const C=t._debug??!1,H=b1({entries:t.entries,debug:C});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),n({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:Nu(H.tree,{children:(w=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:w.children,controls:t.globalValues})}}));const U=ra(e.currentRoute.paths),ge=(U?C1({flattenedNodes:H.flattenedNodes,searchQuery:U}):void 0)??Im(H.flattenedNodes,e.currentRoute.paths,c);l((k=ge[0])==null?void 0:k.entry.title);const fe=(y=e.treeBasedControls)==null?void 0:y.controls;return fe?(t._debug&&console.info({currentControls:fe}),u`
                <div
                    class="root"
        ...
        `;function ki(e){return{foregroundColor:e.backgroundColor,backgroundColor:e.foregroundColor}}const Lm=(()=>{const e={backgroundColor:p`#ffffff`,foregroundColor:p`#000000`},t={...e,foregroundColor:p`#00D093`},r={...e,foregroundColor:p`#ACADAD`},n={...e,foregroundColor:p`#D6D6D6`},o={...t},i={...t,foregroundColor:p`#00A876`},a={...t,foregroundColor:p`#1D6852`},s={...n},l={...e,foregroundColor:p`rgba(0, 0, 0, 0.08)`},c={...e,backgroundColor:p`#D2EEFA`},h=ki(o),f=ki(i),m=ki(a),g=m,w={backgroundColor:p`#F1F3F6`,foregroundColor:e.foregroundColor},k={...w,foregroundColor:p`#9A9A9D`};return{brandPrimary:t,pagePrimary:e,pageSecondary:r,pageTertiary:n,pageInteraction:o,pageInteractionHover:i,pageInteractionActive:a,divider:s,dividerFaint:l,dropShadow:c,pageDarkPrimary:g,accentPrimary:h,accentPrimaryHover:f,accentPrimaryActive:m,accentSecondary:w,accentTertiary:k}})(),xd=Lm;function Hl(e,t){return M(`--toniq-${uo(e)}-${uo(t)}`)}const rs=ve(xd,e=>({backgroundColor:Hl(e,"backgroundColor"),foregroundColor:Hl(e,"foregroundColor")}));function Ke(e,t){const r=xd[e][t],n=rs[e][t];return p`var(${n}, ${r})`}const b=ve(rs,e=>({foregroundColor:Ke(e,"foregroundColor"),backgroundColor:Ke(e,"backgroundColor")}));function j(e){return p`
...
`))}const D=(()=>{const e=p`
    ...
    `,m=p`
        ${Ue("monospaceFont")}
    `;return{toniqFont:e,normalWeightFont:t,boldFont:r,extraBoldFont:n,paragraphFont:o,boldParagraphFont:i,labelFont:a,boldLabelFont:s,h1Font:l,h2Font:c,h3Font:h,h4Font:f,monospaceFont:m}})(),d=pt({"toniq-icon-fill-color":P["vira-icon-fill-color"].default,"toniq-icon-stroke-color":P["vira-icon-stroke-color"].default,"toniq-icon-stroke-width":"2px"}),z=ve(d,(e,t)=>r=>M(`var(${t.name}, ${r})`)),gn={popupShadow:p`
...
`,zp=v({name:"CryptoIcp16Icon",svgTemplate:u`
    ...
    `,renderCallback({inputs:e}){const t=e.icon?u`
        ...
        `}});function rg(e,t,r={behavior:"smooth"}){let n=2;const o=t==="up"||t==="down"?"y":"x",i=t==="right"||t==="down"?"+":"-",a=o==="x"?e.scrollWidth-e.offsetWidth:e.scrollHeight-e.offsetHeight,s=ss(e)[o];i==="-"&&(n*=-1);const l=e[o==="x"?"scrollLeft":"scrollTop"]+n,c=s.filter(f=>i==="+"?f>l:f<l).sort((f,m)=>i==="+"?f-m:m-f);let h;return c.length>0?h=c[0]:i==="+"?h=a:h=0,e.scrollTo({...r,[o==="x"?"left":"top"]:h})}function ng(e){const t=window.getComputedStyle(e),r=e.getBoundingClientRect();let n=t.getPropertyValue("scroll-padding-left").replace("auto","0px"),o=t.getPropertyValue("scroll-padding-top").replace("auto","0px"),i=t.getPropertyValue("scroll-padding-right").replace("auto","0px"),a=t.getPropertyValue("scroll-padding-bottom").replace("auto","0px");function s(m,g){let w=parseFloat(m);return/%/.test(m)&&(w/=100,w*=g),w}let l=s(n,r.width),c=s(o,r.height),h=s(i,r.width),f=s(a,r.height);return{x:{before:l,after:h},y:{before:c,after:f}}}function og(e,t,r="both"){return r==="x"&&e.right>=t.left&&e.left<=t.right||r==="y"&&e.bottom>=t.top&&e.top<=t.bottom||r==="both"&&e.right>=t.left&&e.left<=t.right&&e.bottom>=t.top&&e.top<=t.bottom}function Jd(e){let t=[];for(const r of e.children)t=t.concat(r,Jd(r));return t}function ig(e,t=!0){const r=e.getBoundingClientRect(),n={x:{start:[],center:[],end:[]},y:{start:[],center:[],end:[]}},o=Jd(e);for(const i of["x","y"]){const a=i==="x"?"y":"x",s=i==="x"?"left":"top",l=i==="x"?"width":"height",c=i==="x"?"scrollLeft":"scrollTop";for(const h of o){const f=h.getBoundingClientRect();if(t&&!og(r,f,a))continue;const m=window.getComputedStyle(h);let[g,w]=m.getPropertyValue("scroll-snap-align").split(" ");typeof w>"u"&&(w=g);const k=i==="x"?w:g,y=f[s]-r[s]+e[c];switch(k){case"none":break;case"start":n[i].start.push(y);break;case"center":n[i].center.push(y+f[l]/2);break;case"end":n[i].end.push(y+f[l]);break}}}return n}function ss(e){const t=e.getBoundingClientRect(),r=ng(e),n=ig(e),o={x:e.scrollWidth-e.offsetWidth,y:e.scrollHeight-e.offsetHeight},i=(a,s)=>l=>Math.max(a,Math.min(s,l));return{x:Vl([...n.x.start.map(a=>a-r.x.before),...n.x.center.map(a=>a-t.width/2),...n.x.end.map(a=>a-t.width+r.x.after)].map(i(0,o.x))),y:Vl([...n.y.start.map(a=>a-r.y.before),...n.y.center.map(a=>a-t.height/2),...n.y.end.map(a=>a-t.height+r.y.after)].map(i(0,o.y)))}}function Vl(e){return Array.from(new Set(e))}const io="templates-container",ag=4e3;var ga=(e=>(e.Default="default",e.Banner="banner",e))(ga||{});const Ee=te()({tagName:"toniq-carousel",hostClasses:{"toniq-carousel-banner-variant":({inputs:e})=>e.variant==="banner"},stateInitStatic:{currentScrollPosition:{left:0,right:1/0},scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({hostClasses:e})=>p`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
                ...
                <div class="card-face front" slot="front">
                    ...
                    <div class="all-images">
                        ...
                        <div class="secondary-images">
                            ${e.imageUrls.slice(1).map(y=>{var S;return u`
                                    <div class="secondary-image-wrapper">
                                        ${((S=e.customTemplateCallback)==null?void 0:S.call(e,y))||u`
    ...
    `,renderCallback:({inputs:e})=>u`
            <${T.assign({icon:is,fitContainer:e.size!=="small"})}></${T}>
        `}),Ac="...";function R4(e,t,r=7,n=5){let o;e=fr({value:e,min:1,max:t}),r=fr({value:r,min:n,max:t});const i=r-5,a=r-3;t<=r?o=r:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>r?Oi(t-o,t):e>o?Oi(Math.min(s.start,t-o),Math.min(s.end,t)):Oi(1,Math.min(t,o+1));function c(f,m){return l.length+1!==t?m:[f]}const h=l[l.length-1];if(h&&h<t){const f=c(t,[Ac,t]);return[...l,...f]}else return l[0]!==1?c(1,[1,Ac]).concat(l):l}function Oi(e,t){const r=t-e+1;return Array.from({length:r},(n,o)=>e+o)}const Bi=te()({tagName:"toniq-pagination",styles:p`
        :host {
            display: flex;
        }
    ...
    `,stateInitStatic:{table:{header:[],row:[]},canScroll:!1,debouncedResize:s1(()=>qh(nn.FirstThenWait,{milliseconds:30})),widthSizes:{},isPainting:!1,itemsPainted:0},initCallback({inputs:e,state:t,updateState:r}){const n=e.columns.filter(o=>!o.disabled);r({table:{header:n.map(o=>{var i;return{title:o.title,key:o.key,left:0,mobile:{sticky:(i=o.mobile)==null?void 0:i.sticky}}}),row:[e.rows[0],...e.rows].filter(be)},widthSizes:n.reduce((o,i)=>(o[i.key]=void 0,o),t.widthSizes)})},renderCallback({inputs:e,state:t,updateState:r,events:n,dispatch:o}){var c;function i(h){if(h instanceof HTMLElement){const f=h.getBoundingClientRect().left,m=t.table.header.map((g,w)=>{const k=h.querySelectorAll(".row-item")[w],y=k==null?void 0:k.getBoundingClientRect().left;return{...g,left:y-f}});t.debouncedResize(()=>{r({table:{...t.table,header:m},canScroll:h.scrollWidth>h.clientWidth})})}}const a=e.pagination&&((c=e.pagination)==null?void 0:c.pageCount)>1?u`
                      <${Bi.assign({currentPage:e.pagination.currentPage,pageCount:e.pagination.pageCount})}
                          class=${ce({"blocked-pagination":!!e.showLoading})}
                          ${x(Bi.events.pageChange,h=>{o(new n.pageChange(h.detail))})}
                      ></${Bi}>
                  `:K;function s(h,f){return u`
                <div
                    class="row-wrapper"
                    ${f>0?x("click",m=>{var g,w;(w=(g=h.rowActions)==null?void 0:g.click)==null||w.call(g,{clickEvent:m,dispatch:o})}):K}
                >
                    ${t.table.header.map((m,g)=>{var k,y;const w=h.cells[m.key];return u`
                            <div
                                class=${ce({"row-item":!0,sticky:(k=m.mobile)!=null&&k.sticky?((y=m.mobile)==null?void 0:y.sticky)&&t.canScroll:!1})}
                                style=${p`
                                    left: ${M(`${m.left}px`)};
                                    min-width: ${g>=t.table.header.length-1?M("unset"):M(`${t.widthSizes[m.key]}px`)};
                                `}
                            >
                                <div
                                    class=${ce({"row-content":!0,hidden:f===0})}
                                    ${ea(S=>{const C=S.getBoundingClientRect().width;(!t.widthSizes[m.key]||C>t.widthSizes[m.key])&&r({widthSizes:{...t.widthSizes,[m.key]:C}}),r({itemsPainted:t.itemsPainted+1})})}
                                >
                                    ${w}
                                </div>
                                ${$e(f===0,u`
            ...
            `}const l=t.itemsPainted>=t.table.header.length*t.table.row.length;return u`
            <div
                class=${ce({"table-wrapper":!0,"can-scroll":t.canScroll})}
            >
                <div
                    class=${ce({"table-list":!0,hidden:!l&&!e.showLoading})}
                    ${yr(h=>{i(h.target)})}
                    ${x("scroll",h=>{i(h.target)})}
                    ${x("keydown",h=>{e.showLoading&&(h.preventDefault(),h.stopImmediatePropagation())})}
                >
                    ${t.table.row.length&&t.table.row.map((h,f)=>u`
                            ${s(h,f)}
                        `)}
                    ${$e(t.canScroll,u`
                ...
                <div
                    class="loading-wrapper ${ce({hidden:l&&!e.showLoading})}"
                >
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:r,state:n,updateState:o}){if(!e.text)return u``;const i=e.text,a=j4(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,h=c?F4(i,a):i,f=c?i:"",m=s?Ld:l?Id:void 0,g=m?u`
        ...
        `;return h?s?u`
                    <button
                        tabindex="0"
                        role="link"
                        ${x("click",k=>{var S,C;const y=(C=(S=k.currentTarget)==null?void 0:S.querySelector)==null?void 0:C.call(S,"a");if(!y)throw new Error("Failed to find link anchor tag for middle ellipsis element link.");y.click()})}
                        class="link-wrapper"
                    >
                        <!--
...
`;function t5(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Zr(e){requestAnimationFrame(()=>{const t=rh(e.instanceInputs,e).elementValue;e5(t,e)&&(e.setAttribute("disabled","true"),Zr(e))})}const O=te()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ee()},styles:p`
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Zr(e)}),e.addEventListener("keydown",()=>{Zr(e)}),e.addEventListener("keyup",()=>{Zr(e)})},renderCallback({inputs:e,host:t,events:r,dispatch:n,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:h,elementLimits:f,rangeWidth:m}=rh({...e},t);if(Zr(t),vn(h))return g(a,h,f);return k(a,h,f);function g(y,S,C){const H={left:Ft((m-Ht)*(S.min-C.min)/(C.max-C.min)+Ht/2),right:Ft((m-Ht)*(C.max-S.max)/(C.max-C.min)+Ht/2)},U=Fi(y.min,c,l),ie=Fi(y.max,c,l);requestAnimationFrame(()=>{const xe=Y4(t);xe!==o.labelOverlap&&i({labelOverlap:xe})});const ge=(C.max-S.max)/(C.max-C.min)>.5,fe=Hi({value:S.min,limits:{min:C.min,max:S.max},flip:!0}),W=Hi({value:S.max,limits:{min:S.min,max:C.max},flip:!1}),le=o.labelOverlap&&ge?o.labelOverlap:0,We=o.labelOverlap&&!ge?o.labelOverlap:0;return u`
                <div
                    class="range"
                ...
                >
                    ...
                    <div class="slider-wrapper">
                        <input
                            ...
                            .max=${C.max}
                            .value=${S.min}
                            ${x("input",xe=>{const Qt=xe.target,Lr={...y,min:Vi(Number(Qt.value),s,l)};w(Lr)})}
                        />
                        <input
                            ?disabled=${e.disabled??!1}
                            type="range"
                            ...
                            .value=${S.max}
                            ${cr(Rr.slider)}
                            ${x("input",xe=>{const Qt=xe.target,Lr={...y,max:Vi(Number(Qt.value),s,l)};w(Lr)})}
                        />
                    </div>
                </div>
            `}function w(y){i({internalValue:y}),e.disabled||n(new r.valueChange(y))}function k(y,S,C){const H=Ft((m-Ht)*(C.max-S)/(C.max-C.min)+Ht/2),U=Fi(y,c,l),ie=Hi({value:S,limits:C,flip:!1});return u`
                <div
    ...
    `,renderCallback({inputs:e,dispatch:t,events:r}){const n=e.tabs.map(o=>{var l;const i=o.value===e.value,a=o.icon?u`
                ...
                >
                    <${Je.assign({url:((l=o.link)==null?void 0:l.url)||"",linkType:ht.RouteLink})}
                        ...
                        ${x("click",c=>{var h;i||Vo(c)&&((h=o.link)!=null&&h.route&&t(new r.routeChange(o.link.route)),t(new r.valueChange(o.value)))})}
                    >
    ...
    `,renderCallback({inputs:e}){return u`
            <${T.assign({icon:e.icon})}></${T}>
        `}}),Xo=Object.values(yt).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),r5=Object.keys(Xo).sort();function ws(e){return{controlType:B.Dropdown,initValue:e,options:["None",...r5]}}const ih={"CSS color":{controlType:B.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:B.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:B.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:B.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:B.Number,initValue:2}};function co(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),X(n,"number")&&(n=La({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
...
`,s5=_({parent:re,title:Ee.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:Pc,renderCallback(){return u`
                ...
                `;return u`
                    ...
                    ></${Ee}>
                `}})}});function l5(e){const t=Object.keys(e.cssVars).map(r=>[`--${r}`,{controlType:B.Color,initValue:""}]);return Object.fromEntries(t)}function c5(e){const t=Object.entries(e).map(([r,n])=>{if(r.startsWith("--"))return typeof n!="string"||!n?void 0:`${r}: ${n};`}).filter(be);return M(t.join(`
`))}const u5=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],zi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],d5=_({parent:re,title:gt.tagName,controls:{Text:{controlType:B.Text,initValue:"Text"},...l5(gt)},elementExamplesCallback({defineExample:e}){u5.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:zi.map(r=>!!r.inputs.checked),extraEntryStatuses:zi.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:p`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return zi.map((i,a)=>{const s=(i.extraEntries??[]).map((c,h)=>{var f;return u`
                                    <${gt.assign({...t.inputs,...on(i.inputs,["checked"]),checked:!!((f=r.extraEntryStatuses[a])!=null&&f[h]),text:c})}
                                        ${x(gt.events.checkedChange,()=>{const m=[...r.extraEntryStatuses];m[a][h]=!m[a][h],n({extraEntryStatuses:m})})}
                                    ></${gt}>
                                `}),l=c5(o);return u`
        ...
        `},{customStyle:p`
            max-height: 30px;
            min-height: 30px;
        `}],p5=_({title:Gn.tagName,parent:re,controls:{Selected:{controlType:B.Dropdown,initValue:Jn[0].label,options:Jn.map(e=>e.label)},Direction:{controlType:B.Dropdown,initValue:"Down",options:Uc(Sa)},Icon:ws(Cd.name),Prefix:{controlType:B.Text,initValue:"Sort by: "},"Force open":{controlType:B.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){m5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Nc.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:p`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Nc.map((i,a)=>{const s=p`
                        ...
                        <${Ni}>${t.content}</${Ni}>
                    `}})})}}),Oc="/toniq-labs-design-system";function ah(...e){const r=[globalThis.location.pathname.startsWith(Oc)?Oc:"",...e].filter(be);return an(...r)}const sr=Array(30).fill(ah("/toniq-labs-logo.png")),hr=["Hello there.","There is stuff here."],Kn=hr.concat(Array(30).fill(hr)),v5=_({title:Q.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
                ...
                `}}),e({title:"hyperlink view button",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${Q.assign({imageUrls:[],cardTitle:"Featured Stuff",infoParagraphs:Kn,viewMoreUrl:"https://toniqlabs.com"})}
                        ${x(Q.events.viewMoreButtonClick,()=>{console.info("view more clicked")})}
                    ></${Q}>
                    ...
                    <${Q.assign({imageUrls:sr.map((t,r)=>r%2?"/invalid-image.png":t),infoParagraphs:hr,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return u`
                                <${$t.assign({imageUrl:t,_debugLoadDelay:t.includes("invalid-image")?void 0:{milliseconds:1/0}})}>
                                    <div
                                        ...
                                        `}
                                    >
                                        <${T.assign({icon:is,fitContainer:!0})}
                                            style=${p`
                                                width: 100%;
                                                height: 100%;
                                            `}
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Bc=as({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const r=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(r)}})}},cleanupCallback({state:e,updateState:t}){var r;(r=e.cleanup)==null||r.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),I5=_({title:_t.tagName,parent:re,elementExamplesCallback({defineExample:e}){E5.forEach(t=>{var r,n;e({title:t.title,styles:p`
            ...
            `,stateInitStatic:{tableInputs:{...Zi,rows:Zi.rows.map(t=>({...t,cells:{...t.cells,date:u`
                ...
                `}].forEach(r=>{e({title:r.title,styles:r.styles??p``,renderCallback(){return u`
                    ...
                    `}})})}}),q5=_({title:ue.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
