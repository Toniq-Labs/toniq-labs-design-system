...
`,Ad=v({name:"LoaderAnimated24Icon",svgTemplate:c`
    ...
    `,events:{routeChange:oe()},renderCallback({inputs:e,dispatch:t,events:n}){var o,i;function r(a){e.route&&Wo(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new n.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return c`
            ...
            `}}});const{defineElement:Ge,defineElementNoInputs:N5}=Ja(),Fe=Ge()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>m`
        a {
            box-sizing: border-box;
            display: block;
...
`))}const D=(()=>{const e=m`
    ...
    `}),wg=v({name:"FrameBolt24",svgTemplate:c`
        <svg
            width="24"
            height="24"
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),vg=v({name:"Gear24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),bg=v({name:"Geometry24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),yg=v({name:"GridDots24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),kg=v({name:"Heart24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),xg=v({name:"Info24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Ag=v({name:"LayersLinked24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),$g=v({name:"LayoutGrid24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Cg=v({name:"Lifebuoy24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Sg=v({name:"List24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Tg=v({name:"ListDetails24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Mg=v({name:"Loader24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Eg=v({name:"Lock24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Bg=v({name:"Menu24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),qg=v({name:"Pamphlet24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),Lg=v({name:"Paper24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Pg=v({name:"People24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Og=v({name:"Person24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Dg=v({name:"Photo24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Ng=v({name:"Refresh24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Rg=v({name:"Send24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Fg=v({name:"ShootingStar24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),jg=v({name:"ShoppingCart24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Hg=v({name:"Social24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Ug=v({name:"Square24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Vg=v({name:"SquareCheck24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Wg=v({name:"Tag24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),zg=v({name:"Upload24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Gg=v({name:"WorldUpload24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Yg=v({name:"X24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Qg=v({name:"Folder48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Kg=v({name:"Kyc48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Jg=v({name:"Tag48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${d["toniq-icon-fill-color"].value}
            stroke=${d["toniq-icon-stroke-color"].value}
    ...
    `}),Xg=v({name:"Wallet48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${d["toniq-icon-fill-color"].value}
            stroke=${d["toniq-icon-stroke-color"].value}
    ...
    `}),_g=v({name:"CircleDashes64Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),e2=v({name:"Rocket64Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),n2=v({name:"CryptoCkBtc16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),r2=v({name:"CryptoCkBtc24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
...
`,o2=v({name:"CryptoIcp16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),i2=v({name:"CryptoIcp24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),a2=v({name:"WalletBitfinity24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),s2=v({name:"WalletBitfinity64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),l2=v({name:"WalletLeather24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),c2=v({name:"WalletLeather64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),u2=v({name:"WalletPlug24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),d2=v({name:"WalletPlug64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),h2=v({name:"WalletStoic24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),m2=v({name:"WalletUnisat24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),p2=v({name:"WalletUnisat64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),g2=v({name:"WalletXverse24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),b2=v({name:"BrandGoogleLogo24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),k2=v({name:"BrandInstagramFlat24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),x2=v({name:"BrandNftgeek24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),A2=v({name:"BrandTiktokFlat24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${G["toniq-icon-fill-color"]("#000")}
    ...
    `}),$2=v({name:"BioniqRobot100Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),C2=v({name:"EntrepotLogo144Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),At={"core-16":[Id,Hp,Up,Vp,Et,Wp],"core-24":[zp,Zp,ss,Gp,Yp,ls,Bd,Qp,Kp,Jp,Xp,_p,eg,tg,ng,qd,Ld,rg,og,Pd,ig,ag,sg,lg,cg,Od,ug,dg,hg,fg,mg,Dd,pg,gg,wg,vg,bg,yg,kg,ba,xg,Ag,$g,Cg,Sg,Tg,Mg,cs,Eg,Ig,Bg,qg,Lg,Pg,Og,Dg,Ng,Nd,Rd,Rg,Fg,jg,Hg,Ug,Vg,Wg,ao,zg,Zg,Fd,Gg,Yg],"core-48":[Qg,jd,Kg,Jg,Xg],"core-64":[Hd,_g,e2],cryptocurrencies:[t2,Qo,n2,r2,o2,i2],"external-wallets":[a2,s2,l2,c2,u2,d2,h2,f2,m2,p2,g2,w2],"third-party-brands":[Wd,zd,Zd,v2,b2,y2,Gd,k2,Yd,x2,Qd,Kd,A2,Jd,Xd],toniq:[$2,C2]},S2=Cr({discord:nt(void 0,""),distrikt:nt(void 0,""),dscvr:nt(void 0,""),instagram:nt(void 0,""),medium:nt(void 0,""),telegram:nt(void 0,""),tikTok:nt(void 0,""),twitch:nt(void 0,""),twitter:nt(void 0,""),website:nt(void 0,"")}),T2=S2.defaultValue,_d={discord:Wd,instagram:Gd,telegram:Qd,tikTok:Kd,distrikt:zd,twitch:Jd,dscvr:Zd,medium:Yd,twitter:Xd,website:Fd},zl="toniq-",{defineElement:ie,defineElementNoInputs:us}=Ja({assertInputs:e=>{if(!e.tagName.startsWith(zl))throw new Error(`Tag name should start with '${zl}' but got '${e.tagName}'`)}}),Yt=ie()({tagName:"toniq-bold-space",styles:m`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,renderCallback({inputs:e}){const t=e.iconPlacement??"left",n=e.icon?c`
        ...
        `}});function M2(e,t,n={behavior:"smooth"}){let r=2;const o=t==="up"||t==="down"?"y":"x",i=t==="right"||t==="down"?"+":"-",a=o==="x"?e.scrollWidth-e.offsetWidth:e.scrollHeight-e.offsetHeight,s=ds(e)[o];i==="-"&&(r*=-1);const l=e[o==="x"?"scrollLeft":"scrollTop"]+r,u=s.filter(h=>i==="+"?h>l:h<l).sort((h,p)=>i==="+"?h-p:p-h);let f;return u.length>0?f=u[0]:i==="+"?f=a:f=0,e.scrollTo({...n,[o==="x"?"left":"top"]:f})}function E2(e){const t=window.getComputedStyle(e),n=e.getBoundingClientRect();let r=t.getPropertyValue("scroll-padding-left").replace("auto","0px"),o=t.getPropertyValue("scroll-padding-top").replace("auto","0px"),i=t.getPropertyValue("scroll-padding-right").replace("auto","0px"),a=t.getPropertyValue("scroll-padding-bottom").replace("auto","0px");function s(p,g){let w=parseFloat(p);return/%/.test(p)&&(w/=100,w*=g),w}let l=s(r,n.width),u=s(o,n.height),f=s(i,n.width),h=s(a,n.height);return{x:{before:l,after:f},y:{before:u,after:h}}}function I2(e,t,n="both"){return n==="x"&&e.right>=t.left&&e.left<=t.right||n==="y"&&e.bottom>=t.top&&e.top<=t.bottom||n==="both"&&e.right>=t.left&&e.left<=t.right&&e.bottom>=t.top&&e.top<=t.bottom}function n0(e){let t=[];for(const n of e.children)t=t.concat(n,n0(n));return t}function B2(e,t=!0){const n=e.getBoundingClientRect(),r={x:{start:[],center:[],end:[]},y:{start:[],center:[],end:[]}},o=n0(e);for(const i of["x","y"]){const a=i==="x"?"y":"x",s=i==="x"?"left":"top",l=i==="x"?"width":"height",u=i==="x"?"scrollLeft":"scrollTop";for(const f of o){const h=f.getBoundingClientRect();if(t&&!I2(n,h,a))continue;const p=window.getComputedStyle(f);let[g,w]=p.getPropertyValue("scroll-snap-align").split(" ");typeof w>"u"&&(w=g);const k=i==="x"?w:g,x=h[s]-n[s]+e[u];switch(k){case"none":break;case"start":r[i].start.push(x);break;case"center":r[i].center.push(x+h[l]/2);break;case"end":r[i].end.push(x+h[l]);break}}}return r}function ds(e){const t=e.getBoundingClientRect(),n=E2(e),r=B2(e),o={x:e.scrollWidth-e.offsetWidth,y:e.scrollHeight-e.offsetHeight},i=(a,s)=>l=>Math.max(a,Math.min(s,l));return{x:Zl([...r.x.start.map(a=>a-n.x.before),...r.x.center.map(a=>a-t.width/2),...r.x.end.map(a=>a-t.width+n.x.after)].map(i(0,o.x))),y:Zl([...r.y.start.map(a=>a-n.y.before),...r.y.center.map(a=>a-t.height/2),...r.y.end.map(a=>a-t.height+n.y.after)].map(i(0,o.y)))}}function Zl(e){return Array.from(new Set(e))}const so="templates-container",q2=4e3;var ka=(e=>(e.Default="default",e.Banner="banner",e))(ka||{});const Ie=ie()({tagName:"toniq-carousel",hostClasses:{"toniq-carousel-banner-variant":({inputs:e})=>e.variant==="banner"},stateInitStatic:{currentScrollPosition:{left:0,right:1/0},scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({hostClasses:e})=>m`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
    ...
    `,renderCallback:({inputs:e})=>c`
        ...
        `}),qc="...";function uv(e,t,n=7,r=5){let o;e=wn({value:e,min:1,max:t}),n=wn({value:n,min:r,max:t});const i=n-5,a=n-3;t<=n?o=n:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>n?ji(t-o,t):e>o?ji(Math.min(s.start,t-o),Math.min(s.end,t)):ji(1,Math.min(t,o+1));function u(h,p){return l.length+1!==t?p:[h]}const f=l[l.length-1];if(f&&f<t){const h=u(t,[qc,t]);return[...l,...h]}else return l[0]!==1?u(1,[1,qc]).concat(l):l}function ji(e,t){const n=t-e+1;return Array.from({length:n},(r,o)=>e+o)}const Hi=ie()({tagName:"toniq-pagination",styles:m`
        :host {
            display: flex;
        }
    ...
    `,events:{pageChange:oe()},renderCallback({inputs:e,events:t,dispatch:n}){return e.pageCount<=1?c``:c`
                ...
                ${uv(e.currentPage,e.pageCount,e.pagesShown).map(r=>typeof r=="string"?c`
    ...
    `,stateInitStatic:{canScroll:!1,debouncedResize:m1(()=>Fh(ar.FirstThenWait,{milliseconds:30})),rowStyles:{},isPainting:!1,itemsPainted:0,pageCountKey:0},initCallback({inputs:e,state:t,updateState:n}){const r=e.columns.filter(o=>!o.disabled);n({rowStyles:r.reduce((o,i)=>(o[i.key]={width:void 0,left:void 0},o),t.rowStyles)})},renderCallback({inputs:e,state:t,updateState:n,events:r,dispatch:o}){var h;const i=e.columns.filter(p=>!p.disabled),a=[e.rows[0],...e.rows].filter(ve);function s(p){p instanceof HTMLElement&&t.debouncedResize(()=>{n({canScroll:p.scrollWidth>p.clientWidth})})}const l=e.pagination&&((h=e.pagination)==null?void 0:h.pageCount)>1?c`
        ...
        `}});async function dv(e){return navigator.clipboard.writeText(e)}const hv="…";function fv(e,t){const n=e.slice(0,t).trim(),r=e.slice(-1*t).trim();return`${n}${hv}${r}`}function mv(e){return!(e%1)}function pv(e){return e.letterCount==null?4:mv(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const O=ie()({tagName:"toniq-middle-ellipsis",events:{copy:oe()},cssVars:{"toniq-middle-ellipsis-text-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":b.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":b.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>m`
        :host {
            /* 5 frames at 60 fps */
            transition: ${K.interaction};
            ${D.paragraphFont};
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:n,state:r,updateState:o}){if(!e.text)return c``;const i=e.text,a=pv(e),s=!!e.externalLink,l=!!e.copyOnClick,u=i.length>a*2+2,f=u?fv(i,a):i,h=u?i:"",p=s?Dd:l?Od:void 0,g=p?c`
                  <${$.assign({icon:p})}></${$}>
              `:"",w=c`
        ...
        `;return f?s?c`
                ...
                `:l?c`
                    <button
                        ...
                        ${y("click",async()=>{await dv(i),t(new n.copy),r.showCopiedTextTimeoutId!=null&&window.clearTimeout(r.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${w} ${g}
                    </button>
                `:c`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:ru()})},renderCallback({inputs:e,dispatch:t,events:n,state:r}){return gv(e.entries).map(i=>wv(e.groupName||r.randomGroupName,e.value,i,()=>{t(new n.valueChange(i.value))}))}});function gv(e){const t=Object.fromEntries(e.map(r=>[r.value,r]));return Object.values(t).length!==e.length&&console.error(`${J.tagName} was given duplicate entry values.`),Object.values(t)}function wv(e,t,n,r){const o=t===n.value,i=c`
...
`,Dc=m`
    transform: scale(1.2);
`;function Tv(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Qn(e){requestAnimationFrame(()=>{const t=lh(e.instanceInputs,e).elementValue;Sv(t,e)&&(e.setAttribute("disabled","true"),Qn(e))})}const R=ie()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:oe()},styles:m`
        :host {
            display: block;
        }
            ...
            `}function w(x){i({internalValue:x}),e.disabled||r(new n.valueChange(x))}function k(x,C,S){const N=Vt((p-Ut)*(S.max-C)/(S.max-S.min)+Ut/2),W=Zi(x,u,l),te=zi({value:C,limits:S,flip:!1});return c`
                ...
                >
                    ...
                    <input
                        ?disabled=${e.disabled??!1}
                        type="range"
                        class="${B.slider} ${e.colorTemperature?Tv(Math.abs(te)):""}"
                        step=${e.step}
                        .min=${S.min}
                        .max=${S.max}
                        .value=${C}
    ...
    `,renderCallback({inputs:e}){return c`
            <${$.assign({icon:e.icon})}></${$}>
        `}}),ti=Object.values(At).reduce((e,t)=>(t.forEach(n=>{if(n.name in e)throw new Error(`Icon name duplicate: '${n.name}'`);e[n.name]=n}),e),{}),Mv=Object.keys(ti).sort();function ks(e){return{controlType:j.Dropdown,initValue:e,options:["None",...Mv]}}const hh={"CSS color":{controlType:j.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:j.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:j.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:j.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:j.Number,initValue:2}};function ho(e){return Object.entries(e).filter(([,n])=>n!==""&&n!=null).map(([n,r])=>(n.toLowerCase()==="css color"&&(n="color"),ee(r,"number")&&(r=Oa({value:r,suffix:"px"})),`${n}: ${r};`)).join(`
`)}const Ev=U({title:"Social Urls",parent:dh,elementExamplesCallback({defineExample:e}){function t({socialName:n,icon:r}){e({title:n,renderCallback(){return c`
                        <${Oo.assign({icon:r})}></${Oo}>
                    `}})}Object.entries(_d).forEach(([n,r])=>{t({socialName:n,icon:r})})}}),ae=U({title:"Elements",parent:void 0}),Iv=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:m`
            ${Yt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],Bv=U({title:Yt.tagName,parent:ae,elementExamplesCallback({defineExample:e}){Iv.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:m`
                    .bold {
                        ${D.boldFont}
                    }
...
`,Lv=U({parent:ae,title:Ie.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:Nc,renderCallback(){return c`
                ...
                `;return c`
                    ...
                    ></${Ie}>
                `}})}});function Pv(e){const t=Object.keys(e.cssVars).map(n=>[`--${n}`,{controlType:j.Color,initValue:""}]);return Object.fromEntries(t)}function Ov(e){const t=Object.entries(e).map(([n,r])=>{if(n.startsWith("--"))return typeof r!="string"||!r?void 0:`${n}: ${r};`}).filter(ve);return T(t.join(`
`))}const Dv=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],Qi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],Nv=U({parent:ae,title:bt.tagName,controls:{Text:{controlType:j.Text,initValue:"Text"},...Pv(bt)},elementExamplesCallback({defineExample:e}){Dv.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:Qi.map(n=>!!n.inputs.checked),extraEntryStatuses:Qi.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:m`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Qi.map((i,a)=>{const s=(i.extraEntries??[]).map((u,f)=>{var h;return c`
                        ...
                        `})}})})}}),Rv=U({parent:ae,title:Mi.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Et}},{inputs:{icon:Et}},{inputs:{},template:c`
                    HTML child
        ...
        `},{customStyle:m`
            max-height: 30px;
            min-height: 30px;
        `}],Hv=U({title:Kr.tagName,parent:ae,controls:{Selected:{controlType:j.Dropdown,initValue:Xr[0].label,options:Xr.map(e=>e.label)},Direction:{controlType:j.Dropdown,initValue:"Down",options:Xc(Ea)},Icon:ks(Bd.name),Prefix:{controlType:j.Text,initValue:"Sort by: "},"Force open":{controlType:j.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){jv.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Rc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:m`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Rc.map((i,a)=>{const s=m`
                        ...
                        `;return c`
                            ...
                            ></${Kr}>
                        `})}})})}}),Uv=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],Vv=U({title:Fi.tagName,parent:ae,elementExamplesCallback({defineExample:e}){Uv.forEach(t=>{e({title:t.title,renderCallback(){return c`
                        <${Fi}>${t.content}</${Fi}>
                    `}})})}}),Fc="/toniq-labs-design-system";function fh(...e){const n=[globalThis.location.pathname.startsWith(Fc)?Fc:"",...e].filter(ve);return lr(...n)}const cn=Array(30).fill(fh("/toniq-labs-logo.png")),pn=["Hello there.","There is stuff here."],_r=pn.concat(Array(30).fill(pn)),Wv=U({title:re.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${re.assign({infoParagraphs:_r,imageUrls:cn,socialUrls:T2,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${re}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${re.assign({imageUrls:cn.map((t,n)=>n%2?"/invalid-image.png":t),infoParagraphs:pn,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return c`
                            ...
                            `}})}></${re}>
                `}})}}),zv=U({title:Gt.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:m`
                .front,
                .back {
                    padding: 32px;
                }
            ...
            `,renderCallback({controls:n}){return c`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),c`
                            ...
                            ></${Jr}>
                        `))}})})}});function ni({entries:e,columns:t,createRowObject:n}){const r=Object.fromEntries(t.map(i=>[i.key,""]));return{rows:e.map((i,a)=>{const s=n(i,a);if(!it(Object.keys(r).sort(),Object.keys(s.cells).sort()))throw console.error("broken list table row",{cells:s.cells,columns:r}),new Error("List table row keys does not match expect column keys.");return s}),columns:t}}const mh="https://cdn-bitcoin.bioniq.io",Kv=lr(mh,"content"),Jv=lr(mh,"thumbnail"),gn={thumbnail(e){return lr(Jv,e)},content(e){return lr(Kv,e)}},Xv=Array(5).fill({imageUrl:gn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${m`
                display: flex;
                gap: 8px;
    ...
    `}),_v=[{imageUrl:gn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Payment Sent",price:c`
            <div
                style=${m`
                    display: flex;
                    gap: 8px;
        ...
        `}],e5=[],t5=Array(5).fill({imageUrl:gn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${m`
                display: flex;
                gap: 8px;
    ...
    `}),Ki=ni({entries:Xv,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE",mobile:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${m`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),jc=ni({entries:_v,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${m`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),n5=ni({entries:e5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${m`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),r5=ni({entries:t5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME",style:m`
                display: flex;
                justify-content: flex-end;
            `}],createRowObject:e=>({cells:{image:c`
                    <img
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),o5=[{title:"basic"},{title:"with pagination",inputs:{pagination:{currentPage:1,pageCount:10}}},{title:"squished horizontally",styles:m`
            :host {
                width: 200px;
            }
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Hc=us({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const n=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(n)}})}},cleanupCallback({state:e,updateState:t}){var n;(n=e.cleanup)==null||n.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),i5=U({title:Ne.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return c`
            ...
            `,stateInitStatic:{tableInputs:{...Ki,rows:Ki.rows.map(t=>({...t,cells:{...t.cells,date:c`
                ...
                `}})}}),a5=U({title:rr.tagName,parent:ae,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:nr.Small}},{title:"large",inputs:{size:nr.Large}},{title:"whole page",inputs:{size:nr.WholePage},styles:m`
                    :host {
                        width: 500px;
                    }
                `}].forEach(n=>{e({title:n.title,styles:n.styles??m``,renderCallback(){return c`
                        <${rr.assign(n.inputs)}></${rr}>
                    `}})})}}),s5=U({title:O.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return c`
            ...
            `,renderCallback(){return c`
                ...
                `}})}}),l5=U({title:jn.tagName,parent:ae,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:m`
                ${jn} {
                    height: 32px;
                }
...
`,Ji={min:10,max:50},u5=U({title:R.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:m`
                ${rt}
            `,renderCallback({state:t,updateState:n}){return c`
            ...
            `,renderCallback({state:t,updateState:n}){return c`
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Uc.map((i,a)=>c`
                            ...
                            ></${Yi}>
                        `)}})})}}),f5=U({parent:ae,title:uo.tagName,elementExamplesCallback({defineExample:e}){function t({title:n,tooltipContent:r,forceShow:o}){e({title:n,styles:m`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),m5=U({parent:ae,title:ir.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${uo.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return c`
                    <${ir}>This is a tooltip.</${ir}>
                `}})}}),p5=[f5,m5],g5=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:m`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:m``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:m``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:ba},{label:"label here",value:2,icon:ba},{label:"",value:3,icon:Et,disabled:!0},{label:"16px icon",value:4,icon:Et},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],w5=U({title:Kn.tagName,parent:ae,elementExamplesCallback({defineExample:e}){g5.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:m`
                ...
                `,renderCallback({state:n,updateState:r}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return c`
                        ...
                        ></${Kn}>
                    `}})})}}),ph=U({title:"Icons",parent:void 0,controls:hh}),v5=Object.entries(At).map(([e,t])=>U({title:e,parent:ph,elementExamplesCallback({defineExample:n}){t.map(r=>n({title:r.name,renderCallback({controls:o}){return c`
                                <${Oo.assign({icon:r})}
                                    style=${ho(o)}
                                ></${Oo}>
                            `}}))}}));function gh(e){const t=b5(e),n=ke(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return le(n).reduce((o,i)=>{const a=n[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function b5(e){typeof e!="string"&&(e=String(e));const r=`{"${Zc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(r);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${r}`),o}}const ri=U({title:"Styles",parent:void 0}),y5=m`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function k5(e,t,n){const r=gh(F(n));return e({title:t,styles:y5,renderCallback(){return c`
            ...
            `}})}const x5=U({title:"Colors",parent:ri,elementExamplesCallback({defineExample:e}){le(b).map(t=>k5(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),A5=m`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function $5(e,t,n){const r=gh(n);return e({title:t,styles:A5,renderCallback(){return c`
            ...
            `}})}const C5=U({title:"Fonts",parent:ri,elementExamplesCallback({defineExample:e}){le(D).map(t=>{const n=D[t];return $5(e,t,n)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),S5=U({title:"Shadows",parent:ri,elementExamplesCallback({defineExample:e}){Ch(vr).forEach(([t,n])=>{e({title:t,styles:m`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return c`
                            <div></div>
                        `}})})}}),T5=[ae,ph,ri,dh],M5=[...v5,...p5,Ev,Bv,qv,Lv,Nv,Rv,x5,Fv,Hv,Vv,Wv,zv,C5,Zv,Gv,Yv,Qv,a5,s5,l5,c5,S5,u5,h5,w5,i5].sort((e,t)=>e.title.localeCompare(t.title)),E5=[...T5,...M5];Vo({tagName:"toniq-design-system-app",styles:m`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return c`
            <${$i.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:E5,themeColor:"#00D093"})}>
