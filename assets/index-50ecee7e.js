...
`,ae=xr()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:e})=>!!e.fitContainer},styles:({hostClasses:e})=>p`
    ...
    `,events:{expandChange:ee()},stateInitStatic:{contentHeight:0},renderCallback({state:e,updateState:t,dispatch:r,events:n,inputs:o}){const i=o.expanded?p`
        ...
        `}});const L=pt({"vira-icon-stroke-color":"currentColor","vira-icon-fill-color":"none","vira-icon-stroke-width":"1px"});function v({name:e,svgTemplate:t}){return{name:e,svgTemplate:t}}const s2=v({name:"CloseX24Icon",svgTemplate:u`
    ...
    `}),l2=v({name:"Element16Icon",svgTemplate:u`
...
`,ld=v({name:"LoaderAnimated24Icon",svgTemplate:u`
        ...
        ${c2.svgTemplate}
    `}),d2=v({name:"Options24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <g
                fill=${L["vira-icon-fill-color"].value}
                stroke=${L["vira-icon-stroke-color"].value}
        ...
        `,stateInitStatic:{forcedInputWidth:0},renderCallback:({inputs:e,dispatch:t,state:r,updateState:n,events:o})=>{const{filtered:i}=dd({value:e.value??"",allowed:e.allowedInputs,blocked:e.blockedInputs}),a=e.icon?u`
            ...
            <label>
                ...
                <input
                    ...
                    ?disabled=${e.disabled}
                    .value=${i}
                    ${S("input",l=>{h2({inputs:e,filteredValue:i,event:l,inputBlockedCallback(c){t(new o.inputBlocked(c))},newValueCallback(c){t(new o.valueChange(c))}})})}
    ...
    `,events:{routeChange:ee()},renderCallback({inputs:e,dispatch:t,events:r}){var o,i;function n(a){e.route&&Bo(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new r.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return u`
            ...
            `}}});const{defineElement:Ze,defineElementNoInputs:_v}=Da(),De=Ze()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>p`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `,renderCallback:({inputs:e,dispatch:t})=>{var n,o;const r=((o=e.router)==null?void 0:o.createRoutesUrl({...(n=e.router)==null?void 0:n.getCurrentRawRoutes(),...e.route}))??"#";return u`
        ...
        `}});function f2(e,t){return e.entry.entryType===pe.Root?!1:!!(e.entry.entryType===pe.Page||ht(t,e.fullUrlBreadcrumbs.slice(0,-1))||ht(t==null?void 0:t.slice(0,-1),e.fullUrlBreadcrumbs.slice(0,-1)))}const ct=Ze()({tagName:"book-nav",cssVars:{"book-nav-internal-indent":"0"},styles:({cssVars:e})=>p`
        :host {
            display: flex;
            flex-direction: column;
            padding: 16px 0;
    ...
    `,renderCallback({inputs:e}){const t=e.flattenedNodes.map(r=>{if(!f2(r,e.selectedPath))return;const n=p`
        ...
        `}});async function m2(e){await Fi(2);const t=e.shadowRoot.querySelector(".selected");if(!t)throw new Error("Failed to find selected nav tree element.");await Zh(t)||t.scrollIntoView({behavior:"smooth",block:"center"})}const Lt=Ze()({tagName:"book-error",styles:p`
        :host {
            display: flex;
            flex-direction: column;
            color: red;
    ...
    `,renderCallback({inputs:e,dispatch:t,events:r}){return Object.entries(e.config).length?Object.entries(e.config).map(([n,o],i)=>{if(o.controlType===O.Hidden)return"";const a=p2(e.currentValues[n],o,s=>{const l=J(e.fullUrlBreadcrumbs,"array")?e.fullUrlBreadcrumbs:e.fullUrlBreadcrumbs[n];if(!l)throw new Error(`Failed to find breadcrumbs from given control name: '${n}'`);t(new r.controlValueChange({fullUrlBreadcrumbs:l,newValues:{...e.currentValues,[n]:s}}))});return u`
                ...
                `}):""}});function p2(e,t,r){return Qt(t,O.Hidden)?"":Qt(t,O.Checkbox)?u`
            <input
                type="checkbox"
                .value=${e}
    ...
    `,events:{loadingRender:ee()},stateInitStatic:{lastElement:void 0},renderCallback:({inputs:e,dispatch:t,events:r,state:n,updateState:o})=>{const i=Wi(e.currentRoute.paths),a=g2({currentNodes:e.currentNodes,isTopLevel:!0,router:e.router,isSearching:!!i,controls:e.controls,originalTree:e.originalTree});return u`
            ...
            ${Le(e.showLoading,u`
                ...
                `,u`
                    ...
                    <slot name=${nt.Footer}></slot>
                `)}
        `}});function w2(e,t,r){const n=Al(e,t);if(n.length)return n;r(vr);const o=Al(e,vr.paths);if(!o)throw new Error(`Tried to self-correct for invalid path ${t.join("/")}
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{El(e,Wi(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:r,updateState:n,dispatch:o,events:i})=>{var f,h,m,g,w,$,k;t._debug&&console.info("rendering element-book app");function a(x){return{...e.currentRoute,...x}}function s(x){const C=a(x);return!ht(e.currentRoute,C)}function l(x){t.preventWindowTitleChange||(e.originalWindowTitle||n({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,x].filter(be).join(" - "))}function c(x){if(!s(x))return;const C=a(x);e.router?e.router.setRoutes(C):n({currentRoute:{...e.currentRoute,...C}}),t.elementBookRoutePaths&&!ht(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(C.paths??[]))}try{if(t.elementBookRoutePaths&&!ht(t.elementBookRoutePaths,e.currentRoute.paths)&&c({paths:t.elementBookRoutePaths}),(f=t.internalRouterConfig)!=null&&f.useInternalRouter&&!e.router){const W=x1(t.internalRouterConfig.basePath);n({router:W}),W.addRouteListener(!0,le=>{n({currentRoute:le})})}else!((h=t.internalRouterConfig)!=null&&h.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const x={themeColor:t.themeColor};if(!ht(x,(m=e.colors)==null?void 0:m.config)){const W=yl(x);n({colors:{config:x,theme:W}}),C1(r,W)}const C=t._debug??!1,D=a1({entries:t.entries,debug:C});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),n({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:Tu(D.tree,{children:(w=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:w.children,controls:t.globalValues})}}));const U=Wi(e.currentRoute.paths),fe=(U?f1({flattenedNodes:D.flattenedNodes,searchQuery:U}):void 0)??w2(D.flattenedNodes,e.currentRoute.paths,c);l(($=fe[0])==null?void 0:$.entry.title);const de=(k=e.treeBasedControls)==null?void 0:k.controls;return de?(t._debug&&console.info({currentControls:de}),u`
            ...
            `}}});async function El(e,t,r){if(t||r.paths.length<=1)return;const n=e.shadowRoot.querySelector(ct.tagName);if(!(n instanceof ct))throw new Error(`Failed to find child '${ct.tagName}'`);await m2(n)}const d=pt({"toniq-icon-fill-color":L["vira-icon-fill-color"].default,"toniq-icon-stroke-color":L["vira-icon-stroke-color"].default,"toniq-icon-stroke-width":"2px"}),z=ge(d,(e,t)=>r=>N(`var(${t.name}, ${r})`)),v2=v({name:"Copy16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),b2=v({name:"ExternalLink16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),y2=v({name:"ArrowBarUp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),$2=v({name:"ArrowLoopLeft24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),x2=v({name:"ArrowLoopRight24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),T2=v({name:"ArrowsSortAscending24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),S2=v({name:"ArrowsSortDescending24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),C2=v({name:"Bell24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),M2=v({name:"Bucket24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),A2=v({name:"BuildingStore24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),E2=v({name:"CalendarEvent24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),I2=v({name:"Cash24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),L2=v({name:"Chain24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),P2=v({name:"ChevronUp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),q2=v({name:"Circle24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),N2=v({name:"CirclePlus24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),O2=v({name:"CircleWavyCheck24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),B2=v({name:"Clock24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),D2=v({name:"Code24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),R2=v({name:"CreateFile24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),_2=v({name:"DotsVertical24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),H2=v({name:"Download24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),F2=v({name:"Edit24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),V2=v({name:"Envelope24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),z2=v({name:"Gear24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Z2=v({name:"Geometry24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),W2=v({name:"GridDots24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),U2=v({name:"Heart24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),G2=v({name:"Info24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Y2=v({name:"LayersLinked24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),J2=v({name:"LayoutGrid24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),K2=v({name:"Lifebuoy24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),X2=v({name:"List24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Q2=v({name:"ListDetails24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
...
`))}const R=(()=>{const e=p`
    ...
    `}),wp=v({name:"Upload24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),vp=v({name:"Wallet24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),bp=v({name:"WorldUpload24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),yp=v({name:"X24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),kp=v({name:"Folder48Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),$p=v({name:"Kyc48Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),xp=v({name:"CircleDashes64Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Sp=v({name:"CryptoBtc16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Cp=v({name:"CryptoBtc24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Mp=v({name:"CryptoCkBtc16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Ap=v({name:"CryptoCkBtc24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
...
`,Ep=v({name:"CryptoIcp16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Ip=v({name:"CryptoIcp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Pp=v({name:"BrandGoogleLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),qp=v({name:"BrandIcScan24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),Np=v({name:"BrandInstagramFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),Op=v({name:"BrandNftgeek24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),Bp=v({name:"BrandTiktokFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${z["toniq-icon-fill-color"]("#000")}
    ...
    `}),Rp=v({name:"EntrepotLogo144Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),yt={"core-16":[v2,b2,Ct],"core-24":[y2,k2,Wa,$2,x2,Ua,fd,T2,S2,C2,M2,A2,E2,I2,L2,md,pd,P2,q2,gd,N2,O2,B2,D2,wd,R2,_2,H2,F2,V2,vd,j2,z2,Z2,W2,U2,oa,G2,Y2,J2,K2,X2,Q2,ep,Ga,tp,rp,np,op,ip,ap,sp,lp,bd,yd,cp,up,dp,hp,gp,Jn,wp,vp,xd,bp,yp],"core-48":[kp,Td,$p],"core-64":[Sd,xp,Tp],cryptocurrencies:[Sp,Cp,Mp,Ap,Ep,Ip],"third-party-brands":[Ad,Ed,Id,Lp,Pp,qp,Ld,Np,Pd,Op,qd,Nd,Bp,Od,Bd],toniq:[Dp,Rp]},_p=pn({discord:tt(void 0,""),distrikt:tt(void 0,""),dscvr:tt(void 0,""),instagram:tt(void 0,""),medium:tt(void 0,""),telegram:tt(void 0,""),tikTok:tt(void 0,""),twitch:tt(void 0,""),twitter:tt(void 0,""),website:tt(void 0,"")}),Hp=_p.defaultValue,Dd={discord:Ad,instagram:Ld,telegram:qd,tikTok:Nd,distrikt:Ed,twitch:Od,dscvr:Id,medium:Pd,twitter:Bd,website:xd},Pl="toniq-",{defineElement:te,defineElementNoInputs:Rd}=Da({assertInputs:e=>{if(!e.tagName.startsWith(Pl))throw new Error(`Tag name should start with '${Pl}' but got '${e.tagName}'`)}}),Zt=te()({tagName:"toniq-bold-space",styles:p`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,renderCallback({inputs:e}){const t=e.icon?u`
        ...
        `}});function Fp(e,t,r={behavior:"smooth"}){let n=2;const o=t==="up"||t==="down"?"y":"x",i=t==="right"||t==="down"?"+":"-",a=o==="x"?e.scrollWidth-e.offsetWidth:e.scrollHeight-e.offsetHeight,s=Ja(e)[o];i==="-"&&(n*=-1);const l=e[o==="x"?"scrollLeft":"scrollTop"]+n,c=s.filter(h=>i==="+"?h>l:h<l).sort((h,m)=>i==="+"?h-m:m-h);let f;return c.length>0?f=c[0]:i==="+"?f=a:f=0,e.scrollTo({...r,[o==="x"?"left":"top"]:f})}function Vp(e){const t=window.getComputedStyle(e),r=e.getBoundingClientRect();let n=t.getPropertyValue("scroll-padding-left").replace("auto","0px"),o=t.getPropertyValue("scroll-padding-top").replace("auto","0px"),i=t.getPropertyValue("scroll-padding-right").replace("auto","0px"),a=t.getPropertyValue("scroll-padding-bottom").replace("auto","0px");function s(m,g){let w=parseFloat(m);return/%/.test(m)&&(w/=100,w*=g),w}let l=s(n,r.width),c=s(o,r.height),f=s(i,r.width),h=s(a,r.height);return{x:{before:l,after:f},y:{before:c,after:h}}}function jp(e,t,r="both"){return r==="x"&&e.right>=t.left&&e.left<=t.right||r==="y"&&e.bottom>=t.top&&e.top<=t.bottom||r==="both"&&e.right>=t.left&&e.left<=t.right&&e.bottom>=t.top&&e.top<=t.bottom}function _d(e){let t=[];for(const r of e.children)t=t.concat(r,_d(r));return t}function zp(e,t=!0){const r=e.getBoundingClientRect(),n={x:{start:[],center:[],end:[]},y:{start:[],center:[],end:[]}},o=_d(e);for(const i of["x","y"]){const a=i==="x"?"y":"x",s=i==="x"?"left":"top",l=i==="x"?"width":"height",c=i==="x"?"scrollLeft":"scrollTop";for(const f of o){const h=f.getBoundingClientRect();if(t&&!jp(r,h,a))continue;const m=window.getComputedStyle(f);let[g,w]=m.getPropertyValue("scroll-snap-align").split(" ");typeof w>"u"&&(w=g);const $=i==="x"?w:g,k=h[s]-r[s]+e[c];switch($){case"none":break;case"start":n[i].start.push(k);break;case"center":n[i].center.push(k+h[l]/2);break;case"end":n[i].end.push(k+h[l]);break}}}return n}function Ja(e){const t=e.getBoundingClientRect(),r=Vp(e),n=zp(e),o={x:e.scrollWidth-e.offsetWidth,y:e.scrollHeight-e.offsetHeight},i=(a,s)=>l=>Math.max(a,Math.min(s,l));return{x:ql([...n.x.start.map(a=>a-r.x.before),...n.x.center.map(a=>a-t.width/2),...n.x.end.map(a=>a-t.width+r.x.after)].map(i(0,o.x))),y:ql([...n.y.start.map(a=>a-r.y.before),...n.y.center.map(a=>a-t.height/2),...n.y.end.map(a=>a-t.height+r.y.after)].map(i(0,o.y)))}}function ql(e){return Array.from(new Set(e))}const Kn="templates-container",Zp=4e3;var aa=(e=>(e.Default="default",e.Banner="banner",e))(aa||{});const Ae=te()({tagName:"toniq-carousel",hostClasses:{"toniq-carousel-banner-variant":({inputs:e})=>e.variant==="banner"},stateInitStatic:{currentScrollPosition:{left:0,right:1/0},scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({hostClasses:e})=>p`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
    ...
    `,renderCallback:({inputs:e})=>u`
        ...
        `});async function x4(e){return navigator.clipboard.writeText(e)}const T4="…";function S4(e,t){const r=e.slice(0,t).trim(),n=e.slice(-1*t).trim();return`${r}${T4}${n}`}function C4(e){return!(e%1)}function M4(e){return e.letterCount==null?4:C4(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const we=te()({tagName:"toniq-middle-ellipsis",events:{copy:ee()},cssVars:{"toniq-middle-ellipsis-text-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":b.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":b.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>p`
        :host {
            /* 5 frames at 60 fps */
            transition: ${X.interaction};
            ${R.paragraphFont};
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:r,state:n,updateState:o}){if(!e.text)return u``;const i=e.text,a=M4(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,f=c?S4(i,a):i,h=c?i:"",m=s?vd:l?wd:void 0,g=m?u`
                  <${T.assign({icon:m})}></${T}>
              `:"",w=u`
        ...
        `;return f?s?u`
                ...
                `:l?u`
                    <button
                        ...
                        ${S("click",async()=>{await x4(i),t(new r.copy),n.showCopiedTextTimeoutId!=null&&window.clearTimeout(n.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${w} ${g}
                    </button>
                `:u`
                    ${w}
                `:u``}}),bc="...";function A4(e,t,r=7,n=5){let o;e=dr({value:e,min:1,max:t}),r=dr({value:r,min:n,max:t});const i=r-5,a=r-3;t<=r?o=r:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>r?Ii(t-o,t):e>o?Ii(Math.min(s.start,t-o),Math.min(s.end,t)):Ii(1,Math.min(t,o+1));function c(h,m){return l.length+1!==t?m:[h]}const f=l[l.length-1];if(f&&f<t){const h=c(t,[bc,t]);return[...l,...h]}else return l[0]!==1?c(1,[1,bc]).concat(l):l}function Ii(e,t){const r=t-e+1;return Array.from({length:r},(n,o)=>e+o)}te()({tagName:"toniq-pagination",styles:p`
        :host {
            display: flex;
        }
    ...
    `,events:{pageChange:ee()},renderCallback({inputs:e,events:t,dispatch:r}){return e.pageCount<=1?u``:u`
                ...
                ${A4(e.currentPage,e.pageCount,e.pagesShown).map(n=>typeof n=="string"?u`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:Vc()})},renderCallback({inputs:e,dispatch:t,events:r,state:n}){return E4(e.entries).map(i=>I4(e.groupName||n.randomGroupName,e.value,i,()=>{t(new r.valueChange(i.value))}))}});function E4(e){const t=Object.fromEntries(e.map(n=>[n.value,n]));return Object.values(t).length!==e.length&&console.error(`${Y.tagName} was given duplicate entry values.`),Object.values(t)}function I4(e,t,r,n){const o=t===r.value,i=u`
    ...
    `}function Li(e,t){const r=e[0],n=e[e.length-1];if(r==null||n==null)return 0;if(t<r)return r;if(t>n)return n;const o=e.findIndex((c,f)=>{const h=e[f+1];return h==null?!0:c<=t&&h>=t});if(o<0)return r;const i=e[o];if(i==null)return r;const a=e[o+1];if(a==null)return i;const s=t-i,l=a-t;return s<l?o:o+1}function L4(e,t,r=100){e>t&&([e,t]=[t,e]),r<2&&(r=2);let n=P4(e);const o=[e];for(;n<t;){const i=Math.pow(10,String(n).length-1),a=n+i;a<t&&o.push(a),n=a}return o.push(t),o.length>r&&(yc(o,r),o.length>r&&yc(o,r)),o}function yc(e,t){const r=e.length-t,n=(e.length-2)/r;for(let o=e.length-2;o>=1;o-=n)e.splice(Math.floor(o),1)}function P4(e){let t=1;if(!e)return e;e<0&&(t=-1,e=e*-1);const r=e.toFixed(0),n=Math.pow(10,r.length-1),o=Number(r[0]||1);return n*o*t}const q={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},Or={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"};function q4(e){var n,o;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${q.lowerLabelWrapper} .${q.labelPercentMarginWrapper}`),r=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${q.upperLabelWrapper} .${q.labelPercentMarginWrapper}`);if(r instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),a=r.getBoundingClientRect();return{lower:i,upper:a}}else return}function N4(e,t=8){const r=q4(e);if(!r)return 0;const n=r.lower.right-r.upper.left+t;return Math.max(0,n)}function Pi({value:e,limits:t,flip:r}){const o=(t.max-e)/(t.max-t.min)*100;return-(r?100-o:o)}function un(e){return je(e)&&e.min!==void 0&&e.max!==void 0}function ba(e){var r;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${q.range}`);return(t==null?void 0:t.clientWidth)??0}function qi(e,t,r){return`${r?Hh(e):e} ${t}`}function O4({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function B4({value:e,double:t,min:r,max:n}){return t?un(e)?{min:dr({value:e.min,min:r,max:Math.min(e.max,n)}),max:dr({value:e.max,min:Math.max(e.min,r),max:n})}:{min:r,max:n}:un(e)?r:dr({value:e,min:r,max:n})}function D4({actualValue:e,actualLimits:t,logScale:r,logRange:n}){return r?{elementValue:un(e)?{min:Li(n,e.min),max:Li(n,e.max)}:Li(n,e),elementLimits:{min:0,max:n.length-1}}:{elementValue:e,elementLimits:t}}function Ni(e,t,r){return r?t[e]||0:e}function R4(e){return{actualLimits:O4(e),actualValue:B4(e)}}function _4(e,t){var n,o,i;let r=!1;if(un(e)){const a=(n=t.shadowRoot)==null?void 0:n.querySelector(`.${q.lowerSlider}`),s=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${q.upperSlider}`);a instanceof HTMLInputElement&&s instanceof HTMLInputElement&&(Number(a.value)!==e.min&&(a.value=String(e.min),r=!0),Number(s.value)!==e.max&&(s.value=String(e.max),r=!0))}else{const a=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${q.slider}`);a instanceof HTMLInputElement&&Number(a.value)!==e&&(a.value=String(e),r=!0)}return r}function Z0(e,t){const{actualValue:r,actualLimits:n}=R4({...e}),o=L4(n.min,n.max),i=e.logScale??!1,a=e.suffix??"",{elementValue:s,elementLimits:l}=D4({actualValue:r,actualLimits:n,logScale:i,logRange:o}),c=ba(t);return{actualValue:r,elementLimits:l,elementValue:s,isLogScale:i,logRange:o,rangeWidth:c,suffix:a}}const _t=16,kc=p`
    ${_t}px
`,$c=p`
...
`,xc=p`
    transform: scale(1.2);
`;function Vr(e){requestAnimationFrame(()=>{const t=Z0(e.instanceInputs,e).elementValue;_4(t,e)&&(e.setAttribute("disabled","true"),Vr(e))})}const F=te()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ee()},styles:p`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Vr(e)}),e.addEventListener("keydown",()=>{Vr(e)}),e.addEventListener("keyup",()=>{Vr(e)})},renderCallback({inputs:e,host:t,events:r,dispatch:n,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:f,elementLimits:h,rangeWidth:m}=Z0({...e},t);if(Vr(t),un(f))return g(a,f,h);return $(a,f,h);function g(k,x,C){const D={left:Ht((m-_t)*(x.min-C.min)/(C.max-C.min)+_t/2),right:Ht((m-_t)*(C.max-x.max)/(C.max-C.min)+_t/2)},U=qi(k.min,c,l),se=qi(k.max,c,l);requestAnimationFrame(()=>{const $e=N4(t);$e!==o.labelOverlap&&i({labelOverlap:$e})});const fe=(C.max-x.max)/(C.max-C.min)>.5,de=Pi({value:x.min,limits:{min:C.min,max:x.max},flip:!0}),W=Pi({value:x.max,limits:{min:x.min,max:C.max},flip:!1}),le=o.labelOverlap&&fe?o.labelOverlap:0,We=o.labelOverlap&&!fe?o.labelOverlap:0;return u`
                <div
                    class="range"
    ...
    `,renderCallback({inputs:e}){return u`
            <${T.assign({icon:e.icon})}></${T}>
        `}}),Wo=Object.values(yt).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),H4=Object.keys(Wo).sort();function as(e){return{controlType:O.Dropdown,initValue:e,options:["None",...H4]}}const G0={"CSS color":{controlType:O.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:O.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:O.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:O.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:O.Number,initValue:2}};function ro(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),J(n,"number")&&(n=ka({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
`)}const F4=_({title:"Social Urls",parent:U0,elementExamplesCallback({defineExample:e}){function t({socialName:r,icon:n}){e({title:r,renderCallback(){return u`
                        <${Mo.assign({icon:n})}></${Mo}>
                    `}})}Object.entries(Dd).forEach(([r,n])=>{t({socialName:r,icon:n})})}}),re=_({title:"Elements",parent:void 0}),V4=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:p`
            ${Zt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],j4=_({title:Zt.tagName,parent:re,elementExamplesCallback({defineExample:e}){V4.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:p`
                    .bold {
                        ${R.boldFont}
                    }
...
`,Z4=_({parent:re,title:Ae.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:Tc,renderCallback(){return u`
                ...
                `;return u`
                    ...
                    ></${Ae}>
                `}})}});function W4(e){const t=Object.keys(e.cssVars).map(r=>[`--${r}`,{controlType:O.Color,initValue:""}]);return Object.fromEntries(t)}function U4(e){const t=Object.entries(e).map(([r,n])=>{if(r.startsWith("--"))return typeof n!="string"||!n?void 0:`${r}: ${n};`}).filter(be);return N(t.join(`
`))}const G4=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],Bi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],Y4=_({parent:re,title:gt.tagName,controls:{Text:{controlType:O.Text,initValue:"Text"},...W4(gt)},elementExamplesCallback({defineExample:e}){G4.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:Bi.map(r=>!!r.inputs.checked),extraEntryStatuses:Bi.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:p`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Bi.map((i,a)=>{const s=(i.extraEntries??[]).map((c,f)=>{var h;return u`
                        ...
                        `})}})})}}),J4=_({parent:re,title:wi.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Ct}},{inputs:{icon:Ct}},{inputs:{},template:u`
                    HTML child
        ...
        `},{customStyle:p`
            max-height: 30px;
            min-height: 30px;
        `}],Q4=_({title:Hn.tagName,parent:re,controls:{Selected:{controlType:O.Dropdown,initValue:Vn[0].label,options:Vn.map(e=>e.label)},Direction:{controlType:O.Dropdown,initValue:"Down",options:Dc(pa)},Icon:as(fd.name),Prefix:{controlType:O.Text,initValue:"Sort by: "},"Force open":{controlType:O.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){X4.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Sc.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:p`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Sc.map((i,a)=>{const s=p`
                        ...
                        `;return u`
                            ...
                            ></${Hn}>
                        `})}})})}}),ev=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],tv=_({title:Ai.tagName,parent:re,elementExamplesCallback({defineExample:e}){ev.forEach(t=>{e({title:t.title,renderCallback(){return u`
                        <${Ai}>${t.content}</${Ai}>
                    `}})})}}),Cc="/toniq-labs-design-system";function Y0(...e){const r=[globalThis.location.pathname.startsWith(Cc)?Cc:"",...e].filter(be);return Oh(...r)}const ir=Array(30).fill(Y0("/toniq-labs-logo.png")),ur=["Hello there.","There is stuff here."],jn=ur.concat(Array(30).fill(ur)),rv=_({title:K.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${K.assign({infoParagraphs:jn,imageUrls:ir,socialUrls:Hp,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${K}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${K.assign({imageUrls:ir.map((t,r)=>r%2?"/invalid-image.png":t),infoParagraphs:ur,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return u`
                            ...
                            `}})}></${K}>
                `}})}}),nv=_({title:zt.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:p`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:r}){return u`
                ...
                `}})}}),ov=_({title:Me.tagName,parent:re,elementExamplesCallback({defineExample:e}){Rc(lr).forEach(t=>{e({title:t,renderCallback(){return u`
            ...
            `,renderCallback({controls:r}){return u`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            ...
                            ></${Fn}>
                        `))}})})}}),lv=_({title:Ei.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:eo.Small}},{title:"large",inputs:{size:eo.Large}},{title:"whole page",inputs:{size:eo.WholePage},styles:p`
                    :host {
                        width: 500px;
                    }
                `}].forEach(r=>{e({title:r.title,styles:r.styles??p``,renderCallback(){return u`
                        <${Ei.assign(r.inputs)}></${Ei}>
                    `}})})}}),cv=_({title:we.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
            ...
            `,renderCallback(){return u`
                ...
                `}})}}),uv=_({title:Nr.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:p`
                ${Nr} {
                    height: 32px;
                }
...
`,Di={min:10,max:50},hv=_({title:F.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:p`
                ${st}
            `,renderCallback({state:t,updateState:r}){return u`
            ...
            `,renderCallback({state:t,updateState:r}){return u`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Mc.map((i,a)=>u`
                            ...
                            ></${Oi}>
                        `)}})})}}),pv=_({parent:re,title:to.tagName,elementExamplesCallback({defineExample:e}){function t({title:r,tooltipContent:n,forceShow:o}){e({title:r,styles:p`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),gv=_({parent:re,title:Yr.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${to.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return u`
                    <${Yr}>This is a tooltip.</${Yr}>
                `}})}}),wv=[pv,gv],vv=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:p`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:p``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:p``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:oa},{label:"label here",value:2,icon:oa},{label:"",value:3,icon:Ct,disabled:!0},{label:"16px icon",value:4,icon:Ct},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],bv=_({title:jr.tagName,parent:re,elementExamplesCallback({defineExample:e}){vv.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:p`
                ...
                `,renderCallback({state:r,updateState:n}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return u`
                        ...
                        ></${jr}>
                    `}})})}}),J0=_({title:"Icons",parent:void 0,controls:G0}),yv=Object.entries(yt).map(([e,t])=>_({title:e,parent:J0,elementExamplesCallback({defineExample:r}){t.map(n=>r({title:n.name,renderCallback({controls:o}){return u`
                                <${Mo.assign({icon:n})}
                                    style=${ro(o)}
                                ></${Mo}>
                            `}}))}}));function K0(e){const t=kv(e),r=ge(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return oe(r).reduce((o,i)=>{const a=r[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function kv(e){typeof e!="string"&&(e=String(e));const n=`{"${Lc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const Uo=_({title:"Styles",parent:void 0}),$v=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function xv(e,t,r){const n=K0(j(r));return e({title:t,styles:$v,renderCallback(){return u`
            ...
            `}})}const Tv=_({title:"Colors",parent:Uo,elementExamplesCallback({defineExample:e}){oe(b).map(t=>xv(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),Sv=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function Cv(e,t,r){const n=K0(r);return e({title:t,styles:Sv,renderCallback(){return u`
            ...
            `}})}const Mv=_({title:"Fonts",parent:Uo,elementExamplesCallback({defineExample:e}){oe(R).map(t=>{const r=R[t];return Cv(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),Av=_({title:"Shadows",parent:Uo,elementExamplesCallback({defineExample:e}){ah(ln).forEach(([t,r])=>{e({title:t,styles:p`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return u`
                            <div></div>
                        `}})})}}),Ev=[re,J0,Uo,U0],Iv=[...yv,...wv,F4,j4,z4,Z4,Y4,J4,Tv,K4,Q4,tv,rv,nv,Mv,ov,iv,av,sv,lv,cv,uv,dv,Av,hv,mv,bv].sort((e,t)=>e.title.localeCompare(t.title)),Lv=[...Ev,...Iv];Oo({tagName:"toniq-design-system-app",styles:p`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return u`
            <${mi.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:Lv,themeColor:"#00D093"})}>
