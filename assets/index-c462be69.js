...
`,$d=v({name:"LoaderAnimated24Icon",svgTemplate:u`
    ...
    `,events:{routeChange:re()},renderCallback({inputs:e,dispatch:t,events:r}){var o,i;function n(a){e.route&&jo(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new r.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return u`
            ...
            `}}});const{defineElement:Ue,defineElementNoInputs:mv}=Ja(),He=Ue()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>p`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `,renderCallback({inputs:e}){const t=e.flattenedNodes.map(r=>{if(!Ep(r,e.selectedPath))return;const n=p`
            ...
            `;return u`
                <li style=${n}>
                    <${He.assign({router:e.router,route:{paths:[Se.Book,...r.fullUrlBreadcrumbs]}})}
            ...
            `});return u`
            <${He.assign({route:$r,router:e.router})}>
                <slot name=${at.NavHeader}>Book</slot>
            </${He}>
            <ul>
                ${t}
            </ul>
        `}});async function Ip(e){await Qi(2);const t=e.shadowRoot.querySelector(".selected");if(!t)throw new Error("Failed to find selected nav tree element.");await sf(t)||t.scrollIntoView({behavior:"smooth",block:"center"})}const Lt=Ue()({tagName:"book-error",styles:p`
        :host {
            display: flex;
            flex-direction: column;
            color: red;
    ...
    `,renderCallback({inputs:e,dispatch:t,events:r}){return Object.entries(e.config).length?Object.entries(e.config).map(([n,o],i)=>{if(o.controlType===H.Hidden)return"";const a=qp(e.currentValues[n],o,s=>{const l=Q(e.fullUrlBreadcrumbs,"array")?e.fullUrlBreadcrumbs:e.fullUrlBreadcrumbs[n];if(!l)throw new Error(`Failed to find breadcrumbs from given control name: '${n}'`);t(new r.controlValueChange({fullUrlBreadcrumbs:l,newValues:{...e.currentValues,[n]:s}}))});return u`
                ...
                `}):""}});function qp(e,t,r){return er(t,H.Hidden)?"":er(t,H.Checkbox)?u`
            <input
                type="checkbox"
                .value=${e}
    ...
    `,renderCallback:({inputs:e})=>{const t=e.currentRoute.paths.slice(1);return t.length?t.map((r,n,o)=>{const i=n>=o.length-1,a=o.slice(0,n+1),s=i?"":u`
                  ...
                  `;return u`
                <${He.assign({route:{hash:void 0,search:void 0,paths:[Se.Book,...a]},router:e.router})}>
                    ${r}
                </${He}>
                ${s}
            `}):u`
    ...
    `,events:{loadingRender:re()},stateInitStatic:{lastElement:void 0},renderCallback:({inputs:e,dispatch:t,events:r,state:n,updateState:o})=>{const i=ia(e.currentRoute.paths),a=Pp({currentNodes:e.currentNodes,isTopLevel:!0,router:e.router,isSearching:!!i,controls:e.controls,originalTree:e.originalTree});return u`
            ...
            ${xe(e.showLoading,u`
                ...
                `,u`
                    ...
                    <slot name=${at.Footer}></slot>
                `)}
        `}});function Lp(e,t,r){const n=_l(e,t);if(n.length)return n;r($r);const o=_l(e,$r.paths);if(!o)throw new Error(`Tried to self-correct for invalid path ${t.join("/")}
                        but failed to do so.`);return o}function _l(e,t){return e.filter(r=>af({searchFor:t.slice(1),searchIn:r.fullUrlBreadcrumbs}))}const xi=Nu()({tagName:"element-book-app",events:{pathUpdate:re()},stateInitStatic:{currentRoute:$r,router:void 0,loading:!0,colors:{config:void 0,theme:Pl(void 0)},treeBasedControls:void 0,originalWindowTitle:void 0},styles:p`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{Fl(e,ia(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:r,updateState:n,dispatch:o,events:i})=>{var f,h,m,g,w,k,$;t._debug&&console.info("rendering element-book app");function a(C){return{...e.currentRoute,...C}}function s(C){const S=a(C);return!it(e.currentRoute,S)}function l(C){t.preventWindowTitleChange||(e.originalWindowTitle||n({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,C].filter(we).join(" - "))}function c(C){if(!s(C))return;const S=a(C);e.router?e.router.setRoutes(S):n({currentRoute:{...e.currentRoute,...S}}),t.elementBookRoutePaths&&!it(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(S.paths??[]))}try{if(t.elementBookRoutePaths&&!it(t.elementBookRoutePaths,e.currentRoute.paths)&&c({paths:t.elementBookRoutePaths}),(f=t.internalRouterConfig)!=null&&f.useInternalRouter&&!e.router){const _=H1(t.internalRouterConfig.basePath);n({router:_}),_.addRouteListener(!0,ae=>{n({currentRoute:ae})})}else!((h=t.internalRouterConfig)!=null&&h.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const C={themeColor:t.themeColor};if(!it(C,(m=e.colors)==null?void 0:m.config)){const _=Pl(C);n({colors:{config:C,theme:_}}),V1(r,_)}const S=t._debug??!1,D=$1({entries:t.entries,debug:S});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),n({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:Ru(D.tree,{children:(w=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:w.children,controls:t.globalValues})}}));const j=ia(e.currentRoute.paths),ie=(j?E1({flattenedNodes:D.flattenedNodes,searchQuery:j}):void 0)??Lp(D.flattenedNodes,e.currentRoute.paths,c);l((k=ie[0])==null?void 0:k.entry.title);const ce=($=e.treeBasedControls)==null?void 0:$.controls;return ce?(t._debug&&console.info({currentControls:ce}),u`
                ...
                >
                    ...
                    <${nr.assign({controls:ce,currentNodes:ie,currentRoute:e.currentRoute,debug:S,originalTree:D.tree,router:e.router,showLoading:e.loading})}
                        ${y(nr.events.loadingRender,async _=>{await Qi();const ae=r.shadowRoot.querySelector(nr.tagName);ae?ae.scroll({top:0,behavior:"instant"}):console.error(`Failed to find '${nr.tagName}' for scrolling.`),await Qi(),n({loading:!_.detail})})}
                    >
                        <slot
                            name=${at.Footer}
                            slot=${at.Footer}
...
`))}const B=(()=>{const e=p`
    ...
    `}),Hp=v({name:"ArrowBarUp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),_p=v({name:"ArrowForwardUp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Hm=v({name:"Folder48Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),_m=v({name:"Kyc48Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Vm=v({name:"Wallet48Icon",svgTemplate:u`
    ...
    `}),_d=v({name:"Api64Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),zm=v({name:"Rocket64Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Wm=v({name:"CryptoCkBtc16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Um=v({name:"CryptoCkBtc24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
...
`,Gm=v({name:"CryptoIcp16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Ym=v({name:"CryptoIcp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Jm=v({name:"BrandFacebookLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),Km=v({name:"BrandGoogleLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),Xm=v({name:"BrandIcScan24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),Qm=v({name:"BrandInstagramFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),eg=v({name:"BrandNftgeek24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),tg=v({name:"BrandTiktokFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${U["toniq-icon-fill-color"]("#000")}
    ...
    `}),ng=v({name:"EntrepotLogo144Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),$t={"core-16":[Ed,Dp,Rp,At],"core-24":[Hp,_p,as,Fp,Vp,ss,Id,jp,zp,Zp,Wp,Up,Gp,Yp,Jp,qd,Pd,Kp,Xp,Ld,Qp,em,tm,rm,Nd,nm,om,im,am,sm,Od,lm,cm,um,dm,hm,fm,wa,pm,mm,gm,wm,vm,bm,ym,ls,km,$m,xm,Tm,Cm,Sm,Mm,Am,Bd,Dd,Em,Im,qm,Pm,Lm,Nm,io,Om,Bm,Rd,Dm,Rm],"core-48":[Hm,Hd,_m,Fm,Vm],"core-64":[_d,jm,zm],cryptocurrencies:[Zm,Go,Wm,Um,Gm,Ym],"third-party-brands":[jd,zd,Zd,Jm,Km,Xm,Wd,Qm,Ud,eg,Gd,Yd,tg,Jd,Kd],toniq:[rg,ng]},og=Tn({discord:rt(void 0,""),distrikt:rt(void 0,""),dscvr:rt(void 0,""),instagram:rt(void 0,""),medium:rt(void 0,""),telegram:rt(void 0,""),tikTok:rt(void 0,""),twitch:rt(void 0,""),twitter:rt(void 0,""),website:rt(void 0,"")}),ig=og.defaultValue,Xd={discord:jd,instagram:Wd,telegram:Gd,tikTok:Yd,distrikt:zd,twitch:Jd,dscvr:Zd,medium:Ud,twitter:Kd,website:Rd},zl="toniq-",{defineElement:ne,defineElementNoInputs:cs}=Ja({assertInputs:e=>{if(!e.tagName.startsWith(zl))throw new Error(`Tag name should start with '${zl}' but got '${e.tagName}'`)}}),Ut=ne()({tagName:"toniq-bold-space",styles:p`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,renderCallback:({inputs:e})=>u`
        ...
        `}),qc="...";function V4(e,t,r=7,n=5){let o;e=pr({value:e,min:1,max:t}),r=pr({value:r,min:n,max:t});const i=r-5,a=r-3;t<=r?o=r:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>r?Ri(t-o,t):e>o?Ri(Math.min(s.start,t-o),Math.min(s.end,t)):Ri(1,Math.min(t,o+1));function c(h,m){return l.length+1!==t?m:[h]}const f=l[l.length-1];if(f&&f<t){const h=c(t,[qc,t]);return[...l,...h]}else return l[0]!==1?c(1,[1,qc]).concat(l):l}function Ri(e,t){const r=t-e+1;return Array.from({length:r},(n,o)=>e+o)}const Hi=ne()({tagName:"toniq-pagination",styles:p`
        :host {
            display: flex;
        }
    ...
    `,events:{pageChange:re()},renderCallback({inputs:e,events:t,dispatch:r}){return e.pageCount<=1?u``:u`
            ...
            `}}),_i=b.pageInteraction.foregroundColor,Fi=b.accentSecondary.backgroundColor,De=ne()({tagName:"toniq-list-table",cssVars:{"toniq-list-table-border-width":"1px","toniq-list-table-border-hover-width":"2px","toniq-list-table-header-radius":"16px","toniq-list-table-row-gap":"36px"},events:{pageChange:re()},styles:({cssVars:e})=>p`
        :host {
            display: flex;
            overflow-x: auto;
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:r,state:n,updateState:o}){if(!e.text)return u``;const i=e.text,a=U4(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,f=c?Z4(i,a):i,h=c?i:"",m=s?Od:l?Nd:void 0,g=m?u`
                  <${T.assign({icon:m})}></${T}>
              `:"",w=u`
        ...
        `;return f?s?u`
                ...
                `:l?u`
                    <button
                        ...
                        ${y("click",async()=>{await j4(i),t(new r.copy),n.showCopiedTextTimeoutId!=null&&window.clearTimeout(n.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${w} ${g}
                    </button>
                `:u`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:ru()})},renderCallback({inputs:e,dispatch:t,events:r,state:n}){return G4(e.entries).map(i=>Y4(e.groupName||n.randomGroupName,e.value,i,()=>{t(new r.valueChange(i.value))}))}});function G4(e){const t=Object.fromEntries(e.map(n=>[n.value,n]));return Object.values(t).length!==e.length&&console.error(`${J.tagName} was given duplicate entry values.`),Object.values(t)}function Y4(e,t,r,n){const o=t===r.value,i=u`
    ...
    `}function Vi(e,t){const r=e[0],n=e[e.length-1];if(r==null||n==null)return 0;if(t<r)return r;if(t>n)return n;const o=e.findIndex((c,f)=>{const h=e[f+1];return h==null?!0:c<=t&&h>=t});if(o<0)return r;const i=e[o];if(i==null)return r;const a=e[o+1];if(a==null)return i;const s=t-i,l=a-t;return s<l?o:o+1}function J4(e,t,r=100){e>t&&([e,t]=[t,e]),r<2&&(r=2);let n=K4(e);const o=[e];for(;n<t;){const i=Math.pow(10,String(n).length-1),a=n+i;a<t&&o.push(a),n=a}return o.push(t),o.length>r&&(Pc(o,r),o.length>r&&Pc(o,r)),o}function Pc(e,t){const r=e.length-t,n=(e.length-2)/r;for(let o=e.length-2;o>=1;o-=n)e.splice(Math.floor(o),1)}function K4(e){let t=1;if(!e)return e;e<0&&(t=-1,e=e*-1);const r=e.toFixed(0),n=Math.pow(10,r.length-1),o=Number(r[0]||1);return n*o*t}const q={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},Hr={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"},rn={hot:"rgb(200,0,0)",medium:"orange",cold:"rgb(0,200,0)"};function ar(e){return p`
        background-color: ${M(rn[e])};
        color: ${M(rn[e])};
    `}function X4(e){var n,o;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${q.lowerLabelWrapper} .${q.labelPercentMarginWrapper}`),r=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${q.upperLabelWrapper} .${q.labelPercentMarginWrapper}`);if(r instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),a=r.getBoundingClientRect();return{lower:i,upper:a}}else return}function Q4(e,t=8){const r=X4(e);if(!r)return 0;const n=r.lower.right-r.upper.left+t;return Math.max(0,n)}function ji({value:e,limits:t,flip:r}){const o=(t.max-e)/(t.max-t.min)*100;return-(r?100-o:o)}function bn(e){return Ze(e)&&e.min!==void 0&&e.max!==void 0}function Pa(e){var r;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${q.range}`);return(t==null?void 0:t.clientWidth)??0}function zi(e,t,r){return`${r?tf(e):e} ${t}`}function e5({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function t5({value:e,double:t,min:r,max:n}){return t?bn(e)?{min:pr({value:e.min,min:r,max:Math.min(e.max,n)}),max:pr({value:e.max,min:Math.max(e.min,r),max:n})}:{min:r,max:n}:bn(e)?r:pr({value:e,min:r,max:n})}function r5({actualValue:e,actualLimits:t,logScale:r,logRange:n}){return r?{elementValue:bn(e)?{min:Vi(n,e.min),max:Vi(n,e.max)}:Vi(n,e),elementLimits:{min:0,max:n.length-1}}:{elementValue:e,elementLimits:t}}function Zi(e,t,r){return r?t[e]||0:e}function n5(e){return{actualLimits:e5(e),actualValue:t5(e)}}function o5(e,t){var n,o,i;let r=!1;if(bn(e)){const a=(n=t.shadowRoot)==null?void 0:n.querySelector(`.${q.lowerSlider}`),s=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${q.upperSlider}`);a instanceof HTMLInputElement&&s instanceof HTMLInputElement&&(Number(a.value)!==e.min&&(a.value=String(e.min),r=!0),Number(s.value)!==e.max&&(s.value=String(e.max),r=!0))}else{const a=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${q.slider}`);a instanceof HTMLInputElement&&Number(a.value)!==e&&(a.value=String(e),r=!0)}return r}function ih(e,t){const{actualValue:r,actualLimits:n}=n5({...e}),o=J4(n.min,n.max),i=e.logScale??!1,a=e.suffix??"",{elementValue:s,elementLimits:l}=r5({actualValue:r,actualLimits:n,logScale:i,logRange:o}),c=Pa(t);return{actualValue:r,elementLimits:l,elementValue:s,isLogScale:i,logRange:o,rangeWidth:c,suffix:a}}const Ft=16,Lc=p`
    ${Ft}px
`,Nc=p`
...
`,Oc=p`
    transform: scale(1.2);
`;function i5(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Wr(e){requestAnimationFrame(()=>{const t=ih(e.instanceInputs,e).elementValue;o5(t,e)&&(e.setAttribute("disabled","true"),Wr(e))})}const R=ne()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:re()},styles:p`
        :host {
            display: block;
        }
                ...
                >
                    ...
                    <div class="slider-wrapper">
                        <input
                            ...
                            .max=${S.max}
                            .value=${C.min}
                            ${y("input",ve=>{const lt=ve.target,Pr={...$,min:Zi(Number(lt.value),s,l)};w(Pr)})}
                        />
                        <input
                            ?disabled=${e.disabled??!1}
                            type="range"
                            ...
                            .value=${C.max}
                            ${cr(Hr.slider)}
                            ${y("input",ve=>{const lt=ve.target,Pr={...$,max:Zi(Number(lt.value),s,l)};w(Pr)})}
                        />
                    </div>
                </div>
            `}function w($){i({internalValue:$}),e.disabled||n(new r.valueChange($))}function k($,C,S){const D=Vt((m-Ft)*(S.max-C)/(S.max-S.min)+Ft/2),j=zi($,c,l),ee=ji({value:C,limits:S,flip:!1});return u`
                ...
                >
                    ...
                    <input
                        ?disabled=${e.disabled??!1}
                        type="range"
                        class="${q.slider} ${e.colorTemperature?i5(Math.abs(ee)):""}"
                        step=${e.step}
                        .min=${S.min}
                        .max=${S.max}
                        .value=${C}
                        ${cr(Hr.slider)}
                        ${y("input",ie=>{const ce=ie.target,_=Zi(Number(ce.value),s,l);w(_)})}
                    />
                </div>
    ...
    `,renderCallback({inputs:e}){return u`
            <${T.assign({icon:e.icon})}></${T}>
        `}}),ei=Object.values($t).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),a5=Object.keys(ei).sort();function ys(e){return{controlType:H.Dropdown,initValue:e,options:["None",...a5]}}const lh={"CSS color":{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Number,initValue:2}};function uo(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),Q(n,"number")&&(n=Na({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
`)}const s5=V({title:"Social Urls",parent:sh,elementExamplesCallback({defineExample:e}){function t({socialName:r,icon:n}){e({title:r,renderCallback(){return u`
                        <${No.assign({icon:n})}></${No}>
                    `}})}Object.entries(Xd).forEach(([r,n])=>{t({socialName:r,icon:n})})}}),oe=V({title:"Elements",parent:void 0}),l5=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:p`
            ${Ut} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],c5=V({title:Ut.tagName,parent:oe,elementExamplesCallback({defineExample:e}){l5.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:p`
                    .bold {
                        ${B.boldFont}
                    }
...
`,d5=V({parent:oe,title:Ie.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:Bc,renderCallback(){return u`
                ...
                `;return u`
                    ...
                    ></${Ie}>
                `}})}});function h5(e){const t=Object.keys(e.cssVars).map(r=>[`--${r}`,{controlType:H.Color,initValue:""}]);return Object.fromEntries(t)}function f5(e){const t=Object.entries(e).map(([r,n])=>{if(r.startsWith("--"))return typeof n!="string"||!n?void 0:`${r}: ${n};`}).filter(we);return M(t.join(`
`))}const p5=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],Ui=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],m5=V({parent:oe,title:vt.tagName,controls:{Text:{controlType:H.Text,initValue:"Text"},...h5(vt)},elementExamplesCallback({defineExample:e}){p5.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:Ui.map(r=>!!r.inputs.checked),extraEntryStatuses:Ui.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:p`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Ui.map((i,a)=>{const s=(i.extraEntries??[]).map((c,f)=>{var h;return u`
                        ...
                        `})}})})}}),g5=V({parent:oe,title:Si.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:At}},{inputs:{icon:At}},{inputs:{},template:u`
                    HTML child
        ...
        `},{customStyle:p`
            max-height: 30px;
            min-height: 30px;
        `}],b5=V({title:Yn.tagName,parent:oe,controls:{Selected:{controlType:H.Dropdown,initValue:Kn[0].label,options:Kn.map(e=>e.label)},Direction:{controlType:H.Dropdown,initValue:"Down",options:Kc(Aa)},Icon:ys(Id.name),Prefix:{controlType:H.Text,initValue:"Sort by: "},"Force open":{controlType:H.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){v5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Dc.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:p`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Dc.map((i,a)=>{const s=p`
                        ...
                        `;return u`
                            ...
                            ></${Yn}>
                        `})}})})}}),y5=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],k5=V({title:Di.tagName,parent:oe,elementExamplesCallback({defineExample:e}){y5.forEach(t=>{e({title:t.title,renderCallback(){return u`
                        <${Di}>${t.content}</${Di}>
                    `}})})}}),Rc="/toniq-labs-design-system";function ch(...e){const r=[globalThis.location.pathname.startsWith(Rc)?Rc:"",...e].filter(we);return sn(...r)}const sr=Array(30).fill(ch("/toniq-labs-logo.png")),hr=["Hello there.","There is stuff here."],Xn=hr.concat(Array(30).fill(hr)),$5=V({title:te.tagName,parent:oe,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${te.assign({infoParagraphs:Xn,imageUrls:sr,socialUrls:ig,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${te}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${te.assign({imageUrls:sr.map((t,r)=>r%2?"/invalid-image.png":t),infoParagraphs:hr,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return u`
                            ...
                            `}})}></${te}>
                `}})}}),x5=V({title:Wt.tagName,parent:oe,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:p`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:r}){return u`
                ...
                `}})}}),T5=V({title:Ee.tagName,parent:oe,elementExamplesCallback({defineExample:e}){Xc(ur).forEach(t=>{e({title:t,renderCallback(){return u`
            ...
            `,renderCallback({controls:r}){return u`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            ...
                            ></${Jn}>
                        `))}})})}});function ti({entries:e,columns:t,createRowObject:r}){const n=Object.fromEntries(t.map(i=>[i.key,""]));return{rows:e.map((i,a)=>{const s=r(i,a);if(!it(Object.keys(n).sort(),Object.keys(s.cells).sort()))throw console.error("broken list table row",{cells:s.cells,columns:n}),new Error("List table row keys does not match expect column keys.");return s}),columns:t}}const uh="https://cdn-bitcoin.bioniq.io",A5=sn(uh,"content"),E5=sn(uh,"thumbnail"),fr={thumbnail(e){return sn(E5,e)},content(e){return sn(A5,e)}},I5=Array(5).fill({imageUrl:fr.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:u`
        <div
            style=${p`
                display: flex;
                gap: 8px;
    ...
    `}),q5=[{imageUrl:fr.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Payment Sent",price:u`
            <div
                style=${p`
                    display: flex;
                    gap: 8px;
        ...
        `}],P5=[],L5=Array(5).fill({imageUrl:fr.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:u`
        <div
            style=${p`
                display: flex;
                gap: 8px;
    ...
    `}),Gi=ti({entries:I5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE",mobile:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:u`
                    <img
                        style=${p`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),Hc=ti({entries:q5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:u`
                    <img
                        style=${p`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),N5=ti({entries:P5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:u`
                    <img
                        style=${p`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),O5=ti({entries:L5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME",style:p`
                display: flex;
                justify-content: flex-end;
            `}],createRowObject:e=>({cells:{image:u`
                    <img
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),B5=[{title:"basic"},{title:"with pagination",inputs:{pagination:{currentPage:1,pageCount:10}}},{title:"squished horizontally",styles:p`
            :host {
                width: 200px;
            }
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],_c=cs({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const r=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(r)}})}},cleanupCallback({state:e,updateState:t}){var r;(r=e.cleanup)==null||r.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),D5=V({title:De.tagName,parent:oe,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return u`
                    <${De.assign(O5)}></${De}>
                `}}),e({title:"takes time to load",stateInitStatic:{tableInputs:{...N5,showLoading:!0,pagination:{currentPage:1,pageCount:5}}},renderCallback({state:t,updateState:r}){return setTimeout(()=>{r({tableInputs:{...t.tableInputs,...Hc,showLoading:!1}})},5e3),u`
                    <${De.assign(t.tableInputs)}
                        ${y(De.events.pageChange,n=>{r({tableInputs:{...t.tableInputs,...Hc,pagination:{currentPage:2,pageCount:5}}})})}
                    ></${De}>
                `}}),B5.forEach(t=>{var r,n;e({title:t.title,styles:p`
                    ${M(t.styles)}
            ...
            `,stateInitStatic:{tableInputs:{...Gi,rows:Gi.rows.map(t=>({...t,cells:{...t.cells,date:u`
                ...
                `}})}}),R5=V({title:tn.tagName,parent:oe,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:en.Small}},{title:"large",inputs:{size:en.Large}},{title:"whole page",inputs:{size:en.WholePage},styles:p`
                    :host {
                        width: 500px;
                    }
                `}].forEach(r=>{e({title:r.title,styles:r.styles??p``,renderCallback(){return u`
                        <${tn.assign(r.inputs)}></${tn}>
                    `}})})}}),H5=V({title:O.tagName,parent:oe,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
            ...
            `,renderCallback(){return u`
                ...
                `}})}}),_5=V({title:Rr.tagName,parent:oe,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:p`
                ${Rr} {
                    height: 32px;
                }
...
`,Yi={min:10,max:50},V5=V({title:R.tagName,parent:oe,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:p`
                ${nt}
            `,renderCallback({state:t,updateState:r}){return u`
            ...
            `,renderCallback({state:t,updateState:r}){return u`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Fc.map((i,a)=>u`
                            ...
                            ></${Wi}>
                        `)}})})}}),Z5=V({parent:oe,title:co.tagName,elementExamplesCallback({defineExample:e}){function t({title:r,tooltipContent:n,forceShow:o}){e({title:r,styles:p`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),W5=V({parent:oe,title:nn.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${co.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return u`
                    <${nn}>This is a tooltip.</${nn}>
                `}})}}),U5=[Z5,W5],G5=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:p`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:p``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:p``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:wa},{label:"label here",value:2,icon:wa},{label:"",value:3,icon:At,disabled:!0},{label:"16px icon",value:4,icon:At},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],Y5=V({title:Ur.tagName,parent:oe,elementExamplesCallback({defineExample:e}){G5.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:p`
                ...
                `,renderCallback({state:r,updateState:n}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return u`
                        ...
                        ></${Ur}>
                    `}})})}}),dh=V({title:"Icons",parent:void 0,controls:lh}),J5=Object.entries($t).map(([e,t])=>V({title:e,parent:dh,elementExamplesCallback({defineExample:r}){t.map(n=>r({title:n.name,renderCallback({controls:o}){return u`
                                <${No.assign({icon:n})}
                                    style=${uo(o)}
                                ></${No}>
                            `}}))}}));function hh(e){const t=K5(e),r=ye(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return le(r).reduce((o,i)=>{const a=r[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function K5(e){typeof e!="string"&&(e=String(e));const n=`{"${Zc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const ri=V({title:"Styles",parent:void 0}),X5=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function Q5(e,t,r){const n=hh(W(r));return e({title:t,styles:X5,renderCallback(){return u`
            ...
            `}})}const ev=V({title:"Colors",parent:ri,elementExamplesCallback({defineExample:e}){le(b).map(t=>Q5(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),tv=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function rv(e,t,r){const n=hh(r);return e({title:t,styles:tv,renderCallback(){return u`
            ...
            `}})}const nv=V({title:"Fonts",parent:ri,elementExamplesCallback({defineExample:e}){le(B).map(t=>{const r=B[t];return rv(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),ov=V({title:"Shadows",parent:ri,elementExamplesCallback({defineExample:e}){kh(wn).forEach(([t,r])=>{e({title:t,styles:p`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return u`
                            <div></div>
                        `}})})}}),iv=[oe,dh,ri,sh],av=[...J5,...U5,s5,c5,u5,d5,m5,g5,ev,w5,b5,k5,$5,x5,nv,T5,C5,S5,M5,R5,H5,_5,F5,ov,V5,z5,Y5,D5].sort((e,t)=>e.title.localeCompare(t.title)),sv=[...iv,...av];Vo({tagName:"toniq-design-system-app",styles:p`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return u`
            <${xi.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:sv,themeColor:"#00D093"})}>
