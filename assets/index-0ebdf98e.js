...
`,Xu=v({name:"LoaderAnimated24Icon",svgTemplate:u`
    ...
    `}),bm=v({name:"Geometry24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),$m=v({name:"Info24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Tm=v({name:"LayoutGrid24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Sm=v({name:"Lifebuoy24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Cm=v({name:"List24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Mm=v({name:"ListDetails24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Em=v({name:"Lock24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Im=v({name:"LockOpen24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Lm=v({name:"Menu24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),qm=v({name:"Paper24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Nm=v({name:"People24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Pm=v({name:"Person24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Dm=v({name:"Refresh24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Om=v({name:"Send24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Rm=v({name:"ShoppingCart24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),_m=v({name:"Social24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Hm=v({name:"Square24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),bl={interactionDuration:m`--toniq-interaction-transition-duration`,prettyDuration:m`--toniq-pretty-transition-duration`},X={interaction:m`var(${bl.interactionDuration}, 84ms)`,pretty:m`var(${bl.prettyDuration}, 300ms)`};function Qo(e){return{foregroundColor:e.backgroundColor,backgroundColor:e.foregroundColor}}const Fm=(()=>{const e={backgroundColor:m`#ffffff`,foregroundColor:m`#000000`},t={...e,foregroundColor:m`#00D093`},n={...e,foregroundColor:m`#ACADAD`},r={...e,foregroundColor:m`#D6D6D6`},o={...t},i={...t,foregroundColor:m`#00A876`},a={...t,foregroundColor:m`#1D6852`},s={...r},l={...e,foregroundColor:m`#EAFBF7`},c={...e,backgroundColor:m`#D2EEFA`},d=Qo(o),f=Qo(i),p=Qo(a),g=p,w={backgroundColor:m`#F1F3F6`,foregroundColor:e.foregroundColor},$={...w,foregroundColor:m`#9A9A9D`};return{brandPrimary:t,pagePrimary:e,pageSecondary:n,pageTertiary:r,pageInteraction:o,pageInteractionHover:i,pageInteractionActive:a,divider:s,dividerFaint:l,dropShadow:c,pageDarkPrimary:g,accentPrimary:d,accentPrimaryHover:f,accentPrimaryActive:p,accentSecondary:w,accentTertiary:$}})(),dd=Fm;function yl(e,t){return P(`--toniq-${Gr(e)}-${Gr(t)}`)}const Oa=ve(dd,e=>({backgroundColor:yl(e,"backgroundColor"),foregroundColor:yl(e,"foregroundColor")}));function Ge(e,t){const n=dd[e][t],r=Oa[e][t];return m`var(${r}, ${n})`}const b=ve(Oa,e=>({foregroundColor:Ge(e,"foregroundColor"),backgroundColor:Ge(e,"backgroundColor")}));function F(e){return m`
...
`,rp=v({name:"CryptoIcp16Icon",svgTemplate:u`
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:n,state:r,updateState:o}){if(!e.text)return u``;const i=e.text,a=n5(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,d=c?e5(i,a):i,f=c?i:"",p=s?ld:l?sd:void 0,g=p?u`
                  <${T.assign({icon:p})}></${T}>
              `:"",w=u`
        ...
        `;return d?s?u`
                ...
                `:l?u`
                    <button
                        ...
                        ${S("click",async()=>{await Kw(i),t(new n.copy),r.showCopiedTextTimeoutId!=null&&window.clearTimeout(r.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${w} ${g}
                    </button>
                `:u`
                    ${w}
                `:u``}}),lc="...";function r5(e,t,n=7,r=5){let o;e=On({value:e,min:1,max:t}),n=On({value:n,min:r,max:t});const i=n-5,a=n-3;t<=n?o=n:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>n?fi(t-o,t):e>o?fi(Math.min(s.start,t-o),Math.min(s.end,t)):fi(1,Math.min(t,o+1));function c(f,p){return l.length+1!==t?p:[f]}const d=l[l.length-1];if(d&&d<t){const f=c(t,[lc,t]);return[...l,...f]}else return l[0]!==1?c(1,[1,lc]).concat(l):l}function fi(e,t){const n=t-e+1;return Array.from({length:n},(r,o)=>e+o)}ne()({tagName:"toniq-pagination",styles:m`
        :host {
            display: flex;
        }
    ...
    `,events:{pageChange:K()},renderCallback({inputs:e,events:t,dispatch:n}){return e.pageCount<=1?u``:u`
                ...
                ${r5(e.currentPage,e.pageCount,e.pagesShown).map(r=>typeof r=="string"?u`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:Ic()})},renderCallback({inputs:e,dispatch:t,events:n,state:r}){return o5(e.entries).map(i=>i5(e.groupName||r.randomGroupName,e.value,i,()=>{t(new n.valueChange(i.value))}))}});function o5(e){const t=Object.fromEntries(e.map(r=>[r.value,r]));return Object.values(t).length!==e.length&&console.error(`${G.tagName} was given duplicate entry values.`),Object.values(t)}function i5(e,t,n,r){const o=t===n.value,i=u`
    ...
    `}function mi(e,t){const n=e[0],r=e[e.length-1];if(n==null||r==null)return 0;if(t<n)return n;if(t>r)return r;const o=e.findIndex((c,d)=>{const f=e[d+1];return f==null?!0:c<=t&&f>=t});if(o<0)return n;const i=e[o];if(i==null)return n;const a=e[o+1];if(a==null)return i;const s=t-i,l=a-t;return s<l?o:o+1}function a5(e,t,n=100){e>t&&([e,t]=[t,e]),n<2&&(n=2);let r=s5(e);const o=[e];for(;r<t;){const i=Math.pow(10,String(r).length-1),a=r+i;a<t&&o.push(a),r=a}return o.push(t),o.length>n&&(cc(o,n),o.length>n&&cc(o,n)),o}function cc(e,t){const n=e.length-t,r=(e.length-2)/n;for(let o=e.length-2;o>=1;o-=r)e.splice(Math.floor(o),1)}function s5(e){let t=1;if(!e)return e;e<0&&(t=-1,e=e*-1);const n=e.toFixed(0),r=Math.pow(10,n.length-1),o=Number(n[0]||1);return r*o*t}const N={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},En={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"};function l5(e){var r,o;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${N.lowerLabelWrapper} .${N.labelPercentMarginWrapper}`),n=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${N.upperLabelWrapper} .${N.labelPercentMarginWrapper}`);if(n instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),a=n.getBoundingClientRect();return{lower:i,upper:a}}else return}function c5(e,t=8){const n=l5(e);if(!n)return 0;const r=n.lower.right-n.upper.left+t;return Math.max(0,r)}function pi({value:e,limits:t,flip:n}){const o=(t.max-e)/(t.max-t.min)*100;return-(n?100-o:o)}function nr(e){return Xe(e)&&e.min!==void 0&&e.max!==void 0}function oa(e){var n;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${N.range}`);return(t==null?void 0:t.clientWidth)??0}function gi(e,t,n){return`${n?kh(e):e} ${t}`}function u5({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function d5({value:e,double:t,min:n,max:r}){return t?nr(e)?{min:On({value:e.min,min:n,max:Math.min(e.max,r)}),max:On({value:e.max,min:Math.max(e.min,n),max:r})}:{min:n,max:r}:nr(e)?n:On({value:e,min:n,max:r})}function h5({actualValue:e,actualLimits:t,logScale:n,logRange:r}){return n?{elementValue:nr(e)?{min:mi(r,e.min),max:mi(r,e.max)}:mi(r,e),elementLimits:{min:0,max:r.length-1}}:{elementValue:e,elementLimits:t}}function wi(e,t,n){return n?t[e]||0:e}function f5(e){return{actualLimits:u5(e),actualValue:d5(e)}}function m5(e,t){var r,o,i;let n=!1;if(nr(e)){const a=(r=t.shadowRoot)==null?void 0:r.querySelector(`.${N.lowerSlider}`),s=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${N.upperSlider}`);a instanceof HTMLInputElement&&s instanceof HTMLInputElement&&(Number(a.value)!==e.min&&(a.value=String(e.min),n=!0),Number(s.value)!==e.max&&(s.value=String(e.max),n=!0))}else{const a=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${N.slider}`);a instanceof HTMLInputElement&&Number(a.value)!==e&&(a.value=String(e),n=!0)}return n}function N0(e,t){const{actualValue:n,actualLimits:r}=f5({...e}),o=a5(r.min,r.max),i=e.logScale??!1,a=e.suffix??"",{elementValue:s,elementLimits:l}=h5({actualValue:n,actualLimits:r,logScale:i,logRange:o}),c=oa(t);return{actualValue:n,elementLimits:l,elementValue:s,isLogScale:i,logRange:o,rangeWidth:c,suffix:a}}const Dt=16,uc=m`
    ${Dt}px
`,dc=m`
...
`,hc=m`
    transform: scale(1.2);
`;function Bn(e){requestAnimationFrame(()=>{const t=N0(e.instanceInputs,e).elementValue;m5(t,e)&&(e.setAttribute("disabled","true"),Bn(e))})}const _=ne()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:K()},styles:m`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Bn(e)}),e.addEventListener("keydown",()=>{Bn(e)}),e.addEventListener("keyup",()=>{Bn(e)})},renderCallback({inputs:e,host:t,events:n,dispatch:r,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:d,elementLimits:f,rangeWidth:p}=N0({...e},t);if(Bn(t),nr(d))return g(a,d,f);return $(a,d,f);function g(k,x,C){const O={left:Ot((p-Dt)*(x.min-C.min)/(C.max-C.min)+Dt/2),right:Ot((p-Dt)*(C.max-x.max)/(C.max-C.min)+Dt/2)},j=gi(k.min,c,l),re=gi(k.max,c,l);requestAnimationFrame(()=>{const $e=c5(t);$e!==o.labelOverlap&&i({labelOverlap:$e})});const he=(C.max-x.max)/(C.max-C.min)>.5,ce=pi({value:x.min,limits:{min:C.min,max:x.max},flip:!0}),Z=pi({value:x.max,limits:{min:x.min,max:C.max},flip:!1}),oe=o.labelOverlap&&he?o.labelOverlap:0,ze=o.labelOverlap&&!he?o.labelOverlap:0;return u`
                <div
                    class="range"
    ...
    `,renderCallback({inputs:e}){return u`
            <${T.assign({icon:e.icon})}></${T}>
        `}}),Lo=Object.values(vt).reduce((e,t)=>(t.forEach(n=>{if(n.name in e)throw new Error(`Icon name duplicate: '${n.name}'`);e[n.name]=n}),e),{}),p5=Object.keys(Lo).sort();function Ga(e){return{controlType:B.Dropdown,initValue:e,options:["None",...p5]}}const D0={"CSS color":{controlType:B.Color,initValue:""},[String(h["toniq-icon-stroke-color"].name)]:{controlType:B.Color,initValue:""},[String(h["toniq-icon-fill-color"].name)]:{controlType:B.Color,initValue:""},[String(h["toniq-icon-stroke-width"].name)]:{controlType:B.Color,initValue:""},[String(h["toniq-icon-stroke-width"].name)]:{controlType:B.Number,initValue:2}};function Ur(e){return Object.entries(e).filter(([,n])=>n!==""&&n!=null).map(([n,r])=>(n.toLowerCase()==="css color"&&(n="color"),we(r,"number")&&(r=aa({value:r,suffix:"px"})),`${n}: ${r};`)).join(`
`)}const g5=U({title:"Social Urls",parent:B0,elementExamplesCallback({defineExample:e}){function t({socialName:n,icon:r}){e({title:n,renderCallback(){return u`
                        <${wo.assign({icon:r})}></${wo}>
                    `}})}Object.entries(Cd).forEach(([n,r])=>{t({socialName:n,icon:r})})}}),ae=U({title:"Elements",parent:void 0}),w5=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:m`
            ${Vt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],v5=U({title:Vt.tagName,parent:ae,elementExamplesCallback({defineExample:e}){w5.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:m`
                    .bold {
                        ${Y.boldFont}
                    }
                ...
                `,renderCallback({state:n,updateState:r}){return u`
                        ...
                        ></${Vt}>
                        More text
                    `}})})}}),b5=U({parent:ae,title:ue.tagName,elementExamplesCallback({defineExample:e}){[{name:"default",inputs:{}},{name:"Secondary",inputs:{variant:ho.Secondary}},{name:"Outline",inputs:{variant:ho.Outline}},{name:"Disabled",inputs:{disabled:!0}}].forEach(n=>{e({title:n.name,stateInitStatic:{showIcon:!1,timeoutId:void 0},styles:m`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
...
`,y5=U({parent:ae,title:Me.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:fc,renderCallback(){return u`
                ...
                `;return u`
                    ...
                    ></${Me}>
                `}})}});function k5(e){const t=Object.keys(e.cssVars).map(n=>[`--${n}`,{controlType:B.Color,initValue:""}]);return Object.fromEntries(t)}function $5(e){const t=Object.entries(e).map(([n,r])=>{if(n.startsWith("--"))return typeof r!="string"||!r?void 0:`${n}: ${r};`}).filter(ke);return P(t.join(`
`))}const x5=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],bi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],T5=U({parent:ae,title:mt.tagName,controls:{Text:{controlType:B.Text,initValue:"Text"},...k5(mt)},elementExamplesCallback({defineExample:e}){x5.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:bi.map(n=>!!n.inputs.checked),extraEntryStatuses:bi.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:m`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return bi.map((i,a)=>{const s=(i.extraEntries??[]).map((c,d)=>{var f;return u`
                        ...
                        `})}})})}}),S5=U({parent:ae,title:ti.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Tt}},{inputs:{icon:Tt}},{inputs:{},template:u`
                    HTML child
        ...
        `},{customStyle:m`
            max-height: 30px;
            min-height: 30px;
        `}],A5=U({title:Lr.tagName,parent:ae,controls:{Selected:{controlType:B.Dropdown,initValue:Nr[0].label,options:Nr.map(e=>e.label)},Direction:{controlType:B.Dropdown,initValue:"Down",options:Cc(ea)},Icon:Ga(nd.name),Prefix:{controlType:B.Text,initValue:"Sort by: "},"Force open":{controlType:B.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){M5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:mc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:m`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return mc.map((i,a)=>{const s=m`
                        ...
                        `;return u`
                            ...
                            ></${Lr}>
                        `})}})})}}),pc="/toniq-labs-design-system";function E5(...e){const n=[globalThis.location.pathname.startsWith(pc)?pc:"",...e].filter(ke);return gh(...n)}const tn=Array(30).fill(E5("/toniq-labs-logo.png")),an=["Hello there.","There is stuff here."],Pr=an.concat(Array(30).fill(an)),I5=U({title:J.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${J.assign({imageUrls:tn.map((t,n)=>n%2?"/invalid-image.png":t),infoParagraphs:an,title:"With custom Template Statuses",customTemplateCallback(t){return u`
                            ...
                            `}})}></${J}>
                `}})}}),L5=U({title:Ft.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:m`
                .front,
                .back {
                    padding: 32px;
                }
            ...
            `,renderCallback({controls:n}){return u`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            ...
                            ></${qr}>
                        `))}})})}}),B5=U({title:hi.tagName,parent:ae,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:jr.Small}},{title:"large",inputs:{size:jr.Large}},{title:"whole page",inputs:{size:jr.WholePage},styles:m`
                    :host {
                        width: 500px;
                    }
                `}].forEach(n=>{e({title:n.title,styles:n.styles??m``,renderCallback(){return u`
                        <${hi.assign(n.inputs)}></${hi}>
                    `}})})}}),D5=U({title:pe.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
...
`,yi={min:10,max:50},R5=U({title:_.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:m`
                ${at}
            `,renderCallback({state:t,updateState:n}){return u`
            ...
            `,renderCallback({state:t,updateState:n}){return u`
                    <${_.assign({double:!0,value:t.value,min:0,max:100})}
                        ${S(_.events.valueChange,r=>{if(typeof r.detail=="number")throw new Error("was expecting a double slider value");n({value:r.detail})})}
                    ></${_}>
                `}})}}),_5=[{title:"default",inputs:{}},{title:"text only",inputs:{variant:P0.TextOnly}},{title:"disabled",inputs:{disabled:!0}}],gc=[{inputs:{icon:void 0}},{inputs:{toggled:!0}},{inputs:{}},{inputs:{text:void 0}}],H5=U({title:vi.tagName,parent:ae,controls:{Text:{controlType:B.Text,initValue:"Toggle Button"},Icon:Ga(cd.name)},elementExamplesCallback({defineExample:e}){_5.forEach(t=>{e({title:t.title,stateInitStatic:{buttonStates:gc.map(n=>!!n.inputs.toggled)},styles:m`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return gc.map((i,a)=>u`
                            ...
                            ></${vi}>
                        `)}})})}}),F5=U({parent:ae,title:Wr.tagName,elementExamplesCallback({defineExample:e}){function t({title:n,tooltipContent:r,forceShow:o}){e({title:n,styles:m`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),V5=U({parent:ae,title:zn.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${Wr.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return u`
                    <${zn}>This is a tooltip.</${zn}>
                `}})}}),z5=[F5,V5],Z5=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:m`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:m``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:m``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:zi},{label:"label here",value:2,icon:zi},{label:"",value:3,icon:Tt,disabled:!0},{label:"16px icon",value:4,icon:Tt},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],j5=U({title:Dn.tagName,parent:ae,elementExamplesCallback({defineExample:e}){Z5.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:m`
                ...
                `,renderCallback({state:n,updateState:r}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return u`
                        ...
                        ></${Dn}>
                    `}})})}}),O0=U({title:"Icons",parent:void 0,controls:D0}),W5=Object.entries(vt).map(([e,t])=>U({title:e,parent:O0,elementExamplesCallback({defineExample:n}){t.map(r=>n({title:r.name,renderCallback({controls:o}){return u`
                                <${wo.assign({icon:r})}
                                    style=${Ur(o)}
                                ></${wo}>
                            `}}))}}));function R0(e){const t=U5(e),n=ve(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return de(n).reduce((o,i)=>{const a=n[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function U5(e){typeof e!="string"&&(e=String(e));const r=`{"${bc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(r);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${r}`),o}}const Ya=U({title:"Styles",parent:void 0}),G5=m`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function Y5(e,t,n){const r=R0(F(n));return e({title:t,styles:G5,renderCallback(){return u`
            ...
            `}})}const J5=U({title:"Colors",parent:Ya,elementExamplesCallback({defineExample:e}){de(b).map(t=>Y5(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),X5=m`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function K5(e,t,n){const r=R0(n);return e({title:t,styles:X5,renderCallback(){return u`
            ...
            `}})}const Q5=U({title:"Fonts",parent:Ya,elementExamplesCallback({defineExample:e}){de(Y).map(t=>{const n=Y[t];return K5(e,t,n)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),e4=[ae,O0,Ya,B0],t4=[...W5,...z5,g5,v5,b5,y5,T5,S5,J5,C5,A5,I5,L5,Q5,q5,N5,P5,B5,D5,O5,R5,H5,j5].sort((e,t)=>e.title.localeCompare(t.title)),n4=[...e4,...t4];yo({tagName:"toniq-design-system-app",styles:m`
        :host {
            display: block;
            height: 100%;
            width: 100%;
