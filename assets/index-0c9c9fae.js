...
`,pd=w({name:"LoaderAnimated24Icon",svgTemplate:u`
    ...
    `,events:{routeChange:K()},renderCallback({inputs:e,dispatch:t,events:r}){var o,i;function n(a){e.route&&Oa(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new r.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return u`
            ...
            `}}});const{defineElement:De,defineElementNoInputs:Aw}=La(),Ie=De()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>p`
        a {
            box-sizing: border-box;
            display: block;
...
`))}const Y=(()=>{const e=p`
    ...
    `}),og=w({name:"CryptoBtc16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),ig=w({name:"CryptoBtc24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),ag=w({name:"CryptoCkBtc16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),sg=w({name:"CryptoCkBtc24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
...
`,lg=w({name:"CryptoIcp16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),cg=w({name:"CryptoIcp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),ug=w({name:"BrandDistrikt24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),dg=w({name:"BrandDscvr24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            height="24"
    ...
    `}),hg=w({name:"BrandFacebookLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),fg=w({name:"BrandGoogleLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),mg=w({name:"BrandIcScan24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),pg=w({name:"BrandInstagramFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),gg=w({name:"BrandMedium24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${V["toniq-icon-fill-color"]("#000")}
    ...
    `}),vg=w({name:"BrandNftgeek24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),wg=w({name:"BrandTiktokFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${V["toniq-icon-fill-color"]("#000")}
    ...
    `}),bg=w({name:"BioniqRobot100Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),yg=w({name:"EntrepotLogo144Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),ut={"core-16":[ep,tp,Qt],"core-24":[rp,np,Fa,op,ip,za,xd,ap,sp,lp,cp,up,dp,hp,Td,Sd,fp,mp,Cd,pp,gp,vp,Md,Ad,wp,bp,yp,$p,Ed,kp,xp,Tp,Sp,Cp,Mp,Ap,Ep,Ip,Lp,Pp,Np,ja,qp,Op,Bp,Dp,Rp,_p,Hp,Vp,Id,Ld,Fp,zp,jp,Zp,Yp,Rn,Jp,Kp,Xp,Qp],"core-48":[eg,qd,tg],"core-64":[Od,rg,ng],cryptocurrencies:[og,ig,ag,sg,lg,cg],"third-party-brands":[Rd,ug,dg,hg,fg,mg,_d,pg,gg,vg,Hd,Vd,wg,Fd,zd],toniq:[bg,yg]},$g=tn({Discord:St(void 0,""),Instagram:St(void 0,""),Telegram:St(void 0,""),TikTok:St(void 0,""),Twitch:St(void 0,""),Twitter:St(void 0,""),website:St(void 0,"")}),kg=$g.defaultValue,jd={Discord:Rd,Instagram:_d,Telegram:Hd,TikTok:Vd,Twitch:Fd,Twitter:zd,website:Md},Vl="toniq-",{defineElement:re,defineElementNoInputs:xg}=La({assertInputs:e=>{if(!e.tagName.startsWith(Vl))throw new Error(`Tag name should start with '${Vl}' but got '${e.tagName}'`)}}),Nt=re()({tagName:"toniq-bold-space",styles:p`
        :host {
            display: inline-block;
            position: relative;
            vertical-align: top;
    ...
    `,renderCallback({inputs:e}){const t=e.icon?u`
        ...
        `}});function Tg(e,t,r={behavior:"smooth"}){let n=2;const o=t==="up"||t==="down"?"y":"x",i=t==="right"||t==="down"?"+":"-",a=o==="x"?e.scrollWidth-e.offsetWidth:e.scrollHeight-e.offsetHeight,s=Wa(e)[o];i==="-"&&(n*=-1);const l=e[o==="x"?"scrollLeft":"scrollTop"]+n,c=s.filter(f=>i==="+"?f>l:f<l).sort((f,m)=>i==="+"?f-m:m-f);let d;return c.length>0?d=c[0]:i==="+"?d=a:d=0,e.scrollTo({...r,[o==="x"?"left":"top"]:d})}function Sg(e){const t=window.getComputedStyle(e),r=e.getBoundingClientRect();let n=t.getPropertyValue("scroll-padding-left").replace("auto","0px"),o=t.getPropertyValue("scroll-padding-top").replace("auto","0px"),i=t.getPropertyValue("scroll-padding-right").replace("auto","0px"),a=t.getPropertyValue("scroll-padding-bottom").replace("auto","0px");function s(m,g){let v=parseFloat(m);return/%/.test(m)&&(v/=100,v*=g),v}let l=s(n,r.width),c=s(o,r.height),d=s(i,r.width),f=s(a,r.height);return{x:{before:l,after:d},y:{before:c,after:f}}}function Cg(e,t,r="both"){return r==="x"&&e.right>=t.left&&e.left<=t.right||r==="y"&&e.bottom>=t.top&&e.top<=t.bottom||r==="both"&&e.right>=t.left&&e.left<=t.right&&e.bottom>=t.top&&e.top<=t.bottom}function Zd(e){let t=[];for(const r of e.children)t=t.concat(r,Zd(r));return t}function Mg(e,t=!0){const r=e.getBoundingClientRect(),n={x:{start:[],center:[],end:[]},y:{start:[],center:[],end:[]}},o=Zd(e);for(const i of["x","y"]){const a=i==="x"?"y":"x",s=i==="x"?"left":"top",l=i==="x"?"width":"height",c=i==="x"?"scrollLeft":"scrollTop";for(const d of o){const f=d.getBoundingClientRect();if(t&&!Cg(r,f,a))continue;const m=window.getComputedStyle(d);let[g,v]=m.getPropertyValue("scroll-snap-align").split(" ");typeof v>"u"&&(v=g);const y=i==="x"?v:g,b=f[s]-r[s]+e[c];switch(y){case"none":break;case"start":n[i].start.push(b);break;case"center":n[i].center.push(b+f[l]/2);break;case"end":n[i].end.push(b+f[l]);break}}}return n}function Wa(e){const t=e.getBoundingClientRect(),r=Sg(e),n=Mg(e),o={x:e.scrollWidth-e.offsetWidth,y:e.scrollHeight-e.offsetHeight},i=(a,s)=>l=>Math.max(a,Math.min(s,l));return{x:Fl([...n.x.start.map(a=>a-r.x.before),...n.x.center.map(a=>a-t.width/2),...n.x.end.map(a=>a-t.width+r.x.after)].map(i(0,o.x))),y:Fl([...n.y.start.map(a=>a-r.y.before),...n.y.center.map(a=>a-t.height/2),...n.y.end.map(a=>a-t.height+r.y.after)].map(i(0,o.y)))}}function Fl(e){return Array.from(new Set(e))}const _n="templates-container",Ag=4e3;var Xi=(e=>(e.Default="default",e.BannerStyle="banner-style",e))(Xi||{});const ke=re()({tagName:"toniq-carousel",cssVars:{"toniq-carousel-arrow-margin":"40px"},hostClasses:{"toniq-carousel-banner-style":({inputs:e})=>e.style==="banner-style"},stateInitStatic:{currentScrollPosition:{left:0,right:1/0},scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({cssVars:e,hostClasses:t})=>p`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
    ...
    `,renderCallback:({inputs:e})=>u`
        ...
        `});async function m4(e){return navigator.clipboard.writeText(e)}const p4="…";function g4(e,t){const r=e.slice(0,t).trim(),n=e.slice(-1*t).trim();return`${r}${p4}${n}`}function v4(e){return!(e%1)}function w4(e){return e.letterCount==null?4:v4(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const me=re()({tagName:"toniq-middle-ellipsis",events:{copied:K()},cssVars:{"toniq-middle-ellipsis-text-color":$.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":$.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":$.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":$.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>p`
        :host {
            /* 5 frames at 60 fps */
        ...
        `;return d?s?u`
                ...
                `:l?u`
                    <button
                        ...
                        ${T("click",async()=>{await m4(i),t(new r.copied),n.showCopiedTextTimeoutId!=null&&window.clearTimeout(n.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${v} ${g}
                    </button>
                `:u`
                    ${v}
                `:u``}}),Pc="...";function b4(e,t,r=7,n=5){let o;e=Nr({value:e,min:1,max:t}),r=Nr({value:r,min:n,max:t});const i=r-5,a=r-3;t<=r?o=r:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>r?bi(t-o,t):e>o?bi(Math.min(s.start,t-o),Math.min(s.end,t)):bi(1,Math.min(t,o+1));function c(f,m){return l.length+1!==t?m:[f]}const d=l[l.length-1];if(d&&d<t){const f=c(t,[Pc,t]);return[...l,...f]}else return l[0]!==1?c(1,[1,Pc]).concat(l):l}function bi(e,t){const r=t-e+1;return Array.from({length:r},(n,o)=>e+o)}re()({tagName:"toniq-pagination",styles:p`
        :host {
            display: flex;
        }
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:Z2()})},renderCallback({inputs:e,dispatch:t,events:r,state:n}){return y4(e.entries).map(i=>$4(e.groupName||n.randomGroupName,e.value,i,()=>{t(new r.valueChange(i.value))}))}});function y4(e){const t=Object.fromEntries(e.map(n=>[n.value,n]));return Object.values(t).length!==e.length&&console.error(`${G.tagName} was given duplicate entry values.`),Object.values(t)}function $4(e,t,r,n){const o=t===r.value,i=u`
    ...
    `}function yi(e,t){const r=e[0],n=e[e.length-1];if(r==null||n==null)return 0;if(t<r)return r;if(t>n)return n;const o=e.findIndex((c,d)=>{const f=e[d+1];return f==null?!0:c<=t&&f>=t});if(o<0)return r;const i=e[o];if(i==null)return r;const a=e[o+1];if(a==null)return i;const s=t-i,l=a-t;return s<l?o:o+1}function k4(e,t,r=100){e>t&&([e,t]=[t,e]),r<2&&(r=2);let n=x4(e);const o=[e];for(;n<t;){const i=Math.pow(10,String(n).length-1),a=n+i;a<t&&o.push(a),n=a}return o.push(t),o.length>r&&(Nc(o,r),o.length>r&&Nc(o,r)),o}function Nc(e,t){const r=e.length-t,n=(e.length-2)/r;for(let o=e.length-2;o>=1;o-=n)e.splice(Math.floor(o),1)}function x4(e){let t=1;if(!e)return e;e<0&&(t=-1,e=e*-1);const r=e.toFixed(0),n=Math.pow(10,r.length-1),o=Number(r[0]||1);return n*o*t}const N={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},kr={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"};function T4(e){var n,o;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${N.lowerLabelWrapper} .${N.labelPercentMarginWrapper}`),r=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${N.upperLabelWrapper} .${N.labelPercentMarginWrapper}`);if(r instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),a=r.getBoundingClientRect();return{lower:i,upper:a}}else return}function S4(e,t=8){const r=T4(e);if(!r)return 0;const n=r.lower.right-r.upper.left+t;return Math.max(0,n)}function $i({value:e,limits:t,flip:r}){const o=(t.max-e)/(t.max-t.min)*100;return-(r?100-o:o)}function Jr(e){return _2(e)&&e.min!==void 0&&e.max!==void 0}function ha(e){var r;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${N.range}`);return(t==null?void 0:t.clientWidth)??0}function ki(e,t,r){return`${r?Q2(e):e} ${t}`}function C4({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function M4({value:e,double:t,min:r,max:n}){return t?Jr(e)?{min:Nr({value:e.min,min:r,max:Math.min(e.max,n)}),max:Nr({value:e.max,min:Math.max(e.min,r),max:n})}:{min:r,max:n}:Jr(e)?r:Nr({value:e,min:r,max:n})}function A4({actualValue:e,actualLimits:t,logScale:r,logRange:n}){return r?{elementValue:Jr(e)?{min:yi(n,e.min),max:yi(n,e.max)}:yi(n,e),elementLimits:{min:0,max:n.length-1}}:{elementValue:e,elementLimits:t}}function xi(e,t,r){return r?t[e]||0:e}function E4(e){return{actualLimits:C4(e),actualValue:M4(e)}}function I4(e,t){var n,o,i;let r=!1;if(Jr(e)){const a=(n=t.shadowRoot)==null?void 0:n.querySelector(`.${N.lowerSlider}`),s=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${N.upperSlider}`);a instanceof HTMLInputElement&&s instanceof HTMLInputElement&&(Number(a.value)!==e.min&&(a.value=String(e.min),r=!0),Number(s.value)!==e.max&&(s.value=String(e.max),r=!0))}else{const a=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${N.slider}`);a instanceof HTMLInputElement&&Number(a.value)!==e&&(a.value=String(e),r=!0)}return r}function th(e,t){const{actualValue:r,actualLimits:n}=E4({...e}),o=k4(n.min,n.max),i=e.logScale??!1,a=e.suffix??"",{elementValue:s,elementLimits:l}=A4({actualValue:r,actualLimits:n,logScale:i,logRange:o}),c=ha(t);return{actualValue:r,elementLimits:l,elementValue:s,isLogScale:i,logRange:o,rangeWidth:c,suffix:a}}const At=16,qc=p`
    ${At}px
`,Oc=p`
...
`,Bc=p`
    transform: scale(1.2);
`;function Er(e){requestAnimationFrame(()=>{const t=th(e.instanceInputs,e).elementValue;I4(t,e)&&(e.setAttribute("disabled","true"),Er(e))})}const _=re()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:K()},styles:p`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Er(e)}),e.addEventListener("keydown",()=>{Er(e)}),e.addEventListener("keyup",()=>{Er(e)})},renderCallback({inputs:e,host:t,events:r,dispatch:n,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:d,elementLimits:f,rangeWidth:m}=th({...e},t);if(Er(t),Jr(d))return g(a,d,f);return y(a,d,f);function g(b,x,C){const D={left:Gt((m-At)*(x.min-C.min)/(C.max-C.min)+At/2),right:Gt((m-At)*(C.max-x.max)/(C.max-C.min)+At/2)},Z=ki(b.min,c,l),ne=ki(b.max,c,l);requestAnimationFrame(()=>{const ve=S4(t);ve!==o.labelOverlap&&i({labelOverlap:ve})});const de=(C.max-x.max)/(C.max-C.min)>.5,ue=$i({value:x.min,limits:{min:C.min,max:x.max},flip:!0}),j=$i({value:x.max,limits:{min:x.min,max:C.max},flip:!1}),oe=o.labelOverlap&&de?o.labelOverlap:0,Re=o.labelOverlap&&!de?o.labelOverlap:0;return u`
                <div
                    class="range"
    ...
    `,renderCallback({inputs:e}){const t=e.icon?u`
        ...
        `}}),Or=xg({tagName:"toniq-tooltip",styles:p`
        :host {
            display: block;
            padding: 4px 8px;
            border-radius: 8px;
    ...
    `,renderCallback({inputs:e}){return u`
            <${S.assign({icon:e.icon})}></${S}>
        `}}),qo=Object.values(ut).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),L4=Object.keys(qo).sort();function rs(e){return{controlType:O.Dropdown,initValue:e,options:["None",...L4]}}const oh={"CSS color":{controlType:O.Color,initValue:""},[String(h["toniq-icon-stroke-color"].name)]:{controlType:O.Color,initValue:""},[String(h["toniq-icon-fill-color"].name)]:{controlType:O.Color,initValue:""},[String(h["toniq-icon-stroke-width"].name)]:{controlType:O.Color,initValue:""},[String(h["toniq-icon-stroke-width"].name)]:{controlType:O.Number,initValue:2}};function jn(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),V2(n,"number")&&(n=Ha({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
`)}const P4=U({title:"Social Urls",parent:nh,elementExamplesCallback({defineExample:e}){function t({socialName:r,icon:n}){e({title:r,renderCallback(){return u`
                        <${vo.assign({icon:n})}></${vo}>
                    `}})}Object.entries(jd).forEach(([r,n])=>{t({socialName:r,icon:n})})}}),ae=U({title:"Elements",parent:void 0}),N4=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:p`
            ${Nt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],q4=U({title:Nt.tagName,parent:ae,elementExamplesCallback({defineExample:e}){N4.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:p`
                    .bold {
                        ${Y.boldFont}
                    }
                ...
                `,renderCallback({state:r,updateState:n}){return u`
                        ...
                        ></${Nt}>
                        More text
                    `}})})}}),O4=U({parent:ae,title:ie.tagName,elementExamplesCallback({defineExample:e}){[{name:"default",inputs:{}},{name:"Secondary",inputs:{buttonStyle:Gr.Secondary}},{name:"Outline",inputs:{buttonStyle:Gr.Outline}},{name:"Disabled",inputs:{disabled:!0}}].forEach(r=>{e({title:r.name,stateInitStatic:{showIcon:!1,timeoutId:void 0},styles:p`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
...
`,B4=U({parent:ae,title:ke.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:Dc,renderCallback(){return u`
                ...
                `;return u`
                    ...
                    ></${ke}>
                `}})}});function D4(e){const t=Object.keys(e.cssVars).map(r=>[`--${r}`,{controlType:O.Color,initValue:""}]);return Object.fromEntries(t)}function R4(e){const t=Object.entries(e).map(([r,n])=>{if(r.startsWith("--"))return typeof n!="string"||!n?void 0:`${r}: ${n};`}).filter(an);return q(t.join(`
`))}const _4=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],Si=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],H4=U({parent:ae,title:at.tagName,controls:{Text:{controlType:O.Text,initValue:"Text"},...D4(at)},elementExamplesCallback({defineExample:e}){_4.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:Si.map(r=>!!r.inputs.checked),extraEntryStatuses:Si.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:p`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Si.map((i,a)=>{const s=(i.extraEntries??[]).map((c,d)=>{var f;return u`
                        ...
                        `})}})})}}),V4=U({parent:ae,title:si.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Qt}},{inputs:{icon:Qt}},{inputs:{},template:u`
                    HTML child
        ...
        `},{customStyle:p`
            max-height: 30px;
            min-height: 30px;
        `}],j4=U({title:Mn.tagName,parent:ae,controls:{Selected:{controlType:O.Dropdown,initValue:En[0].label,options:En.map(e=>e.label)},Direction:{controlType:O.Dropdown,initValue:"Down",options:F2(la)},Icon:rs(xd.name),Prefix:{controlType:O.Text,initValue:"Sort by: "},"Force open":{controlType:O.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){z4.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Rc.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:p`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Rc.map((i,a)=>{const s=p`
                        ...
                        `;return u`
                            ...
                            ></${Mn}>
                        `})}})})}}),_c="/toniq-labs-design-system";function Z4(...e){const r=[globalThis.location.pathname.startsWith(_c)?_c:"",...e].filter(an);return G2(...r)}const xr=Array(30).fill(Z4("/toniq-labs-logo.png")),Br=["Hello there.","There is stuff here."],In=Br.concat(Array(30).fill(Br)),W4=U({title:Q.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${Q.assign({infoParagraphs:In,imageUrls:xr,socialUrls:kg,title:"Featured Stuff",viewButtonTitle:"Stuff"})}></${Q}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${Q.assign({imageUrls:xr.map((t,r)=>r%2?"/invalid-image.png":t),infoParagraphs:Br,title:"With custom Template Statuses",customTemplateCallback(t){return u`
                            ...
                            `}})}></${Q}>
                `}})}}),U4=U({title:Pt.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:p`
                .front,
                .back {
                    padding: 32px;
                }
            ...
            `,renderCallback({controls:r}){return u`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            ...
                            ></${An}>
                        `))}})})}}),K4=U({title:wi.tagName,parent:ae,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:Fn.Small}},{title:"large",inputs:{size:Fn.Large}},{title:"whole page",inputs:{size:Fn.WholePage},styles:p`
                    :host {
                        width: 500px;
                    }
                `}].forEach(r=>{e({title:r.title,styles:r.styles??p``,renderCallback(){return u`
                        <${wi.assign(r.inputs)}></${wi}>
                    `}})})}}),X4=U({title:me.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
...
`,Ci={min:10,max:50},ew=U({title:_.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:p`
                ${et}
            `,renderCallback({state:t,updateState:r}){return u`
            ...
            `,renderCallback({state:t,updateState:r}){return u`
                    <${_.assign({double:!0,value:t.value,min:0,max:100})}
                        ${T(_.events.valueChange,n=>{if(typeof n.detail=="number")throw new Error("was expecting a double slider value");r({value:n.detail})})}
                    ></${_}>
                `}})}}),tw=[{title:"default",inputs:{}},{title:"text only",inputs:{style:rh.TextOnly}},{title:"disabled",inputs:{disabled:!0}}],Hc=[{inputs:{icon:void 0}},{inputs:{toggled:!0}},{inputs:{}},{inputs:{text:void 0}}],rw=U({title:Ti.tagName,parent:ae,controls:{Text:{controlType:O.Text,initValue:"Toggle Button"},Icon:rs(Id.name)},elementExamplesCallback({defineExample:e}){tw.forEach(t=>{e({title:t.title,stateInitStatic:{buttonStates:Hc.map(r=>!!r.inputs.toggled)},styles:p`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Hc.map((i,a)=>u`
                            ...
                            ></${Ti}>
                        `)}})})}}),nw=U({parent:ae,title:zn.tagName,elementExamplesCallback({defineExample:e}){function t({title:r,tooltipContent:n,forceShow:o}){e({title:r,styles:p`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),ow=U({parent:ae,title:Or.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${zn.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return u`
                    <${Or}>This is a tooltip.</${Or}>
                `}})}}),iw=[nw,ow],aw=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:p`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:p``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}}],sw=U({title:Ir.tagName,parent:ae,elementExamplesCallback({defineExample:e}){aw.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:p`
                    ${t.extraStyles??p``}
                `,renderCallback({state:r,updateState:n}){return u`
                        ...
                        ></${Ir}>
                    `}})})}}),ih=U({title:"Icons",parent:void 0,controls:oh}),lw=Object.entries(ut).map(([e,t])=>U({title:e,parent:ih,elementExamplesCallback({defineExample:r}){t.map(n=>r({title:n.name,renderCallback({controls:o}){return u`
                                <${vo.assign({icon:n})}
                                    style=${jn(o)}
                                ></${vo}>
                            `}}))}}));function ah(e){const t=cw(e),r=sr(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return Ke(r).reduce((o,i)=>{const a=r[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function cw(e){typeof e!="string"&&(e=String(e));const n=`{"${N2(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const ns=U({title:"Styles",parent:void 0}),uw=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function dw(e,t,r){const n=ah(F(r));return e({title:t,styles:uw,renderCallback(){return u`
            ...
            `}})}const hw=U({title:"Colors",parent:ns,elementExamplesCallback({defineExample:e}){Ke($).map(t=>dw(e,t,$[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),fw=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function mw(e,t,r){const n=ah(r);return e({title:t,styles:fw,renderCallback(){return u`
            ...
            `}})}const pw=U({title:"Fonts",parent:ns,elementExamplesCallback({defineExample:e}){Ke(Y).map(t=>{const r=Y[t];return mw(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),gw=[ae,ih,ns,nh],vw=[...lw,...iw,P4,q4,O4,B4,H4,V4,hw,F4,j4,W4,U4,pw,G4,Y4,J4,K4,X4,Q4,ew,rw,sw].sort((e,t)=>e.title.localeCompare(t.title)),ww=[...gw,...vw];xo({tagName:"toniq-design-system-app",styles:p`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return u`
            <${ri.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:ww,themeColor:"#00D093"})}>
