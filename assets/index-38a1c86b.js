...
`,Pd=w({name:"LoaderAnimated24Icon",svgTemplate:c`
    ...
    `,events:{routeChange:ie()},renderCallback({inputs:e,dispatch:t,events:n}){var o,i;function r(a){e.route&&ti(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new n.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return c`
            ...
            `}}});const{defineElement:Ye,defineElementNoInputs:yA}=ss(),Fe=Ye()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>h`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `,renderCallback:({inputs:e,dispatch:t})=>{var r,o;const n=((o=e.router)==null?void 0:o.createRoutesUrl({...(r=e.router)==null?void 0:r.getCurrentRawRoutes(),...e.route}))??"#";return c`
        ...
        `}});function _p(e,t){return e.entry.entryType===ve.Root?!1:!!(e.entry.entryType===ve.Page||st(t,e.fullUrlBreadcrumbs.slice(0,-1))||st(t==null?void 0:t.slice(0,-1),e.fullUrlBreadcrumbs.slice(0,-1)))}const pt=Ye()({tagName:"book-nav",cssVars:{"book-nav-internal-indent":"0"},styles:({cssVars:e})=>h`
        :host {
            display: flex;
            flex-direction: column;
            padding: 16px 0;
    ...
    `,renderCallback({inputs:e}){const t=e.flattenedNodes.map(n=>{if(!_p(n,e.selectedPath))return;const r=h`
        ...
        `}});async function em(e){await da(2);const t=e.shadowRoot.querySelector(".selected");if(!t)throw new Error("Failed to find selected nav tree element.");await xh(t)||t.scrollIntoView({behavior:"smooth",block:"center"})}const Dt=Ye()({tagName:"book-error",styles:h`
        :host {
            display: flex;
            flex-direction: column;
            color: red;
    ...
    `,renderCallback({inputs:e}){return(ee(e.message,"array")?e.message:[e.message]).map(n=>c`
                <p>${n}</p>
            `)}}),Cr=Ye()({tagName:"book-page-controls",events:{controlValueChange:ie()},hostClasses:{"book-page-controls-has-controls":({inputs:e})=>!!Object.keys(e.config).length},styles:({hostClasses:e})=>h`
        :host {
            display: flex;
            flex-wrap: wrap;
    ...
    `,renderCallback({inputs:e,dispatch:t,events:n}){return Object.entries(e.config).length?Object.entries(e.config).map(([r,o],i)=>{if(o.controlType===V.Hidden)return"";const a=tm(e.currentValues[r],o,s=>{const l=ee(e.fullUrlBreadcrumbs,"array")?e.fullUrlBreadcrumbs:e.fullUrlBreadcrumbs[r];if(!l)throw new Error(`Failed to find breadcrumbs from given control name: '${r}'`);t(new n.controlValueChange({fullUrlBreadcrumbs:l,newValues:{...e.currentValues,[r]:s}}))});return c`
        ...
        `}const Ul=Ye()({tagName:"book-breadcrumbs",styles:h`
        :host {
            display: flex;
            color: #999;
        }
    ...
    `,renderCallback:({inputs:e})=>{const t=e.currentRoute.paths.slice(1);return t.length?t.map((n,r,o)=>{const i=r>=o.length-1,a=o.slice(0,r+1),s=i?"":c`
            ...
            `}):c`
                &nbsp;
            `}}),Bi=Ye()({tagName:"book-breadcrumbs-bar",styles:h`
        :host {
    ...
    `,renderCallback({inputs:e}){const t=e.isTopLevel?c`
        ...
        `}}),Qr=Ye()({tagName:"book-element-example-controls",styles:h`
        :host {
            display: flex;
            color: ${Z["element-book-page-foreground-faint-level-1-color"].value};
              ...
              `:Q,l=fa(e,u=>u.fullUrlBreadcrumbs.join(">"),(u,p)=>{if(kn(u,ve.Page))return c`
                ...
                `}else return kn(u,ve.Root)?Q:c`
                    <${Dt.assign({message:`Unknown entry type for rendering: '${u.entry.entryType}'`})}
                        class="block-entry"
                    ></${Dt}>
                `});return[s,l]}const ln=Ye()({tagName:"book-entry-display",styles:h`
        :host {
            display: flex;
            flex-direction: column;
            position: relative;
...
`))}const P=(()=>{const e=h`
    ...
    `,k=h`
        ${Te("rubikFont")}
    `;return{toniqFont:e,normalWeightFont:t,boldFont:n,extraBoldFont:r,paragraphFont:o,boldParagraphFont:i,labelFont:a,boldLabelFont:s,h1Font:l,h2Font:u,h3Font:p,h4Font:f,h5Font:m,h6Font:g,monospaceFont:v,rubikFont:k}})(),Tr={popupShadow:h`
...
`,Rg=w({name:"CryptoIcp16Icon",svgTemplate:c`
    ...
    `,renderCallback({inputs:e}){return e.level==="h1"?c`
            ...
            `:c`
                <slot></slot>
            `}});function Fa({input:e,matcher:t}){return!e||!t?!0:e.length>1?!!e.split("").every(n=>Fa({input:n,matcher:t})):t instanceof RegExp?!!e.match(t):t.includes(e)}function v1({value:e,allowed:t,blocked:n}){const r=t?Fa({input:e,matcher:t}):!0,o=n?Fa({input:e,matcher:n}):!1;return r&&!o}function Vc(e){if(!e.value)return{filtered:e.value,blocked:""};const{filtered:t,blocked:n}=e.value.split("").reduce((r,o)=>(v1({...e,value:o})?r.filtered.push(o):r.blocked.push(o),r),{filtered:[],blocked:[]});return{filtered:t.join(""),blocked:n.join("")}}var Va=(e=>(e.Default="default",e.Outline="outline",e))(Va||{});const io=ae()({tagName:"toniq-input",hostClasses:{"toniq-input-outline":({inputs:e})=>e.variant==="outline","toniq-input-has-a-value":({inputs:e})=>!!e.value,"toniq-input-disabled":({inputs:e})=>!!e.disabled},events:{valueChange:ie(),inputBlock:ie()},styles:({hostClasses:e})=>h`
            :host {
                position: relative;
                display: inline-flex;
                width: 224px;
    ...
    `,stateInitStatic:{canScroll:!1,debouncedResize:B2(()=>J1(pr.FirstThenWait,{milliseconds:30})),rowStyles:{},isPainting:!1,isStillPainting:!0,pageCountKey:0,tableListLeft:0},initCallback({inputs:e,state:t,updateState:n}){const r=e.columns.filter(o=>!o.disabled);n({rowStyles:r.reduce((o,i)=>(o[i.key]={width:void 0,left:void 0},o),t.rowStyles)})},renderCallback({inputs:e,state:t,updateState:n,events:r,dispatch:o,host:i}){var m;const a=e.columns.filter(g=>!g.disabled),s=[e.rows[0],...e.rows].filter(ye);function l(g){g instanceof HTMLElement&&setTimeout(()=>{t.debouncedResize(()=>{n({canScroll:g.scrollWidth>g.clientWidth,tableListLeft:g.getBoundingClientRect().left})})},0)}const u=e.pagination&&((m=e.pagination)==null?void 0:m.pageCount)>1?c`
...
`,Zc=h`
    transform: scale(1.2);
`;function l3(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function er(e){requestAnimationFrame(()=>{const t=b1(e.instanceInputs,e).elementValue;s3(t,e)&&(e.setAttribute("disabled","true"),er(e))})}const D=ae()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ie()},hostClasses:{"toniq-slider-disabled":({inputs:e})=>!!e.disabled},styles:({hostClasses:e})=>h`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{er(e)}),e.addEventListener("keydown",()=>{er(e)}),e.addEventListener("keyup",()=>{er(e)})},renderCallback({inputs:e,host:t,events:n,dispatch:r,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:u,elementValue:p,elementLimits:f,rangeWidth:m}=b1({...e},t);if(er(t),Mr(p))return g(a,p,f);return k(a,p,f);function g(x,$,T){const N={left:Ut((m-Wt)*($.min-T.min)/(T.max-T.min)+Wt/2),right:Ut((m-Wt)*(T.max-$.max)/(T.max-T.min)+Wt/2)},j=na(x.min,u,l),G=na(x.max,u,l);requestAnimationFrame(()=>{const Ce=n3(t);Ce!==o.labelOverlap&&i({labelOverlap:Ce})});const ne=(T.max-$.max)/(T.max-T.min)>.5,se=ta({value:$.min,limits:{min:T.min,max:$.max},flip:!0}),W=ta({value:$.max,limits:{min:$.min,max:T.max},flip:!1}),pe=o.labelOverlap&&ne?o.labelOverlap:0,Xe=o.labelOverlap&&!ne?o.labelOverlap:0;return c`
                <div
                    class="range"
            ...
            `}function v(x){i({internalValue:x}),e.disabled||r(new n.valueChange(x))}function k(x,$,T){const N=Ut((m-Wt)*(T.max-$)/(T.max-T.min)+Wt/2),j=na(x,u,l),G=ta({value:$,limits:T,flip:!1});return c`
                <div
...
`)}const u3=z({title:"Social Urls",parent:$1,elementExamplesCallback({defineExample:e}){function t({socialName:n,icon:r}){e({title:n,renderCallback(){return c`
                        <${Zo.assign({icon:r})}></${Zo}>
                    `}})}Object.entries(u0).forEach(([n,r])=>{t({socialName:n,icon:r})})}}),te=z({title:"Elements",parent:void 0}),d3=z({parent:te,title:lr.tagName,elementExamplesCallback({defineExample:e}){[{name:"danger",inputs:{variant:sr.Danger},slot:c`<strong>Alert!</strong>This is an alert, Please be very careful!`},{name:"warning",inputs:{variant:sr.Warning},slot:"This is a warning, proceed with caution 🚧"},{name:"success",inputs:{variant:sr.Success},slot:"You have successfully completed your task!"}].forEach(n=>{e({title:n.name,stateInitStatic:{},styles:h`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
...
`))}const A3=[{title:"default",inputs:{}},{title:"button",inputs:{variant:p0.Button}},{title:"disabled",inputs:{disabled:!0}}],aa=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],v3=z({parent:te,title:yt.tagName,controls:{Text:{controlType:V.Text,initValue:"Text"},...g3(yt)},elementExamplesCallback({defineExample:e}){A3.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:aa.map(n=>!!n.inputs.checked),extraEntryStatuses:aa.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:h`
                ...
                `,inputs:{text:"custom size"}}];[{title:"default",inputs:{variant:gn.Default}},{title:"secondary style",inputs:{variant:gn.Secondary}},{title:"warning style",inputs:{variant:gn.Warning}},{title:"danger style",inputs:{variant:gn.Danger}},{title:"outline style",inputs:{variant:gn.Outline}}].forEach(r=>{e({title:r.title,renderCallback(){return t.map(o=>c`
                    ...
                    `}})})}}),ao=[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3},{label:"Really really super duper long option",value:4}],k3=[{title:"default"},{title:"transparent background",customStyle:h`
        ...
        `}],x3=z({title:oo.tagName,parent:te,controls:{Selected:{controlType:V.Dropdown,initValue:ao[0].label,options:ao.map(e=>e.label)},Direction:{controlType:V.Dropdown,initValue:"Down",options:su(Ra)},Icon:Ps(Fd.name),Prefix:{controlType:V.Text,initValue:"Sort by: "},"Force open":{controlType:V.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){k3.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Gc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:h`
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Gc.map((i,a)=>{const s=h`
                        ...
                        <${Xi}>${t.content}</${Xi}>
                    `}})})}}),Yc="/toniq-labs-design-system";function T1(...e){const n=[globalThis.location.pathname.startsWith(Yc)?Yc:"",...e].filter(ye);return gr(...n)}const fn=Array(30).fill(T1("/toniq-labs-logo.png")),bn=["Hello there.","There is stuff here."],so=bn.concat(Array(30).fill(bn)),T3=z({title:re.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${re.assign({infoParagraphs:so,imageUrls:fn,socialUrls:l4,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${re}>
            ...
            `,renderCallback({controls:n}){return c`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),c`
                            ...
                            ></${io}>
                        `))}})})}}),S1="https://cdn-bitcoin.bioniq.io",P3=gr(S1,"content"),B3=gr(S1,"thumbnail"),et={thumbnail(e){return gr(B3,e)},content(e){return gr(P3,e)}},L3=[{imageUrl:et.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
            <div
                style=${h`
                    display: flex;
                    gap: 8px;
    ...
    `}),sa=Fr({entries:L3,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"price",title:"PRICE",option:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${h`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),j3=Fr({entries:O3,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"price",title:"PRICE LONG COLUMN NAME",option:{sticky:!0,spaceEvenly:!0}},{key:"from",title:"FROM",option:{spaceEvenly:!0}},{key:"to",title:"TO",option:{spaceEvenly:!0},style:h`
                width: 100%;
                display: flex;
                justify-content: flex-end;
            `}],createRowObject:e=>({cells:{image:c`
                ...
                `},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),Xc=Fr({entries:N3,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"type",title:"TYPE",option:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),F3=Fr({entries:D3,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"type",title:"TYPE",option:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${h`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),V3=Fr({entries:R3,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME",style:h`
                display: flex;
                justify-content: flex-end;
            `}],createRowObject:e=>({cells:{image:c`
                    <img
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Kc=ys({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const n=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(n)}})}},cleanupCallback({state:e,updateState:t}){var n;(n=e.cleanup)==null||n.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),H3=z({title:ke.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return c`
            ...
            `,renderCallback(){return c`
                ...
                `}})}}),W3=z({title:dr.tagName,parent:te,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:ur.Small}},{title:"large",inputs:{size:ur.Large}},{title:"whole page",inputs:{size:ur.WholePage},styles:h`
                    :host {
                        width: 500px;
                    }
...
`,Yn={min:10,max:50},Y3=z({title:D.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:h`
                ${Re}
            `,renderCallback({state:t,updateState:n}){return c`
                    <${D.assign({value:t.value,...Yn})}
            ...
            `,renderCallback({state:t,updateState:n}){return c`
                ...
                ${Re}
            `,renderCallback({state:t,updateState:n}){return c`
                    <${D.assign({value:t.value,...Yn,suffix:"ICP"})}
                        ${y(D.events.valueChange,r=>{if(typeof r.detail!="number")throw new Error("was expecting a single numeric slider value");n({value:r.detail})})}
                    ></${D}>
            ...
            `,renderCallback({state:t,updateState:n}){return c`
                ...
                ${Re}
            `,renderCallback({state:t,updateState:n}){return c`
                    <${D.assign({value:t.value,noLabel:!0,...Yn})}
                        ${y(D.events.valueChange,r=>{if(typeof r.detail!="number")throw new Error("was expecting a single numeric slider value");n({value:r.detail})})}
                    ></${D}>
                `}}),e({title:"Disabled",stateInitStatic:{value:28},styles:h`
                ${Re}
            `,renderCallback({state:t,updateState:n}){return c`
                    <${D.assign({value:t.value,disabled:!0,...Yn})}
                        ${y(D.events.valueChange,r=>{if(typeof r.detail!="number")throw new Error("was expecting a single numeric slider value");n({value:r.detail})})}
                    ></${D}>
                ...
                <p>another one</p>
            `,forceShow:!1}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!1})}}),J3=z({parent:te,title:fr.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${bo.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return c`
...
`;function lA(e,t,n){const r=E1(n);return e({title:t,styles:sA,renderCallback(){return c`
            ...
            `}})}const cA=z({title:"Fonts",parent:hi,elementExamplesCallback({defineExample:e}){ue(P).map(t=>{const n=P[t];return lA(e,t,n)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),uA=z({title:"Shadows",parent:hi,elementExamplesCallback({defineExample:e}){R1(Tr).forEach(([t,n])=>{e({title:t,styles:h`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
