 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const rr=(e,t)=>{var r;const n=e._$AN;if(n===void 0)return!1;for(const o of n)(r=o._$AO)==null||r.call(o,t,!1),rr(o,t);return!0},Co=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while((n==null?void 0:n.size)===0)},Su=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),Vf(t)}};function Uf(e){this._$AN!==void 0?(Co(this),this._$AM=e,Su(this)):this._$AM=e}function Wf(e,t=!1,n=0){const r=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(t)if(Array.isArray(r))for(let i=n;i<r.length;i++)rr(r[i],!1),Co(r[i]);else r!=null&&(rr(r,!1),Co(r));else rr(this,e)}const Vf=e=>{e.type==Bn.CHILD&&(e._$AP??(e._$AP=Wf),e._$AQ??(e._$AQ=Uf))};class zf extends ut{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,n,r){super._$AT(t,n,r),Su(this),this.isConnected=t._$AU}_$AO(t,n=!0){var r,o;t!==this.isConnected&&(this.isConnected=t,t?(r=this.reconnected)==null||r.call(this):(o=this.disconnected)==null||o.call(this)),n&&(rr(this,t),Co(this))}setValue(t){if(Rf(this._$Ct))this._$Ct._$AI(t,this);else{const n=[...this._$Ct._$AH];n[this._$Ci]=t,this._$Ct._$AI(n,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Zf={attribute:!0,type:String,converter:$o,reflect:!1,hasChanged:Qa},Gf=(e=Zf,t,n)=>{const{kind:r,metadata:o}=n;let i=globalThis.litPropertyMetadata.get(o);if(i===void 0&&globalThis.litPropertyMetadata.set(o,i=new Map),i.set(n.name,e),r==="accessor"){const{name:a}=n;return{set(s){const l=t.get.call(this);t.set.call(this,s),this.requestUpdate(a,l,e)},init(s){return s!==void 0&&this.P(a,void 0,e),s}}}if(r==="setter"){const{name:a}=n;return function(s){const l=this[a];t.call(this,s),this.requestUpdate(a,l,e)}}throw Error("Unsupported decorator location: "+r)};function Yf(e){return(t,n)=>typeof n=="object"?Gf(e,t,n):((r,o,i)=>{const a=o.hasOwnProperty(i);return o.constructor.createProperty(i,a?{...r,wrapped:!0}:r),a?Object.getOwnPropertyDescriptor(o,i):void 0})(e,t,n)}/**
 * @license
...
`,Bd=v({name:"LoaderAnimated24Icon",svgTemplate:c`
    ...
    `,events:{routeChange:ie()},renderCallback({inputs:e,dispatch:t,events:n}){var o,i;function r(a){e.route&&_o(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new n.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return c`
            ...
            `}}});const{defineElement:Ge,defineElementNoInputs:hb}=ss(),Fe=Ge()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>h`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `,renderCallback:({inputs:e,dispatch:t})=>{var r,o;const n=((o=e.router)==null?void 0:o.createRoutesUrl({...(r=e.router)==null?void 0:r.getCurrentRawRoutes(),...e.route}))??"#";return c`
        ...
        `}});function Jm(e,t){return e.entry.entryType===be.Root?!1:!!(e.entry.entryType===be.Page||st(t,e.fullUrlBreadcrumbs.slice(0,-1))||st(t==null?void 0:t.slice(0,-1),e.fullUrlBreadcrumbs.slice(0,-1)))}const pt=Ge()({tagName:"book-nav",cssVars:{"book-nav-internal-indent":"0"},styles:({cssVars:e})=>h`
        :host {
            display: flex;
            flex-direction: column;
            padding: 16px 0;
    ...
    `,renderCallback({inputs:e}){const t=e.flattenedNodes.map(n=>{if(!Jm(n,e.selectedPath))return;const r=h`
        ...
        `}});async function Xm(e){await ua(2);const t=e.shadowRoot.querySelector(".selected");if(!t)throw new Error("Failed to find selected nav tree element.");await xf(t)||t.scrollIntoView({behavior:"smooth",block:"center"})}const Dt=Ge()({tagName:"book-error",styles:h`
        :host {
            display: flex;
            flex-direction: column;
            color: red;
    ...
    `,renderCallback({inputs:e,dispatch:t,events:n}){return Object.entries(e.config).length?Object.entries(e.config).map(([r,o],i)=>{if(o.controlType===H.Hidden)return"";const a=_m(e.currentValues[r],o,s=>{const l=ee(e.fullUrlBreadcrumbs,"array")?e.fullUrlBreadcrumbs:e.fullUrlBreadcrumbs[r];if(!l)throw new Error(`Failed to find breadcrumbs from given control name: '${r}'`);t(new n.controlValueChange({fullUrlBreadcrumbs:l,newValues:{...e.currentValues,[r]:s}}))});return c`
                ...
                `}):""}});function _m(e,t,n){return on(t,H.Hidden)?"":on(t,H.Checkbox)?c`
            <input
                type="checkbox"
                .value=${e}
    ...
    `,events:{loadingRender:ie()},stateInitStatic:{lastElement:void 0},renderCallback:({inputs:e,dispatch:t,events:n,state:r,updateState:o})=>{const i=wa(e.currentRoute.paths),a=eg({currentNodes:e.currentNodes,isTopLevel:!0,router:e.router,isSearching:!!i,controls:e.controls,originalTree:e.originalTree});return c`
            ...
            ${me(e.showLoading,c`
                ...
                `,c`
                    ...
                    <slot name=${lt.Footer}></slot>
                `)}
        `}});function tg(e,t,n){const r=Jl(e,t);if(r.length)return r;n(Tn);const o=Jl(e,Tn.paths);if(!o)throw new Error(`Tried to self-correct for invalid path ${t.join("/")}
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{Xl(e,wa(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:n,updateState:r,dispatch:o,events:i})=>{var p,f,m,g,b,x,$;t._debug&&console.info("rendering element-book app");function a(A){return{...e.currentRoute,...A}}function s(A){const S=a(A);return!st(e.currentRoute,S)}function l(A){t.preventWindowTitleChange||(e.originalWindowTitle||r({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,A].filter(ke).join(" - "))}function u(A){if(!s(A))return;const S=a(A);e.router?e.router.setRoutes(S):r({currentRoute:{...e.currentRoute,...S}}),t.elementBookRoutePaths&&!st(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(S.paths??[]))}try{if(t.elementBookRoutePaths&&!st(t.elementBookRoutePaths,e.currentRoute.paths)&&u({paths:t.elementBookRoutePaths}),(p=t.internalRouterConfig)!=null&&p.useInternalRouter&&!e.router){const V=sp(t.internalRouterConfig.basePath);r({router:V}),V.addRouteListener(!0,he=>{r({currentRoute:he})})}else!((f=t.internalRouterConfig)!=null&&f.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const A={themeColor:t.themeColor};if(!st(A,(m=e.colors)==null?void 0:m.config)){const V=Wl(A);r({colors:{config:A,theme:V}}),up(n,V)}const S=t._debug??!1,D=V1({entries:t.entries,debug:S});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),r({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:Yu(D.tree,{children:(b=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:b.children,controls:t.globalValues})}}));const R=wa(e.currentRoute.paths),ne=(R?J1({flattenedNodes:D.flattenedNodes,searchQuery:R}):void 0)??tg(D.flattenedNodes,e.currentRoute.paths,u);l((x=ne[0])==null?void 0:x.entry.title);const se=($=e.treeBasedControls)==null?void 0:$.controls;return se?(t._debug&&console.info({currentControls:se}),c`
                <div
                    ...
                    ${k($r.events.controlValueChange,V=>{if(!e.treeBasedControls)return;const he=Z1(se,V.detail.fullUrlBreadcrumbs,V.detail.newValues);r({treeBasedControls:{...e.treeBasedControls,controls:he}})})}
                >
            ...
            `}}});async function Xl(e,t,n){if(t||n.paths.length<=1)return;const r=e.shadowRoot.querySelector(pt.tagName);if(!(r instanceof pt))throw new Error(`Failed to find child '${pt.tagName}'`);await Xm(r)}const d=yt({"toniq-icon-fill-color":P["vira-icon-fill-color"].default,"toniq-icon-stroke-color":P["vira-icon-stroke-color"].default,"toniq-icon-stroke-width":"2px"}),Y=ye(d,(e,t)=>n=>M(`var(${t.name}, ${n})`)),ng=v({name:"CheckMark16Icon",svgTemplate:c`
...
`))}const O=(()=>{const e=h`
    ...
    `,g=h`
        ${Oe("monospaceFont")}
    `;return{toniqFont:e,normalWeightFont:t,boldFont:n,extraBoldFont:r,paragraphFont:o,boldParagraphFont:i,labelFont:a,boldLabelFont:s,h1Font:l,h2Font:u,h3Font:p,h4Font:f,h5Font:m,monospaceFont:g}})(),Ar={popupShadow:h`
...
`,I2=v({name:"CryptoIcp16Icon",svgTemplate:c`
    ...
    `}),at={"core-16":[ng,Fd,ag,sg,lg,qt,cg,ug],"core-24":[dg,hg,ws,fg,pg,vs,jd,mg,gg,wg,vg,bg,yg,kg,xg,$g,bs,Hd,Ag,Cg,Ud,Sg,Tg,Mg,Eg,Ig,Wd,qg,Bg,Lg,Pg,Og,Vd,Dg,Ng,Rg,Fg,jg,Hg,Ug,Wg,Ea,zd,Vg,zg,Zg,Gg,Yg,Qg,ys,Kg,Jg,Xg,_g,e2,t2,n2,r2,o2,Zd,Gd,i2,a2,s2,l2,c2,u2,d2,fo,h2,f2,p2,Yd,m2,g2,Qd],"core-48":[w2,v2,Kd,b2,y2,k2,x2,$2,A2],"core-64":[Jd,C2,S2],cryptocurrencies:[T2,gt,M2,E2,I2,q2],"external-wallets":[B2,L2,P2,O2,D2,N2,R2,F2,j2,H2,U2,W2],"third-party-brands":[e0,t0,n0,V2,z2,Z2,r0,G2,o0,Y2,i0,a0,Q2,s0,l0],toniq:[K2,J2]},X2=Ir({discord:rt(void 0,""),distrikt:rt(void 0,""),dscvr:rt(void 0,""),instagram:rt(void 0,""),medium:rt(void 0,""),telegram:rt(void 0,""),tikTok:rt(void 0,""),twitch:rt(void 0,""),twitter:rt(void 0,""),website:rt(void 0,"")}),_2=X2.defaultValue,c0={discord:e0,instagram:r0,telegram:i0,tikTok:a0,distrikt:t0,twitch:s0,dscvr:n0,medium:o0,twitter:l0,website:Yd},tc="toniq-",{defineElement:ae,defineElementNoInputs:ks}=ss({assertInputs:e=>{if(!e.tagName.startsWith(tc))throw new Error(`Tag name should start with '${tc}' but got '${e.tagName}'`)}}),y=ae()({tagName:"toniq-icon",styles:h`
        :host {
            display: flex;
    ...
    `,renderCallback:({inputs:e})=>c`
        ...
        `}),Uc="...";function Dv(e,t,n=7,r=5){let o;e=yn({value:e,min:1,max:t}),n=yn({value:n,min:r,max:t});const i=n-5,a=n-3;t<=n?o=n:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>n?Yi(t-o,t):e>o?Yi(Math.min(s.start,t-o),Math.min(s.end,t)):Yi(1,Math.min(t,o+1));function u(f,m){return l.length+1!==t?m:[f]}const p=l[l.length-1];if(p&&p<t){const f=u(t,[Uc,t]);return[...l,...f]}else return l[0]!==1?u(1,[1,Uc]).concat(l):l}function Yi(e,t){const n=t-e+1;return Array.from({length:n},(r,o)=>e+o)}const Qi=ae()({tagName:"toniq-pagination",styles:h`
        :host {
            display: flex;
        }
    ...
    `,stateInitStatic:{canScroll:!1,debouncedResize:B1(()=>Kh(hr.FirstThenWait,{milliseconds:30})),rowStyles:{},isPainting:!1,isStillPainting:!0,pageCountKey:0,tableListLeft:0},initCallback({inputs:e,state:t,updateState:n}){const r=e.columns.filter(o=>!o.disabled);n({rowStyles:r.reduce((o,i)=>(o[i.key]={width:void 0,left:void 0},o),t.rowStyles)})},renderCallback({inputs:e,state:t,updateState:n,events:r,dispatch:o,host:i}){var m;const a=e.columns.filter(g=>!g.disabled),s=[e.rows[0],...e.rows].filter(ke);function l(g){g instanceof HTMLElement&&setTimeout(()=>{t.debouncedResize(()=>{n({canScroll:g.scrollWidth>g.clientWidth,tableListLeft:g.getBoundingClientRect().left})})},0)}const u=e.pagination&&((m=e.pagination)==null?void 0:m.pageCount)>1?c`
        ...
        `}});async function Nv(e){return navigator.clipboard.writeText(e)}const Rv="…";function Fv(e,t){const n=e.slice(0,t).trim(),r=e.slice(-1*t).trim();return`${n}${Rv}${r}`}function jv(e){return!(e%1)}function Hv(e){return e.letterCount==null?4:jv(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const T=ae()({tagName:"toniq-middle-ellipsis",events:{copy:ie()},cssVars:{"toniq-middle-ellipsis-text-color":w.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":w.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":w.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":w.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>h`
        :host {
            /* 5 frames at 60 fps */
            transition: ${oe.interaction};
            ${O.paragraphFont};
...
`,Zc=h`
    transform: scale(1.2);
`;function _v(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Xn(e){requestAnimationFrame(()=>{const t=bh(e.instanceInputs,e).elementValue;Xv(t,e)&&(e.setAttribute("disabled","true"),Xn(e))})}const j=ae()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ie()},styles:h`
        :host {
            display: block;
        }
            ...
            `}function b($){i({internalValue:$}),e.disabled||r(new n.valueChange($))}function x($,A,S){const D=Vt((m-Wt)*(S.max-A)/(S.max-S.min)+Wt/2),R=ea($,u,l),G=_i({value:A,limits:S,flip:!1});return c`
                ...
                >
                    ...
                    <input
                        ?disabled=${e.disabled??!1}
                        type="range"
                        class="${B.slider} ${e.colorTemperature?_v(Math.abs(G)):""}"
                        step=${e.step}
                        .min=${S.min}
                        .max=${S.max}
                        .value=${A}
    ...
    `,stateInitStatic:{clickToggled:!1,boundingClientRect:void 0,popOverEl:void 0},renderCallback({inputs:e,state:t,updateState:n}){const r=Qf();function o(s){var l,u;if(!(s instanceof HTMLSlotElement))throw new Error("click event had no target");n({boundingClientRect:(l=s.assignedElements()[0])==null?void 0:l.getBoundingClientRect()}),e.forceShow&&((u=t.popOverEl)==null||u.showPopover())}function i(s){const l=s.target;if(!(l instanceof HTMLElement))throw new Error("click event had no target");n({boundingClientRect:l.getBoundingClientRect()})}function a(){var s;n({clickToggled:!1}),(s=t.popOverEl)==null||s.hidePopover()}return c`
        ...
        `}}),_n=ae()({tagName:"toniq-top-tabs",events:{routeChange:ie(),valueChange:ie()},cssVars:{"toniq-top-tabs-selected-border-width":"2px","toniq-top-tabs-tab-vertical-padding":"18px"},styles:({cssVars:e})=>h`
        :host {
            display: block;
        }
    ...
    `,renderCallback({inputs:e,dispatch:t,events:n}){const r=e.tabs.map(o=>{var l;const i=o.value===e.value,a=o.icon?c`
        ...
        `}}),xh=U({title:"Data",parent:void 0}),Vo=ae()({tagName:"toniq-icon-book-viewer",styles:h`
        :host {
            display: inline-flex;
            padding: 8px;
            border-radius: 8px;
    ...
    `,renderCallback({inputs:e}){return c`
            <${y.assign({icon:e.icon})}></${y}>
        `}}),ci=Object.values(at).reduce((e,t)=>(t.forEach(n=>{if(n.name in e)throw new Error(`Icon name duplicate: '${n.name}'`);e[n.name]=n}),e),{}),e5=Object.keys(ci).sort();function Bs(e){return{controlType:H.Dropdown,initValue:e,options:["None",...e5]}}const $h={"CSS color":{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Number,initValue:2}};function bo(e){return Object.entries(e).filter(([,n])=>n!==""&&n!=null).map(([n,r])=>(n.toLowerCase()==="css color"&&(n="color"),ee(r,"number")&&(r=Va({value:r,suffix:"px"})),`${n}: ${r};`)).join(`
`)}const t5=U({title:"Social Urls",parent:xh,elementExamplesCallback({defineExample:e}){function t({socialName:n,icon:r}){e({title:n,renderCallback(){return c`
                        <${Vo.assign({icon:r})}></${Vo}>
                    `}})}Object.entries(c0).forEach(([n,r])=>{t({socialName:n,icon:r})})}}),te=U({title:"Elements",parent:void 0}),n5=U({parent:te,title:ar.tagName,elementExamplesCallback({defineExample:e}){[{name:"danger",inputs:{variant:ir.Danger},slot:c`<strong>Alert!</strong>This is an alert, Please be very careful!`},{name:"warning",inputs:{variant:ir.Warning},slot:"This is a warning, proceed with caution 🚧"},{name:"success",inputs:{variant:ir.Success},slot:"You have successfully completed your task!"}].forEach(n=>{e({title:n.name,stateInitStatic:{},styles:h`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
        ...
        `}],o5=U({title:Qt.tagName,parent:te,elementExamplesCallback({defineExample:e}){r5.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:h`
                    .bold {
                        ${O.boldFont}
                    }
...
`,a5=U({parent:te,title:ve.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:ra,renderCallback(){return c`
                    ...
                    <${ve.assign({enableAutomaticCycling:!0,templates:at["core-24"].map(t=>{const n=h`
                            ...
                            `;return c`
                                <${y.assign({icon:t})} style=${n}></${y}>
                            `})})}></${ve}>
                    <${ve.assign({enableAutomaticCycling:!0,cycleIntervalMs:1e3,templates:at["core-24"].map(t=>{const n=af({min:0,max:150}),r=h`
                                padding: 100px ${n}px;
                                border: 1px solid ${w.pageInteraction.foregroundColor};
                                border-radius: 12px;
                            `;return c`
                ...
                `;return c`
                    ...
                    <${ve.assign({enableAutomaticCycling:!1,offsetArrows:!0,variant:mo.Banner,templates:at["core-24"].map(n=>c`
                            ...
                            `)})}></${ve}>
                `}})}});function s5(e){const t=Object.keys(e.cssVars).map(n=>[`--${n}`,{controlType:H.Color,initValue:""}]);return Object.fromEntries(t)}function l5(e){const t=Object.entries(e).map(([n,r])=>{if(n.startsWith("--"))return typeof r!="string"||!r?void 0:`${n}: ${r};`}).filter(ke);return M(t.join(`
`))}const c5=[{title:"default",inputs:{}},{title:"button",inputs:{variant:f0.Button}},{title:"disabled",inputs:{disabled:!0}}],oa=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],u5=U({parent:te,title:kt.tagName,controls:{Text:{controlType:H.Text,initValue:"Text"},...s5(kt)},elementExamplesCallback({defineExample:e}){c5.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:oa.map(n=>!!n.inputs.checked),extraEntryStatuses:oa.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:h`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return oa.map((i,a)=>{const s=(i.extraEntries??[]).map((u,p)=>{var f;return c`
                        ...
                        `})}})})}}),d5=U({parent:te,title:Di.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:qt}},{inputs:{icon:qt}},{inputs:{},template:c`
                    HTML child
                ...
                `,inputs:{text:"custom size"}}];[{title:"default",inputs:{variant:mn.Default}},{title:"secondary style",inputs:{variant:mn.Secondary}},{title:"warning style",inputs:{variant:mn.Warning}},{title:"danger style",inputs:{variant:mn.Danger}},{title:"outline style",inputs:{variant:mn.Outline}}].forEach(r=>{e({title:r.title,renderCallback(){return t.map(o=>c`
                    ...
                    `}})})}}),oo=[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3},{label:"Really really super duper long option",value:4}],f5=[{title:"default"},{title:"transparent background",customStyle:h`
        ...
        `}],p5=U({title:no.tagName,parent:te,controls:{Selected:{controlType:H.Dropdown,initValue:oo[0].label,options:oo.map(e=>e.label)},Direction:{controlType:H.Dropdown,initValue:"Down",options:su(Ra)},Icon:Bs(jd.name),Prefix:{controlType:H.Text,initValue:"Sort by: "},"Force open":{controlType:H.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){f5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Gc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:h`
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Gc.map((i,a)=>{const s=h`
                        ...
                        <${Gi}>${t.content}</${Gi}>
                    `}})})}}),Yc="/toniq-labs-design-system";function Ah(...e){const n=[globalThis.location.pathname.startsWith(Yc)?Yc:"",...e].filter(ke);return pr(...n)}const fn=Array(30).fill(Ah("/toniq-labs-logo.png")),bn=["Hello there.","There is stuff here."],io=bn.concat(Array(30).fill(bn)),w5=U({title:re.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${re.assign({infoParagraphs:io,imageUrls:fn,socialUrls:_2,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${re}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${re.assign({imageUrls:fn.map((t,n)=>n%2?"/invalid-image.png":t),infoParagraphs:bn,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return c`
                            ...
                            `}})}></${re}>
                `}})}}),v5=U({title:Yt.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:h`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:n}){return c`
                ...
                `}})}}),b5=U({title:Ie.tagName,parent:te,elementExamplesCallback({defineExample:e}){lu(wn).forEach(t=>{e({title:t,renderCallback(){return c`
            ...
            `,renderCallback(){return c`
                ...
                `}})}}),y5=U({parent:te,title:Je.tagName,elementExamplesCallback({defineExample:e}){[{title:"default",inputs:{linkType:wt.ReplacePage}},{title:"new tab",inputs:{linkType:wt.NewTab}},{title:"hover styles",inputs:{withHoverStyles:!0,linkType:wt.NewTab}},{title:"route link",inputs:{linkType:wt.RouteLink}},{title:"link disabled",inputs:{linkType:wt.Disabled}}].forEach(n=>{e({title:n.title,descriptionParagraphs:n.descriptions,renderCallback(){return c`
                    ...
                    `}})})}}),k5=U({title:y.tagName,parent:te,controls:$h,elementExamplesCallback({defineExample:e}){const t=[{icon:Jd},{icon:Kd},{icon:Ud},{icon:qt},{icon:void 0}];e({title:"sizes",styles:h`
                :host {
                    display: flex;
                    gap: 16px;
                    align-items: center;
            ...
            `,renderCallback({controls:n}){return c`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),c`
                            ...
                            ></${ro}>
                        `))}})})}}),Ch="https://cdn-bitcoin.bioniq.io",$5=pr(Ch,"content"),A5=pr(Ch,"thumbnail"),_e={thumbnail(e){return pr(A5,e)},content(e){return pr($5,e)}},C5=[{imageUrl:_e.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
            <div
                style=${h`
                    display: flex;
                    gap: 8px;
    ...
    `}),ia=Rr({entries:C5,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"price",title:"PRICE",option:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${h`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),I5=Rr({entries:S5,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"price",title:"PRICE LONG COLUMN NAME",option:{sticky:!0,spaceEvenly:!0}},{key:"from",title:"FROM",option:{spaceEvenly:!0}},{key:"to",title:"TO",option:{spaceEvenly:!0},style:h`
                width: 100%;
                display: flex;
                justify-content: flex-end;
            `}],createRowObject:e=>({cells:{image:c`
                ...
                `},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),Qc=Rr({entries:T5,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"type",title:"TYPE",option:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),q5=Rr({entries:M5,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"type",title:"TYPE",option:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${h`
                            width: 24px;
                            height: auto;
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Kc=ks({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const n=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(n)}})}},cleanupCallback({state:e,updateState:t}){var n;(n=e.cleanup)==null||n.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),P5=U({title:xe.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return c`
            ...
            `,renderCallback(){return c`
                    <${xe.assign({...I5,pagination:{currentPage:1,pageCount:5},nonBlocking:!0})}></${xe}>
                `}})}}),O5=U({title:cr.tagName,parent:te,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:lr.Small}},{title:"large",inputs:{size:lr.Large}},{title:"whole page",inputs:{size:lr.WholePage},styles:h`
                    :host {
                        width: 500px;
                    }
            ...
            `,renderCallback(){return c`
                ...
                `}})}}),N5=U({title:Vn.tagName,parent:te,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:h`
                ${Vn} {
                    height: 32px;
                }
...
`,aa={min:10,max:50},F5=U({title:j.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:h`
            ...
            `,renderCallback({state:t,updateState:n}){return c`
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Jc.map((i,a)=>c`
                            ...
                            ></${na}>
                        `)}})})}}),U5=U({parent:te,title:vo.tagName,elementExamplesCallback({defineExample:e}){function t({title:n,tooltipContent:r,forceShow:o}){e({title:n,styles:h`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!1}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!1})}}),W5=U({parent:te,title:dr.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${vo.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return c`
                ...
                `,renderCallback({state:n,updateState:r}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return c`
                    ...
                    `}})})}}),Sh=U({title:"Icons",parent:void 0,controls:$h}),G5=Object.entries(at).map(([e,t])=>U({title:e,parent:Sh,elementExamplesCallback({defineExample:n}){t.map(r=>n({title:r.name,renderCallback({controls:o}){return c`
                                <${Vo.assign({icon:r})}
                                    style=${bo(o)}
                                ></${Vo}>
                            `}}))}}));function Th(e){const t=Y5(e),n=ye(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return ce(n).reduce((o,i)=>{const a=n[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function Y5(e){typeof e!="string"&&(e=String(e));const r=`{"${tu(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(r);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${r}`),o}}const ui=U({title:"Styles",parent:void 0}),Q5=h`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function K5(e,t,n){const r=Th(F(n));return e({title:t,styles:Q5,renderCallback(){return c`
            ...
            `}})}const J5=U({title:"Colors",parent:ui,elementExamplesCallback({defineExample:e}){ce(w).map(t=>K5(e,t,w[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),X5=h`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function _5(e,t,n){const r=Th(n);return e({title:t,styles:X5,renderCallback(){return c`
            ...
            `}})}const eb=U({title:"Fonts",parent:ui,elementExamplesCallback({defineExample:e}){ce(O).map(t=>{const n=O[t];return _5(e,t,n)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),tb=U({title:"Shadows",parent:ui,elementExamplesCallback({defineExample:e}){Dh(Ar).forEach(([t,n])=>{e({title:t,styles:h`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return c`
                            <div></div>
                        `}})})}}),nb=[te,Sh,ui,xh],rb=[...G5,...V5,t5,o5,n5,i5,a5,u5,d5,J5,h5,p5,g5,w5,v5,eb,b5,y5,k5,x5,O5,D5,N5,R5,tb,F5,H5,Z5,P5].sort((e,t)=>e.title.localeCompare(t.title)),ob=[...nb,...rb];Xo({tagName:"toniq-design-system-app",styles:h`
        :host {
            display: block;
            height: 100%;
            width: 100%;
