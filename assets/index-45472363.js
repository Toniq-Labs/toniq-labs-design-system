 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:a1}=o1,Ms=()=>document.createComment(""),Lr=(e,t,r)=>{var i;const n=e._$AA.parentNode,o=t===void 0?e._$AB:t._$AA;if(r===void 0){const a=n.insertBefore(Ms(),o),s=n.insertBefore(Ms(),o);r=new a1(a,s,e,e.options)}else{const a=r._$AB.nextSibling,s=r._$AM,l=s!==e;if(l){let c;(i=r._$AQ)==null||i.call(r,e),r._$AM=e,r._$AP!==void 0&&(c=e._$AU)!==s._$AU&&r._$AP(c)}if(a!==o||l){let c=r._$AA;for(;c!==a;){const f=c.nextSibling;n.insertBefore(c,o),c=f}}}return r},Bt=(e,t,r=e)=>(e._$AI(t,r),e),s1={},l1=(e,t=s1)=>e._$AH=t,c1=e=>e._$AH,ri=e=>{var n;(n=e._$AP)==null||n.call(e,!1,!0);let t=e._$AA;const r=e._$AB.nextSibling;for(;t!==r;){const o=t.nextSibling;t.remove(),t=o}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const hn={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Pt=e=>(...t)=>({_$litDirective$:e,values:t});class mt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,n){this._$Ct=t,this._$AM=r,this._$Ci=n}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const u1={attribute:!0,type:String,converter:ao,reflect:!1,hasChanged:Ca},d1=(e=u1,t,r)=>{const{kind:n,metadata:o}=r;let i=globalThis.litPropertyMetadata.get(o);if(i===void 0&&globalThis.litPropertyMetadata.set(o,i=new Map),i.set(r.name,e),n==="accessor"){const{name:a}=r;return{set(s){const l=t.get.call(this);t.set.call(this,s),this.requestUpdate(a,l,e)},init(s){return s!==void 0&&this.P(a,void 0,e),s}}}if(n==="setter"){const{name:a}=r;return function(s){const l=this[a];t.call(this,s),this.requestUpdate(a,l,e)}}throw Error("Unsupported decorator location: "+n)};function h1(e){return(t,r)=>typeof r=="object"?d1(e,t,r):((n,o,i)=>{const a=o.hasOwnProperty(i);return o.constructor.createProperty(i,a?{...n,wrapped:!0}:n),a?Object.getOwnPropertyDescriptor(o,i):void 0})(e,t,r)}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ke=Pt(class extends mt{constructor(e){var t;if(super(e),e.type!==hn.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var n,o;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!((n=this.nt)!=null&&n.has(i))&&this.st.add(i);return this.render(t)}const r=e.element.classList;for(const i of this.st)i in t||(r.remove(i),this.st.delete(i));for(const i in t){const a=!!t[i];a===this.st.has(i)||(o=this.nt)!=null&&o.has(i)||(a?(r.add(i),this.st.add(i)):(r.remove(i),this.st.delete(i)))}return Pe}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const As=e=>e??Q;/**
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Vi extends mt{constructor(t){if(super(t),this.it=Q,t.type!==hn.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===Q||t==null)return this._t=void 0,this.it=t;if(t===Pe)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const r=[t];return r.raw=r,this._t={_$litType$:this.constructor.resultType,strings:r,values:[]}}}Vi.directiveName="unsafeHTML",Vi.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,ld=v({name:"LoaderAnimated24Icon",svgTemplate:u`
    ...
    `,events:{routeChange:ee()},renderCallback({inputs:e,dispatch:t,events:r}){var o,i;function n(a){e.route&&Bo(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new r.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return u`
            ...
            `}}});const{defineElement:ze,defineElementNoInputs:V5}=Da(),De=ze()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>p`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `,renderCallback({inputs:e}){return u`
        ...
        `}});function hd(e,t,r,n){const o=zi(r,n),i=[];if(o){const a=hd(e,t,o,n);a&&i.push(a)}if(hr(r,pe.Page)&&!e.includes(r)){const a=_a(t,r.fullUrlBreadcrumbs);i.push({config:r.entry.controls,current:a,breadcrumbs:ge(a,()=>r.fullUrlBreadcrumbs)})}return i.reduce((a,s)=>({config:{...a.config,...s.config},current:{...a.current,...s.current},breadcrumbs:{...a.breadcrumbs,...s.breadcrumbs}}),{config:{},current:{},breadcrumbs:{}})}function gm({currentNodes:e,isTopLevel:t,router:r,isSearching:n,controls:o,originalTree:i}){if(!e.length&&n)return[u`
            ...
            `];const a=_i(e,1)?hd(e,o,e[0],i):void 0,s=a&&Object.values(a.config).length&&_i(e,1)?u`
              ...
              `:Q,l=p1(e,c=>c.fullUrlBreadcrumbs.join(">"),(c,f)=>{if(hr(c,pe.Page))return u`
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{El(e,Wi(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:r,updateState:n,dispatch:o,events:i})=>{var f,h,m,g,w,$,k;t._debug&&console.info("rendering element-book app");function a(x){return{...e.currentRoute,...x}}function s(x){const C=a(x);return!ht(e.currentRoute,C)}function l(x){t.preventWindowTitleChange||(e.originalWindowTitle||n({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,x].filter(be).join(" - "))}function c(x){if(!s(x))return;const C=a(x);e.router?e.router.setRoutes(C):n({currentRoute:{...e.currentRoute,...C}}),t.elementBookRoutePaths&&!ht(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(C.paths??[]))}try{if(t.elementBookRoutePaths&&!ht(t.elementBookRoutePaths,e.currentRoute.paths)&&c({paths:t.elementBookRoutePaths}),(f=t.internalRouterConfig)!=null&&f.useInternalRouter&&!e.router){const W=xf(t.internalRouterConfig.basePath);n({router:W}),W.addRouteListener(!0,le=>{n({currentRoute:le})})}else!((h=t.internalRouterConfig)!=null&&h.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const x={themeColor:t.themeColor};if(!ht(x,(m=e.colors)==null?void 0:m.config)){const W=yl(x);n({colors:{config:x,theme:W}}),Cf(r,W)}const C=t._debug??!1,D=af({entries:t.entries,debug:C});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),n({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:Tu(D.tree,{children:(w=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:w.children,controls:t.globalValues})}}));const U=Wi(e.currentRoute.paths),fe=(U?ff({flattenedNodes:D.flattenedNodes,searchQuery:U}):void 0)??wm(D.flattenedNodes,e.currentRoute.paths,c);l(($=fe[0])==null?void 0:$.entry.title);const de=(k=e.treeBasedControls)==null?void 0:k.controls;return de?(t._debug&&console.info({currentControls:de}),u`
                <div
                    ...
                    ${S(sn.events.controlValueChange,W=>{if(!e.treeBasedControls)return;const le=lf(de,W.detail.fullUrlBreadcrumbs,W.detail.newValues);n({treeBasedControls:{...e.treeBasedControls,controls:le}})})}
                >
    ...
    `}),qm=v({name:"ChevronUp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Pm=v({name:"Circle24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Il={interactionDuration:p`--toniq-interaction-transition-duration`,prettyDuration:p`--toniq-pretty-transition-duration`},X={interaction:p`var(${Il.interactionDuration}, 84ms)`,pretty:p`var(${Il.prettyDuration}, 300ms)`};p`toniq-modal-grow`,p`
        ...
        `;function pi(e){return{foregroundColor:e.backgroundColor,backgroundColor:e.foregroundColor}}const Zm=(()=>{const e={backgroundColor:p`#ffffff`,foregroundColor:p`#000000`},t={...e,foregroundColor:p`#00D093`},r={...e,foregroundColor:p`#ACADAD`},n={...e,foregroundColor:p`#D6D6D6`},o={...t},i={...t,foregroundColor:p`#00A876`},a={...t,foregroundColor:p`#1D6852`},s={...n},l={...e,foregroundColor:p`#EAFBF7`},c={...e,backgroundColor:p`#D2EEFA`},f=pi(o),h=pi(i),m=pi(a),g=m,w={backgroundColor:p`#F1F3F6`,foregroundColor:e.foregroundColor},$={...w,foregroundColor:p`#9A9A9D`};return{brandPrimary:t,pagePrimary:e,pageSecondary:r,pageTertiary:n,pageInteraction:o,pageInteractionHover:i,pageInteractionActive:a,divider:s,dividerFaint:l,dropShadow:c,pageDarkPrimary:g,accentPrimary:f,accentPrimaryHover:h,accentPrimaryActive:m,accentSecondary:w,accentTertiary:$}})(),bd=Zm;function Ll(e,t){return N(`--toniq-${no(e)}-${no(t)}`)}const Ga=ge(bd,e=>({backgroundColor:Ll(e,"backgroundColor"),foregroundColor:Ll(e,"foregroundColor")}));function Ke(e,t){const r=bd[e][t],n=Ga[e][t];return p`var(${n}, ${r})`}const b=ge(Ga,e=>({foregroundColor:Ke(e,"foregroundColor"),backgroundColor:Ke(e,"backgroundColor")}));function j(e){return p`
...
`;function Nt({mainSelector:e,elementBorderSize:t,outlineGap:r=2,outlineWidth:n=3}){const o=N(Ht(n+r+t));return p`
    ...
    `}const yd={toniqFont:{"font-family":p`'Lexend', sans-serif`},normalWeightFont:{"font-weight":p`400`},boldFont:{"font-weight":p`600`},extraBoldFont:{"font-weight":p`900`},paragraphFont:{"line-height":p`24px`,"font-size":p`16px`},boldParagraphFont:{},labelFont:{"line-height":p`16px`,"font-size":p`12px`},boldLabelFont:{},h1Font:{"line-height":p`96px`,"font-size":p`64px`},h2Font:{"line-height":p`64px`,"font-size":p`48px`},h3Font:{"line-height":p`48px`,"font-size":p`32px`},h4Font:{"line-height":p`32px`,"font-size":p`24px`},monospaceFont:{"font-family":p`'Inconsolata', monospace`,"line-height":p`1.125em`}},zm=ge(yd,(e,t)=>{const r=N(no(e.replace(/Font$/,"")));return ge(t,o=>{const i=N(o);return p`--toniq-font-${r}-${i}`})});function Ue(e){const t=zm[e],r=yd[e],n=oe(t).map(o=>{const i=r[o],a=t[o];return p`
            ${N(o)}: var(${a}, ${i});
        `});return N(n.join(`
`))}const R=(()=>{const e=p`
        font-style: normal;
    ...
    `,menuShadow:p`
        ...
        */
        will-change: filter;
    `};function Wm(e,t=!0){const r=N(e),n=e===":host"?p`
                  :host(:hover);
              `:p`
                  ${r}:hover
              `,o=t?p`
        ...
        ${o}
    `}const Um=v({name:"Fire24Icon",svgTemplate:u`
        <svg
            width="14"
            height="24"
            viewBox="0 0 14 19"
    ...
    `}),Gm=v({name:"Gear24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Ym=v({name:"Geometry24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Jm=v({name:"GridDots24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Km=v({name:"Heart24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Xm=v({name:"Info24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Qm=v({name:"LayersLinked24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),ep=v({name:"LayoutGrid24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),tp=v({name:"Lifebuoy24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),rp=v({name:"List24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),np=v({name:"ListDetails24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),op=v({name:"Loader24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Ya=v({name:"LoaderAnimated24Icon",svgTemplate:u`
        <style>
            @keyframes spin {
                0% {
                    transform: rotate(0deg);
    ...
    `}),ip=v({name:"Lock24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),ap=v({name:"LockOpen24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),sp=v({name:"Menu24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),lp=v({name:"Paper24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),cp=v({name:"People24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),up=v({name:"Person24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),dp=v({name:"Photo24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),hp=v({name:"Refresh24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),kd=v({name:"Rocket24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),$d=v({name:"Search24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),fp=v({name:"Send24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),pp=v({name:"Social24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),gp=v({name:"Square24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),wp=v({name:"SquareCheck24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),vp=v({name:"Tag24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),bp=v({name:"Upload24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),yp=v({name:"Wallet24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),kp=v({name:"WorldUpload24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),$p=v({name:"X24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),xp=v({name:"Folder48Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Tp=v({name:"Kyc48Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Sp=v({name:"Tag48Icon",svgTemplate:u`
        <svg
            width="48"
            height="48"
            viewBox="0 0 48 48"
...
`,qp=v({name:"CryptoIcp16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Pp=v({name:"CryptoIcp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),qd=v({name:"BrandMedium24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${Z["toniq-icon-fill-color"]("#000")}
    ...
    `}),yt={"core-16":[vm,bm,Ct],"core-24":[ym,km,Wa,$m,xm,Ua,fd,Tm,Sm,Cm,Mm,Am,Em,Im,Lm,md,pd,qm,Pm,gd,Nm,Om,Bm,Dm,wd,Rm,_m,Hm,Fm,Vm,vd,jm,Um,Gm,Ym,Jm,Km,oa,Xm,Qm,ep,tp,rp,np,op,Ya,ip,ap,sp,lp,cp,up,dp,hp,kd,$d,fp,mp,pp,gp,wp,vp,Jn,bp,yp,xd,kp,$p],"core-48":[xp,Td,Tp,Sp],"core-64":[Sd,Cp,Mp],cryptocurrencies:[Ap,Ep,Ip,Lp,qp,Pp],"third-party-brands":[Ad,Ed,Id,Np,Op,Bp,Ld,Dp,qd,Rp,Pd,Nd,_p,Od,Bd],toniq:[Hp,Fp]},Vp=pn({discord:tt(void 0,""),distrikt:tt(void 0,""),dscvr:tt(void 0,""),instagram:tt(void 0,""),medium:tt(void 0,""),telegram:tt(void 0,""),tikTok:tt(void 0,""),twitch:tt(void 0,""),twitter:tt(void 0,""),website:tt(void 0,"")}),jp=Vp.defaultValue,Dd={discord:Ad,instagram:Ld,telegram:Pd,tikTok:Nd,distrikt:Ed,twitch:Od,dscvr:Id,medium:qd,twitter:Bd,website:xd},ql="toniq-",{defineElement:te,defineElementNoInputs:Rd}=Da({assertInputs:e=>{if(!e.tagName.startsWith(ql))throw new Error(`Tag name should start with '${ql}' but got '${e.tagName}'`)}}),zt=te()({tagName:"toniq-bold-space",styles:p`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,renderCallback({inputs:e}){const t=e.icon?u`
        ...
        `}});function Zp(e,t,r={behavior:"smooth"}){let n=2;const o=t==="up"||t==="down"?"y":"x",i=t==="right"||t==="down"?"+":"-",a=o==="x"?e.scrollWidth-e.offsetWidth:e.scrollHeight-e.offsetHeight,s=Ja(e)[o];i==="-"&&(n*=-1);const l=e[o==="x"?"scrollLeft":"scrollTop"]+n,c=s.filter(h=>i==="+"?h>l:h<l).sort((h,m)=>i==="+"?h-m:m-h);let f;return c.length>0?f=c[0]:i==="+"?f=a:f=0,e.scrollTo({...r,[o==="x"?"left":"top"]:f})}function zp(e){const t=window.getComputedStyle(e),r=e.getBoundingClientRect();let n=t.getPropertyValue("scroll-padding-left").replace("auto","0px"),o=t.getPropertyValue("scroll-padding-top").replace("auto","0px"),i=t.getPropertyValue("scroll-padding-right").replace("auto","0px"),a=t.getPropertyValue("scroll-padding-bottom").replace("auto","0px");function s(m,g){let w=parseFloat(m);return/%/.test(m)&&(w/=100,w*=g),w}let l=s(n,r.width),c=s(o,r.height),f=s(i,r.width),h=s(a,r.height);return{x:{before:l,after:f},y:{before:c,after:h}}}function Wp(e,t,r="both"){return r==="x"&&e.right>=t.left&&e.left<=t.right||r==="y"&&e.bottom>=t.top&&e.top<=t.bottom||r==="both"&&e.right>=t.left&&e.left<=t.right&&e.bottom>=t.top&&e.top<=t.bottom}function _d(e){let t=[];for(const r of e.children)t=t.concat(r,_d(r));return t}function Up(e,t=!0){const r=e.getBoundingClientRect(),n={x:{start:[],center:[],end:[]},y:{start:[],center:[],end:[]}},o=_d(e);for(const i of["x","y"]){const a=i==="x"?"y":"x",s=i==="x"?"left":"top",l=i==="x"?"width":"height",c=i==="x"?"scrollLeft":"scrollTop";for(const f of o){const h=f.getBoundingClientRect();if(t&&!Wp(r,h,a))continue;const m=window.getComputedStyle(f);let[g,w]=m.getPropertyValue("scroll-snap-align").split(" ");typeof w>"u"&&(w=g);const $=i==="x"?w:g,k=h[s]-r[s]+e[c];switch($){case"none":break;case"start":n[i].start.push(k);break;case"center":n[i].center.push(k+h[l]/2);break;case"end":n[i].end.push(k+h[l]);break}}}return n}function Ja(e){const t=e.getBoundingClientRect(),r=zp(e),n=Up(e),o={x:e.scrollWidth-e.offsetWidth,y:e.scrollHeight-e.offsetHeight},i=(a,s)=>l=>Math.max(a,Math.min(s,l));return{x:Pl([...n.x.start.map(a=>a-r.x.before),...n.x.center.map(a=>a-t.width/2),...n.x.end.map(a=>a-t.width+r.x.after)].map(i(0,o.x))),y:Pl([...n.y.start.map(a=>a-r.y.before),...n.y.center.map(a=>a-t.height/2),...n.y.end.map(a=>a-t.height+r.y.after)].map(i(0,o.y)))}}function Pl(e){return Array.from(new Set(e))}const Kn="templates-container",Gp=4e3;var aa=(e=>(e.Default="default",e.Banner="banner",e))(aa||{});const Ae=te()({tagName:"toniq-carousel",hostClasses:{"toniq-carousel-banner-variant":({inputs:e})=>e.variant==="banner"},stateInitStatic:{currentScrollPosition:{left:0,right:1/0},scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({hostClasses:e})=>p`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
    ...
    `,renderCallback:({inputs:e})=>u`
            <${T.assign({icon:Ya,fitContainer:e.size!=="small"})}></${T}>
        `});async function Cw(e){return navigator.clipboard.writeText(e)}const Mw="…";function Aw(e,t){const r=e.slice(0,t).trim(),n=e.slice(-1*t).trim();return`${r}${Mw}${n}`}function Ew(e){return!(e%1)}function Iw(e){return e.letterCount==null?4:Ew(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const we=te()({tagName:"toniq-middle-ellipsis",events:{copy:ee()},cssVars:{"toniq-middle-ellipsis-text-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":b.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":b.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>p`
        :host {
            /* 5 frames at 60 fps */
            transition: ${X.interaction};
            ${R.paragraphFont};
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:r,state:n,updateState:o}){if(!e.text)return u``;const i=e.text,a=Iw(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,f=c?Aw(i,a):i,h=c?i:"",m=s?vd:l?wd:void 0,g=m?u`
                  <${T.assign({icon:m})}></${T}>
              `:"",w=u`
        ...
        `;return f?s?u`
                ...
                `:l?u`
                    <button
                        ...
                        ${S("click",async()=>{await Cw(i),t(new r.copy),n.showCopiedTextTimeoutId!=null&&window.clearTimeout(n.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${w} ${g}
                    </button>
                `:u`
                    ${w}
                `:u``}}),bc="...";function Lw(e,t,r=7,n=5){let o;e=dr({value:e,min:1,max:t}),r=dr({value:r,min:n,max:t});const i=r-5,a=r-3;t<=r?o=r:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>r?Ii(t-o,t):e>o?Ii(Math.min(s.start,t-o),Math.min(s.end,t)):Ii(1,Math.min(t,o+1));function c(h,m){return l.length+1!==t?m:[h]}const f=l[l.length-1];if(f&&f<t){const h=c(t,[bc,t]);return[...l,...h]}else return l[0]!==1?c(1,[1,bc]).concat(l):l}function Ii(e,t){const r=t-e+1;return Array.from({length:r},(n,o)=>e+o)}te()({tagName:"toniq-pagination",styles:p`
        :host {
            display: flex;
        }
    ...
    `,events:{pageChange:ee()},renderCallback({inputs:e,events:t,dispatch:r}){return e.pageCount<=1?u``:u`
                ...
                ${Lw(e.currentPage,e.pageCount,e.pagesShown).map(n=>typeof n=="string"?u`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:Vc()})},renderCallback({inputs:e,dispatch:t,events:r,state:n}){return qw(e.entries).map(i=>Pw(e.groupName||n.randomGroupName,e.value,i,()=>{t(new r.valueChange(i.value))}))}});function qw(e){const t=Object.fromEntries(e.map(n=>[n.value,n]));return Object.values(t).length!==e.length&&console.error(`${Y.tagName} was given duplicate entry values.`),Object.values(t)}function Pw(e,t,r,n){const o=t===r.value,i=u`
    ...
    `}function Li(e,t){const r=e[0],n=e[e.length-1];if(r==null||n==null)return 0;if(t<r)return r;if(t>n)return n;const o=e.findIndex((c,f)=>{const h=e[f+1];return h==null?!0:c<=t&&h>=t});if(o<0)return r;const i=e[o];if(i==null)return r;const a=e[o+1];if(a==null)return i;const s=t-i,l=a-t;return s<l?o:o+1}function Nw(e,t,r=100){e>t&&([e,t]=[t,e]),r<2&&(r=2);let n=Ow(e);const o=[e];for(;n<t;){const i=Math.pow(10,String(n).length-1),a=n+i;a<t&&o.push(a),n=a}return o.push(t),o.length>r&&(yc(o,r),o.length>r&&yc(o,r)),o}function yc(e,t){const r=e.length-t,n=(e.length-2)/r;for(let o=e.length-2;o>=1;o-=n)e.splice(Math.floor(o),1)}function Ow(e){let t=1;if(!e)return e;e<0&&(t=-1,e=e*-1);const r=e.toFixed(0),n=Math.pow(10,r.length-1),o=Number(r[0]||1);return n*o*t}const P={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},Or={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"};function Bw(e){var n,o;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${P.lowerLabelWrapper} .${P.labelPercentMarginWrapper}`),r=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${P.upperLabelWrapper} .${P.labelPercentMarginWrapper}`);if(r instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),a=r.getBoundingClientRect();return{lower:i,upper:a}}else return}function Dw(e,t=8){const r=Bw(e);if(!r)return 0;const n=r.lower.right-r.upper.left+t;return Math.max(0,n)}function qi({value:e,limits:t,flip:r}){const o=(t.max-e)/(t.max-t.min)*100;return-(r?100-o:o)}function un(e){return je(e)&&e.min!==void 0&&e.max!==void 0}function ba(e){var r;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${P.range}`);return(t==null?void 0:t.clientWidth)??0}function Pi(e,t,r){return`${r?Hh(e):e} ${t}`}function Rw({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function _w({value:e,double:t,min:r,max:n}){return t?un(e)?{min:dr({value:e.min,min:r,max:Math.min(e.max,n)}),max:dr({value:e.max,min:Math.max(e.min,r),max:n})}:{min:r,max:n}:un(e)?r:dr({value:e,min:r,max:n})}function Hw({actualValue:e,actualLimits:t,logScale:r,logRange:n}){return r?{elementValue:un(e)?{min:Li(n,e.min),max:Li(n,e.max)}:Li(n,e),elementLimits:{min:0,max:n.length-1}}:{elementValue:e,elementLimits:t}}function Ni(e,t,r){return r?t[e]||0:e}function Fw(e){return{actualLimits:Rw(e),actualValue:_w(e)}}function Vw(e,t){var n,o,i;let r=!1;if(un(e)){const a=(n=t.shadowRoot)==null?void 0:n.querySelector(`.${P.lowerSlider}`),s=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${P.upperSlider}`);a instanceof HTMLInputElement&&s instanceof HTMLInputElement&&(Number(a.value)!==e.min&&(a.value=String(e.min),r=!0),Number(s.value)!==e.max&&(s.value=String(e.max),r=!0))}else{const a=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${P.slider}`);a instanceof HTMLInputElement&&Number(a.value)!==e&&(a.value=String(e),r=!0)}return r}function z0(e,t){const{actualValue:r,actualLimits:n}=Fw({...e}),o=Nw(n.min,n.max),i=e.logScale??!1,a=e.suffix??"",{elementValue:s,elementLimits:l}=Hw({actualValue:r,actualLimits:n,logScale:i,logRange:o}),c=ba(t);return{actualValue:r,elementLimits:l,elementValue:s,isLogScale:i,logRange:o,rangeWidth:c,suffix:a}}const _t=16,kc=p`
    ${_t}px
`,$c=p`
...
`,xc=p`
    transform: scale(1.2);
`;function Vr(e){requestAnimationFrame(()=>{const t=z0(e.instanceInputs,e).elementValue;Vw(t,e)&&(e.setAttribute("disabled","true"),Vr(e))})}const F=te()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ee()},styles:p`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Vr(e)}),e.addEventListener("keydown",()=>{Vr(e)}),e.addEventListener("keyup",()=>{Vr(e)})},renderCallback({inputs:e,host:t,events:r,dispatch:n,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:f,elementLimits:h,rangeWidth:m}=z0({...e},t);if(Vr(t),un(f))return g(a,f,h);return $(a,f,h);function g(k,x,C){const D={left:Ht((m-_t)*(x.min-C.min)/(C.max-C.min)+_t/2),right:Ht((m-_t)*(C.max-x.max)/(C.max-C.min)+_t/2)},U=Pi(k.min,c,l),se=Pi(k.max,c,l);requestAnimationFrame(()=>{const $e=Dw(t);$e!==o.labelOverlap&&i({labelOverlap:$e})});const fe=(C.max-x.max)/(C.max-C.min)>.5,de=qi({value:x.min,limits:{min:C.min,max:x.max},flip:!0}),W=qi({value:x.max,limits:{min:x.min,max:C.max},flip:!1}),le=o.labelOverlap&&fe?o.labelOverlap:0,We=o.labelOverlap&&!fe?o.labelOverlap:0;return u`
                <div
                    class="range"
            ...
            `}function w(k){i({internalValue:k}),e.disabled||n(new r.valueChange(k))}function $(k,x,C){const D=Ht((m-_t)*(C.max-x)/(C.max-C.min)+_t/2),U=Pi(k,c,l),se=qi({value:x,limits:C,flip:!1});return u`
                <div
                    class="range"
                    ${tn(()=>{i({rangeWidth:ba(t)})})}
                >
    ...
    `,renderCallback({inputs:e}){return u`
            <${T.assign({icon:e.icon})}></${T}>
        `}}),Wo=Object.values(yt).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),jw=Object.keys(Wo).sort();function as(e){return{controlType:O.Dropdown,initValue:e,options:["None",...jw]}}const G0={"CSS color":{controlType:O.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:O.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:O.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:O.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:O.Number,initValue:2}};function ro(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),J(n,"number")&&(n=ka({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
`)}const Zw=_({title:"Social Urls",parent:U0,elementExamplesCallback({defineExample:e}){function t({socialName:r,icon:n}){e({title:r,renderCallback(){return u`
                        <${Mo.assign({icon:n})}></${Mo}>
                    `}})}Object.entries(Dd).forEach(([r,n])=>{t({socialName:r,icon:n})})}}),re=_({title:"Elements",parent:void 0}),zw=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:p`
            ${zt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],Ww=_({title:zt.tagName,parent:re,elementExamplesCallback({defineExample:e}){zw.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:p`
                    .bold {
                        ${R.boldFont}
                    }
                ...
                `,renderCallback({state:r,updateState:n}){return u`
                        ...
                        ></${zt}>
                        More text
                    `}})})}}),Uw=_({parent:re,title:he.tagName,elementExamplesCallback({defineExample:e}){[{name:"default",inputs:{}},{name:"Secondary",inputs:{variant:$o.Secondary}},{name:"Outline",inputs:{variant:$o.Outline}},{name:"Disabled",inputs:{disabled:!0}}].forEach(r=>{e({title:r.name,stateInitStatic:{showIcon:!1,timeoutId:void 0},styles:p`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
...
`,Gw=_({parent:re,title:Ae.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:Tc,renderCallback(){return u`
                ...
                `;return u`
                    ...
                    ></${Ae}>
                `}})}});function Yw(e){const t=Object.keys(e.cssVars).map(r=>[`--${r}`,{controlType:O.Color,initValue:""}]);return Object.fromEntries(t)}function Jw(e){const t=Object.entries(e).map(([r,n])=>{if(r.startsWith("--"))return typeof n!="string"||!n?void 0:`${r}: ${n};`}).filter(be);return N(t.join(`
`))}const Kw=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],Bi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],Xw=_({parent:re,title:gt.tagName,controls:{Text:{controlType:O.Text,initValue:"Text"},...Yw(gt)},elementExamplesCallback({defineExample:e}){Kw.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:Bi.map(r=>!!r.inputs.checked),extraEntryStatuses:Bi.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:p`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Bi.map((i,a)=>{const s=(i.extraEntries??[]).map((c,f)=>{var h;return u`
                        ...
                        `})}})})}}),Qw=_({parent:re,title:wi.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Ct}},{inputs:{icon:Ct}},{inputs:{},template:u`
                    HTML child
        ...
        `},{customStyle:p`
            max-height: 30px;
            min-height: 30px;
        `}],r5=_({title:Hn.tagName,parent:re,controls:{Selected:{controlType:O.Dropdown,initValue:Vn[0].label,options:Vn.map(e=>e.label)},Direction:{controlType:O.Dropdown,initValue:"Down",options:Dc(pa)},Icon:as(fd.name),Prefix:{controlType:O.Text,initValue:"Sort by: "},"Force open":{controlType:O.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){t5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Sc.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:p`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Sc.map((i,a)=>{const s=p`
                        ...
                        `;return u`
                            ...
                            ></${Hn}>
                        `})}})})}}),n5=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],o5=_({title:Ai.tagName,parent:re,elementExamplesCallback({defineExample:e}){n5.forEach(t=>{e({title:t.title,renderCallback(){return u`
                        <${Ai}>${t.content}</${Ai}>
                    `}})})}}),Cc="/toniq-labs-design-system";function Y0(...e){const r=[globalThis.location.pathname.startsWith(Cc)?Cc:"",...e].filter(be);return Oh(...r)}const ir=Array(30).fill(Y0("/toniq-labs-logo.png")),ur=["Hello there.","There is stuff here."],jn=ur.concat(Array(30).fill(ur)),i5=_({title:K.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${K.assign({infoParagraphs:jn,imageUrls:ir,socialUrls:jp,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${K}>
                    ...
                    <${K.assign({imageUrls:ir.map((t,r)=>r%2?"/invalid-image.png":t),infoParagraphs:ur,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return u`
                                <${$t.assign({imageUrl:t,_debugLoadDelay:t.includes("invalid-image")?void 0:{milliseconds:1/0}})}>
                                    <div
                                        ...
                                        `}
                                    >
                                        <${T.assign({icon:Ya,fitContainer:!0})}
                                            style=${p`
                                                width: 100%;
                                                height: 100%;
                                            `}
                            ...
                            `}})}></${K}>
                `}})}}),a5=_({title:Zt.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:p`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:r}){return u`
                ...
                `}})}}),s5=_({title:Me.tagName,parent:re,elementExamplesCallback({defineExample:e}){Rc(lr).forEach(t=>{e({title:t,renderCallback(){return u`
            ...
            `,renderCallback({controls:r}){return u`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            ...
                            ></${Fn}>
                        `))}})})}}),d5=_({title:Ei.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:eo.Small}},{title:"large",inputs:{size:eo.Large}},{title:"whole page",inputs:{size:eo.WholePage},styles:p`
                    :host {
                        width: 500px;
                    }
                `}].forEach(r=>{e({title:r.title,styles:r.styles??p``,renderCallback(){return u`
                        <${Ei.assign(r.inputs)}></${Ei}>
                    `}})})}}),h5=_({title:we.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
            ...
            `,renderCallback(){return u`
                ...
                `}})}}),f5=_({title:Nr.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:p`
                ${Nr} {
                    height: 32px;
                }
...
`,Di={min:10,max:50},p5=_({title:F.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:p`
                ${st}
            `,renderCallback({state:t,updateState:r}){return u`
            ...
            `,renderCallback({state:t,updateState:r}){return u`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Mc.map((i,a)=>u`
                            ...
                            ></${Oi}>
                        `)}})})}}),v5=_({parent:re,title:to.tagName,elementExamplesCallback({defineExample:e}){function t({title:r,tooltipContent:n,forceShow:o}){e({title:r,styles:p`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),b5=_({parent:re,title:Yr.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${to.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return u`
                    <${Yr}>This is a tooltip.</${Yr}>
                `}})}}),y5=[v5,b5],k5=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:p`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:p``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:p``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:oa},{label:"label here",value:2,icon:oa},{label:"",value:3,icon:Ct,disabled:!0},{label:"16px icon",value:4,icon:Ct},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],$5=_({title:jr.tagName,parent:re,elementExamplesCallback({defineExample:e}){k5.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:p`
                ...
                `,renderCallback({state:r,updateState:n}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return u`
                        ...
                        ></${jr}>
                    `}})})}}),J0=_({title:"Icons",parent:void 0,controls:G0}),x5=Object.entries(yt).map(([e,t])=>_({title:e,parent:J0,elementExamplesCallback({defineExample:r}){t.map(n=>r({title:n.name,renderCallback({controls:o}){return u`
                                <${Mo.assign({icon:n})}
                                    style=${ro(o)}
                                ></${Mo}>
                            `}}))}}));function K0(e){const t=T5(e),r=ge(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return oe(r).reduce((o,i)=>{const a=r[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function T5(e){typeof e!="string"&&(e=String(e));const n=`{"${Lc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const Uo=_({title:"Styles",parent:void 0}),S5=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function C5(e,t,r){const n=K0(j(r));return e({title:t,styles:S5,renderCallback(){return u`
            ...
            `}})}const M5=_({title:"Colors",parent:Uo,elementExamplesCallback({defineExample:e}){oe(b).map(t=>C5(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),A5=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function E5(e,t,r){const n=K0(r);return e({title:t,styles:A5,renderCallback(){return u`
            ...
            `}})}const I5=_({title:"Fonts",parent:Uo,elementExamplesCallback({defineExample:e}){oe(R).map(t=>{const r=R[t];return E5(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),L5=_({title:"Shadows",parent:Uo,elementExamplesCallback({defineExample:e}){ah(ln).forEach(([t,r])=>{e({title:t,styles:p`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return u`
                            <div></div>
                        `}})})}}),q5=[re,J0,Uo,U0],P5=[...x5,...y5,Zw,Ww,Uw,Gw,Xw,Qw,M5,e5,r5,o5,i5,a5,I5,s5,l5,c5,u5,d5,h5,f5,m5,L5,p5,w5,$5].sort((e,t)=>e.title.localeCompare(t.title)),N5=[...q5,...P5];Oo({tagName:"toniq-design-system-app",styles:p`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return u`
            <${mi.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:N5,themeColor:"#00D093"})}>
