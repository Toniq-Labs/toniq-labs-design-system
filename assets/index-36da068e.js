 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wn={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Pt=e=>(...t)=>({_$litDirective$:e,values:t});class pt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,n){this._$Ct=t,this._$AM=r,this._$Ci=n}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const kf={attribute:!0,type:String,converter:uo,reflect:!1,hasChanged:Pa},$f=(e=kf,t,r)=>{const{kind:n,metadata:o}=r;let i=globalThis.litPropertyMetadata.get(o);if(i===void 0&&globalThis.litPropertyMetadata.set(o,i=new Map),i.set(r.name,e),n==="accessor"){const{name:a}=r;return{set(s){const l=t.get.call(this);t.set.call(this,s),this.requestUpdate(a,l,e)},init(s){return s!==void 0&&this.P(a,void 0,e),s}}}if(n==="setter"){const{name:a}=r;return function(s){const l=this[a];t.call(this,s),this.requestUpdate(a,l,e)}}throw Error("Unsupported decorator location: "+n)};function xf(e){return(t,r)=>typeof r=="object"?$f(e,t,r):((n,o,i)=>{const a=o.hasOwnProperty(i);return o.constructor.createProperty(i,a?{...n,wrapped:!0}:n),a?Object.getOwnPropertyDescriptor(o,i):void 0})(e,t,r)}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const de=Pt(class extends pt{constructor(e){var t;if(super(e),e.type!==wn.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var n,o;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!((n=this.nt)!=null&&n.has(i))&&this.st.add(i);return this.render(t)}const r=e.element.classList;for(const i of this.st)i in t||(r.remove(i),this.st.delete(i));for(const i in t){const a=!!t[i];a===this.st.has(i)||(o=this.nt)!=null&&o.has(i)||(a?(r.add(i),this.st.add(i)):(r.remove(i),this.st.delete(i)))}return Pe}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Os=e=>e??Q;/**
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Yi extends pt{constructor(t){if(super(t),this.it=Q,t.type!==wn.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===Q||t==null)return this._t=void 0,this.it=t;if(t===Pe)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const r=[t];return r.raw=r,this._t={_$litType$:this.constructor.resultType,strings:r,values:[]}}}Yi.directiveName="unsafeHTML",Yi.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,gd=v({name:"LoaderAnimated24Icon",svgTemplate:u`
    ...
    `,renderCallback:({inputs:e,dispatch:t})=>{var n,o;const r=((o=e.router)==null?void 0:o.createRoutesUrl({...(n=e.router)==null?void 0:n.getCurrentRawRoutes(),...e.route}))??"#";return u`
            <a
                href=${r}
                ${T("click",i=>{(!e.router||Ho(i))&&(i.preventDefault(),window.scrollTo(0,0),t(new xo(e.route)))})}
            >
                <slot></slot>
            </a>
    ...
    `,renderCallback({inputs:e}){return(K(e.message,"array")?e.message:[e.message]).map(r=>u`
                <p>${r}</p>
            `)}}),hn=Ze()({tagName:"book-page-controls",events:{controlValueChange:ee()},hostClasses:{"book-page-controls-has-controls":({inputs:e})=>!!Object.keys(e.config).length},styles:({hostClasses:e})=>m`
        :host {
            display: flex;
            flex-wrap: wrap;
    ...
    `,renderCallback({inputs:e,dispatch:t}){return u`
            ...
            <input
                ...
                ${T("input",async r=>{const n=r.currentTarget;if(!(n instanceof HTMLInputElement))throw new Error("Failed to find input element for search.");const o=n.value;await Ui(200),n.value===o&&(n.value?t(new xo({paths:[Se.Search,encodeURIComponent(n.value)]})):t(new xo(yr)))})}
            />
                ...
                <div class="title-group">
                    ...
                    ${n?u`
                          ...
                          `:u`
                              ...
                              <${hn.assign({config:e.pageNode.entry.controls,currentValues:Wa(e.controls,e.pageNode.fullUrlBreadcrumbs),fullUrlBreadcrumbs:e.pageNode.fullUrlBreadcrumbs})}></${hn}>
                          `}
                </div>
            </div>
        `}}),Rn=Ze()({tagName:"book-element-example-controls",styles:m`
        :host {
            display: flex;
            color: ${V["element-book-page-foreground-faint-level-1-color"].value};
    ...
    `,renderCallback({inputs:e}){return u`
            <div class="individual-example-wrapper">
                <${Rn.assign(tn(e,["currentPageControls"]))}></${Rn}>
                <${Pl.assign(e)}></${Pl}>
            </div>
        `}});function yd(e,t,r,n){const o=Xi(r,n),i=[];if(o){const a=yd(e,t,o,n);a&&i.push(a)}if(fr(r,we.Page)&&!e.includes(r)){const a=Wa(t,r.fullUrlBreadcrumbs);i.push({config:r.entry.controls,current:a,breadcrumbs:ve(a,()=>r.fullUrlBreadcrumbs)})}return i.reduce((a,s)=>({config:{...a.config,...s.config},current:{...a.current,...s.current},breadcrumbs:{...a.breadcrumbs,...s.breadcrumbs}}),{config:{},current:{},breadcrumbs:{}})}function Mp({currentNodes:e,isTopLevel:t,router:r,isSearching:n,controls:o,originalTree:i}){if(!e.length&&n)return[u`
            ...
            `];const a=Wi(e,1)?yd(e,o,e[0],i):void 0,s=a&&Object.values(a.config).length&&Wi(e,1)?u`
                  <${hn.assign({config:a.config,currentValues:a.current,fullUrlBreadcrumbs:a.breadcrumbs})}></${hn}>
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{Bl(e,Qi(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:r,updateState:n,dispatch:o,events:i})=>{var f,h,p,g,w,$,k;t._debug&&console.info("rendering element-book app");function a(S){return{...e.currentRoute,...S}}function s(S){const C=a(S);return!nt(e.currentRoute,C)}function l(S){t.preventWindowTitleChange||(e.originalWindowTitle||n({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,S].filter(ye).join(" - "))}function c(S){if(!s(S))return;const C=a(S);e.router?e.router.setRoutes(C):n({currentRoute:{...e.currentRoute,...C}}),t.elementBookRoutePaths&&!nt(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(C.paths??[]))}try{if(t.elementBookRoutePaths&&!nt(t.elementBookRoutePaths,e.currentRoute.paths)&&c({paths:t.elementBookRoutePaths}),(f=t.internalRouterConfig)!=null&&f.useInternalRouter&&!e.router){const W=N1(t.internalRouterConfig.basePath);n({router:W}),W.addRouteListener(!0,le=>{n({currentRoute:le})})}else!((h=t.internalRouterConfig)!=null&&h.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const S={themeColor:t.themeColor};if(!nt(S,(p=e.colors)==null?void 0:p.config)){const W=Ml(S);n({colors:{config:S,theme:W}}),D1(r,W)}const C=t._debug??!1,_=w1({entries:t.entries,debug:C});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),n({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:qu(_.tree,{children:(w=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:w.children,controls:t.globalValues})}}));const U=Qi(e.currentRoute.paths),ge=(U?T1({flattenedNodes:_.flattenedNodes,searchQuery:U}):void 0)??Ap(_.flattenedNodes,e.currentRoute.paths,c);l(($=ge[0])==null?void 0:$.entry.title);const fe=(k=e.treeBasedControls)==null?void 0:k.controls;return fe?(t._debug&&console.info({currentControls:fe}),u`
                <div
                    class="root"
                    ${T(xo,async W=>{const le=W.detail;if(!s(le))return;if(n({loading:!0}),c(le),!(r.shadowRoot.querySelector(ut.tagName)instanceof ut))throw new Error(`Failed to find child '${ut.tagName}'`);Bl(r,U,e.currentRoute)})}
                    ${T(hn.events.controlValueChange,W=>{if(!e.treeBasedControls)return;const le=b1(fe,W.detail.fullUrlBreadcrumbs,W.detail.newValues);n({treeBasedControls:{...e.treeBasedControls,controls:le}})})}
                >
...
`))}const B=(()=>{const e=m`
    ...
    `}),to=v({name:"Trash24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
...
`,Vm=v({name:"CryptoIcp16Icon",svgTemplate:u`
    ...
    `}),yt={"core-16":[xd,qp,Pp,Ct],"core-24":[Np,Op,es,Bp,Dp,ts,Td,Rp,_p,Hp,Fp,Vp,jp,zp,Zp,Sd,Cd,Wp,Up,Md,Gp,Yp,Jp,Kp,Ad,Xp,Qp,em,tm,rm,Ed,nm,om,im,am,sm,lm,da,cm,um,dm,hm,fm,pm,mm,rs,gm,wm,vm,bm,ym,km,$m,xm,Id,Ld,Tm,Sm,Cm,Mm,Am,Em,to,Im,Lm,qd,qm,Pm],"core-48":[Nm,Pd,Om,Bm],"core-64":[Nd,Dm,Rm],cryptocurrencies:[_m,Od,Hm,Fm,Vm,jm],"third-party-brands":[Rd,_d,Hd,zm,Zm,Wm,Fd,Um,Vd,Gm,jd,zd,Ym,Zd,Wd],toniq:[Jm,Km]},Xm=yn({discord:tt(void 0,""),distrikt:tt(void 0,""),dscvr:tt(void 0,""),instagram:tt(void 0,""),medium:tt(void 0,""),telegram:tt(void 0,""),tikTok:tt(void 0,""),twitch:tt(void 0,""),twitter:tt(void 0,""),website:tt(void 0,"")}),Qm=Xm.defaultValue,Ud={discord:Rd,instagram:Fd,telegram:jd,tikTok:zd,distrikt:_d,twitch:Zd,dscvr:Hd,medium:Vd,twitter:Wd,website:qd},_l="toniq-",{defineElement:te,defineElementNoInputs:ns}=za({assertInputs:e=>{if(!e.tagName.startsWith(_l))throw new Error(`Tag name should start with '${_l}' but got '${e.tagName}'`)}}),Wt=te()({tagName:"toniq-bold-space",styles:m`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,renderCallback({inputs:e}){return u`
            <${ae.assign(e)}></${ae}>
        `}}),ha=m`8px`;var Co=(e=>(e.Default="default",e.Outline="outline",e.Secondary="secondary",e))(Co||{});const pe=te()({tagName:"toniq-button",hostClasses:{"toniq-button-secondary":({inputs:e})=>e.variant==="secondary","toniq-button-outline":({inputs:e})=>e.variant==="outline","toniq-button-disabled":({inputs:e})=>!!e.disabled},styles:({hostClasses:e})=>m`
        :host {
            ${B.boldParagraphFont};
            display: inline-flex;
            position: relative;
    ...
    `,events:{viewMoreButtonClick:ee(),flipCardButtonClick:ee()},renderCallback({inputs:e,dispatch:t,events:r}){const n=e.socialUrls,o=n?oe(n).map(i=>{const a=n[i];if(!a)return;const s=Ud[i];return u`
            ...
            <div class="buttons">
                ...
                >
                    <${pe.assign({text:e.viewMoreButtonText,variant:Co.Outline})}></${pe}>
                </${Je}>
    ...
    `,renderCallback({inputs:e,state:t,updateState:r,host:n,dispatch:o,events:i}){var p,g,w,$;const a=e.mainImageSize||xa,s=X0(a);fo({onElement:n,forCssVar:rt["main-image-size"],toValue:`${a}px`}),fo({onElement:n,forCssVar:rt["secondary-image-size"],toValue:`${s}px`});const l=["View",e.viewButtonTitle].filter(ye).join(" "),c=u`
            <h3>${e.cardTitle}</h3>
    ...
    `,renderCallback({inputs:e}){return e.level==="h1"?u`
        ...
        `}});var Kr=(e=>(e.Small="small",e.Large="large",e.WholePage="whole-page",e))(Kr||{});const Xr=te()({tagName:"toniq-loading",hostClasses:{"toniq-loading-large":({inputs:e})=>e.size==="large","toniq-loading-whole-page":({inputs:e})=>e.size==="whole-page"},styles:({hostClasses:e})=>m`
        :host {
            display: inline-flex;
        }
    ...
    `,renderCallback({inputs:e,cssVars:t,host:r}){const n=hr({value:e.percent,max:100,min:0}),o=`${n}%`;return fo({forCssVar:t["toniq-progress-width"],onElement:r,toValue:o}),r.setAttribute("title",`${o} finished`),n?u`
...
`;function zr(e){requestAnimationFrame(()=>{const t=eh(e.instanceInputs,e).elementValue;X4(t,e)&&(e.setAttribute("disabled","true"),zr(e))})}const F=te()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ee()},styles:m`
    ...
    `,renderCallback({inputs:e}){const t=e.icon?u`
        ...
        `}}),Qr=ns({tagName:"toniq-tooltip",styles:m`
        :host {
            display: block;
            padding: 4px 8px;
            border-radius: 8px;
    ...
    `,renderCallback(){return u`
            <slot></slot>
        `}}),io=te()({tagName:"toniq-with-tooltip",hostClasses:{"toniq-with-tooltip-force-tooltip":({inputs:e,state:t})=>!!e.forceShow||t.clickToggled},styles:({hostClasses:e})=>m`
        :host {
            display: inline-block;
            position: relative;
        }
    ...
    `,renderCallback({inputs:e}){return u`
            <${x.assign({icon:e.icon})}></${x}>
        `}}),Jo=Object.values(yt).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),Q4=Object.keys(Jo).sort();function ps(e){return{controlType:O.Dropdown,initValue:e,options:["None",...Q4]}}const nh={"CSS color":{controlType:O.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:O.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:O.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:O.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:O.Number,initValue:2}};function ao(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),K(n,"number")&&(n=Aa({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
`)}const e5=R({title:"Social Urls",parent:rh,elementExamplesCallback({defineExample:e}){function t({socialName:r,icon:n}){e({title:r,renderCallback(){return u`
        ...
        `}],r5=R({title:Wt.tagName,parent:re,elementExamplesCallback({defineExample:e}){t5.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:m`
                ...
                `,renderCallback({state:r,updateState:n}){return u`
                        ...
                        ></${Wt}>
                        More text
                    `}})})}}),n5=R({parent:re,title:pe.tagName,elementExamplesCallback({defineExample:e}){[{name:"default",inputs:{}},{name:"Secondary",inputs:{variant:Co.Secondary}},{name:"Outline",inputs:{variant:Co.Outline}},{name:"Disabled",inputs:{disabled:!0}}].forEach(r=>{e({title:r.name,stateInitStatic:{showIcon:!1,timeoutId:void 0},styles:m`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:n,updateState:o}){return n.timeoutId||o({timeoutId:window.setTimeout(()=>{o({showIcon:!n.showIcon,timeoutId:void 0})},1e3)}),u`
                        ...
                        <${pe.assign({icon:to,...r.inputs})}></${pe}>
                        <${pe.assign(n.showIcon?{icon:to,text:"icon",...r.inputs}:{text:"no icon",...r.inputs})}
                            class="icon-toggle"
                        ></${pe}>
                        <${pe.assign({text:"Button",icon:to,...r.inputs})}></${pe}>
                        <${pe.assign({...r.inputs})}>
...
`))}const s5=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],Vi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],l5=R({parent:re,title:gt.tagName,controls:{Text:{controlType:O.Text,initValue:"Text"},...i5(gt)},elementExamplesCallback({defineExample:e}){s5.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:Vi.map(r=>!!r.inputs.checked),extraEntryStatuses:Vi.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:m`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Vi.map((i,a)=>{const s=(i.extraEntries??[]).map((c,f)=>{var h;return u`
                                    <${gt.assign({...t.inputs,...tn(i.inputs,["checked"]),checked:!!((h=r.extraEntryStatuses[a])!=null&&h[f]),text:c})}
                                        ${T(gt.events.checkedChange,()=>{const p=[...r.extraEntryStatuses];p[a][f]=!p[a][f],n({extraEntryStatuses:p})})}
                                    ></${gt}>
                                `}),l=a5(o);return u`
                            <div class="checkbox-group" style=${l}>
                                <${gt.assign({...t.inputs,...tn(i.inputs,["checked"]),checked:r.checkedStatuses[a],text:o.Text})}
                ...
                `,inputs:{text:"custom size"}}];[{title:"default",inputs:{variant:ma.Default}},{title:"secondary style",inputs:{variant:ma.Secondary}}].forEach(n=>{e({title:n.title,renderCallback(){return t.map(o=>u`
                    ...
                    `}})})}}),Un=[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3},{label:"Really really super duper long option",value:4}],d5=[{title:"default"},{title:"transparent background",customStyle:m`
        ...
        `}],h5=R({title:Zn.tagName,parent:re,controls:{Selected:{controlType:O.Dropdown,initValue:Un[0].label,options:Un.map(e=>e.label)},Direction:{controlType:O.Dropdown,initValue:"Down",options:Zc($a)},Icon:ps(Td.name),Prefix:{controlType:O.Text,initValue:"Sort by: "},"Force open":{controlType:O.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){d5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:qc.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:m`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return qc.map((i,a)=>{const s=m`
                            ...
                            ${i.customStyle??m``};
                        `;return u`
                            <${Zn.assign({...t.inputs,...i.inputs,options:Un,value:r.selected[a]??Un.find(l=>l.label===o.Selected),icon:Jo[o.Icon],selectedLabelPrefix:o.Prefix,direction:$a[o.Direction],_forceOpenState:o["Force open"]||void 0})}
                                style=${s}
                                ${T(Zn.events.selectChange,l=>{const c=[...r.selected];c[a]=l.detail,n({selected:c})})}
                            ></${Zn}>
                        ...
                        <${qi}>${t.content}</${qi}>
                    `}})})}}),Pc="/toniq-labs-design-system";function oh(...e){const r=[globalThis.location.pathname.startsWith(Pc)?Pc:"",...e].filter(ye);return rn(...r)}const ar=Array(30).fill(oh("/toniq-labs-logo.png")),dr=["Hello there.","There is stuff here."],Gn=dr.concat(Array(30).fill(dr)),m5=R({title:X.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${X.assign({infoParagraphs:Gn,imageUrls:ar,socialUrls:Qm,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${X}>
                ...
                `}}),e({title:"hyperlink view button",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${X.assign({imageUrls:[],cardTitle:"Featured Stuff",infoParagraphs:Gn,viewMoreUrl:"https://toniqlabs.com"})}
                ...
                `}}),e({title:"min height",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${X.assign({imageUrls:[],cardTitle:"Featured Stuff",infoParagraphs:Gn})}></${X}>
            ...
            `,renderCallback({controls:r}){return u`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            <${Wn.assign({...n.inputs,value:o["External value"]||i.value,icon:Jo[o.Icon],placeholder:o.Placeholder,suffix:o.Suffix,disableBrowserHelps:o["No browser helps"],allowedInputs:o["Exclusive characters"],blockedInputs:o["Blocked characters"]})}
                                style=${s.customStyles}
                                ${T(Wn.events.valueChange,l=>{a({value:l.detail})})}
                            ></${Wn}>
                        `))}})})}});function k5({entries:e,columns:t,createRowObject:r}){const n=Object.fromEntries(t.map(i=>[i.key,""]));return{rows:e.map((i,a)=>{const s=r(i,a);if(!nt(Object.keys(n).sort(),Object.keys(s.cells).sort()))throw console.error("broken list table row",{cells:s.cells,columns:n}),new Error("List table row keys does not match expect column keys.");return s}),columns:t}}const ih="https://cdn-bitcoin.bioniq.io",$5=rn(ih,"content"),x5=rn(ih,"thumbnail"),T5={thumbnail(e){return rn(x5,e)},content(e){return rn($5,e)}},S5=Array(5).fill({imageUrl:T5.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:u`
        <div
            style=${m`
                display: flex;
                gap: 8px;
    ...
    `}),ji=k5({entries:S5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE",mobile:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:u`
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Nc=ns({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const r=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(r)}})}},cleanupCallback({state:e,updateState:t}){var r;(r=e.cleanup)==null||r.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),M5=R({title:_t.tagName,parent:re,elementExamplesCallback({defineExample:e}){C5.forEach(t=>{var r,n;e({title:t.title,styles:m`
            ...
            `,stateInitStatic:{tableInputs:{...ji,rows:ji.rows.map(t=>({...t,cells:{...t.cells,date:u`
                ...
                `}})}}),A5=R({title:Xr.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:Kr.Small}},{title:"large",inputs:{size:Kr.Large}},{title:"whole page",inputs:{size:Kr.WholePage},styles:m`
                    :host {
                        width: 500px;
                    }
                `}].forEach(r=>{e({title:r.title,styles:r.styles??m``,renderCallback(){return u`
                        <${Xr.assign(r.inputs)}></${Xr}>
...
`,zi={min:10,max:50},q5=R({title:F.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:m`
            ...
            `,renderCallback({state:t,updateState:r}){return u`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Oc.map((i,a)=>u`
                            <${Fi.assign({...t.inputs,toggled:r.buttonStates[a],icon:Jo[o.Icon],text:o.Text,...tn(i.inputs,["toggled"])})}
                                ${T("click",()=>{const s=[...r.buttonStates];s[a]=!s[a],n({buttonStates:s})})}
                            ></${Fi}>
                        `)}})})}}),O5=R({parent:re,title:io.tagName,elementExamplesCallback({defineExample:e}){function t({title:r,tooltipContent:n,forceShow:o}){e({title:r,styles:m`
                    div {
                        padding: 16px;
                        display: block;
                ...
                `,renderCallback(){return u`
                        <${io.assign({tooltipContent:n,forceShow:o})}>
                            <div>Hover me!</div>
                        </${io}>
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),B5=R({parent:re,title:Qr.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${io.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return u`
...
`;function W5(e,t,r){const n=sh(r);return e({title:t,styles:Z5,renderCallback(){return u`
            ...
            `}})}const U5=R({title:"Fonts",parent:Ko,elementExamplesCallback({defineExample:e}){oe(B).map(t=>{const r=B[t];return W5(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),G5=R({title:"Shadows",parent:Ko,elementExamplesCallback({defineExample:e}){gh(fn).forEach(([t,r])=>{e({title:t,styles:m`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
