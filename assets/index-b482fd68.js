 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class aa extends gt{constructor(t){if(super(t),this.it=ee,t.type!==Ar.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===ee||t==null)return this._t=void 0,this.it=t;if(t===Pe)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const n=[t];return n.raw=n,this._t={_$litType$:this.constructor.resultType,strings:n,values:[]}}}aa.directiveName="unsafeHTML",aa.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ys extends aa{}Ys.directiveName="unsafeSVG",Ys.resultType=2;/**
 * @license
...
`,he=Bn()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:e})=>!!e.fitContainer},styles:({hostClasses:e})=>f`
    ...
    `,renderCallback:({inputs:e})=>{const t=e.icon?c`
        ...
        `}});var ka;(function(e){e.Header="header"})(ka||(ka={}));Bn()({tagName:"vira-collapsible-wrapper",hostClasses:{"vira-collapsible-wrapper-expanded":({inputs:e})=>e.expanded},styles:({hostClasses:e})=>f`
        :host {
            display: flex;
    ...
    `,events:{expandChange:ie()},stateInitStatic:{contentHeight:0},renderCallback({state:e,updateState:t,dispatch:n,events:r,inputs:o}){const i=o.expanded?f`
            ...
            >
                <slot name=${ka.Header}>Header</slot>
            </button>
...
`,Td=v({name:"LoaderAnimated24Icon",svgTemplate:c`
                ...
                <div class="title-group">
                    ...
                    ${r?c`
                          ...
                          `:c`
                              ...
                              <${vr.assign({config:e.pageNode.entry.controls,currentValues:os(e.controls,e.pageNode.fullUrlBreadcrumbs),fullUrlBreadcrumbs:e.pageNode.fullUrlBreadcrumbs})}></${vr}>
                          `}
                </div>
            </div>
            ...
            `];const a=na(e,1)?Bd(e,o,e[0],i):void 0,s=a&&Object.values(a.config).length&&na(e,1)?c`
              ...
              `:ee,l=jf(e,u=>u.fullUrlBreadcrumbs.join(">"),(u,p)=>{if(bn(u,ye.Page))return c`
                    <${Ul.assign({isTopLevel:t,pageNode:u,controls:o,router:n})}
                        class="block-entry"
                    ></${Ul}>
                `;if(bn(u,ye.ElementExample)){const h=os(o,u.fullUrlBreadcrumbs.slice(0,-1));return c`
    ...
    `,events:{loadingRender:ie()},stateInitStatic:{lastElement:void 0},renderCallback:({inputs:e,dispatch:t,events:n,state:r,updateState:o})=>{const i=da(e.currentRoute.paths),a=Hm({currentNodes:e.currentNodes,isTopLevel:!0,router:e.router,isSearching:!!i,controls:e.controls,originalTree:e.originalTree});return c`
            <${Ci.assign({currentSearch:i,currentRoute:e.currentRoute,router:e.router})}></${Ci}>

            ${we(e.showLoading,c`
                    <div
                        ${ca(()=>{t(new n.loadingRender(!0))})}
                        class="loading"
                    >
                        <${he.assign({icon:Td})}></${he}>
                    </div>
...
`))}const D=(()=>{const e=f`
    ...
    `}),hs=v({name:"ArrowLeft24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),fs=v({name:"ArrowRight24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),ps=v({name:"CheckMark24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Aa=v({name:"Infinity24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),ms=v({name:"LoaderAnimated24Icon",svgTemplate:c`
        <style>
            @keyframes spin {
                0% {
                    transform: rotate(0deg);
...
`,l2=v({name:"CryptoIcp16Icon",svgTemplate:c`
    ...
    `,renderCallback({inputs:e}){return c`
            <${he.assign(e)}></${he}>
        `}});var lo=(e=>(e.Danger="danger",e.Warning="warning",e.Success="success",e))(lo||{});const Ei=es()({tagName:"toniq-alert",hostClasses:{"toniq-alert-danger":({inputs:e})=>e.variant==="danger","toniq-alert-warning":({inputs:e})=>e.variant==="warning","toniq-alert-success":({inputs:e})=>e.variant==="success"},styles:({hostClasses:e})=>f`
        :host {
            padding: 8px 12px;
            border-radius: 8px;
            border: 1px solid;
    ...
    `,renderCallback({inputs:e}){let t;switch(e.variant){case"success":t=ps;break;case"warning":t=jd;break;default:t=Vd;break}return c`
            <${x.assign({icon:t})}></${x}>
            <slot></slot>
    ...
    `,cleanupCallback:({state:e})=>{window.clearInterval(e.rotationIntervalId)},renderCallback({inputs:e,state:t,updateState:n,host:r}){e.enableAutomaticCycling&&t.rotationIntervalId==null?n({rotationIntervalId:window.setInterval(()=>{Ii({host:r,direction:"right",allowWrapping:!0,blockIfHovering:!0})},e.cycleIntervalMs||D2)}):!e.enableAutomaticCycling&&t.rotationIntervalId!=null&&(window.clearInterval(t.rotationIntervalId),n({rotationIntervalId:void 0}));const o=Xl(t.scrollSnapPositions,0),i=Xl(t.scrollSnapPositions,-1);return c`
            <div>
                ...
                <div
                    ${Cn(()=>{n({scrollSnapPositions:ws(Sa(r)).x})})}
                    class=${co}
    ...
    `,initCallback:({state:e,host:t,updateState:n})=>{function r(o){var s;const i=(s=t.shadowRoot)==null?void 0:s.querySelector("button.dropdown");!o.composedPath().includes(i)&&e.dropdownOpen&&n({dropdownOpen:!1})}window.addEventListener("click",r)},renderCallback({dispatch:e,events:t,state:n,inputs:r,updateState:o}){r._forceOpenState!=null&&o({dropdownOpen:r._forceOpenState}),r.disabled&&o({dropdownOpen:!1});const i=r.value?r.options.find(l=>{var u;return l.value===((u=r.value)==null?void 0:u.value)})??r.options[0]:r.options[0],a=r.icon?c`
        ...
        `}}),Ui=gs({tagName:"toniq-error-message",styles:f`
        :host {
            display: block;
            color: red;
        }
    ...
    `,renderCallback({inputs:e}){function t(r){if(e.linkType==="disabled"){r.preventDefault();return}e.linkType==="route-link"&&Zo(r)&&(r.preventDefault(),e.scrollToTop&&window.scrollTo(0,0))}const n=e.linkType==="new-tab";return c`
            <a
                href=${e.url.toString()}
                ${y("click",t)}
                target=${ia(n?"_blank":void 0)}
                rel=${ia(n?"noopener noreferrer":void 0)}
            >
                <slot></slot>
            </a>
        `}}),Pa=360,uh=8;function dh(e){return(e-uh)/2}const ot=wt({"main-image-size":Pa,"secondary-image-size":dh(Pa)}),ut=ae()({tagName:"toniq-featured-flip-card-footer",styles:f`
        :host {
            display: inline-flex;
    ...
    `,renderCallback({inputs:e,state:t,updateState:n,host:r,dispatch:o,events:i}){var m,g,w,A;const a=e.mainImageSize||Pa,s=dh(a);yo({onElement:r,forCssVar:ot["main-image-size"],toValue:`${a}px`}),yo({onElement:r,forCssVar:ot["secondary-image-size"],toValue:`${s}px`});const l=["View",e.viewButtonTitle].filter(ve).join(" "),u=c`
            <h3>${e.cardTitle}</h3>
    ...
    `,renderCallback({inputs:e}){return e.level==="h1"?c`
            ...
            `:c`
                <slot></slot>
            `}});function Oa({input:e,matcher:t}){return!e||!t?!0:e.length>1?!!e.split("").every(n=>Oa({input:n,matcher:t})):t instanceof RegExp?!!e.match(t):t.includes(e)}function hh({value:e,allowed:t,blocked:n}){const r=t?Oa({input:e,matcher:t}):!0,o=n?Oa({input:e,matcher:n}):!1;return r&&!o}function Dc(e){if(!e.value)return{filtered:e.value,blocked:""};const{filtered:t,blocked:n}=e.value.split("").reduce((r,o)=>(hh({...e,value:o})?r.filtered.push(o):r.blocked.push(o),r),{filtered:[],blocked:[]});return{filtered:t.join(""),blocked:n.join("")}}var Da=(e=>(e.Default="default",e.Outline="outline",e))(Da||{});const Xr=ae()({tagName:"toniq-input",hostClasses:{"toniq-input-outline":({inputs:e})=>e.variant==="outline","toniq-input-has-a-value":({inputs:e})=>!!e.value,"toniq-input-disabled":({inputs:e})=>!!e.disabled},events:{valueChange:ie(),inputBlock:ie()},styles:({hostClasses:e})=>f`
            :host {
                position: relative;
                display: inline-flex;
                width: 224px;
    ...
    `,renderCallback:({inputs:e})=>c`
            <${x.assign({icon:ms,fitContainer:e.size!=="small"})}></${x}>
...
`;function Bv(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Kn(e){requestAnimationFrame(()=>{const t=fh(e.instanceInputs,e).elementValue;Iv(t,e)&&(e.setAttribute("disabled","true"),Kn(e))})}const F=ae()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ie()},styles:f`
    ...
    `,renderCallback({inputs:e}){const t=e.iconPlacement??"left",n=e.icon?c`
        ...
        `}}),ar=gs({tagName:"toniq-tooltip",styles:f`
        :host {
            display: block;
            padding: 4px 8px;
            border-radius: 8px;
    ...
    `,renderCallback({inputs:e}){return c`
            <${x.assign({icon:e.icon})}></${x}>
        `}}),ri=Object.values(At).reduce((e,t)=>(t.forEach(n=>{if(n.name in e)throw new Error(`Icon name duplicate: '${n.name}'`);e[n.name]=n}),e),{}),qv=Object.keys(ri).sort();function Ts(e){return{controlType:H.Dropdown,initValue:e,options:["None",...qv]}}const wh={"CSS color":{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Number,initValue:2}};function po(e){return Object.entries(e).filter(([,n])=>n!==""&&n!=null).map(([n,r])=>(n.toLowerCase()==="css color"&&(n="color"),te(r,"number")&&(r=Fa({value:r,suffix:"px"})),`${n}: ${r};`)).join(`
...
`,Rv=U({parent:ne,title:Ie.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:Uc,renderCallback(){return c`
                ...
                `}}),e({title:"banner style",styles:Uc,renderCallback(){const t=f`
                    ...
                    border-radius: 12px;
                `;return c`
                    <${Ie.assign({enableAutomaticCycling:!0,variant:Ca.Banner,templates:At["core-24"].map(n=>c`
                                <div style=${t}>
                                    <${x.assign({icon:n})}></${x}>
                                </div>
                            `)})}></${Ie}>
                    <${Ie.assign({enableAutomaticCycling:!0,variant:Ca.Banner,templates:[At["core-24"][0]].map(n=>c`
                                <div style=${t}>
                                    <${x.assign({icon:n})}></${x}>
                                </div>
                            `)})}
...
`))}const Hv=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],Xi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],Uv=U({parent:ne,title:bt.tagName,controls:{Text:{controlType:H.Text,initValue:"Text"},...Fv(bt)},elementExamplesCallback({defineExample:e}){Hv.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:Xi.map(n=>!!n.inputs.checked),extraEntryStatuses:Xi.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:f`
        ...
        `},{customStyle:f`
            max-height: 30px;
            min-height: 30px;
        `}],Zv=U({title:Jr.tagName,parent:ne,controls:{Selected:{controlType:H.Dropdown,initValue:_r[0].label,options:_r.map(e=>e.label)},Direction:{controlType:H.Dropdown,initValue:"Down",options:ru(La)},Icon:Ts(Od.name),Prefix:{controlType:H.Text,initValue:"Sort by: "},"Force open":{controlType:H.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){zv.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Wc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:f`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Wc.map((i,a)=>{const s=f`
                            ...
                            ${i.customStyle??f``};
                        `;return c`
                            <${Jr.assign({...t.inputs,...i.inputs,options:_r,value:n.selected[a]??_r.find(l=>l.label===o.Selected),icon:ri[o.Icon],selectedLabelPrefix:o.Prefix,direction:La[o.Direction],_forceOpenState:o["Force open"]||void 0})}
                                style=${s}
                    ...
                    <${oe.assign({imageUrls:un.map((t,n)=>n%2?"/invalid-image.png":t),infoParagraphs:gn,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return c`
                                <${Ct.assign({imageUrl:t,_debugLoadDelay:t.includes("invalid-image")?void 0:{milliseconds:1/0}})}>
                                    <div
                                        ...
                                        `}
                                    >
                                        <${x.assign({icon:ms,fitContainer:!0})}
                                            style=${f`
                                                width: 100%;
                                                height: 100%;
                                            `}
            ...
            `,renderCallback({controls:n}){return c`
                    <${x.assign({icon:Et,fitContainer:!0})}
                        style=${po(n)}
                    ></${x}>
                `}})}}),e5=U({title:Xr.tagName,parent:ne,controls:{"External value":{controlType:H.Text,initValue:""},Placeholder:{controlType:H.Text,initValue:"placeholder"},Icon:Ts(Ud.name),Suffix:{controlType:H.Text,initValue:"ICP"},"No browser helps":{controlType:H.Checkbox,initValue:!1},"Blocked characters":{controlType:H.Text,initValue:""},"Exclusive characters":{controlType:H.Text,initValue:""}},elementExamplesCallback({defineExample:e}){const t=[{},{customStyles:f`
                    height: 75px;
                    width: 300px;
                `},{customStyles:f`
                    height: 40px;
                    width: 140px;
                `}];[{title:"default",inputs:{variant:Da.Default}},{title:"outline",inputs:{variant:Da.Outline}},{title:"disabled",inputs:{disabled:!0}}].forEach(r=>{e({title:r.title,stateInitStatic:{value:""},styles:f`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
    ...
    `}),_i=oi({entries:r5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE",mobile:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Zc=gs({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const n=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(n)}})}},cleanupCallback({state:e,updateState:t}){var n;(n=e.cleanup)==null||n.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),u5=U({title:Ne.tagName,parent:ne,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return c`
                    <${Ne.assign(l5)}></${Ne}>
