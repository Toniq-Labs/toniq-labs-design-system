...
`,M2=w({name:"CryptoIcp16Icon",svgTemplate:c`
    ...
    `}),it={"core-16":[tg,Rd,ig,ag,sg,It,lg,cg],"core-24":[ug,dg,gs,hg,fg,ws,Fd,pg,mg,gg,wg,vg,bg,yg,kg,xg,vs,jd,$g,Ag,Hd,Cg,Sg,Tg,Mg,Eg,Ud,Ig,Bg,qg,Lg,Pg,Wd,Og,Dg,Ng,Rg,Fg,jg,Hg,Ug,Ma,Vd,Wg,Vg,zg,Zg,Yg,Gg,bs,Qg,Kg,Jg,Xg,_g,e2,t2,n2,r2,zd,Zd,o2,i2,a2,s2,l2,c2,u2,uo,d2,h2,Yd,f2,p2,Gd],"core-48":[m2,g2,Qd,w2,v2,b2,y2,k2,x2],"core-64":[Kd,$2,A2],cryptocurrencies:[C2,ni,S2,T2,M2,E2],"external-wallets":[I2,B2,q2,L2,P2,O2,D2,N2,R2,F2,j2,H2],"third-party-brands":[_d,e0,t0,U2,W2,V2,n0,z2,r0,Z2,o0,i0,Y2,a0,s0],toniq:[G2,Q2]},K2=Er({discord:nt(void 0,""),distrikt:nt(void 0,""),dscvr:nt(void 0,""),instagram:nt(void 0,""),medium:nt(void 0,""),telegram:nt(void 0,""),tikTok:nt(void 0,""),twitch:nt(void 0,""),twitter:nt(void 0,""),website:nt(void 0,"")}),J2=K2.defaultValue,l0={discord:_d,instagram:n0,telegram:o0,tikTok:i0,distrikt:e0,twitch:a0,dscvr:t0,medium:r0,twitter:s0,website:Yd},ec="toniq-",{defineElement:ae,defineElementNoInputs:ys}=as({assertInputs:e=>{if(!e.tagName.startsWith(ec))throw new Error(`Tag name should start with '${ec}' but got '${e.tagName}'`)}}),y=ae()({tagName:"toniq-icon",styles:f`
        :host {
            display: flex;
    ...
    `,renderCallback:({inputs:e})=>c`
        ...
        `}),Hc="...";function Pv(e,t,n=7,r=5){let o;e=yn({value:e,min:1,max:t}),n=yn({value:n,min:r,max:t});const i=n-5,a=n-3;t<=n?o=n:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>n?Gi(t-o,t):e>o?Gi(Math.min(s.start,t-o),Math.min(s.end,t)):Gi(1,Math.min(t,o+1));function u(h,m){return l.length+1!==t?m:[h]}const p=l[l.length-1];if(p&&p<t){const h=u(t,[Hc,t]);return[...l,...h]}else return l[0]!==1?u(1,[1,Hc]).concat(l):l}function Gi(e,t){const n=t-e+1;return Array.from({length:n},(r,o)=>e+o)}const Qi=ae()({tagName:"toniq-pagination",styles:f`
        :host {
            display: flex;
        }
    ...
    `,stateInitStatic:{canScroll:!1,debouncedResize:B1(()=>Gh(dr.FirstThenWait,{milliseconds:30})),rowStyles:{},isPainting:!1,itemsPainted:0,pageCountKey:0},initCallback({inputs:e,state:t,updateState:n}){const r=e.columns.filter(o=>!o.disabled);n({rowStyles:r.reduce((o,i)=>(o[i.key]={width:void 0,left:void 0},o),t.rowStyles)})},renderCallback({inputs:e,state:t,updateState:n,events:r,dispatch:o}){var h;const i=e.columns.filter(m=>!m.disabled),a=[e.rows[0],...e.rows].filter(ve);function s(m){m instanceof HTMLElement&&t.debouncedResize(()=>{n({canScroll:m.scrollWidth>m.clientWidth})})}const l=e.pagination&&((h=e.pagination)==null?void 0:h.pageCount)>1?c`
        ...
        `}});async function Ov(e){return navigator.clipboard.writeText(e)}const Dv="…";function Nv(e,t){const n=e.slice(0,t).trim(),r=e.slice(-1*t).trim();return`${n}${Dv}${r}`}function Rv(e){return!(e%1)}function Fv(e){return e.letterCount==null?4:Rv(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const D=ae()({tagName:"toniq-middle-ellipsis",events:{copy:ie()},cssVars:{"toniq-middle-ellipsis-text-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":b.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":b.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>f`
        :host {
            /* 5 frames at 60 fps */
            transition: ${oe.interaction};
            ${O.paragraphFont};
        ...
        `;return p?s?c`
                ...
                `:l?c`
                    <button
                        ...
                        ${k("click",async()=>{await Ov(i),t(new n.copy),r.showCopiedTextTimeoutId!=null&&window.clearTimeout(r.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${v} ${g}
                    </button>
                `:c`
...
`,zc=f`
    transform: scale(1.2);
`;function Jv(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Jn(e){requestAnimationFrame(()=>{const t=wh(e.instanceInputs,e).elementValue;Kv(t,e)&&(e.setAttribute("disabled","true"),Jn(e))})}const j=ae()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ie()},styles:f`
        :host {
            display: block;
        }
    ...
    `,renderCallback({inputs:e}){return c`
            <${y.assign({icon:e.icon})}></${y}>
        `}}),li=Object.values(it).reduce((e,t)=>(t.forEach(n=>{if(n.name in e)throw new Error(`Icon name duplicate: '${n.name}'`);e[n.name]=n}),e),{}),Xv=Object.keys(li).sort();function Bs(e){return{controlType:H.Dropdown,initValue:e,options:["None",...Xv]}}const kh={"CSS color":{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Number,initValue:2}};function wo(e){return Object.entries(e).filter(([,n])=>n!==""&&n!=null).map(([n,r])=>(n.toLowerCase()==="css color"&&(n="color"),ee(r,"number")&&(r=Wa({value:r,suffix:"px"})),`${n}: ${r};`)).join(`
`)}const _v=U({title:"Social Urls",parent:yh,elementExamplesCallback({defineExample:e}){function t({socialName:n,icon:r}){e({title:n,renderCallback(){return c`
                        <${Uo.assign({icon:r})}></${Uo}>
                    `}})}Object.entries(l0).forEach(([n,r])=>{t({socialName:n,icon:r})})}}),te=U({title:"Elements",parent:void 0}),e5=U({parent:te,title:ir.tagName,elementExamplesCallback({defineExample:e}){[{name:"danger",inputs:{variant:or.Danger},slot:c`<strong>Alert!</strong>This is an alert, Please be very careful!`},{name:"warning",inputs:{variant:or.Warning},slot:"This is a warning, proceed with caution 🚧"},{name:"success",inputs:{variant:or.Success},slot:"You have successfully completed your task!"}].forEach(n=>{e({title:n.name,stateInitStatic:{},styles:f`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
        ...
        `}],n5=U({title:Gt.tagName,parent:te,elementExamplesCallback({defineExample:e}){t5.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:f`
                    .bold {
                        ${O.boldFont}
                    }
...
`,o5=U({parent:te,title:ye.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:ra,renderCallback(){return c`
                ...
                `;return c`
                    ...
                    <${ye.assign({enableAutomaticCycling:!1,offsetArrows:!0,variant:fo.Banner,templates:it["core-24"].map(n=>c`
                            ...
                            `)})}></${ye}>
                `}})}});function i5(e){const t=Object.keys(e.cssVars).map(n=>[`--${n}`,{controlType:H.Color,initValue:""}]);return Object.fromEntries(t)}function a5(e){const t=Object.entries(e).map(([n,r])=>{if(n.startsWith("--"))return typeof r!="string"||!r?void 0:`${n}: ${r};`}).filter(ve);return T(t.join(`
`))}const s5=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],oa=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],l5=U({parent:te,title:kt.tagName,controls:{Text:{controlType:H.Text,initValue:"Text"},...i5(kt)},elementExamplesCallback({defineExample:e}){s5.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:oa.map(n=>!!n.inputs.checked),extraEntryStatuses:oa.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:f`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return oa.map((i,a)=>{const s=(i.extraEntries??[]).map((u,p)=>{var h;return c`
                        ...
                        `})}})})}}),c5=U({parent:te,title:Di.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:It}},{inputs:{icon:It}},{inputs:{},template:c`
                    HTML child
        ...
        `},{customStyle:f`
            max-height: 30px;
            min-height: 30px;
        `}],h5=U({title:eo.tagName,parent:te,controls:{Selected:{controlType:H.Dropdown,initValue:no[0].label,options:no.map(e=>e.label)},Direction:{controlType:H.Dropdown,initValue:"Down",options:au(Na)},Icon:Bs(Fd.name),Prefix:{controlType:H.Text,initValue:"Sort by: "},"Force open":{controlType:H.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){d5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Zc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:f`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Zc.map((i,a)=>{const s=f`
                        ...
                        `;return c`
                            ...
                            ></${eo}>
                        `})}})})}}),f5=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],p5=U({title:Yi.tagName,parent:te,elementExamplesCallback({defineExample:e}){f5.forEach(t=>{e({title:t.title,renderCallback(){return c`
                        <${Yi}>${t.content}</${Yi}>
                    `}})})}}),Yc="/toniq-labs-design-system";function xh(...e){const n=[globalThis.location.pathname.startsWith(Yc)?Yc:"",...e].filter(ve);return fr(...n)}const dn=Array(30).fill(xh("/toniq-labs-logo.png")),vn=["Hello there.","There is stuff here."],ro=vn.concat(Array(30).fill(vn)),m5=U({title:re.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${re.assign({infoParagraphs:ro,imageUrls:dn,socialUrls:J2,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${re}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${re.assign({imageUrls:dn.map((t,n)=>n%2?"/invalid-image.png":t),infoParagraphs:vn,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return c`
                            ...
                            `}})}></${re}>
                `}})}}),g5=U({title:Yt.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:f`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:n}){return c`
                ...
                `}})}}),w5=U({title:Ie.tagName,parent:te,elementExamplesCallback({defineExample:e}){su(mn).forEach(t=>{e({title:t,renderCallback(){return c`
            ...
            `,renderCallback({controls:n}){return c`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),c`
                            ...
                            ></${to}>
                        `))}})})}});function ci({entries:e,columns:t,createRowObject:n}){const r=Object.fromEntries(t.map(i=>[i.key,""]));return{rows:e.map((i,a)=>{const s=n(i,a);if(!at(Object.keys(r).sort(),Object.keys(s.cells).sort()))throw console.error("broken list table row",{cells:s.cells,columns:r}),new Error("List table row keys does not match expect column keys.");return s}),columns:t}}const $h="https://cdn-bitcoin.bioniq.io",k5=fr($h,"content"),x5=fr($h,"thumbnail"),bn={thumbnail(e){return fr(x5,e)},content(e){return fr(k5,e)}},$5=Array(5).fill({imageUrl:bn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${f`
                display: flex;
                gap: 8px;
    ...
    `}),A5=[{imageUrl:bn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Payment Sent",price:c`
            <div
                style=${f`
                    display: flex;
                    gap: 8px;
        ...
        `}],C5=[],S5=Array(5).fill({imageUrl:bn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${f`
                display: flex;
                gap: 8px;
    ...
    `}),ia=ci({entries:$5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE",mobile:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${f`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),Gc=ci({entries:A5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${f`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),T5=ci({entries:C5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${f`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),M5=ci({entries:S5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME",style:f`
                display: flex;
                justify-content: flex-end;
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Qc=ys({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const n=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(n)}})}},cleanupCallback({state:e,updateState:t}){var n;(n=e.cleanup)==null||n.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),I5=U({title:Re.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return c`
            ...
            `,stateInitStatic:{tableInputs:{...ia,rows:ia.rows.map(t=>({...t,cells:{...t.cells,date:c`
                ...
                `}})}}),B5=U({title:lr.tagName,parent:te,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:sr.Small}},{title:"large",inputs:{size:sr.Large}},{title:"whole page",inputs:{size:sr.WholePage},styles:f`
                    :host {
                        width: 500px;
                    }
                `}].forEach(n=>{e({title:n.title,styles:n.styles??f``,renderCallback(){return c`
                        <${lr.assign(n.inputs)}></${lr}>
                    `}})})}}),q5=U({title:D.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return c`
            ...
            `,renderCallback(){return c`
                ...
                `}})}}),L5=U({title:Wn.tagName,parent:te,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:f`
                ${Wn} {
                    height: 32px;
                }
...
`,aa={min:10,max:50},O5=U({title:j.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:f`
                ${rt}
            `,renderCallback({state:t,updateState:n}){return c`
            ...
            `,renderCallback({state:t,updateState:n}){return c`
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Kc.map((i,a)=>c`
                            ...
                            ></${na}>
                        `)}})})}}),R5=U({parent:te,title:go.tagName,elementExamplesCallback({defineExample:e}){function t({title:n,tooltipContent:r,forceShow:o}){e({title:n,styles:f`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!1}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!1})}}),F5=U({parent:te,title:ur.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${go.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return c`
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:f``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:f``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:Ma},{label:"label here",value:2,icon:Ma},{label:"",value:3,icon:It,disabled:!0},{label:"16px icon",value:4,icon:It},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],U5=U({title:Xn.tagName,parent:te,elementExamplesCallback({defineExample:e}){H5.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:f`
                ...
                `,renderCallback({state:n,updateState:r}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return c`
                        ...
                        ></${Xn}>
                    `}})})}}),Ah=U({title:"Icons",parent:void 0,controls:kh}),W5=Object.entries(it).map(([e,t])=>U({title:e,parent:Ah,elementExamplesCallback({defineExample:n}){t.map(r=>n({title:r.name,renderCallback({controls:o}){return c`
                                <${Uo.assign({icon:r})}
                                    style=${wo(o)}
                                ></${Uo}>
                            `}}))}}));function Ch(e){const t=V5(e),n=xe(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return le(n).reduce((o,i)=>{const a=n[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function V5(e){typeof e!="string"&&(e=String(e));const r=`{"${eu(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(r);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${r}`),o}}const ui=U({title:"Styles",parent:void 0}),z5=f`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function Z5(e,t,n){const r=Ch(R(n));return e({title:t,styles:z5,renderCallback(){return c`
            ...
            `}})}const Y5=U({title:"Colors",parent:ui,elementExamplesCallback({defineExample:e}){le(b).map(t=>Z5(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),G5=f`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function Q5(e,t,n){const r=Ch(n);return e({title:t,styles:G5,renderCallback(){return c`
            ...
            `}})}const K5=U({title:"Fonts",parent:ui,elementExamplesCallback({defineExample:e}){le(O).map(t=>{const n=O[t];return Q5(e,t,n)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),J5=U({title:"Shadows",parent:ui,elementExamplesCallback({defineExample:e}){Ph($r).forEach(([t,n])=>{e({title:t,styles:f`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return c`
                            <div></div>
                        `}})})}}),X5=[te,Ah,ui,yh],_5=[...W5,...j5,_v,n5,e5,r5,o5,l5,c5,Y5,u5,h5,p5,m5,g5,K5,w5,v5,b5,y5,B5,q5,L5,P5,J5,O5,N5,U5,I5].sort((e,t)=>e.title.localeCompare(t.title)),eb=[...X5,..._5];Ko({tagName:"toniq-design-system-app",styles:f`
        :host {
            display: block;
            height: 100%;
            width: 100%;
