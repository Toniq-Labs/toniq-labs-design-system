 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:A1}=k1,Hs=()=>document.createComment(""),Nn=(e,t,n)=>{var i;const r=e._$AA.parentNode,o=t===void 0?e._$AB:t._$AA;if(n===void 0){const a=r.insertBefore(Hs(),o),s=r.insertBefore(Hs(),o);n=new A1(a,s,e,e.options)}else{const a=n._$AB.nextSibling,s=n._$AM,l=s!==e;if(l){let c;(i=n._$AQ)==null||i.call(n,e),n._$AM=e,n._$AP!==void 0&&(c=e._$AU)!==s._$AU&&n._$AP(c)}if(a!==o||l){let c=n._$AA;for(;c!==a;){const f=c.nextSibling;r.insertBefore(c,o),c=f}}}return n},Rt=(e,t,n=e)=>(e._$AI(t,n),e),$1={},C1=(e,t=$1)=>e._$AH=t,S1=e=>e._$AH,hi=e=>{var r;(r=e._$AP)==null||r.call(e,!1,!0);let t=e._$AA;const n=e._$AB.nextSibling;for(;t!==n;){const o=t.nextSibling;t.remove(),t=o}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ot=e=>(...t)=>({_$litDirective$:e,values:t});class gt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,n,r){this._$Ct=t,this._$AM=n,this._$Ci=r}_$AS(t,n){return this.update(t,n)}update(t,n){return this.render(...n)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const T1={attribute:!0,type:String,converter:go,reflect:!1,hasChanged:ja},M1=(e=T1,t,n)=>{const{kind:r,metadata:o}=n;let i=globalThis.litPropertyMetadata.get(o);if(i===void 0&&globalThis.litPropertyMetadata.set(o,i=new Map),i.set(n.name,e),r==="accessor"){const{name:a}=n;return{set(s){const l=t.get.call(this);t.set.call(this,s),this.requestUpdate(a,l,e)},init(s){return s!==void 0&&this.P(a,void 0,e),s}}}if(r==="setter"){const{name:a}=n;return function(s){const l=this[a];t.call(this,s),this.requestUpdate(a,l,e)}}throw Error("Unsupported decorator location: "+r)};function E1(e){return(t,n)=>typeof n=="object"?M1(e,t,n):((r,o,i)=>{const a=o.hasOwnProperty(i);return o.constructor.createProperty(i,a?{...r,wrapped:!0}:r),a?Object.getOwnPropertyDescriptor(o,i):void 0})(e,t,n)}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fe=Ot(class extends gt{constructor(e){var t;if(super(e),e.type!==xr.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var r,o;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!((r=this.nt)!=null&&r.has(i))&&this.st.add(i);return this.render(t)}const n=e.element.classList;for(const i of this.st)i in t||(n.remove(i),this.st.delete(i));for(const i in t){const a=!!t[i];a===this.st.has(i)||(o=this.nt)!=null&&o.has(i)||(a?(n.add(i),this.st.add(i)):(n.remove(i),this.st.delete(i)))}return Pe}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Us=e=>e??X;/**
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class na extends gt{constructor(t){if(super(t),this.it=X,t.type!==xr.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===X||t==null)return this._t=void 0,this.it=t;if(t===Pe)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const n=[t];return n.raw=n,this._t={_$litType$:this.constructor.resultType,strings:n,values:[]}}}na.directiveName="unsafeHTML",na.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,he=En()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:e})=>!!e.fitContainer},styles:({hostClasses:e})=>p`
    ...
    `,renderCallback:({inputs:e})=>{const t=e.icon?u`
        ...
        `}});var wa;(function(e){e.Header="header"})(wa||(wa={}));En()({tagName:"vira-collapsible-wrapper",hostClasses:{"vira-collapsible-wrapper-expanded":({inputs:e})=>e.expanded},styles:({hostClasses:e})=>p`
        :host {
            display: flex;
    ...
    `,events:{expandChange:ne()},stateInitStatic:{contentHeight:0},renderCallback({state:e,updateState:t,dispatch:n,events:r,inputs:o}){const i=o.expanded?p`
        ...
        `}});const q=wt({"vira-icon-stroke-color":"currentColor","vira-icon-fill-color":"none","vira-icon-stroke-width":"1px"});function v({name:e,svgTemplate:t}){return{name:e,svgTemplate:t}}const Cp=v({name:"CloseX24Icon",svgTemplate:u`
    ...
    `});const Tp=v({name:"Loader24Icon",svgTemplate:u`
        <svg
...
`,Ad=v({name:"LoaderAnimated24Icon",svgTemplate:u`
    ...
    `,events:{routeChange:ne()},renderCallback({inputs:e,dispatch:t,events:n}){var o,i;function r(a){e.route&&Wo(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new n.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return u`
    ...
    `,renderCallback({inputs:e}){const t=e.flattenedNodes.map(n=>{if(!Bp(n,e.selectedPath))return;const r=p`
        ...
        `}});async function Lp(e){await ta(2);const t=e.shadowRoot.querySelector(".selected");if(!t)throw new Error("Failed to find selected nav tree element.");await l1(t)||t.scrollIntoView({behavior:"smooth",block:"center"})}const qt=Ge()({tagName:"book-error",styles:p`
        :host {
            display: flex;
            flex-direction: column;
            color: red;
    ...
    `,renderCallback({inputs:e}){return(_(e.message,"array")?e.message:[e.message]).map(n=>u`
                <p>${n}</p>
            `)}}),wr=Ge()({tagName:"book-page-controls",events:{controlValueChange:ne()},hostClasses:{"book-page-controls-has-controls":({inputs:e})=>!!Object.keys(e.config).length},styles:({hostClasses:e})=>p`
        :host {
            display: flex;
            flex-wrap: wrap;
    ...
    `,renderCallback({inputs:e,dispatch:t,events:n}){return Object.entries(e.config).length?Object.entries(e.config).map(([r,o],i)=>{if(o.controlType===j.Hidden)return"";const a=qp(e.currentValues[r],o,s=>{const l=_(e.fullUrlBreadcrumbs,"array")?e.fullUrlBreadcrumbs:e.fullUrlBreadcrumbs[r];if(!l)throw new Error(`Failed to find breadcrumbs from given control name: '${r}'`);t(new n.controlValueChange({fullUrlBreadcrumbs:l,newValues:{...e.currentValues,[r]:s}}))});return u`
                ...
                `}):""}});function qp(e,t,n){return en(t,j.Hidden)?"":en(t,j.Checkbox)?u`
            <input
                type="checkbox"
                .value=${e}
    ...
    `,renderCallback({inputs:e,dispatch:t}){return u`
            ...
            <input
                ...
                ${y("input",async n=>{const r=n.currentTarget;if(!(r instanceof HTMLInputElement))throw new Error("Failed to find input element for search.");const o=r.value;await ea(200),r.value===o&&(r.value?t(new Mo({paths:[Se.Search,encodeURIComponent(r.value)]})):t(new Mo($n)))})}
            />
    ...
    `,renderCallback({inputs:e}){return u`
        ...
        `}});function Td(e,t,n,r){const o=aa(n,r),i=[];if(o){const a=Td(e,t,o,r);a&&i.push(a)}if(wn(n,be.Page)&&!e.includes(n)){const a=_a(t,n.fullUrlBreadcrumbs);i.push({config:n.entry.controls,current:a,breadcrumbs:ke(a,()=>n.fullUrlBreadcrumbs)})}return i.reduce((a,s)=>({config:{...a.config,...s.config},current:{...a.current,...s.current},breadcrumbs:{...a.breadcrumbs,...s.breadcrumbs}}),{config:{},current:{},breadcrumbs:{}})}function Pp({currentNodes:e,isTopLevel:t,router:n,isSearching:r,controls:o,originalTree:i}){if(!e.length&&r)return[u`
            ...
            `];const a=_i(e,1)?Td(e,o,e[0],i):void 0,s=a&&Object.values(a.config).length&&_i(e,1)?u`
              ...
              `:X,l=L1(e,c=>c.fullUrlBreadcrumbs.join(">"),(c,f)=>{if(wn(c,be.Page))return u`
                    <${Nl.assign({isTopLevel:t,pageNode:c,controls:o,router:n})}
                        class="block-entry"
                    ></${Nl}>
                `;if(wn(c,be.ElementExample)){const h=_a(o,c.fullUrlBreadcrumbs.slice(0,-1));return u`
                    <${jl.assign({elementExampleNode:c,currentPageControls:h,router:n})}
                        class="inline-entry"
                    ></${jl}>
                `}else return wn(c,be.Root)?X:u`
                    <${qt.assign({message:`Unknown entry type for rendering: '${c.entry.entryType}'`})}
                        class="block-entry"
                    ></${qt}>
    ...
    `,events:{loadingRender:ne()},stateInitStatic:{lastElement:void 0},renderCallback:({inputs:e,dispatch:t,events:n,state:r,updateState:o})=>{const i=sa(e.currentRoute.paths),a=Pp({currentNodes:e.currentNodes,isTopLevel:!0,router:e.router,isSearching:!!i,controls:e.controls,originalTree:e.originalTree});return u`
        ...
        `}});function Op(e,t,n){const r=Hl(e,t);if(r.length)return r;n($n);const o=Hl(e,$n.paths);if(!o)throw new Error(`Tried to self-correct for invalid path ${t.join("/")}
                        but failed to do so.`);return o}function Hl(e,t){return e.filter(n=>s1({searchFor:t.slice(1),searchIn:n.fullUrlBreadcrumbs}))}const $i=Ou()({tagName:"element-book-app",events:{pathUpdate:ne()},stateInitStatic:{currentRoute:$n,router:void 0,loading:!0,colors:{config:void 0,theme:ql(void 0)},treeBasedControls:void 0,originalWindowTitle:void 0},styles:p`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{Ul(e,sa(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:n,updateState:r,dispatch:o,events:i})=>{var f,h,m,g,w,k,x;t._debug&&console.info("rendering element-book app");function a(C){return{...e.currentRoute,...C}}function s(C){const S=a(C);return!it(e.currentRoute,S)}function l(C){t.preventWindowTitleChange||(e.originalWindowTitle||r({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,C].filter(we).join(" - "))}function c(C){if(!s(C))return;const S=a(C);e.router?e.router.setRoutes(S):r({currentRoute:{...e.currentRoute,...S}}),t.elementBookRoutePaths&&!it(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(S.paths??[]))}try{if(t.elementBookRoutePaths&&!it(t.elementBookRoutePaths,e.currentRoute.paths)&&c({paths:t.elementBookRoutePaths}),(f=t.internalRouterConfig)!=null&&f.useInternalRouter&&!e.router){const H=Hf(t.internalRouterConfig.basePath);r({router:H}),H.addRouteListener(!0,ae=>{r({currentRoute:ae})})}else!((h=t.internalRouterConfig)!=null&&h.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const C={themeColor:t.themeColor};if(!it(C,(m=e.colors)==null?void 0:m.config)){const H=ql(C);r({colors:{config:C,theme:H}}),Wf(n,H)}const S=t._debug??!1,N=$f({entries:t.entries,debug:S});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),r({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:Fu(N.tree,{children:(w=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:w.children,controls:t.globalValues})}}));const W=sa(e.currentRoute.paths),ie=(W?Bf({flattenedNodes:N.flattenedNodes,searchQuery:W}):void 0)??Op(N.flattenedNodes,e.currentRoute.paths,c);l((k=ie[0])==null?void 0:k.entry.title);const ce=(x=e.treeBasedControls)==null?void 0:x.controls;return ce?(t._debug&&console.info({currentControls:ce}),u`
                ...
                >
                    ...
                    <${rn.assign({controls:ce,currentNodes:ie,currentRoute:e.currentRoute,debug:S,originalTree:N.tree,router:e.router,showLoading:e.loading})}
                        ${y(rn.events.loadingRender,async H=>{await ta();const ae=n.shadowRoot.querySelector(rn.tagName);ae?ae.scroll({top:0,behavior:"instant"}):console.error(`Failed to find '${rn.tagName}' for scrolling.`),await ta(),r({loading:!H.detail})})}
                    >
                        <slot
                            name=${at.Footer}
                            slot=${at.Footer}
...
`))}const D=(()=>{const e=p`
    ...
    `}),Fp=v({name:"Copy16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${d["toniq-icon-fill-color"].value}
            stroke=${d["toniq-icon-stroke-color"].value}
    ...
    `}),jp=v({name:"ExternalLink16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Mt=v({name:"InfoCircle16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Up=v({name:"ArrowForwardUp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Vp=v({name:"ArrowLoopLeft24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Wp=v({name:"ArrowLoopRight24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Gp=v({name:"Bell24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Yp=v({name:"Bucket24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Qp=v({name:"BuildingStore24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Kp=v({name:"CalendarEvent24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Jp=v({name:"Cash24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),_p=v({name:"ChevronUp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),nm=v({name:"CircleWavyCheck24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),rm=v({name:"Clock24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),xm=v({name:"Loader24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Mm=v({name:"People24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Lm=v({name:"Send24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Nm=v({name:"SquareCheck24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Hm=v({name:"WorldUpload24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Vm=v({name:"Folder48Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Gm=v({name:"CircleDashes64Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Ym=v({name:"Rocket64Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Qm=v({name:"CryptoBtc16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Km=v({name:"CryptoCkBtc16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Jm=v({name:"CryptoCkBtc24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
...
`,Xm=v({name:"CryptoIcp16Icon",svgTemplate:u`
    ...
    `}),_m=v({name:"CryptoIcp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),eg=v({name:"WalletInfinity24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),tg=v({name:"WalletInfinity64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),ng=v({name:"WalletLeather24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),rg=v({name:"WalletLeather64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),og=v({name:"WalletPlug24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),ig=v({name:"WalletPlug64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),ag=v({name:"WalletStoic24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),sg=v({name:"WalletStoic64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),lg=v({name:"WalletUnisat24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),cg=v({name:"WalletUnisat64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),ug=v({name:"WalletXverse24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),dg=v({name:"WalletXverse64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),hg=v({name:"BrandFacebookLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),fg=v({name:"BrandGoogleLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),pg=v({name:"BrandIcScan24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),mg=v({name:"BrandInstagramFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),gg=v({name:"BrandNftgeek24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),wg=v({name:"BrandTiktokFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${G["toniq-icon-fill-color"]("#000")}
    ...
    `}),vg=v({name:"BioniqRobot100Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),bg=v({name:"EntrepotLogo144Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),xt={"core-16":[Id,Fp,jp,Mt],"core-24":[Hp,Up,ss,Vp,Wp,ls,Bd,zp,Zp,Gp,Yp,Qp,Kp,Jp,Xp,Ld,qd,_p,em,Pd,tm,nm,rm,om,Od,im,am,sm,lm,cm,Dd,um,dm,hm,fm,pm,mm,ba,gm,wm,vm,bm,ym,km,xm,cs,Am,$m,Cm,Sm,Tm,Mm,Em,Im,Bm,Nd,Rd,Lm,qm,Pm,Om,Dm,Nm,Rm,ao,Fm,jm,Fd,Hm,Um],"core-48":[Vm,jd,Wm,zm,Zm],"core-64":[Hd,Gm,Ym],cryptocurrencies:[Qm,Qo,Km,Jm,Xm,_m],"external-wallets":[eg,tg,ng,rg,og,ig,ag,sg,lg,cg,ug,dg],"third-party-brands":[Wd,zd,Zd,hg,fg,pg,Gd,mg,Yd,gg,Qd,Kd,wg,Jd,Xd],toniq:[vg,bg]},yg=Cr({discord:nt(void 0,""),distrikt:nt(void 0,""),dscvr:nt(void 0,""),instagram:nt(void 0,""),medium:nt(void 0,""),telegram:nt(void 0,""),tikTok:nt(void 0,""),twitch:nt(void 0,""),twitter:nt(void 0,""),website:nt(void 0,"")}),kg=yg.defaultValue,_d={discord:Wd,instagram:Gd,telegram:Qd,tikTok:Kd,distrikt:zd,twitch:Jd,dscvr:Zd,medium:Yd,twitter:Xd,website:Fd},zl="toniq-",{defineElement:re,defineElementNoInputs:us}=Ja({assertInputs:e=>{if(!e.tagName.startsWith(zl))throw new Error(`Tag name should start with '${zl}' but got '${e.tagName}'`)}}),Gt=re()({tagName:"toniq-bold-space",styles:p`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,cleanupCallback:({state:e})=>{window.clearInterval(e.rotationIntervalId)},renderCallback({inputs:e,state:t,updateState:n,host:r}){e.enableAutomaticCycling&&t.rotationIntervalId==null?n({rotationIntervalId:window.setInterval(()=>{Ti({host:r,direction:"right",allowWrapping:!0,blockIfHovering:!0})},e.cycleIntervalMs||Sg)}):!e.enableAutomaticCycling&&t.rotationIntervalId!=null&&(window.clearInterval(t.rotationIntervalId),n({rotationIntervalId:void 0}));const o=Gl(t.scrollSnapPositions,0),i=Gl(t.scrollSnapPositions,-1);return u`
            <div>
                ...
                <div
                    ${An(()=>{n({scrollSnapPositions:ds(xa(r)).x})})}
                    class=${so}
    ...
    `,renderCallback({inputs:e,dispatch:t,events:n}){const r=u`
        ...
        `}});var Zn=(e=>(e.Default="default",e.Secondary="secondary",e.Success="success",e.Warning="warning",e.Danger="danger",e))(Zn||{});const Mi=re()({tagName:"toniq-chip",hostClasses:{"toniq-chip-secondary":({inputs:e})=>e.variant==="secondary","toniq-chip-success":({inputs:e})=>e.variant==="success","toniq-chip-warning":({inputs:e})=>e.variant==="warning","toniq-chip-danger":({inputs:e})=>e.variant==="danger"},options:{ignoreUnsetInputs:!0},styles:({hostClasses:e})=>p`
        :host {
            display: inline-flex;
            vertical-align: middle;
            align-items: center;
    ...
    `,events:{viewMoreButtonClick:ne(),flipCardButtonClick:ne()},renderCallback({inputs:e,dispatch:t,events:n}){const r=e.socialUrls,o=r?le(r).map(i=>{const a=r[i];if(!a)return;const s=_d[i];return u`
    ...
    `,renderCallback({inputs:e,state:t,updateState:n,host:r,dispatch:o,events:i}){var m,g,w,k;const a=e.mainImageSize||Ia,s=ih(a);vo({onElement:r,forCssVar:ot["main-image-size"],toValue:`${a}px`}),vo({onElement:r,forCssVar:ot["secondary-image-size"],toValue:`${s}px`});const l=["View",e.viewButtonTitle].filter(we).join(" "),c=u`
            <h3>${e.cardTitle}</h3>
    ...
    `,renderCallback({inputs:e}){return e.level==="h1"?u`
            ...
            `:u`
                <slot></slot>
            `}});function Ba({input:e,matcher:t}){return!e||!t?!0:e.length>1?!!e.split("").every(n=>Ba({input:n,matcher:t})):t instanceof RegExp?!!e.match(t):t.includes(e)}function ah({value:e,allowed:t,blocked:n}){const r=t?Ba({input:e,matcher:t}):!0,o=n?Ba({input:e,matcher:n}):!1;return r&&!o}function Bc(e){if(!e.value)return{filtered:e.value,blocked:""};const{filtered:t,blocked:n}=e.value.split("").reduce((r,o)=>(ah({...e,value:o})?r.filtered.push(o):r.blocked.push(o),r),{filtered:[],blocked:[]});return{filtered:t.join(""),blocked:n.join("")}}var La=(e=>(e.Default="default",e.Outline="outline",e))(La||{});const Jr=re()({tagName:"toniq-input",hostClasses:{"toniq-input-outline":({inputs:e})=>e.variant==="outline","toniq-input-has-a-value":({inputs:e})=>!!e.value,"toniq-input-disabled":({inputs:e})=>!!e.disabled},events:{valueChange:ne(),inputBlock:ne()},styles:({hostClasses:e})=>p`
            :host {
                position: relative;
                display: inline-flex;
                width: 224px;
        ...
        `,renderCallback({inputs:e,dispatch:t,events:n}){const{filtered:r}=Bc({value:e.value??"",allowed:e.allowedInputs,blocked:e.blockedInputs}),o=e.icon?u`
            ...
            <label>
                ...
                <input
                    ...
                    ?disabled=${e.disabled}
                    .value=${r}
                    ${y("input",i=>{if(!(i instanceof InputEvent))throw new Error(`Input event type mismatch: "${i.constructor.name}"`);const a=i.target;if(!(a instanceof HTMLInputElement))throw new Error("Failed to find input element target from input event.");const s=i.data,l=r;let c=a.value??"";if(s)if(s.length===1)ah({value:s,allowed:e.allowedInputs,blocked:e.blockedInputs})||(c=l,t(new n.inputBlock(s)));else{const{filtered:f,blocked:h}=Bc({value:s,allowed:e.allowedInputs,blocked:e.blockedInputs});c=f,t(new n.inputBlock(h))}a.value!==c&&(a.value=c),l!==c&&t(new n.valueChange(c))})}
                    placeholder=${e.placeholder}
                />
                ${ye(!!e.suffix,u`
                        <div class="suffix">${e.suffix}</div>
        ...
        `}});var nr=(e=>(e.Small="small",e.Large="large",e.WholePage="whole-page",e))(nr||{});const rr=re()({tagName:"toniq-loading",hostClasses:{"toniq-loading-large":({inputs:e})=>e.size==="large","toniq-loading-whole-page":({inputs:e})=>e.size==="whole-page"},styles:({hostClasses:e})=>p`
        :host {
            display: inline-flex;
        }
    ...
    `,renderCallback:({inputs:e})=>u`
        ...
        `}),Lc="...";function o5(e,t,n=7,r=5){let o;e=gn({value:e,min:1,max:t}),n=gn({value:n,min:r,max:t});const i=n-5,a=n-3;t<=n?o=n:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>n?ji(t-o,t):e>o?ji(Math.min(s.start,t-o),Math.min(s.end,t)):ji(1,Math.min(t,o+1));function c(h,m){return l.length+1!==t?m:[h]}const f=l[l.length-1];if(f&&f<t){const h=c(t,[Lc,t]);return[...l,...h]}else return l[0]!==1?c(1,[1,Lc]).concat(l):l}function ji(e,t){const n=t-e+1;return Array.from({length:n},(r,o)=>e+o)}const Hi=re()({tagName:"toniq-pagination",styles:p`
        :host {
            display: flex;
        }
    ...
    `,events:{pageChange:ne()},renderCallback({inputs:e,events:t,dispatch:n}){return e.pageCount<=1?u``:u`
                <button
                ...
                ${o5(e.currentPage,e.pageCount,e.pagesShown).map(r=>typeof r=="string"?u`
            ...
            `}}),Ui=b.pageInteraction.foregroundColor,Vi=b.accentSecondary.backgroundColor,Ne=re()({tagName:"toniq-list-table",cssVars:{"toniq-list-table-border-width":"1px","toniq-list-table-border-hover-width":"2px","toniq-list-table-header-radius":"16px","toniq-list-table-row-gap":"36px"},events:{pageChange:ne()},styles:({cssVars:e})=>p`
        :host {
            display: flex;
            overflow-x: auto;
    ...
    `,stateInitStatic:{canScroll:!1,debouncedResize:hf(()=>Nh(ar.FirstThenWait,{milliseconds:30})),rowStyles:{},isPainting:!1,itemsPainted:0},initCallback({inputs:e,state:t,updateState:n}){const r=e.columns.filter(o=>!o.disabled);n({rowStyles:r.reduce((o,i)=>(o[i.key]={width:void 0,left:void 0},o),t.rowStyles)})},renderCallback({inputs:e,state:t,updateState:n,events:r,dispatch:o}){var h;const i=e.columns.filter(m=>!m.disabled),a=[e.rows[0],...e.rows].filter(we);function s(m){m instanceof HTMLElement&&t.debouncedResize(()=>{n({canScroll:m.scrollWidth>m.clientWidth})})}const l=e.pagination&&((h=e.pagination)==null?void 0:h.pageCount)>1?u`
                ...
                >
                    ${i.map((w,k)=>{var C,S,N,W;const x=m.cells[w.key];return u`
                            <div
                                ...
                                style=${w.style?w.style:p`
                                          ...
                                          min-width: ${k>=i.length-1?T("unset"):T(`${(W=t.rowStyles[w.key])==null?void 0:W.width}px`)};
                                      `}
                            >
                                <div
                                    class=${fe({"row-content":!0,hidden:g===0})}
                                    ${ia(ee=>{var ve,lt;const ie=ee.closest(".table-list"),ce=ie==null?void 0:ie.getBoundingClientRect().left,H=ie==null?void 0:ie.querySelectorAll(".row-item")[k],ae=H==null?void 0:H.getBoundingClientRect().left,$e=ee.getBoundingClientRect().width;(!((ve=t.rowStyles[w.key])!=null&&ve.width)||$e>((lt=t.rowStyles[w.key])==null?void 0:lt.width))&&n({rowStyles:{...t.rowStyles,[w.key]:{width:$e,left:ce?ae-ce:ae}}}),n({itemsPainted:t.itemsPainted+1})})}
                                >
                                    ${x}
                                </div>
                                ${ye(g===0,u`
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:n,state:r,updateState:o}){if(!e.text)return u``;const i=e.text,a=c5(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,f=c?s5(i,a):i,h=c?i:"",m=s?Dd:l?Od:void 0,g=m?u`
                  <${$.assign({icon:m})}></${$}>
              `:"",w=u`
        ...
        `;return f?s?u`
                ...
                `:u`
                    ${w}
                `:u``}}),jn=re()({tagName:"toniq-progress",cssVars:{"toniq-progress-width":"0%"},styles:({cssVars:e})=>p`
        :host {
            position: relative;
            width: 100%;
            display: inline-block;
    ...
    `,renderCallback({inputs:e,cssVars:t,host:n}){const r=gn({value:e.percent,max:100,min:0}),o=`${r}%`;return vo({forCssVar:t["toniq-progress-width"],onElement:n,toValue:o}),n.setAttribute("title",`${o} finished`),r?u`
...
`,Dc=p`
    transform: scale(1.2);
`;function k5(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Qn(e){requestAnimationFrame(()=>{const t=sh(e.instanceInputs,e).elementValue;y5(t,e)&&(e.setAttribute("disabled","true"),Qn(e))})}const R=re()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ne()},styles:p`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Qn(e)}),e.addEventListener("keydown",()=>{Qn(e)}),e.addEventListener("keyup",()=>{Qn(e)})},renderCallback({inputs:e,host:t,events:n,dispatch:r,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:f,elementLimits:h,rangeWidth:m}=sh({...e},t);if(Qn(t),yr(f))return g(a,f,h);return k(a,f,h);function g(x,C,S){const N={left:Ut((m-Ht)*(C.min-S.min)/(S.max-S.min)+Ht/2),right:Ut((m-Ht)*(S.max-C.max)/(S.max-S.min)+Ht/2)},W=Zi(x.min,c,l),ee=Zi(x.max,c,l);requestAnimationFrame(()=>{const ve=m5(t);ve!==o.labelOverlap&&i({labelOverlap:ve})});const ie=(S.max-C.max)/(S.max-S.min)>.5,ce=zi({value:C.min,limits:{min:S.min,max:C.max},flip:!0}),H=zi({value:C.max,limits:{min:C.min,max:S.max},flip:!1}),ae=o.labelOverlap&&ie?o.labelOverlap:0,$e=o.labelOverlap&&!ie?o.labelOverlap:0;return u`
                <div
                    class="range"
                ...
                >
                    ...
                    <div class="slider-wrapper">
                        <input
                            ...
                            .max=${S.max}
                            .value=${C.min}
                            ${y("input",ve=>{const lt=ve.target,Pn={...x,min:Gi(Number(lt.value),s,l)};w(Pn)})}
                        />
                        <input
                            ?disabled=${e.disabled??!1}
                            type="range"
                            ...
                            .value=${C.max}
                            ${un(Hn.slider)}
                            ${y("input",ve=>{const lt=ve.target,Pn={...x,max:Gi(Number(lt.value),s,l)};w(Pn)})}
                        />
                    </div>
                </div>
            `}function w(x){i({internalValue:x}),e.disabled||r(new n.valueChange(x))}function k(x,C,S){const N=Ut((m-Ht)*(S.max-C)/(S.max-S.min)+Ht/2),W=Zi(x,c,l),ee=zi({value:C,limits:S,flip:!1});return u`
                <div
                ...
                >
                    ...
                    <input
                        ...
                        .value=${C}
                        ${un(Hn.slider)}
                        ${y("input",ie=>{const ce=ie.target,H=Gi(Number(ce.value),s,l);w(H)})}
                    />
                </div>
            `}}});var lh=(e=>(e.Default="default",e.TextOnly="text-only",e))(lh||{});const Yi=re()({tagName:"toniq-toggle-button",hostClasses:{"toniq-toggle-button-text-only":({inputs:e})=>e.variant==="text-only","toniq-toggle-button-disabled":({inputs:e})=>!!e.disabled},styles:({hostClasses:e})=>p`
        :host {
            ${D.boldParagraphFont};
            ${Ze};
            display: inline-flex;
    ...
    `,renderCallback(){return u`
            <slot></slot>
        `}}),uo=re()({tagName:"toniq-with-tooltip",hostClasses:{"toniq-with-tooltip-force-tooltip":({inputs:e,state:t})=>!!e.forceShow||t.clickToggled},styles:({hostClasses:e})=>p`
        :host {
            display: inline-block;
            position: relative;
        }
    ...
    `,stateInitStatic:{clickToggled:!1},renderCallback({inputs:e,state:t,updateState:n}){return u`
        ...
        `}}),Kn=re()({tagName:"toniq-top-tabs",events:{routeChange:ne(),valueChange:ne()},cssVars:{"toniq-top-tabs-selected-border-width":"4px","toniq-top-tabs-tab-vertical-padding":"8px"},styles:({cssVars:e})=>p`
        :host {
            display: block;
        }
    ...
    `,renderCallback({inputs:e,dispatch:t,events:n}){const r=e.tabs.map(o=>{var l;const i=o.value===e.value,a=o.icon?u`
        ...
        `}}),ch=V({title:"Data",parent:void 0}),Oo=re()({tagName:"toniq-icon-book-viewer",styles:p`
        :host {
            display: inline-flex;
            padding: 8px;
            border-radius: 8px;
    ...
    `,renderCallback({inputs:e}){return u`
            <${$.assign({icon:e.icon})}></${$}>
        `}}),ti=Object.values(xt).reduce((e,t)=>(t.forEach(n=>{if(n.name in e)throw new Error(`Icon name duplicate: '${n.name}'`);e[n.name]=n}),e),{}),x5=Object.keys(ti).sort();function ks(e){return{controlType:j.Dropdown,initValue:e,options:["None",...x5]}}const uh={"CSS color":{controlType:j.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:j.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:j.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:j.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:j.Number,initValue:2}};function ho(e){return Object.entries(e).filter(([,n])=>n!==""&&n!=null).map(([n,r])=>(n.toLowerCase()==="css color"&&(n="color"),_(r,"number")&&(r=Oa({value:r,suffix:"px"})),`${n}: ${r};`)).join(`
`)}const A5=V({title:"Social Urls",parent:ch,elementExamplesCallback({defineExample:e}){function t({socialName:n,icon:r}){e({title:n,renderCallback(){return u`
                        <${Oo.assign({icon:r})}></${Oo}>
                    `}})}Object.entries(_d).forEach(([n,r])=>{t({socialName:n,icon:r})})}}),oe=V({title:"Elements",parent:void 0}),$5=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:p`
            ${Gt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],C5=V({title:Gt.tagName,parent:oe,elementExamplesCallback({defineExample:e}){$5.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:p`
                    .bold {
                        ${D.boldFont}
                    }
...
`,T5=V({parent:oe,title:Ie.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:Nc,renderCallback(){return u`
                ...
                `}}),e({title:"banner style",styles:Nc,renderCallback(){const t=p`
                    ...
                    border-radius: 12px;
                `;return u`
                    <${Ie.assign({enableAutomaticCycling:!0,variant:ka.Banner,templates:xt["core-24"].map(n=>u`
                                <div style=${t}>
                                    <${$.assign({icon:n})}></${$}>
                                </div>
                            `)})}></${Ie}>
                    <${Ie.assign({enableAutomaticCycling:!0,variant:ka.Banner,templates:[xt["core-24"][0]].map(n=>u`
                                <div style=${t}>
                                    <${$.assign({icon:n})}></${$}>
                                </div>
                            `)})}
                    ...
                    ></${Ie}>
                `}})}});function M5(e){const t=Object.keys(e.cssVars).map(n=>[`--${n}`,{controlType:j.Color,initValue:""}]);return Object.fromEntries(t)}function E5(e){const t=Object.entries(e).map(([n,r])=>{if(n.startsWith("--"))return typeof r!="string"||!r?void 0:`${n}: ${r};`}).filter(we);return T(t.join(`
`))}const I5=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],Qi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],B5=V({parent:oe,title:vt.tagName,controls:{Text:{controlType:j.Text,initValue:"Text"},...M5(vt)},elementExamplesCallback({defineExample:e}){I5.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:Qi.map(n=>!!n.inputs.checked),extraEntryStatuses:Qi.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:p`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Qi.map((i,a)=>{const s=(i.extraEntries??[]).map((c,f)=>{var h;return u`
                                    <${vt.assign({...t.inputs,...sr(i.inputs,["checked"]),checked:!!((h=n.extraEntryStatuses[a])!=null&&h[f]),text:c})}
                                        ${y(vt.events.checkedChange,()=>{const m=[...n.extraEntryStatuses];m[a][f]=!m[a][f],r({extraEntryStatuses:m})})}
                                    ></${vt}>
                                `}),l=E5(o);return u`
                            <div class="checkbox-group" style=${l}>
                                <${vt.assign({...t.inputs,...sr(i.inputs,["checked"]),checked:n.checkedStatuses[a],text:o.Text})}
                                    ${y(vt.events.checkedChange,()=>{const c=[...n.checkedStatuses];c[a]=!c[a],r({checkedStatuses:c})})}
                                ></${vt}>
                                ${s}
                            </div>
                        `})}})})}}),L5=V({parent:oe,title:Mi.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Mt}},{inputs:{icon:Mt}},{inputs:{},template:u`
                    HTML child
                `},{inputs:{icon:Mt},template:u`
                    HTML child
                `},{customStyle:p`
                    width: 150px;
                    height: 24px;
        ...
        `},{customStyle:p`
            max-height: 30px;
            min-height: 30px;
        `}],O5=V({title:Kr.tagName,parent:oe,controls:{Selected:{controlType:j.Dropdown,initValue:Xr[0].label,options:Xr.map(e=>e.label)},Direction:{controlType:j.Dropdown,initValue:"Down",options:Xc(Ea)},Icon:ks(Bd.name),Prefix:{controlType:j.Text,initValue:"Sort by: "},"Force open":{controlType:j.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){P5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Rc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:p`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Rc.map((i,a)=>{const s=p`
                        ...
                        `;return u`
                            ...
                            ></${Kr}>
                        `})}})})}}),D5=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],N5=V({title:Fi.tagName,parent:oe,elementExamplesCallback({defineExample:e}){D5.forEach(t=>{e({title:t.title,renderCallback(){return u`
                        <${Fi}>${t.content}</${Fi}>
                    `}})})}}),Fc="/toniq-labs-design-system";function dh(...e){const n=[globalThis.location.pathname.startsWith(Fc)?Fc:"",...e].filter(we);return lr(...n)}const ln=Array(30).fill(dh("/toniq-labs-logo.png")),pn=["Hello there.","There is stuff here."],_r=pn.concat(Array(30).fill(pn)),R5=V({title:te.tagName,parent:oe,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${te.assign({infoParagraphs:_r,imageUrls:ln,socialUrls:kg,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${te}>
                ...
                `}}),e({title:"hyperlink view button",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${te.assign({imageUrls:[],cardTitle:"Featured Stuff",infoParagraphs:_r,viewMoreUrl:"https://toniqlabs.com"})}
                ...
                `}}),e({title:"min height",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${te.assign({imageUrls:[],cardTitle:"Featured Stuff",infoParagraphs:_r})}></${te}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${te.assign({imageUrls:ln,infoParagraphs:pn,cardTitle:"With custom Template",customTemplateCallback(t){return u`
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${te.assign({imageUrls:ln.map((t,n)=>n%2?"/invalid-image.png":t),infoParagraphs:pn,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return u`
                            ...
                            `}})}></${te}>
                `}})}}),F5=V({title:Zt.tagName,parent:oe,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:p`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:n}){return u`
                ...
                `}})}}),j5=V({title:Ee.tagName,parent:oe,elementExamplesCallback({defineExample:e}){_c(dn).forEach(t=>{e({title:t,renderCallback(){return u`
            ...
            `,renderCallback({controls:n}){return t.map(r=>u`
                ...
                `;return xt["third-party-brands"].map(o=>u`
                        <${$.assign({icon:o})}
                            style=${ho(n)}
                        ></${$}>
                        <${$.assign({icon:o})}
            ...
            `,renderCallback({controls:n}){return u`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            ...
                            ></${Jr}>
                        `))}})})}});function ni({entries:e,columns:t,createRowObject:n}){const r=Object.fromEntries(t.map(i=>[i.key,""]));return{rows:e.map((i,a)=>{const s=n(i,a);if(!it(Object.keys(r).sort(),Object.keys(s.cells).sort()))throw console.error("broken list table row",{cells:s.cells,columns:r}),new Error("List table row keys does not match expect column keys.");return s}),columns:t}}const hh="https://cdn-bitcoin.bioniq.io",W5=lr(hh,"content"),z5=lr(hh,"thumbnail"),mn={thumbnail(e){return lr(z5,e)},content(e){return lr(W5,e)}},Z5=Array(5).fill({imageUrl:mn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:u`
        <div
            style=${p`
                display: flex;
                gap: 8px;
    ...
    `}),G5=[{imageUrl:mn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Payment Sent",price:u`
            <div
                style=${p`
                    display: flex;
                    gap: 8px;
        ...
        `},{imageUrl:mn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Transfer",price:u`
            -
        `,from:u`
            <${O.assign({text:"QP6Wqf97r0ydgw9yxfmptu4krqjgy49kx7m5g3K14U",copyOnClick:!0})}
                style=${p`
        ...
        `},{imageUrl:mn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Accept Offer",price:u`
            -
        `,from:u`
            <${O.assign({text:"QP6Wqf97r0ydgw9yxfmptu4krqjgy49kx7m5g3K14U",copyOnClick:!0})}
                style=${p`
        ...
        `},{imageUrl:mn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Cancel Listing",price:u`
            -
        `,from:u`
            <${O.assign({text:"QP6Wqf97r0ydgw9yxfmptu4krqjgy49kx7m5g3K14U",copyOnClick:!0})}
                style=${p`
        ...
        `}],Y5=[],Q5=Array(5).fill({imageUrl:mn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:u`
        <div
            style=${p`
                display: flex;
                gap: 8px;
    ...
    `}),Ki=ni({entries:Z5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE",mobile:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:u`
                    <img
                        style=${p`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),jc=ni({entries:G5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:u`
                    <img
                        style=${p`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),K5=ni({entries:Y5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:u`
                    <img
                        style=${p`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),J5=ni({entries:Q5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME",style:p`
                display: flex;
                justify-content: flex-end;
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Hc=us({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const n=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(n)}})}},cleanupCallback({state:e,updateState:t}){var n;(n=e.cleanup)==null||n.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),_5=V({title:Ne.tagName,parent:oe,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return u`
            ...
            `,stateInitStatic:{tableInputs:{...Ki,rows:Ki.rows.map(t=>({...t,cells:{...t.cells,date:u`
                ...
                `}})}}),ev=V({title:rr.tagName,parent:oe,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:nr.Small}},{title:"large",inputs:{size:nr.Large}},{title:"whole page",inputs:{size:nr.WholePage},styles:p`
                    :host {
                        width: 500px;
                    }
                `}].forEach(n=>{e({title:n.title,styles:n.styles??p``,renderCallback(){return u`
                        <${rr.assign(n.inputs)}></${rr}>
                    `}})})}}),tv=V({title:O.tagName,parent:oe,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
            ...
            `,renderCallback(){return u`
                ...
                `}})}}),nv=V({title:jn.tagName,parent:oe,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:p`
                ${jn} {
                    height: 32px;
                }
...
`,Ji={min:10,max:50},ov=V({title:R.tagName,parent:oe,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:p`
                ${rt}
            `,renderCallback({state:t,updateState:n}){return u`
            ...
            `,renderCallback({state:t,updateState:n}){return u`
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Uc.map((i,a)=>u`
                            ...
                            ></${Yi}>
                        `)}})})}}),sv=V({parent:oe,title:uo.tagName,elementExamplesCallback({defineExample:e}){function t({title:n,tooltipContent:r,forceShow:o}){e({title:n,styles:p`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),lv=V({parent:oe,title:ir.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${uo.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return u`
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:p``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:p``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:ba},{label:"label here",value:2,icon:ba},{label:"",value:3,icon:Mt,disabled:!0},{label:"16px icon",value:4,icon:Mt},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],dv=V({title:Kn.tagName,parent:oe,elementExamplesCallback({defineExample:e}){uv.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:p`
                ...
                `,renderCallback({state:n,updateState:r}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return u`
                        ...
                        ></${Kn}>
                    `}})})}}),fh=V({title:"Icons",parent:void 0,controls:uh}),hv=Object.entries(xt).map(([e,t])=>V({title:e,parent:fh,elementExamplesCallback({defineExample:n}){t.map(r=>n({title:r.name,renderCallback({controls:o}){return u`
                                <${Oo.assign({icon:r})}
                                    style=${ho(o)}
                                ></${Oo}>
                            `}}))}}));function ph(e){const t=fv(e),n=ke(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return le(n).reduce((o,i)=>{const a=n[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function fv(e){typeof e!="string"&&(e=String(e));const r=`{"${Zc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(r);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${r}`),o}}const ri=V({title:"Styles",parent:void 0}),pv=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function mv(e,t,n){const r=ph(F(n));return e({title:t,styles:pv,renderCallback(){return u`
            ...
            `}})}const gv=V({title:"Colors",parent:ri,elementExamplesCallback({defineExample:e}){le(b).map(t=>mv(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),wv=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function vv(e,t,n){const r=ph(n);return e({title:t,styles:wv,renderCallback(){return u`
            ...
            `}})}const bv=V({title:"Fonts",parent:ri,elementExamplesCallback({defineExample:e}){le(D).map(t=>{const n=D[t];return vv(e,t,n)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),yv=V({title:"Shadows",parent:ri,elementExamplesCallback({defineExample:e}){Ah(vr).forEach(([t,n])=>{e({title:t,styles:p`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return u`
                            <div></div>
                        `}})})}}),kv=[oe,fh,ri,ch],xv=[...hv,...cv,A5,C5,S5,T5,B5,L5,gv,q5,O5,N5,R5,F5,bv,j5,H5,U5,V5,ev,tv,nv,rv,yv,ov,av,dv,_5].sort((e,t)=>e.title.localeCompare(t.title)),Av=[...kv,...xv];Vo({tagName:"toniq-design-system-app",styles:p`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return u`
            <${$i.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:Av,themeColor:"#00D093"})}>
