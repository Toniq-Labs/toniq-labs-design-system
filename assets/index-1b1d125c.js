 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Rf}=Df,Ff=e=>e.strings===void 0,Xs=()=>document.createComment(""),Un=(e,t,n)=>{var i;const r=e._$AA.parentNode,o=t===void 0?e._$AB:t._$AA;if(n===void 0){const a=r.insertBefore(Xs(),o),s=r.insertBefore(Xs(),o);n=new Rf(a,s,e,e.options)}else{const a=n._$AB.nextSibling,s=n._$AM,l=s!==e;if(l){let u;(i=n._$AQ)==null||i.call(n,e),n._$AM=e,n._$AP!==void 0&&(u=e._$AU)!==s._$AU&&n._$AP(u)}if(a!==o||l){let u=n._$AA;for(;u!==a;){const p=u.nextSibling;r.insertBefore(u,o),u=p}}}return n},Ht=(e,t,n=e)=>(e._$AI(t,n),e),jf={},Hf=(e,t=jf)=>e._$AH=t,Uf=e=>e._$AH,yi=e=>{var r;(r=e._$AP)==null||r.call(e,!1,!0);let t=e._$AA;const n=e._$AB.nextSibling;for(;t!==n;){const o=t.nextSibling;t.remove(),t=o}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const or=(e,t)=>{var r;const n=e._$AN;if(n===void 0)return!1;for(const o of n)(r=o._$AO)==null||r.call(o,t,!1),or(o,t);return!0},So=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while((n==null?void 0:n.size)===0)},Su=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),zf(t)}};function Wf(e){this._$AN!==void 0?(So(this),this._$AM=e,Su(this)):this._$AM=e}function Vf(e,t=!1,n=0){const r=this._$AH,o=this._$AN;if(o!==void 0&&o.size!==0)if(t)if(Array.isArray(r))for(let i=n;i<r.length;i++)or(r[i],!1),So(r[i]);else r!=null&&(or(r,!1),So(r));else or(this,e)}const zf=e=>{e.type==Ln.CHILD&&(e._$AP??(e._$AP=Vf),e._$AQ??(e._$AQ=Wf))};class Zf extends ut{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,n,r){super._$AT(t,n,r),Su(this),this.isConnected=t._$AU}_$AO(t,n=!0){var r,o;t!==this.isConnected&&(this.isConnected=t,t?(r=this.reconnected)==null||r.call(this):(o=this.disconnected)==null||o.call(this)),n&&(or(this,t),So(this))}setValue(t){if(Ff(this._$Ct))this._$Ct._$AI(t,this);else{const n=[...this._$Ct._$AH];n[this._$Ci]=t,this._$Ct._$AI(n,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Gf={attribute:!0,type:String,converter:Ao,reflect:!1,hasChanged:Qa},Yf=(e=Gf,t,n)=>{const{kind:r,metadata:o}=n;let i=globalThis.litPropertyMetadata.get(o);if(i===void 0&&globalThis.litPropertyMetadata.set(o,i=new Map),i.set(n.name,e),r==="accessor"){const{name:a}=n;return{set(s){const l=t.get.call(this);t.set.call(this,s),this.requestUpdate(a,l,e)},init(s){return s!==void 0&&this.P(a,void 0,e),s}}}if(r==="setter"){const{name:a}=n;return function(s){const l=this[a];t.call(this,s),this.requestUpdate(a,l,e)}}throw Error("Unsupported decorator location: "+r)};function Qf(e){return(t,n)=>typeof n=="object"?Yf(e,t,n):((r,o,i)=>{const a=o.hasOwnProperty(i);return o.constructor.createProperty(i,a?{...r,wrapped:!0}:r),a?Object.getOwnPropertyDescriptor(o,i):void 0})(e,t,n)}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const pe=bt(class extends ut{constructor(e){var t;if(super(e),e.type!==Ln.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var r,o;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!((r=this.nt)!=null&&r.has(i))&&this.st.add(i);return this.render(t)}const n=e.element.classList;for(const i of this.st)i in t||(n.remove(i),this.st.delete(i));for(const i in t){const a=!!t[i];a===this.st.has(i)||(o=this.nt)!=null&&o.has(i)||(a?(n.add(i),this.st.add(i)):(n.remove(i),this.st.delete(i)))}return Oe}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const To=e=>e??J;/**
...
`,Bd=v({name:"LoaderAnimated24Icon",svgTemplate:c`
    ...
    `,renderCallback({inputs:e}){const t=e.flattenedNodes.map(n=>{if(!Xm(n,e.selectedPath))return;const r=h`
        ...
        `}});async function _m(e){await da(2);const t=e.shadowRoot.querySelector(".selected");if(!t)throw new Error("Failed to find selected nav tree element.");await $f(t)||t.scrollIntoView({behavior:"smooth",block:"center"})}const Nt=Ge()({tagName:"book-error",styles:h`
        :host {
            display: flex;
            flex-direction: column;
            color: red;
    ...
    `,events:{loadingRender:ie()},stateInitStatic:{lastElement:void 0},renderCallback:({inputs:e,dispatch:t,events:n,state:r,updateState:o})=>{const i=va(e.currentRoute.paths),a=tg({currentNodes:e.currentNodes,isTopLevel:!0,router:e.router,isSearching:!!i,controls:e.controls,originalTree:e.originalTree});return c`
            ...
            ${me(e.showLoading,c`
                ...
                `,c`
                    ...
                    <slot name=${lt.Footer}></slot>
                `)}
        `}});function ng(e,t,n){const r=Jl(e,t);if(r.length)return r;n(Mn);const o=Jl(e,Mn.paths);if(!o)throw new Error(`Tried to self-correct for invalid path ${t.join("/")}
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{Xl(e,va(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:n,updateState:r,dispatch:o,events:i})=>{var p,f,m,g,b,x,$;t._debug&&console.info("rendering element-book app");function a(A){return{...e.currentRoute,...A}}function s(A){const S=a(A);return!st(e.currentRoute,S)}function l(A){t.preventWindowTitleChange||(e.originalWindowTitle||r({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,A].filter(ke).join(" - "))}function u(A){if(!s(A))return;const S=a(A);e.router?e.router.setRoutes(S):r({currentRoute:{...e.currentRoute,...S}}),t.elementBookRoutePaths&&!st(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(S.paths??[]))}try{if(t.elementBookRoutePaths&&!st(t.elementBookRoutePaths,e.currentRoute.paths)&&u({paths:t.elementBookRoutePaths}),(p=t.internalRouterConfig)!=null&&p.useInternalRouter&&!e.router){const V=lp(t.internalRouterConfig.basePath);r({router:V}),V.addRouteListener(!0,he=>{r({currentRoute:he})})}else!((f=t.internalRouterConfig)!=null&&f.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const A={themeColor:t.themeColor};if(!st(A,(m=e.colors)==null?void 0:m.config)){const V=Wl(A);r({colors:{config:A,theme:V}}),dp(n,V)}const S=t._debug??!1,D=z1({entries:t.entries,debug:S});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),r({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:Yu(D.tree,{children:(b=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:b.children,controls:t.globalValues})}}));const R=va(e.currentRoute.paths),ne=(R?X1({flattenedNodes:D.flattenedNodes,searchQuery:R}):void 0)??ng(D.flattenedNodes,e.currentRoute.paths,u);l((x=ne[0])==null?void 0:x.entry.title);const se=($=e.treeBasedControls)==null?void 0:$.controls;return se?(t._debug&&console.info({currentControls:se}),c`
                ...
                >
                    ...
                    <${ln.assign({controls:se,currentNodes:ne,currentRoute:e.currentRoute,debug:S,originalTree:D.tree,router:e.router,showLoading:e.loading})}
                        ${k(ln.events.loadingRender,async V=>{await da();const he=n.shadowRoot.querySelector(ln.tagName);he?he.scroll({top:0,behavior:"instant"}):console.error(`Failed to find '${ln.tagName}' for scrolling.`),await da(),r({loading:!V.detail})})}
                    >
                        <slot
                            name=${lt.Footer}
                            slot=${lt.Footer}
...
`))}const B=(()=>{const e=h`
    ...
    `}),Bt=v({name:"InfoCircle16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
...
`,B2=v({name:"CryptoIcp16Icon",svgTemplate:c`
    ...
    `,renderCallback({inputs:e}){return e.text?c`
        ...
        `:""}}),Ia=h`8px`;var Mt=(e=>(e.Default="default",e.Outline="outline",e.Secondary="secondary",e.TextOnly="text-only",e))(Mt||{}),u0=(e=>(e.Left="left",e.Right="right",e))(u0||{}),d0=(e=>(e.Pulse="pulse",e))(d0||{});const fe=ae()({tagName:"toniq-button",hostClasses:{"toniq-button-secondary":({inputs:e})=>e.variant==="secondary","toniq-button-outline":({inputs:e})=>e.variant==="outline","toniq-button-text-only":({inputs:e})=>e.variant==="text-only","toniq-button-disabled":({inputs:e})=>!!e.disabled,"toniq-button-effect-pulse":({inputs:e})=>e.effect==="pulse"},styles:({hostClasses:e})=>h`
        :host {
            ${B.boldParagraphFont};
            display: inline-flex;
            position: relative;
    ...
    `,renderCallback({inputs:e,dispatch:t,events:n}){const r=me(e.variant!=="button",c`
            ...
            `,c`
                <${fe.assign({text:e.text,variant:e.checked?Mt.Default:Mt.Outline})}></${fe}>
            `);return c`
            <button
                ?disabled=${e.disabled}
    ...
    `,events:{viewMoreButtonClick:ie(),flipCardButtonClick:ie()},renderCallback({inputs:e,dispatch:t,events:n}){const r=e.socialUrls,o=r?ce(r).map(i=>{const a=r[i];if(!a)return;const s=c0[i];return c`
            ...
            <div class="buttons">
                ...
                >
                    <${fe.assign({text:e.viewMoreButtonText,variant:Mt.Outline})}></${fe}>
                </${Je}>
    ...
    `,renderCallback({inputs:e,state:t,updateState:n,host:r,dispatch:o,events:i}){var m,g,b,x;const a=e.mainImageSize||Fa,s=wh(a);Mo({onElement:r,forCssVar:it["main-image-size"],toValue:`${a}px`}),Mo({onElement:r,forCssVar:it["secondary-image-size"],toValue:`${s}px`});const l=["View",e.viewButtonTitle].filter(ke).join(" "),u=c`
            <h3>${e.cardTitle}</h3>
    ...
    `,renderCallback({inputs:e}){return e.level==="h1"?c`
            ...
            `:c`
                <slot></slot>
            `}});function ja({input:e,matcher:t}){return!e||!t?!0:e.length>1?!!e.split("").every(n=>ja({input:n,matcher:t})):t instanceof RegExp?!!e.match(t):t.includes(e)}function vh({value:e,allowed:t,blocked:n}){const r=t?ja({input:e,matcher:t}):!0,o=n?ja({input:e,matcher:n}):!1;return r&&!o}function Hc(e){if(!e.value)return{filtered:e.value,blocked:""};const{filtered:t,blocked:n}=e.value.split("").reduce((r,o)=>(vh({...e,value:o})?r.filtered.push(o):r.blocked.push(o),r),{filtered:[],blocked:[]});return{filtered:t.join(""),blocked:n.join("")}}var Ha=(e=>(e.Default="default",e.Outline="outline",e))(Ha||{});const oo=ae()({tagName:"toniq-input",hostClasses:{"toniq-input-outline":({inputs:e})=>e.variant==="outline","toniq-input-has-a-value":({inputs:e})=>!!e.value,"toniq-input-disabled":({inputs:e})=>!!e.disabled},events:{valueChange:ie(),inputBlock:ie()},styles:({hostClasses:e})=>h`
            :host {
                position: relative;
                display: inline-flex;
                width: 224px;
    ...
    `,renderCallback:({inputs:e})=>c`
        ...
        `}),Uc="...";function Rv(e,t,n=7,r=5){let o;e=kn({value:e,min:1,max:t}),n=kn({value:n,min:r,max:t});const i=n-5,a=n-3;t<=n?o=n:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>n?Qi(t-o,t):e>o?Qi(Math.min(s.start,t-o),Math.min(s.end,t)):Qi(1,Math.min(t,o+1));function u(f,m){return l.length+1!==t?m:[f]}const p=l[l.length-1];if(p&&p<t){const f=u(t,[Uc,t]);return[...l,...f]}else return l[0]!==1?u(1,[1,Uc]).concat(l):l}function Qi(e,t){const n=t-e+1;return Array.from({length:n},(r,o)=>e+o)}const Ki=ae()({tagName:"toniq-pagination",styles:h`
        :host {
            display: flex;
        }
    ...
    `,stateInitStatic:{canScroll:!1,debouncedResize:L1(()=>Jh(fr.FirstThenWait,{milliseconds:30})),rowStyles:{},isPainting:!1,isStillPainting:!0,pageCountKey:0,tableListLeft:0},initCallback({inputs:e,state:t,updateState:n}){const r=e.columns.filter(o=>!o.disabled);n({rowStyles:r.reduce((o,i)=>(o[i.key]={width:void 0,left:void 0},o),t.rowStyles)})},renderCallback({inputs:e,state:t,updateState:n,events:r,dispatch:o,host:i}){var m;const a=e.columns.filter(g=>!g.disabled),s=[e.rows[0],...e.rows].filter(ke);function l(g){g instanceof HTMLElement&&setTimeout(()=>{t.debouncedResize(()=>{n({canScroll:g.scrollWidth>g.clientWidth,tableListLeft:g.getBoundingClientRect().left})})},0)}const u=e.pagination&&((m=e.pagination)==null?void 0:m.pageCount)>1?c`
                      <${Ki.assign({currentPage:e.pagination.currentPage,pageCount:e.pagination.pageCount})}
...
`,Zc=h`
    transform: scale(1.2);
`;function t5(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function _n(e){requestAnimationFrame(()=>{const t=bh(e.instanceInputs,e).elementValue;e5(t,e)&&(e.setAttribute("disabled","true"),_n(e))})}const j=ae()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ie()},styles:h`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{_n(e)}),e.addEventListener("keydown",()=>{_n(e)}),e.addEventListener("keyup",()=>{_n(e)})},renderCallback({inputs:e,host:t,events:n,dispatch:r,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:u,elementValue:p,elementLimits:f,rangeWidth:m}=bh({...e},t);if(_n(t),Tr(p))return g(a,p,f);return x(a,p,f);function g($,A,S){const D={left:zt((m-Vt)*(A.min-S.min)/(S.max-S.min)+Vt/2),right:zt((m-Vt)*(S.max-A.max)/(S.max-S.min)+Vt/2)},R=ta($.min,u,l),G=ta($.max,u,l);requestAnimationFrame(()=>{const Ce=Qv(t);Ce!==o.labelOverlap&&i({labelOverlap:Ce})});const ne=(S.max-A.max)/(S.max-S.min)>.5,se=ea({value:A.min,limits:{min:S.min,max:A.max},flip:!0}),V=ea({value:A.max,limits:{min:A.min,max:S.max},flip:!1}),he=o.labelOverlap&&ne?o.labelOverlap:0,Ye=o.labelOverlap&&!ne?o.labelOverlap:0;return c`
                <div
                    class="range"
            ...
            `}}});var yh=(e=>(e.Default="default",e.TextOnly="text-only",e))(yh||{}),kh=(e=>(e.Left="left",e.Right="right",e))(kh||{});const ra=ae()({tagName:"toniq-toggle-button",hostClasses:{"toniq-toggle-button-text-only":({inputs:e})=>e.variant==="text-only","toniq-toggle-button-disabled":({inputs:e})=>!!e.disabled},styles:({hostClasses:e})=>h`
        :host {
            ${B.boldParagraphFont};
            ${Ze};
            display: inline-flex;
    ...
    `,renderCallback({inputs:e,dispatch:t,events:n}){const r=e.tabs.map(o=>{var l;const i=o.value===e.value,a=o.icon?c`
        ...
        `}}),$h=U({title:"Data",parent:void 0}),zo=ae()({tagName:"toniq-icon-book-viewer",styles:h`
        :host {
            display: inline-flex;
            padding: 8px;
            border-radius: 8px;
    ...
    `,renderCallback({inputs:e}){return c`
            <${y.assign({icon:e.icon})}></${y}>
        `}}),ui=Object.values(at).reduce((e,t)=>(t.forEach(n=>{if(n.name in e)throw new Error(`Icon name duplicate: '${n.name}'`);e[n.name]=n}),e),{}),n5=Object.keys(ui).sort();function Bs(e){return{controlType:H.Dropdown,initValue:e,options:["None",...n5]}}const Ah={"CSS color":{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Number,initValue:2}};function yo(e){return Object.entries(e).filter(([,n])=>n!==""&&n!=null).map(([n,r])=>(n.toLowerCase()==="css color"&&(n="color"),ee(r,"number")&&(r=Va({value:r,suffix:"px"})),`${n}: ${r};`)).join(`
`)}const r5=U({title:"Social Urls",parent:$h,elementExamplesCallback({defineExample:e}){function t({socialName:n,icon:r}){e({title:n,renderCallback(){return c`
        ...
        `}],a5=U({title:Tt.tagName,parent:te,elementExamplesCallback({defineExample:e}){i5.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:h`
                    .bold {
                        ${B.boldFont}
                    }
...
`,l5=U({parent:te,title:ve.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:oa,renderCallback(){return c`
...
`))}const d5=[{title:"default",inputs:{}},{title:"button",inputs:{variant:f0.Button}},{title:"disabled",inputs:{disabled:!0}}],ia=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],h5=U({parent:te,title:kt.tagName,controls:{Text:{controlType:H.Text,initValue:"Text"},...c5(kt)},elementExamplesCallback({defineExample:e}){d5.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:ia.map(n=>!!n.inputs.checked),extraEntryStatuses:ia.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:h`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return ia.map((i,a)=>{const s=(i.extraEntries??[]).map((u,p)=>{var f;return c`
                        ...
                        `})}})})}}),f5=U({parent:te,title:Ni.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Bt}},{inputs:{icon:Bt}},{inputs:{},template:c`
                    HTML child
        ...
        `}],g5=U({title:ro.tagName,parent:te,controls:{Selected:{controlType:H.Dropdown,initValue:io[0].label,options:io.map(e=>e.label)},Direction:{controlType:H.Dropdown,initValue:"Down",options:su(Ra)},Icon:Bs(jd.name),Prefix:{controlType:H.Text,initValue:"Sort by: "},"Force open":{controlType:H.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){m5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Gc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:h`
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Gc.map((i,a)=>{const s=h`
                        ...
                        `;return c`
                            ...
                            ></${ro}>
                        `})}})})}}),w5=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],v5=U({title:Yi.tagName,parent:te,elementExamplesCallback({defineExample:e}){w5.forEach(t=>{e({title:t.title,renderCallback(){return c`
                        <${Yi}>${t.content}</${Yi}>
                    `}})})}}),Yc="/toniq-labs-design-system";function Ch(...e){const n=[globalThis.location.pathname.startsWith(Yc)?Yc:"",...e].filter(ke);return mr(...n)}const fn=Array(30).fill(Ch("/toniq-labs-logo.png")),yn=["Hello there.","There is stuff here."],ao=yn.concat(Array(30).fill(yn)),b5=U({title:re.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${re.assign({infoParagraphs:ao,imageUrls:fn,socialUrls:tw,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${re}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${re.assign({imageUrls:fn.map((t,n)=>n%2?"/invalid-image.png":t),infoParagraphs:yn,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return c`
                            ...
                            `}})}></${re}>
                `}})}}),y5=U({title:Qt.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:h`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:n}){return c`
                ...
                `}})}}),k5=U({title:qe.tagName,parent:te,elementExamplesCallback({defineExample:e}){lu(vn).forEach(t=>{e({title:t,renderCallback(){return c`
            ...
            `,renderCallback(){return c`
                ...
                `}})}}),x5=U({parent:te,title:Je.tagName,elementExamplesCallback({defineExample:e}){[{title:"default",inputs:{linkType:wt.ReplacePage}},{title:"new tab",inputs:{linkType:wt.NewTab}},{title:"hover styles",inputs:{withHoverStyles:!0,linkType:wt.NewTab}},{title:"route link",inputs:{linkType:wt.RouteLink}},{title:"link disabled",inputs:{linkType:wt.Disabled}}].forEach(n=>{e({title:n.title,descriptionParagraphs:n.descriptions,renderCallback(){return c`
                    ...
                    `}})})}}),$5=U({title:y.tagName,parent:te,controls:Ah,elementExamplesCallback({defineExample:e}){const t=[{icon:Jd},{icon:Kd},{icon:Ud},{icon:Bt},{icon:void 0}];e({title:"sizes",styles:h`
                :host {
                    display: flex;
                    gap: 16px;
                    align-items: center;
            ...
            `,renderCallback({controls:n}){return c`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),c`
                            ...
                            ></${oo}>
                        `))}})})}}),Sh="https://cdn-bitcoin.bioniq.io",C5=mr(Sh,"content"),S5=mr(Sh,"thumbnail"),_e={thumbnail(e){return mr(S5,e)},content(e){return mr(C5,e)}},T5=[{imageUrl:_e.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
            <div
                style=${h`
                    display: flex;
                    gap: 8px;
    ...
    `}),aa=Fr({entries:T5,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"price",title:"PRICE",option:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${h`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),B5=Fr({entries:M5,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"price",title:"PRICE LONG COLUMN NAME",option:{sticky:!0,spaceEvenly:!0}},{key:"from",title:"FROM",option:{spaceEvenly:!0}},{key:"to",title:"TO",option:{spaceEvenly:!0},style:h`
                width: 100%;
                display: flex;
                justify-content: flex-end;
            `}],createRowObject:e=>({cells:{image:c`
                ...
                `},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),Qc=Fr({entries:E5,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"type",title:"TYPE",option:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),L5=Fr({entries:I5,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"type",title:"TYPE",option:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${h`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),P5=Fr({entries:q5,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME",style:h`
                display: flex;
                justify-content: flex-end;
            `}],createRowObject:e=>({cells:{image:c`
                    <img
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Kc=ks({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const n=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(n)}})}},cleanupCallback({state:e,updateState:t}){var n;(n=e.cleanup)==null||n.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),D5=U({title:xe.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return c`
            ...
            `,renderCallback(){return c`
                ...
                `}})}}),N5=U({title:ur.tagName,parent:te,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:cr.Small}},{title:"large",inputs:{size:cr.Large}},{title:"whole page",inputs:{size:cr.WholePage},styles:h`
                    :host {
                        width: 500px;
                    }
            ...
            `,renderCallback(){return c`
                ...
                `}})}}),F5=U({title:zn.tagName,parent:te,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:h`
                ${zn} {
                    height: 32px;
                }
...
`,sa={min:10,max:50},H5=U({title:j.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:h`
                ${ot}
            `,renderCallback({state:t,updateState:n}){return c`
            ...
            `,renderCallback({state:t,updateState:n}){return c`
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Jc.map((i,a)=>c`
                            ...
                            ></${ra}>
                        `)}})})}}),V5=U({parent:te,title:bo.tagName,elementExamplesCallback({defineExample:e}){function t({title:n,tooltipContent:r,forceShow:o}){e({title:n,styles:h`
                    div {
                        padding: 16px;
                        display: block;
...
`;function X5(e,t,n){const r=Mh(F(n));return e({title:t,styles:J5,renderCallback(){return c`
            ...
            `}})}const _5=U({title:"Colors",parent:di,elementExamplesCallback({defineExample:e}){ce(w).map(t=>X5(e,t,w[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),eb=h`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function tb(e,t,n){const r=Mh(n);return e({title:t,styles:eb,renderCallback(){return c`
            ...
            `}})}const nb=U({title:"Fonts",parent:di,elementExamplesCallback({defineExample:e}){ce(B).map(t=>{const n=B[t];return tb(e,t,n)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),rb=U({title:"Shadows",parent:di,elementExamplesCallback({defineExample:e}){Nh(Cr).forEach(([t,n])=>{e({title:t,styles:h`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return c`
                            <div></div>
                        `}})})}}),ob=[te,Th,di,$h],ib=[...Q5,...Z5,r5,a5,o5,s5,l5,h5,f5,_5,p5,g5,v5,b5,y5,nb,k5,x5,$5,A5,N5,R5,F5,j5,rb,H5,W5,Y5,D5].sort((e,t)=>e.title.localeCompare(t.title)),ab=[...ob,...ib];_o({tagName:"toniq-design-system-app",styles:h`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return c`
            <${Li.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:ab,themeColor:"#00D093"})}>
