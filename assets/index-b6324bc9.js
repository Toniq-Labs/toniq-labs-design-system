var mh=Object.defineProperty;var ph=(e,t,r)=>t in e?mh(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var qn=(e,t,r)=>(ph(e,typeof t!="symbol"?t+"":t,r),r);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function r(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=r(o);fetch(o.href,i)}})();const gh=[(e,t)=>t in e,(e,t)=>t in e.constructor.prototype];function Ce(e,t){return e?gh.some(r=>{try{return r(e,t)}catch{return!1}}):!1}function _c(e,t){return e&&t.every(r=>Ce(e,r))}function oe(e){let t;try{t=Reflect.ownKeys(e)}catch{}return t??[...Object.keys(e),...Object.getOwnPropertySymbols(e)]}function wh(e){return oe(e).map(t=>e[t])}function vh(e){return oe(e).map(t=>[t,e[t]])}function bh(e){return Object.fromEntries(e)}function yh(e,t){return e.includes(t)}function kh(e,t){return e.map(t)}function be(e){return!!e}function Hc(e,t){return e.match(t)??[]}function $h(e){return e.replace(/,/g,"")}function Fc(e,{keepNewLines:t}={}){return(t?e.replace(/[\s\n]*\n+[\s\n]*/g,`
`):e.replace(/\n/g," ")).trim().replace(/\s{2,}/g," ")}const xh={capitalizeFirstLetter:!1};function Th(e){return e.length?e[0].toUpperCase()+e.slice(1):""}function Sh(e,t){return t.capitalizeFirstLetter?Th(e):e}function Ch(e,t=xh){const r=e.toLowerCase();if(!r.length)return"";const n=r.replace(/^-+/,"").replace(/-{2,}/g,"-").replace(/-(?:.|$)/g,o=>{const i=o[1];return i?i.toUpperCase():""});return Sh(n,t)}var vr;(function(e){e.Upper="upper",e.Lower="lower"})(vr||(vr={}));function Mh(e){return e.toLowerCase()!==e.toUpperCase()}function $s(e,t,r){if(!e&&(r!=null&&r.blockNoCaseCharacters))return!1;for(let n=0;n<e.length;n++){const o=e[n]||"";if(!Mh(o)){if(r!=null&&r.blockNoCaseCharacters)return!1;continue}if(t===vr.Upper&&o!==o.toUpperCase())return!1;if(t===vr.Lower&&o!==o.toLowerCase())return!1}return!0}function uo(e){return e.split("").reduce((r,n,o,i)=>{const a=o>0&&i[o-1]||"",s=o<i.length-1&&i[o+1]||"",l=$s(a,vr.Lower,{blockNoCaseCharacters:!0})||$s(s,vr.Lower,{blockNoCaseCharacters:!0});return n===n.toLowerCase()||o===0||!l?r+=n:r+=`-${n.toLowerCase()}`,r},"").toLowerCase()}function br(e,t){return e.split(t)}const Ah=String(NaN);function Vc(e){if(typeof e=="string"&&isNaN(Number(e)))return Ah;const t=Number(e),r=t<0,n=String(Math.abs(t)),[o,i]=n.split("."),a=i?`.${i}`:"",l=Hc(o.split("").reverse().join(""),/.{1,3}/g).reverse().map(f=>f.split("").reverse().join("")).join(",");return[r?"-":"",l,a].join("")}function Eh(e){return typeof e=="number"?e:Number(typeof e=="string"?$h(e):e)}function Ih(e){return String(e).includes("e")}function Lh({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function Ui(e){const t=Math.pow(10,e.digits),r=e.number*t;return Number((Math.round(r)/t).toFixed(e.digits))}function fr({value:e,min:t,max:r}){return Math.min(Math.max(e,t),r)}var nn;(function(e){e.FirstThenWait="first-then-wait",e.AfterWait="after-wait"})(nn||(nn={}));function qh(e,t){let r=0,n;return o=>{n=o;const i=Date.now();r>i||(e===nn.FirstThenWait?n():e===nn.AfterWait&&setTimeout(()=>{n==null||n()},t.milliseconds),r=i+t.milliseconds)}}function jc(e){if(!e||e.length===0)return;const t=e[0];return e.length===1&&t?t:new Error(e.map(r=>qt(r).trim()).join(`
`))}function Ph(e){return e?e.map(qt).filter(be).join(`
`):""}function qt(e){return e?e instanceof Error?e.message:Ce(e,"message")?String(e.message):String(e):""}function zc(e){return e instanceof Error?e:new Error(qt(e))}function Nh(e,t){const r=zc(e);return r.message=`${t}: ${r.message}`,r}class Oh extends Error{constructor(){super(...arguments),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"AssertionError"})}}function ho(e){return Array.isArray(e)?"array":typeof e}function X(e,t){return ho(e)===t}function Bh(e,t){if(!(X(e,"string")||X(e,"number")||X(e,"symbol")))throw new Oh(t||`value is of type '${ho(e)}' but expected a PropertyKey.`)}function ti(e){try{return Bh(e),!0}catch{return!1}}function je(e){return!!e&&typeof e=="object"}function Zc(e,t,r=!1,n={}){const o=oe(e),i=new Set(oe(t));if(!r){const a=o.filter(s=>!i.has(s));if(a.length)throw new Error(`Test object has extra keys: ${a.join(", ")}`)}i.forEach(a=>{if(!Ce(e,a))throw new Error(`test object does not have key "${String(a)}" from expected shape.`);function s(f){throw new Error(`test object value at key "${String(a)}" did not match expected shape: ${f}`)}const l=e[a],c=t[a];n[a]||Wc(l,c,s,r,n[a]??{})})}function Wc(e,t,r,n,o){var s;const i=typeof e,a=typeof t;i!==a&&r(`type "${i}" did not match expected type "${a}"`);try{Ce(t,"constructor")&&(!Ce(e,"constructor")||e.constructor!==t.constructor)&&r(`constructor "${(s=e==null?void 0:e.constructor)==null?void 0:s.name}" did not match expected constructor "${t.constructor}"`)}catch(l){if(l instanceof r)throw l}Array.isArray(t)?(Array.isArray(e)||r("expected an array"),e.forEach((l,c)=>{if(t.map(h=>{try{Wc(l,h,r,n,o);return}catch(m){return new Error(`entry at index "${c}" did not match expected shape: ${qt(m)}`)}}).filter(be).length===t.length)throw new Error(`entry at index "${c}" did not match any of the possible types from "${t.join(", ")}"`)})):je(t)&&Zc(e,t,n,o)}function xs({source:e,whitespace:t,errorHandler:r}){try{return JSON.stringify(e,void 0,t)}catch(n){if(r)return r(n);throw n}}const Ts="Failed to compare objects using JSON.stringify";function Ss(e,t,r){return xs({source:e,errorHandler(n){if(r)return"";throw n}})===xs({source:t,errorHandler(n){if(r)return"";throw n}})}function ot(e,t,r={}){try{return e===t?!0:je(e)&&je(t)?Ss(Object.keys(e).sort(),Object.keys(t).sort(),!!(r!=null&&r.ignoreNonSerializableProperties))?Object.keys(e).every(o=>ot(e[o],t[o])):!1:Ss(e,t,!!(r!=null&&r.ignoreNonSerializableProperties))}catch(n){const o=zc(n);throw o.message.startsWith(Ts)||(o.message=`${Ts}: ${o.message}`),o}}function Uc(e){return oe(e).filter(t=>isNaN(Number(t)))}function Gc(e){return Uc(e).map(r=>e[r])}function Dh(e,t){return Gc(t).includes(e)}function Yc(e,t){return oe(e).filter(n=>{const o=e[n];return t(n,o,e)}).reduce((n,o)=>(n[o]=e[o],n),{})}function on(e,t){return Yc(e,r=>!t.includes(r))}function Rh(e,t){return Yc(e,r=>t.includes(r))}function _h(e,t,r){const n=t;if(e.has(n))return e.get(n);{const o=r();return e.set(n,o),o}}function ve(e,t){let r=!1;const n=oe(e).reduce((o,i)=>{const a=t(i,e[i],e);return a instanceof Promise&&(r=!0),{...o,[i]:a}},{});return r?new Promise(async(o,i)=>{try{await Promise.all(oe(n).map(async a=>{const s=await n[a];n[a]=s})),o(n)}catch(a){i(a)}}):n}function Gi(e,t){try{return Jc(e,t),!0}catch{return!1}}function Jc(e,t,r){if(e.length<t)throw new Error(r?`'${r}' is not at least '${t}' in length.`:`Array is not at least '${t}' in length.`)}function Ia(){let e,t,r=!1;const n=new Promise((o,i)=>{e=a=>(r=!0,o(a)),t=a=>{r=!0,i(a)}});if(!e||!t)throw new Error(`Reject and resolve callbacks were not set by the promise constructor for ${Ia.name}.`);return{promise:n,resolve:e,reject:t,isSettled(){return r}}}function Yi(e){const t=Ia();return e!==1/0&&setTimeout(()=>{t.resolve()},e<=0?0:e),t.promise}function Hh(){return globalThis.crypto?globalThis.crypto:require("crypto").webcrypto}const Kc=Hh();function Fh({min:e,max:t}){const{min:r,max:n}=Lh({min:Math.floor(e),max:Math.floor(t)}),o=n-r+1,i=Math.ceil(Math.log2(o)/8),a=Math.floor(256**i/o)*o,s=new Uint8Array(i);let l;do Kc.getRandomValues(s),l=s.reduce((c,f,h)=>c+f*256**h,0);while(l>=a);return r+l%o}function Xc(e=16){const t=Math.ceil(e/2),r=new Uint8Array(t);return Kc.getRandomValues(r),Array.from(r).map(n=>n.toString(16).padStart(2,"0")).join("").substring(0,e)}function Vh({value:e,prefix:t}){return e.startsWith(t)?e.substring(t.length):e}function jh(e){const t=Object.entries(e).map(([r,n])=>{if(n!=null)return`${r}=${String(n)}`}).filter(be);return t.length?`?${t.join("&")}`:""}function zh(e){return Vh({value:e,prefix:"?"}).split("&").map(n=>{const[o,...i]=br(n,"="),a=i.join("");if(!(!a&&!o))return[o,a]}).filter(be)}function Zh(e,t){const r=X(e,"string")?new URL(e):e,n=zh(r.search),o=Object.fromEntries(n);return t&&Zc(o,t),o}const Wh="%",Uh="px";function Ft(e){return La({value:e,suffix:Uh})}function ri(e){return La({value:e,suffix:Wh})}function La({value:e,suffix:t}){return String(e).endsWith(t)?String(e):`${String(e)}${t}`}const ni="://";function an(...e){const t=e.join("/"),[r,n=""]=t.includes(ni)?t.split(ni):["",t];let o=!1,i=!1;const a=n.replace(/\/{2,}/g,"/").split("/").map(s=>((s.includes("?")||o)&&(o=!0),s)).reduce((s,l,c,f)=>{if(i)return s;const h=f[c+1];let m=l;const g=!l.includes("?")&&(h==null?void 0:h.startsWith("?"));if(h!=null&&h.startsWith("?")||g){i=!0;let w=!1;const k=f.slice(g?c+2:c+1).reduce((y,x)=>(x.includes("#")&&(w=!0),w?y.concat(x):[y,x].join("&")),"");m=[l,h,k].join("")}return s.concat(m)},[]);return[r,r?ni:"",a.join("/")].join("")}const Gh=["k","M","B","T","P","E","Z","Y"];function qa({beforeDot:e,afterDot:t="",maxLength:r}){if(t.length){const n=r-e.length-1;if(n>0){const o=t.slice(0,n);return Number(o)?[e,o].join("."):e}}return e}function Yh(e,t,r){const[n,o]=br(e,"."),i=Vc(n),a=Hc(i,/,/g).length,s=t[a-1],[l,c]=br(i,","),f=[c,o].join("");return l.length+1>r?["0.",l[0],t[a]].join(""):[qa({beforeDot:l,afterDot:f,maxLength:r-1}),s].join("")}const Cs=3;function Jh({input:e,maxLength:t}){const r=String(e),[n,o]=br(r,"e"),i=o.replace(/^[\-\+]/,""),a=o[0],s=["e",a,i].join(""),[l,c]=br(n,"."),f=i.length+Cs;return f===t?[l,s].join(""):f>t?a==="-"?"0":String(1/0):[qa({afterDot:c,beforeDot:l,maxLength:t-i.length+Cs}),s].join("")}function Kh(e,t){const[r,n]=br(Vc(e),".");if(r.length<=t)return qa({beforeDot:r,afterDot:n,maxLength:t})}function Xh(e,{customSuffixes:t=Gh,maxLength:r=6}={}){const n=Eh(e);if(isNaN(n)||n===1/0)return String(n);if(Ih(n))return Jh({input:n,maxLength:r});const o=String(n),i=Kh(o,r);return i??Yh(o,t,r)}function Qh(e,t){return Ce(e,"entryType")&&e.entryType===t}var we;(function(e){e.ElementExample="element-example",e.Page="page",e.Root="root"})(we||(we={}));function er(e,t){return e.controlType===t}var D;(function(e){e.Checkbox="checkbox",e.Color="color",e.Dropdown="dropdown",e.Hidden="hidden",e.Number="number",e.Text="text"})(D||(D={}));const Qc=Symbol("any-type"),ef={[D.Checkbox]:!1,[D.Color]:"",[D.Dropdown]:"",[D.Hidden]:Qc,[D.Number]:0,[D.Text]:""};function tf(e,t){if(!e)return[];const r=[];return Object.entries(e).forEach(([n,o])=>{const i=ef[o.controlType];i!==Qc&&(typeof i!=typeof o.initValue&&r.push(new Error(`Control '${n}' in page '${t}' has invalid initValue '${o.initValue}': expected initValue of type ${typeof i} because the control is of type ${o.controlType}.`)),n||r.push(new Error(`'${t}' cannot have an empty control name.`)))}),r}function Pa(e,t){const r=fo(e.title);return e.parent?[...Pa(e.parent,!1),fo(e.parent.title)].concat(t?[r]:[]):t?[r]:[]}function fo(e){return Fc(e).toLowerCase().replaceAll(/\s/g,"-")}function rf({searchFor:e,searchIn:t}){return e.every((r,n)=>t[n]===r)}function H(e){const t={...e,entryType:we.Page,elementExamples:{},descriptionParagraphs:e.descriptionParagraphs??[],controls:e.controls??{},errors:[]},r=new Set;return e.elementExamplesCallback&&e.elementExamplesCallback({defineExample(n){const o={...n,entryType:we.ElementExample,parent:t,descriptionParagraphs:n.descriptionParagraphs??[],errors:[r.has(n.title)&&new Error(`Example title '${n.title}' in page '${e.title}' is already taken.`)].filter(be)};r.add(n.title),t.elementExamples[fo(o.title)]=o}}),t}var it;(function(e){e.Footer="book-footer",e.NavHeader="book-nav-header"})(it||(it={}));async function Ji(e=1){const t=Ia();function r(){requestAnimationFrame(()=>{e--,e?r():t.resolve()})}return r(),t.promise}async function nf(e){return of(e,1)}async function of(e,t){return new Promise(r=>{new IntersectionObserver((o,i)=>{Jc(o,1),i.disconnect(),r(o[0].intersectionRatio>=t)}).observe(e)})}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Xn=globalThis,Na=Xn.ShadowRoot&&(Xn.ShadyCSS===void 0||Xn.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Oa=Symbol(),Ms=new WeakMap;let eu=class{constructor(t,r,n){if(this._$cssResult$=!0,n!==Oa)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=r}get styleSheet(){let t=this.o;const r=this.t;if(Na&&t===void 0){const n=r!==void 0&&r.length===1;n&&(t=Ms.get(r)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),n&&Ms.set(r,t))}return t}toString(){return this.cssText}};const M=e=>new eu(typeof e=="string"?e:e+"",void 0,Oa),Qn=(e,...t)=>{const r=e.length===1?e[0]:t.reduce((n,o,i)=>n+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+e[i+1],e[0]);return new eu(r,e,Oa)},af=(e,t)=>{if(Na)e.adoptedStyleSheets=t.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet);else for(const r of t){const n=document.createElement("style"),o=Xn.litNonce;o!==void 0&&n.setAttribute("nonce",o),n.textContent=r.cssText,e.appendChild(n)}},As=Na?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let r="";for(const n of t.cssRules)r+=n.cssText;return M(r)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:sf,defineProperty:lf,getOwnPropertyDescriptor:cf,getOwnPropertyNames:uf,getOwnPropertySymbols:df,getPrototypeOf:hf}=Object,xt=globalThis,Es=xt.trustedTypes,ff=Es?Es.emptyScript:"",oi=xt.reactiveElementPolyfillSupport,Ur=(e,t)=>e,mo={toAttribute(e,t){switch(t){case Boolean:e=e?ff:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let r=e;switch(t){case Boolean:r=e!==null;break;case Number:r=e===null?null:Number(e);break;case Object:case Array:try{r=JSON.parse(e)}catch{r=null}}return r}},Ba=(e,t)=>!sf(e,t),Is={attribute:!0,type:String,converter:mo,reflect:!1,hasChanged:Ba};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),xt.litPropertyMetadata??(xt.litPropertyMetadata=new WeakMap);let lr=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,r=Is){if(r.state&&(r.attribute=!1),this._$Ei(),this.elementProperties.set(t,r),!r.noAccessor){const n=Symbol(),o=this.getPropertyDescriptor(t,n,r);o!==void 0&&lf(this.prototype,t,o)}}static getPropertyDescriptor(t,r,n){const{get:o,set:i}=cf(this.prototype,t)??{get(){return this[r]},set(a){this[r]=a}};return{get(){return o==null?void 0:o.call(this)},set(a){const s=o==null?void 0:o.call(this);i.call(this,a),this.requestUpdate(t,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Is}static _$Ei(){if(this.hasOwnProperty(Ur("elementProperties")))return;const t=hf(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Ur("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Ur("properties"))){const r=this.properties,n=[...uf(r),...df(r)];for(const o of n)this.createProperty(o,r[o])}const t=this[Symbol.metadata];if(t!==null){const r=litPropertyMetadata.get(t);if(r!==void 0)for(const[n,o]of r)this.elementProperties.set(n,o)}this._$Eh=new Map;for(const[r,n]of this.elementProperties){const o=this._$Eu(r,n);o!==void 0&&this._$Eh.set(o,r)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const r=[];if(Array.isArray(t)){const n=new Set(t.flat(1/0).reverse());for(const o of n)r.unshift(As(o))}else t!==void 0&&r.push(As(t));return r}static _$Eu(t,r){const n=r.attribute;return n===!1?void 0:typeof n=="string"?n:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(r=>this.enableUpdating=r),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(r=>r(this))}addController(t){var r;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((r=t.hostConnected)==null||r.call(t))}removeController(t){var r;(r=this._$EO)==null||r.delete(t)}_$E_(){const t=new Map,r=this.constructor.elementProperties;for(const n of r.keys())this.hasOwnProperty(n)&&(t.set(n,this[n]),delete this[n]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return af(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(r=>{var n;return(n=r.hostConnected)==null?void 0:n.call(r)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(r=>{var n;return(n=r.hostDisconnected)==null?void 0:n.call(r)})}attributeChangedCallback(t,r,n){this._$AK(t,n)}_$EC(t,r){var i;const n=this.constructor.elementProperties.get(t),o=this.constructor._$Eu(t,n);if(o!==void 0&&n.reflect===!0){const a=(((i=n.converter)==null?void 0:i.toAttribute)!==void 0?n.converter:mo).toAttribute(r,n.type);this._$Em=t,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._$Em=null}}_$AK(t,r){var i;const n=this.constructor,o=n._$Eh.get(t);if(o!==void 0&&this._$Em!==o){const a=n.getPropertyOptions(o),s=typeof a.converter=="function"?{fromAttribute:a.converter}:((i=a.converter)==null?void 0:i.fromAttribute)!==void 0?a.converter:mo;this._$Em=o,this[o]=s.fromAttribute(r,a.type),this._$Em=null}}requestUpdate(t,r,n){if(t!==void 0){if(n??(n=this.constructor.getPropertyOptions(t)),!(n.hasChanged??Ba)(this[t],r))return;this.P(t,r,n)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(t,r,n){this._$AL.has(t)||this._$AL.set(t,r),n.reflect===!0&&this._$Em!==t&&(this._$Ej??(this._$Ej=new Set)).add(t)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(r){Promise.reject(r)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var n;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[i,a]of this._$Ep)this[i]=a;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[i,a]of o)a.wrapped!==!0||this._$AL.has(i)||this[i]===void 0||this.P(i,this[i],a)}let t=!1;const r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),(n=this._$EO)==null||n.forEach(o=>{var i;return(i=o.hostUpdate)==null?void 0:i.call(o)}),this.update(r)):this._$EU()}catch(o){throw t=!1,this._$EU(),o}t&&this._$AE(r)}willUpdate(t){}_$AE(t){var r;(r=this._$EO)==null||r.forEach(n=>{var o;return(o=n.hostUpdated)==null?void 0:o.call(n)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Ej&&(this._$Ej=this._$Ej.forEach(r=>this._$EC(r,this[r]))),this._$EU()}updated(t){}firstUpdated(t){}};lr.elementStyles=[],lr.shadowRootOptions={mode:"open"},lr[Ur("elementProperties")]=new Map,lr[Ur("finalized")]=new Map,oi==null||oi({ReactiveElement:lr}),(xt.reactiveElementVersions??(xt.reactiveElementVersions=[])).push("2.0.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Gr=globalThis,po=Gr.trustedTypes,Ls=po?po.createPolicy("lit-html",{createHTML:e=>e}):void 0,Da="$lit$",dt=`lit$${(Math.random()+"").slice(9)}$`,Ra="?"+dt,mf=`<${Ra}>`,Gt=document,sn=()=>Gt.createComment(""),ln=e=>e===null||typeof e!="object"&&typeof e!="function",tu=Array.isArray,ru=e=>tu(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",ii=`[ 	
\f\r]`,Pr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,qs=/-->/g,Ps=/>/g,Ot=RegExp(`>|${ii}(?:([^\\s"'>=/]+)(${ii}*=${ii}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ns=/'/g,Os=/"/g,nu=/^(?:script|style|textarea|title)$/i,ou=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),pf=ou(1),gf=ou(2),Pe=Symbol.for("lit-noChange"),K=Symbol.for("lit-nothing"),Bs=new WeakMap,Vt=Gt.createTreeWalker(Gt,129);function iu(e,t){if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ls!==void 0?Ls.createHTML(t):t}const au=(e,t)=>{const r=e.length-1,n=[];let o,i=t===2?"<svg>":"",a=Pr;for(let s=0;s<r;s++){const l=e[s];let c,f,h=-1,m=0;for(;m<l.length&&(a.lastIndex=m,f=a.exec(l),f!==null);)m=a.lastIndex,a===Pr?f[1]==="!--"?a=qs:f[1]!==void 0?a=Ps:f[2]!==void 0?(nu.test(f[2])&&(o=RegExp("</"+f[2],"g")),a=Ot):f[3]!==void 0&&(a=Ot):a===Ot?f[0]===">"?(a=o??Pr,h=-1):f[1]===void 0?h=-2:(h=a.lastIndex-f[2].length,c=f[1],a=f[3]===void 0?Ot:f[3]==='"'?Os:Ns):a===Os||a===Ns?a=Ot:a===qs||a===Ps?a=Pr:(a=Ot,o=void 0);const g=a===Ot&&e[s+1].startsWith("/>")?" ":"";i+=a===Pr?l+mf:h>=0?(n.push(c),l.slice(0,h)+Da+l.slice(h)+dt+g):l+dt+(h===-2?s:g)}return[iu(e,i+(e[r]||"<?>")+(t===2?"</svg>":"")),n]};class cn{constructor({strings:t,_$litType$:r},n){let o;this.parts=[];let i=0,a=0;const s=t.length-1,l=this.parts,[c,f]=au(t,r);if(this.el=cn.createElement(c,n),Vt.currentNode=this.el.content,r===2){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(o=Vt.nextNode())!==null&&l.length<s;){if(o.nodeType===1){if(o.hasAttributes())for(const h of o.getAttributeNames())if(h.endsWith(Da)){const m=f[a++],g=o.getAttribute(h).split(dt),w=/([.?@])?(.*)/.exec(m);l.push({type:1,index:i,name:w[2],strings:g,ctor:w[1]==="."?lu:w[1]==="?"?cu:w[1]==="@"?uu:bn}),o.removeAttribute(h)}else h.startsWith(dt)&&(l.push({type:6,index:i}),o.removeAttribute(h));if(nu.test(o.tagName)){const h=o.textContent.split(dt),m=h.length-1;if(m>0){o.textContent=po?po.emptyScript:"";for(let g=0;g<m;g++)o.append(h[g],sn()),Vt.nextNode(),l.push({type:2,index:++i});o.append(h[m],sn())}}}else if(o.nodeType===8)if(o.data===Ra)l.push({type:2,index:i});else{let h=-1;for(;(h=o.data.indexOf(dt,h+1))!==-1;)l.push({type:7,index:i}),h+=dt.length-1}i++}}static createElement(t,r){const n=Gt.createElement("template");return n.innerHTML=t,n}}function Yt(e,t,r=e,n){var a,s;if(t===Pe)return t;let o=n!==void 0?(a=r._$Co)==null?void 0:a[n]:r._$Cl;const i=ln(t)?void 0:t._$litDirective$;return(o==null?void 0:o.constructor)!==i&&((s=o==null?void 0:o._$AO)==null||s.call(o,!1),i===void 0?o=void 0:(o=new i(e),o._$AT(e,r,n)),n!==void 0?(r._$Co??(r._$Co=[]))[n]=o:r._$Cl=o),o!==void 0&&(t=Yt(e,o._$AS(e,t.values),o,n)),t}class su{constructor(t,r){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:r},parts:n}=this._$AD,o=((t==null?void 0:t.creationScope)??Gt).importNode(r,!0);Vt.currentNode=o;let i=Vt.nextNode(),a=0,s=0,l=n[0];for(;l!==void 0;){if(a===l.index){let c;l.type===2?c=new Sr(i,i.nextSibling,this,t):l.type===1?c=new l.ctor(i,l.name,l.strings,this,t):l.type===6&&(c=new du(i,this,t)),this._$AV.push(c),l=n[++s]}a!==(l==null?void 0:l.index)&&(i=Vt.nextNode(),a++)}return Vt.currentNode=Gt,o}p(t){let r=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(t,n,r),r+=n.strings.length-2):n._$AI(t[r])),r++}}class Sr{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,r,n,o){this.type=2,this._$AH=K,this._$AN=void 0,this._$AA=t,this._$AB=r,this._$AM=n,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const r=this._$AM;return r!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=r.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,r=this){t=Yt(this,t,r),ln(t)?t===K||t==null||t===""?(this._$AH!==K&&this._$AR(),this._$AH=K):t!==this._$AH&&t!==Pe&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ru(t)?this.k(t):this._(t)}S(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.S(t))}_(t){this._$AH!==K&&ln(this._$AH)?this._$AA.nextSibling.data=t:this.T(Gt.createTextNode(t)),this._$AH=t}$(t){var i;const{values:r,_$litType$:n}=t,o=typeof n=="number"?this._$AC(t):(n.el===void 0&&(n.el=cn.createElement(iu(n.h,n.h[0]),this.options)),n);if(((i=this._$AH)==null?void 0:i._$AD)===o)this._$AH.p(r);else{const a=new su(o,this),s=a.u(this.options);a.p(r),this.T(s),this._$AH=a}}_$AC(t){let r=Bs.get(t.strings);return r===void 0&&Bs.set(t.strings,r=new cn(t)),r}k(t){tu(this._$AH)||(this._$AH=[],this._$AR());const r=this._$AH;let n,o=0;for(const i of t)o===r.length?r.push(n=new Sr(this.S(sn()),this.S(sn()),this,this.options)):n=r[o],n._$AI(i),o++;o<r.length&&(this._$AR(n&&n._$AB.nextSibling,o),r.length=o)}_$AR(t=this._$AA.nextSibling,r){var n;for((n=this._$AP)==null?void 0:n.call(this,!1,!0,r);t&&t!==this._$AB;){const o=t.nextSibling;t.remove(),t=o}}setConnected(t){var r;this._$AM===void 0&&(this._$Cv=t,(r=this._$AP)==null||r.call(this,t))}}class bn{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,r,n,o,i){this.type=1,this._$AH=K,this._$AN=void 0,this.element=t,this.name=r,this._$AM=o,this.options=i,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=K}_$AI(t,r=this,n,o){const i=this.strings;let a=!1;if(i===void 0)t=Yt(this,t,r,0),a=!ln(t)||t!==this._$AH&&t!==Pe,a&&(this._$AH=t);else{const s=t;let l,c;for(t=i[0],l=0;l<i.length-1;l++)c=Yt(this,s[n+l],r,l),c===Pe&&(c=this._$AH[l]),a||(a=!ln(c)||c!==this._$AH[l]),c===K?t=K:t!==K&&(t+=(c??"")+i[l+1]),this._$AH[l]=c}a&&!o&&this.j(t)}j(t){t===K?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class lu extends bn{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===K?void 0:t}}class cu extends bn{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==K)}}class uu extends bn{constructor(t,r,n,o,i){super(t,r,n,o,i),this.type=5}_$AI(t,r=this){if((t=Yt(this,t,r,0)??K)===Pe)return;const n=this._$AH,o=t===K&&n!==K||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,i=t!==K&&(n===K||o);o&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var r;typeof this._$AH=="function"?this._$AH.call(((r=this.options)==null?void 0:r.host)??this.element,t):this._$AH.handleEvent(t)}}class du{constructor(t,r,n){this.element=t,this.type=6,this._$AN=void 0,this._$AM=r,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(t){Yt(this,t)}}const wf={P:Da,A:dt,C:Ra,M:1,L:au,R:su,D:ru,V:Yt,I:Sr,H:bn,N:cu,U:uu,B:lu,F:du},ai=Gr.litHtmlPolyfillSupport;ai==null||ai(cn,Sr),(Gr.litHtmlVersions??(Gr.litHtmlVersions=[])).push("3.1.2");const vf=(e,t,r)=>{const n=(r==null?void 0:r.renderBefore)??t;let o=n._$litPart$;if(o===void 0){const i=(r==null?void 0:r.renderBefore)??null;n._$litPart$=o=new Sr(t.insertBefore(sn(),i),i,void 0,r??{})}return o._$AI(e),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xf={attribute:!0,type:String,converter:mo,reflect:!1,hasChanged:Ba},Tf=(e=xf,t,r)=>{const{kind:n,metadata:o}=r;let i=globalThis.litPropertyMetadata.get(o);if(i===void 0&&globalThis.litPropertyMetadata.set(o,i=new Map),i.set(r.name,e),n==="accessor"){const{name:a}=r;return{set(s){const l=t.get.call(this);t.set.call(this,s),this.requestUpdate(a,l,e)},init(s){return s!==void 0&&this.P(a,void 0,e),s}}}if(n==="setter"){const{name:a}=r;return function(s){const l=this[a];t.call(this,s),this.requestUpdate(a,l,e)}}throw Error("Unsupported decorator location: "+n)};function Sf(e){return(t,r)=>typeof r=="object"?Tf(e,t,r):((n,o,i)=>{const a=o.hasOwnProperty(i);return o.constructor.createProperty(i,a?{...n,wrapped:!0}:n),a?Object.getOwnPropertyDescriptor(o,i):void 0})(e,t,r)}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ce=Pt(class extends mt{constructor(e){var t;if(super(e),e.type!==yn.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var n,o;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!((n=this.nt)!=null&&n.has(i))&&this.st.add(i);return this.render(t)}const r=e.element.classList;for(const i of this.st)i in t||(r.remove(i),this.st.delete(i));for(const i in t){const a=!!t[i];a===this.st.has(i)||(o=this.nt)!=null&&o.has(i)||(a?(r.add(i),this.st.add(i)):(r.remove(i),this.st.delete(i)))}return Pe}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Rs=e=>e??K;/**
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ki extends mt{constructor(t){if(super(t),this.it=K,t.type!==yn.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===K||t==null)return this._t=void 0,this.it=t;if(t===Pe)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const r=[t];return r.raw=r,this._t={_$litType$:this.constructor.resultType,strings:r,values:[]}}}Ki.directiveName="unsafeHTML",Ki.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class _s extends Ki{}_s.directiveName="unsafeSVG",_s.resultType=2;/**
 * @license
...
`,se=Cr()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:e})=>!!e.fitContainer},styles:({hostClasses:e})=>p`
    ...
    `,renderCallback:({inputs:e})=>{const t=e.icon?u`
        ...
        `}});var ha;(function(e){e.Header="header"})(ha||(ha={}));Cr()({tagName:"vira-collapsible-wrapper",hostClasses:{"vira-collapsible-wrapper-expanded":({inputs:e})=>e.expanded},styles:({hostClasses:e})=>p`
        :host {
            display: flex;
    ...
    `,events:{expandChange:ee()},stateInitStatic:{contentHeight:0},renderCallback({state:e,updateState:t,dispatch:r,events:n,inputs:o}){const i=o.expanded?p`
            ...
            >
                <slot name=${ha.Header}>Header</slot>
            </button>
...
`,vd=v({name:"LoaderAnimated24Icon",svgTemplate:u`
        ...
        `,stateInitStatic:{forcedInputWidth:0},renderCallback:({inputs:e,dispatch:t,state:r,updateState:n,events:o})=>{const{filtered:i}=kd({value:e.value??"",allowed:e.allowedInputs,blocked:e.blockedInputs}),a=e.icon?u`
            ...
            <label>
                ...
                <input
                    ...
                    ?disabled=${e.disabled}
                    .value=${i}
                    ${T("input",l=>{Sm({inputs:e,filteredValue:i,event:l,inputBlockedCallback(c){t(new o.inputBlocked(c))},newValueCallback(c){t(new o.valueChange(c))}})})}
    ...
    `,events:{routeChange:ee()},renderCallback({inputs:e,dispatch:t,events:r}){var o,i;function n(a){e.route&&Vo(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new r.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return u`
            ...
            `}}});const{defineElement:Ze,defineElementNoInputs:lv}=Ua(),De=Ze()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>p`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `,renderCallback:({inputs:e,dispatch:t})=>{var n,o;const r=((o=e.router)==null?void 0:o.createRoutesUrl({...(n=e.router)==null?void 0:n.getCurrentRawRoutes(),...e.route}))??"#";return u`
            <a
                href=${r}
                ${T("click",i=>{(!e.router||Vo(i))&&(i.preventDefault(),window.scrollTo(0,0),t(new Co(e.route)))})}
            >
                <slot></slot>
            </a>
            ...
            `;return u`
                <li style=${n}>
                    <${De.assign({router:e.router,route:{paths:[Se.Book,...r.fullUrlBreadcrumbs]}})}
                        class=${ce({"title-row":!0,selected:e.selectedPath?ot(e.selectedPath,r.fullUrlBreadcrumbs):!1})}
                    >
    ...
    `,renderCallback({inputs:e}){return(X(e.message,"array")?e.message:[e.message]).map(r=>u`
                <p>${r}</p>
    ...
    `,renderCallback({inputs:e,dispatch:t,events:r}){return Object.entries(e.config).length?Object.entries(e.config).map(([n,o],i)=>{if(o.controlType===D.Hidden)return"";const a=Am(e.currentValues[n],o,s=>{const l=X(e.fullUrlBreadcrumbs,"array")?e.fullUrlBreadcrumbs:e.fullUrlBreadcrumbs[n];if(!l)throw new Error(`Failed to find breadcrumbs from given control name: '${n}'`);t(new r.controlValueChange({fullUrlBreadcrumbs:l,newValues:{...e.currentValues,[n]:s}}))});return u`
                ...
                `}):""}});function Am(e,t,r){return er(t,D.Hidden)?"":er(t,D.Checkbox)?u`
            <input
                type="checkbox"
                .value=${e}
                ${T("input",n=>{const o=Fr(n,HTMLInputElement);r(o.checked)})}
            />
        `:er(t,D.Color)?u`
            <input
                type="color"
                .value=${e}
                ${T("input",n=>{const o=Fr(n,HTMLInputElement);r(o.value)})}
            />
        `:er(t,D.Text)?u`
        ...
        `:er(t,D.Dropdown)?u`
            <select
                .value=${e}
                ${T("input",n=>{const o=Fr(n,HTMLSelectElement);r(o.value)})}
            >
                ${t.options.map(n=>u`
    ...
    `,renderCallback({inputs:e,dispatch:t}){return u`
            ...
            <input
                ...
                ${T("input",async r=>{const n=r.currentTarget;if(!(n instanceof HTMLInputElement))throw new Error("Failed to find input element for search.");const o=n.value;await Yi(200),n.value===o&&(n.value?t(new Co({paths:[Se.Search,encodeURIComponent(n.value)]})):t(new Co(kr)))})}
            />
                ...
                <div class="title-group">
                    ...
                    ${n?u`
                          ...
                          `:u`
                              ...
                              <${pn.assign({config:e.pageNode.entry.controls,currentValues:Ya(e.controls,e.pageNode.fullUrlBreadcrumbs),fullUrlBreadcrumbs:e.pageNode.fullUrlBreadcrumbs})}></${pn}>
                          `}
                </div>
            </div>
    ...
    `,renderCallback({inputs:e}){return u`
        ...
        `}});function $d(e,t,r,n){const o=ta(r,n),i=[];if(o){const a=$d(e,t,o,n);a&&i.push(a)}if(mr(r,we.Page)&&!e.includes(r)){const a=Ya(t,r.fullUrlBreadcrumbs);i.push({config:r.entry.controls,current:a,breadcrumbs:ve(a,()=>r.fullUrlBreadcrumbs)})}return i.reduce((a,s)=>({config:{...a.config,...s.config},current:{...a.current,...s.current},breadcrumbs:{...a.breadcrumbs,...s.breadcrumbs}}),{config:{},current:{},breadcrumbs:{}})}function Em({currentNodes:e,isTopLevel:t,router:r,isSearching:n,controls:o,originalTree:i}){if(!e.length&&n)return[u`
            ...
            `];const a=Gi(e,1)?$d(e,o,e[0],i):void 0,s=a&&Object.values(a.config).length&&Gi(e,1)?u`
              ...
              `:K,l=Af(e,c=>c.fullUrlBreadcrumbs.join(">"),(c,f)=>{if(mr(c,we.Page))return u`
                    <${Pl.assign({isTopLevel:t,pageNode:c,controls:o,router:r})}
                        class="block-entry"
                    ></${Pl}>
                `;if(mr(c,we.ElementExample)){const h=Ya(o,c.fullUrlBreadcrumbs.slice(0,-1));return u`
                    <${Bl.assign({elementExampleNode:c,currentPageControls:h,router:r})}
                        class="inline-entry"
                    ></${Bl}>
                `}else return mr(c,we.Root)?K:u`
    ...
    `,events:{loadingRender:ee()},stateInitStatic:{lastElement:void 0},renderCallback:({inputs:e,dispatch:t,events:r,state:n,updateState:o})=>{const i=ra(e.currentRoute.paths),a=Em({currentNodes:e.currentNodes,isTopLevel:!0,router:e.router,isSearching:!!i,controls:e.controls,originalTree:e.originalTree});return u`
            <${bi.assign({currentSearch:i,currentRoute:e.currentRoute,router:e.router})}></${bi}>

            ${$e(e.showLoading,u`
                    <div
                        ${ea(()=>{t(new r.loadingRender(!0))})}
                        class="loading"
                    >
                        <${se.assign({icon:vd})}></${se}>
                    </div>
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{Rl(e,ra(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:r,updateState:n,dispatch:o,events:i})=>{var f,h,m,g,w,k,y;t._debug&&console.info("rendering element-book app");function a(x){return{...e.currentRoute,...x}}function s(x){const C=a(x);return!ot(e.currentRoute,C)}function l(x){t.preventWindowTitleChange||(e.originalWindowTitle||n({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,x].filter(be).join(" - "))}function c(x){if(!s(x))return;const C=a(x);e.router?e.router.setRoutes(C):n({currentRoute:{...e.currentRoute,...C}}),t.elementBookRoutePaths&&!ot(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(C.paths??[]))}try{if(t.elementBookRoutePaths&&!ot(t.elementBookRoutePaths,e.currentRoute.paths)&&c({paths:t.elementBookRoutePaths}),(f=t.internalRouterConfig)!=null&&f.useInternalRouter&&!e.router){const U=B1(t.internalRouterConfig.basePath);n({router:U}),U.addRouteListener(!0,le=>{n({currentRoute:le})})}else!((h=t.internalRouterConfig)!=null&&h.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const x={themeColor:t.themeColor};if(!ot(x,(m=e.colors)==null?void 0:m.config)){const U=El(x);n({colors:{config:x,theme:U}}),_1(r,U)}const C=t._debug??!1,O=b1({entries:t.entries,debug:C});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),n({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:Nu(O.tree,{children:(w=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:w.children,controls:t.globalValues})}}));const F=ra(e.currentRoute.paths),ge=(F?C1({flattenedNodes:O.flattenedNodes,searchQuery:F}):void 0)??Im(O.flattenedNodes,e.currentRoute.paths,c);l((k=ge[0])==null?void 0:k.entry.title);const fe=(y=e.treeBasedControls)==null?void 0:y.controls;return fe?(t._debug&&console.info({currentControls:fe}),u`
                <div
                    class="root"
                    ${T(Co,async U=>{const le=U.detail;if(!s(le))return;if(n({loading:!0}),c(le),!(r.shadowRoot.querySelector(ut.tagName)instanceof ut))throw new Error(`Failed to find child '${ut.tagName}'`);Rl(r,F,e.currentRoute)})}
                    ${T(pn.events.controlValueChange,U=>{if(!e.treeBasedControls)return;const le=k1(fe,U.detail.fullUrlBreadcrumbs,U.detail.newValues);n({treeBasedControls:{...e.treeBasedControls,controls:le}})})}
                >
                    <${ut.assign({flattenedNodes:O.flattenedNodes,router:e.router,selectedPath:F?void 0:e.currentRoute.paths.slice(1)})}>
                        <slot
                            name=${it.NavHeader}
                            slot=${it.NavHeader}
                        ></slot>
                    </${ut}>
                    <${nr.assign({controls:fe,currentNodes:ge,currentRoute:e.currentRoute,debug:C,originalTree:O.tree,router:e.router,showLoading:e.loading})}
                        ${T(nr.events.loadingRender,async U=>{await Ji();const le=r.shadowRoot.querySelector(nr.tagName);le?le.scroll({top:0,behavior:"instant"}):console.error(`Failed to find '${nr.tagName}' for scrolling.`),await Ji(),n({loading:!U.detail})})}
                    >
                        <slot
                            name=${it.Footer}
                            slot=${it.Footer}
        ...
        `;function ki(e){return{foregroundColor:e.backgroundColor,backgroundColor:e.foregroundColor}}const Lm=(()=>{const e={backgroundColor:p`#ffffff`,foregroundColor:p`#000000`},t={...e,foregroundColor:p`#00D093`},r={...e,foregroundColor:p`#ACADAD`},n={...e,foregroundColor:p`#D6D6D6`},o={...t},i={...t,foregroundColor:p`#00A876`},a={...t,foregroundColor:p`#1D6852`},s={...n},l={...e,foregroundColor:p`rgba(0, 0, 0, 0.08)`},c={...e,backgroundColor:p`#D2EEFA`},f=ki(o),h=ki(i),m=ki(a),g=m,w={backgroundColor:p`#F1F3F6`,foregroundColor:e.foregroundColor},k={...w,foregroundColor:p`#9A9A9D`};return{brandPrimary:t,pagePrimary:e,pageSecondary:r,pageTertiary:n,pageInteraction:o,pageInteractionHover:i,pageInteractionActive:a,divider:s,dividerFaint:l,dropShadow:c,pageDarkPrimary:g,accentPrimary:f,accentPrimaryHover:h,accentPrimaryActive:m,accentSecondary:w,accentTertiary:k}})(),xd=Lm;function Hl(e,t){return M(`--toniq-${uo(e)}-${uo(t)}`)}const rs=ve(xd,e=>({backgroundColor:Hl(e,"backgroundColor"),foregroundColor:Hl(e,"foregroundColor")}));function Ke(e,t){const r=xd[e][t],n=rs[e][t];return p`var(${n}, ${r})`}const b=ve(rs,e=>({foregroundColor:Ke(e,"foregroundColor"),backgroundColor:Ke(e,"backgroundColor")}));function z(e){return p`
...
`))}const R=(()=>{const e=p`
    ...
    `}),ns=v({name:"ArrowLeft24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),os=v({name:"ArrowRight24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),is=v({name:"LoaderAnimated24Icon",svgTemplate:u`
        <style>
            @keyframes spin {
                0% {
                    transform: rotate(0deg);
...
`,zp=v({name:"CryptoIcp16Icon",svgTemplate:u`
    ...
    `}),yt={"core-16":[Sd,Nm,Om,Ct],"core-24":[Bm,Dm,ns,Rm,_m,os,Cd,Hm,Fm,Vm,jm,zm,Zm,Wm,Um,Md,Ad,Gm,Ym,Ed,Jm,Km,Xm,Qm,Id,ep,tp,rp,np,op,Ld,ip,ap,sp,lp,cp,up,ma,dp,hp,fp,mp,pp,gp,wp,is,vp,bp,yp,kp,$p,xp,Tp,Sp,qd,Pd,Cp,Mp,Ap,Ep,Ip,Lp,oo,qp,Pp,Nd,Np,Op],"core-48":[Bp,Od,Dp,Rp],"core-64":[Bd,_p,Hp],cryptocurrencies:[Fp,Dd,Vp,jp,zp,Zp],"third-party-brands":[Hd,Fd,Vd,Wp,Up,Gp,jd,Yp,zd,Jp,Zd,Wd,Kp,Ud,Gd],toniq:[Xp,Qp]},eg=xn({discord:tt(void 0,""),distrikt:tt(void 0,""),dscvr:tt(void 0,""),instagram:tt(void 0,""),medium:tt(void 0,""),telegram:tt(void 0,""),tikTok:tt(void 0,""),twitch:tt(void 0,""),twitter:tt(void 0,""),website:tt(void 0,"")}),tg=eg.defaultValue,Yd={discord:Hd,instagram:jd,telegram:Zd,tikTok:Wd,distrikt:Fd,twitch:Ud,dscvr:Vd,medium:zd,twitter:Gd,website:Nd},Fl="toniq-",{defineElement:te,defineElementNoInputs:as}=Ua({assertInputs:e=>{if(!e.tagName.startsWith(Fl))throw new Error(`Tag name should start with '${Fl}' but got '${e.tagName}'`)}}),Wt=te()({tagName:"toniq-bold-space",styles:p`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,renderCallback({inputs:e}){return e.text?u`
        ...
        `:""}}),S=te()({tagName:"toniq-icon",styles:p`
        :host {
            display: flex;
    ...
    `,cleanupCallback:({state:e})=>{window.clearInterval(e.rotationIntervalId)},renderCallback({inputs:e,state:t,updateState:r,host:n}){e.enableAutomaticCycling&&t.rotationIntervalId==null?r({rotationIntervalId:window.setInterval(()=>{$i({host:n,direction:"right",allowWrapping:!0,blockIfHovering:!0})},e.cycleIntervalMs||ag)}):!e.enableAutomaticCycling&&t.rotationIntervalId!=null&&(window.clearInterval(t.rotationIntervalId),r({rotationIntervalId:void 0}));const o=jl(t.scrollSnapPositions,0),i=jl(t.scrollSnapPositions,-1);return u`
            <div>
                <div
                    class="arrow left ${ce({hidden:o==null?!0:t.currentScrollPosition.left<=o})}"
                >
                    <${S.assign({icon:ns})}
                        ${T("click",()=>{$i({allowWrapping:!1,blockIfHovering:!1,direction:"left",host:n})})}
                    ></${S}>
                </div>
                <div
                    ${yr(()=>{r({scrollSnapPositions:ss(wa(n)).x})})}
                    class=${io}
    ...
    `,renderCallback({inputs:e,dispatch:t,events:r}){const n=u`
        ...
        `}});var va=(e=>(e.Default="default",e.Secondary="secondary",e))(va||{});const xi=te()({tagName:"toniq-chip",hostClasses:{"toniq-chip-secondary":({inputs:e})=>e.variant==="secondary"},options:{ignoreUnsetInputs:!0},styles:({hostClasses:e})=>p`
        :host {
            display: inline-flex;
            vertical-align: middle;
            align-items: center;
    ...
    `,initCallback:({state:e,host:t,updateState:r})=>{function n(o){var s;const i=(s=t.shadowRoot)==null?void 0:s.querySelector("button.dropdown");!o.composedPath().includes(i)&&e.dropdownOpen&&r({dropdownOpen:!1})}window.addEventListener("click",n)},renderCallback({dispatch:e,events:t,state:r,inputs:n,updateState:o}){n._forceOpenState!=null&&o({dropdownOpen:n._forceOpenState}),n.disabled&&o({dropdownOpen:!1});const i=n.value?n.options.find(l=>{var c;return l.value===((c=n.value)==null?void 0:c.value)})??n.options[0]:n.options[0],a=n.icon?u`
        ...
        `}}),Ni=as({tagName:"toniq-error-message",styles:p`
        :host {
            display: block;
            color: red;
        }
    ...
    `,renderCallback({inputs:e}){function t(n){if(e.linkType==="disabled"){n.preventDefault();return}e.linkType==="route-link"&&Vo(n)&&(n.preventDefault(),e.scrollToTop&&window.scrollTo(0,0))}const r=e.linkType==="new-tab";return u`
            <a
                href=${e.url.toString()}
                ${T("click",t)}
                target=${Rs(r?"_blank":void 0)}
                rel=${Rs(r?"noopener noreferrer":void 0)}
            >
                <slot></slot>
            </a>
        `}}),Ca=360,Q0=8;function eh(e){return(e-Q0)/2}const nt=pt({"main-image-size":Ca,"secondary-image-size":eh(Ca)}),lt=te()({tagName:"toniq-featured-flip-card-footer",styles:p`
        :host {
            display: inline-flex;
    ...
    `,renderCallback({inputs:e,dispatch:t,events:r}){return u`
        ...
        `}}),Q=te()({tagName:"toniq-featured-flip-card",stateInitStatic:{flipped:!1},events:{viewMoreButtonClick:ee()},styles:p`
        :host {
            max-width: 100%;
            display: inline-flex;
            position: relative;
    ...
    `,renderCallback({inputs:e,state:t,updateState:r,host:n,dispatch:o,events:i}){var m,g,w,k;const a=e.mainImageSize||Ca,s=eh(a);go({onElement:n,forCssVar:nt["main-image-size"],toValue:`${a}px`}),go({onElement:n,forCssVar:nt["secondary-image-size"],toValue:`${s}px`});const l=["View",e.viewButtonTitle].filter(be).join(" "),c=u`
            <h3>${e.cardTitle}</h3>
        `,f=e.imageUrls[0],h=f?u`
            ...
            <${Zt.assign({flipped:t.flipped})}
                ${T(lt.events.viewMoreButtonClick,()=>{o(new i.viewMoreButtonClick)})}
            >
                <div class="card-face front" slot="front">
                    ...
                    <${lt.assign({viewMoreButtonText:l,flipCardButtonText:(g=e.infoParagraphs)!=null&&g.length?e.flipCardButtonTitle||"More Info":"",viewMoreButtonUrl:e.viewMoreUrl||"",socialUrls:e.socialUrls})}
                        ${T(lt.events.flipCardButtonClick,()=>{r({flipped:!t.flipped})})}
                    ></${lt}>
                </div>
                <div class="card-face back" slot="back">
                    ${c}
                    <div class="paragraphs">
                        ${(w=e.infoParagraphs)==null?void 0:w.map(y=>u`
                                <p>${y}</p>
                            `)}
                    </div>
                    <${lt.assign({viewMoreButtonText:l,flipCardButtonText:(k=e.infoParagraphs)!=null&&k.length?"Back":"",viewMoreButtonUrl:e.viewMoreUrl||"",socialUrls:e.socialUrls})}
                        ${T(lt.events.flipCardButtonClick,()=>{r({flipped:!t.flipped})})}
                    ></${lt}>
                </div>
            </${Zt}>
    ...
    `,renderCallback({inputs:e}){return e.level==="h1"?u`
            ...
            `:u`
                <slot></slot>
            `}});function Ma({input:e,matcher:t}){return!e||!t?!0:e.length>1?!!e.split("").every(r=>Ma({input:r,matcher:t})):t instanceof RegExp?!!e.match(t):t.includes(e)}function th({value:e,allowed:t,blocked:r}){const n=t?Ma({input:e,matcher:t}):!0,o=r?Ma({input:e,matcher:r}):!1;return n&&!o}function Mc(e){if(!e.value)return{filtered:e.value,blocked:""};const{filtered:t,blocked:r}=e.value.split("").reduce((n,o)=>(th({...e,value:o})?n.filtered.push(o):n.blocked.push(o),n),{filtered:[],blocked:[]});return{filtered:t.join(""),blocked:r.join("")}}var Aa=(e=>(e.Default="default",e.Outline="outline",e))(Aa||{});const Yn=te()({tagName:"toniq-input",hostClasses:{"toniq-input-outline":({inputs:e})=>e.variant==="outline","toniq-input-has-a-value":({inputs:e})=>!!e.value,"toniq-input-disabled":({inputs:e})=>!!e.disabled},events:{valueChange:ee(),inputBlock:ee()},styles:({hostClasses:e})=>p`
            :host {
                position: relative;
                display: inline-flex;
                width: 224px;
        ...
        `,renderCallback({inputs:e,dispatch:t,events:r}){const{filtered:n}=Mc({value:e.value??"",allowed:e.allowedInputs,blocked:e.blockedInputs}),o=e.icon?u`
            ...
            <label>
                ...
                <input
                    ...
                    ?disabled=${e.disabled}
                    .value=${n}
                    ${T("input",i=>{if(!(i instanceof InputEvent))throw new Error(`Input event type mismatch: "${i.constructor.name}"`);const a=i.target;if(!(a instanceof HTMLInputElement))throw new Error("Failed to find input element target from input event.");const s=i.data,l=n;let c=a.value??"";if(s)if(s.length===1)th({value:s,allowed:e.allowedInputs,blocked:e.blockedInputs})||(c=l,t(new r.inputBlock(s)));else{const{filtered:f,blocked:h}=Mc({value:s,allowed:e.allowedInputs,blocked:e.blockedInputs});c=f,t(new r.inputBlock(h))}a.value!==c&&(a.value=c),l!==c&&t(new r.valueChange(c))})}
                    placeholder=${e.placeholder}
                />
                ${$e(!!e.suffix,u`
                        <div class="suffix">${e.suffix}</div>
    ...
    `,renderCallback:({inputs:e})=>u`
            <${S.assign({icon:is,fitContainer:e.size!=="small"})}></${S}>
    ...
    `,stateInitStatic:{canScroll:!1,debouncedResize:s1(()=>qh(nn.FirstThenWait,{milliseconds:30})),widthSizes:{},isPainting:!1,itemsPainted:0},initCallback({inputs:e,state:t,updateState:r}){const n=e.columns.filter(o=>!o.disabled);r({widthSizes:n.reduce((o,i)=>(o[i.key]=void 0,o),t.widthSizes)})},renderCallback({inputs:e,state:t,updateState:r,events:n,dispatch:o}){var h;const i=e.columns.filter(m=>!m.disabled),a=[e.rows[0],...e.rows];function s(m){m instanceof HTMLElement&&t.debouncedResize(()=>{r({canScroll:m.scrollWidth>m.clientWidth})})}const l=e.pagination&&((h=e.pagination)==null?void 0:h.pageCount)>1?u`
                      <${Bi.assign({currentPage:e.pagination.currentPage,pageCount:e.pagination.pageCount})}
                          class=${ce({"blocked-pagination":!!e.showLoading})}
                          ${T(Bi.events.pageChange,m=>{o(new n.pageChange(m.detail))})}
                      ></${Bi}>
                  `:K;function c(m,g){return u`
                <div
                    class="row-wrapper"
                    ${g>0?T("click",w=>{var k,y;(y=(k=m.rowActions)==null?void 0:k.click)==null||y.call(k,{clickEvent:w,dispatch:o})}):K}
                >
                    ${i.map((w,k)=>{var x,C;const y=m.cells[w.key];return u`
                            <div
                                class=${ce({"row-item":!0,sticky:(x=w.mobile)!=null&&x.sticky?((C=w.mobile)==null?void 0:C.sticky)&&t.canScroll:!1})}
                                style=${p`
                                    min-width: ${k>=i.length-1?M("unset"):M(`${t.widthSizes[w.key]}px`)};
                                `}
                            >
                                <div
                                    class=${ce({"row-content":!0,hidden:g===0})}
                                    ${ea(O=>{const F=O.getBoundingClientRect().width;(!t.widthSizes[w.key]||F>t.widthSizes[w.key])&&r({widthSizes:{...t.widthSizes,[w.key]:F}}),r({itemsPainted:t.itemsPainted+1})})}
                                >
                                    ${y}
                                </div>
                                ${$e(g===0,u`
            ...
            `}const f=t.itemsPainted<i.length*e.rows.length||!!e.showLoading;return u`
            <div
                class=${ce({"table-wrapper":!0,"can-scroll":t.canScroll})}
            >
                <div
                    class=${ce({"table-list":!0,hidden:f})}
                    ${yr(m=>{s(m.target)})}
                    ${T("scroll",m=>{s(m.target)})}
                    ${T("keydown",m=>{e.showLoading&&(m.preventDefault(),m.stopImmediatePropagation())})}
                >
                    ${a.filter(be).map((m,g)=>u`
                            ${c(m,g)}
                        `)}
                    ${$e(t.canScroll,u`
                ...
                <div
                    class=${ce({"loading-wrapper":!0,hidden:!f})}
                >
                    <${en.assign({size:Qr.Large})}></${en}>
                </div>
                ${l}
            </div>
        `}});async function _4(e){return navigator.clipboard.writeText(e)}const H4="…";function F4(e,t){const r=e.slice(0,t).trim(),n=e.slice(-1*t).trim();return`${r}${H4}${n}`}function V4(e){return!(e%1)}function j4(e){return e.letterCount==null?4:V4(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const ue=te()({tagName:"toniq-middle-ellipsis",events:{copy:ee()},cssVars:{"toniq-middle-ellipsis-text-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":b.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":b.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>p`
        :host {
            /* 5 frames at 60 fps */
            transition: ${J.interaction};
            ${R.paragraphFont};
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:r,state:n,updateState:o}){if(!e.text)return u``;const i=e.text,a=j4(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,f=c?F4(i,a):i,h=c?i:"",m=s?Ld:l?Id:void 0,g=m?u`
        ...
        `;return f?s?u`
                    <button
                        tabindex="0"
                        role="link"
                        ${T("click",k=>{var x,C;const y=(C=(x=k.currentTarget)==null?void 0:x.querySelector)==null?void 0:C.call(x,"a");if(!y)throw new Error("Failed to find link anchor tag for middle ellipsis element link.");y.click()})}
                        class="link-wrapper"
                    >
                        <!--
                ...
                `:l?u`
                    <button
                        ...
                        ${T("click",async()=>{await _4(i),t(new r.copy),n.showCopiedTextTimeoutId!=null&&window.clearTimeout(n.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${w} ${g}
                    </button>
                `:u`
    ...
    `,renderCallback({inputs:e,cssVars:t,host:r}){const n=fr({value:e.percent,max:100,min:0}),o=`${n}%`;return go({forCssVar:t["toniq-progress-width"],onElement:r,toValue:o}),r.setAttribute("title",`${o} finished`),n?u`
            ...
            `:K}}),Y=te()({tagName:"toniq-radio-group",stateInitStatic:{randomGroupName:""},events:{valueChange:ee()},cssVars:{"toniq-radio-group-unchecked-radio-color":String(Ke("pagePrimary","foregroundColor")),"toniq-radio-group-unchecked-label-color":String(Ke("pagePrimary","foregroundColor")),"toniq-radio-group-checked-radio-color":String(Ke("accentPrimary","backgroundColor")),"toniq-radio-group-checked-label-color":String(Ke("pageInteraction","foregroundColor"))},styles:({cssVars:e})=>p`
        :host {
            ${R.boldParagraphFont};
            display: inline-flex;
            transition:
...
`,qc=p`
    transform: scale(1.2);
`;function t5(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Zr(e){requestAnimationFrame(()=>{const t=rh(e.instanceInputs,e).elementValue;e5(t,e)&&(e.setAttribute("disabled","true"),Zr(e))})}const B=te()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ee()},styles:p`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Zr(e)}),e.addEventListener("keydown",()=>{Zr(e)}),e.addEventListener("keyup",()=>{Zr(e)})},renderCallback({inputs:e,host:t,events:r,dispatch:n,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:f,elementLimits:h,rangeWidth:m}=rh({...e},t);if(Zr(t),vn(f))return g(a,f,h);return k(a,f,h);function g(y,x,C){const O={left:Ft((m-Ht)*(x.min-C.min)/(C.max-C.min)+Ht/2),right:Ft((m-Ht)*(C.max-x.max)/(C.max-C.min)+Ht/2)},F=Fi(y.min,c,l),ie=Fi(y.max,c,l);requestAnimationFrame(()=>{const xe=Y4(t);xe!==o.labelOverlap&&i({labelOverlap:xe})});const ge=(C.max-x.max)/(C.max-C.min)>.5,fe=Hi({value:x.min,limits:{min:C.min,max:x.max},flip:!0}),U=Hi({value:x.max,limits:{min:x.min,max:C.max},flip:!1}),le=o.labelOverlap&&ge?o.labelOverlap:0,We=o.labelOverlap&&!ge?o.labelOverlap:0;return u`
                <div
                    class="range"
                    ${yr(()=>{i({rangeWidth:Ea(t)})})}
                >
                    <div
                        class="progress"
                    ...
                    <div class="slider-wrapper">
                        <input
                            ...
                            .max=${C.max}
                            .value=${x.min}
                            ${T("input",xe=>{const Qt=xe.target,Lr={...y,min:Vi(Number(Qt.value),s,l)};w(Lr)})}
                        />
                        <input
                            ?disabled=${e.disabled??!1}
                            type="range"
                            ...
                            .value=${x.max}
                            ${cr(Rr.slider)}
                            ${T("input",xe=>{const Qt=xe.target,Lr={...y,max:Vi(Number(Qt.value),s,l)};w(Lr)})}
                        />
                    </div>
                </div>
            `}function w(y){i({internalValue:y}),e.disabled||n(new r.valueChange(y))}function k(y,x,C){const O=Ft((m-Ht)*(C.max-x)/(C.max-C.min)+Ht/2),F=Fi(y,c,l),ie=Hi({value:x,limits:C,flip:!1});return u`
                <div
                ...
                >
                    ...
                    <input
                        ...
                        .value=${x}
                        ${cr(Rr.slider)}
                        ${T("input",ge=>{const fe=ge.target,U=Vi(Number(fe.value),s,l);w(U)})}
                    />
                </div>
    ...
    `,renderCallback({inputs:e}){const t=e.icon?u`
        ...
        `}}),rn=as({tagName:"toniq-tooltip",styles:p`
        :host {
            display: block;
            padding: 4px 8px;
            border-radius: 8px;
    ...
    `,renderCallback({inputs:e,dispatch:t,events:r}){const n=e.tabs.map(o=>{var l;const i=o.value===e.value,a=o.icon?u`
                ...
                >
                    <${Je.assign({url:((l=o.link)==null?void 0:l.url)||"",linkType:ht.RouteLink})}
                        class="tab ${ce({"disabled-tab":!!o.disabled})}"
                        role="tab"
                        title=${o.label}
                        aria-selected=${i?"true":"false"}
                        ${T("click",c=>{var f;i||Vo(c)&&((f=o.link)!=null&&f.route&&t(new r.routeChange(o.link.route)),t(new r.valueChange(o.value)))})}
                    >
        ...
        `}}),oh=H({title:"Data",parent:void 0}),Po=te()({tagName:"toniq-icon-book-viewer",styles:p`
        :host {
            display: inline-flex;
            padding: 8px;
            border-radius: 8px;
    ...
    `,renderCallback({inputs:e}){return u`
            <${S.assign({icon:e.icon})}></${S}>
        `}}),Xo=Object.values(yt).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),r5=Object.keys(Xo).sort();function ws(e){return{controlType:D.Dropdown,initValue:e,options:["None",...r5]}}const ih={"CSS color":{controlType:D.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:D.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:D.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:D.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:D.Number,initValue:2}};function co(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),X(n,"number")&&(n=La({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
`)}const n5=H({title:"Social Urls",parent:oh,elementExamplesCallback({defineExample:e}){function t({socialName:r,icon:n}){e({title:r,renderCallback(){return u`
                        <${Po.assign({icon:n})}></${Po}>
                    `}})}Object.entries(Yd).forEach(([r,n])=>{t({socialName:r,icon:n})})}}),re=H({title:"Elements",parent:void 0}),o5=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:p`
            ${Wt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],i5=H({title:Wt.tagName,parent:re,elementExamplesCallback({defineExample:e}){o5.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:p`
                    .bold {
                        ${R.boldFont}
                    }
...
`,s5=H({parent:re,title:Ee.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:Pc,renderCallback(){return u`
                ...
                `}}),e({title:"banner style",styles:Pc,renderCallback(){const t=p`
                    ...
                    border-radius: 12px;
                `;return u`
                    <${Ee.assign({enableAutomaticCycling:!0,variant:ga.Banner,templates:yt["core-24"].map(r=>u`
                                <div style=${t}>
                                    <${S.assign({icon:r})}></${S}>
                                </div>
                            `)})}></${Ee}>
                    <${Ee.assign({enableAutomaticCycling:!0,variant:ga.Banner,templates:[yt["core-24"][0]].map(r=>u`
                                <div style=${t}>
                                    <${S.assign({icon:r})}></${S}>
                                </div>
                            `)})}
                    ...
                    ></${Ee}>
                `}})}});function l5(e){const t=Object.keys(e.cssVars).map(r=>[`--${r}`,{controlType:D.Color,initValue:""}]);return Object.fromEntries(t)}function c5(e){const t=Object.entries(e).map(([r,n])=>{if(r.startsWith("--"))return typeof n!="string"||!n?void 0:`${r}: ${n};`}).filter(be);return M(t.join(`
`))}const u5=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],zi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],d5=H({parent:re,title:gt.tagName,controls:{Text:{controlType:D.Text,initValue:"Text"},...l5(gt)},elementExamplesCallback({defineExample:e}){u5.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:zi.map(r=>!!r.inputs.checked),extraEntryStatuses:zi.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:p`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return zi.map((i,a)=>{const s=(i.extraEntries??[]).map((c,f)=>{var h;return u`
                                    <${gt.assign({...t.inputs,...on(i.inputs,["checked"]),checked:!!((h=r.extraEntryStatuses[a])!=null&&h[f]),text:c})}
                                        ${T(gt.events.checkedChange,()=>{const m=[...r.extraEntryStatuses];m[a][f]=!m[a][f],n({extraEntryStatuses:m})})}
                                    ></${gt}>
                                `}),l=c5(o);return u`
                        ...
                        `})}})})}}),h5=H({parent:re,title:xi.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Ct}},{inputs:{icon:Ct}},{inputs:{},template:u`
                    HTML child
            ...
            ${rs.accentSecondary.backgroundColor}: transparent;
        ...
        `},{customStyle:p`
            max-height: 30px;
            min-height: 30px;
        `}],p5=H({title:Gn.tagName,parent:re,controls:{Selected:{controlType:D.Dropdown,initValue:Jn[0].label,options:Jn.map(e=>e.label)},Direction:{controlType:D.Dropdown,initValue:"Down",options:Uc(Sa)},Icon:ws(Cd.name),Prefix:{controlType:D.Text,initValue:"Sort by: "},"Force open":{controlType:D.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){m5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Nc.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:p`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Nc.map((i,a)=>{const s=p`
                            ...
                            ${i.customStyle??p``};
                        `;return u`
                            <${Gn.assign({...t.inputs,...i.inputs,options:Jn,value:r.selected[a]??Jn.find(l=>l.label===o.Selected),icon:Xo[o.Icon],selectedLabelPrefix:o.Prefix,direction:Sa[o.Direction],_forceOpenState:o["Force open"]||void 0})}
                                style=${s}
                                ${T(Gn.events.selectChange,l=>{const c=[...r.selected];c[a]=l.detail,n({selected:c})})}
                            ></${Gn}>
                        `})}})})}}),g5=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],w5=H({title:Ni.tagName,parent:re,elementExamplesCallback({defineExample:e}){g5.forEach(t=>{e({title:t.title,renderCallback(){return u`
                        <${Ni}>${t.content}</${Ni}>
                    `}})})}}),Oc="/toniq-labs-design-system";function ah(...e){const r=[globalThis.location.pathname.startsWith(Oc)?Oc:"",...e].filter(be);return an(...r)}const sr=Array(30).fill(ah("/toniq-labs-logo.png")),hr=["Hello there.","There is stuff here."],Kn=hr.concat(Array(30).fill(hr)),v5=H({title:Q.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${Q.assign({infoParagraphs:Kn,imageUrls:sr,socialUrls:tg,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${Q}>
                `}}),e({title:"with missing inputs",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${Q.assign({imageUrls:sr,cardTitle:"Featured Stuff",infoParagraphs:void 0})}></${Q}>
                `}}),e({title:"hyperlink view button",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${Q.assign({imageUrls:[],cardTitle:"Featured Stuff",infoParagraphs:Kn,viewMoreUrl:"https://toniqlabs.com"})}
                ...
                `}}),e({title:"min height",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${Q.assign({imageUrls:[],cardTitle:"Featured Stuff",infoParagraphs:Kn})}></${Q}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${Q.assign({imageUrls:sr,infoParagraphs:hr,cardTitle:"Featured Stuff"})}></${Q}>
                `}}),e({title:"with social URLs",styles:p`
                ${Q} {
                    width: 1000px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${Q.assign({imageUrls:sr,infoParagraphs:hr,cardTitle:"Featured Stuff",socialUrls:{discord:"https://toniqlabs.com",instagram:"https://toniqlabs.com",telegram:"https://toniqlabs.com"}})}></${Q}>
                `}}),e({title:"with custom template",styles:p`
                ${Q} {
                    width: 1000px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${Q.assign({imageUrls:sr,infoParagraphs:hr,cardTitle:"With custom Template",customTemplateCallback(t){return u`
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${Q.assign({imageUrls:sr.map((t,r)=>r%2?"/invalid-image.png":t),infoParagraphs:hr,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return u`
                                <${$t.assign({imageUrl:t,_debugLoadDelay:t.includes("invalid-image")?void 0:{milliseconds:1/0}})}>
                                    <div
                                        ...
                                        `}
                                    >
                                        <${S.assign({icon:is,fitContainer:!0})}
                                            style=${p`
                                                width: 100%;
                                                height: 100%;
                                            `}
                                    ...
                                    <div
                                        ...
                                        `}
                                    >
                                        <${S.assign({icon:bd,fitContainer:!0})}
                                            style=${p`
                            ...
                            `}})}></${Q}>
                `}})}}),b5=H({title:Zt.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:p`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:r}){return u`
                ...
                `}})}}),y5=H({title:Ae.tagName,parent:re,elementExamplesCallback({defineExample:e}){Gc(ur).forEach(t=>{e({title:t,renderCallback(){return u`
            ...
            `,renderCallback({controls:r}){return u`
                    <${S.assign({icon:Ct,fitContainer:!0})}
                        style=${co(r)}
                    ></${S}>
                `}})}}),x5=H({title:Yn.tagName,parent:re,controls:{"External value":{controlType:D.Text,initValue:""},Placeholder:{controlType:D.Text,initValue:"placeholder"},Icon:ws(Pd.name),Suffix:{controlType:D.Text,initValue:"ICP"},"No browser helps":{controlType:D.Checkbox,initValue:!1},"Blocked characters":{controlType:D.Text,initValue:""},"Exclusive characters":{controlType:D.Text,initValue:""}},elementExamplesCallback({defineExample:e}){const t=[{},{customStyles:p`
                    height: 75px;
                    width: 300px;
                `},{customStyles:p`
                    height: 40px;
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            <${Yn.assign({...n.inputs,value:o["External value"]||i.value,icon:Xo[o.Icon],placeholder:o.Placeholder,suffix:o.Suffix,disableBrowserHelps:o["No browser helps"],allowedInputs:o["Exclusive characters"],blockedInputs:o["Blocked characters"]})}
                                ...
                                ${T(Yn.events.valueChange,l=>{a({value:l.detail})})}
                            ></${Yn}>
    ...
    `,from:u`
        <${ue.assign({text:"QP6Wqf97r0ydgw9yxfmptu4krqjgy49kx7m5g3K14U",copyOnClick:!0})}
            style=${p`
                color: ${b.pageInteraction.foregroundColor};
            `}
        ></${ue}>
    `,to:u`
        <${ue.assign({text:"TR5Gqf97r0ydgw9yxfmptu4krqjgy49kx7m5g3E87V",externalLink:"https://toniqlabs.com"})}
            style=${p`
                color: ${b.pageInteraction.foregroundColor};
            `}
        ></${ue}>
    ...
    `}),Zi=T5({entries:A5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE",mobile:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:u`
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Bc=as({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const r=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(r)}})}},cleanupCallback({state:e,updateState:t}){var r;(r=e.cleanup)==null||r.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),I5=H({title:_t.tagName,parent:re,elementExamplesCallback({defineExample:e}){E5.forEach(t=>{var r,n;e({title:t.title,styles:p`
                    ${M(t.styles)}
            ...
            `,stateInitStatic:{tableInputs:{...Zi,rows:Zi.rows.map(t=>({...t,cells:{...t.cells,date:u`
                ...
                `}})}}),L5=H({title:en.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:Qr.Small}},{title:"large",inputs:{size:Qr.Large}},{title:"whole page",inputs:{size:Qr.WholePage},styles:p`
                    :host {
                        width: 500px;
                    }
                `}].forEach(r=>{e({title:r.title,styles:r.styles??p``,renderCallback(){return u`
                        <${en.assign(r.inputs)}></${en}>
                    `}})})}}),q5=H({title:ue.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
                    <${ue.assign({text:"Long string instead of text"})}></${ue}>
                `}}),e({title:"Short text",renderCallback(){return u`
                    <${ue.assign({text:"Short text"})}></${ue}>
                `}}),e({title:"External Link",renderCallback(){return u`
                    <${ue.assign({text:"Long text with link",externalLink:"https://toniqlabs.com"})}></${ue}>
                `}}),e({title:"Copyable",renderCallback(){return u`
                    <${ue.assign({text:"Long text that you can copy",copyOnClick:!0})}></${ue}>
                `}}),e({title:"Custom CSS vars",styles:p`
                ${ue} {
                    ${ue.cssVars["toniq-middle-ellipsis-icon-color"].name}: red;
                    ${ue.cssVars["toniq-middle-ellipsis-icon-hover-color"].name}: blue;
                    ${ue.cssVars["toniq-middle-ellipsis-text-color"].name}: green;
                    ${ue.cssVars["toniq-middle-ellipsis-text-hover-color"].name}: purple;
                }
            `,renderCallback(){return u`
                    <${ue.assign({text:"long text with custom colors",copyOnClick:!0})}></${ue}>
                `}})}}),P5=H({title:Dr.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:p`
                ${Dr} {
                    height: 32px;
                }
...
`,Wi={min:10,max:50},O5=H({title:B.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:p`
                ${rt}
            `,renderCallback({state:t,updateState:r}){return u`
                    <${B.assign({value:t.value,...Wi})}
                        ${T(B.events.valueChange,n=>{if(typeof n.detail!="number")throw new Error("was expecting a single numeric slider value");r({value:n.detail})})}
                    ></${B}>
                `}}),e({title:"Double range",stateInitStatic:{value:{min:10,max:72}},styles:p`
                ${rt}
            `,renderCallback({state:t,updateState:r}){return u`
                    <${B.assign({double:!0,value:t.value,min:0,max:100})}
                        ${T(B.events.valueChange,n=>{if(typeof n.detail=="number")throw new Error("was expecting a double slider value");r({value:n.detail})})}
                    ></${B}>
                `}}),e({title:"Suffix",stateInitStatic:{value:20},styles:p`
                ${rt}
            `,renderCallback({state:t,updateState:r}){return u`
                    <${B.assign({value:t.value,...Wi,suffix:"ICP"})}
                        ${T(B.events.valueChange,n=>{if(typeof n.detail!="number")throw new Error("was expecting a single numeric slider value");r({value:n.detail})})}
                    ></${B}>
                `}}),e({title:"Log Scale",stateInitStatic:{value:20},styles:p`
                ${rt}
            `,renderCallback({state:t,updateState:r}){return u`
                    <${B.assign({value:t.value,min:0,max:1e6,suffix:"ICP",logScale:!0})}
                        ${T(B.events.valueChange,n=>{if(typeof n.detail!="number")throw new Error("was expecting a single numeric slider value");r({value:n.detail})})}
                    ></${B}>
                `}}),e({title:"Log Scale Double",stateInitStatic:{value:{min:10,max:1e3}},styles:p`
                ${rt}
            `,renderCallback({state:t,updateState:r}){return u`
                    <${B.assign({value:t.value,double:!0,min:0,max:1e6,logScale:!0})}
                        ${T(B.events.valueChange,n=>{if(typeof n.detail=="number")throw new Error("was expecting a double slider value");r({value:n.detail})})}
                    ></${B}>
                `}}),e({title:"Decimals",stateInitStatic:{value:{min:1.95,max:50}},styles:p`
                ${rt}
            `,renderCallback({state:t,updateState:r}){return u`
                    <${B.assign({value:t.value,double:!0,min:1.95,max:100.5,logScale:!0})}
                        ${T(B.events.valueChange,n=>{if(typeof n.detail=="number")throw new Error("was expecting a double slider value");r({value:n.detail})})}
                    ></${B}>
                `}}),e({title:"Negative min",stateInitStatic:{value:20},styles:p`
                ${rt}
            `,renderCallback({state:t,updateState:r}){return u`
                    <${B.assign({value:t.value,min:-100,max:100})}
                        ${T(B.events.valueChange,n=>{if(typeof n.detail!="number")throw new Error("was expecting a single numeric slider value");r({value:n.detail})})}
                    ></${B}>
            ...
            `,renderCallback({state:t,updateState:r}){return u`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Dc.map((i,a)=>u`
                            ...
                            ></${ji}>
                        `)}})})}}),R5=H({parent:re,title:lo.tagName,elementExamplesCallback({defineExample:e}){function t({title:r,tooltipContent:n,forceShow:o}){e({title:r,styles:p`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),_5=H({parent:re,title:rn.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${lo.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return u`
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:p``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:p``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:ma},{label:"label here",value:2,icon:ma},{label:"",value:3,icon:Ct,disabled:!0},{label:"16px icon",value:4,icon:Ct},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],V5=H({title:Wr.tagName,parent:re,elementExamplesCallback({defineExample:e}){F5.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:p`
                    ${t.extraStyles??p``}
                `,renderCallback({state:r,updateState:n}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return u`
                        <${Wr.assign({tabs:o,value:r.selectedTab})}
                            ${T(Wr.events.valueChange,i=>{n({selectedTab:i.detail})})}
                        ></${Wr}>
                    `}})})}}),lh=H({title:"Icons",parent:void 0,controls:ih}),j5=Object.entries(yt).map(([e,t])=>H({title:e,parent:lh,elementExamplesCallback({defineExample:r}){t.map(n=>r({title:n.name,renderCallback({controls:o}){return u`
                                <${Po.assign({icon:n})}
                                    style=${co(o)}
                                ></${Po}>
                            `}}))}}));function ch(e){const t=z5(e),r=ve(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return oe(r).reduce((o,i)=>{const a=r[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function z5(e){typeof e!="string"&&(e=String(e));const n=`{"${Fc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const Qo=H({title:"Styles",parent:void 0}),Z5=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function W5(e,t,r){const n=ch(z(r));return e({title:t,styles:Z5,renderCallback(){return u`
            ...
            `}})}const U5=H({title:"Colors",parent:Qo,elementExamplesCallback({defineExample:e}){oe(b).map(t=>W5(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),G5=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function Y5(e,t,r){const n=ch(r);return e({title:t,styles:G5,renderCallback(){return u`
            ...
            `}})}const J5=H({title:"Fonts",parent:Qo,elementExamplesCallback({defineExample:e}){oe(R).map(t=>{const r=R[t];return Y5(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),K5=H({title:"Shadows",parent:Qo,elementExamplesCallback({defineExample:e}){vh(gn).forEach(([t,r])=>{e({title:t,styles:p`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
