...
`,de=In()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:e})=>!!e.fitContainer},styles:({hostClasses:e})=>p`
    ...
    `,events:{expandChange:oe()},stateInitStatic:{contentHeight:0},renderCallback({state:e,updateState:t,dispatch:n,events:r,inputs:o}){const i=o.expanded?p`
        ...
        `}});const q=wt({"vira-icon-stroke-color":"currentColor","vira-icon-fill-color":"none","vira-icon-stroke-width":"1px"});function v({name:e,svgTemplate:t}){return{name:e,svgTemplate:t}}const Tp=v({name:"CloseX24Icon",svgTemplate:u`
    ...
    `}),Mp=v({name:"Element16Icon",svgTemplate:u`
    ...
    `});const Ep=v({name:"Loader24Icon",svgTemplate:u`
        <svg
...
`,Ad=v({name:"LoaderAnimated24Icon",svgTemplate:u`
        ...
        ${Ep.svgTemplate}
    `}),Bp=v({name:"Options24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <g
                fill=${q["vira-icon-fill-color"].value}
                stroke=${q["vira-icon-stroke-color"].value}
        ...
        `,stateInitStatic:{forcedInputWidth:0},renderCallback:({inputs:e,dispatch:t,state:n,updateState:r,events:o})=>{const{filtered:i}=Sd({value:e.value??"",allowed:e.allowedInputs,blocked:e.blockedInputs}),a=e.icon?u`
            ...
            <label>
                ...
                <input
                    ...
                    ?disabled=${e.disabled}
                    .value=${i}
                    ${y("input",l=>{Lp({inputs:e,filteredValue:i,event:l,inputBlockedCallback(c){t(new o.inputBlocked(c))},newValueCallback(c){t(new o.valueChange(c))}})})}
                    placeholder=${e.placeholder}
                />
                ${we(!!(e.showClearButton&&e.value),u`
                        <button
    ...
    `,events:{routeChange:oe()},renderCallback({inputs:e,dispatch:t,events:n}){var o,i;function r(a){e.route&&Wo(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new n.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return u`
            ...
            `}}});const{defineElement:Ge,defineElementNoInputs:qv}=Ja(),Fe=Ge()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>p`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `,renderCallback({inputs:e,dispatch:t,events:n}){return Object.entries(e.config).length?Object.entries(e.config).map(([r,o],i)=>{if(o.controlType===j.Hidden)return"";const a=Op(e.currentValues[r],o,s=>{const l=ee(e.fullUrlBreadcrumbs,"array")?e.fullUrlBreadcrumbs:e.fullUrlBreadcrumbs[r];if(!l)throw new Error(`Failed to find breadcrumbs from given control name: '${r}'`);t(new n.controlValueChange({fullUrlBreadcrumbs:l,newValues:{...e.currentValues,[r]:s}}))});return u`
                ...
                `}):""}});function Op(e,t,n){return tn(t,j.Hidden)?"":tn(t,j.Checkbox)?u`
            <input
                type="checkbox"
                .value=${e}
    ...
    `,renderCallback({inputs:e}){const t=[Se.Book,...e.elementExampleNode.fullUrlBreadcrumbs];return u`
        ...
        `}}),Rl=Symbol("unset-internal-state"),Fl=Ge()({tagName:"book-element-example-viewer",stateInitStatic:{isUnset:Rl},renderCallback({state:e,inputs:t,updateState:n}){try{if(t.elementExampleNode.entry.errors.length)throw Yc(t.elementExampleNode.entry.errors);if(!t.elementExampleNode.entry.renderCallback||typeof t.elementExampleNode.entry.renderCallback=="string")throw new Error(`Failed to render example '${t.elementExampleNode.entry.title}': renderCallback is not a function`);e.isUnset===Rl&&n({isUnset:void 0,...t.elementExampleNode.entry.stateInitStatic});const r=t.elementExampleNode.entry.renderCallback({state:e,updateState:n,controls:t.currentPageControls});if(r instanceof Promise)throw new Error("renderCallback output cannot be a promise");return u`
                ${we(!!t.elementExampleNode.entry.styles,u`
                        <style>
    ...
    `,renderCallback({inputs:e}){return u`
        ...
        `}});function Td(e,t,n,r){const o=aa(n,r),i=[];if(o){const a=Td(e,t,o,r);a&&i.push(a)}if(vn(n,ye.Page)&&!e.includes(n)){const a=_a(t,n.fullUrlBreadcrumbs);i.push({config:n.entry.controls,current:a,breadcrumbs:ke(a,()=>n.fullUrlBreadcrumbs)})}return i.reduce((a,s)=>({config:{...a.config,...s.config},current:{...a.current,...s.current},breadcrumbs:{...a.breadcrumbs,...s.breadcrumbs}}),{config:{},current:{},breadcrumbs:{}})}function Dp({currentNodes:e,isTopLevel:t,router:n,isSearching:r,controls:o,originalTree:i}){if(!e.length&&r)return[u`
            ...
            `];const a=_i(e,1)?Td(e,o,e[0],i):void 0,s=a&&Object.values(a.config).length&&_i(e,1)?u`
              ...
              `:_,l=P1(e,c=>c.fullUrlBreadcrumbs.join(">"),(c,f)=>{if(vn(c,ye.Page))return u`
                    <${Nl.assign({isTopLevel:t,pageNode:c,controls:o,router:n})}
                        class="block-entry"
                    ></${Nl}>
                `;if(vn(c,ye.ElementExample)){const h=_a(o,c.fullUrlBreadcrumbs.slice(0,-1));return u`
                    <${jl.assign({elementExampleNode:c,currentPageControls:h,router:n})}
                        class="inline-entry"
                    ></${jl}>
                `}else return vn(c,ye.Root)?_:u`
    ...
    `,events:{loadingRender:oe()},stateInitStatic:{lastElement:void 0},renderCallback:({inputs:e,dispatch:t,events:n,state:r,updateState:o})=>{const i=sa(e.currentRoute.paths),a=Dp({currentNodes:e.currentNodes,isTopLevel:!0,router:e.router,isSearching:!!i,controls:e.controls,originalTree:e.originalTree});return u`
...
`))}const D=(()=>{const e=p`
    ...
    `}),Hp=v({name:"Copy16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${d["toniq-icon-fill-color"].value}
            stroke=${d["toniq-icon-stroke-color"].value}
    ...
    `}),Up=v({name:"ExternalLink16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Vp=v({name:"ArrowBarUp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Wp=v({name:"ArrowForwardUp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),zp=v({name:"ArrowLoopLeft24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Gp=v({name:"ArrowsSortAscending24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Yp=v({name:"ArrowsSortDescending24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Qp=v({name:"Bell24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Kp=v({name:"Bucket24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Jp=v({name:"BuildingStore24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Xp=v({name:"CalendarEvent24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),_p=v({name:"Cash24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),em=v({name:"Chain24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),tm=v({name:"ChevronUp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),nm=v({name:"Circle24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),im=v({name:"Clock24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),am=v({name:"Code24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),sm=v({name:"CreateFile24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),lm=v({name:"DotsVertical24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),cm=v({name:"Download24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),dm=v({name:"Envelope24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),hm=v({name:"Filter24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),fm=v({name:"Fire24Icon",svgTemplate:u`
        <svg
            width="14"
            height="24"
            viewBox="0 0 14 19"
    ...
    `}),pm=v({name:"Gear24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),gm=v({name:"GridDots24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),wm=v({name:"Heart24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Am=v({name:"ListDetails24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Cm=v({name:"Lock24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Sm=v({name:"LockOpen24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Tm=v({name:"Menu24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Mm=v({name:"Pamphlet24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),Em=v({name:"Paper24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Im=v({name:"People24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Bm=v({name:"Person24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Om=v({name:"ShootingStar24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),Dm=v({name:"ShoppingCart24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Nm=v({name:"Social24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Rm=v({name:"Square24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Fm=v({name:"SquareCheck24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),jm=v({name:"Tag24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),Hm=v({name:"Upload24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Um=v({name:"Wallet24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Vm=v({name:"WorldUpload24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Wm=v({name:"X24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),zm=v({name:"Folder48Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Gm=v({name:"Tag48Icon",svgTemplate:u`
        <svg
            width="48"
            height="48"
            viewBox="0 0 48 48"
    ...
    `}),Ym=v({name:"Wallet48Icon",svgTemplate:u`
    ...
    `}),Qm=v({name:"CircleDashes64Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Km=v({name:"Rocket64Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Jm=v({name:"CryptoBtc16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),_m=v({name:"CryptoCkBtc24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
...
`,eg=v({name:"CryptoIcp16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),tg=v({name:"CryptoIcp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),ng=v({name:"WalletBitfinity24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),rg=v({name:"WalletBitfinity64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),og=v({name:"WalletLeather24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),ig=v({name:"WalletLeather64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),ag=v({name:"WalletPlug24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),sg=v({name:"WalletPlug64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),lg=v({name:"WalletStoic24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),cg=v({name:"WalletStoic64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),ug=v({name:"WalletUnisat24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),dg=v({name:"WalletUnisat64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),hg=v({name:"WalletXverse24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),fg=v({name:"WalletXverse64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),pg=v({name:"BrandFacebookLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),mg=v({name:"BrandGoogleLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),gg=v({name:"BrandIcScan24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),wg=v({name:"BrandInstagramFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),vg=v({name:"BrandNftgeek24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),bg=v({name:"BrandTiktokFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${G["toniq-icon-fill-color"]("#000")}
    ...
    `}),yg=v({name:"BioniqRobot100Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),kg=v({name:"EntrepotLogo144Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),At={"core-16":[Id,Hp,Up,Et],"core-24":[Vp,Wp,ss,zp,Zp,ls,Bd,Gp,Yp,Qp,Kp,Jp,Xp,_p,em,Ld,qd,tm,nm,Pd,rm,om,im,am,Od,sm,lm,cm,um,dm,Dd,hm,fm,pm,mm,gm,wm,ba,vm,bm,ym,km,xm,Am,$m,cs,Cm,Sm,Tm,Mm,Em,Im,Bm,Lm,qm,Nd,Rd,Pm,Om,Dm,Nm,Rm,Fm,jm,ao,Hm,Um,Fd,Vm,Wm],"core-48":[zm,jd,Zm,Gm,Ym],"core-64":[Hd,Qm,Km],cryptocurrencies:[Jm,Qo,Xm,_m,eg,tg],"external-wallets":[ng,rg,og,ig,ag,sg,lg,cg,ug,dg,hg,fg],"third-party-brands":[Wd,zd,Zd,pg,mg,gg,Gd,wg,Yd,vg,Qd,Kd,bg,Jd,Xd],toniq:[yg,kg]},xg=Cr({discord:nt(void 0,""),distrikt:nt(void 0,""),dscvr:nt(void 0,""),instagram:nt(void 0,""),medium:nt(void 0,""),telegram:nt(void 0,""),tikTok:nt(void 0,""),twitch:nt(void 0,""),twitter:nt(void 0,""),website:nt(void 0,"")}),Ag=xg.defaultValue,_d={discord:Wd,instagram:Gd,telegram:Qd,tikTok:Kd,distrikt:zd,twitch:Jd,dscvr:Zd,medium:Yd,twitter:Xd,website:Fd},zl="toniq-",{defineElement:ie,defineElementNoInputs:us}=Ja({assertInputs:e=>{if(!e.tagName.startsWith(zl))throw new Error(`Tag name should start with '${zl}' but got '${e.tagName}'`)}}),Yt=ie()({tagName:"toniq-bold-space",styles:p`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,renderCallback({inputs:e,state:t,updateState:n,host:r,dispatch:o,events:i}){var m,g,w,k;const a=e.mainImageSize||Ia,s=ah(a);vo({onElement:r,forCssVar:ot["main-image-size"],toValue:`${a}px`}),vo({onElement:r,forCssVar:ot["secondary-image-size"],toValue:`${s}px`});const l=["View",e.viewButtonTitle].filter(ve).join(" "),c=u`
            <h3>${e.cardTitle}</h3>
    ...
    `,renderCallback:({inputs:e})=>u`
        ...
        `}),Lc="...";function a5(e,t,n=7,r=5){let o;e=wn({value:e,min:1,max:t}),n=wn({value:n,min:r,max:t});const i=n-5,a=n-3;t<=n?o=n:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>n?ji(t-o,t):e>o?ji(Math.min(s.start,t-o),Math.min(s.end,t)):ji(1,Math.min(t,o+1));function c(h,m){return l.length+1!==t?m:[h]}const f=l[l.length-1];if(f&&f<t){const h=c(t,[Lc,t]);return[...l,...h]}else return l[0]!==1?c(1,[1,Lc]).concat(l):l}function ji(e,t){const n=t-e+1;return Array.from({length:n},(r,o)=>e+o)}const Hi=ie()({tagName:"toniq-pagination",styles:p`
        :host {
            display: flex;
        }
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:n,state:r,updateState:o}){if(!e.text)return u``;const i=e.text,a=d5(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,f=c?c5(i,a):i,h=c?i:"",m=s?Dd:l?Od:void 0,g=m?u`
                  <${$.assign({icon:m})}></${$}>
              `:"",w=u`
...
`,Dc=p`
    transform: scale(1.2);
`;function A5(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Qn(e){requestAnimationFrame(()=>{const t=lh(e.instanceInputs,e).elementValue;x5(t,e)&&(e.setAttribute("disabled","true"),Qn(e))})}const R=ie()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:oe()},styles:p`
        :host {
            display: block;
        }
...
`,E5=U({parent:ae,title:Ie.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:Nc,renderCallback(){return u`
                ...
                `;return u`
                    ...
                    ></${Ie}>
                `}})}});function I5(e){const t=Object.keys(e.cssVars).map(n=>[`--${n}`,{controlType:j.Color,initValue:""}]);return Object.fromEntries(t)}function B5(e){const t=Object.entries(e).map(([n,r])=>{if(n.startsWith("--"))return typeof r!="string"||!r?void 0:`${n}: ${r};`}).filter(ve);return T(t.join(`
`))}const L5=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],Qi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],q5=U({parent:ae,title:bt.tagName,controls:{Text:{controlType:j.Text,initValue:"Text"},...I5(bt)},elementExamplesCallback({defineExample:e}){L5.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:Qi.map(n=>!!n.inputs.checked),extraEntryStatuses:Qi.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:p`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Qi.map((i,a)=>{const s=(i.extraEntries??[]).map((c,f)=>{var h;return u`
                        ...
                        `})}})})}}),P5=U({parent:ae,title:Mi.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Et}},{inputs:{icon:Et}},{inputs:{},template:u`
                    HTML child
        ...
        `},{customStyle:p`
            max-height: 30px;
            min-height: 30px;
        `}],N5=U({title:Kr.tagName,parent:ae,controls:{Selected:{controlType:j.Dropdown,initValue:Xr[0].label,options:Xr.map(e=>e.label)},Direction:{controlType:j.Dropdown,initValue:"Down",options:Xc(Ea)},Icon:ks(Bd.name),Prefix:{controlType:j.Text,initValue:"Sort by: "},"Force open":{controlType:j.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){D5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Rc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:p`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Rc.map((i,a)=>{const s=p`
                        ...
                        `;return u`
                            ...
                            ></${Kr}>
                        `})}})})}}),R5=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],F5=U({title:Fi.tagName,parent:ae,elementExamplesCallback({defineExample:e}){R5.forEach(t=>{e({title:t.title,renderCallback(){return u`
                        <${Fi}>${t.content}</${Fi}>
                    `}})})}}),Fc="/toniq-labs-design-system";function fh(...e){const n=[globalThis.location.pathname.startsWith(Fc)?Fc:"",...e].filter(ve);return lr(...n)}const cn=Array(30).fill(fh("/toniq-labs-logo.png")),mn=["Hello there.","There is stuff here."],_r=mn.concat(Array(30).fill(mn)),j5=U({title:re.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
            ...
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:n}){return u`
                ...
                `}})}}),U5=U({title:Ee.tagName,parent:ae,elementExamplesCallback({defineExample:e}){_c(hn).forEach(t=>{e({title:t,renderCallback(){return u`
            ...
            `,renderCallback(){return u`
                ...
                `}})}}),V5=U({parent:ae,title:Je.tagName,elementExamplesCallback({defineExample:e}){[{title:"default",inputs:{linkType:pt.ReplacePage}},{title:"new tab",inputs:{linkType:pt.NewTab}},{title:"hover styles",inputs:{withHoverStyles:!0,linkType:pt.NewTab}},{title:"route link",inputs:{linkType:pt.RouteLink}},{title:"link disabled",inputs:{linkType:pt.Disabled}}].forEach(n=>{e({title:n.title,descriptionParagraphs:n.descriptions,renderCallback(){return u`
                    ...
                    `}})})}}),W5=U({title:$.tagName,parent:ae,controls:hh,elementExamplesCallback({defineExample:e}){const t=[{icon:Hd},{icon:jd},{icon:Pd},{icon:Et},{icon:void 0}];e({title:"sizes",styles:p`
                :host {
                    display: flex;
                    gap: 16px;
                    align-items: center;
    ...
    `}),Q5=[{imageUrl:gn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Payment Sent",price:u`
            <div
                style=${p`
                    display: flex;
                    gap: 8px;
        ...
        `}],K5=[],J5=Array(5).fill({imageUrl:gn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:u`
        <div
            style=${p`
                display: flex;
                gap: 8px;
    ...
    `}),Ki=ni({entries:Y5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE",mobile:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:u`
                    <img
                        style=${p`
                            width: 24px;
                            height: auto;
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Hc=us({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const n=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(n)}})}},cleanupCallback({state:e,updateState:t}){var n;(n=e.cleanup)==null||n.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),tv=U({title:Ne.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return u`
                    <${Ne.assign(_5)}></${Ne}>
                `}}),e({title:"takes time to load",stateInitStatic:{tableInputs:{...X5,showLoading:!0,pagination:{currentPage:1,pageCount:5}}},renderCallback({state:t,updateState:n}){return setTimeout(()=>{n({tableInputs:{...t.tableInputs,...jc,showLoading:!1}})},5e3),u`
            ...
            `,stateInitStatic:{tableInputs:{...Ki,rows:Ki.rows.map(t=>({...t,cells:{...t.cells,date:u`
                ...
                `}].forEach(n=>{e({title:n.title,styles:n.styles??p``,renderCallback(){return u`
                    ...
                    `}})})}}),rv=U({title:O.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
...
`,Ji={min:10,max:50},av=U({title:R.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:p`
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:p``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:p``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:ba},{label:"label here",value:2,icon:ba},{label:"",value:3,icon:Et,disabled:!0},{label:"16px icon",value:4,icon:Et},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],fv=U({title:Kn.tagName,parent:ae,elementExamplesCallback({defineExample:e}){hv.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:p`
                ...
                `,renderCallback({state:n,updateState:r}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return u`
                        ...
                        ></${Kn}>
                    `}})})}}),mh=U({title:"Icons",parent:void 0,controls:hh}),pv=Object.entries(At).map(([e,t])=>U({title:e,parent:mh,elementExamplesCallback({defineExample:n}){t.map(r=>n({title:r.name,renderCallback({controls:o}){return u`
                                <${Oo.assign({icon:r})}
                                    style=${ho(o)}
                                ></${Oo}>
...
`;function wv(e,t,n){const r=gh(F(n));return e({title:t,styles:gv,renderCallback(){return u`
...
`;function yv(e,t,n){const r=gh(n);return e({title:t,styles:bv,renderCallback(){return u`
