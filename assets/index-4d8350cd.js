 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $i=(e,t,r)=>{const n=new Map;for(let o=t;o<=r;o++)n.set(e[o],o);return n},a0=De(class extends Ke{constructor(e){if(super(e),e.type!==dr.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,r){let n;r===void 0?r=t:t!==void 0&&(n=t);const o=[],i=[];let s=0;for(const a of e)o[s]=n?n(a,s):s,i[s]=r(a,s),s++;return{values:i,keys:o}}render(e,t,r){return this.dt(e,t,r).values}update(e,[t,r,n]){var o;const i=s0(e),{values:s,keys:a}=this.dt(t,r,n);if(!Array.isArray(i))return this.ht=a,s;const l=(o=this.ht)!==null&&o!==void 0?o:this.ht=[],c=[];let u,d,p=0,w=i.length-1,m=0,k=s.length-1;for(;p<=w&&m<=k;)if(i[p]===null)p++;else if(i[w]===null)w--;else if(l[p]===a[m])c[m]=nt(i[p],s[m]),p++,m++;else if(l[w]===a[k])c[k]=nt(i[w],s[k]),w--,k--;else if(l[p]===a[k])c[k]=nt(i[p],s[k]),Ht(e,c[k+1],i[p]),p++,k--;else if(l[w]===a[m])c[m]=nt(i[w],s[m]),Ht(e,i[p],i[w]),w--,m++;else if(u===void 0&&(u=$i(a,m,k),d=$i(l,p,w)),u.has(l[p]))if(u.has(l[w])){const y=d.get(a[m]),C=y!==void 0?i[y]:null;if(C===null){const M=Ht(e,i[p]);nt(M,s[m]),c[m]=M}else c[m]=nt(C,s[m]),Ht(e,i[p],C),i[y]=null;m++}else fn(i[w]),w--;else fn(i[p]),p++;for(;m<=k;){const y=Ht(e,c[k+1]);nt(y,s[m]),c[m++]=y}for(;p<=w;){const y=i[p++];y!==null&&fn(y)}return this.ht=a,i0(e,c),xe}});/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Rr=window,Ro=Rr.ShadowRoot&&(Rr.ShadyCSS===void 0||Rr.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,jo=Symbol(),yi=new WeakMap;let la=class{constructor(t,r,n){if(this._$cssResult$=!0,n!==jo)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=r}get styleSheet(){let t=this.o;const r=this.t;if(Ro&&t===void 0){const n=r!==void 0&&r.length===1;n&&(t=yi.get(r)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),n&&yi.set(r,t))}return t}toString(){return this.cssText}};const B=e=>new la(typeof e=="string"?e:e+"",void 0,jo),Vt=(e,...t)=>{const r=e.length===1?e[0]:t.reduce((n,o,i)=>n+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+e[i+1],e[0]);return new la(r,e,jo)},u0=(e,t)=>{Ro?e.adoptedStyleSheets=t.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet):t.forEach(r=>{const n=document.createElement("style"),o=Rr.litNonce;o!==void 0&&n.setAttribute("nonce",o),n.textContent=r.cssText,e.appendChild(n)})},xi=Ro?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let r="";for(const n of t.cssRules)r+=n.cssText;return B(r)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */var bn;((bn=window.HTMLSlotElement)===null||bn===void 0?void 0:bn.prototype.assignedElements)!=null;const Kn=Symbol("this-is-an-element-vir-declarative-element"),Oo=Symbol("key for ignoring inputs not having been set yet"),T0={[Oo]:!0};function fa(e,t){const r=e.instanceState;ut(t).forEach(n=>{if(r&&n in r)throw new Error(`Cannot set input '${n}' on '${e.tagName}'. '${e.tagName}' already has a state property with the same name.`);pa()(e,n),"instanceInputs"in e?e.instanceInputs[n]=t[n]:e[n]=t[n]}),"instanceInputs"in e&&ut(e.instanceInputs).forEach(n=>{n in t||(e.instanceInputs[n]=void 0)}),ga(e)}function ga(e){e.haveInputsBeenSet||(e.haveInputsBeenSet=!0)}function ma(e,t){return rr(e,t),e.element}function rr(e,t){if(e.type!==dr.ELEMENT)throw new Error(`${t} directive can only be attached directly to an element.`);if(!e.element)throw new Error(`${t} directive found no element.`)}function g(e,t){return t?Ti(e,t):Ti(void 0,e)}const Ti=De(class extends Ke{constructor(e){super(e),this.element=ma(e,"assign")}render(e,t){return P0(e,this.element,t),xe}});function P0(e,t,r){fa(t,r)}function va(e){const t=e.getRootNode();if(!(t instanceof ShadowRoot))return!1;const r=t.host;return r instanceof da?!0:va(r)}function wa(e,t){return`${e}-${x0(t)}`}function L0(e,t){return t?tr(t,r=>B(`--${wa(e,String(r))}`)):{}}function B0(e,t){return e?tr(e,(r,n)=>{const o=t[r];return B(`var(${o}, ${n})`)}):{}}class _0 extends CustomEvent{get type(){return this._type}constructor(t,r){super(typeof t=="string"?t:t.type,{detail:r,bubbles:!0,composed:!0}),this._type=""}}function Do(){return e=>{var t;return t=class extends _0{constructor(r){super(e,r),this._type=e}},t.type=e,t}}function ue(){return Do()}function z0(e){return e?Object.keys(e).filter(t=>{if(typeof t!="string")throw new Error(`Expected event key of type string but got type "${typeof t}" for key ${String(t)}`);if(t==="")throw new Error("Got empty string for events key.");return!0}).reduce((t,r)=>{const n=Do()(r);return t[r]=n,t},{}):{}}const Qn="_is_element_vir_observable_property_handler_instance",eo="_is_element_vir_observable_property_handler_creator";function R0(e){return hr(e,eo)&&e[eo]===!0}function j0(e){return hr(e,Qn)&&e[Qn]===!0}function Pi(e,t,r){if(typeof e!="string"&&typeof e!="number"&&typeof e!="symbol")throw new Error(`Property name must be a string, got type '${typeof e}' from: '${String(e)}' for '${r.toLowerCase()}'`);if(!(e in t))throw new Error(`Property '${String(e)}' does not exist on '${r.toLowerCase()}'.`)}function Li(e,t){const r=e;function n(i,s){return t&&Pi(s,e,e.tagName),r[s]}return new Proxy({},{get:n,set:(i,s,a)=>{t&&Pi(s,e,e.tagName);const l=e.observablePropertyHandlerMap[s];function c(u){i[s]=u,r[s]=u}return R0(a)&&(a=a.init()),j0(a)?(l&&a!==l?(a.addMultipleListeners(l.getAllListeners()),l.removeAllListeners()):a.addListener(!0,u=>{c(u)}),e.observablePropertyHandlerMap[s]=a):l?l.setValue(a):c(a),!0},ownKeys:i=>Reflect.ownKeys(i),getOwnPropertyDescriptor(i,s){if(s in i)return{get value(){return n(i,s)},configurable:!0,enumerable:!0}},has:(i,s)=>Reflect.has(i,s)})}function N0(e,t){return t?tr(t,r=>wa(e,String(r))):{}}function H0({hostClassNames:e,cssVarNames:t,cssVarValues:r}){return{hostClassSelectors:tr(e,(n,o)=>B(`:host(.${o})`)),hostClassNames:tr(e,(n,o)=>B(o)),cssVarNames:t,cssVarValues:r}}function O0({host:e,hostClassesInit:t,hostClassNames:r,state:n,inputs:o}){t&&ut(t).forEach(i=>{const s=t[i],a=r[i];typeof s=="function"&&(s({state:n,inputs:o})?e.classList.add(a):e.classList.remove(a))})}function D0(e,t){function r(o){ut(o).forEach(i=>{const s=o[i];e.instanceState[i]=s})}return{dispatch:o=>e.dispatchEvent(o),updateState:r,inputs:e.instanceInputs,host:e,state:e.instanceState,events:t}}var F0=globalThis&&globalThis.__setFunctionName||function(e,t,r){return typeof t=="symbol"&&(t=t.description?"[".concat(t.description,"]"):""),Object.defineProperty(e,"name",{configurable:!0,value:r?"".concat(r," ",t):t})};function en(e){var t;if(!e.renderCallback||typeof e.renderCallback=="string")throw new Error(`Failed to define element '${e.tagName}': renderCallback is not a function`);const r=z0(e.events),n=N0(e.tagName,e.hostClasses),o=L0(e.tagName,e.cssVars),i=B0(e.cssVars,o),s={...T0,...e.options},a=typeof e.styles=="function"?e.styles(H0({hostClassNames:n,cssVarNames:o,cssVarValues:i})):e.styles||Vt``,l=e.renderCallback,c=(t=class extends da{createRenderParams(){return D0(this,r)}get instanceType(){throw new Error(`"instanceType" was called on ${e.tagName} as a value but it is only for types.`)}static get inputsType(){throw new Error(`"inputsType" was called on ${e.tagName} as a value but it is only for types.`)}static get stateType(){throw new Error(`"stateType" was called on ${e.tagName} as a value but it is only for types.`)}markInputsAsHavingBeenSet(){ga(this)}render(){try{va(this)&&!this.haveInputsBeenSet&&!s[Oo]&&console.warn(this,`${e.tagName} got rendered before its input object was set. This was most likely caused by forgetting to use the "${g.name}" directive on it. If no inputs are intended, use "${en.name}" to define ${e.tagName}.`),this.hasRendered=!0;const u=this.createRenderParams();!this.initCalled&&e.initCallback&&(this.initCalled=!0,e.initCallback(u));const d=l(u);return O0({host:u.host,hostClassesInit:e.hostClasses,hostClassNames:n,state:u.state,inputs:u.inputs}),this.lastRenderedProps={inputs:{...u.inputs},state:{...u.state}},d}catch(u){const d=No(u);throw d.message=`Failed to render '${e.tagName}': ${d.message}`,d}}connectedCallback(){if(super.connectedCallback(),this.hasRendered&&!this.initCalled&&e.initCallback){this.initCalled=!0;const u=this.createRenderParams();e.initCallback(u)}}disconnectedCallback(){if(super.disconnectedCallback(),e.cleanupCallback){const u=this.createRenderParams();e.cleanupCallback(u)}this.initCalled=!1}assignInputs(u){fa(this,u)}constructor(){super(),this.initCalled=!1,this.hasRendered=!1,this.lastRenderedProps=void 0,this.haveInputsBeenSet=!1,this.definition={},this.observablePropertyHandlerMap={},this.instanceInputs=Li(this,!1),this.instanceState=Li(this,!0);const u=e.stateInit||{};ut(u).forEach(d=>{pa()(this,d),this.instanceState[d]=u[d]}),this.definition=c}},F0(t,"anonymousClass"),t.tagName=e.tagName,t.styles=a,t.isStrictInstance=()=>!1,t.events=r,t.renderCallback=l,t.hostClasses=n,t.cssVarNames=o,t.stateInit=e.stateInit,t.cssVarValues=o,t);return Object.defineProperties(c,{[Kn]:{value:!0,writable:!1},name:{value:y0(e.tagName,{capitalizeFirstLetter:!0}),writable:!0},isStrictInstance:{value:u=>u instanceof c,writable:!1}}),window.customElements.get(e.tagName)?console.warn(`Tried to define custom element '${e.tagName}' but it is already defined.`):window.customElements.define(e.tagName,c),c}function tn(){return e=>en({...e,options:{[Oo]:!1},...e.options})}function A(e,t){return Z0(e,t)}const Z0=De(class extends Ke{constructor(e){super(e),this.element=ma(e,"listen")}resetListener(e){this.lastListenerMetaData&&this.element.removeEventListener(this.lastListenerMetaData.eventType,this.lastListenerMetaData.listener),this.element.addEventListener(e.eventType,e.listener),this.lastListenerMetaData=e}createListenerMetaData(e,t){return{eventType:e,callback:t,listener:r=>{var n;return(n=this.lastListenerMetaData)==null?void 0:n.callback(r)}}}render(e,t){const r=typeof e=="string"?e:e.type;if(typeof r!="string")throw new Error(`Cannot listen to an event with a name that is not a string. Given event name: "${r}"`);return this.lastListenerMetaData&&this.lastListenerMetaData.eventType===r?this.lastListenerMetaData.callback=t:this.resetListener(this.createListenerMetaData(r,t)),xe}}),Bi="onDomCreated",_i=De(class extends Ke{constructor(e){super(e),rr(e,Bi)}update(e,[t]){rr(e,Bi);const r=e.element;return r!==this.element&&(requestAnimationFrame(()=>t(r)),this.element=r),this.render(t)}render(e){}}),$n="onResize",to=De(class extends Ke{constructor(e){super(e),this.resizeObserver=new ResizeObserver(t=>this.fireCallback(t)),rr(e,$n)}fireCallback(e){var r;const t=e[0];if(!t)throw console.error(e),new Error(`${$n} observation triggered but the first entry was empty.`);(r=this.callback)==null||r.call(this,{target:t.target,contentRect:t.contentRect})}update(e,[t]){rr(e,$n),this.callback=t;const r=e.element;return r!==this.element&&(this.element&&this.resizeObserver.unobserve(this.element),this.resizeObserver.observe(r),this.element=r),this.render(t)}render(e){}});function zi(e,t,r,n){return e instanceof Error?n?n(e):ua(e):M0(e)?t:r?r(e):e}function ht(e,t,r){return d0(e,()=>t,()=>r)}var P=globalThis&&globalThis.__classPrivateFieldGet||function(e,t,r,n){if(r==="a"&&!n)throw new TypeError("Private accessor was defined without a getter");if(typeof t=="function"?e!==t||!n:!t.has(e))throw new TypeError("Cannot read private member from an object whose class did not declare it");return r==="m"?n:r==="a"?n.call(e):n?n.value:t.get(e)},Ee=globalThis&&globalThis.__classPrivateFieldSet||function(e,t,r,n,o){if(n==="m")throw new TypeError("Private method is not writable");if(n==="a"&&!o)throw new TypeError("Private accessor was defined without a setter");if(typeof t=="function"?e!==t||!o:!t.has(e))throw new TypeError("Cannot write private member to an object whose class did not declare it");return n==="a"?o.call(e,r):o?o.value=r:t.set(e,r),r},re,ot,Ve,at,Ie,Ct,me,Et,ro,no,qt,ba;const se=Symbol("not set");class V0{constructor(t){re.add(this),ot.set(this,se),Ve.set(this,se),at.set(this,se),Ie.set(this,new Set),Ct.set(this,void 0),me.set(this,Ho()),this[ba]=!0,this.resetValue(t)}resetValue(t){P(this,re,"m",qt).call(this),t!==se&&(t instanceof Promise?this.setValue({newPromise:t}):this.setValue({resolvedValue:t}))}setValue(t){if("createPromise"in t){if(P(this,ot,"f")===se||!ha(t.trigger,P(this,ot,"f"))){Ee(this,ot,t.trigger,"f");const r=t.createPromise();P(this,re,"m",ro).call(this,r),P(this,re,"m",Et).call(this)}}else"newPromise"in t?(P(this,ot,"f"),P(this,re,"m",ro).call(this,t.newPromise),P(this,re,"m",Et).call(this)):"resolvedValue"in t?P(this,re,"m",no).call(this,t.resolvedValue):"forceUpdate"in t?(Ee(this,ot,se,"f"),Ee(this,Ve,se,"f"),P(this,me,"f").isSettled()||P(this,me,"f").reject("Canceled by force update"),P(this,re,"m",qt).call(this),P(this,re,"m",Et).call(this)):this.resetValue(t)}getValue(){if(P(this,me,"f").isSettled()){if(P(this,at,"f")!==se)return P(this,at,"f");if(P(this,Ve,"f")===se)throw new Error("Promise says it has settled but resolution value was not set!");return P(this,Ve,"f")}else return P(this,me,"f").promise}addListener(t,r){P(this,Ie,"f").add(r),t&&r(this.getValue())}addMultipleListeners(t){t.forEach(r=>P(this,Ie,"f").add(r))}getAllListeners(){return P(this,Ie,"f")}removeListener(t){return P(this,Ie,"f").has(t)?(P(this,Ie,"f").delete(t),!0):!1}removeAllListeners(){const t=P(this,Ie,"f").size;return P(this,Ie,"f").clear(),t}}ot=new WeakMap,Ve=new WeakMap,at=new WeakMap,Ie=new WeakMap,Ct=new WeakMap,me=new WeakMap,re=new WeakSet,ba=Qn,Et=function(){const t=this.getValue();P(this,Ie,"f").forEach(r=>{r(t)})},ro=function(t){t!==P(this,Ct,"f")&&(Ee(this,Ve,se,"f"),Ee(this,at,se,"f"),Ee(this,Ct,t,"f"),P(this,me,"f").isSettled()&&P(this,re,"m",qt).call(this),t.then(r=>{P(this,Ct,"f")===t&&P(this,re,"m",no).call(this,r)}).catch(r=>{P(this,Ct,"f")===t&&(Ee(this,at,No(r),"f"),P(this,me,"f").promise.catch(()=>{}),P(this,me,"f").reject(r),P(this,re,"m",Et).call(this))}))},no=function(t){t!==P(this,Ve,"f")&&(Ee(this,at,se,"f"),Ee(this,Ve,t,"f"),P(this,me,"f").isSettled()&&P(this,re,"m",qt).call(this),P(this,me,"f").resolve(t),P(this,re,"m",Et).call(this))},qt=function(){Ee(this,me,Ho(),"f")};function W0(...e){const t=A0(e,1)?e[0]:se;return{[eo]:!0,init(){return new V0(t)}}}function oo(e){if("templateString"in e)return e.templateString;const{strings:t,values:r}=e;if((!t||!(t!=null&&t.length))&&(!r||!r.length))return"";const n=[...r||[],""],i=(t??[""]).map((s,a)=>{const l=q0(s,n[a]);return`${s}${l}`});return v0(i.join(""))}function q0(e,t){return t._$litType$!=null||t._$litDirective$!=null?oo(t):Array.isArray(t)?t.map(n=>oo(n)).join(""):e.endsWith("=")?`"${t}"`:t}function $a(e){const{assertInputs:t,transformInputs:r}={assertInputs:(e==null?void 0:e.assertInputs)??(()=>{}),transformInputs:(e==null?void 0:e.transformInputs)??(n=>n)};return{defineElement:()=>n=>(t(n),tn()(r(n))),defineElementNoInputs:n=>(t(n),en(r(n)))}}function U0(e,t){return e.filter((r,n)=>!t.includes(n))}function ya(e){return e.filter(t=>S0(t,["tagName",Kn])&&!!t.tagName&&!!t[Kn])}const xa=new WeakMap;function G0(e,t){var o;const r=ya(t);return(o=ka(xa,[e,...r]).value)==null?void 0:o.template}function Y0(e,t,r){const n=ya(t);return Sa(xa,[e,...n],r)}function ka(e,t,r=0){const{currentTemplateAndNested:n,reason:o}=Ca(e,t,r);return n?r===t.length-1?{value:n,reason:"reached end of keys array"}:n.nested?ka(n.nested,t,r+1):{value:void 0,reason:`map at key index ${r} did not have nested maps`}:{value:n,reason:o}}function Ca(e,t,r){const n=t[r];if(n==null)return{currentKey:void 0,currentTemplateAndNested:void 0,reason:`key at index ${r} not found`};if(!e.has(n))return{currentKey:n,currentTemplateAndNested:void 0,reason:`key at index ${r} was not in the map`};const o=e.get(n);return o==null?{currentKey:n,currentTemplateAndNested:void 0,reason:`value at key at index ${r} was undefined`}:{currentKey:n,currentTemplateAndNested:o,reason:"key and value exists"}}function Sa(e,t,r,n=0){const{currentTemplateAndNested:o,currentKey:i,reason:s}=Ca(e,t,n);if(!i)return{result:!1,reason:s};const a=o??{nested:void 0,template:void 0};if(o||e.set(i,a),n===t.length-1)return a.template=r,{result:!0,reason:"set value at end of keys array"};const l=a.nested??new WeakMap;return a.nested||(a.nested=l),Sa(l,t,r,n+1)}function Ma(e,t,r){return{name:e,check:t,transform:r}}const J0=new WeakMap;function Aa(e,t,r){const n=G0(e,t),o=n??r();if(!n){const s=Y0(e,t,o);if(s.result)J0.set(e,o);else throw new Error(`Failed to set template transform: ${s.reason}`)}const i=U0(t,o.valueIndexDeletions);return{strings:o.templateStrings,values:i}}function Ia(e,t,r,n){const o=[],i=[],s=[];return e.forEach((l,c)=>{var y;const u=o.length-1,d=o[u],p=c-1,w=t[p];let m;n&&n(l),typeof d=="string"&&(m=(y=r.find(C=>C.check(d,l,w)))==null?void 0:y.transform,m&&(o[u]=d+m(w)+l,s.push(p))),m||o.push(l);const k=e.raw[c];m?i[u]=i[u]+m(w)+k:i.push(k)}),{templateStrings:Object.assign([],o,{raw:i}),valueIndexDeletions:s}}function Ea(e){return hr(e,"tagName")&&typeof e.tagName=="string"&&e.tagName.includes("-")}const X0=[Ma("tag name css selector interpolation",(e,t,r)=>Ea(r),e=>e.tagName)];function K0(e,t){return Ia(e,t,X0)}function f(e,...t){const r=Aa(e,t,()=>K0(e,t));return Vt(r.strings,...r.values)}const Q0=[Ma("tag name interpolation",(e,t,r)=>{const n=e.trim().endsWith("<")&&!!t.match(/^[\s\n>]/)||(e==null?void 0:e.trim().endsWith("</"))&&t.trim().startsWith(">"),o=Ea(r);if(n&&!o)throw console.error({lastNewString:e,currentLitString:t,currentValue:r}),new Error(`Got interpolated tag name but it wasn't of type VirElement: '${r.prototype.constructor.name}'`);return n&&o},e=>e.tagName)];function ed(e){}function td(e){return Ia(e.strings,e.values,Q0,ed)}function h(e,...t){const r=Qc(e,...t),n=Aa(e,t,()=>td(r));return{...r,strings:n.strings,values:n.values}}const rd=0;function nd(e){return!(e.type!=="click"||e.metaKey||e.altKey||e.ctrlKey||e.shiftKey||e.button!==rd)}class pr extends Error{constructor(t){super(t),this.name="SpaRouterError"}}class Ri extends pr{constructor(t){super(t),this.name="WindowEventConsolidationError"}}const rn="locationchange";let ji=!1;const od=globalThis.history.pushState;function Ni(...e){const t=od.apply(globalThis.history,e);return globalThis.dispatchEvent(new Event(rn)),t}const id=globalThis.history.replaceState;function Hi(...e){const t=id.apply(globalThis.history,e);return globalThis.dispatchEvent(new Event(rn)),t}function sd(){if(!ji){if(globalThis.history.pushState===Ni)throw new Ri("The consolidation module thinks that window events have not been consolidated yet but globalThis.history.pushState has already been overridden. Does this module have two copies in your repo?");if(globalThis.history.replaceState===Hi)throw new Ri("The consolidation module thinks that window events have not been consolidated yet but globalThis.history.replaceState has already been overridden. Does this module have two copies in your repo?");ji=!0,globalThis.history.pushState=Ni,globalThis.history.replaceState=Hi,globalThis.addEventListener("popstate",()=>{globalThis.dispatchEvent(new Event(rn))})}}function ad(e){return Array.from(e.entries()).reduce((t,r)=>(t[r[0]]=r[1],t),{})}function ld(e){const t=Object.entries(e).reduce((r,n)=>{const o=`${n[0]}=${n[1]}`;return`${r}&${o}`},"");return new URLSearchParams(t)}function cd(e){const r=(e?globalThis.location.pathname.replace(e,""):globalThis.location.pathname).split("/").filter(s=>!!s),o=globalThis.location.search?ad(new URLSearchParams(globalThis.location.search)):void 0,i=globalThis.location.hash||void 0;return{paths:r,search:o,hash:i}}class dd extends pr{constructor(t){super(t),this.name="SanitizationDepthMaxed"}}function Ta(e,t){if(e.paths.join(" ")!==t.paths.join(" "))return!1;if(typeof e.search=="object"&&typeof t.search=="object"){const r=Object.entries(e.search).join(" "),n=Object.entries(t.search).join(" ");if(r!==n)return!1}else if(e.search!==t.search)return!1;return e.hash===t.hash}const Oi=6;function Di(e,t){const r=e.getCurrentRawRoutes();if(e.sanitizationDepth>Oi)throw new dd(`Route sanitization depth has exceed the max of ${Oi} with ${JSON.stringify(r)}`);const n=e.sanitizeFullRoute(r);if(Ta(n,r))e.sanitizationDepth=0,t?t(n):e.listeners.forEach(o=>{o(n)});else return e.sanitizationDepth++,e.setRoutes(n,!0)}class yn extends pr{constructor(t){super(t),this.name="InvalidRouterInitParamsError"}}function ud(e){if("routeBase"in e&&typeof e.routeBase!="string"&&e.routeBase!=null)throw new yn(`Invalid type for router init params "routeBase" property. Expected string or undefined but got "${e.routeBase}" with type "${typeof e.routeBase}".`);if("routeSanitizer"in e&&typeof e.routeSanitizer!="function"&&e.routeSanitizer!=null)throw new yn(`Invalid type for router init params "routeSanitizer" property. Expected a function or undefined but got "${e.routeSanitizer}" with type "${typeof e.routeSanitizer}".`);if("maxListenerCount"in e&&(typeof e.maxListenerCount!="number"||isNaN(e.maxListenerCount))&&e.maxListenerCount!=null)throw new yn(`Invalid type for router init params "maxListenerCount" property. Expected a number or undefined but got "${e.maxListenerCount}" with type "${typeof e.maxListenerCount}".`)}function hd(e,t,r,n=!1){const o=Pa(e,t,r);n?globalThis.history.replaceState(void 0,"",o):globalThis.history.pushState(void 0,"",o)}function Pa(e,t,r=""){var l;if(!r&&t!=null)throw new pr("Route base regexp was defined but routeBase string was not provided.");const n=pd(t)?`/${r}`:"",o=e.search?ld(e.search).toString():"",i=o?`?${o}`:"",s=(l=e.hash)!=null&&l.startsWith("#")?"":"#",a=e.hash?`${s}${e.hash}`:"";return`${n}/${e.paths.join("/")}${i}${a}`}function pd(e){return!!(e&&globalThis.location.pathname.match(e))}function fd(e={}){var i;ud(e),sd();const t=(i=e.routeBase)==null?void 0:i.replace(/\/+$/,""),r=t?new RegExp(`^\\/${e.routeBase}`):void 0;let n=!1;const o={listeners:new Set,initParams:e,sanitizeFullRoute:s=>{const a={hash:void 0,search:void 0,...s};return e.routeSanitizer?e.routeSanitizer(a):a},setRoutes:(s,a=!1,l=!1)=>{const c=o.getCurrentRawRoutes(),u={...c,...s},d=o.sanitizeFullRoute(u);if(!(!l&&Ta(c,d)))return hd(d,r,t,a)},createRoutesUrl:s=>Pa(s,r,t),getCurrentRawRoutes:()=>cd(r),addRouteListener:(s,a)=>{if(e.maxListenerCount&&o.listeners.size>=e.maxListenerCount)throw new pr(`Tried to exceed route listener max of '${e.maxListenerCount}'.`);return o.listeners.add(a),n||(globalThis.addEventListener(rn,()=>Di(o)),n=!0),s&&Di(o,a),a},hasRouteListener:s=>o.listeners.has(s),removeRouteListener:s=>o.listeners.delete(s),sanitizationDepth:0};return o}var we;(function(e){e.Search="search",e.Book="book"})(we||(we={}));const La={hash:void 0,paths:[we.Book],search:void 0};function gd(e){return fd({routeBase:e,routeSanitizer(t){return{paths:md(t.paths),hash:void 0,search:void 0}}})}function md(e){const t=e[0];if(Fc(t,we)){if(t===we.Book)return[we.Book,...e.slice(1)];if(t===we.Search)return[t,e[1]??""];throw new Error(`Route path not handled for sanitization: ${e.join("/")}`)}else return La.paths}function Fi(e){return e!==e.toUpperCase()}function vd(e){return e.split("").reduce((r,n,o,i)=>{const s=o>0?i[o-1]:"",a=o<i.length-1?i[o+1]:"",l=Fi(s)||Fi(a);return n===n.toLowerCase()||o===0||!l?r+=n:r+=`-${n.toLowerCase()}`,r},"").toLowerCase()}const wd=["january","february","march","april","may","june","july","august","september","october","november","december"];wd.map(e=>e.slice(0,3));function bd(e){return!!e&&typeof e=="object"}function Zi(e){let t;try{t=Reflect.ownKeys(e)}catch{}return t??[...Object.keys(e),...Object.getOwnPropertySymbols(e)]}function $d(e){return Array.isArray(e)?"array":typeof e}function yd(e,t){return $d(e)===t}function xd(e,t){let r=!1;const n=Zi(e).reduce((o,i)=>{const s=t(i,e[i],e);return s instanceof Promise&&(r=!0),{...o,[i]:s}},{});return r?new Promise(async(o,i)=>{try{await Promise.all(Zi(n).map(async s=>{const a=await n[s];n[s]=a})),o(n)}catch(s){i(s)}}):n}function fr(e){if(bd(e))return xd(e,(r,n)=>{if(!yd(r,"string"))throw new Error(`Invalid CSS var name '${String(r)}' given. CSS var names must be strings.`);if(vd(r).toLowerCase()!==r)throw new Error(`Invalid CSS var name '${r}' given. CSS var names must be in lower kebab case.`);const i=n,s=r.startsWith("--")?B(r):r.startsWith("-")?Vt`-${B(r)}`:Vt`--${B(r)}`;return{name:s,value:Vt`var(${s}, ${B(i)})`,default:String(i)}});throw new Error(`Invalid setup input for '${fr.name}' function.`)}function io({onElement:e,toValue:t,forCssVar:r}){e.style.setProperty(String(r.name),String(t))}const D=fr({"element-book-nav-hover-background-color":"magenta","element-book-nav-hover-foreground-color":"magenta","element-book-nav-active-background-color":"magenta","element-book-nav-active-foreground-color":"magenta","element-book-nav-selected-background-color":"magenta","element-book-nav-selected-foreground-color":"magenta","element-book-accent-icon-color":"magenta","element-book-page-background-color":"magenta","element-book-page-background-faint-level-1-color":"magenta","element-book-page-background-faint-level-2-color":"magenta","element-book-page-foreground-color":"magenta","element-book-page-foreground-faint-level-1-color":"magenta","element-book-page-foreground-faint-level-2-color":"magenta"}),kd={nav:{hover:{background:D["element-book-nav-hover-background-color"],foreground:D["element-book-nav-hover-foreground-color"]},active:{background:D["element-book-nav-active-background-color"],foreground:D["element-book-nav-active-foreground-color"]},selected:{background:D["element-book-nav-selected-background-color"],foreground:D["element-book-nav-selected-foreground-color"]}},accent:{icon:D["element-book-accent-icon-color"]},page:{background:D["element-book-page-background-color"],backgroundFaint1:D["element-book-page-background-faint-level-1-color"],backgroundFaint2:D["element-book-page-background-faint-level-2-color"],foreground:D["element-book-page-foreground-color"],foregroundFaint1:D["element-book-page-foreground-faint-level-1-color"],foregroundFaint2:D["element-book-page-foreground-faint-level-2-color"]}};function Cd(e,t){Ba(e,t,kd)}function so(e){return _o(e,"_$cssResult$")}function Vi(e){return Ks(e,["name","value","default"])&&Nc(e.default,"string")&&so(e.name)&&so(e.value)}function Ba(e,t,r){Object.entries(t).forEach(([n,o])=>{const i=r[n];if(!i)throw new Error(`no nestedCssVar at key '${n}'`);if(so(o)){if(!Vi(i))throw new Error(`got a CSS result at '${n}' but no CSS var`);io({forCssVar:i,onElement:e,toValue:String(o)})}else{if(Vi(i))throw new Error(`got no CSS result at '${n}' but did find a CSS var`);Ba(e,o,i)}})}function G(e,t){let r=e.length;Array.isArray(e[0])||(e=[e]),Array.isArray(t[0])||(t=t.map(s=>[s]));let n=t[0].length,o=t[0].map((s,a)=>t.map(l=>l[a])),i=e.map(s=>o.map(a=>{let l=0;if(!Array.isArray(s)){for(let c of a)l+=s*c;return l}for(let c=0;c<s.length;c++)l+=s[c]*(a[c]||0);return l}));return r===1&&(i=i[0]),n===1?i.map(s=>s[0]):i}function gr(e){return We(e)==="string"}function We(e){return(Object.prototype.toString.call(e).match(/^\[object\s+(.*?)\]$/)[1]||"").toLowerCase()}function Wr(e,t){e=+e,t=+t;let r=(Math.floor(e)+"").length;if(t>r)return+e.toFixed(t-r);{let n=10**(r-t);return Math.round(e/n)*n}}function _a(e){if(!e)return;e=e.trim();const t=/^([a-z]+)\((.+?)\)$/i,r=/^-?[\d.]+$/;let n=e.match(t);if(n){let o=[];return n[2].replace(/\/?\s*([-\w.]+(?:%|deg)?)/g,(i,s)=>{/%$/.test(s)?(s=new Number(s.slice(0,-1)/100),s.type="<percentage>"):/deg$/.test(s)?(s=new Number(+s.slice(0,-3)),s.type="<angle>",s.unit="deg"):r.test(s)&&(s=new Number(s),s.type="<number>"),i.startsWith("/")&&(s=s instanceof Number?s:new Number(s),s.alpha=!0),o.push(s)}),{name:n[1].toLowerCase(),rawName:n[1],rawArgs:n[2],args:o}}}function za(e){return e[e.length-1]}function qr(e,t,r){return isNaN(e)?t:isNaN(t)?e:e+(t-e)*r}function Ra(e,t,r){return(r-e)/(t-e)}function Fo(e,t,r){return qr(t[0],t[1],Ra(e[0],e[1],r))}function ja(e){return e.map(t=>t.split("|").map(r=>{r=r.trim();let n=r.match(/^(<[a-z]+>)\[(-?[.\d]+),\s*(-?[.\d]+)\]?$/);if(n){let o=new String(n[1]);return o.range=[+n[2],+n[3]],o}return r}))}var Sd=Object.freeze({__proto__:null,isString:gr,type:We,toPrecision:Wr,parseFunction:_a,last:za,interpolate:qr,interpolateInv:Ra,mapRange:Fo,parseCoordGrammar:ja,multiplyMatrices:G});class Md{add(t,r,n){if(typeof arguments[0]!="string"){for(var t in arguments[0])this.add(t,arguments[0][t],arguments[1]);return}(Array.isArray(t)?t:[t]).forEach(function(o){this[o]=this[o]||[],r&&this[o][n?"unshift":"push"](r)},this)}run(t,r){this[t]=this[t]||[],this[t].forEach(function(n){n.call(r&&r.context?r.context:r,r)})}}const Ue=new Md;var Te={gamut_mapping:"lch.c",precision:5,deltaE:"76"};const Se={D50:[.3457/.3585,1,(1-.3457-.3585)/.3585],D65:[.3127/.329,1,(1-.3127-.329)/.329]};function ao(e){return Array.isArray(e)?e:Se[e]}function Ur(e,t,r,n={}){if(e=ao(e),t=ao(t),!e||!t)throw new TypeError(`Missing white point to convert ${e?"":"from"}${!e&&!t?"/":""}${t?"":"to"}`);if(e===t)return r;let o={W1:e,W2:t,XYZ:r,options:n};if(Ue.run("chromatic-adaptation-start",o),o.M||(o.W1===Se.D65&&o.W2===Se.D50?o.M=[[1.0479298208405488,.022946793341019088,-.05019222954313557],[.029627815688159344,.990434484573249,-.01707382502938514],[-.009243058152591178,.015055144896577895,.7518742899580008]]:o.W1===Se.D50&&o.W2===Se.D65&&(o.M=[[.9554734527042182,-.023098536874261423,.0632593086610217],[-.028369706963208136,1.0099954580058226,.021041398966943008],[.012314001688319899,-.020507696433477912,1.3303659366080753]])),Ue.run("chromatic-adaptation-end",o),o.M)return G(o.M,o.XYZ);throw new TypeError("Only Bradford CAT with white points D50 and D65 supported for now.")}const Ad=75e-6;var lr,lo,Tt,Qr,Na;const Ce=class{constructor(t){jt(this,lr);jt(this,Qr);jt(this,Tt,void 0);var o,i,s;this.id=t.id,this.name=t.name,this.base=t.base?Ce.get(t.base):null,this.aliases=t.aliases,this.base&&(this.fromBase=t.fromBase,this.toBase=t.toBase);let r=t.coords??this.base.coords;this.coords=r;let n=t.white??this.base.white??"D65";this.white=ao(n),this.formats=t.formats??{};for(let a in this.formats){let l=this.formats[a];l.type||(l.type="function"),l.name||(l.name=a)}t.cssId&&!((o=this.formats.functions)!=null&&o.color)?(this.formats.color={id:t.cssId},Object.defineProperty(this,"cssId",{value:t.cssId})):(i=this.formats)!=null&&i.color&&!((s=this.formats)!=null&&s.color.id)&&(this.formats.color.id=this.id),this.referred=t.referred,dn(this,Tt,yr(this,Qr,Na).call(this).reverse()),Ue.run("colorspace-init-end",this)}inGamut(t,{epsilon:r=Ad}={}){if(this.isPolar)return t=this.toBase(t),this.base.inGamut(t,{epsilon:r});let n=Object.values(this.coords);return t.every((o,i)=>{let s=n[i];if(s.type!=="angle"&&s.range){if(Number.isNaN(o))return!0;let[a,l]=s.range;return(a===void 0||o>=a-r)&&(l===void 0||o<=l+r)}return!0})}get cssId(){var t,r;return((r=(t=this.formats.functions)==null?void 0:t.color)==null?void 0:r.id)||this.id}get isPolar(){for(let t in this.coords)if(this.coords[t].type==="angle")return!0;return!1}getFormat(t){if(typeof t=="object")return t=yr(this,lr,lo).call(this,t),t;let r;return t==="default"?r=Object.values(this.formats)[0]:r=this.formats[t],r?(r=yr(this,lr,lo).call(this,r),r):null}to(t,r){if(arguments.length===1&&([t,r]=[t.space,t.coords]),t=Ce.get(t),this===t)return r;r=r.map(a=>Number.isNaN(a)?0:a);let n=vt(this,Tt),o=vt(t,Tt),i,s;for(let a=0;a<n.length&&n[a]===o[a];a++)i=n[a],s=a;if(!i)throw new Error(`Cannot convert between color spaces ${this} and ${t}: no connection space was found`);for(let a=n.length-1;a>s;a--)r=n[a].toBase(r);for(let a=s+1;a<o.length;a++)r=o[a].fromBase(r);return r}from(t,r){return arguments.length===1&&([t,r]=[t.space,t.coords]),t=Ce.get(t),t.to(this,r)}toString(){return`${this.name} (${this.id})`}getMinCoords(){let t=[];for(let r in this.coords){let n=this.coords[r],o=n.range||n.refRange;t.push((o==null?void 0:o.min)??0)}return t}static get all(){return[...new Set(Object.values(Ce.registry))]}static register(t,r){if(arguments.length===1&&(r=arguments[0],t=r.id),r=this.get(r),this.registry[t]&&this.registry[t]!==r)throw new Error(`Duplicate color space registration: '${t}'`);if(this.registry[t]=r,arguments.length===1&&r.aliases)for(let n of r.aliases)this.register(n,r);return r}static get(t,...r){if(!t||t instanceof Ce)return t;if(We(t)==="string"){let o=Ce.registry[t.toLowerCase()];if(!o)throw new TypeError(`No color space found with id = "${t}"`);return o}if(r.length)return Ce.get(...r);throw new TypeError(`${t} is not a valid color space`)}static resolveCoord(t,r){var l;let n=We(t),o,i;if(n==="string"?t.includes(".")?[o,i]=t.split("."):[o,i]=[,t]:Array.isArray(t)?[o,i]=t:(o=t.space,i=t.coordId),o=Ce.get(o),o||(o=r),!o)throw new TypeError(`Cannot resolve coordinate reference ${t}: No color space specified and relative references are not allowed here`);if(n=We(i),n==="number"||n==="string"&&i>=0){let c=Object.entries(o.coords)[i];if(c)return{space:o,id:c[0],index:i,...c[1]}}o=Ce.get(o);let s=i.toLowerCase(),a=0;for(let c in o.coords){let u=o.coords[c];if(c.toLowerCase()===s||((l=u.name)==null?void 0:l.toLowerCase())===s)return{space:o,id:c,index:a,...u};a++}throw new TypeError(`No "${i}" coordinate found in ${o.name}. Its coordinates are: ${Object.keys(o.coords).join(", ")}`)}};let I=Ce;lr=new WeakSet,lo=function(t){if(t.coords&&!t.coordGrammar){t.type||(t.type="function"),t.name||(t.name="color"),t.coordGrammar=ja(t.coords);let r=Object.entries(this.coords).map(([n,o],i)=>{let s=t.coordGrammar[i][0],a=o.range||o.refRange,l=s.range,c="";return s=="<percentage>"?(l=[0,100],c="%"):s=="<angle>"&&(c="deg"),{fromRange:a,toRange:l,suffix:c}});t.serializeCoords=(n,o)=>n.map((i,s)=>{let{fromRange:a,toRange:l,suffix:c}=r[s];return a&&l&&(i=Fo(a,l,i)),i=Wr(i,o),c&&(i+=c),i})}return t},Tt=new WeakMap,Qr=new WeakSet,Na=function(){let t=[this];for(let r=this;r=r.base;)t.push(r);return t},ln(I,"registry",{}),ln(I,"DEFAULT_FORMAT",{type:"functions",name:"color"});var $e=new I({id:"xyz-d65",name:"XYZ D65",coords:{x:{name:"X"},y:{name:"Y"},z:{name:"Z"}},white:"D65",formats:{color:{ids:["xyz-d65","xyz"]}},aliases:["xyz"]});class ae extends I{constructor(t){t.coords||(t.coords={r:{range:[0,1],name:"Red"},g:{range:[0,1],name:"Green"},b:{range:[0,1],name:"Blue"}}),t.base||(t.base=$e),t.toXYZ_M&&t.fromXYZ_M&&(t.toBase??(t.toBase=r=>{let n=G(t.toXYZ_M,r);return this.white!==this.base.white&&(n=Ur(this.white,this.base.white,n)),n}),t.fromBase??(t.fromBase=r=>(r=Ur(this.base.white,this.white,r),G(t.fromXYZ_M,r)))),t.referred??(t.referred="display"),super(t)}}function Ha(e){var r,n,o,i,s;let t={str:(r=String(e))==null?void 0:r.trim()};if(Ue.run("parse-start",t),t.color)return t.color;if(t.parsed=_a(t.str),t.parsed){let a=t.parsed.name;if(a==="color"){let l=t.parsed.args.shift(),c=t.parsed.rawArgs.indexOf("/")>0?t.parsed.args.pop():1;for(let d of I.all){let p=d.getFormat("color");if(p&&(l===p.id||(n=p.ids)!=null&&n.includes(l))){let w=Object.keys(d.coords).length,m=Array(w).fill(0);return m.forEach((k,y)=>m[y]=t.parsed.args[y]||0),{spaceId:d.id,coords:m,alpha:c}}}let u="";if(l in I.registry){let d=(s=(i=(o=I.registry[l].formats)==null?void 0:o.functions)==null?void 0:i.color)==null?void 0:s.id;d&&(u=`Did you mean color(${d})?`)}throw new TypeError(`Cannot parse color(${l}). `+(u||"Missing a plugin?"))}else for(let l of I.all){let c=l.getFormat(a);if(c&&c.type==="function"){let u=1;(c.lastAlpha||za(t.parsed.args).alpha)&&(u=t.parsed.args.pop());let d=t.parsed.args;return c.coordGrammar&&Object.entries(l.coords).forEach(([p,w],m)=>{var _;let k=c.coordGrammar[m],y=(_=d[m])==null?void 0:_.type;if(k=k.find(X=>X==y),!k){let X=w.name||p;throw new TypeError(`${y} not allowed for ${X} in ${a}()`)}let C=k.range;y==="<percentage>"&&(C||(C=[0,1]));let M=w.range||w.refRange;C&&M&&(d[m]=Fo(C,M,d[m]))}),{spaceId:l.id,coords:d,alpha:u}}}}else for(let a of I.all)for(let l in a.formats){let c=a.formats[l];if(c.type!=="custom"||c.test&&!c.test(t.str))continue;let u=c.parse(t.str);if(u)return u.alpha??(u.alpha=1),u}throw new TypeError(`Could not parse ${e} as a color. Missing a plugin?`)}function F(e){if(!e)throw new TypeError("Empty color reference");gr(e)&&(e=Ha(e));let t=e.space||e.spaceId;return t instanceof I||(e.space=I.get(t)),e.alpha===void 0&&(e.alpha=1),e}function mr(e,t){return t=I.get(t),t.from(e)}function ye(e,t){let{space:r,index:n}=I.resolveCoord(t,e.space);return mr(e,r)[n]}function Oa(e,t,r){return t=I.get(t),e.coords=t.to(e.space,r),e}function Ge(e,t,r){if(e=F(e),arguments.length===2&&We(arguments[1])==="object"){let n=arguments[1];for(let o in n)Ge(e,o,n[o])}else{typeof r=="function"&&(r=r(ye(e,t)));let{space:n,index:o}=I.resolveCoord(t,e.space),i=mr(e,n);i[o]=r,Oa(e,n,i)}return e}var Zo=new I({id:"xyz-d50",name:"XYZ D50",white:"D50",base:$e,fromBase:e=>Ur($e.white,"D50",e),toBase:e=>Ur("D50",$e.white,e),formats:{color:{}}});const Id=216/24389,Wi=24/116,xr=24389/27;let xn=Se.D50;var de=new I({id:"lab",name:"Lab",coords:{l:{refRange:[0,100],name:"L"},a:{refRange:[-125,125]},b:{refRange:[-125,125]}},white:xn,base:Zo,fromBase(e){let r=e.map((n,o)=>n/xn[o]).map(n=>n>Id?Math.cbrt(n):(xr*n+16)/116);return[116*r[1]-16,500*(r[0]-r[1]),200*(r[1]-r[2])]},toBase(e){let t=[];return t[1]=(e[0]+16)/116,t[0]=e[1]/500+t[1],t[2]=t[1]-e[2]/200,[t[0]>Wi?Math.pow(t[0],3):(116*t[0]-16)/xr,e[0]>8?Math.pow((e[0]+16)/116,3):e[0]/xr,t[2]>Wi?Math.pow(t[2],3):(116*t[2]-16)/xr].map((n,o)=>n*xn[o])},formats:{lab:{coords:["<number> | <percentage>","<number>","<number>"]}}});function nn(e){return(e%360+360)%360}function Ed(e,t){if(e==="raw")return t;let[r,n]=t.map(nn),o=n-r;return e==="increasing"?o<0&&(n+=360):e==="decreasing"?o>0&&(r+=360):e==="longer"?-180<o&&o<180&&(o>0?n+=360:r+=360):e==="shorter"&&(o>180?r+=360:o<-180&&(n+=360)),[r,n]}var nr=new I({id:"lch",name:"LCH",coords:{l:{refRange:[0,100],name:"Lightness"},c:{refRange:[0,150],name:"Chroma"},h:{refRange:[0,360],type:"angle",name:"Hue"}},base:de,fromBase(e){let[t,r,n]=e,o;const i=.02;return Math.abs(r)<i&&Math.abs(n)<i?o=NaN:o=Math.atan2(n,r)*180/Math.PI,[t,Math.sqrt(r**2+n**2),nn(o)]},toBase(e){let[t,r,n]=e;return r<0&&(r=0),isNaN(n)&&(n=0),[t,r*Math.cos(n*Math.PI/180),r*Math.sin(n*Math.PI/180)]},formats:{lch:{coords:["<number> | <percentage>","<number>","<number> | <angle>"]}}});const qi=25**7,Gr=Math.PI,Ui=180/Gr,wt=Gr/180;function co(e,t,{kL:r=1,kC:n=1,kH:o=1}={}){let[i,s,a]=de.from(e),l=nr.from(de,[i,s,a])[1],[c,u,d]=de.from(t),p=nr.from(de,[c,u,d])[1];l<0&&(l=0),p<0&&(p=0);let m=((l+p)/2)**7,k=.5*(1-Math.sqrt(m/(m+qi))),y=(1+k)*s,C=(1+k)*u,M=Math.sqrt(y**2+a**2),_=Math.sqrt(C**2+d**2),X=y===0&&a===0?0:Math.atan2(a,y),he=C===0&&d===0?0:Math.atan2(d,C);X<0&&(X+=2*Gr),he<0&&(he+=2*Gr),X*=Ui,he*=Ui;let Le=c-i,Fe=_-M,ie=he-X,tt=X+he,br=Math.abs(ie),pe;M*_===0?pe=0:br<=180?pe=ie:ie>180?pe=ie-360:ie<-180?pe=ie+360:console.log("the unthinkable has happened");let mt=2*Math.sqrt(_*M)*Math.sin(pe*wt/2),zt=(i+c)/2,an=(M+_)/2,ni=Math.pow(an,7),Be;M*_===0?Be=tt:br<=180?Be=tt/2:tt<360?Be=(tt+360)/2:Be=(tt-360)/2;let oi=(zt-50)**2,Ic=1+.015*oi/Math.sqrt(20+oi),ii=1+.045*an,Rt=1;Rt-=.17*Math.cos((Be-30)*wt),Rt+=.24*Math.cos(2*Be*wt),Rt+=.32*Math.cos((3*Be+6)*wt),Rt-=.2*Math.cos((4*Be-63)*wt);let si=1+.015*an*Rt,Ec=30*Math.exp(-1*((Be-275)/25)**2),Tc=2*Math.sqrt(ni/(ni+qi)),Pc=-1*Math.sin(2*Ec*wt)*Tc,$r=(Le/(r*Ic))**2;return $r+=(Fe/(n*ii))**2,$r+=(mt/(o*si))**2,$r+=Pc*(Fe/(n*ii))*(mt/(o*si)),Math.sqrt($r)}const Td=75e-6;function Ut(e,t=e.space,{epsilon:r=Td}={}){e=F(e),t=I.get(t);let n=e.coords;return t!==e.space&&(n=t.from(e)),t.inGamut(n,{epsilon:r})}function or(e){return{space:e.space,coords:e.coords.slice(),alpha:e.alpha}}function Ye(e,{method:t=Te.gamut_mapping,space:r=e.space}={}){if(gr(arguments[1])&&(r=arguments[1]),r=I.get(r),Ut(e,r,{epsilon:0}))return e;let n=be(e,r);if(t!=="clip"&&!Ut(e,r)){let o=Ye(or(n),{method:"clip",space:r});if(co(e,o)>2){let i=I.resolveCoord(t),s=i.space,a=i.id,l=be(n,s),u=(i.range||i.refRange)[0],d=.01,p=u,w=ye(l,a);for(;w-p>d;){let m=or(l);m=Ye(m,{space:r,method:"clip"}),co(l,m)-2<d?p=ye(l,a):w=ye(l,a),Ge(l,a,(p+w)/2)}n=be(l,r)}else n=o}if(t==="clip"||!Ut(n,r,{epsilon:0})){let o=Object.values(r.coords).map(i=>i.range||[]);n.coords=n.coords.map((i,s)=>{let[a,l]=o[s];return a!==void 0&&(i=Math.max(a,i)),l!==void 0&&(i=Math.min(i,l)),i})}return r!==e.space&&(n=be(n,e.space)),e.coords=n.coords,e}Ye.returns="color";function be(e,t,{inGamut:r}={}){e=F(e),t=I.get(t);let n=t.from(e),o={space:t,coords:n,alpha:e.alpha};return r&&(o=Ye(o)),o}be.returns="color";function Yr(e,{precision:t=Te.precision,format:r="default",inGamut:n=!0,...o}={}){var l;let i;e=F(e);let s=r;r=e.space.getFormat(r)??e.space.getFormat("default")??I.DEFAULT_FORMAT,n||(n=r.toGamut);let a=e.coords;if(a=a.map(c=>c||0),n&&!Ut(e)&&(a=Ye(or(e),n===!0?void 0:n).coords),r.type==="custom")if(o.precision=t,r.serialize)i=r.serialize(a,e.alpha,o);else throw new TypeError(`format ${s} can only be used to parse colors, not for serialization`);else{let c=r.name||"color";r.serializeCoords?a=r.serializeCoords(a,t):t!==null&&(a=a.map(w=>Wr(w,t)));let u=[...a];if(c==="color"){let w=r.id||((l=r.ids)==null?void 0:l[0])||e.space.id;u.unshift(w)}let d=e.alpha;t!==null&&(d=Wr(d,t));let p=e.alpha<1&&!r.noAlpha?`${r.commas?",":" /"} ${d}`:"";i=`${c}(${u.join(r.commas?", ":" ")}${p})`}return i}const Pd=[[.6369580483012914,.14461690358620832,.1688809751641721],[.2627002120112671,.6779980715188708,.05930171646986196],[0,.028072693049087428,1.060985057710791]],Ld=[[1.716651187971268,-.355670783776392,-.25336628137366],[-.666684351832489,1.616481236634939,.0157685458139111],[.017639857445311,-.042770613257809,.942103121235474]];var on=new ae({id:"rec2020-linear",name:"Linear REC.2020",white:"D65",toXYZ_M:Pd,fromXYZ_M:Ld,formats:{color:{}}});const kr=1.09929682680944,Gi=.018053968510807;var Da=new ae({id:"rec2020",name:"REC.2020",base:on,toBase(e){return e.map(function(t){return t<Gi*4.5?t/4.5:Math.pow((t+kr-1)/kr,1/.45)})},fromBase(e){return e.map(function(t){return t>=Gi?kr*Math.pow(t,.45)-(kr-1):4.5*t})},formats:{color:{}}});const Bd=[[.4865709486482162,.26566769316909306,.1982172852343625],[.2289745640697488,.6917385218365064,.079286914093745],[0,.04511338185890264,1.043944368900976]],_d=[[2.493496911941425,-.9313836179191239,-.40271078445071684],[-.8294889695615747,1.7626640603183463,.023624685841943577],[.03584583024378447,-.07617238926804182,.9568845240076872]];var Fa=new ae({id:"p3-linear",name:"Linear P3",white:"D65",toXYZ_M:Bd,fromXYZ_M:_d});const zd=[[.41239079926595934,.357584339383878,.1804807884018343],[.21263900587151027,.715168678767756,.07219231536073371],[.01933081871559182,.11919477979462598,.9505321522496607]],Rd=[[3.2409699419045226,-1.537383177570094,-.4986107602930034],[-.9692436362808796,1.8759675015077202,.04155505740717559],[.05563007969699366,-.20397695888897652,1.0569715142428786]];var Za=new ae({id:"srgb-linear",name:"Linear sRGB",white:"D65",toXYZ_M:zd,fromXYZ_M:Rd,formats:{color:{}}}),Yi={aliceblue:[240/255,248/255,1],antiquewhite:[250/255,235/255,215/255],aqua:[0,1,1],aquamarine:[127/255,1,212/255],azure:[240/255,1,1],beige:[245/255,245/255,220/255],bisque:[1,228/255,196/255],black:[0,0,0],blanchedalmond:[1,235/255,205/255],blue:[0,0,1],blueviolet:[138/255,43/255,226/255],brown:[165/255,42/255,42/255],burlywood:[222/255,184/255,135/255],cadetblue:[95/255,158/255,160/255],chartreuse:[127/255,1,0],chocolate:[210/255,105/255,30/255],coral:[1,127/255,80/255],cornflowerblue:[100/255,149/255,237/255],cornsilk:[1,248/255,220/255],crimson:[220/255,20/255,60/255],cyan:[0,1,1],darkblue:[0,0,139/255],darkcyan:[0,139/255,139/255],darkgoldenrod:[184/255,134/255,11/255],darkgray:[169/255,169/255,169/255],darkgreen:[0,100/255,0],darkgrey:[169/255,169/255,169/255],darkkhaki:[189/255,183/255,107/255],darkmagenta:[139/255,0,139/255],darkolivegreen:[85/255,107/255,47/255],darkorange:[1,140/255,0],darkorchid:[153/255,50/255,204/255],darkred:[139/255,0,0],darksalmon:[233/255,150/255,122/255],darkseagreen:[143/255,188/255,143/255],darkslateblue:[72/255,61/255,139/255],darkslategray:[47/255,79/255,79/255],darkslategrey:[47/255,79/255,79/255],darkturquoise:[0,206/255,209/255],darkviolet:[148/255,0,211/255],deeppink:[1,20/255,147/255],deepskyblue:[0,191/255,1],dimgray:[105/255,105/255,105/255],dimgrey:[105/255,105/255,105/255],dodgerblue:[30/255,144/255,1],firebrick:[178/255,34/255,34/255],floralwhite:[1,250/255,240/255],forestgreen:[34/255,139/255,34/255],fuchsia:[1,0,1],gainsboro:[220/255,220/255,220/255],ghostwhite:[248/255,248/255,1],gold:[1,215/255,0],goldenrod:[218/255,165/255,32/255],gray:[128/255,128/255,128/255],green:[0,128/255,0],greenyellow:[173/255,1,47/255],grey:[128/255,128/255,128/255],honeydew:[240/255,1,240/255],hotpink:[1,105/255,180/255],indianred:[205/255,92/255,92/255],indigo:[75/255,0,130/255],ivory:[1,1,240/255],khaki:[240/255,230/255,140/255],lavender:[230/255,230/255,250/255],lavenderblush:[1,240/255,245/255],lawngreen:[124/255,252/255,0],lemonchiffon:[1,250/255,205/255],lightblue:[173/255,216/255,230/255],lightcoral:[240/255,128/255,128/255],lightcyan:[224/255,1,1],lightgoldenrodyellow:[250/255,250/255,210/255],lightgray:[211/255,211/255,211/255],lightgreen:[144/255,238/255,144/255],lightgrey:[211/255,211/255,211/255],lightpink:[1,182/255,193/255],lightsalmon:[1,160/255,122/255],lightseagreen:[32/255,178/255,170/255],lightskyblue:[135/255,206/255,250/255],lightslategray:[119/255,136/255,153/255],lightslategrey:[119/255,136/255,153/255],lightsteelblue:[176/255,196/255,222/255],lightyellow:[1,1,224/255],lime:[0,1,0],limegreen:[50/255,205/255,50/255],linen:[250/255,240/255,230/255],magenta:[1,0,1],maroon:[128/255,0,0],mediumaquamarine:[102/255,205/255,170/255],mediumblue:[0,0,205/255],mediumorchid:[186/255,85/255,211/255],mediumpurple:[147/255,112/255,219/255],mediumseagreen:[60/255,179/255,113/255],mediumslateblue:[123/255,104/255,238/255],mediumspringgreen:[0,250/255,154/255],mediumturquoise:[72/255,209/255,204/255],mediumvioletred:[199/255,21/255,133/255],midnightblue:[25/255,25/255,112/255],mintcream:[245/255,1,250/255],mistyrose:[1,228/255,225/255],moccasin:[1,228/255,181/255],navajowhite:[1,222/255,173/255],navy:[0,0,128/255],oldlace:[253/255,245/255,230/255],olive:[128/255,128/255,0],olivedrab:[107/255,142/255,35/255],orange:[1,165/255,0],orangered:[1,69/255,0],orchid:[218/255,112/255,214/255],palegoldenrod:[238/255,232/255,170/255],palegreen:[152/255,251/255,152/255],paleturquoise:[175/255,238/255,238/255],palevioletred:[219/255,112/255,147/255],papayawhip:[1,239/255,213/255],peachpuff:[1,218/255,185/255],peru:[205/255,133/255,63/255],pink:[1,192/255,203/255],plum:[221/255,160/255,221/255],powderblue:[176/255,224/255,230/255],purple:[128/255,0,128/255],rebeccapurple:[102/255,51/255,153/255],red:[1,0,0],rosybrown:[188/255,143/255,143/255],royalblue:[65/255,105/255,225/255],saddlebrown:[139/255,69/255,19/255],salmon:[250/255,128/255,114/255],sandybrown:[244/255,164/255,96/255],seagreen:[46/255,139/255,87/255],seashell:[1,245/255,238/255],sienna:[160/255,82/255,45/255],silver:[192/255,192/255,192/255],skyblue:[135/255,206/255,235/255],slateblue:[106/255,90/255,205/255],slategray:[112/255,128/255,144/255],slategrey:[112/255,128/255,144/255],snow:[1,250/255,250/255],springgreen:[0,1,127/255],steelblue:[70/255,130/255,180/255],tan:[210/255,180/255,140/255],teal:[0,128/255,128/255],thistle:[216/255,191/255,216/255],tomato:[1,99/255,71/255],turquoise:[64/255,224/255,208/255],violet:[238/255,130/255,238/255],wheat:[245/255,222/255,179/255],white:[1,1,1],whitesmoke:[245/255,245/255,245/255],yellow:[1,1,0],yellowgreen:[154/255,205/255,50/255]};let Ji=Array(3).fill("<percentage> | <number>[0, 255]"),Xi=Array(3).fill("<number>[0, 255]");var ir=new ae({id:"srgb",name:"sRGB",base:Za,fromBase:e=>e.map(t=>{let r=t<0?-1:1,n=t*r;return n>.0031308?r*(1.055*n**(1/2.4)-.055):12.92*t}),toBase:e=>e.map(t=>{let r=t<0?-1:1,n=t*r;return n<.04045?t/12.92:r*((n+.055)/1.055)**2.4}),formats:{rgb:{coords:Ji},rgb_number:{name:"rgb",commas:!0,coords:Xi,noAlpha:!0},color:{},rgba:{coords:Ji,commas:!0,lastAlpha:!0},rgba_number:{name:"rgba",commas:!0,coords:Xi},hex:{type:"custom",toGamut:!0,test:e=>/^#([a-f0-9]{3,4}){1,2}$/i.test(e),parse(e){e.length<=5&&(e=e.replace(/[a-f0-9]/gi,"$&$&"));let t=[];return e.replace(/[a-f0-9]{2}/gi,r=>{t.push(parseInt(r,16)/255)}),{spaceId:"srgb",coords:t.slice(0,3),alpha:t.slice(3)[0]}},serialize:(e,t,{collapse:r=!0}={})=>{t<1&&e.push(t),e=e.map(i=>Math.round(i*255));let n=r&&e.every(i=>i%17===0);return"#"+e.map(i=>n?(i/17).toString(16):i.toString(16).padStart(2,"0")).join("")}},keyword:{type:"custom",test:e=>/^[a-z]+$/i.test(e),parse(e){e=e.toLowerCase();let t={spaceId:"srgb",coords:null,alpha:1};if(e==="transparent"?(t.coords=Yi.black,t.alpha=0):t.coords=Yi[e],t.coords)return t}}}}),Va=new ae({id:"p3",name:"P3",base:Fa,fromBase:ir.fromBase,toBase:ir.toBase,formats:{color:{id:"display-p3"}}});Te.display_space=ir;if(typeof CSS<"u"&&CSS.supports)for(let e of[de,Da,Va]){let t=e.getMinCoords(),n=Yr({space:e,coords:t,alpha:1});if(CSS.supports("color",n)){Te.display_space=e;break}}function jd(e,{space:t=Te.display_space,...r}={}){let n=Yr(e,r);if(typeof CSS>"u"||CSS.supports("color",n)||!Te.display_space)n=new String(n),n.color=e;else{let o=be(e,t);n=new String(Yr(o,r)),n.color=o}return n}function Wa(e,t,r="lab"){r=I.get(r);let n=r.from(e),o=r.from(t);return Math.sqrt(n.reduce((i,s,a)=>{let l=o[a];return isNaN(s)||isNaN(l)?i:i+(l-s)**2},0))}function Nd(e,t){return e=F(e),t=F(t),e.space===t.space&&e.alpha===t.alpha&&e.coords.every((r,n)=>r===t.coords[n])}function Je(e){return ye(e,[$e,"y"])}function qa(e,t){Ge(e,[$e,"y"],t)}function Hd(e){Object.defineProperty(e.prototype,"luminance",{get(){return Je(this)},set(t){qa(this,t)}})}var Od=Object.freeze({__proto__:null,getLuminance:Je,setLuminance:qa,register:Hd});function Dd(e,t){e=F(e),t=F(t);let r=Math.max(Je(e),0),n=Math.max(Je(t),0);return n>r&&([r,n]=[n,r]),(r+.05)/(n+.05)}const Fd=.56,Zd=.57,Vd=.62,Wd=.65,Ki=.022,qd=1.414,Ud=.1,Gd=5e-4,Yd=1.14,Qi=.027,Jd=1.14;function es(e){return e>=Ki?e:e+(Ki-e)**qd}function bt(e){let t=e<0?-1:1,r=Math.abs(e);return t*Math.pow(r,2.4)}function Xd(e,t){t=F(t),e=F(e);let r,n,o,i,s,a;t=be(t,"srgb"),[i,s,a]=t.coords;let l=bt(i)*.2126729+bt(s)*.7151522+bt(a)*.072175;e=be(e,"srgb"),[i,s,a]=e.coords;let c=bt(i)*.2126729+bt(s)*.7151522+bt(a)*.072175,u=es(l),d=es(c),p=d>u;return Math.abs(d-u)<Gd?n=0:p?(r=d**Fd-u**Zd,n=r*Yd):(r=d**Wd-u**Vd,n=r*Jd),Math.abs(n)<Ud?o=0:n>0?o=n-Qi:o=n+Qi,o*100}function Kd(e,t){e=F(e),t=F(t);let r=Math.max(Je(e),0),n=Math.max(Je(t),0);n>r&&([r,n]=[n,r]);let o=r+n;return o===0?0:(r-n)/o}const Qd=5e4;function e1(e,t){e=F(e),t=F(t);let r=Math.max(Je(e),0),n=Math.max(Je(t),0);return n>r&&([r,n]=[n,r]),n===0?Qd:(r-n)/n}function t1(e,t){e=F(e),t=F(t);let r=ye(e,[de,"l"]),n=ye(t,[de,"l"]);return Math.abs(r-n)}const r1=216/24389,ts=24/116,Cr=24389/27;let kn=Se.D65;var uo=new I({id:"lab-d65",name:"Lab D65",coords:{l:{refRange:[0,100],name:"L"},a:{refRange:[-125,125]},b:{refRange:[-125,125]}},white:kn,base:$e,fromBase(e){let r=e.map((n,o)=>n/kn[o]).map(n=>n>r1?Math.cbrt(n):(Cr*n+16)/116);return[116*r[1]-16,500*(r[0]-r[1]),200*(r[1]-r[2])]},toBase(e){let t=[];return t[1]=(e[0]+16)/116,t[0]=e[1]/500+t[1],t[2]=t[1]-e[2]/200,[t[0]>ts?Math.pow(t[0],3):(116*t[0]-16)/Cr,e[0]>8?Math.pow((e[0]+16)/116,3):e[0]/Cr,t[2]>ts?Math.pow(t[2],3):(116*t[2]-16)/Cr].map((n,o)=>n*kn[o])},formats:{"lab-d65":{coords:["<number> | <percentage>","<number>","<number>"]}}});const Cn=Math.pow(5,.5)*.5+.5;function n1(e,t){e=F(e),t=F(t);let r=ye(e,[uo,"l"]),n=ye(t,[uo,"l"]),o=Math.abs(Math.pow(r,Cn)-Math.pow(n,Cn)),i=Math.pow(o,1/Cn)*Math.SQRT2-40;return i<7.5?0:i}var jr=Object.freeze({__proto__:null,contrastWCAG21:Dd,contrastAPCA:Xd,contrastMichelson:Kd,contrastWeber:e1,contrastLstar:t1,contrastDeltaPhi:n1});function o1(e,t,r={}){gr(r)&&(r={algorithm:r});let{algorithm:n,...o}=r;if(!n){let i=Object.keys(jr).map(s=>s.replace(/^contrast/,"")).join(", ");throw new TypeError(`contrast() function needs a contrast algorithm. Please specify one of: ${i}`)}e=F(e),t=F(t);for(let i in jr)if("contrast"+n.toLowerCase()===i.toLowerCase())return jr[i](e,t,o);throw new TypeError(`Unknown contrast algorithm: ${n}`)}function Ua(e){let[t,r,n]=mr(e,$e),o=t+15*r+3*n;return[4*t/o,9*r/o]}function Ga(e){let[t,r,n]=mr(e,$e),o=t+r+n;return[t/o,r/o]}function i1(e){Object.defineProperty(e.prototype,"uv",{get(){return Ua(this)}}),Object.defineProperty(e.prototype,"xy",{get(){return Ga(this)}})}var s1=Object.freeze({__proto__:null,uv:Ua,xy:Ga,register:i1});function a1(e,t){return Wa(e,t,"lab")}const l1=Math.PI,rs=l1/180;function c1(e,t,{l:r=2,c:n=1}={}){let[o,i,s]=de.from(e),[,a,l]=nr.from(de,[o,i,s]),[c,u,d]=de.from(t),p=nr.from(de,[c,u,d])[1];a<0&&(a=0),p<0&&(p=0);let w=o-c,m=a-p,k=i-u,y=s-d,C=k**2+y**2-m**2,M=.511;o>=16&&(M=.040975*o/(1+.01765*o));let _=.0638*a/(1+.0131*a)+.638,X;Number.isNaN(l)&&(l=0),l>=164&&l<=345?X=.56+Math.abs(.2*Math.cos((l+168)*rs)):X=.36+Math.abs(.4*Math.cos((l+35)*rs));let he=Math.pow(a,4),Le=Math.sqrt(he/(he+1900)),Fe=_*(Le*X+1-Le),ie=(w/(r*M))**2;return ie+=(m/(n*_))**2,ie+=C/Fe**2,Math.sqrt(ie)}const ns=203;var Vo=new I({id:"xyz-abs-d65",name:"Absolute XYZ D65",coords:{x:{refRange:[0,9504.7],name:"Xa"},y:{refRange:[0,1e4],name:"Ya"},z:{refRange:[0,10888.3],name:"Za"}},base:$e,fromBase(e){return e.map(t=>Math.max(t*ns,0))},toBase(e){return e.map(t=>Math.max(t/ns,0))}});const Sr=1.15,Mr=.66,os=2610/2**14,d1=2**14/2610,is=3424/2**12,ss=2413/2**7,as=2392/2**7,u1=1.7*2523/2**5,ls=2**5/(1.7*2523),Ar=-.56,Sn=16295499532821565e-27,h1=[[.41478972,.579999,.014648],[-.20151,1.120649,.0531008],[-.0166008,.2648,.6684799]],p1=[[1.9242264357876067,-1.0047923125953657,.037651404030618],[.35031676209499907,.7264811939316552,-.06538442294808501],[-.09098281098284752,-.3127282905230739,1.5227665613052603]],f1=[[.5,.5,0],[3.524,-4.066708,.542708],[.199076,1.096799,-1.295875]],g1=[[1,.1386050432715393,.05804731615611886],[.9999999999999999,-.1386050432715393,-.05804731615611886],[.9999999999999998,-.09601924202631895,-.8118918960560388]];var Ya=new I({id:"jzazbz",name:"Jzazbz",coords:{jz:{refRange:[0,1],name:"Jz"},az:{refRange:[-.5,.5]},bz:{refRange:[-.5,.5]}},base:Vo,fromBase(e){let[t,r,n]=e,o=Sr*t-(Sr-1)*n,i=Mr*r-(Mr-1)*t,a=G(h1,[o,i,n]).map(function(p){let w=is+ss*(p/1e4)**os,m=1+as*(p/1e4)**os;return(w/m)**u1}),[l,c,u]=G(f1,a);return[(1+Ar)*l/(1+Ar*l)-Sn,c,u]},toBase(e){let[t,r,n]=e,o=(t+Sn)/(1+Ar-Ar*(t+Sn)),s=G(g1,[o,r,n]).map(function(p){let w=is-p**ls,m=as*p**ls-ss;return 1e4*(w/m)**d1}),[a,l,c]=G(p1,s),u=(a+(Sr-1)*c)/Sr,d=(l+(Mr-1)*u)/Mr;return[u,d,c]},formats:{color:{}}}),ho=new I({id:"jzczhz",name:"JzCzHz",coords:{jz:{refRange:[0,1],name:"Jz"},cz:{refRange:[0,1],name:"Chroma"},hz:{refRange:[0,360],type:"angle",name:"Hue"}},base:Ya,fromBase(e){let[t,r,n]=e,o;const i=2e-4;return Math.abs(r)<i&&Math.abs(n)<i?o=NaN:o=Math.atan2(n,r)*180/Math.PI,[t,Math.sqrt(r**2+n**2),nn(o)]},toBase(e){return[e[0],e[1]*Math.cos(e[2]*Math.PI/180),e[1]*Math.sin(e[2]*Math.PI/180)]},formats:{color:{}}});function m1(e,t){let[r,n,o]=ho.from(e),[i,s,a]=ho.from(t),l=r-i,c=n-s;Number.isNaN(o)&&Number.isNaN(a)?(o=0,a=0):Number.isNaN(o)?o=a:Number.isNaN(a)&&(a=o);let u=o-a,d=2*Math.sqrt(n*s)*Math.sin(u/2*(Math.PI/180));return Math.sqrt(l**2+c**2+d**2)}const Ja=3424/4096,Xa=2413/128,Ka=2392/128,cs=2610/16384,v1=2523/32,w1=16384/2610,ds=32/2523,b1=[[.3592,.6976,-.0358],[-.1922,1.1004,.0755],[.007,.0749,.8434]],$1=[[2048/4096,2048/4096,0],[6610/4096,-13613/4096,7003/4096],[17933/4096,-17390/4096,-543/4096]],y1=[[.9999888965628402,.008605050147287059,.11103437159861648],[1.00001110343716,-.008605050147287059,-.11103437159861648],[1.0000320633910054,.56004913547279,-.3206339100541203]],x1=[[2.0701800566956137,-1.326456876103021,.20661600684785517],[.3649882500326575,.6804673628522352,-.04542175307585323],[-.04959554223893211,-.04942116118675749,1.1879959417328034]];var po=new I({id:"ictcp",name:"ICTCP",coords:{i:{refRange:[0,1],name:"I"},ct:{refRange:[-.5,.5],name:"CT"},cp:{refRange:[-.5,.5],name:"CP"}},base:Vo,fromBase(e){let t=G(b1,e);return k1(t)},toBase(e){let t=C1(e);return G(x1,t)},formats:{color:{}}});function k1(e){let t=e.map(function(r){let n=Ja+Xa*(r/1e4)**cs,o=1+Ka*(r/1e4)**cs;return(n/o)**v1});return G($1,t)}function C1(e){return G(y1,e).map(function(n){let o=Math.max(n**ds-Ja,0),i=Xa-Ka*n**ds;return 1e4*(o/i)**w1})}function S1(e,t){let[r,n,o]=po.from(e),[i,s,a]=po.from(t);return 720*Math.sqrt((r-i)**2+.25*(n-s)**2+(o-a)**2)}const M1=[[.8190224432164319,.3619062562801221,-.12887378261216414],[.0329836671980271,.9292868468965546,.03614466816999844],[.048177199566046255,.26423952494422764,.6335478258136937]],A1=[[1.2268798733741557,-.5578149965554813,.28139105017721583],[-.04057576262431372,1.1122868293970594,-.07171106666151701],[-.07637294974672142,-.4214933239627914,1.5869240244272418]],I1=[[.2104542553,.793617785,-.0040720468],[1.9779984951,-2.428592205,.4505937099],[.0259040371,.7827717662,-.808675766]],E1=[[.9999999984505198,.39633779217376786,.2158037580607588],[1.0000000088817609,-.10556134232365635,-.06385417477170591],[1.0000000546724108,-.08948418209496575,-1.2914855378640917]];var Jr=new I({id:"oklab",name:"OKLab",coords:{l:{refRange:[0,1],name:"L"},a:{refRange:[-.4,.4]},b:{refRange:[-.4,.4]}},white:"D65",base:$e,fromBase(e){let r=G(M1,e).map(n=>Math.cbrt(n));return G(I1,r)},toBase(e){let r=G(E1,e).map(n=>n**3);return G(A1,r)},formats:{oklab:{coords:["<number> | <percentage>","<number>","<number>"]}}});function T1(e,t){let[r,n,o]=Jr.from(e),[i,s,a]=Jr.from(t),l=r-i,c=n-s,u=o-a;return Math.sqrt(l**2+c**2+u**2)}var fo=Object.freeze({__proto__:null,deltaE76:a1,deltaECMC:c1,deltaE2000:co,deltaEJz:m1,deltaEITP:S1,deltaEOK:T1});function Ft(e,t,r={}){gr(r)&&(r={method:r});let{method:n=Te.deltaE,...o}=r;e=F(e),t=F(t);for(let i in fo)if("deltae"+n.toLowerCase()===i.toLowerCase())return fo[i](e,t,o);throw new TypeError(`Unknown deltaE method: ${n}`)}function P1(e,t=.25){let n=[I.get("oklch","lch"),"l"];return Ge(e,n,o=>o*(1+t))}function L1(e,t=.25){let n=[I.get("oklch","lch"),"l"];return Ge(e,n,o=>o*(1-t))}var B1=Object.freeze({__proto__:null,lighten:P1,darken:L1});function Qa(e,t,r=.5,n={}){[e,t]=[F(e),F(t)],We(r)==="object"&&([r,n]=[.5,r]);let{space:o,outputSpace:i,premultiplied:s}=n;return vr(e,t,{space:o,outputSpace:i,premultiplied:s})(r)}function el(e,t,r={}){let n;Wo(e)&&([n,r]=[e,t],[e,t]=n.rangeArgs.colors);let{maxDeltaE:o,deltaEMethod:i,steps:s=2,maxSteps:a=1e3,...l}=r;n||([e,t]=[F(e),F(t)],n=vr(e,t,l));let c=Ft(e,t),u=o>0?Math.max(s,Math.ceil(c/o)+1):s,d=[];if(a!==void 0&&(u=Math.min(u,a)),u===1)d=[{p:.5,color:n(.5)}];else{let p=1/(u-1);d=Array.from({length:u},(w,m)=>{let k=m*p;return{p:k,color:n(k)}})}if(o>0){let p=d.reduce((w,m,k)=>{if(k===0)return 0;let y=Ft(m.color,d[k-1].color,i);return Math.max(w,y)},0);for(;p>o;){p=0;for(let w=1;w<d.length&&d.length<a;w++){let m=d[w-1],k=d[w],y=(k.p+m.p)/2,C=n(y);p=Math.max(p,Ft(C,m.color),Ft(C,k.color)),d.splice(w,0,{p:y,color:n(y)}),w++}}}return d=d.map(p=>p.color),d}function vr(e,t,r={}){if(Wo(e)){let[l,c]=[e,t];return vr(...l.rangeArgs.colors,{...l.rangeArgs.options,...c})}let{space:n,outputSpace:o,progression:i,premultiplied:s}=r;e=F(e),t=F(t),e=or(e),t=or(t);let a={colors:[e,t],options:r};if(n?n=I.get(n):n=I.registry[Te.interpolationSpace]||e.space,o=o?I.get(o):n,e=be(e,n),t=be(t,n),e=Ye(e),t=Ye(t),n.coords.h&&n.coords.h.type==="angle"){let l=r.hue=r.hue||"shorter",c=[n,"h"],[u,d]=[ye(e,c),ye(t,c)];[u,d]=Ed(l,[u,d]),Ge(e,c,u),Ge(t,c,d)}return s&&(e.coords=e.coords.map(l=>l*e.alpha),t.coords=t.coords.map(l=>l*t.alpha)),Object.assign(l=>{l=i?i(l):l;let c=e.coords.map((p,w)=>{let m=t.coords[w];return qr(p,m,l)}),u=qr(e.alpha,t.alpha,l),d={space:n,coords:c,alpha:u};return s&&(d.coords=d.coords.map(p=>p/u)),o!==n&&(d=be(d,o)),d},{rangeArgs:a})}function Wo(e){return We(e)==="function"&&!!e.rangeArgs}Te.interpolationSpace="lab";function _1(e){e.defineFunction("mix",Qa,{returns:"color"}),e.defineFunction("range",vr,{returns:"function<color>"}),e.defineFunction("steps",el,{returns:"array<color>"})}var z1=Object.freeze({__proto__:null,mix:Qa,steps:el,range:vr,isRange:Wo,register:_1}),tl=new I({id:"hsl",name:"HSL",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,100],name:"Saturation"},l:{range:[0,100],name:"Lightness"}},base:ir,fromBase:e=>{let t=Math.max(...e),r=Math.min(...e),[n,o,i]=e,[s,a,l]=[NaN,0,(r+t)/2],c=t-r;if(c!==0){switch(a=l===0||l===1?0:(t-l)/Math.min(l,1-l),t){case n:s=(o-i)/c+(o<i?6:0);break;case o:s=(i-n)/c+2;break;case i:s=(n-o)/c+4}s=s*60}return[s,a*100,l*100]},toBase:e=>{let[t,r,n]=e;t=t%360,t<0&&(t+=360),r/=100,n/=100;function o(i){let s=(i+t/30)%12,a=r*Math.min(n,1-n);return n-a*Math.max(-1,Math.min(s-3,9-s,1))}return[o(0),o(8),o(4)]},formats:{hsl:{toGamut:!0,coords:["<number> | <angle>","<percentage>","<percentage>"]},hsla:{coords:["<number> | <angle>","<percentage>","<percentage>"],commas:!0,lastAlpha:!0}}}),rl=new I({id:"hsv",name:"HSV",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,100],name:"Saturation"},v:{range:[0,100],name:"Value"}},base:tl,fromBase(e){let[t,r,n]=e;r/=100,n/=100;let o=n+r*Math.min(n,1-n);return[t,o===0?0:200*(1-n/o),100*o]},toBase(e){let[t,r,n]=e;r/=100,n/=100;let o=n*(1-r/2);return[t,o===0||o===1?0:(n-o)/Math.min(o,1-o)*100,o*100]},formats:{color:{toGamut:!0}}}),R1=new I({id:"hwb",name:"HWB",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},w:{range:[0,100],name:"Whiteness"},b:{range:[0,100],name:"Blackness"}},base:rl,fromBase(e){let[t,r,n]=e;return[t,n*(100-r)/100,100-n]},toBase(e){let[t,r,n]=e;r/=100,n/=100;let o=r+n;if(o>=1){let a=r/o;return[t,0,a*100]}let i=1-n,s=i===0?0:1-r/i;return[t,s*100,i*100]},formats:{hwb:{toGamut:!0,coords:["<number> | <angle>","<percentage>","<percentage>"]}}});const j1=[[.5766690429101305,.1855582379065463,.1882286462349947],[.29734497525053605,.6273635662554661,.07529145849399788],[.02703136138641234,.07068885253582723,.9913375368376388]],N1=[[2.0415879038107465,-.5650069742788596,-.34473135077832956],[-.9692436362808795,1.8759675015077202,.04155505740717557],[.013444280632031142,-.11836239223101838,1.0151749943912054]];var nl=new ae({id:"a98rgb-linear",name:"Linear Adobe® 98 RGB compatible",white:"D65",toXYZ_M:j1,fromXYZ_M:N1}),H1=new ae({id:"a98rgb",name:"Adobe® 98 RGB compatible",base:nl,toBase:e=>e.map(t=>Math.pow(Math.abs(t),563/256)*Math.sign(t)),fromBase:e=>e.map(t=>Math.pow(Math.abs(t),256/563)*Math.sign(t)),formats:{color:{id:"a98-rgb"}}});const O1=[[.7977604896723027,.13518583717574031,.0313493495815248],[.2880711282292934,.7118432178101014,8565396060525902e-20],[0,0,.8251046025104601]],D1=[[1.3457989731028281,-.25558010007997534,-.05110628506753401],[-.5446224939028347,1.5082327413132781,.02053603239147973],[0,0,1.2119675456389454]];var ol=new ae({id:"prophoto-linear",name:"Linear ProPhoto",white:"D50",base:Zo,toXYZ_M:O1,fromXYZ_M:D1});const F1=1/512,Z1=16/512;var V1=new ae({id:"prophoto",name:"ProPhoto",base:ol,toBase(e){return e.map(t=>t<Z1?t/16:t**1.8)},fromBase(e){return e.map(t=>t>=F1?t**(1/1.8):16*t)},formats:{color:{id:"prophoto-rgb"}}}),W1=new I({id:"oklch",name:"OKLCh",coords:{l:{refRange:[0,1],name:"Lightness"},c:{refRange:[0,.4],name:"Chroma"},h:{refRange:[0,360],type:"angle",name:"Hue"}},white:"D65",base:Jr,fromBase(e){let[t,r,n]=e,o;const i=2e-4;return Math.abs(r)<i&&Math.abs(n)<i?o=NaN:o=Math.atan2(n,r)*180/Math.PI,[t,Math.sqrt(r**2+n**2),nn(o)]},toBase(e){let[t,r,n]=e,o,i;return isNaN(n)?(o=0,i=0):(o=r*Math.cos(n*Math.PI/180),i=r*Math.sin(n*Math.PI/180)),[t,o,i]},formats:{oklch:{coords:["<number> | <percentage>","<number>","<number> | <angle>"]}}});const us=203,hs=2610/2**14,q1=2**14/2610,U1=2523/2**5,ps=2**5/2523,fs=3424/2**12,gs=2413/2**7,ms=2392/2**7;var G1=new ae({id:"rec2100pq",name:"REC.2100-PQ",base:on,toBase(e){return e.map(function(t){return(Math.max(t**ps-fs,0)/(gs-ms*t**ps))**q1*1e4/us})},fromBase(e){return e.map(function(t){let r=Math.max(t*us/1e4,0),n=fs+gs*r**hs,o=1+ms*r**hs;return(n/o)**U1})},formats:{color:{id:"rec2100-pq"}}});const vs=.17883277,ws=.28466892,bs=.55991073,Mn=3.7743;var Y1=new ae({id:"rec2100hlg",cssid:"rec2100-hlg",name:"REC.2100-HLG",referred:"scene",base:on,toBase(e){return e.map(function(t){return t<=.5?t**2/3*Mn:Math.exp((t-bs)/vs+ws)/12*Mn})},fromBase(e){return e.map(function(t){return t/=Mn,t<=1/12?Math.sqrt(3*t):vs*Math.log(12*t-ws)+bs})},formats:{color:{id:"rec2100-hlg"}}});const il={};Ue.add("chromatic-adaptation-start",e=>{e.options.method&&(e.M=sl(e.W1,e.W2,e.options.method))});Ue.add("chromatic-adaptation-end",e=>{e.M||(e.M=sl(e.W1,e.W2,e.options.method))});function sn({id:e,toCone_M:t,fromCone_M:r}){il[e]=arguments[0]}function sl(e,t,r="Bradford"){let n=il[r],[o,i,s]=G(n.toCone_M,e),[a,l,c]=G(n.toCone_M,t),u=[[a/o,0,0],[0,l/i,0],[0,0,c/s]],d=G(u,n.toCone_M);return G(n.fromCone_M,d)}sn({id:"von Kries",toCone_M:[[.40024,.7076,-.08081],[-.2263,1.16532,.0457],[0,0,.91822]],fromCone_M:[[1.8599364,-1.1293816,.2198974],[.3611914,.6388125,-64e-7],[0,0,1.0890636]]});sn({id:"Bradford",toCone_M:[[.8951,.2664,-.1614],[-.7502,1.7135,.0367],[.0389,-.0685,1.0296]],fromCone_M:[[.9869929,-.1470543,.1599627],[.4323053,.5183603,.0492912],[-.0085287,.0400428,.9684867]]});sn({id:"CAT02",toCone_M:[[.7328,.4296,-.1624],[-.7036,1.6975,.0061],[.003,.0136,.9834]],fromCone_M:[[1.0961238,-.278869,.1827452],[.454369,.4735332,.0720978],[-.0096276,-.005698,1.0153256]]});sn({id:"CAT16",toCone_M:[[.401288,.650173,-.051461],[-.250268,1.204414,.045854],[-.002079,.048952,.953127]],fromCone_M:[[1.862067855087233,-1.011254630531685,.1491867754444518],[.3875265432361372,.6214474419314753,-.008973985167612518],[-.01584149884933386,-.03412293802851557,1.04996443687785]]});Object.assign(Se,{A:[1.0985,1,.35585],C:[.98074,1,1.18232],D55:[.95682,1,.92149],D75:[.94972,1,1.22638],E:[1,1,1],F2:[.99186,1,.67393],F7:[.95041,1,1.08747],F11:[1.00962,1,.6435]});Se.ACES=[.32168/.33767,1,(1-.32168-.33767)/.33767];const J1=[[.6624541811085053,.13400420645643313,.1561876870049078],[.27222871678091454,.6740817658111484,.05368951740793705],[-.005574649490394108,.004060733528982826,1.0103391003129971]],X1=[[1.6410233796943257,-.32480329418479,-.23642469523761225],[-.6636628587229829,1.6153315916573379,.016756347685530137],[.011721894328375376,-.008284441996237409,.9883948585390215]];var al=new ae({id:"acescg",name:"ACEScg",coords:{r:{range:[0,65504],name:"Red"},g:{range:[0,65504],name:"Green"},b:{range:[0,65504],name:"Blue"}},referred:"scene",white:Se.ACES,toXYZ_M:J1,fromXYZ_M:X1,formats:{color:{}}});const Ir=2**-16,An=-.35828683,Er=(Math.log2(65504)+9.72)/17.52;var K1=new ae({id:"acescc",name:"ACEScc",coords:{r:{range:[An,Er],name:"Red"},g:{range:[An,Er],name:"Green"},b:{range:[An,Er],name:"Blue"}},referred:"scene",base:al,toBase(e){const t=-.3013698630136986;return e.map(function(r){return r<=t?(2**(r*17.52-9.72)-Ir)*2:r<Er?2**(r*17.52-9.72):65504})},fromBase(e){return e.map(function(t){return t<=0?(Math.log2(Ir)+9.72)/17.52:t<Ir?(Math.log2(Ir+t*.5)+9.72)/17.52:(Math.log2(t)+9.72)/17.52})},formats:{color:{}}}),$s=Object.freeze({__proto__:null,XYZ_D65:$e,XYZ_D50:Zo,XYZ_ABS_D65:Vo,Lab_D65:uo,Lab:de,LCH:nr,sRGB_Linear:Za,sRGB:ir,HSL:tl,HWB:R1,HSV:rl,P3_Linear:Fa,P3:Va,A98RGB_Linear:nl,A98RGB:H1,ProPhoto_Linear:ol,ProPhoto:V1,REC_2020_Linear:on,REC_2020:Da,OKLab:Jr,OKLCH:W1,Jzazbz:Ya,JzCzHz:ho,ICTCP:po,REC_2100_PQ:G1,REC_2100_HLG:Y1,ACEScg:al,ACEScc:K1}),ct;const te=class{constructor(...t){jt(this,ct,void 0);let r;t.length===1&&(r=F(t[0]));let n,o,i;r?(n=r.space||r.spaceId,o=r.coords,i=r.alpha):[n,o,i]=t,dn(this,ct,I.get(n)),this.coords=o?o.slice():[0,0,0],this.alpha=i<1?i:1;for(let s=0;s<this.coords.length;s++)this.coords[s]==="NaN"&&(this.coords[s]=NaN);for(let s in vt(this,ct).coords)Object.defineProperty(this,s,{get:()=>this.get(s),set:a=>this.set(s,a)})}get space(){return vt(this,ct)}get spaceId(){return vt(this,ct).id}clone(){return new te(this.space,this.coords,this.alpha)}toJSON(){return{spaceId:this.spaceId,coords:this.coords,alpha:this.alpha}}display(...t){let r=jd(this,...t);return r.color=new te(r.color),r}static get(t,...r){return t instanceof te?t:new te(t,...r)}static defineFunction(t,r,n=r){let{instance:o=!0,returns:i}=n,s=function(...a){let l=r(...a);if(i==="color")l=te.get(l);else if(i==="function<color>"){let c=l;l=function(...u){let d=c(...u);return te.get(d)},Object.assign(l,c)}else i==="array<color>"&&(l=l.map(c=>te.get(c)));return l};t in te||(te[t]=s),o&&(te.prototype[t]=function(...a){return s(this,...a)})}static defineFunctions(t){for(let r in t)te.defineFunction(r,t[r],t[r])}static extend(t){if(t.register)t.register(te);else for(let r in t)te.defineFunction(r,t[r])}};let Z=te;ct=new WeakMap;Z.defineFunctions({get:ye,getAll:mr,set:Ge,setAll:Oa,to:be,equals:Nd,inGamut:Ut,toGamut:Ye,distance:Wa,toString:Yr});Object.assign(Z,{util:Sd,hooks:Ue,WHITES:Se,Space:I,spaces:I.registry,parse:Ha,defaults:Te});for(let e of Object.keys($s))I.register($s[e]);for(let e in I.registry)go(e,I.registry[e]);Ue.add("colorspace-init-end",e=>{var t;go(e.id,e),(t=e.aliases)==null||t.forEach(r=>{go(r,e)})});function go(e,t){Object.keys(t.coords),Object.values(t.coords).map(n=>n.name);let r=e.replace(/-/g,"_");Object.defineProperty(Z.prototype,r,{get(){let n=this.getAll(e);return typeof Proxy>"u"?n:new Proxy(n,{has:(o,i)=>{try{return I.resolveCoord([t,i]),!0}catch{}return Reflect.has(o,i)},get:(o,i,s)=>{if(i&&typeof i!="symbol"&&!(i in o)){let{index:a}=I.resolveCoord([t,i]);if(a>=0)return o[a]}return Reflect.get(o,i,s)},set:(o,i,s,a)=>{if(i&&typeof i!="symbol"&&!(i in o)||i>=0){let{index:l}=I.resolveCoord([t,i]);if(l>=0)return o[l]=s,this.setAll(e,o),!0}return Reflect.set(o,i,s,a)}})},set(n){this.setAll(e,n)},configurable:!0,enumerable:!0})}Z.extend(fo);Z.extend({deltaE:Ft});Z.extend(B1);Z.extend({contrast:o1});Z.extend(s1);Z.extend(Od);Z.extend(z1);Z.extend(jr);function ll(e){return Zc(e,(t,r)=>r instanceof Z?B(r.toString({format:"hex"})):ll(r))}const Q1="dodgerblue";function mo(e){const t=Math.abs(e.contrast("white","APCA")),r=Math.abs(e.contrast("black","APCA"));return t>r?"white":"black"}function In({background:e,foreground:t}){return{background:e??new Z(mo(t)),foreground:t??new Z(mo(e))}}var Xr;(function(e){e.Dark="dark",e.Light="light"})(Xr||(Xr={}));function eu(e){return e==="black"?"white":"black"}const tu={black:{foregroundFaint1:new Z("#ccc"),foregroundFaint2:new Z("#eee")},white:{foregroundFaint1:new Z("#ccc"),foregroundFaint2:new Z("#eee")}},ru={black:{backgroundFaint1:new Z("#666"),backgroundFaint2:new Z("#444")},white:{backgroundFaint1:new Z("#ccc"),backgroundFaint2:new Z("#fafafa")}};function ys({themeColor:e=Q1,themeStyle:t=Xr.Light}={}){const r=new Z(e),n=new Z(t===Xr.Dark?"black":"white"),o=mo(n),i=new Z(o),s={nav:{hover:In({background:r.clone().set({"hsl.l":93})}),active:In({background:r.clone().set({"hsl.l":90})}),selected:In({background:r.clone().set({"hsl.l":85})})},accent:{icon:r.clone().set({"hsl.l":40})},page:{background:n,...ru[eu(o)],foreground:i,...tu[o]}};return ll(s)}const cl=Do()("change-page"),vo=fr({"vir-icon-color":"currentColor"}),nu=fr({"vir-icon-stroke-color":vo["vir-icon-color"].value,"vir-icon-fill-color":vo["vir-icon-color"].value}),En={...vo,...nu};function dl({name:e,svgTemplate:t}){return{name:e,templateString:typeof t=="string"?t:oo(t)}}const qe=tn()({tagName:"vir-icon",hostClasses:{"vir-icon-fit-icon":({inputs:e})=>!!e.fitContainer},styles:({hostClassSelectors:e})=>f`
    ...
    `}),{defineElement:gt,defineElementNoInputs:sf}=$a(),ne=gt()({tagName:"element-book-route-link",cssVars:{anchorPadding:""},styles:({cssVarValues:e})=>f`
        a {
    ...
    `,renderCallback:({inputs:e,dispatch:t})=>{var n,o;const r=((o=e.router)==null?void 0:o.createRoutesUrl({...(n=e.router)==null?void 0:n.getCurrentRawRoutes(),...e.route}))??"#";return h`
            <a
                href=${r}
                ${A("click",i=>{(!e.router||nd(i))&&(i.preventDefault(),window.scrollTo(0,0),t(new cl(e.route)))})}
            >
                <slot></slot>
            </a>
...
`,Pr=gt()({tagName:"element-book-example-controls",styles:f`
    ...
    `,initCallback({updateState:e,state:t,inputs:r,host:n}){if(r.baseUrl&&!t.router){const o=gd(r.baseUrl);e({router:o}),o.addRouteListener(!0,i=>{e({currentRoute:i})})}},renderCallback:({state:e,inputs:t,host:r,updateState:n})=>{var i;try{let a=function(d){e.router?e.router.setRoutes(d):n({currentRoute:{...e.currentRoute,...d}})};var o=a;const s={themeColor:t.themeColor};if(!Bo(s,(i=e.colors)==null?void 0:i.config)){const d=ys(s);n({colors:{config:s,theme:d}}),Cd(r,d)}const l=Hc(au,t.entries,()=>Yc(t.entries,t.everythingTitle));if(!Yn(e.currentRoute.paths.slice(1),l)){const d=Object.values(l.children)[0];if(!d)throw new Error("No entries exist.");const p=cr(d.entry,!0),w=t.defaultPath??(p.length?p:void 0);if(w&&w.length){const m={paths:[we.Book,...w]};a(m)}}const u=Yn(e.currentRoute.paths.slice(1),l);if(!u)throw new Error(`Tried to self-correct for invalid path ${e.currentRoute.paths.join("/")}
                ...
                <div
                    class="root"
                    ${A(cl,d=>{const p=r.shadowRoot.querySelector($t.tagName);p?p.scroll({top:0,behavior:"smooth"}):console.error(`Failed to find '${$t.tagName}' for scrolling.`),a(d.detail)})}
                >
                    <${Tr}
...
`))}const W=(()=>{const e=f`
    ...
    `,d=f`
        ${Ae("monospaceFont")}
    `;return Uo()({toniqFont:e,normalWeightFont:t,boldFont:r,extraBoldFont:n,paragraphFont:o,boldParagraphFont:i,labelFont:s,boldLabelFont:a,h1Font:l,h2Font:c,h3Font:u,monospaceFont:d})})(),ze={color:"--toniq-icon-color",strokeColor:"--toniq-icon-stroke-color",fillColor:"--toniq-icon-fill-color"};function Es(e,t){return`var(${e}, var(${ze.color}, ${t}))`}const x={stroke:(e="currentColor")=>Es(ze.strokeColor,e),fill:(e="currentColor")=>Es(ze.fillColor,e)},et=f`
    background: none;
    padding: 0;
    margin: 0;
    border: none;
...
`,$l=ee({title:"Data",parent:void 0}),Ts="toniq-",{defineElement:oe,defineElementNoInputs:af}=$a({assertInputs:e=>{if(!e.tagName.startsWith(Ts))throw new Error(`Tag name should start with '${Ts}' but got '${e.tagName}'`)}}),v=oe()({tagName:"toniq-icon",hostClasses:{"icon-fit":!1},styles:({hostClassSelectors:e})=>f`
        :host {
            display: block;
        }
        svg {
    ...
    `),R2=new b("BrandTiktokFlat24Icon",$`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            xml:space="preserve"
            fill-rule="evenodd"
    ...
    `),Xt={"core-16":[Lu,Bu,zu,Yt],"core-24":[Ru,ju,Jo,Nu,Cl,Xo,$o,Hu,Ou,Du,Fu,Zu,Vu,Wu,Sl,Ml,qu,Uu,Mt,Gu,Yu,Ju,Xu,Al,Il,Ku,Qu,e2,t2,El,r2,n2,o2,i2,s2,a2,l2,c2,d2,u2,h2,p2,f2,Tl,g2,m2,v2,w2,b2,yo,Pl,$2,y2,x2,k2,C2,Jt,S2,M2,A2,I2,E2,T2],"core-32":[Ll],"core-48":[Bl],"core-64":[_l,P2,L2],logos:[B2],"third-party-brands":[zl,_2,Rl,z2,jl,Nl,R2,Hl,Ol]},Nr="templates-container",j2=4e3,V=oe()({tagName:"toniq-carousel",cssVars:{"arrow-margin":"40px"},hostClasses:{"banner-style":!1},stateInit:{currentScrollPosition:{left:0,right:1/0},templatesWrapperHeight:0,scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({cssVarValues:e,hostClassSelectors:t})=>f`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
            ...
            >
                <div class="arrow left">
                    <${v}
                        ...
                        ${g(v,{icon:Jo})}
                        ${A("click",()=>{jn({allowWrapping:!1,blockIfHovering:!1,direction:"left",host:n})})}
                    ></${v}>
                </div>
                ${e.templates.map(s=>h`
    ...
    `,renderCallback:({inputs:e})=>{const t=e.icon?h`
            ...
            ${t}
            <slot>${e.text}</slot>
        `}}),H2="data-test-id",At=De(class extends Ke{constructor(e){super(e),this.element=O2(e,"testId",HTMLElement)}render(e){return this.element.setAttribute(H2,e),xe}});function O2(e,t,r){D2(e,t);const n=e.element;if(!(n instanceof r))throw new Error(`${t} attached to non ${r.name} element.`);return n}function D2(e,t){if(e.type!==dr.ELEMENT)throw new Error(`${t} directive can only be attached directly to an element.`);if(!e.element)throw new Error(`${t} directive found no element.`)}const N=oe()({tagName:"toniq-dropdown",stateInit:{dropdownOpen:!1},events:{selectChange:ue()},styles:f`
        :host {
            display: inline-flex;
            vertical-align: middle;
            width: 288px;
    ...
    `,initCallback:({state:e,host:t,updateState:r})=>{function n(o){var a;const i=(a=t.shadowRoot)==null?void 0:a.querySelector("button.dropdown");!o.composedPath().includes(i)&&e.dropdownOpen&&r({dropdownOpen:!1})}window.addEventListener("click",n)},renderCallback:({dispatch:e,events:t,state:r,inputs:n,updateState:o})=>{const i=n.selected?n.selected:n.options[0];function s(){o({dropdownOpen:!r.dropdownOpen})}function a(u){o({dropdownOpen:!1}),e(new t.selectChange(u))}const l=n.icon?h`
        ...
        `}});function Dl(e){return e.replace(/\n/g," ").trim().replace(/\s{2,}/g," ")}function F2({value:e,min:t,max:r}){return Math.max(Math.min(e,r),t)}const Z2=["january","february","march","april","may","june","july","august","september","october","november","december"];Z2.map(e=>e.slice(0,3));function Fl(e){return e?e instanceof Error?e.message:String(e):""}function Nn(e){return e instanceof Error?e:new Error(Fl(e))}function V2(e){return!!e}function W2(e){return!!e&&typeof e=="object"}const q2=[(e,t)=>t in e,(e,t)=>t in e.constructor.prototype];function ko(e,t){return e?q2.some(r=>{try{return r(e,t)}catch{return!1}}):!1}function Bt(e){let t;try{t=Reflect.ownKeys(e)}catch{}return t??[...Object.keys(e),...Object.getOwnPropertySymbols(e)]}function U2(e){return Bt(e).map(t=>e[t])}function Zl(e,t,r=!1,n={}){const o=Bt(e),i=new Set(Bt(t));if(!r){const s=o.filter(a=>!i.has(a));if(s.length)throw new Error(`Test object has extra keys: ${s.join(", ")}`)}i.forEach(s=>{if(!ko(e,s))throw new Error(`test object does not have key "${String(s)}" from expected shape.`);function a(u){throw new Error(`test object value at key "${String(s)}" did not match expected shape: ${u}`)}const l=e[s],c=t[s];n[s]||Vl(l,c,a,r,n[s]??{})})}function Vl(e,t,r,n,o){var a;const i=typeof e,s=typeof t;i!==s&&r(`type "${i}" did not match expected type "${s}"`);try{ko(t,"constructor")&&(!ko(e,"constructor")||e.constructor!==t.constructor)&&r(`constructor "${(a=e==null?void 0:e.constructor)==null?void 0:a.name}" did not match expected constructor "${t.constructor}"`)}catch(l){if(l instanceof r)throw l}Array.isArray(t)?(Array.isArray(e)||r("expected an array"),e.forEach((l,c)=>{if(t.map(d=>{try{Vl(l,d,r,n,o);return}catch(p){return new Error(`entry at index "${c}" did not match expected shape: ${Fl(p)}`)}}).filter(V2).length===t.length)throw new Error(`entry at index "${c}" did not match any of the possible types from "${t.join(", ")}"`)})):W2(t)&&Zl(e,t,n,o)}function Ko(e){return Array.isArray(e)?"array":typeof e}function Kr(e,t){return Ko(e)===t}function G2(e,t,r){if(!Kr(e,t))throw new TypeError(`'${r}' is of type '${Ko(e)}' but type '${t}' was expected.`)}function _s({jsonString:e,errorHandler:t,shapeMatcher:r}){try{const n=JSON.parse(e);return r!=null&&(Kr(r,"object")?Zl(n,r):G2(n,Ko(r),"parsedJson")),n}catch(n){if(t)return t(n);throw n}}function Y2(e,t){return Bt(e).filter(n=>{const o=e[n];return t(n,o,e)}).reduce((n,o)=>(n[o]=e[o],n),{})}function J2(e,t){return Y2(e,r=>!t.includes(r))}function Wl(e,t){let r=!1;const n=Bt(e).reduce((o,i)=>{const s=t(i,e[i],e);return s instanceof Promise&&(r=!0),{...o,[i]:s}},{});return r?new Promise(async(o,i)=>{try{await Promise.all(Bt(n).map(async s=>{const a=await n[s];n[s]=a})),o(n)}catch(s){i(s)}}):n}function zs(e){const t=Qo();return e!==1/0&&setTimeout(()=>{t.resolve()},e<=0?0:e),t.promise}class X2 extends Error{constructor(t,r=`Promised timed out after ${t} ms.`){super(r),this.durationMs=t,this.message=r,this.name="PromiseTimeoutError"}}function K2(e,t){return new Promise(async(r,n)=>{const o=e===1/0?void 0:setTimeout(()=>{n(new X2(e))},e);try{const i=await t;r(i)}catch(i){n(i)}finally{clearTimeout(o)}})}function Qo(){let e,t,r=!1;const n=new Promise((o,i)=>{e=s=>(r=!0,o(s)),t=s=>{r=!0,i(s)}});if(!e||!t)throw new Error(`Reject and resolve callbacks were not set by the promise constructor for ${Qo.name}.`);return{promise:n,resolve:e,reject:t,isSettled(){return r}}}function Q2(e,t){return e<t}function eh(e,t){return e>t}const Rs={width:250,height:250};function th({constraint:e,box:t,constraintType:r="max"}){return(r==="max"?eh:Q2)(t.width/t.height,e.width/e.height)?"width":"height"}function Hn({box:e,constraint:t,constraintType:r}){const n=th({box:e,constraint:t,constraintType:r});return t[n]/e[n]}function ql({box:e,ratio:t}){return Wl(e,(r,n)=>n*t)}function Co({box:e,min:t,max:r}){return Wl(e,(n,o)=>F2({value:o,min:(t==null?void 0:t[n])??0,max:(r==null?void 0:r[n])??1/0}))}function Ul({min:e,max:t,box:r}){const n=Gl({min:e,max:t,box:r}),o=ql({box:r,ratio:n});return{height:Math.floor(o.height||(e==null?void 0:e.height)||Rs.height),width:Math.floor(o.width||(e==null?void 0:e.width)||Rs.width)}}function Gl({min:e,max:t,box:r}){if(!e&&!t)return 1;const n=e?Hn({box:r,constraint:e,constraintType:"min"}):1,o=t?Hn({box:r,constraint:t,constraintType:"max"}):1,i=n>1?n:o<1?o:1,s=ql({ratio:i,box:r});return(e?Hn({box:s,constraint:e,constraintType:"min"}):1)>1?n:i}function rh(e){return e.replace(/\n/g," ").trim().replace(/\s{2,}/g," ")}const nh=["january","february","march","april","may","june","july","august","september","october","november","december"];nh.map(e=>e.slice(0,3));function lt(e){if("templateString"in e)return e.templateString;const{strings:t,values:r}=e;if((!t||!(t!=null&&t.length))&&(!r||!r.length))return"";const n=[...r||[],""],i=(t??[""]).map((s,a)=>{const l=oh(s,n[a]);return`${s}${l}`});return rh(i.join(""))}function oh(e,t){return t._$litType$!=null||t._$litDirective$!=null?lt(t):Array.isArray(t)?t.map(n=>lt(n)).join(""):e.endsWith("=")?`"${t}"`:t}function ih(e){const t=sh(e);return Kr(t,"object")||Kr(t,"array")}function sh(e){const t=_s({jsonString:e,errorHandler:()=>{}});if(t)return t;const r=ah(e);return _s({jsonString:r,errorHandler:()=>{}})}function ah(e){return Dl(e).replace(/,\s*([}\]])/,"$1")}var E;(function(e){e.Html="html",e.Text="text",e.Json="json",e.Svg="svg",e.Image="image",e.Video="video",e.Audio="audio",e.Pdf="pdf"})(E||(E={}));const lh=[E.Text,E.Json];function js(e){return lh.includes(e)}async function ch(e,t){return e.includes("video")?E.Video:e.includes("svg")||t.includes("<svg")?E.Svg:e.includes("html")||t.includes("<html")?E.Html:ih(t)?E.Json:e.includes("json")||e.includes("yaml")||e.includes("yml")||e.includes("pgp-signature")||e.includes("text")||e.includes("txt")?E.Text:e.includes("audio")?E.Audio:e.includes("pdf")?E.Pdf:E.Image}function dh({imageType:e,imageText:t,imageUrl:r,blockAutoPlay:n}){return e===E.Image?lt(h`
            <img src=${r} />
        `):e===E.Video?lt(h`
            <video
                ${n?"":"autoplay"}
        ...
        `):e===E.Text||e===E.Json?lt(h`
            ...
            `):t}function uh(e,t){if(t===E.Json)try{return JSON.stringify(JSON.parse(e),null,4)}catch{}else if(t===E.Html)return e.replaceAll(/console\.\w+/g,"doNothing");return e}async function Ns({imageUrl:e,blockAutoPlay:t,textTransformer:r=n=>n}){var c;const n=await fetch(e);if(!n.ok)throw new Error(`Failed to fetch '${e}'`);const o=((c=n==null?void 0:n.headers.get("Content-Type"))==null?void 0:c.toLowerCase())??"",i=await(n==null?void 0:n.text())??"",s=n?await ch(o,i):E.Image,a=r(uh(i??"",s));return{templateString:dh({imageText:a,imageType:s,imageUrl:e,blockAutoPlay:t}),imageUrl:e,imageType:s}}class So extends Error{constructor(){super("Iframe is no longer attached to the DOM."),this.name="IframeDisconnectedError"}}let hh=!1;function ph(){return hh}var ft;(function(e){e.FromParent="from-parent",e.FromChild="from-child"})(ft||(ft={}));const st=Symbol("any-origin");function Yl(e,t){try{return fh(e,t),!0}catch{return!1}}function fh(e,t){if(e===st)return;if(!e.filter(n=>t.origin===n).length)throw new Error(`Received message from invalid origin: ${t.origin}. Expected '[${e.join(", ")}]'`)}const gh=Symbol("dangerDisableSecurityWarningsSymbol");function mh({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}const vh=["january","february","march","april","may","june","july","august","september","october","november","december"];vh.map(e=>e.slice(0,3));const Jl=globalThis.crypto;function wh({min:e,max:t}){const{min:r,max:n}=mh({min:Math.floor(e),max:Math.floor(t)}),o=n-r+1,i=Math.ceil(Math.log2(o)/8),s=Math.floor(256**i/o)*o,a=new Uint8Array(i);let l;do Jl.getRandomValues(a),l=a.reduce((c,u,d)=>c+u*256**d,0);while(l>=s);return r+l%o}function Xl(e=16){const t=Math.ceil(e/2),r=new Uint8Array(t);return Jl.getRandomValues(r),Array.from(r).map(n=>n.toString(16).padStart(2,"0")).join("").substring(0,e)}function Br(e){return String(e).endsWith("px")?String(e):`${e}px`}const bh=["january","february","march","april","may","june","july","august","september","october","november","december"];bh.map(e=>e.slice(0,3));function $h(e){return e?e instanceof Error?e.message:String(e):""}function yh(e){return e instanceof Error?e:new Error($h(e))}function xh(e){const t=Kl();return e!==1/0&&setTimeout(()=>{t.resolve()},e<=0?0:e),t.promise}function Kl(){let e,t,r=!1;const n=new Promise((o,i)=>{e=s=>(r=!0,o(s)),t=s=>{r=!0,i(s)}});if(!e||!t)throw new Error(`Reject and resolve callbacks were not set by the promise constructor for ${Kl.name}.`);return{promise:n,resolve:e,reject:t,isSettled(){return r}}}function kh(e,t,r){return r.type===e&&r.direction===t}function Ch(e){return e<2?10:e<5?100:e<10?1e3:5e3}async function Sh({message:e,verifyChildData:t,iframeElement:r},n,o,i){if(!r)throw new Error("No iframe element was provided.");let s=0,a=!1,l,c,u,d=!1;const p={...e,direction:ft.FromParent,messageId:Xl(32)},w=e.type,m=n===st?["*"]:n;function k(C){try{if(!Yl(n,C))return;const M=C.data;if(M.type==="error")throw new Error(`Child threw an error: ${M.data}`);if(ph(),M&&d&&kh(w,ft.FromChild,M)&&M.messageId===p.messageId){let _=!1;try{_=t?t(M.data):!0}catch{}if(!_)return;a=!0,c=C,l=M}}catch(M){u=yh(M)}}globalThis.addEventListener("message",k);const y=Date.now();for(;!a&&Date.now()-y<o&&!u;){if(!r.isConnected)throw new So;const C=r.contentWindow;C&&(d=!0,m.forEach(M=>{try{C.postMessage(p,{targetOrigin:M})}catch{}})),await xh(i||Ch(s)),s++}if(globalThis.removeEventListener("message",k),u)throw u;if(!a)throw new Error(`Failed to receive response from the iframe for message '${e.type}' after '${Math.ceil(o/1e3)}' seconds).`);if(!c)throw new Error("Never got message event from child but received a valid response");return{data:l==null?void 0:l.data,event:c}}function Ql({allowedOrigins:e,timeoutMs:t=1e4,...r}){if(e!==st&&e.includes("*")&&(e=st),e===st&&!r[gh]&&console.warn("Creating iframe messenger with any origin allowed ('*'). This is insecure, please provide an actual list of allowed origins."),e!==st&&!e.length)throw new Error(`No allowed origins were provide to ${Ql.name}. At least one must be provided.`);const n=e===st?["*"]:e;return{async sendMessageToChild(o){if(o.message.type==="error")throw new Error("Cannot send message to child with type 'error'. 'error' is reserved for internal error messaging.");return await Sh(o,e,o.timeoutMs||t,o.intervalMs)},listenForParentMessages(o){globalThis.addEventListener("message",async i=>{if(!Yl(e,i))return;const s=i.data,a=await o({...s,originalEvent:i}),l={type:s.type,direction:ft.FromChild,data:a,messageId:s.messageId};n.forEach(c=>{try{globalThis.parent.postMessage(l,{targetOrigin:c})}catch{}})})}}}var ce;(function(e){e.VerticallyCenter="vertically-center",e.HideLoading="hide-loading"})(ce||(ce={}));var K;(function(e){e.Ready="ready",e.SendSize="send-size",e.SendScale="set-scale",e.SendScalingMethod="set-scaling-method",e.ForceSize="force-size",e.SizeDetermined="size-determined"})(K||(K={}));const je=Ql({allowedOrigins:[window.location.origin]});async function Mh(e,t){const r=Qo();e.onload=()=>{r.resolve()};try{await je.sendMessageToChild({message:{type:K.Ready},iframeElement:e,timeoutMs:t})}catch{await r.promise,await je.sendMessageToChild({message:{type:K.Ready},iframeElement:e,timeoutMs:t})}}async function Ah({min:e,max:t,host:r,iframeElement:n,imageData:o,forcedFinalImageSize:i,forcedOriginalImageSize:s,timeoutMs:a}){var c;await Mh(n,a),i&&await je.sendMessageToChild({message:{type:K.ForceSize,data:i},iframeElement:n,timeoutMs:a});const l=s??(await je.sendMessageToChild({message:{type:K.SendSize},iframeElement:n,timeoutMs:a,verifyChildData(u){return!isNaN(u.width)&&!isNaN(u.height)&&!!u.width&&!!u.height}})).data;return await ec({min:e,max:t,imageDimensions:l,host:r,iframeElement:n,imageData:o,forcedFinalImageSize:i,sendSizeMessage:!0,timeoutMs:a}),((c=n.contentWindow)==null?void 0:c.document.documentElement.outerHTML)??""}async function ec({min:e,max:t,imageDimensions:r,host:n,iframeElement:o,imageData:i,forcedFinalImageSize:s,sendSizeMessage:a,timeoutMs:l}){const c=n.shadowRoot.querySelector(".frame-constraint");if(!(c instanceof HTMLElement))throw new Error("Could not find frame constraint div.");const u={min:e,max:t,box:s??r},d=js(i.imageType)?Co(u):Ul(u);c.style.width=Br(Math.floor(d.width)),c.style.height=Br(Math.floor(d.height));const p=Co({min:e,max:t,box:d});d.height<p.height?n.classList.add(ce.VerticallyCenter):n.classList.remove(ce.VerticallyCenter),n.style.width=Br(p.width),n.style.height=Br(p.height);const w=Gl({min:e,max:t,box:s??r});if(a){if(w>3?await je.sendMessageToChild({message:{type:K.SendScalingMethod,data:"pixelated"},iframeElement:o,timeoutMs:l}):await je.sendMessageToChild({message:{type:K.SendScalingMethod,data:"default"},iframeElement:o,timeoutMs:l}),await je.sendMessageToChild({message:{type:K.SizeDetermined,data:d},iframeElement:o,timeoutMs:l}),i.imageType===E.Html){const m=s?{width:s.width/r.width,height:s.height/r.height}:{width:1,height:1},k={width:w*m.width,height:w*m.height};await je.sendMessageToChild({message:{type:K.SendScale,data:k},iframeElement:o,timeoutMs:l})}else if(js(i.imageType)){const m=s??r;if(m.height<d.height){const k=d.width/m.width,y=d.height/m.height,C=Math.min(k,y);await je.sendMessageToChild({message:{type:K.SendScale,data:{height:C,width:C}},iframeElement:o,timeoutMs:l})}}}}const _r={x:16,y:8};var Js,Xs;function Ih(e,t,r){const n=Math.random(),o=h(Js||(Js=un([`
        <script>
            function doNothing() {}
            const imageType = '`,`';
...
${e.templateString}
`)}const Eh=1e4,Th={textTransformer:"textTransformer",extraHtml:"extraHtml"},Ph=U2(Th),Lh={imageData:W0(),error:void 0},yt=tn()({tagName:"vir-resizable-image",stateInit:Lh,events:{settled:ue(),imageDataCalculated:ue(),errored:ue()},styles:f`
        :host {
            position: relative;
    ...
    `,cleanupCallback({host:e}){const t=e.shadowRoot.querySelector("iframe"),r=e[On];t&&r&&(t.srcdoc=r)},renderCallback({state:e,inputs:t,updateState:r,host:n,dispatch:o,events:i}){const s=t.timeoutMs??Eh,a=e.imageData instanceof Error?e.imageData:e.error;r({imageData:{createPromise:async()=>{if(e.error&&r({error:void 0}),n.classList.remove(ce.HideLoading),o(new i.settled(!1)),n.classList.remove(ce.VerticallyCenter),!t.imageUrl)return new Promise(async(M,_)=>{await zs(s),_(new Error("An imageUrl was never provided to vir-resizable-image."))});const y={imageUrl:t.imageUrl,blockAutoPlay:!!t.blockAutoPlay,textTransformer:t.textTransformer};let C;try{C=await K2(s,Ns(y))}catch{await zs(1e3);try{C=await Ns(y)}catch(_){throw _}}if(C)return C;throw new Error("no image data result")},trigger:{...J2(t,Ph)}}});const l=t.min&&t.max?Co({box:t.min,max:t.max}):t.min,c=t.max,u=t.forcedOriginalImageSize?Ul({min:l,max:c,box:t.forcedOriginalImageSize}):void 0,d=zi(e.imageData,"",y=>(o(new i.imageDataCalculated(y)),y.imageType===E.Pdf?h`
                        <iframe
                            src=${y.imageUrl}
                    ...
                    `:h`
                        <iframe
                            ...
                            scrolling="no"
                            srcdoc=${Ih(y,t.extraHtml,t.htmlSizeQuerySelector)}
                            ${_i(async C=>{try{const M=await Ah({min:l,max:c,host:n,iframeElement:C,imageData:y,forcedFinalImageSize:t.forcedFinalImageSize,forcedOriginalImageSize:u,timeoutMs:s});n[On]=M,o(new i.settled(!0)),n.classList.add(ce.HideLoading)}catch(M){const _=Nn(M);if(_ instanceof So)return;console.error(_),r({error:_}),o(new i.errored(_))}})}
                        ></iframe>
                        <slot name="loaded"></slot>
                    `),y=>{r({error:y}),o(new i.errored(Nn(y)))}),p=zi(e.imageData,Hs,y=>!t.blockInteraction&&[E.Html,E.Video,E.Audio,E.Pdf].includes(y.imageType)?"":Hs,()=>""),w=a?f`
                  max-width: 100%;
                  max-height: 100%;
              `:u?f`
                  width: ${u.width}px;
...
`,On="latest-frame-srcdoc";function Bh(e,t){return e.includes(t)}const _h=["january","february","march","april","may","june","july","august","september","october","november","december"];_h.map(e=>e.slice(0,3));function tc(e){return!!e&&typeof e=="object"}const zh=[(e,t)=>t in e,(e,t)=>t in e.constructor.prototype];function Hr(e,t){return e?zh.some(r=>{try{return r(e,t)}catch{return!1}}):!1}function Os(e){let t;try{t=Reflect.ownKeys(e)}catch{}return t??[...Object.keys(e),...Object.getOwnPropertySymbols(e)]}function Rh(e){return Array.isArray(e)?"array":typeof e}function rc(e,t){return Rh(e)===t}function jh(e,t){let r=!1;const n=Os(e).reduce((o,i)=>{const s=t(i,e[i],e);return s instanceof Promise&&(r=!0),{...o,[i]:s}},{});return r?new Promise(async(o,i)=>{try{await Promise.all(Os(n).map(async s=>{const a=await n[s];n[s]=a})),o(n)}catch(s){i(s)}}):n}const nc=Symbol("and"),oc=Symbol("or"),ic=Symbol("exact"),sc=Symbol("enum"),ac=Symbol("unknown"),lc="__vir__shape__definition__key__do__not__use__in__actual__objects";function Nh(e){return Hr(e,lc)}const Hh="__vir__shape__specifier__key__do__not__use__in__actual__objects",Oh=[nc,oc,ic,sc,ac];function Dh(e){return wr(e,oc)}function Fh(e){return wr(e,nc)}function Zh(e){return wr(e,ic)}function Vh(e){return wr(e,sc)}function Wh(e){return wr(e,ac)}function wr(e,t){const r=cc(e);return!!r&&r.specifierType===t}function cc(e){if(tc(e)&&Hr(e,Hh)){if(!Hr(e,"parts")||!rc(e.parts,"array"))throw new Error("Found a shape specifier but its parts are not valid.");if(!Hr(e,"specifierType")||!Bh(Oh,e.specifierType))throw new Error("Found a shape specifier but its specifier type is not valid.");return e}}function Mo(e){return Ao(e)}function Ao(e){const t=cc(e);if(t){if(Dh(t)||Zh(t))return Ao(t.parts[0]);if(Fh(t))return t.parts.reduce((r,n)=>Object.assign(r,Ao(n)),{});if(Vh(t))return Object.values(t.parts[0])[0];if(Wh(t))return"unknown";throw new Error(`found specifier but it matches no expected specifiers: ${String(t.specifierType)}`)}return Nh(e)?Mo(e.shape):e instanceof RegExp||rc(e,"array")?e:tc(e)?jh(e,(r,n)=>Mo(n)):e}function qh(e){return{shape:e,get runTimeType(){throw new Error("runTimeType cannot be used as a value, it is only for types.")},defaultValue:Mo(e),[lc]:!0}}const Uh=qh({Discord:"",Instagram:"",Telegram:"",TikTok:"",Twitch:"",Twitter:"",website:""}),Gh=Uh.defaultValue,dc={Discord:zl,Instagram:Rl,Telegram:jl,TikTok:Nl,Twitch:Hl,Twitter:Ol,website:Al},He=oe()({tagName:"toniq-hyperlink",hostClasses:{"with-hover-styles":!1},styles:({hostClassSelectors:e})=>f`
        :host {
            display: inline;
    ...
    `,renderCallback:({inputs:e,state:t,updateState:r,dispatch:n,events:o,host:i})=>{var y;const s=e.mainImageSize||Io,a=hc(s);io({onElement:i,forCssVar:xt["main-image-size"],toValue:`${s}px`}),io({onElement:i,forCssVar:xt["secondary-image-size"],toValue:`${a}px`});const l=e.socialUrls,c=l?Xe(l).filter(C=>!!l[C]).map(C=>{const M=l[C],_=dc[C];return h`
        ...
        `}});T.hostClasses.outline;async function Yh(e){return navigator.clipboard.writeText(e)}const Jh="…";function Xh(e,t){const r=e.slice(0,t).trim(),n=e.slice(-1*t).trim();return`${r}${Jh}${n}`}function Kh(e){return!(e%1)}function Qh(e){return e.letterCount==null?4:Kh(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const q=oe()({tagName:"toniq-middle-ellipsis",events:{copied:ue()},cssVars:{textColor:S.pagePrimary.foregroundColor,iconColor:S.pagePrimary.foregroundColor,textHoverColor:S.pageInteraction.foregroundColor,iconHoverColor:S.pageInteraction.foregroundColor},styles:({hostClassNames:e,cssVarValues:t})=>f`
        :host {
            /* 5 frames at 60 fps */
    ...
    `,hostClasses:{clickable:({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInit:{showCopiedTextTimeoutId:void 0},renderCallback:({inputs:e,dispatch:t,events:r,state:n,updateState:o})=>{if(!e.text)return h``;const i=e.text,s=Qh(e),a=!!e.externalLink,l=!!e.copyOnClick,c=i.length>s*2+2,u=c?Xh(i,s):i,d=c?i:"",p=a?El:l?Il:void 0,w=p?h`
                  <${v} ${g(v,{icon:p})}></${v}>
              `:"",m=h`
    ...
    `,events:{pageChange:ue()},renderCallback:({inputs:e,events:t,dispatch:r})=>e.pageCount<=1?h``:h`
                ...
                ${ep(e.currentPage,e.pageCount,e.pagesShown).map(n=>typeof n=="string"?h`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:Xl()})},renderCallback:({inputs:e,dispatch:t,events:r,state:n})=>tp(e.entries).map(i=>rp(e.groupName||n.randomGroupName,e.value,i,()=>{t(new r.valueChange(i.value))}))});function tp(e){const t=Object.fromEntries(e.map(n=>[n.value,n]));return Object.values(t).length!==e.length&&console.error(`${j.tagName} was given duplicate entry values.`),Object.values(t)}function rp(e,t,r,n){const o=t===r.value,i=h`
    ...
    `}const z={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},Ot={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"};function np(e){var n,o;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${z.lowerLabelWrapper} .${z.labelPercentMarginWrapper}`),r=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${z.upperLabelWrapper} .${z.labelPercentMarginWrapper}`);if(r instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),s=r.getBoundingClientRect();return{lower:i,upper:s}}else return}function op(e,t=8){const r=np(e);if(!r)return 0;const n=r.lower.right-r.upper.left+t;return Math.max(0,n)}function Fn({value:e,limits:t,flip:r}){const o=(t.max-e)/(t.max-t.min)*100;return-(r?100-o:o)}function ar(e){return gu(e)&&e.min!==void 0&&e.max!==void 0}function To(e){var r;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${z.range}`);return(t==null?void 0:t.clientWidth)??0}function Zn(e,t,r){return`${r?yu(e):e} ${t}`}function ip({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function sp({value:e,double:t,min:r,max:n}){return t?ar(e)?{min:Gt(e.min,r,Math.min(e.max,n)),max:Gt(e.max,Math.max(e.min,r),n)}:{min:r,max:n}:ar(e)?r:Gt(e,r,n)}function ap({actualValue:e,actualLimits:t,logScale:r,logRange:n}){return r?{elementValue:ar(e)?{min:Rn(n,e.min),max:Rn(n,e.max)}:Rn(n,e),elementLimits:{min:0,max:n.length-1}}:{elementValue:e,elementLimits:t}}function Vn(e,t,r){return r?t[e]||0:e}function lp(e){return{actualLimits:ip(e),actualValue:sp(e)}}function cp(e,t){var n,o,i;let r=!1;if(ar(e)){const s=(n=t.shadowRoot)==null?void 0:n.querySelector(`.${z.lowerSlider}`),a=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${z.upperSlider}`);s instanceof HTMLInputElement&&a instanceof HTMLInputElement&&(Number(s.value)!==e.min&&(s.value=String(e.min),r=!0),Number(a.value)!==e.max&&(a.value=String(e.max),r=!0))}else{const s=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${z.slider}`);s instanceof HTMLInputElement&&Number(s.value)!==e&&(s.value=String(e),r=!0)}return r}function fc(e,t){const{actualValue:r,actualLimits:n}=lp({...e}),o=Cu(n.min,n.max),i=e.logScale??!1,s=e.suffix??"",{elementValue:a,elementLimits:l}=ap({actualValue:r,actualLimits:n,logScale:i,logRange:o}),c=To(t);return{actualValue:r,elementLimits:l,elementValue:a,isLogScale:i,logRange:o,rangeWidth:c,suffix:s}}const it=16,Zs=f`
    ${it}px
`,Vs=f`
...
`,Ws=f`
    transform: scale(1.2);
`;function Zt(e){requestAnimationFrame(()=>{const t=fc(e.instanceInputs,e).elementValue;cp(t,e)&&(e.setAttribute("disabled","true"),Zt(e))})}const L=oe()({tagName:"toniq-slider",stateInit:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ue()},styles:f`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Zt(e)}),e.addEventListener("keydown",()=>{Zt(e)}),e.addEventListener("keyup",()=>{Zt(e)})},renderCallback:({inputs:e,host:t,events:r,dispatch:n,state:o,updateState:i})=>{const{actualValue:s,logRange:a,isLogScale:l,suffix:c,elementValue:u,elementLimits:d,rangeWidth:p}=fc({...e},t);if(Zt(t),ar(u))return w(s,u,d);return k(s,u,d);function w(y,C,M){const _={left:St((p-it)*(C.min-M.min)/(M.max-M.min)+it/2),right:St((p-it)*(M.max-C.max)/(M.max-M.min)+it/2)},X=Zn(y.min,c,l),he=Zn(y.max,c,l);requestAnimationFrame(()=>{const pe=op(t);pe!==o.labelOverlap&&i({labelOverlap:pe})});const Le=(M.max-C.max)/(M.max-M.min)>.5,Fe=Fn({value:C.min,limits:{min:M.min,max:C.max},flip:!0}),ie=Fn({value:C.max,limits:{min:C.min,max:M.max},flip:!1}),tt=o.labelOverlap&&Le?o.labelOverlap:0,br=o.labelOverlap&&!Le?o.labelOverlap:0;return h`
                <div
                    class="range"
                ...
                >
                    ...
                    <div class="slider-wrapper">
                        <input
                            ...
                            .max=${M.max}
                            .value=${C.min}
                            ${A("input",pe=>{const mt=pe.target,zt={...y,min:Vn(Number(mt.value),a,l)};m(zt)})}
                        />
                        <input
                            ?disabled=${e.disabled??!1}
                            type="range"
                            ...
                            .value=${C.max}
                            ${At(Ot.slider)}
                            ${A("input",pe=>{const mt=pe.target,zt={...y,max:Vn(Number(mt.value),a,l)};m(zt)})}
                        />
                    </div>
                </div>
            `}function m(y){i({internalValue:y}),e.disabled||n(new r.valueChange(y))}function k(y,C,M){const _=St((p-it)*(M.max-C)/(M.max-M.min)+it/2),X=Zn(y,c,l),he=Fn({value:C,limits:M,flip:!1});return h`
                <div
                    class="range"
                    ${to(()=>{i({rangeWidth:To(t)})})}
                >
    ...
    `,renderCallback:({inputs:e})=>{const t=e.icon?h`
        ...
        `}}),dp=J({title:"Social Urls",parent:$l,examples:[{title:"Icons",styles:f`
                :host {
                    display: flex;
                    gap: 32px;
                }
            ...
            `,render(){return Object.entries(dc).map(([e,t])=>h`
                        ...
                        `)}}]}),le=ee({title:"Elements",parent:void 0}),gc=ee({title:"Button",parent:le});function zr(e){return[{title:"Text",render(){return h`
                    <${H}
                        class=${e}
                        ${g(H,{text:"Button"})}
                    ></${H}>
                ...
                `}},{title:"Sizable",render(){return h`
                    <${H}
                        ...
                        ${g(H,{text:"bigger"})}
                    ></${H}>
                `}}]}const up=Pe({[H.tagName]:zr(""),[H.hostClasses.secondary]:zr(H.hostClasses.secondary),[H.hostClasses.outline]:zr(H.hostClasses.outline),[H.hostClasses.disabled]:zr(H.hostClasses.disabled)},(e,t)=>J({title:e,examples:t,parent:gc})),hp=[gc,...Object.values(up)],ei=ee({title:"Carousel",parent:le}),pp=J({title:V.tagName,parent:ei,descriptionParagraphs:["A carousel that can show multiple elements at once.","Automatic scrolling is optional."],examples:[{title:"short and fast",styles:f`
                :host {
                    max-width: 100%;
                }
            ...
            `,render(){return h`
                    <${V}
                        ${g(V,{enableAutomaticCycling:!0,cycleIntervalMs:1e3,templates:Xt["core-24"].map(e=>{const t=wh({min:0,max:150}),r=f`
                                    padding: 100px ${t}px;
                                    border: 1px solid ${S.pageInteraction.foregroundColor};
                                    border-radius: 12px;
                                `;return h`
                                ...
                                `})})}
                    ></${V}>
                `}}]}),fp=J({title:V.hostClasses["banner-style"],parent:ei,descriptionParagraphs:[`${V.tagName} style for a single, full-width element.`],examples:[{title:V.hostClasses["banner-style"],styles:f`
                :host {
                    max-width: 100%;
                }
            ...
            `,render(){return h`
                    <${V}
                        ...
                        ${g(V,{enableAutomaticCycling:!0,templates:Xt["core-24"].map(e=>{const t=f`
                                ...
                                `})})}
                    ></${V}>
                `}}]}),gp=[ei,pp,fp],mc=ee({title:"Checkbox",parent:le}),mp=J({title:R.tagName,parent:mc,examples:[{title:"Unchecked",stateInit:{checked:!1},render({state:e,updateState:t}){return h`
                    <${R}
            ...
            `,render({state:e,updateState:t}){return h`
                    ...
                    ></${R}>
                `}}]}),vp=[mc,mp],vc=ee({title:"Chip",parent:le});function qs(e){return[{title:"Text",render(){return h`
                    <${Y}
                        class=${e}
            ...
            `,render(){return h`
                ...
                `}}]}const wp=Pe({[Y.tagName]:qs(""),[Y.hostClasses.secondary]:qs(Y.hostClasses.secondary)},(e,t)=>J({title:e,examples:t,parent:vc})),bp=[vc,...Object.values(wp)],wc=ee({title:"Dropdown",parent:le}),Ze=[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3},{label:"Really really super duper long option",value:4}],$p=J({title:N.tagName,parent:wc,examples:[{title:"Default",stateInit:{selected:void 0},render({state:e,updateState:t}){return h`
                    <${N}
            ...
            `,render({state:e,updateState:t}){return h`
                    <${N}
                        ...
                        ${A(N.events.selectChange,r=>{t({selected:r.detail})})}
                    ></${N}>
                `}}]}),yp=[wc,$p],Us="/toniq-labs-design-system";function xp(...e){const r=[globalThis.location.pathname.startsWith(Us)?Us:"",...e].filter(ml);return mu(...r)}const ti=ee({title:"Flip Card",parent:le}),Wn=Array(30).fill(xp("/toniq-labs-logo.png")),Po=["Hello there.","There is stuff here."],kp=Po.concat(Array(30).fill(Po)),Cp=J({title:ke.tagName,parent:ti,examples:[{title:"basic",styles:f`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInit:{flipped:!1},render(){return h`
                    <${ke}
                        ${g(ke,{moreInfoParagraphs:kp,imageUrls:Wn,socialUrls:Gh,title:"Featured Stuff",viewName:"Stuff"})}
                    ></${ke}>
            ...
            `,stateInit:{flipped:!1},render(){return h`
                    ...
                    ></${ke}>
                `}}]}),Sp=J({title:Ne.tagName,parent:ti,examples:[{title:"basic",styles:f`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInit:{flipped:!1},render({state:e,updateState:t}){return h`
                ...
                `}}]}),Mp=[ti,Sp,Cp],bc=ee({title:"Hyperlink",parent:le});function Gs(e){return[{title:"text hyperlink",render(){return h`
                    <${He}
                        class=${e}
                ...
                `}}]}const Ap=Pe({[He.tagName]:Gs(""),[He.hostClasses["with-hover-styles"]]:Gs(He.hostClasses["with-hover-styles"])},(e,t)=>J({title:e,examples:t,parent:bc})),Ip=[bc,...Object.values(Ap)],$c=ee({title:"Icon",parent:le}),Ep=Pe({[v.tagName]:[{title:"With Icon",render(){return h`
                        <${v}
                            ${g(v,{icon:Jt})}
                        ></${v}>
                ...
                `,render(){return h`
                        <${v}
                            ${g(v,{icon:Mt})}
                        ></${v}>
                    `}}]},(e,t)=>J({title:e,examples:t,parent:$c})),Tp=[$c,...Object.values(Ep)],yc=ee({title:"Input",parent:le}),Pp=J({title:T.tagName,parent:yc,examples:[{title:"Assigned value",stateInit:{value:"init value"},render({state:e,updateState:t}){return h`
                    <${T}
                        ${g(T,{value:e.value})}
                ...
                `}},{title:"Icon",stateInit:{value:""},render({state:e,updateState:t}){return h`
                    <${T}
                        ${g(T,{value:e.value,placeholder:"with icon",icon:Pl})}
                        ${A(T.events.valueChange,r=>{t({value:r.detail})})}
                    ></${T}>
            ...
            `,render({state:e,updateState:t}){return h`
                ...
                `}},{title:"no browser auto-helps",stateInit:{value:""},render({state:e,updateState:t}){return h`
                    <${T}
                        ...
                        ${A(T.events.valueChange,r=>{t({value:r.detail})})}
                    ></${T}>
                `}}]}),Lp=[yc,Pp],xc=ee({title:"Middle Ellipsis",parent:le}),Bp=J({title:q.tagName,parent:xc,examples:[{title:"Long text",render(){return h`
                    <${q}
            ...
            `,render(){return h`
                    ...
                    ></${q}>
                `}}]}),_p=[xc,Bp],kc=ee({title:"Radio Group",parent:le}),Dt=[{value:"1",label:"Entry 1"},{value:"2",label:"Entry 2"},{value:"3",label:"Entry 3"}],fe={basic:Dt,longText:[{value:"first",label:"Entry 1 with really really really really really really really really really long label"},...Dt.slice(1)],disabled:[{...Dt[0],disabled:!0},...Dt.slice(1)],noLabels:lu(Dt,e=>({...e,label:void 0}))},zp=J({title:j.tagName,parent:kc,examples:[{title:"Default",stateInit:{selectedValue:fe.basic[0].value},render({state:e,updateState:t}){return h`
                    <${j}
            ...
            `,render({state:e,updateState:t}){return h`
                    <${j}
                        ...
                        ${A(j.events.valueChange,r=>{t({selectedValue:r.detail})})}
                    ></${j}>
                `}}]}),Rp=[kc,zp],Cc=ee({title:"Slider",parent:le}),_e=f`
    ${L} {
        width: 300px;
    }
`,qn={min:10,max:50},jp=J({title:L.tagName,parent:Cc,examples:[{title:"Default",stateInit:{value:20},styles:f`
                ${_e}
            `,render({state:e,updateState:t}){return h`
                    <${L}
            ...
            `,render({state:e,updateState:t}){return h`
                    <${L}
                        ...
                        ${A(L.events.valueChange,r=>{if(typeof r.detail=="number")throw new Error("was expecting a double slider value");t({value:r.detail})})}
                    ></${L}>
                `}}]}),Np=[Cc,jp],Sc=ee({title:"Toggle Button",parent:le});function Ys(e){return[{title:"Default",stateInit:{toggled:!1},render({state:t,updateState:r}){return h`
                    <${ge}
                        class=${e}
                ...
                `}},{title:"Icon only",stateInit:{toggled:!1},render({state:t,updateState:r}){return h`
                    <${ge}
                        ...
                        ${A("click",()=>{r({toggled:!t.toggled})})}
                    ></${ge}>
                `}}]}const Hp=Pe({[ge.tagName]:Ys(""),[ge.hostClasses.textOnly]:Ys(ge.hostClasses.textOnly)},(e,t)=>J({title:e,examples:t,parent:Sc})),Op=[Sc,...Object.values(Hp)],Mc=ee({title:"Icons",parent:void 0}),Dp=Object.entries(Xt).map(([e,t])=>J({title:e,parent:Mc,examples:t.map(r=>({title:r.iconName,render(){return h`
                            <${v} ${g(v,{icon:r})}></${v}>
                        `}}))})),ri=ee({title:"Styles",parent:void 0});function Ac(e){const t=Fp(e),r=Pe(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return Xe(r).reduce((o,i)=>{const s=r[i];return s&&s[1]&&s[2]&&(o[i]={cssVarName:s[1],defaultValue:s[2]}),o},{})}function Fp(e){typeof e!="string"&&(e=String(e));const n=`{"${du(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((s,a)=>(s[a]=o[a],s),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const Zp=f`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function Vp(e,t){const r=Ac(O(t));return{title:e,styles:Zp,render(){return h`
            ...
            `}}}const Wp=Xe(S).map(e=>Vp(e,S[e])),qp=J({title:"Colors",parent:ri,examples:Wp,descriptionParagraphs:['Accessed via the "toniqColors" export.']}),Up=f`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function Gp(e,t){const r=Ac(t);return{title:e,styles:Up,render(){return h`
            ...
            `}}}const Yp=Xe(W).map(e=>{const t=W[e];return Gp(e,t)}),Jp=J({title:"Fonts",parent:ri,examples:Yp,descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),Xp=[le,Mc,ri,...Dp,...hp,...gp,...vp,...bp,...yp,...Mp,...Ip,...Tp,...Lp,..._p,...Rp,...Np,...Op,qp,Jp,$l,dp];en({tagName:"toniq-design-system-app",styles:f`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return h`
            <${Lr}
                ${g(Lr,{baseUrl:"toniq-labs-design-system",entries:Xp,themeColor:"#00D093",everythingTitle:"Design System"})}
            ></${Lr}>
        `}});
