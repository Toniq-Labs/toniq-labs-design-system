...
`,pd=w({name:"LoaderAnimated24Icon",svgTemplate:u`
    ...
    `,events:{routeChange:K()},renderCallback({inputs:e,dispatch:t,events:r}){var o,i;function n(a){e.route&&Oa(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new r.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return u`
            ...
            `}}});const{defineElement:De,defineElementNoInputs:Sw}=La(),Ie=De()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>p`
        a {
            box-sizing: border-box;
            display: block;
...
`,ag=w({name:"CryptoIcp16Icon",svgTemplate:u`
    ...
    `,renderCallback:({inputs:e})=>u`
        ...
        `});async function d4(e){return navigator.clipboard.writeText(e)}const h4="…";function f4(e,t){const r=e.slice(0,t).trim(),n=e.slice(-1*t).trim();return`${r}${h4}${n}`}function m4(e){return!(e%1)}function p4(e){return e.letterCount==null?4:m4(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const me=re()({tagName:"toniq-middle-ellipsis",events:{copied:K()},cssVars:{"toniq-middle-ellipsis-text-color":$.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":$.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":$.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":$.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>p`
        :host {
            /* 5 frames at 60 fps */
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:r,state:n,updateState:o}){if(!e.text)return u``;const i=e.text,a=p4(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,d=c?f4(i,a):i,f=c?i:"",m=s?Ed:l?Ad:void 0,g=m?u`
                  <${S.assign({icon:m})}></${S}>
              `:"",v=u`
        ...
        `;return d?s?u`
                ...
                `:l?u`
                    <button
                        ...
                        ${T("click",async()=>{await d4(i),t(new r.copied),n.showCopiedTextTimeoutId!=null&&window.clearTimeout(n.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${v} ${g}
                    </button>
                `:u`
                    ${v}
                `:u``}}),Pc="...";function g4(e,t,r=7,n=5){let o;e=Nr({value:e,min:1,max:t}),r=Nr({value:r,min:n,max:t});const i=r-5,a=r-3;t<=r?o=r:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>r?bi(t-o,t):e>o?bi(Math.min(s.start,t-o),Math.min(s.end,t)):bi(1,Math.min(t,o+1));function c(f,m){return l.length+1!==t?m:[f]}const d=l[l.length-1];if(d&&d<t){const f=c(t,[Pc,t]);return[...l,...f]}else return l[0]!==1?c(1,[1,Pc]).concat(l):l}function bi(e,t){const r=t-e+1;return Array.from({length:r},(n,o)=>e+o)}re()({tagName:"toniq-pagination",styles:p`
        :host {
            display: flex;
        }
    ...
    `,events:{pageChange:K()},renderCallback({inputs:e,events:t,dispatch:r}){return e.pageCount<=1?u``:u`
                ...
                ${g4(e.currentPage,e.pageCount,e.pagesShown).map(n=>typeof n=="string"?u`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:Z2()})},renderCallback({inputs:e,dispatch:t,events:r,state:n}){return v4(e.entries).map(i=>w4(e.groupName||n.randomGroupName,e.value,i,()=>{t(new r.valueChange(i.value))}))}});function v4(e){const t=Object.fromEntries(e.map(n=>[n.value,n]));return Object.values(t).length!==e.length&&console.error(`${G.tagName} was given duplicate entry values.`),Object.values(t)}function w4(e,t,r,n){const o=t===r.value,i=u`
    ...
    `}function yi(e,t){const r=e[0],n=e[e.length-1];if(r==null||n==null)return 0;if(t<r)return r;if(t>n)return n;const o=e.findIndex((c,d)=>{const f=e[d+1];return f==null?!0:c<=t&&f>=t});if(o<0)return r;const i=e[o];if(i==null)return r;const a=e[o+1];if(a==null)return i;const s=t-i,l=a-t;return s<l?o:o+1}function b4(e,t,r=100){e>t&&([e,t]=[t,e]),r<2&&(r=2);let n=y4(e);const o=[e];for(;n<t;){const i=Math.pow(10,String(n).length-1),a=n+i;a<t&&o.push(a),n=a}return o.push(t),o.length>r&&(Nc(o,r),o.length>r&&Nc(o,r)),o}function Nc(e,t){const r=e.length-t,n=(e.length-2)/r;for(let o=e.length-2;o>=1;o-=n)e.splice(Math.floor(o),1)}function y4(e){let t=1;if(!e)return e;e<0&&(t=-1,e=e*-1);const r=e.toFixed(0),n=Math.pow(10,r.length-1),o=Number(r[0]||1);return n*o*t}const N={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},kr={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"};function $4(e){var n,o;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${N.lowerLabelWrapper} .${N.labelPercentMarginWrapper}`),r=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${N.upperLabelWrapper} .${N.labelPercentMarginWrapper}`);if(r instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),a=r.getBoundingClientRect();return{lower:i,upper:a}}else return}function k4(e,t=8){const r=$4(e);if(!r)return 0;const n=r.lower.right-r.upper.left+t;return Math.max(0,n)}function $i({value:e,limits:t,flip:r}){const o=(t.max-e)/(t.max-t.min)*100;return-(r?100-o:o)}function Jr(e){return _2(e)&&e.min!==void 0&&e.max!==void 0}function ha(e){var r;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${N.range}`);return(t==null?void 0:t.clientWidth)??0}function ki(e,t,r){return`${r?Q2(e):e} ${t}`}function x4({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function T4({value:e,double:t,min:r,max:n}){return t?Jr(e)?{min:Nr({value:e.min,min:r,max:Math.min(e.max,n)}),max:Nr({value:e.max,min:Math.max(e.min,r),max:n})}:{min:r,max:n}:Jr(e)?r:Nr({value:e,min:r,max:n})}function S4({actualValue:e,actualLimits:t,logScale:r,logRange:n}){return r?{elementValue:Jr(e)?{min:yi(n,e.min),max:yi(n,e.max)}:yi(n,e),elementLimits:{min:0,max:n.length-1}}:{elementValue:e,elementLimits:t}}function xi(e,t,r){return r?t[e]||0:e}function C4(e){return{actualLimits:x4(e),actualValue:T4(e)}}function M4(e,t){var n,o,i;let r=!1;if(Jr(e)){const a=(n=t.shadowRoot)==null?void 0:n.querySelector(`.${N.lowerSlider}`),s=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${N.upperSlider}`);a instanceof HTMLInputElement&&s instanceof HTMLInputElement&&(Number(a.value)!==e.min&&(a.value=String(e.min),r=!0),Number(s.value)!==e.max&&(s.value=String(e.max),r=!0))}else{const a=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${N.slider}`);a instanceof HTMLInputElement&&Number(a.value)!==e&&(a.value=String(e),r=!0)}return r}function th(e,t){const{actualValue:r,actualLimits:n}=C4({...e}),o=b4(n.min,n.max),i=e.logScale??!1,a=e.suffix??"",{elementValue:s,elementLimits:l}=S4({actualValue:r,actualLimits:n,logScale:i,logRange:o}),c=ha(t);return{actualValue:r,elementLimits:l,elementValue:s,isLogScale:i,logRange:o,rangeWidth:c,suffix:a}}const At=16,qc=p`
    ${At}px
`,Oc=p`
...
`,Bc=p`
    transform: scale(1.2);
`;function Er(e){requestAnimationFrame(()=>{const t=th(e.instanceInputs,e).elementValue;M4(t,e)&&(e.setAttribute("disabled","true"),Er(e))})}const _=re()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:K()},styles:p`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Er(e)}),e.addEventListener("keydown",()=>{Er(e)}),e.addEventListener("keyup",()=>{Er(e)})},renderCallback({inputs:e,host:t,events:r,dispatch:n,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:d,elementLimits:f,rangeWidth:m}=th({...e},t);if(Er(t),Jr(d))return g(a,d,f);return y(a,d,f);function g(b,x,C){const D={left:Gt((m-At)*(x.min-C.min)/(C.max-C.min)+At/2),right:Gt((m-At)*(C.max-x.max)/(C.max-C.min)+At/2)},Z=ki(b.min,c,l),ne=ki(b.max,c,l);requestAnimationFrame(()=>{const ve=k4(t);ve!==o.labelOverlap&&i({labelOverlap:ve})});const de=(C.max-x.max)/(C.max-C.min)>.5,ue=$i({value:x.min,limits:{min:C.min,max:x.max},flip:!0}),j=$i({value:x.max,limits:{min:x.min,max:C.max},flip:!1}),oe=o.labelOverlap&&de?o.labelOverlap:0,Re=o.labelOverlap&&!de?o.labelOverlap:0;return u`
                <div
                    class="range"
    ...
    `,renderCallback({inputs:e}){return u`
            <${S.assign({icon:e.icon})}></${S}>
        `}}),qo=Object.values(ut).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),A4=Object.keys(qo).sort();function rs(e){return{controlType:O.Dropdown,initValue:e,options:["None",...A4]}}const oh={"CSS color":{controlType:O.Color,initValue:""},[String(h["toniq-icon-stroke-color"].name)]:{controlType:O.Color,initValue:""},[String(h["toniq-icon-fill-color"].name)]:{controlType:O.Color,initValue:""},[String(h["toniq-icon-stroke-width"].name)]:{controlType:O.Color,initValue:""},[String(h["toniq-icon-stroke-width"].name)]:{controlType:O.Number,initValue:2}};function jn(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),V2(n,"number")&&(n=Ha({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
`)}const E4=U({title:"Social Urls",parent:nh,elementExamplesCallback({defineExample:e}){function t({socialName:r,icon:n}){e({title:r,renderCallback(){return u`
                        <${vo.assign({icon:n})}></${vo}>
                    `}})}Object.entries(jd).forEach(([r,n])=>{t({socialName:r,icon:n})})}}),ae=U({title:"Elements",parent:void 0}),I4=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:p`
            ${Nt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],L4=U({title:Nt.tagName,parent:ae,elementExamplesCallback({defineExample:e}){I4.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:p`
                    .bold {
                        ${Y.boldFont}
                    }
                ...
                `,renderCallback({state:r,updateState:n}){return u`
                        ...
                        ></${Nt}>
                        More text
                    `}})})}}),P4=U({parent:ae,title:ie.tagName,elementExamplesCallback({defineExample:e}){[{name:"default",inputs:{}},{name:"Secondary",inputs:{buttonStyle:Gr.Secondary}},{name:"Outline",inputs:{buttonStyle:Gr.Outline}},{name:"Disabled",inputs:{disabled:!0}}].forEach(r=>{e({title:r.name,stateInitStatic:{showIcon:!1,timeoutId:void 0},styles:p`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
...
`,N4=U({parent:ae,title:ke.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:Dc,renderCallback(){return u`
                ...
                `;return u`
                    ...
                    ></${ke}>
                `}})}});function q4(e){const t=Object.keys(e.cssVars).map(r=>[`--${r}`,{controlType:O.Color,initValue:""}]);return Object.fromEntries(t)}function O4(e){const t=Object.entries(e).map(([r,n])=>{if(r.startsWith("--"))return typeof n!="string"||!n?void 0:`${r}: ${n};`}).filter(an);return q(t.join(`
`))}const B4=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],Si=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],D4=U({parent:ae,title:at.tagName,controls:{Text:{controlType:O.Text,initValue:"Text"},...q4(at)},elementExamplesCallback({defineExample:e}){B4.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:Si.map(r=>!!r.inputs.checked),extraEntryStatuses:Si.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:p`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Si.map((i,a)=>{const s=(i.extraEntries??[]).map((c,d)=>{var f;return u`
                        ...
                        `})}})})}}),R4=U({parent:ae,title:si.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Qt}},{inputs:{icon:Qt}},{inputs:{},template:u`
                    HTML child
        ...
        `}],V4=U({title:Mn.tagName,parent:ae,controls:{Selected:{controlType:O.Dropdown,initValue:En[0].label,options:En.map(e=>e.label)},Direction:{controlType:O.Dropdown,initValue:"Down",options:F2(la)},Icon:rs(xd.name),Prefix:{controlType:O.Text,initValue:"Sort by: "},"Force open":{controlType:O.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){H4.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Rc.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:p`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Rc.map((i,a)=>{const s=p`
                        ...
                        `;return u`
                            ...
                            ></${Mn}>
                        `})}})})}}),_c="/toniq-labs-design-system";function F4(...e){const r=[globalThis.location.pathname.startsWith(_c)?_c:"",...e].filter(an);return G2(...r)}const xr=Array(30).fill(F4("/toniq-labs-logo.png")),Br=["Hello there.","There is stuff here."],In=Br.concat(Array(30).fill(Br)),z4=U({title:Q.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${Q.assign({imageUrls:xr.map((t,r)=>r%2?"/invalid-image.png":t),infoParagraphs:Br,title:"With custom Template Statuses",customTemplateCallback(t){return u`
                            ...
                            `}})}></${Q}>
                `}})}}),j4=U({title:Pt.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:p`
                .front,
                .back {
                    padding: 32px;
                }
            ...
            `,renderCallback({controls:r}){return u`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            ...
                            ></${An}>
                        `))}})})}}),G4=U({title:wi.tagName,parent:ae,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:Fn.Small}},{title:"large",inputs:{size:Fn.Large}},{title:"whole page",inputs:{size:Fn.WholePage},styles:p`
                    :host {
                        width: 500px;
                    }
                `}].forEach(r=>{e({title:r.title,styles:r.styles??p``,renderCallback(){return u`
                        <${wi.assign(r.inputs)}></${wi}>
                    `}})})}}),Y4=U({title:me.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
...
`,Ci={min:10,max:50},K4=U({title:_.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:p`
                ${et}
            `,renderCallback({state:t,updateState:r}){return u`
            ...
            `,renderCallback({state:t,updateState:r}){return u`
                    <${_.assign({double:!0,value:t.value,min:0,max:100})}
                        ${T(_.events.valueChange,n=>{if(typeof n.detail=="number")throw new Error("was expecting a double slider value");r({value:n.detail})})}
                    ></${_}>
                `}})}}),X4=[{title:"default",inputs:{}},{title:"text only",inputs:{style:rh.TextOnly}},{title:"disabled",inputs:{disabled:!0}}],Hc=[{inputs:{icon:void 0}},{inputs:{toggled:!0}},{inputs:{}},{inputs:{text:void 0}}],Q4=U({title:Ti.tagName,parent:ae,controls:{Text:{controlType:O.Text,initValue:"Toggle Button"},Icon:rs(Id.name)},elementExamplesCallback({defineExample:e}){X4.forEach(t=>{e({title:t.title,stateInitStatic:{buttonStates:Hc.map(r=>!!r.inputs.toggled)},styles:p`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Hc.map((i,a)=>u`
                            ...
                            ></${Ti}>
                        `)}})})}}),ew=U({parent:ae,title:zn.tagName,elementExamplesCallback({defineExample:e}){function t({title:r,tooltipContent:n,forceShow:o}){e({title:r,styles:p`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),tw=U({parent:ae,title:Or.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${zn.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return u`
                    <${Or}>This is a tooltip.</${Or}>
                `}})}}),rw=[ew,tw],nw=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:p`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:p``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}}],ow=U({title:Ir.tagName,parent:ae,elementExamplesCallback({defineExample:e}){nw.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:p`
                    ${t.extraStyles??p``}
                `,renderCallback({state:r,updateState:n}){return u`
                        ...
                        ></${Ir}>
                    `}})})}}),ih=U({title:"Icons",parent:void 0,controls:oh}),iw=Object.entries(ut).map(([e,t])=>U({title:e,parent:ih,elementExamplesCallback({defineExample:r}){t.map(n=>r({title:n.name,renderCallback({controls:o}){return u`
                                <${vo.assign({icon:n})}
                                    style=${jn(o)}
                                ></${vo}>
                            `}}))}}));function ah(e){const t=aw(e),r=sr(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return Ke(r).reduce((o,i)=>{const a=r[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function aw(e){typeof e!="string"&&(e=String(e));const n=`{"${N2(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const ns=U({title:"Styles",parent:void 0}),sw=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function lw(e,t,r){const n=ah(F(r));return e({title:t,styles:sw,renderCallback(){return u`
            ...
            `}})}const cw=U({title:"Colors",parent:ns,elementExamplesCallback({defineExample:e}){Ke($).map(t=>lw(e,t,$[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),uw=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function dw(e,t,r){const n=ah(r);return e({title:t,styles:uw,renderCallback(){return u`
            ...
            `}})}const hw=U({title:"Fonts",parent:ns,elementExamplesCallback({defineExample:e}){Ke(Y).map(t=>{const r=Y[t];return dw(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),fw=[ae,ih,ns,nh],mw=[...iw,...rw,E4,L4,P4,N4,D4,R4,cw,_4,V4,z4,j4,hw,Z4,W4,U4,G4,Y4,J4,K4,Q4,ow].sort((e,t)=>e.title.localeCompare(t.title)),pw=[...fw,...mw];xo({tagName:"toniq-design-system-app",styles:p`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return u`
            <${ri.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:pw,themeColor:"#00D093"})}>
