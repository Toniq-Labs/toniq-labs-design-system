...
`,Pd=w({name:"LoaderAnimated24Icon",svgTemplate:c`
    ...
    `,events:{routeChange:ie()},renderCallback({inputs:e,dispatch:t,events:n}){var o,i;function r(a){e.route&&ti(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new n.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return c`
            ...
            `}}});const{defineElement:Ge,defineElementNoInputs:yA}=ss(),je=Ge()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>h`
        a {
            box-sizing: border-box;
            display: block;
...
`))}const P=(()=>{const e=h`
    ...
    `}),Km=w({name:"LightningBolt24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
    ...
    `}),Qm=w({name:"LightningBoltFilled24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
    ...
    `}),Jm=w({name:"List24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),_m=w({name:"ListDetails24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),eg=w({name:"Loader24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),tg=w({name:"Lock24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),ng=w({name:"LockOpen24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),rg=w({name:"Menu24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),og=w({name:"Pamphlet24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),ig=w({name:"Paper24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),ag=w({name:"People24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),sg=w({name:"Person24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),lg=w({name:"Photo24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),cg=w({name:"Plus24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
    ...
    `}),ug=w({name:"Refresh24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),dg=w({name:"Send24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),hg=w({name:"ShootingStar24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),fg=w({name:"ShoppingCart24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),pg=w({name:"Sliders24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
    ...
    `}),mg=w({name:"Social24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),gg=w({name:"Square24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),wg=w({name:"SquareCheck24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Ag=w({name:"Tag24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),vg=w({name:"Upload24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),bg=w({name:"UploadCloud24",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),yg=w({name:"Wallet24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),kg=w({name:"WorldUpload24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),xg=w({name:"X24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),$g=w({name:"Fire48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Cg=w({name:"Folder48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Tg=w({name:"Kyc48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Sg=w({name:"Rocket48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Mg=w({name:"Sunrise48Icon",svgTemplate:c`
        <svg
            width="48"
            height="48"
            viewBox="0 0 48 48"
    ...
    `}),Eg=w({name:"Tag48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${d["toniq-icon-fill-color"].value}
            stroke=${d["toniq-icon-stroke-color"].value}
    ...
    `}),Ig=w({name:"Trophy48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),qg=w({name:"Wallet48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${d["toniq-icon-fill-color"].value}
            stroke=${d["toniq-icon-stroke-color"].value}
    ...
    `}),Pg=w({name:"CircleDashes64Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Bg=w({name:"Rocket64Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Lg=w({name:"CryptoBoxy24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
    ...
    `}),Og=w({name:"CryptoBtc16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Ng=w({name:"CryptoCkBtc16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Dg=w({name:"CryptoCkBtc24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
...
`,Rg=w({name:"CryptoIcp16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),jg=w({name:"CryptoIcp24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Fg=w({name:"CryptoRich24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            id="Layer_1"
            width="24"
    ...
    `}),Vg=w({name:"WalletBitfinity24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),zg=w({name:"WalletBitfinity64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),Hg=w({name:"WalletLeather24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),Wg=w({name:"WalletLeather64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),Ug=w({name:"WalletPlug24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),Gg=w({name:"WalletStoic24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),Yg=w({name:"WalletStoic64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),Xg=w({name:"WalletUnisat24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),Kg=w({name:"WalletUnisat64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),Qg=w({name:"WalletXverse24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),Jg=w({name:"WalletXverse64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),_g=w({name:"BrandFacebookLogo24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),e4=w({name:"BrandGoogleLogo24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),t4=w({name:"BrandIcScan24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),n4=w({name:"BrandInstagramFlat24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),r4=w({name:"BrandNftgeek24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),o4=w({name:"BrandTiktokFlat24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${Y["toniq-icon-fill-color"]("#000")}
    ...
    `}),i4=w({name:"BioniqRobot100Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),a4=w({name:"EntrepotLogo144Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),at={"core-16":[om,jd,lm,cm,um,Pt,dm,hm],"core-24":[fm,pm,ws,mm,gm,As,Fd,wm,Am,vm,bm,ym,km,xm,$m,Cm,vs,Vd,Tm,Sm,zd,Mm,Em,Im,qm,Pm,Hd,Bm,Lm,Om,Nm,Dm,Wd,Rm,jm,Fm,Vm,zm,Hm,Wm,Um,Zm,mn,Ud,Gm,Ym,Xm,Km,Qm,Jm,_m,eg,bs,tg,ng,rg,og,ig,ag,sg,lg,cg,ug,Zd,Gd,dg,hg,fg,pg,mg,gg,wg,Ag,Yd,mo,vg,bg,yg,Xd,kg,xg,Kd],"core-48":[$g,Cg,Qd,Tg,Sg,Mg,Eg,Ig,qg],"core-64":[Jd,Pg,Bg],cryptocurrencies:[Lg,Og,gt,Ng,Dg,Rg,jg,Fg],"external-wallets":[Vg,zg,Hg,Wg,Ug,Zg,Gg,Yg,Xg,Kg,Qg,Jg],"third-party-brands":[t0,n0,r0,_g,e4,t4,o0,n4,i0,r4,a0,s0,o4,l0,c0],toniq:[i4,a4]},s4=qr({discord:ot(void 0,""),distrikt:ot(void 0,""),dscvr:ot(void 0,""),instagram:ot(void 0,""),medium:ot(void 0,""),telegram:ot(void 0,""),tikTok:ot(void 0,""),twitch:ot(void 0,""),twitter:ot(void 0,""),website:ot(void 0,"")}),l4=s4.defaultValue,u0={discord:t0,instagram:o0,telegram:a0,tikTok:s0,distrikt:n0,twitch:l0,dscvr:r0,medium:i0,twitter:c0,website:Xd},tc="toniq-",{defineElement:ae,defineElementNoInputs:ys}=ss({assertInputs:e=>{if(!e.tagName.startsWith(tc))throw new Error(`Tag name should start with '${tc}' but got '${e.tagName}'`)}}),b=ae()({tagName:"toniq-icon",styles:h`
        :host {
            display: flex;
    ...
    `,renderCallback({inputs:e}){const t=e.iconPlacement??"left",n=e.icon?c`
        ...
        `}});function c4(e,t,n={behavior:"smooth"}){let r=2;const o=t==="up"||t==="down"?"y":"x",i=t==="right"||t==="down"?"+":"-",a=o==="x"?e.scrollWidth-e.offsetWidth:e.scrollHeight-e.offsetHeight,s=ks(e)[o];i==="-"&&(r*=-1);const l=e[o==="x"?"scrollLeft":"scrollTop"]+r,u=s.filter(f=>i==="+"?f>l:f<l).sort((f,m)=>i==="+"?f-m:m-f);let p;return u.length>0?p=u[0]:i==="+"?p=a:p=0,e.scrollTo({...n,[o==="x"?"left":"top"]:p})}function u4(e){const t=window.getComputedStyle(e),n=e.getBoundingClientRect();let r=t.getPropertyValue("scroll-padding-left").replace("auto","0px"),o=t.getPropertyValue("scroll-padding-top").replace("auto","0px"),i=t.getPropertyValue("scroll-padding-right").replace("auto","0px"),a=t.getPropertyValue("scroll-padding-bottom").replace("auto","0px");function s(m,g){let v=parseFloat(m);return/%/.test(m)&&(v/=100,v*=g),v}let l=s(r,n.width),u=s(o,n.height),p=s(i,n.width),f=s(a,n.height);return{x:{before:l,after:p},y:{before:u,after:f}}}function d4(e,t,n="both"){return n==="x"&&e.right>=t.left&&e.left<=t.right||n==="y"&&e.bottom>=t.top&&e.top<=t.bottom||n==="both"&&e.right>=t.left&&e.left<=t.right&&e.bottom>=t.top&&e.top<=t.bottom}function f0(e){let t=[];for(const n of e.children)t=t.concat(n,f0(n));return t}function h4(e,t=!0){const n=e.getBoundingClientRect(),r={x:{start:[],center:[],end:[]},y:{start:[],center:[],end:[]}},o=f0(e);for(const i of["x","y"]){const a=i==="x"?"y":"x",s=i==="x"?"left":"top",l=i==="x"?"width":"height",u=i==="x"?"scrollLeft":"scrollTop";for(const p of o){const f=p.getBoundingClientRect();if(t&&!d4(n,f,a))continue;const m=window.getComputedStyle(p);let[g,v]=m.getPropertyValue("scroll-snap-align").split(" ");typeof v>"u"&&(v=g);const k=i==="x"?v:g,x=f[s]-n[s]+e[u];switch(k){case"none":break;case"start":r[i].start.push(x);break;case"center":r[i].center.push(x+f[l]/2);break;case"end":r[i].end.push(x+f[l]);break}}}return r}function ks(e){const t=e.getBoundingClientRect(),n=u4(e),r=h4(e),o={x:e.scrollWidth-e.offsetWidth,y:e.scrollHeight-e.offsetHeight},i=(a,s)=>l=>Math.max(a,Math.min(s,l));return{x:nc([...r.x.start.map(a=>a-n.x.before),...r.x.center.map(a=>a-t.width/2),...r.x.end.map(a=>a-t.width+n.x.after)].map(i(0,o.x))),y:nc([...r.y.start.map(a=>a-n.y.before),...r.y.center.map(a=>a-t.height/2),...r.y.end.map(a=>a-t.height+n.y.after)].map(i(0,o.y)))}}function nc(e){return Array.from(new Set(e))}const go="templates-container",f4=4e3;var wo=(e=>(e.Default="default",e.Banner="banner",e))(wo||{});const Ae=ae()({tagName:"toniq-carousel",hostClasses:{"toniq-carousel-banner-variant":({inputs:e})=>e.variant==="banner","toniq-carousel-offset-arrows":({inputs:e})=>!!e.offsetArrows},stateInitStatic:{currentScrollPosition:{left:0,right:1/0},scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({hostClasses:e})=>h`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
    ...
    `,events:{pageChange:ie()},renderCallback({inputs:e,events:t,dispatch:n}){return e.pageCount<=1?c``:c`
                ...
                ${Uw(e.currentPage,e.pageCount,e.pagesShown).map(r=>typeof r=="string"?c`
    ...
    `,stateInitStatic:{canScroll:!1,debouncedResize:B2(()=>J1(fr.FirstThenWait,{milliseconds:30})),rowStyles:{},isPainting:!1,isStillPainting:!0,pageCountKey:0,tableListLeft:0},initCallback({inputs:e,state:t,updateState:n}){const r=e.columns.filter(o=>!o.disabled);n({rowStyles:r.reduce((o,i)=>(o[i.key]={width:void 0,left:void 0},o),t.rowStyles)})},renderCallback({inputs:e,state:t,updateState:n,events:r,dispatch:o,host:i}){var m;const a=e.columns.filter(g=>!g.disabled),s=[e.rows[0],...e.rows].filter(ye);function l(g){g instanceof HTMLElement&&setTimeout(()=>{t.debouncedResize(()=>{n({canScroll:g.scrollWidth>g.clientWidth,tableListLeft:g.getBoundingClientRect().left})})},0)}const u=e.pagination&&((m=e.pagination)==null?void 0:m.pageCount)>1?c`
        ...
        `}});async function Zw(e){return navigator.clipboard.writeText(e)}const Gw="…";function Yw(e,t){const n=e.slice(0,t).trim(),r=e.slice(-1*t).trim();return`${n}${Gw}${r}`}function Xw(e){return!(e%1)}function Kw(e){return e.letterCount==null?4:Xw(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const S=ae()({tagName:"toniq-middle-ellipsis",events:{copy:ie()},cssVars:{"toniq-middle-ellipsis-text-color":A.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":A.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":A.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":A.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>h`
        :host {
            /* 5 frames at 60 fps */
            transition: ${oe.interaction};
            ${P.paragraphFont};
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:n,state:r,updateState:o}){if(!e.text)return c``;const i=e.text,a=Kw(e),s=!!e.externalLink,l=!!e.copyOnClick,u=i.length>a*2+2,p=u?Yw(i,a):i,f=u?i:"",m=s?Wd:l?Hd:void 0,g=m?c`
                  <${b.assign({icon:m})}></${b}>
              `:"",v=c`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:hu()})},renderCallback({inputs:e,dispatch:t,events:n,state:r}){return Qw(e.entries).map(i=>Jw(e.groupName||r.randomGroupName,e.value,i,()=>{t(new n.valueChange(i.value))}))}});function Qw(e){const t=Object.fromEntries(e.map(r=>[r.value,r]));return Object.values(t).length!==e.length&&console.error(`${J.tagName} was given duplicate entry values.`),Object.values(t)}function Jw(e,t,n,r){const o=t===n.value,i=c`
    ...
    `}function ea(e,t){const n=e[0],r=e[e.length-1];if(n==null||r==null)return 0;if(t<n)return n;if(t>r)return r;const o=e.findIndex((u,p)=>{const f=e[p+1];return f==null?!0:u<=t&&f>=t});if(o<0)return n;const i=e[o];if(i==null)return n;const a=e[o+1];if(a==null)return i;const s=t-i,l=a-t;return s<l?o:o+1}function _w(e,t,n=100){e>t&&([e,t]=[t,e]),n<2&&(n=2);let r=e3(e);const o=[e];for(;r<t;){const i=Math.pow(10,String(r).length-1),a=r+i;a<t&&o.push(a),r=a}return o.push(t),o.length>n&&(Hc(o,n),o.length>n&&Hc(o,n)),o}function Hc(e,t){const n=e.length-t,r=(e.length-2)/n;for(let o=e.length-2;o>=1;o-=r)e.splice(Math.floor(o),1)}function e3(e){let t=1;if(!e)return e;e<0&&(t=-1,e=e*-1);const n=e.toFixed(0),r=Math.pow(10,n.length-1),o=Number(n[0]||1);return r*o*t}const B={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},Zn={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"},dr={hot:"rgb(200,0,0)",medium:"orange",cold:"rgb(0,200,0)"};function hn(e){return h`
        background-color: ${M(dr[e])};
        color: ${M(dr[e])};
    `}function t3(e){var r,o;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${B.lowerLabelWrapper} .${B.labelPercentMarginWrapper}`),n=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${B.upperLabelWrapper} .${B.labelPercentMarginWrapper}`);if(n instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),a=n.getBoundingClientRect();return{lower:i,upper:a}}else return}function n3(e,t=8){const n=t3(e);if(!n)return 0;const r=n.lower.right-n.upper.left+t;return Math.max(0,r)}function ta({value:e,limits:t,flip:n}){const o=(t.max-e)/(t.max-t.min)*100;return-(n?100-o:o)}function Sr(e){return Ue(e)&&e.min!==void 0&&e.max!==void 0}function za(e){var n;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${B.range}`);return(t==null?void 0:t.clientWidth)??0}function na(e,t,n){return`${n?Ah(e):e} ${t}`}function r3({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function o3({value:e,double:t,min:n,max:r}){return t?Sr(e)?{min:yn({value:e.min,min:n,max:Math.min(e.max,r)}),max:yn({value:e.max,min:Math.max(e.min,n),max:r})}:{min:n,max:r}:Sr(e)?n:yn({value:e,min:n,max:r})}function i3({actualValue:e,actualLimits:t,logScale:n,logRange:r}){return n?{elementValue:Sr(e)?{min:ea(r,e.min),max:ea(r,e.max)}:ea(r,e),elementLimits:{min:0,max:r.length-1}}:{elementValue:e,elementLimits:t}}function ra(e,t,n){return n?t[e]||0:e}function a3(e){return{actualLimits:r3(e),actualValue:o3(e)}}function s3(e,t){var r,o,i;let n=!1;if(Sr(e)){const a=(r=t.shadowRoot)==null?void 0:r.querySelector(`.${B.lowerSlider}`),s=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${B.upperSlider}`);a instanceof HTMLInputElement&&s instanceof HTMLInputElement&&(Number(a.value)!==e.min&&(a.value=String(e.min),n=!0),Number(s.value)!==e.max&&(s.value=String(e.max),n=!0))}else{const a=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${B.slider}`);a instanceof HTMLInputElement&&Number(a.value)!==e&&(a.value=String(e),n=!0)}return n}function b1(e,t){const{actualValue:n,actualLimits:r}=a3({...e}),o=_w(r.min,r.max),i=e.logScale??!1,a=e.suffix??"",{elementValue:s,elementLimits:l}=i3({actualValue:n,actualLimits:r,logScale:i,logRange:o}),u=za(t);return{actualValue:n,elementLimits:l,elementValue:s,isLogScale:i,logRange:o,rangeWidth:u,suffix:a}}const Wt=16,Wc=h`
    ${Wt}px
`,Uc=h`
...
`,Zc=h`
    transform: scale(1.2);
`;function l3(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function _n(e){requestAnimationFrame(()=>{const t=b1(e.instanceInputs,e).elementValue;s3(t,e)&&(e.setAttribute("disabled","true"),_n(e))})}const j=ae()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ie()},styles:h`
        :host {
            display: block;
        }
            ...
            `}function v(x){i({internalValue:x}),e.disabled||r(new n.valueChange(x))}function k(x,$,T){const N=Ut((m-Wt)*(T.max-$)/(T.max-T.min)+Wt/2),R=na(x,u,l),G=ta({value:$,limits:T,flip:!1});return c`
                ...
                >
                    ...
                    <input
                        ?disabled=${e.disabled??!1}
                        type="range"
                        class="${B.slider} ${e.colorTemperature?l3(Math.abs(G)):""}"
                        step=${e.step}
                        .min=${T.min}
                        .max=${T.max}
                        .value=${$}
    ...
    `,renderCallback({inputs:e}){return c`
            <${b.assign({icon:e.icon})}></${b}>
        `}}),di=Object.values(at).reduce((e,t)=>(t.forEach(n=>{if(n.name in e)throw new Error(`Icon name duplicate: '${n.name}'`);e[n.name]=n}),e),{}),c3=Object.keys(di).sort();function Ps(e){return{controlType:V.Dropdown,initValue:e,options:["None",...c3]}}const C1={"CSS color":{controlType:V.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:V.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:V.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:V.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:V.Number,initValue:2}};function yo(e){return Object.entries(e).filter(([,n])=>n!==""&&n!=null).map(([n,r])=>(n.toLowerCase()==="css color"&&(n="color"),ee(r,"number")&&(r=Wa({value:r,suffix:"px"})),`${n}: ${r};`)).join(`
`)}const u3=z({title:"Social Urls",parent:$1,elementExamplesCallback({defineExample:e}){function t({socialName:n,icon:r}){e({title:n,renderCallback(){return c`
                        <${Zo.assign({icon:r})}></${Zo}>
                    `}})}Object.entries(u0).forEach(([n,r])=>{t({socialName:n,icon:r})})}}),te=z({title:"Elements",parent:void 0}),d3=z({parent:te,title:sr.tagName,elementExamplesCallback({defineExample:e}){[{name:"danger",inputs:{variant:ar.Danger},slot:c`<strong>Alert!</strong>This is an alert, Please be very careful!`},{name:"warning",inputs:{variant:ar.Warning},slot:"This is a warning, proceed with caution 🚧"},{name:"success",inputs:{variant:ar.Success},slot:"You have successfully completed your task!"}].forEach(n=>{e({title:n.name,stateInitStatic:{},styles:h`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
                ...
                `,renderCallback(){return c`
                    ...
                    `}})})}}),h3=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:h`
            ${St} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],f3=z({title:St.tagName,parent:te,elementExamplesCallback({defineExample:e}){h3.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:h`
                    .bold {
                        ${P.boldFont}
                    }
...
`,m3=z({parent:te,title:Ae.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:ia,renderCallback(){return c`
                ...
                `;return c`
                    ...
                    <${Ae.assign({enableAutomaticCycling:!1,offsetArrows:!0,variant:wo.Banner,templates:at["core-24"].map(n=>c`
                            ...
                            `)})}></${Ae}>
                `}})}});function g3(e){const t=Object.keys(e.cssVars).map(n=>[`--${n}`,{controlType:V.Color,initValue:""}]);return Object.fromEntries(t)}function w3(e){const t=Object.entries(e).map(([n,r])=>{if(n.startsWith("--"))return typeof r!="string"||!r?void 0:`${n}: ${r};`}).filter(ye);return M(t.join(`
`))}const A3=[{title:"default",inputs:{}},{title:"button",inputs:{variant:p0.Button}},{title:"disabled",inputs:{disabled:!0}}],aa=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],v3=z({parent:te,title:yt.tagName,controls:{Text:{controlType:V.Text,initValue:"Text"},...g3(yt)},elementExamplesCallback({defineExample:e}){A3.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:aa.map(n=>!!n.inputs.checked),extraEntryStatuses:aa.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:h`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return aa.map((i,a)=>{const s=(i.extraEntries??[]).map((u,p)=>{var f;return c`
                        ...
                        `})}})})}}),b3=z({parent:te,title:Ri.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Pt}},{inputs:{icon:Pt}},{inputs:{},template:c`
                    HTML child
        ...
        `},{customStyle:h`
            max-height: 30px;
            min-height: 30px;
        `}],x3=z({title:ro.tagName,parent:te,controls:{Selected:{controlType:V.Dropdown,initValue:io[0].label,options:io.map(e=>e.label)},Direction:{controlType:V.Dropdown,initValue:"Down",options:su(Ra)},Icon:Ps(Fd.name),Prefix:{controlType:V.Text,initValue:"Sort by: "},"Force open":{controlType:V.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){k3.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Gc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:h`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Gc.map((i,a)=>{const s=h`
                        ...
                        `;return c`
                            ...
                            ></${ro}>
                        `})}})})}}),$3=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],C3=z({title:Xi.tagName,parent:te,elementExamplesCallback({defineExample:e}){$3.forEach(t=>{e({title:t.title,renderCallback(){return c`
                        <${Xi}>${t.content}</${Xi}>
                    `}})})}}),Yc="/toniq-labs-design-system";function T1(...e){const n=[globalThis.location.pathname.startsWith(Yc)?Yc:"",...e].filter(ye);return mr(...n)}const fn=Array(30).fill(T1("/toniq-labs-logo.png")),bn=["Hello there.","There is stuff here."],ao=bn.concat(Array(30).fill(bn)),T3=z({title:re.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${re.assign({infoParagraphs:ao,imageUrls:fn,socialUrls:l4,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${re}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${re.assign({imageUrls:fn.map((t,n)=>n%2?"/invalid-image.png":t),infoParagraphs:bn,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return c`
                            ...
                            `}})}></${re}>
                `}})}}),S3=z({title:Xt.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:h`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:n}){return c`
                ...
                `}})}}),M3=z({title:qe.tagName,parent:te,elementExamplesCallback({defineExample:e}){lu(An).forEach(t=>{e({title:t,renderCallback(){return c`
            ...
            `,renderCallback({controls:n}){return c`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),c`
                            ...
                            ></${oo}>
                        `))}})})}}),S1="https://cdn-bitcoin.bioniq.io",P3=mr(S1,"content"),B3=mr(S1,"thumbnail"),et={thumbnail(e){return mr(B3,e)},content(e){return mr(P3,e)}},L3=[{imageUrl:et.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
            <div
                style=${h`
                    display: flex;
                    gap: 8px;
        ...
        `}],O3=Array(50).fill({imageUrl:et.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${h`
                display: flex;
                gap: 8px;
    ...
    `}),N3=[{imageUrl:et.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Payment Sent",price:c`
            <div
                style=${h`
                    display: flex;
                    gap: 8px;
        ...
        `}],D3=[],R3=Array(5).fill({imageUrl:et.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${h`
                display: flex;
                gap: 8px;
    ...
    `}),sa=jr({entries:L3,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"price",title:"PRICE",option:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${h`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),j3=jr({entries:O3,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"price",title:"PRICE LONG COLUMN NAME",option:{sticky:!0,spaceEvenly:!0}},{key:"from",title:"FROM",option:{spaceEvenly:!0}},{key:"to",title:"TO",option:{spaceEvenly:!0},style:h`
                width: 100%;
                display: flex;
                justify-content: flex-end;
            `}],createRowObject:e=>({cells:{image:c`
                ...
                `},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),Xc=jr({entries:N3,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"type",title:"TYPE",option:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),F3=jr({entries:D3,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"type",title:"TYPE",option:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${h`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),V3=jr({entries:R3,columns:[{key:"image",title:"",option:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME",style:h`
                display: flex;
                justify-content: flex-end;
            `}],createRowObject:e=>({cells:{image:c`
                    <img
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),z3=[{title:"basic"},{title:"with pagination",inputs:{pagination:{currentPage:1,pageCount:10}}},{title:"with pagination and custom action",inputs:{pagination:{currentPage:1,pageCount:10},paginationAction:c`
                <${b.assign({icon:Yd})}
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Kc=ys({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const n=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(n)}})}},cleanupCallback({state:e,updateState:t}){var n;(n=e.cleanup)==null||n.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),H3=z({title:ke.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return c`
            ...
            `,renderCallback(){return c`
                    <${ke.assign({...j3,pagination:{currentPage:1,pageCount:5},nonBlocking:!0})}></${ke}>
                `}})}}),W3=z({title:ur.tagName,parent:te,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:cr.Small}},{title:"large",inputs:{size:cr.Large}},{title:"whole page",inputs:{size:cr.WholePage},styles:h`
                    :host {
                        width: 500px;
                    }
                `}].forEach(n=>{e({title:n.title,styles:n.styles??h``,renderCallback(){return c`
                        <${ur.assign(n.inputs)}></${ur}>
                    `}})})}}),U3=z({title:S.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return c`
...
`,so={min:10,max:50},Y3=z({title:j.tagName,parent:te,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:h`
                ${Qe}
            `,renderCallback({state:t,updateState:n}){return c`
            ...
            `,renderCallback({state:t,updateState:n}){return c`
                    <${j.assign({value:t.value,noLabel:!0,...so})}
                        ${y(j.events.valueChange,r=>{if(typeof r.detail!="number")throw new Error("was expecting a single numeric slider value");n({value:r.detail})})}
                    ></${j}>
                `}})}}),X3=[{title:"default",inputs:{}},{title:"right icon",inputs:{iconPlacement:k1.Right}},{title:"text only",inputs:{variant:y1.TextOnly}},{title:"disabled",inputs:{disabled:!0}}],Qc=[{inputs:{icon:void 0}},{inputs:{toggled:!0}},{inputs:{}},{inputs:{text:void 0}}],K3=z({title:oa.tagName,parent:te,controls:{Text:{controlType:V.Text,initValue:"Toggle Button"},Icon:Ps(Zd.name)},elementExamplesCallback({defineExample:e}){X3.forEach(t=>{e({title:t.title,stateInitStatic:{buttonStates:Qc.map(n=>!!n.inputs.toggled)},styles:h`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Qc.map((i,a)=>c`
                            ...
                            ></${oa}>
                        `)}})})}}),Q3=z({parent:te,title:bo.tagName,elementExamplesCallback({defineExample:e}){function t({title:n,tooltipContent:r,forceShow:o}){e({title:n,styles:h`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!1}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!1})}}),J3=z({parent:te,title:hr.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${bo.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return c`
                    <${hr}>This is a tooltip.</${hr}>
                `}})}}),_3=[Q3,J3],eA=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:h`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:h``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:h``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:mn},{label:"label here",value:2,icon:mn},{label:"",value:3,icon:Pt,disabled:!0},{label:"16px icon",value:4,icon:Pt},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}},{title:"no bottom border",inputs:{value:"hi",tabs:["hi","bye","hello","so long"],options:{variant:x1.Minimal}}},{title:"icon only",inputs:{value:0,tabs:[{label:"tab 1",value:0,icon:mn},{label:"tab 2",value:1,icon:mn},{label:"tab 3",value:2,icon:mn}],options:{iconOnlyMobile:!0}}}],tA=z({title:er.tagName,parent:te,elementExamplesCallback({defineExample:e}){eA.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:h`
                ...
                `,renderCallback({state:n,updateState:r}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return c`
                        ...
                        ></${er}>
                    `}})})}}),M1=z({title:"Icons",parent:void 0,controls:C1}),nA=Object.entries(at).map(([e,t])=>z({title:e,parent:M1,elementExamplesCallback({defineExample:n}){t.map(r=>n({title:r.name,renderCallback({controls:o}){return c`
                                <${Zo.assign({icon:r})}
                                    style=${yo(o)}
                                ></${Zo}>
                            `}}))}}));function E1(e){const t=rA(e),n=be(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return ue(n).reduce((o,i)=>{const a=n[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function rA(e){typeof e!="string"&&(e=String(e));const r=`{"${tu(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(r);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${r}`),o}}const hi=z({title:"Styles",parent:void 0}),oA=h`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function iA(e,t,n){const r=E1(F(n));return e({title:t,styles:oA,renderCallback(){return c`
            ...
            `}})}const aA=z({title:"Colors",parent:hi,elementExamplesCallback({defineExample:e}){ue(A).map(t=>iA(e,t,A[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),sA=h`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function lA(e,t,n){const r=E1(n);return e({title:t,styles:sA,renderCallback(){return c`
            ...
            `}})}const cA=z({title:"Fonts",parent:hi,elementExamplesCallback({defineExample:e}){ue(P).map(t=>{const n=P[t];return lA(e,t,n)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),uA=z({title:"Shadows",parent:hi,elementExamplesCallback({defineExample:e}){R1(Cr).forEach(([t,n])=>{e({title:t,styles:h`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return c`
                            <div></div>
                        `}})})}}),dA=[te,M1,hi,$1],hA=[...nA,..._3,u3,f3,d3,p3,m3,v3,b3,aA,y3,x3,C3,T3,S3,cA,M3,E3,I3,q3,W3,U3,Z3,G3,uA,Y3,K3,tA,H3].sort((e,t)=>e.title.localeCompare(t.title)),fA=[...dA,...hA];ei({tagName:"toniq-design-system-app",styles:h`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return c`
            <${Li.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:fA,themeColor:"#00D093"})}>
