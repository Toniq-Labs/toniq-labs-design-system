var yh=Object.defineProperty;var kh=(e,t,n)=>t in e?yh(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var Pr=(e,t,n)=>(kh(e,typeof t!="symbol"?t+"":t,n),n);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function n(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(o){if(o.ep)return;o.ep=!0;const i=n(o);fetch(o.href,i)}})();const xh=[(e,t)=>t in e,(e,t)=>t in e.constructor.prototype];function Te(e,t){return e?xh.some(n=>{try{return n(e,t)}catch{return!1}}):!1}function Wc(e,t){return e&&t.every(n=>Te(e,n))}function le(e){let t;try{t=Reflect.ownKeys(e)}catch{}return t??[...Object.keys(e),...Object.getOwnPropertySymbols(e)]}function Ah(e){return le(e).map(t=>e[t])}function $h(e){return le(e).map(t=>[t,e[t]])}function Ch(e){return Object.fromEntries(e)}function Sh(e,t){return e.includes(t)}function Th(e,t){return e.map(t)}function we(e){return!!e}function zc(e,t){return e.match(t)??[]}function Mh(e){return e.replace(/,/g,"")}function Zc(e,{keepNewLines:t}={}){return(t?e.replace(/[\s\n]*\n+[\s\n]*/g,`
`):e.replace(/\n/g," ")).trim().replace(/\s{2,}/g," ")}const Eh={capitalizeFirstLetter:!1};function Ih(e){return e.length?e[0].toUpperCase()+e.slice(1):""}function Bh(e,t){return t.capitalizeFirstLetter?Ih(e):e}function Lh(e,t=Eh){const n=e.toLowerCase();if(!n.length)return"";const r=n.replace(/^-+/,"").replace(/-{2,}/g,"-").replace(/-(?:.|$)/g,o=>{const i=o[1];return i?i.toUpperCase():""});return Bh(r,t)}var xn;(function(e){e.Upper="upper",e.Lower="lower"})(xn||(xn={}));function qh(e){return e.toLowerCase()!==e.toUpperCase()}function Ss(e,t,n){if(!e&&(n!=null&&n.blockNoCaseCharacters))return!1;for(let r=0;r<e.length;r++){const o=e[r]||"";if(!qh(o)){if(n!=null&&n.blockNoCaseCharacters)return!1;continue}if(t===xn.Upper&&o!==o.toUpperCase())return!1;if(t===xn.Lower&&o!==o.toLowerCase())return!1}return!0}function fo(e){return e.split("").reduce((n,r,o,i)=>{const a=o>0&&i[o-1]||"",s=o<i.length-1&&i[o+1]||"",l=Ss(a,xn.Lower,{blockNoCaseCharacters:!0})||Ss(s,xn.Lower,{blockNoCaseCharacters:!0});return r===r.toLowerCase()||o===0||!l?n+=r:n+=`-${r.toLowerCase()}`,n},"").toLowerCase()}function An(e,t){return e.split(t)}const Ph=String(NaN);function Gc(e){if(typeof e=="string"&&isNaN(Number(e)))return Ph;const t=Number(e),n=t<0,r=String(Math.abs(t)),[o,i]=r.split("."),a=i?`.${i}`:"",l=zc(o.split("").reverse().join(""),/.{1,3}/g).reverse().map(f=>f.split("").reverse().join("")).join(",");return[n?"-":"",l,a].join("")}function Oh(e){return typeof e=="number"?e:Number(typeof e=="string"?Mh(e):e)}function Dh(e){return String(e).includes("e")}function Nh({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function Xi(e){const t=Math.pow(10,e.digits),n=e.number*t;return Number((Math.round(n)/t).toFixed(e.digits))}function wn({value:e,min:t,max:n}){return Math.min(Math.max(e,t),n)}var ar;(function(e){e.FirstThenWait="first-then-wait",e.AfterWait="after-wait"})(ar||(ar={}));function Rh(e,t){let n=0,r;return o=>{r=o;const i=Date.now();n>i||(e===ar.FirstThenWait?r():e===ar.AfterWait&&setTimeout(()=>{r==null||r()},t.milliseconds),n=i+t.milliseconds)}}function Yc(e){if(!e||e.length===0)return;const t=e[0];return e.length===1&&t?t:new Error(e.map(n=>Ot(n).trim()).join(`
`))}function Fh(e){return e?e.map(Ot).filter(we).join(`
`):""}function Ot(e){return e?e instanceof Error?e.message:Te(e,"message")?String(e.message):String(e):""}function Qc(e){return e instanceof Error?e:new Error(Ot(e))}function jh(e,t){const n=Qc(e);return n.message=`${t}: ${n.message}`,n}class Hh extends Error{constructor(){super(...arguments),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"AssertionError"})}}function po(e){return Array.isArray(e)?"array":typeof e}function ee(e,t){return po(e)===t}function Uh(e,t){if(!(ee(e,"string")||ee(e,"number")||ee(e,"symbol")))throw new Hh(t||`value is of type '${po(e)}' but expected a PropertyKey.`)}function ii(e){try{return Uh(e),!0}catch{return!1}}function ze(e){return!!e&&typeof e=="object"}function Kc(e,t,n=!1,r={}){const o=le(e),i=new Set(le(t));if(!n){const a=o.filter(s=>!i.has(s));if(a.length)throw new Error(`Test object has extra keys: ${a.join(", ")}`)}i.forEach(a=>{if(!Te(e,a))throw new Error(`test object does not have key "${String(a)}" from expected shape.`);function s(f){throw new Error(`test object value at key "${String(a)}" did not match expected shape: ${f}`)}const l=e[a],c=t[a];r[a]||Jc(l,c,s,n,r[a]??{})})}function Jc(e,t,n,r,o){var s;const i=typeof e,a=typeof t;i!==a&&n(`type "${i}" did not match expected type "${a}"`);try{Te(t,"constructor")&&(!Te(e,"constructor")||e.constructor!==t.constructor)&&n(`constructor "${(s=e==null?void 0:e.constructor)==null?void 0:s.name}" did not match expected constructor "${t.constructor}"`)}catch(l){if(l instanceof n)throw l}Array.isArray(t)?(Array.isArray(e)||n("expected an array"),e.forEach((l,c)=>{if(t.map(h=>{try{Jc(l,h,n,r,o);return}catch(m){return new Error(`entry at index "${c}" did not match expected shape: ${Ot(m)}`)}}).filter(we).length===t.length)throw new Error(`entry at index "${c}" did not match any of the possible types from "${t.join(", ")}"`)})):ze(t)&&Kc(e,t,r,o)}function Ts({source:e,whitespace:t,errorHandler:n}){try{return JSON.stringify(e,void 0,t)}catch(r){if(n)return n(r);throw r}}const Ms="Failed to compare objects using JSON.stringify";function Es(e,t,n){return Ts({source:e,errorHandler(r){if(n)return"";throw r}})===Ts({source:t,errorHandler(r){if(n)return"";throw r}})}function it(e,t,n={}){try{return e===t?!0:ze(e)&&ze(t)?Es(Object.keys(e).sort(),Object.keys(t).sort(),!!(n!=null&&n.ignoreNonSerializableProperties))?Object.keys(e).every(o=>it(e[o],t[o])):!1:Es(e,t,!!(n!=null&&n.ignoreNonSerializableProperties))}catch(r){const o=Qc(r);throw o.message.startsWith(Ms)||(o.message=`${Ms}: ${o.message}`),o}}function Xc(e){return le(e).filter(t=>isNaN(Number(t)))}function _c(e){return Xc(e).map(n=>e[n])}function Vh(e,t){return _c(t).includes(e)}function eu(e,t){return le(e).filter(r=>{const o=e[r];return t(r,o,e)}).reduce((r,o)=>(r[o]=e[o],r),{})}function sr(e,t){return eu(e,n=>!t.includes(n))}function Wh(e,t){return eu(e,n=>t.includes(n))}function zh(e,t,n){const r=t;if(e.has(r))return e.get(r);{const o=n();return e.set(r,o),o}}function ke(e,t){let n=!1;const r=le(e).reduce((o,i)=>{const a=t(i,e[i],e);return a instanceof Promise&&(n=!0),{...o,[i]:a}},{});return n?new Promise(async(o,i)=>{try{await Promise.all(le(r).map(async a=>{const s=await r[a];r[a]=s})),o(r)}catch(a){i(a)}}):r}function _i(e,t){try{return tu(e,t),!0}catch{return!1}}function tu(e,t,n){if(e.length<t)throw new Error(n?`'${n}' is not at least '${t}' in length.`:`Array is not at least '${t}' in length.`)}function Pa(){let e,t,n=!1;const r=new Promise((o,i)=>{e=a=>(n=!0,o(a)),t=a=>{n=!0,i(a)}});if(!e||!t)throw new Error(`Reject and resolve callbacks were not set by the promise constructor for ${Pa.name}.`);return{promise:r,resolve:e,reject:t,isSettled(){return n}}}function ea(e){const t=Pa();return e!==1/0&&setTimeout(()=>{t.resolve()},e<=0?0:e),t.promise}function Zh(){return globalThis.crypto?globalThis.crypto:require("crypto").webcrypto}const nu=Zh();function Gh({min:e,max:t}){const{min:n,max:r}=Nh({min:Math.floor(e),max:Math.floor(t)}),o=r-n+1,i=Math.ceil(Math.log2(o)/8),a=Math.floor(256**i/o)*o,s=new Uint8Array(i);let l;do nu.getRandomValues(s),l=s.reduce((c,f,h)=>c+f*256**h,0);while(l>=a);return n+l%o}function ru(e=16){const t=Math.ceil(e/2),n=new Uint8Array(t);return nu.getRandomValues(n),Array.from(n).map(r=>r.toString(16).padStart(2,"0")).join("").substring(0,e)}function Yh({value:e,prefix:t}){return e.startsWith(t)?e.substring(t.length):e}function Qh(e){const t=Object.entries(e).map(([n,r])=>{if(r!=null)return`${n}=${String(r)}`}).filter(we);return t.length?`?${t.join("&")}`:""}function Kh(e){return Yh({value:e,prefix:"?"}).split("&").map(r=>{const[o,...i]=An(r,"="),a=i.join("");if(!(!a&&!o))return[o,a]}).filter(we)}function Jh(e,t){const n=ee(e,"string")?new URL(e):e,r=Kh(n.search),o=Object.fromEntries(r);return t&&Kc(o,t),o}const Xh="%",_h="px";function Vt(e){return Oa({value:e,suffix:_h})}function ai(e){return Oa({value:e,suffix:Xh})}function Oa({value:e,suffix:t}){return String(e).endsWith(t)?String(e):`${String(e)}${t}`}const si="://";function lr(...e){const t=e.join("/"),[n,r=""]=t.includes(si)?t.split(si):["",t];let o=!1,i=!1;const a=r.replace(/\/{2,}/g,"/").split("/").map(s=>((s.includes("?")||o)&&(o=!0),s)).reduce((s,l,c,f)=>{if(i)return s;const h=f[c+1];let m=l;const g=!l.includes("?")&&(h==null?void 0:h.startsWith("?"));if(h!=null&&h.startsWith("?")||g){i=!0;let w=!1;const k=f.slice(g?c+2:c+1).reduce((x,C)=>(C.includes("#")&&(w=!0),w?x.concat(C):[x,C].join("&")),"");m=[l,h,k].join("")}return s.concat(m)},[]);return[n,n?si:"",a.join("/")].join("")}const e1=["k","M","B","T","P","E","Z","Y"];function Da({beforeDot:e,afterDot:t="",maxLength:n}){if(t.length){const r=n-e.length-1;if(r>0){const o=t.slice(0,r);return Number(o)?[e,o].join("."):e}}return e}function t1(e,t,n){const[r,o]=An(e,"."),i=Gc(r),a=zc(i,/,/g).length,s=t[a-1],[l,c]=An(i,","),f=[c,o].join("");return l.length+1>n?["0.",l[0],t[a]].join(""):[Da({beforeDot:l,afterDot:f,maxLength:n-1}),s].join("")}const Is=3;function n1({input:e,maxLength:t}){const n=String(e),[r,o]=An(n,"e"),i=o.replace(/^[\-\+]/,""),a=o[0],s=["e",a,i].join(""),[l,c]=An(r,"."),f=i.length+Is;return f===t?[l,s].join(""):f>t?a==="-"?"0":String(1/0):[Da({afterDot:c,beforeDot:l,maxLength:t-i.length+Is}),s].join("")}function r1(e,t){const[n,r]=An(Gc(e),".");if(n.length<=t)return Da({beforeDot:n,afterDot:r,maxLength:t})}function o1(e,{customSuffixes:t=e1,maxLength:n=6}={}){const r=Oh(e);if(isNaN(r)||r===1/0)return String(r);if(Dh(r))return n1({input:r,maxLength:n});const o=String(r),i=r1(o,n);return i??t1(o,t,n)}function i1(e,t){return Te(e,"entryType")&&e.entryType===t}var be;(function(e){e.ElementExample="element-example",e.Page="page",e.Root="root"})(be||(be={}));function tn(e,t){return e.controlType===t}var j;(function(e){e.Checkbox="checkbox",e.Color="color",e.Dropdown="dropdown",e.Hidden="hidden",e.Number="number",e.Text="text"})(j||(j={}));const ou=Symbol("any-type"),a1={[j.Checkbox]:!1,[j.Color]:"",[j.Dropdown]:"",[j.Hidden]:ou,[j.Number]:0,[j.Text]:""};function s1(e,t){if(!e)return[];const n=[];return Object.entries(e).forEach(([r,o])=>{const i=a1[o.controlType];i!==ou&&(typeof i!=typeof o.initValue&&n.push(new Error(`Control '${r}' in page '${t}' has invalid initValue '${o.initValue}': expected initValue of type ${typeof i} because the control is of type ${o.controlType}.`)),r||n.push(new Error(`'${t}' cannot have an empty control name.`)))}),n}function Na(e,t){const n=mo(e.title);return e.parent?[...Na(e.parent,!1),mo(e.parent.title)].concat(t?[n]:[]):t?[n]:[]}function mo(e){return Zc(e).toLowerCase().replaceAll(/\s/g,"-")}function l1({searchFor:e,searchIn:t}){return e.every((n,r)=>t[r]===n)}function U(e){const t={...e,entryType:be.Page,elementExamples:{},descriptionParagraphs:e.descriptionParagraphs??[],controls:e.controls??{},errors:[]},n=new Set;return e.elementExamplesCallback&&e.elementExamplesCallback({defineExample(r){const o={...r,entryType:be.ElementExample,parent:t,descriptionParagraphs:r.descriptionParagraphs??[],errors:[n.has(r.title)&&new Error(`Example title '${r.title}' in page '${e.title}' is already taken.`)].filter(we)};n.add(r.title),t.elementExamples[mo(o.title)]=o}}),t}var at;(function(e){e.Footer="book-footer",e.NavHeader="book-nav-header"})(at||(at={}));async function ta(e=1){const t=Pa();function n(){requestAnimationFrame(()=>{e--,e?n():t.resolve()})}return n(),t.promise}async function c1(e){return u1(e,1)}async function u1(e,t){return new Promise(n=>{new IntersectionObserver((o,i)=>{tu(o,1),i.disconnect(),n(o[0].intersectionRatio>=t)}).observe(e)})}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const eo=globalThis,Ra=eo.ShadowRoot&&(eo.ShadyCSS===void 0||eo.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Fa=Symbol(),Bs=new WeakMap;let iu=class{constructor(t,n,r){if(this._$cssResult$=!0,r!==Fa)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=n}get styleSheet(){let t=this.o;const n=this.t;if(Ra&&t===void 0){const r=n!==void 0&&n.length===1;r&&(t=Bs.get(n)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),r&&Bs.set(n,t))}return t}toString(){return this.cssText}};const T=e=>new iu(typeof e=="string"?e:e+"",void 0,Fa),to=(e,...t)=>{const n=e.length===1?e[0]:t.reduce((r,o,i)=>r+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+e[i+1],e[0]);return new iu(n,e,Fa)},d1=(e,t)=>{if(Ra)e.adoptedStyleSheets=t.map(n=>n instanceof CSSStyleSheet?n:n.styleSheet);else for(const n of t){const r=document.createElement("style"),o=eo.litNonce;o!==void 0&&r.setAttribute("nonce",o),r.textContent=n.cssText,e.appendChild(r)}},Ls=Ra?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let n="";for(const r of t.cssRules)n+=r.cssText;return T(n)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:h1,defineProperty:f1,getOwnPropertyDescriptor:p1,getOwnPropertyNames:m1,getOwnPropertySymbols:g1,getPrototypeOf:w1}=Object,St=globalThis,qs=St.trustedTypes,v1=qs?qs.emptyScript:"",li=St.reactiveElementPolyfillSupport,Jn=(e,t)=>e,go={toAttribute(e,t){switch(t){case Boolean:e=e?v1:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let n=e;switch(t){case Boolean:n=e!==null;break;case Number:n=e===null?null:Number(e);break;case Object:case Array:try{n=JSON.parse(e)}catch{n=null}}return n}},ja=(e,t)=>!h1(e,t),Ps={attribute:!0,type:String,converter:go,reflect:!1,hasChanged:ja};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),St.litPropertyMetadata??(St.litPropertyMetadata=new WeakMap);let un=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,n=Ps){if(n.state&&(n.attribute=!1),this._$Ei(),this.elementProperties.set(t,n),!n.noAccessor){const r=Symbol(),o=this.getPropertyDescriptor(t,r,n);o!==void 0&&f1(this.prototype,t,o)}}static getPropertyDescriptor(t,n,r){const{get:o,set:i}=p1(this.prototype,t)??{get(){return this[n]},set(a){this[n]=a}};return{get(){return o==null?void 0:o.call(this)},set(a){const s=o==null?void 0:o.call(this);i.call(this,a),this.requestUpdate(t,s,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Ps}static _$Ei(){if(this.hasOwnProperty(Jn("elementProperties")))return;const t=w1(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Jn("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Jn("properties"))){const n=this.properties,r=[...m1(n),...g1(n)];for(const o of r)this.createProperty(o,n[o])}const t=this[Symbol.metadata];if(t!==null){const n=litPropertyMetadata.get(t);if(n!==void 0)for(const[r,o]of n)this.elementProperties.set(r,o)}this._$Eh=new Map;for(const[n,r]of this.elementProperties){const o=this._$Eu(n,r);o!==void 0&&this._$Eh.set(o,n)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const n=[];if(Array.isArray(t)){const r=new Set(t.flat(1/0).reverse());for(const o of r)n.unshift(Ls(o))}else t!==void 0&&n.push(Ls(t));return n}static _$Eu(t,n){const r=n.attribute;return r===!1?void 0:typeof r=="string"?r:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(n=>this.enableUpdating=n),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(n=>n(this))}addController(t){var n;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((n=t.hostConnected)==null||n.call(t))}removeController(t){var n;(n=this._$EO)==null||n.delete(t)}_$E_(){const t=new Map,n=this.constructor.elementProperties;for(const r of n.keys())this.hasOwnProperty(r)&&(t.set(r,this[r]),delete this[r]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return d1(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(n=>{var r;return(r=n.hostConnected)==null?void 0:r.call(n)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(n=>{var r;return(r=n.hostDisconnected)==null?void 0:r.call(n)})}attributeChangedCallback(t,n,r){this._$AK(t,r)}_$EC(t,n){var i;const r=this.constructor.elementProperties.get(t),o=this.constructor._$Eu(t,r);if(o!==void 0&&r.reflect===!0){const a=(((i=r.converter)==null?void 0:i.toAttribute)!==void 0?r.converter:go).toAttribute(n,r.type);this._$Em=t,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._$Em=null}}_$AK(t,n){var i;const r=this.constructor,o=r._$Eh.get(t);if(o!==void 0&&this._$Em!==o){const a=r.getPropertyOptions(o),s=typeof a.converter=="function"?{fromAttribute:a.converter}:((i=a.converter)==null?void 0:i.fromAttribute)!==void 0?a.converter:go;this._$Em=o,this[o]=s.fromAttribute(n,a.type),this._$Em=null}}requestUpdate(t,n,r){if(t!==void 0){if(r??(r=this.constructor.getPropertyOptions(t)),!(r.hasChanged??ja)(this[t],n))return;this.P(t,n,r)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(t,n,r){this._$AL.has(t)||this._$AL.set(t,n),r.reflect===!0&&this._$Em!==t&&(this._$Ej??(this._$Ej=new Set)).add(t)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(n){Promise.reject(n)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var r;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[i,a]of this._$Ep)this[i]=a;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[i,a]of o)a.wrapped!==!0||this._$AL.has(i)||this[i]===void 0||this.P(i,this[i],a)}let t=!1;const n=this._$AL;try{t=this.shouldUpdate(n),t?(this.willUpdate(n),(r=this._$EO)==null||r.forEach(o=>{var i;return(i=o.hostUpdate)==null?void 0:i.call(o)}),this.update(n)):this._$EU()}catch(o){throw t=!1,this._$EU(),o}t&&this._$AE(n)}willUpdate(t){}_$AE(t){var n;(n=this._$EO)==null||n.forEach(r=>{var o;return(o=r.hostUpdated)==null?void 0:o.call(r)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Ej&&(this._$Ej=this._$Ej.forEach(n=>this._$EC(n,this[n]))),this._$EU()}updated(t){}firstUpdated(t){}};un.elementStyles=[],un.shadowRootOptions={mode:"open"},un[Jn("elementProperties")]=new Map,un[Jn("finalized")]=new Map,li==null||li({ReactiveElement:un}),(St.reactiveElementVersions??(St.reactiveElementVersions=[])).push("2.0.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Xn=globalThis,wo=Xn.trustedTypes,Os=wo?wo.createPolicy("lit-html",{createHTML:e=>e}):void 0,Ha="$lit$",ft=`lit$${(Math.random()+"").slice(9)}$`,Ua="?"+ft,b1=`<${Ua}>`,Kt=document,cr=()=>Kt.createComment(""),ur=e=>e===null||typeof e!="object"&&typeof e!="function",au=Array.isArray,su=e=>au(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",ci=`[ 	
\f\r]`,Dn=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ds=/-->/g,Ns=/>/g,Rt=RegExp(`>|${ci}(?:([^\\s"'>=/]+)(${ci}*=${ci}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Rs=/'/g,Fs=/"/g,lu=/^(?:script|style|textarea|title)$/i,cu=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),y1=cu(1),k1=cu(2),Pe=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),js=new WeakMap,Wt=Kt.createTreeWalker(Kt,129);function uu(e,t){if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Os!==void 0?Os.createHTML(t):t}const du=(e,t)=>{const n=e.length-1,r=[];let o,i=t===2?"<svg>":"",a=Dn;for(let s=0;s<n;s++){const l=e[s];let c,f,h=-1,m=0;for(;m<l.length&&(a.lastIndex=m,f=a.exec(l),f!==null);)m=a.lastIndex,a===Dn?f[1]==="!--"?a=Ds:f[1]!==void 0?a=Ns:f[2]!==void 0?(lu.test(f[2])&&(o=RegExp("</"+f[2],"g")),a=Rt):f[3]!==void 0&&(a=Rt):a===Rt?f[0]===">"?(a=o??Dn,h=-1):f[1]===void 0?h=-2:(h=a.lastIndex-f[2].length,c=f[1],a=f[3]===void 0?Rt:f[3]==='"'?Fs:Rs):a===Fs||a===Rs?a=Rt:a===Ds||a===Ns?a=Dn:(a=Rt,o=void 0);const g=a===Rt&&e[s+1].startsWith("/>")?" ":"";i+=a===Dn?l+b1:h>=0?(r.push(c),l.slice(0,h)+Ha+l.slice(h)+ft+g):l+ft+(h===-2?s:g)}return[uu(e,i+(e[n]||"<?>")+(t===2?"</svg>":"")),r]};class dr{constructor({strings:t,_$litType$:n},r){let o;this.parts=[];let i=0,a=0;const s=t.length-1,l=this.parts,[c,f]=du(t,n);if(this.el=dr.createElement(c,r),Wt.currentNode=this.el.content,n===2){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(o=Wt.nextNode())!==null&&l.length<s;){if(o.nodeType===1){if(o.hasAttributes())for(const h of o.getAttributeNames())if(h.endsWith(Ha)){const m=f[a++],g=o.getAttribute(h).split(ft),w=/([.?@])?(.*)/.exec(m);l.push({type:1,index:i,name:w[2],strings:g,ctor:w[1]==="."?fu:w[1]==="?"?pu:w[1]==="@"?mu:kr}),o.removeAttribute(h)}else h.startsWith(ft)&&(l.push({type:6,index:i}),o.removeAttribute(h));if(lu.test(o.tagName)){const h=o.textContent.split(ft),m=h.length-1;if(m>0){o.textContent=wo?wo.emptyScript:"";for(let g=0;g<m;g++)o.append(h[g],cr()),Wt.nextNode(),l.push({type:2,index:++i});o.append(h[m],cr())}}}else if(o.nodeType===8)if(o.data===Ua)l.push({type:2,index:i});else{let h=-1;for(;(h=o.data.indexOf(ft,h+1))!==-1;)l.push({type:7,index:i}),h+=ft.length-1}i++}}static createElement(t,n){const r=Kt.createElement("template");return r.innerHTML=t,r}}function Jt(e,t,n=e,r){var a,s;if(t===Pe)return t;let o=r!==void 0?(a=n._$Co)==null?void 0:a[r]:n._$Cl;const i=ur(t)?void 0:t._$litDirective$;return(o==null?void 0:o.constructor)!==i&&((s=o==null?void 0:o._$AO)==null||s.call(o,!1),i===void 0?o=void 0:(o=new i(e),o._$AT(e,n,r)),r!==void 0?(n._$Co??(n._$Co=[]))[r]=o:n._$Cl=o),o!==void 0&&(t=Jt(e,o._$AS(e,t.values),o,r)),t}class hu{constructor(t,n){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:n},parts:r}=this._$AD,o=((t==null?void 0:t.creationScope)??Kt).importNode(n,!0);Wt.currentNode=o;let i=Wt.nextNode(),a=0,s=0,l=r[0];for(;l!==void 0;){if(a===l.index){let c;l.type===2?c=new En(i,i.nextSibling,this,t):l.type===1?c=new l.ctor(i,l.name,l.strings,this,t):l.type===6&&(c=new gu(i,this,t)),this._$AV.push(c),l=r[++s]}a!==(l==null?void 0:l.index)&&(i=Wt.nextNode(),a++)}return Wt.currentNode=Kt,o}p(t){let n=0;for(const r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,n),n+=r.strings.length-2):r._$AI(t[n])),n++}}class En{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,n,r,o){this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=r,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const n=this._$AM;return n!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=Jt(this,t,n),ur(t)?t===_||t==null||t===""?(this._$AH!==_&&this._$AR(),this._$AH=_):t!==this._$AH&&t!==Pe&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):su(t)?this.k(t):this._(t)}S(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.S(t))}_(t){this._$AH!==_&&ur(this._$AH)?this._$AA.nextSibling.data=t:this.T(Kt.createTextNode(t)),this._$AH=t}$(t){var i;const{values:n,_$litType$:r}=t,o=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=dr.createElement(uu(r.h,r.h[0]),this.options)),r);if(((i=this._$AH)==null?void 0:i._$AD)===o)this._$AH.p(n);else{const a=new hu(o,this),s=a.u(this.options);a.p(n),this.T(s),this._$AH=a}}_$AC(t){let n=js.get(t.strings);return n===void 0&&js.set(t.strings,n=new dr(t)),n}k(t){au(this._$AH)||(this._$AH=[],this._$AR());const n=this._$AH;let r,o=0;for(const i of t)o===n.length?n.push(r=new En(this.S(cr()),this.S(cr()),this,this.options)):r=n[o],r._$AI(i),o++;o<n.length&&(this._$AR(r&&r._$AB.nextSibling,o),n.length=o)}_$AR(t=this._$AA.nextSibling,n){var r;for((r=this._$AP)==null?void 0:r.call(this,!1,!0,n);t&&t!==this._$AB;){const o=t.nextSibling;t.remove(),t=o}}setConnected(t){var n;this._$AM===void 0&&(this._$Cv=t,(n=this._$AP)==null||n.call(this,t))}}class kr{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,n,r,o,i){this.type=1,this._$AH=_,this._$AN=void 0,this.element=t,this.name=n,this._$AM=o,this.options=i,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=_}_$AI(t,n=this,r,o){const i=this.strings;let a=!1;if(i===void 0)t=Jt(this,t,n,0),a=!ur(t)||t!==this._$AH&&t!==Pe,a&&(this._$AH=t);else{const s=t;let l,c;for(t=i[0],l=0;l<i.length-1;l++)c=Jt(this,s[r+l],n,l),c===Pe&&(c=this._$AH[l]),a||(a=!ur(c)||c!==this._$AH[l]),c===_?t=_:t!==_&&(t+=(c??"")+i[l+1]),this._$AH[l]=c}a&&!o&&this.j(t)}j(t){t===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class fu extends kr{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===_?void 0:t}}class pu extends kr{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==_)}}class mu extends kr{constructor(t,n,r,o,i){super(t,n,r,o,i),this.type=5}_$AI(t,n=this){if((t=Jt(this,t,n,0)??_)===Pe)return;const r=this._$AH,o=t===_&&r!==_||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,i=t!==_&&(r===_||o);o&&this.element.removeEventListener(this.name,this,r),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var n;typeof this._$AH=="function"?this._$AH.call(((n=this.options)==null?void 0:n.host)??this.element,t):this._$AH.handleEvent(t)}}class gu{constructor(t,n,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){Jt(this,t)}}const x1={P:Ha,A:ft,C:Ua,M:1,L:du,R:hu,D:su,V:Jt,I:En,H:kr,N:pu,U:mu,B:fu,F:gu},ui=Xn.litHtmlPolyfillSupport;ui==null||ui(dr,En),(Xn.litHtmlVersions??(Xn.litHtmlVersions=[])).push("3.1.2");const A1=(e,t,n)=>{const r=(n==null?void 0:n.renderBefore)??t;let o=r._$litPart$;if(o===void 0){const i=(n==null?void 0:n.renderBefore)??null;r._$litPart$=o=new En(t.insertBefore(cr(),i),i,void 0,n??{})}return o._$AI(e),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:$1}=x1,Hs=()=>document.createComment(""),Nn=(e,t,n)=>{var i;const r=e._$AA.parentNode,o=t===void 0?e._$AB:t._$AA;if(n===void 0){const a=r.insertBefore(Hs(),o),s=r.insertBefore(Hs(),o);n=new $1(a,s,e,e.options)}else{const a=n._$AB.nextSibling,s=n._$AM,l=s!==e;if(l){let c;(i=n._$AQ)==null||i.call(n,e),n._$AM=e,n._$AP!==void 0&&(c=e._$AU)!==s._$AU&&n._$AP(c)}if(a!==o||l){let c=n._$AA;for(;c!==a;){const f=c.nextSibling;r.insertBefore(c,o),c=f}}}return n},Ft=(e,t,n=e)=>(e._$AI(t,n),e),C1={},S1=(e,t=C1)=>e._$AH=t,T1=e=>e._$AH,hi=e=>{var r;(r=e._$AP)==null||r.call(e,!1,!0);let t=e._$AA;const n=e._$AB.nextSibling;for(;t!==n;){const o=t.nextSibling;t.remove(),t=o}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const M1={attribute:!0,type:String,converter:go,reflect:!1,hasChanged:ja},E1=(e=M1,t,n)=>{const{kind:r,metadata:o}=n;let i=globalThis.litPropertyMetadata.get(o);if(i===void 0&&globalThis.litPropertyMetadata.set(o,i=new Map),i.set(n.name,e),r==="accessor"){const{name:a}=n;return{set(s){const l=t.get.call(this);t.set.call(this,s),this.requestUpdate(a,l,e)},init(s){return s!==void 0&&this.P(a,void 0,e),s}}}if(r==="setter"){const{name:a}=n;return function(s){const l=this[a];t.call(this,s),this.requestUpdate(a,l,e)}}throw Error("Unsupported decorator location: "+r)};function I1(e){return(t,n)=>typeof n=="object"?E1(e,t,n):((r,o,i)=>{const a=o.hasOwnProperty(i);return o.constructor.createProperty(i,a?{...r,wrapped:!0}:r),a?Object.getOwnPropertyDescriptor(o,i):void 0})(e,t,n)}/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function B1(e,t,n){return e?t(e):n==null?void 0:n(e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ws=(e,t,n)=>{const r=new Map;for(let o=t;o<=n;o++)r.set(e[o],o);return r},L1=Dt(class extends gt{constructor(e){if(super(e),e.type!==xr.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,n){let r;n===void 0?n=t:t!==void 0&&(r=t);const o=[],i=[];let a=0;for(const s of e)o[a]=r?r(s,a):a,i[a]=n(s,a),a++;return{values:i,keys:o}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,r]){const o=T1(e),{values:i,keys:a}=this.dt(t,n,r);if(!Array.isArray(o))return this.ut=a,i;const s=this.ut??(this.ut=[]),l=[];let c,f,h=0,m=o.length-1,g=0,w=i.length-1;for(;h<=m&&g<=w;)if(o[h]===null)h++;else if(o[m]===null)m--;else if(s[h]===a[g])l[g]=Ft(o[h],i[g]),h++,g++;else if(s[m]===a[w])l[w]=Ft(o[m],i[w]),m--,w--;else if(s[h]===a[w])l[w]=Ft(o[h],i[w]),Nn(e,l[w+1],o[h]),h++,w--;else if(s[m]===a[g])l[g]=Ft(o[m],i[g]),Nn(e,o[h],o[m]),m--,g++;else if(c===void 0&&(c=Ws(a,g,w),f=Ws(s,h,m)),c.has(s[h]))if(c.has(s[m])){const k=f.get(a[g]),x=k!==void 0?o[k]:null;if(x===null){const C=Nn(e,o[h]);Ft(C,i[g]),l[g]=C}else l[g]=Ft(x,i[g]),Nn(e,o[h],x),o[k]=null;g++}else hi(o[m]),m--;else hi(o[h]),h++;for(;g<=w;){const k=Nn(e,l[w+1]);Ft(k,i[g]),l[g++]=k}for(;h<=m;){const k=o[h++];k!==null&&hi(k)}return this.ut=a,S1(e,l),Pe}}),q1=L1;class wu extends _n{}function wt(e){if(ze(e))return ke(e,(n,r)=>{if(!ee(n,"string"))throw new Error(`Invalid CSS var name '${String(n)}' given. CSS var names must be strings.`);if(fo(n).toLowerCase()!==n)throw new Error(`Invalid CSS var name '${n}' given. CSS var names must be in lower kebab case.`);const i=r,a=n.startsWith("--")?T(n):n.startsWith("-")?to`-${T(n)}`:to`--${T(n)}`;return{name:a,value:to`var(${a}, ${T(i)})`,default:String(i)}});throw new Error(`Invalid setup input for '${wt.name}' function.`)}function vo({onElement:e,toValue:t,forCssVar:n}){e.style.setProperty(String(n.name),String(t))}function P1(e,t,n){const r=!t.length&&!n.length,o=e.length?!1:!t.filter(s=>!!s.index).length;if(r||o)return[...e];const i=e.map(s=>[s]);return i.length||(i[0]=[]),n.forEach(s=>{s>=0&&s<e.length&&(i[s]=[])}),t.forEach(s=>{const l=i[s.index];l&&l.splice(0,0,...s.values)}),i.flat()}function no(e){return Te(e,"_elementVirIsMinimalDefinitionWithInputs")&&!!e._elementVirIsMinimalDefinitionWithInputs}function Va(e){return Te(e,"tagName")&&!!e.tagName&&typeof e.tagName=="string"&&e.tagName.includes("-")}function vu(e){return e.map(t=>no(t)?t.definition:t).filter(t=>Va(t))}const bu=new WeakMap;function O1(e,t){var o;const n=vu(t);return(o=yu(bu,[e,...n]).value)==null?void 0:o.template}function D1(e,t,n){const r=vu(t);return xu(bu,[e,...r],n)}function yu(e,t,n=0){const{currentTemplateAndNested:r,reason:o}=ku(e,t,n);return r?n===t.length-1?{value:r,reason:"reached end of keys array"}:r.nested?yu(r.nested,t,n+1):{value:void 0,reason:`map at key index ${n} did not have nested maps`}:{value:r,reason:o}}function ku(e,t,n){const r=t[n];if(r==null)return{currentKey:void 0,currentTemplateAndNested:void 0,reason:`key at index ${n} not found`};if(!e.has(r))return{currentKey:r,currentTemplateAndNested:void 0,reason:`key at index ${n} was not in the map`};const o=e.get(r);return o==null?{currentKey:r,currentTemplateAndNested:void 0,reason:`value at key at index ${n} was undefined`}:{currentKey:r,currentTemplateAndNested:o,reason:"key and value exists"}}function xu(e,t,n,r=0){const{currentTemplateAndNested:o,currentKey:i,reason:a}=ku(e,t,r);if(!i)return{result:!1,reason:a};const s=o??{nested:void 0,template:void 0};if(o||e.set(i,s),r===t.length-1)return s.template=n,{result:!0,reason:"set value at end of keys array"};const l=s.nested??new WeakMap;return s.nested||(s.nested=l),xu(l,t,n,r+1)}const N1=new WeakMap;function Au(e,t,n){const r=O1(e,t),o=r??n();if(!r){const s=D1(e,t,o);if(s.result)N1.set(e,o);else throw new Error(`Failed to set template transform: ${s.reason}`)}const i=o.valuesTransform(t),a=P1(t,i.valueInsertions,i.valueIndexDeletions);return{strings:o.templateStrings,values:a}}function $u(e,t,n,r){const o=[],i=[],a=[],s=[];return e.forEach((c,f)=>{const h=o.length-1,m=o[h],g=f-1,w=t[g];r&&r(c);let k,x=[];if(typeof m=="string"&&(k=n(m,c,w),k)){o[h]=m+k.replacement,a.push(g);const S=k.getExtraValues;x=S?S(w):[],x.length&&S?(o[h]+=" ",x.forEach((N,W)=>{W&&o.push(" ")}),s.push(N=>{const W=N[g],te=S(W);return{index:g,values:te}}),o.push(c)):o[h]+=c}k||o.push(c);const C=e.raw[f];k?(i[h]=i[h]+k.replacement+C,x.length&&x.forEach(()=>{i.push("")})):i.push(C)}),{templateStrings:Object.assign([],o,{raw:i}),valuesTransform(c){const f=s.map(h=>h(c)).flat();return{valueIndexDeletions:a,valueInsertions:f}}}}function R1(...[e,t,n]){if(Va(n))return{replacement:n.tagName,getExtraValues:void 0}}function F1(e,t){return $u(e,t,R1)}function p(e,...t){const n=Au(e,t,()=>F1(e,t));return to(n.strings,...n.values)}const j1={ignoreUnsetInputs:!0,allowPolymorphicState:!1};function Cu(e){const t=e.getRootNode();if(!(t instanceof ShadowRoot))return!1;const n=t.host;return n instanceof wu?!0:Cu(n)}function Su(e,t){const n=e.instanceState;le(t).forEach(r=>{if(n&&r in n)throw new Error(`Cannot set input '${r}' on '${e.tagName}'. '${e.tagName}' already has a state property with the same name.`);"instanceInputs"in e?e.instanceInputs[r]=t[r]:e[r]=t[r]}),"instanceInputs"in e&&le(e.instanceInputs).forEach(r=>{r in t||(e.instanceInputs[r]=void 0)}),H1(e)}function H1(e){e._haveInputsBeenSet||(e._haveInputsBeenSet=!0)}function zs(e,t){const n=[e,"-"].join("");Object.keys(t).forEach(r=>{if(!r.startsWith(n))throw new Error(`Invalid CSS property name '${r}' in '${e}': CSS property names must begin with the element's tag name.`)})}class U1 extends CustomEvent{get type(){return this._type}constructor(t,n){super(typeof t=="string"?t:t.type,{detail:n,bubbles:!0,composed:!0}),Object.defineProperty(this,"_type",{enumerable:!0,configurable:!0,writable:!0,value:""})}}function Wa(){return e=>{var t;return t=class extends U1{constructor(n){super(e,n),Object.defineProperty(this,"_type",{enumerable:!0,configurable:!0,writable:!0,value:e})}},Object.defineProperty(t,"type",{enumerable:!0,configurable:!0,writable:!0,value:e}),t}}function oe(){return Wa()}function V1(e,t){return t?Object.keys(t).filter(n=>{if(typeof n!="string")throw new Error(`Expected event key of type string but got type "${typeof n}" for key ${String(n)}`);if(n==="")throw new Error("Got empty string for events key.");return!0}).reduce((n,r)=>{const o=Wa()([e,r].join("-"));return n[r]=o,n},{}):{}}const W1="_elementVirStateSetup";function z1(e){return ze(e)?W1 in e:!1}function Z1(e,t){const n=(e==null?void 0:e.constructor)===(t==null?void 0:t.constructor);return po(e)===po(t)&&n}const Tu="__vir__shape__definition__key__do__not__use__in__actual__objects";function Mu(e){return Te(e,Tu)}const za=Symbol("and"),Eu=Symbol("instance"),Iu=Symbol("enum"),Bu=Symbol("exact"),Za=Symbol("indexed-keys"),Ga=Symbol("or"),Ya=Symbol("unknown"),G1=[za,Iu,Bu,Za,Eu,Ga,Ya],Lu="__vir__shape__specifier__key__do__not__use__in__actual__objects";function Y1(...e){return Uo(e,za)}function Q1(...e){return Uo(e,Za)}function nt(...e){return Uo(e,Ga)}function K1(e){return Uo([e],Ya)}function Do(e){return _t(e,za)}function No(e){return _t(e,Eu)}function Ro(e){return _t(e,Iu)}function Fo(e){return _t(e,Bu)}function jo(e){return _t(e,Za)}function Ar(e){return _t(e,Ga)}function Ho(e){return _t(e,Ya)}function _t(e,t){const n=$r(e);return!!n&&n.specifierType===t}function Uo(e,t){return{[Lu]:!0,specifierType:t,parts:e}}function zt(e,t,n,r){const o=$r(t);if(o){if(No(o))return e instanceof o.parts[0];if(Do(o))return o.parts.every(i=>zt(e,i));if(Ar(o))return o.parts.some(i=>zt(e,i));if(Fo(o))return ze(e)?zt(e,o.parts[0]):e===o.parts[0];if(Ro(o))return Object.values(o.parts[0]).some(i=>i===e);if(jo(o))return ze(e)?J1(e,o,!!n)&&Ah(e).every(i=>zt(i,o.parts[0].values)):!1;if(Ho(o))return!0}return r?t===e:Z1(e,t)}function J1(e,t,n){const r=t.parts[0].required,o=t.parts[0].keys;if(n)if(r){const i=Qa(t);return ee(i,"boolean")?i:i.every(a=>le(e).some(s=>zt(s,a,!1,!0)))}else return!0;else return le(e).every(i=>zt(i,o))}function Qa(e){const t=e.parts[0].keys,n=$r(t);if(ii(t))return[t];if(n){if(No(n))return!1;if(Do(n))return!1;if(Ar(n)){const r=n.parts.map(i=>Qa(Q1({...e.parts[0],keys:i})));let o;return r.forEach(i=>{ee(i,"boolean")&&(i&&o==null?o=!0:o=!1)}),ee(o,"boolean")?o:r.flat().filter(ii)}else if(Fo(n)){const r=n.parts.filter(ii);return r.length!==n.parts.length?!1:r}else{if(Ro(n))return Object.values(n.parts[0]);if(jo(n))return!1;if(Ho(n))return!0}}return!1}function $r(e){if(ze(e)&&Te(e,Lu)){if(!Te(e,"parts")||!ee(e.parts,"array"))throw new Error("Found a shape specifier but its parts are not valid.");if(!Te(e,"specifierType")||!Sh(G1,e.specifierType))throw new Error("Found a shape specifier but its specifier type is not valid.");return e}}class Zs extends TypeError{constructor(){super(...arguments),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"DefaultValueConstructionError"})}}function ra(e,t=!1){return Vn(e)}function Vn(e){const t=$r(e);if(t)if(No(t)){const n=t.parts[0];try{return new n}catch(r){throw new Zs(`Failed to create default value for classShape for class '${n.name}': ${Ot(r)}`)}}else{if(Ar(t)||Fo(t))return Vn(t.parts[0]);if(Do(t))return t.parts.reduce((n,r)=>Object.assign(n,Vn(r)),{});if(Ro(t))return Object.values(t.parts[0])[0];if(jo(t)){const n=Qa(t);return!t.parts[0].required||ee(n,"boolean")?{}:Object.fromEntries(n.map(r=>[r,Vn(t.parts[0].values)]))}else{if(Ho(t))return t.parts[0]??{};throw new Zs(`found specifier but it matches no expected specifiers: ${String(t.specifierType)}`)}}return Mu(e)?ra(e.shape):e instanceof RegExp?e:ee(e,"array")?e.map(Vn):ze(e)?ke(e,(n,r)=>ra(r)):e}function Cr(e,t=!1){return{shape:e,get runTimeType(){throw new Error("runTimeType cannot be used as a value, it is only for types.")},isReadonly:t,get defaultValue(){return ra(e)},[Tu]:!0}}class Re extends TypeError{constructor(){super(...arguments),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"ShapeMismatchError"})}}function X1(e,t,n={}){try{return qu(e,t,n),!0}catch{return!1}}function qu(e,t,n={}){dt({subject:e,shape:t.shape,keys:["top level"],options:{exactValues:!1,ignoreExtraKeys:!!n.allowExtraKeys}})}function oa(e){return[e[0],...e.slice(1).map(t=>`'${String(t)}'`)].join(" -> ")}function dt({subject:e,shape:t,keys:n,options:r}){if(Ho(t))return!0;if(Mu(t))return dt({subject:e,shape:t.shape,keys:n,options:r});const o=oa(n);if($r(e))throw new Re(`Shape test subjects cannot be contain shape specifiers but one was found at ${o}.`);if(!zt(e,t,!r.ignoreExtraKeys))throw new Re(`Subject does not match shape definition at key ${o}`);if(ee(t,"function"))return ee(e,"function");if(No(t))return e instanceof t.parts[0];if(ze(e)){const a=e,s=r.ignoreExtraKeys?{}:Object.fromEntries(Object.keys(a).map(f=>[f,!1])),l=[];let c=!1;if(Ar(t)){const f=[];c=t.parts.some(h=>{try{const m=dt({subject:e,shape:h,keys:n,options:{...r}});return Object.assign(s,m),!0}catch(m){if(m instanceof Re)return f.push(m),!1;throw m}}),!c&&_i(f,1)&&l.push(f[0])}else if(Do(t))c=t.parts.every(f=>{try{const h=dt({subject:e,shape:f,keys:n,options:{...r,ignoreExtraKeys:!0}});return Object.assign(s,h),!0}catch(h){if(h instanceof Re)return l.push(h),!1;throw h}});else if(Fo(t)){const f=dt({subject:e,shape:t.parts[0],keys:n,options:{...r,exactValues:!0}});Object.assign(s,f),c=!0}else{if(Ro(t))throw new Re(`Cannot compare an enum specifier to an object at ${o}`);if(ee(t,"array")&&ee(a,"array"))c=a.every((f,h)=>{const m=t.some(g=>{try{return dt({subject:f,shape:g,keys:[...n,h],options:r}),!0}catch(w){if(w instanceof Re)return l.push(w),!1;throw w}});return s[h]=m,m});else if(jo(t)){const f=ke(e,(h,m)=>(r.ignoreExtraKeys||dt({shape:t.parts[0].keys,subject:h,keys:[...n,h],options:r}),dt({shape:t.parts[0].values,subject:m,keys:[...n,h],options:r}),!0));Object.assign(s,f),c=!0}else{const f=_1({keys:n,options:r,shape:t,subject:e});Object.assign(s,f),c=!0}}if(l.length)throw new Re(Fh(l));if(!c){const h=`Failed on key(s): ${Object.keys(s).filter(m=>!s[m]).map(m=>oa([...n,m])).join(",")}`;throw new Re(h)}return r.ignoreExtraKeys||Object.entries(s).forEach(([f,h])=>{if(!h)throw new Re(`subject as extra key '${f}' in ${o}.`)}),s}else if(r.exactValues)return e===t;return!0}function _1({keys:e,options:t,shape:n,subject:r}){const o=oa(e),i={};if(ze(n)){const a=new Set(le(r)),s=new Set(le(n));t.ignoreExtraKeys||a.forEach(l=>{if(!s.has(l))throw new Re(`Subject has extra key '${String(l)}' in ${o}`)}),s.forEach(l=>{var m;const c=n[l],f=Ar(c)?c.parts.includes(void 0):!1,h=((m=c==null?void 0:c.includes)==null?void 0:m.call(c,void 0))||c===void 0;if(!a.has(l)&&!f&&!h)throw new Re(`Subject missing key '${String(l)}' in ${o}`)}),a.forEach(l=>{const c=r[l];if(t.ignoreExtraKeys&&!s.has(l))return;const f=n[l];dt({subject:c,shape:f,keys:[...e,l],options:t}),i[l]=!0})}else throw new Re(`shape definition at ${o} was not an object.`);return i}const ef=Cr({addListener(){return()=>!1},removeListener(){return!1},destroy(){},value:K1()});function fi(e){return X1(e,ef,{allowExtraKeys:!0})}function Pu(e,t){t in e||I1()(e,t)}function tf(e,t,n){if(typeof e!="string"&&typeof e!="number"&&typeof e!="symbol")throw new Error(`Property name must be a string, got type '${typeof e}' from: '${String(e)}' for '${n.toLowerCase()}'`);if(!(e in t))throw new Error(`Property '${String(e)}' does not exist on '${n.toLowerCase()}'.`)}function Gs(e,t){const n=e;function r(a){t?tf(a,e,e.tagName):Pu(e,a)}function o(a,s){return r(s),n[s]}return new Proxy({},{get:o,set(a,s,l){const c=z1(l)?l._elementVirStateSetup():l;r(s);const f=n[s];function h(w){a[s]=w,n[s]=w}const m=e.observablePropertyListenerMap[s];if(f!==c&&fi(f)&&(m!=null&&m.length)&&f.removeListener(m),fi(c))if(m)c.addListener(m);else{let w=function(){e.requestUpdate()};var g=w;e.observablePropertyListenerMap[s]=w,c.addListener(w)}else fi(f)&&(e.observablePropertyListenerMap[s]=void 0);return h(c),!0},ownKeys(a){return Reflect.ownKeys(a)},getOwnPropertyDescriptor(a,s){if(s in a)return{get value(){return o(a,s)},configurable:!0,enumerable:!0}},has(a,s){return Reflect.has(a,s)}})}function nf(e){return e?ke(e,t=>t):{}}function rf({hostClassNames:e,cssVars:t}){return{hostClasses:ke(e,(n,r)=>({name:T(r),selector:T(`:host(.${r})`)})),cssVars:t}}function of({host:e,hostClassesInit:t,hostClassNames:n,state:r,inputs:o}){t&&le(t).forEach(i=>{const a=t[i],s=n[i];typeof a=="function"&&(a({state:r,inputs:o})?e.classList.add(s):e.classList.remove(s))})}function af({element:e,eventsMap:t,cssVars:n,slotNamesMap:r}){function o(a){le(a).forEach(s=>{const l=a[s];e.instanceState[s]=l})}return{cssVars:n,slotNames:r,dispatch:a=>e.dispatchEvent(a),events:t,host:e,inputs:e.instanceInputs,state:e.instanceState,updateState:o}}function sf(e){return e?e.reduce((n,r)=>(n[r]=r,n),{}):{}}var lf=globalThis&&globalThis.__setFunctionName||function(e,t,n){return typeof t=="symbol"&&(t=t.description?"[".concat(t.description,"]"):""),Object.defineProperty(e,"name",{configurable:!0,value:n?"".concat(n," ",t):t})};function Vo(e){var t;const n=e;if(!ee(n,"object"))throw new Error("Cannot define element with non-object init: ${init}");if(!ee(n.tagName,"string"))throw new Error("Missing valid tagName (expected a string).");if(!n.renderCallback||typeof n.renderCallback=="string")throw new Error(`Failed to define element '${n.tagName}': renderCallback is not a function`);const r={...j1,...n.options},o=V1(n.tagName,n.events),i=nf(n.hostClasses);n.hostClasses&&zs(n.tagName,n.hostClasses),n.cssVars&&zs(n.tagName,n.cssVars);const a=n.cssVars?wt(n.cssVars):{},s=sf(n.slotNames),l=typeof n.styles=="function"?n.styles(rf({hostClassNames:i,cssVars:a})):n.styles||p``,c=n.renderCallback;function f(...[m]){return{_elementVirIsMinimalDefinitionWithInputs:!0,definition:h,inputs:m}}const h=(t=class extends wu{createRenderParams(){return af({element:this,eventsMap:o,cssVars:a,slotNamesMap:s})}get instanceType(){throw new Error(`"instanceType" was called on ${n.tagName} as a value but it is only for types.`)}static get inputsType(){throw new Error(`"inputsType" was called on ${n.tagName} as a value but it is only for types.`)}static get stateType(){throw new Error(`"stateType" was called on ${n.tagName} as a value but it is only for types.`)}render(){this._internalRenderCount++;try{Cu(this)&&!this._haveInputsBeenSet&&!r.ignoreUnsetInputs&&console.warn(this,`${n.tagName} got rendered before its input object was set. This was most likely caused by forgetting to use '.assign()' on its opening tag. If no inputs are intended, use '${Vo.name}' to define ${n.tagName}.`),this._hasRendered=!0;const m=this.createRenderParams();if(!this._initCalled&&n.initCallback&&(this._initCalled=!0,n.initCallback(m)instanceof Promise))throw new Error("initCallback cannot be asynchronous");const g=c(m);if(g instanceof Promise)throw new Error("renderCallback cannot be asynchronous");return of({host:m.host,hostClassesInit:n.hostClasses,hostClassNames:i,state:m.state,inputs:m.inputs}),this._lastRenderedProps={inputs:{...m.inputs},state:{...m.state}},g}catch(m){const g=jh(m,`Failed to render ${n.tagName}`);return console.error(g),this._lastRenderError=g,Ot(g)}}connectedCallback(){if(super.connectedCallback(),this._hasRendered&&!this._initCalled&&n.initCallback){this._initCalled=!0;const m=this.createRenderParams();if(n.initCallback(m)instanceof Promise)throw new Error(`initCallback in '${n.tagName}' cannot be asynchronous`)}}disconnectedCallback(){if(super.disconnectedCallback(),n.cleanupCallback){const m=this.createRenderParams();if(n.cleanupCallback(m)instanceof Promise)throw new Error(`cleanupCallback in '${n.tagName}' cannot be asynchronous`)}this._initCalled=!1}assignInputs(m){Su(this,m)}constructor(){super(),Object.defineProperty(this,"_lastRenderError",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"_internalRenderCount",{enumerable:!0,configurable:!0,writable:!0,value:0}),Object.defineProperty(this,"_initCalled",{enumerable:!0,configurable:!0,writable:!0,value:!1}),Object.defineProperty(this,"_hasRendered",{enumerable:!0,configurable:!0,writable:!0,value:!1}),Object.defineProperty(this,"_lastRenderedProps",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"_haveInputsBeenSet",{enumerable:!0,configurable:!0,writable:!0,value:!1}),Object.defineProperty(this,"definition",{enumerable:!0,configurable:!0,writable:!0,value:{}}),Object.defineProperty(this,"observablePropertyListenerMap",{enumerable:!0,configurable:!0,writable:!0,value:{}}),Object.defineProperty(this,"instanceInputs",{enumerable:!0,configurable:!0,writable:!0,value:Gs(this,!1)}),Object.defineProperty(this,"instanceState",{enumerable:!0,configurable:!0,writable:!0,value:Gs(this,!r.allowPolymorphicState)});const m=n.stateInitStatic||{};le(m).forEach(g=>{Pu(this,g),this.instanceState[g]=m[g]}),this.definition=h}},lf(t,"anonymousClass"),Object.defineProperty(t,"elementOptions",{enumerable:!0,configurable:!0,writable:!0,value:r}),Object.defineProperty(t,"tagName",{enumerable:!0,configurable:!0,writable:!0,value:n.tagName}),Object.defineProperty(t,"styles",{enumerable:!0,configurable:!0,writable:!0,value:l}),Object.defineProperty(t,"assign",{enumerable:!0,configurable:!0,writable:!0,value:f}),Object.defineProperty(t,"isStrictInstance",{enumerable:!0,configurable:!0,writable:!0,value:()=>!1}),Object.defineProperty(t,"events",{enumerable:!0,configurable:!0,writable:!0,value:o}),Object.defineProperty(t,"renderCallback",{enumerable:!0,configurable:!0,writable:!0,value:c}),Object.defineProperty(t,"hostClasses",{enumerable:!0,configurable:!0,writable:!0,value:i}),Object.defineProperty(t,"cssVars",{enumerable:!0,configurable:!0,writable:!0,value:a}),Object.defineProperty(t,"init",{enumerable:!0,configurable:!0,writable:!0,value:n}),Object.defineProperty(t,"slotNames",{enumerable:!0,configurable:!0,writable:!0,value:s}),Object.defineProperty(t,"stateInitStatic",{enumerable:!0,configurable:!0,writable:!0,value:n.stateInitStatic}),t);return Object.defineProperties(h,{name:{value:Lh(n.tagName,{capitalizeFirstLetter:!0}),writable:!0},isStrictInstance:{value:m=>m instanceof h,writable:!1}}),window.customElements.get(n.tagName)?console.warn(`Tried to define custom element '${n.tagName}' but it is already defined.`):window.customElements.define(n.tagName,h),h}function Ou(){return e=>{const t=e;if(!ee(t,"object"))throw new Error("Cannot define element with non-object init: ${init}");return Vo({...t,options:{ignoreUnsetInputs:!1,...t.options}})}}function Ka(e,t){return hr(e,t),e.element}function cf(e){try{return e.options.host.tagName.toLowerCase()}catch{return}}function hr(e,t){const n=cf(e),r=n?`: in ${n}`:"";if(e.type!==xr.ELEMENT)throw new Error(`${t} directive can only be attached directly to an element${r}.`);if(!e.element)throw new Error(`${t} directive found no element${r}.`)}function uf(e){const t=Dt(class extends gt{constructor(n){super(n),Object.defineProperty(this,"element",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.element=Ka(n,e)}render(n){return this.element.setAttribute(e,n),Pe}});return{attributeSelector(n){return`[${e}="${n}"]`},attributeDirective(n){return t(n)},attributeName:e}}function y(e,t){return df(e,t)}const df=Dt(class extends gt{constructor(e){super(e),Object.defineProperty(this,"element",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"lastListenerMetaData",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.element=Ka(e,"listen")}resetListener(e){this.lastListenerMetaData&&this.element.removeEventListener(this.lastListenerMetaData.eventType,this.lastListenerMetaData.listener),this.element.addEventListener(e.eventType,e.listener),this.lastListenerMetaData=e}createListenerMetaData(e,t){return{eventType:e,callback:t,listener:n=>{var r;return(r=this.lastListenerMetaData)==null?void 0:r.callback(n)}}}render(e,t){const n=typeof e=="string"?e:e.type;if(typeof n!="string")throw new Error(`Cannot listen to an event with a name that is not a string. Given event name: "${n}"`);return this.lastListenerMetaData&&this.lastListenerMetaData.eventType===n?this.lastListenerMetaData.callback=t:this.resetListener(this.createListenerMetaData(n,t)),Pe}}),Ys="onDomCreated",ia=Dt(class extends gt{constructor(e){super(e),Object.defineProperty(this,"element",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),hr(e,Ys)}update(e,[t]){hr(e,Ys);const n=e.element;return n!==this.element&&(requestAnimationFrame(()=>t(n)),this.element=n),this.render(t)}render(e){}}),pi="onResize",$n=Dt(class extends gt{constructor(e){super(e),Object.defineProperty(this,"element",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"resizeObserver",{enumerable:!0,configurable:!0,writable:!0,value:new ResizeObserver(t=>this.fireCallback(t))}),Object.defineProperty(this,"callback",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),hr(e,pi)}fireCallback(e){var n;const t=e[0];if(!t)throw console.error(e),new Error(`${pi} observation triggered but the first entry was empty.`);(n=this.callback)==null||n.call(this,{target:t.target,contentRect:t.contentRect},this.element)}update(e,[t]){hr(e,pi),this.callback=t;const n=e.element,r=this.element;return n!==r&&(this.element=n,r&&this.resizeObserver.unobserve(r),this.resizeObserver.observe(n)),this.render(t)}render(e){}});function ye(e,t,n){return B1(e,()=>t,()=>n)}const{attributeDirective:hf,attributeSelector:Ev,attributeName:Iv}=uf("data-test-id");function ff(e){return{_elementVirStateSetup:e}}function Ja(e){const{assertInputs:t,transformInputs:n}={assertInputs:(e==null?void 0:e.assertInputs)??(()=>{}),transformInputs:(e==null?void 0:e.transformInputs)??(r=>r)};return{defineElement:()=>r=>(t(r),Ou()(n(r))),defineElementNoInputs:r=>(t(r),Vo(n(r)))}}function pf(e,t){return t?Qs(e,t):Qs(void 0,e)}const Qs=Dt(class extends gt{constructor(e){super(e),Object.defineProperty(this,"element",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.element=Ka(e,"assign")}render(e,t){return Su(this.element,t),Pe}});function mf(...[e,t,n]){const r=no(n)?n.definition:n,o=e.trim().endsWith("<")&&!!t.match(/^[\s\n>]/),i=(e==null?void 0:e.trim().endsWith("</"))&&t.trim().startsWith(">"),a=o||i,s=Va(r);if(a&&!s)throw console.error({lastNewString:e,currentLitString:t,currentValue:r}),new Error(`Got interpolated tag name but found no tag name on the given value: '${r.prototype.constructor.name}'`);if(!a||!s)return;if(o&&!r.elementOptions.ignoreUnsetInputs&&!no(n))throw new Error(`Missing inputs for '${r.tagName}'`);return{replacement:r.tagName,getExtraValues(c){const f=no(c)?c.inputs:void 0;return[o&&f?pf(f):void 0].filter(we)}}}function gf(e){}function wf(e){return $u(e.strings,e.values,mf,gf)}function u(e,...t){const n=y1(e,...t),r=Au(e,t,()=>wf(n));return{...n,strings:r.strings,values:r.values}}const vf={a:window.HTMLAnchorElement,abbr:window.HTMLElement,address:window.HTMLElement,area:window.HTMLAreaElement,article:window.HTMLElement,aside:window.HTMLElement,audio:window.HTMLAudioElement,b:window.HTMLElement,base:window.HTMLBaseElement,bdi:window.HTMLElement,bdo:window.HTMLElement,blockquote:window.HTMLQuoteElement,body:window.HTMLBodyElement,br:window.HTMLBRElement,button:window.HTMLButtonElement,canvas:window.HTMLCanvasElement,caption:window.HTMLTableCaptionElement,cite:window.HTMLElement,code:window.HTMLElement,col:window.HTMLTableColElement,colgroup:window.HTMLTableColElement,data:window.HTMLDataElement,datalist:window.HTMLDataListElement,dd:window.HTMLElement,del:window.HTMLModElement,details:window.HTMLDetailsElement,dfn:window.HTMLElement,dialog:window.HTMLDialogElement,div:window.HTMLDivElement,dl:window.HTMLDListElement,dt:window.HTMLElement,em:window.HTMLElement,embed:window.HTMLEmbedElement,fieldset:window.HTMLFieldSetElement,figcaption:window.HTMLElement,figure:window.HTMLElement,footer:window.HTMLElement,form:window.HTMLFormElement,h1:window.HTMLHeadingElement,h2:window.HTMLHeadingElement,h3:window.HTMLHeadingElement,h4:window.HTMLHeadingElement,h5:window.HTMLHeadingElement,h6:window.HTMLHeadingElement,head:window.HTMLHeadElement,header:window.HTMLElement,hgroup:window.HTMLElement,hr:window.HTMLHRElement,html:window.HTMLHtmlElement,i:window.HTMLElement,iframe:window.HTMLIFrameElement,img:window.HTMLImageElement,input:window.HTMLInputElement,ins:window.HTMLModElement,kbd:window.HTMLElement,label:window.HTMLLabelElement,legend:window.HTMLLegendElement,li:window.HTMLLIElement,link:window.HTMLLinkElement,main:window.HTMLElement,map:window.HTMLMapElement,mark:window.HTMLElement,menu:window.HTMLMenuElement,meta:window.HTMLMetaElement,meter:window.HTMLMeterElement,nav:window.HTMLElement,noscript:window.HTMLElement,object:window.HTMLObjectElement,ol:window.HTMLOListElement,optgroup:window.HTMLOptGroupElement,option:window.HTMLOptionElement,output:window.HTMLOutputElement,p:window.HTMLParagraphElement,picture:window.HTMLPictureElement,pre:window.HTMLPreElement,progress:window.HTMLProgressElement,q:window.HTMLQuoteElement,rp:window.HTMLElement,rt:window.HTMLElement,ruby:window.HTMLElement,s:window.HTMLElement,samp:window.HTMLElement,script:window.HTMLScriptElement,search:window.HTMLElement,section:window.HTMLElement,select:window.HTMLSelectElement,slot:window.HTMLSlotElement,small:window.HTMLElement,source:window.HTMLSourceElement,span:window.HTMLSpanElement,strong:window.HTMLElement,style:window.HTMLStyleElement,sub:window.HTMLElement,summary:window.HTMLElement,sup:window.HTMLElement,table:window.HTMLTableElement,tbody:window.HTMLTableSectionElement,td:window.HTMLTableCellElement,template:window.HTMLTemplateElement,textarea:window.HTMLTextAreaElement,tfoot:window.HTMLTableSectionElement,th:window.HTMLTableCellElement,thead:window.HTMLTableSectionElement,time:window.HTMLTimeElement,title:window.HTMLTitleElement,tr:window.HTMLTableRowElement,track:window.HTMLTrackElement,u:window.HTMLElement,ul:window.HTMLUListElement,var:window.HTMLElement,video:window.HTMLVideoElement,wbr:window.HTMLElement},bf=Object.keys(vf),yf=["a","animate","animateMotion","animateTransform","audio","canvas","circle","clipPath","defs","desc","discard","ellipse","feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence","filter","foreignObject","g","iframe","image","line","linearGradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialGradient","rect","script","set","stop","style","svg","switch","symbol","text","textPath","title","tspan","unknown","use","video","view"];[...bf,...yf];function Wn(e,t){const n=e.currentTarget;if(!(n instanceof t))throw new Error(`Target from event '${e.type}' was not of type '${t.constructor.name}'. Got '${n==null?void 0:n.constructor.name}'.`);return n}const kf={[be.ElementExample]:()=>[],[be.Page]:e=>[!e.title&&new Error("Cannot define an element-book page with an empty title."),...s1(e.controls,e.title)].filter(we),[be.Root]:()=>[]},bo="_isBookTreeNode",Du=new Map;function xf(e){return Du.get(e)}function Af(e,t){zh(Du,e,()=>t)}function vn(e,t){return!!(Nu(e)&&e.entry.entryType===t)}function Nu(e){return!!(Wc(e,[bo,"entry"])&&e[bo])}function $f(){return{[bo]:!0,entry:{entryType:be.Root,title:"",parent:void 0,errors:[],descriptionParagraphs:[]},urlBreadcrumb:"",fullUrlBreadcrumbs:[],children:{},manuallyAdded:!0}}function Cf({entries:e,debug:t}){const n=xf(e);if(n)return n;const r=$f();e.forEach(a=>Xa({tree:r,newEntry:a,debug:t,manuallyAdded:!0}));const o=Ru(r),i={tree:r,flattenedNodes:o};return Af(e,i),t&&console.info("element-book tree:",r),i}function Sf(e,t,n){if(!t.parent)return e;const r=aa(t,e);if(r)return r;n&&console.info(`parent of ${t.title} not found in tree; adding it now.`),Xa({tree:e,newEntry:t.parent,debug:n,manuallyAdded:!1});const o=aa(t,e);if(!o)throw new Error(`Failed to find node despite having just added it: ${Na(t,!1)}`);return o}function Xa({tree:e,newEntry:t,debug:n,manuallyAdded:r}){const o=kf[t.entryType](t);t.errors.push(...o);const i=Sf(e,t,n),a=mo(t.title),s=i.children[a];if(s){if(r){if(s.manuallyAdded){s.entry.errors.push(new Error(`Cannot create duplicate '${a}'${i.urlBreadcrumb?` in parent '${i.urlBreadcrumb}'.`:""}`));return}s.manuallyAdded=!0}return}const l={[bo]:!0,children:{},urlBreadcrumb:a,fullUrlBreadcrumbs:[...i.fullUrlBreadcrumbs,a],entry:t,manuallyAdded:r};i.children[a]=l,i1(t,be.Page)&&Object.values(t.elementExamples??{}).length&&Object.values(t.elementExamples??{}).forEach(c=>Xa({tree:e,newEntry:c,debug:n,manuallyAdded:r}))}function aa(e,t){const n=Nu(e)?e.fullUrlBreadcrumbs.slice(0,-1):Na(e,!1);return n.length?n.reduce((o,i)=>{if(o)return o.children[i]},t):void 0}function Ru(e){const n=!!e.entry.errors.length?[]:Object.values(e.children).map(o=>Ru(o));return[e,...n].flat()}function _a(e,t){return es(e,["",...t],void 0)}function es(e,t,n){const r=t.slice(1),o=r[0];!o&&n&&(e.controls=n);const i=e.children[o||""],a=i&&es(i,r,n);return{...e.controls,...a}}function Tf(e,t,n){const r={...e};return es(r,["",...t],n),r}function Fu(e,t){const n=(t==null?void 0:t.controls)||(vn(e,be.Page)?ke(e.entry.controls,(o,i)=>i.initValue):{});return{children:ke(e.children,(o,i)=>{var a;return Fu(i,(a=t==null?void 0:t.children)==null?void 0:a[i.urlBreadcrumb])}),controls:n}}function Mf({searchQuery:e,searchIn:t}){const n=t.length,r=e.length;if(r>n)return!1;if(r===n)return e===t;const o=t.toLowerCase(),i=e.toLowerCase();e:for(let a=0,s=0;a<r;a++){const l=i.charCodeAt(a);for(;s<n;)if(o.charCodeAt(s++)===l)continue e;return!1}return!0}const Ef=ru(32);function ro(e){return e.join(Ef)}function ju(e){if(!e.length)return[];const t=ro(e),n=ju(e.slice(0,-1));return[t,...n]}const If=["error","errors"];function Bf(e){return If.includes(e)}function Lf({flattenedNodes:e,searchQuery:t}){const n={};function r(o){Object.values(o.children).map(a=>(r(a),ro(a.fullUrlBreadcrumbs))).forEach(a=>n[a]=!0)}return e.forEach(o=>{const i=o.entry.errors.length&&Bf(t),a=ro(o.fullUrlBreadcrumbs);if(Mf({searchIn:[o.entry.title,...o.entry.descriptionParagraphs].join(" ").toLowerCase(),searchQuery:t.toLowerCase()})||i||n[a]){const l=ju(o.fullUrlBreadcrumbs);r(o),l.forEach(c=>n[c]=!0)}else n[a]=!1}),e.filter(o=>{const i=ro(o.fullUrlBreadcrumbs),a=n[i];if(!ee(a,"boolean"))throw new Error(`Failed to find '${o.fullUrlBreadcrumbs.join(" > ")}' in includeInSearchResults.`);return a})}var Se;(function(e){e.Search="search",e.Book="book"})(Se||(Se={}));function sa(e){return e[0]===Se.Book?"":e[1]?decodeURIComponent(e[1]):""}const Cn={hash:void 0,paths:[Se.Book],search:void 0},qf=0;function Wo(e){return!(e.type!=="click"||e.metaKey||e.altKey||e.ctrlKey||e.shiftKey||e.button!==qf)}class zo extends Error{constructor(t){super(t),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"SpaRouterError"})}}class Ks extends zo{constructor(t){super(t),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"WindowEventConsolidationError"})}}const fr="locationchange";globalThis.SPA_ROUTER_VIR_HISTORY_EVENTS_CONSOLIDATED_ALREADY=!1;const Pf=globalThis.history.pushState;function Js(...e){const t=Pf.apply(globalThis.history,e);return globalThis.dispatchEvent(new Event(fr)),t}const Of=globalThis.history.replaceState;function Xs(...e){const t=Of.apply(globalThis.history,e);return globalThis.dispatchEvent(new Event(fr)),t}function Df(){if(!globalThis.SPA_ROUTER_VIR_HISTORY_EVENTS_CONSOLIDATED_ALREADY){if(globalThis.history.pushState===Js)throw new Ks("The consolidation module thinks that window events have not been consolidated yet but globalThis.history.pushState has already been overridden. Does this module have two copies in your repo?");if(globalThis.history.replaceState===Xs)throw new Ks("The consolidation module thinks that window events have not been consolidated yet but globalThis.history.replaceState has already been overridden. Does this module have two copies in your repo?");globalThis.SPA_ROUTER_VIR_HISTORY_EVENTS_CONSOLIDATED_ALREADY=!0,globalThis.history.pushState=Js,globalThis.history.replaceState=Xs,globalThis.addEventListener("popstate",()=>{globalThis.dispatchEvent(new Event(fr))})}}function Nf(e){const t=`/${e}`,r=(e&&globalThis.location.pathname.startsWith(t)?globalThis.location.pathname.replace(t,""):globalThis.location.pathname).split("/").filter(a=>!!a),o=globalThis.location.search?Jh(globalThis.location.toString()):void 0,i=globalThis.location.hash||void 0;return{paths:r,search:o,hash:i}}function Hu(e){return e.replace(/(?:^\/|\/+$)/g,"")}function Uu({routeBase:e,windowPath:t}){if(!e)return"";const n=Hu(e);if(Vu({routeBase:n,windowPath:t}))return n;const r=n.replace(/^[^\/]+\//,"");return r&&r!==n?Uu({routeBase:r,windowPath:t}):""}function Vu({routeBase:e,windowPath:t}){const n=Hu(e);return n?t.startsWith(`/${n}`):!1}class Rf extends zo{constructor(t){super(t),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"SanitizationDepthMaxed"})}}function Wu(e,t){if(e.paths.join(" ")!==t.paths.join(" "))return!1;if(typeof e.search=="object"&&typeof t.search=="object"){const n=Object.entries(e.search).join(" "),r=Object.entries(t.search).join(" ");if(n!==r)return!1}else if(e.search!==t.search)return!1;return e.hash===t.hash}const _s=6;function el(e,t){const n=e.getCurrentRawRoutes();if(e.sanitizationDepth>_s)throw new Rf(`Route sanitization depth has exceed the max of ${_s} with ${JSON.stringify(n)}`);const r=e.sanitizeFullRoute(n);if(Wu(r,n))e.sanitizationDepth=0,t?t(r):e.listeners.forEach(o=>{o(r)});else return e.sanitizationDepth++,e.setRoutes(r,!0)}class mi extends zo{constructor(t){super(t),Object.defineProperty(this,"name",{enumerable:!0,configurable:!0,writable:!0,value:"InvalidRouterInitParamsError"})}}function Ff(e){if("routeBase"in e&&typeof e.routeBase!="string"&&e.routeBase!=null)throw new mi(`Invalid type for router init params "routeBase" property. Expected string or undefined but got "${e.routeBase}" with type "${typeof e.routeBase}".`);if("routeSanitizer"in e&&typeof e.routeSanitizer!="function"&&e.routeSanitizer!=null)throw new mi(`Invalid type for router init params "routeSanitizer" property. Expected a function or undefined but got "${e.routeSanitizer}" with type "${typeof e.routeSanitizer}".`);if("maxListenerCount"in e&&(typeof e.maxListenerCount!="number"||isNaN(e.maxListenerCount))&&e.maxListenerCount!=null)throw new mi(`Invalid type for router init params "maxListenerCount" property. Expected a number or undefined but got "${e.maxListenerCount}" with type "${typeof e.maxListenerCount}".`)}function jf(e,t,n=!1){const r=zu(e,t);n?globalThis.history.replaceState(void 0,"",r):globalThis.history.pushState(void 0,"",r)}function zu(e,t){var s;const n=Vu({routeBase:t,windowPath:globalThis.location.pathname})?t:"",r=e.search?Qh(e.search):"",o=(s=e.hash)!=null&&s.startsWith("#")?"":"#",i=e.hash?`${o}${e.hash}`:"";return`/${[n,...e.paths].filter(we).join("/")}${r}${i}`}function Hf(e={}){Ff(e),Df();const t=e.routeBase?Uu({routeBase:e.routeBase,windowPath:globalThis.window.location.pathname}):"";let n=!1;const r=()=>el(o),o={listeners:new Set,initParams:e,sanitizeFullRoute(i){const a={hash:void 0,search:void 0,...i};return e.routeSanitizer?e.routeSanitizer(a):a},setRoutes(i,a=!1,s=!1){const l=o.getCurrentRawRoutes(),c={...l,...i},f=o.sanitizeFullRoute(c);if(!(!s&&Wu(l,f)))return jf(f,t,a)},createRoutesUrl(i){return zu(i,t)},getCurrentRawRoutes(){return Nf(t)},removeAllRouteListeners(){o.listeners.forEach(i=>o.removeRouteListener(i))},addRouteListener(i,a){if(e.maxListenerCount&&o.listeners.size>=e.maxListenerCount)throw new zo(`Tried to exceed route listener max of '${e.maxListenerCount}'.`);return o.listeners.add(a),n||(globalThis.addEventListener(fr,r),n=!0),i&&el(o,a),a},hasRouteListener(i){return o.listeners.has(i)},removeRouteListener(i){const a=o.listeners.delete(i);return o.listeners.size||(globalThis.removeEventListener(fr,r),n=!1),a},sanitizationDepth:0};return o}function Uf(e){return Hf({routeBase:e,routeSanitizer(t){return{paths:Vf(t.paths),hash:void 0,search:void 0}}})}function Vf(e){const t=e[0];if(Vh(t,Se)){if(t===Se.Book)return[Se.Book,...e.slice(1)];if(t===Se.Search)return e[1]?[t,e[1]]:[Se.Book,...e.slice(1)];throw new Error(`Route path not handled for sanitization: ${e.join("/")}`)}else return Cn.paths}const Z=wt({"element-book-nav-hover-background-color":"magenta","element-book-nav-hover-foreground-color":"magenta","element-book-nav-active-background-color":"magenta","element-book-nav-active-foreground-color":"magenta","element-book-nav-selected-background-color":"magenta","element-book-nav-selected-foreground-color":"magenta","element-book-accent-icon-color":"magenta","element-book-page-background-color":"magenta","element-book-page-background-faint-level-1-color":"magenta","element-book-page-background-faint-level-2-color":"magenta","element-book-page-foreground-color":"magenta","element-book-page-foreground-faint-level-1-color":"magenta","element-book-page-foreground-faint-level-2-color":"magenta"}),Wf={nav:{hover:{background:Z["element-book-nav-hover-background-color"],foreground:Z["element-book-nav-hover-foreground-color"]},active:{background:Z["element-book-nav-active-background-color"],foreground:Z["element-book-nav-active-foreground-color"]},selected:{background:Z["element-book-nav-selected-background-color"],foreground:Z["element-book-nav-selected-foreground-color"]}},accent:{icon:Z["element-book-accent-icon-color"]},page:{background:Z["element-book-page-background-color"],backgroundFaint1:Z["element-book-page-background-faint-level-1-color"],backgroundFaint2:Z["element-book-page-background-faint-level-2-color"],foreground:Z["element-book-page-foreground-color"],foregroundFaint1:Z["element-book-page-foreground-faint-level-1-color"],foregroundFaint2:Z["element-book-page-foreground-faint-level-2-color"]}};function zf(e,t){Zu(e,t,Wf)}function la(e){return Te(e,"_$cssResult$")}function tl(e){return Wc(e,["name","value","default"])&&ee(e.default,"string")&&la(e.name)&&la(e.value)}function Zu(e,t,n){Object.entries(t).forEach(([r,o])=>{const i=n[r];if(!i)throw new Error(`no nestedCssVar at key '${r}'`);if(la(o)){if(!tl(i))throw new Error(`got a CSS result at '${r}' but no CSS var`);vo({forCssVar:i,onElement:e,toValue:String(o)})}else{if(tl(i))throw new Error(`got no CSS result at '${r}' but did find a CSS var`);Zu(e,o,i)}})}function me(e,t){let n=e.length;Array.isArray(e[0])||(e=[e]),Array.isArray(t[0])||(t=t.map(a=>[a]));let r=t[0].length,o=t[0].map((a,s)=>t.map(l=>l[s])),i=e.map(a=>o.map(s=>{let l=0;if(!Array.isArray(a)){for(let c of s)l+=a*c;return l}for(let c=0;c<a.length;c++)l+=a[c]*(s[c]||0);return l}));return n===1&&(i=i[0]),r===1?i.map(a=>a[0]):i}function Sr(e){return Tt(e)==="string"}function Tt(e){return(Object.prototype.toString.call(e).match(/^\[object\s+(.*?)\]$/)[1]||"").toLowerCase()}function yo(e,t){e=+e,t=+t;let n=(Math.floor(e)+"").length;if(t>n)return+e.toFixed(t-n);{let r=10**(n-t);return Math.round(e/r)*r}}function Gu(e){if(!e)return;e=e.trim();const t=/^([a-z]+)\((.+?)\)$/i,n=/^-?[\d.]+$/;let r=e.match(t);if(r){let o=[];return r[2].replace(/\/?\s*([-\w.]+(?:%|deg)?)/g,(i,a)=>{/%$/.test(a)?(a=new Number(a.slice(0,-1)/100),a.type="<percentage>"):/deg$/.test(a)?(a=new Number(+a.slice(0,-3)),a.type="<angle>",a.unit="deg"):n.test(a)&&(a=new Number(a),a.type="<number>"),i.startsWith("/")&&(a=a instanceof Number?a:new Number(a),a.alpha=!0),o.push(a)}),{name:r[1].toLowerCase(),rawName:r[1],rawArgs:r[2],args:o}}}function Yu(e){return e[e.length-1]}function ko(e,t,n){return isNaN(e)?t:isNaN(t)?e:e+(t-e)*n}function Qu(e,t,n){return(n-e)/(t-e)}function ts(e,t,n){return ko(t[0],t[1],Qu(e[0],e[1],n))}function Ku(e){return e.map(t=>t.split("|").map(n=>{n=n.trim();let r=n.match(/^(<[a-z]+>)\[(-?[.\d]+),\s*(-?[.\d]+)\]?$/);if(r){let o=new String(r[1]);return o.range=[+r[2],+r[3]],o}return n}))}var Zf=Object.freeze({__proto__:null,interpolate:ko,interpolateInv:Qu,isString:Sr,last:Yu,mapRange:ts,multiplyMatrices:me,parseCoordGrammar:Ku,parseFunction:Gu,toPrecision:yo,type:Tt});class Gf{add(t,n,r){if(typeof arguments[0]!="string"){for(var t in arguments[0])this.add(t,arguments[0][t],arguments[1]);return}(Array.isArray(t)?t:[t]).forEach(function(o){this[o]=this[o]||[],n&&this[o][r?"unshift":"push"](n)},this)}run(t,n){this[t]=this[t]||[],this[t].forEach(function(r){r.call(n&&n.context?n.context:n,n)})}}const It=new Gf;var st={gamut_mapping:"lch.c",precision:5,deltaE:"76"};const _e={D50:[.3457/.3585,1,(1-.3457-.3585)/.3585],D65:[.3127/.329,1,(1-.3127-.329)/.329]};function ca(e){return Array.isArray(e)?e:_e[e]}function xo(e,t,n,r={}){if(e=ca(e),t=ca(t),!e||!t)throw new TypeError(`Missing white point to convert ${e?"":"from"}${!e&&!t?"/":""}${t?"":"to"}`);if(e===t)return n;let o={W1:e,W2:t,XYZ:n,options:r};if(It.run("chromatic-adaptation-start",o),o.M||(o.W1===_e.D65&&o.W2===_e.D50?o.M=[[1.0479298208405488,.022946793341019088,-.05019222954313557],[.029627815688159344,.990434484573249,-.01707382502938514],[-.009243058152591178,.015055144896577895,.7518742899580008]]:o.W1===_e.D50&&o.W2===_e.D65&&(o.M=[[.9554734527042182,-.023098536874261423,.0632593086610217],[-.028369706963208136,1.0099954580058226,.021041398966943008],[.012314001688319899,-.020507696433477912,1.3303659366080753]])),It.run("chromatic-adaptation-end",o),o.M)return me(o.M,o.XYZ);throw new TypeError("Only Bradford CAT with white points D50 and D65 supported for now.")}const Yf=75e-6,Be=class Be{constructor(t){var o,i,a;this.id=t.id,this.name=t.name,this.base=t.base?Be.get(t.base):null,this.aliases=t.aliases,this.base&&(this.fromBase=t.fromBase,this.toBase=t.toBase);let n=t.coords??this.base.coords;for(let s in n)"name"in n[s]||(n[s].name=s);this.coords=n;let r=t.white??this.base.white??"D65";this.white=ca(r),this.formats=t.formats??{};for(let s in this.formats){let l=this.formats[s];l.type||(l.type="function"),l.name||(l.name=s)}t.cssId&&!((o=this.formats.functions)!=null&&o.color)?(this.formats.color={id:t.cssId},Object.defineProperty(this,"cssId",{value:t.cssId})):(i=this.formats)!=null&&i.color&&!((a=this.formats)!=null&&a.color.id)&&(this.formats.color.id=this.id),this.referred=t.referred,Object.defineProperty(this,"path",{value:Qf(this).reverse(),writable:!1,enumerable:!0,configurable:!0}),It.run("colorspace-init-end",this)}inGamut(t,{epsilon:n=Yf}={}){if(this.isPolar)return t=this.toBase(t),this.base.inGamut(t,{epsilon:n});let r=Object.values(this.coords);return t.every((o,i)=>{let a=r[i];if(a.type!=="angle"&&a.range){if(Number.isNaN(o))return!0;let[s,l]=a.range;return(s===void 0||o>=s-n)&&(l===void 0||o<=l+n)}return!0})}get cssId(){var t,n;return((n=(t=this.formats.functions)==null?void 0:t.color)==null?void 0:n.id)||this.id}get isPolar(){for(let t in this.coords)if(this.coords[t].type==="angle")return!0;return!1}getFormat(t){if(typeof t=="object")return t=nl(t,this),t;let n;return t==="default"?n=Object.values(this.formats)[0]:n=this.formats[t],n?(n=nl(n,this),n):null}equals(t){return t?this===t||this.id===t.id:!1}to(t,n){if(arguments.length===1&&([t,n]=[t.space,t.coords]),t=Be.get(t),this.equals(t))return n;n=n.map(s=>Number.isNaN(s)?0:s);let r=this.path,o=t.path,i,a;for(let s=0;s<r.length&&r[s].equals(o[s]);s++)i=r[s],a=s;if(!i)throw new Error(`Cannot convert between color spaces ${this} and ${t}: no connection space was found`);for(let s=r.length-1;s>a;s--)n=r[s].toBase(n);for(let s=a+1;s<o.length;s++)n=o[s].fromBase(n);return n}from(t,n){return arguments.length===1&&([t,n]=[t.space,t.coords]),t=Be.get(t),t.to(this,n)}toString(){return`${this.name} (${this.id})`}getMinCoords(){let t=[];for(let n in this.coords){let r=this.coords[n],o=r.range||r.refRange;t.push((o==null?void 0:o.min)??0)}return t}static get all(){return[...new Set(Object.values(Be.registry))]}static register(t,n){if(arguments.length===1&&(n=arguments[0],t=n.id),n=this.get(n),this.registry[t]&&this.registry[t]!==n)throw new Error(`Duplicate color space registration: '${t}'`);if(this.registry[t]=n,arguments.length===1&&n.aliases)for(let r of n.aliases)this.register(r,n);return n}static get(t,...n){if(!t||t instanceof Be)return t;if(Tt(t)==="string"){let o=Be.registry[t.toLowerCase()];if(!o)throw new TypeError(`No color space found with id = "${t}"`);return o}if(n.length)return Be.get(...n);throw new TypeError(`${t} is not a valid color space`)}static resolveCoord(t,n){var l;let r=Tt(t),o,i;if(r==="string"?t.includes(".")?[o,i]=t.split("."):[o,i]=[,t]:Array.isArray(t)?[o,i]=t:(o=t.space,i=t.coordId),o=Be.get(o),o||(o=n),!o)throw new TypeError(`Cannot resolve coordinate reference ${t}: No color space specified and relative references are not allowed here`);if(r=Tt(i),r==="number"||r==="string"&&i>=0){let c=Object.entries(o.coords)[i];if(c)return{space:o,id:c[0],index:i,...c[1]}}o=Be.get(o);let a=i.toLowerCase(),s=0;for(let c in o.coords){let f=o.coords[c];if(c.toLowerCase()===a||((l=f.name)==null?void 0:l.toLowerCase())===a)return{space:o,id:c,index:s,...f};s++}throw new TypeError(`No "${i}" coordinate found in ${o.name}. Its coordinates are: ${Object.keys(o.coords).join(", ")}`)}};Pr(Be,"registry",{}),Pr(Be,"DEFAULT_FORMAT",{type:"functions",name:"color"});let M=Be;function Qf(e){let t=[e];for(let n=e;n=n.base;)t.push(n);return t}function nl(e,{coords:t}={}){if(e.coords&&!e.coordGrammar){e.type||(e.type="function"),e.name||(e.name="color"),e.coordGrammar=Ku(e.coords);let n=Object.entries(t).map(([r,o],i)=>{let a=e.coordGrammar[i][0],s=o.range||o.refRange,l=a.range,c="";return a=="<percentage>"?(l=[0,100],c="%"):a=="<angle>"&&(c="deg"),{fromRange:s,toRange:l,suffix:c}});e.serializeCoords=(r,o)=>r.map((i,a)=>{let{fromRange:s,toRange:l,suffix:c}=n[a];return s&&l&&(i=ts(s,l,i)),i=yo(i,o),c&&(i+=c),i})}return e}var Ve=new M({id:"xyz-d65",name:"XYZ D65",coords:{x:{name:"X"},y:{name:"Y"},z:{name:"Z"}},white:"D65",formats:{color:{ids:["xyz-d65","xyz"]}},aliases:["xyz"]});class Me extends M{constructor(t){t.coords||(t.coords={r:{range:[0,1],name:"Red"},g:{range:[0,1],name:"Green"},b:{range:[0,1],name:"Blue"}}),t.base||(t.base=Ve),t.toXYZ_M&&t.fromXYZ_M&&(t.toBase??(t.toBase=n=>{let r=me(t.toXYZ_M,n);return this.white!==this.base.white&&(r=xo(this.white,this.base.white,r)),r}),t.fromBase??(t.fromBase=n=>(n=xo(this.base.white,this.white,n),me(t.fromXYZ_M,n)))),t.referred??(t.referred="display"),super(t)}}function Ju(e,{meta:t}={}){var r,o,i,a,s;let n={str:(r=String(e))==null?void 0:r.trim()};if(It.run("parse-start",n),n.color)return n.color;if(n.parsed=Gu(n.str),n.parsed){let l=n.parsed.name;if(l==="color"){let c=n.parsed.args.shift(),f=n.parsed.rawArgs.indexOf("/")>0?n.parsed.args.pop():1;for(let m of M.all){let g=m.getFormat("color");if(g&&(c===g.id||(o=g.ids)!=null&&o.includes(c))){const w=Object.keys(m.coords).map((k,x)=>n.parsed.args[x]||0);return t&&(t.formatId="color"),{spaceId:m.id,coords:w,alpha:f}}}let h="";if(c in M.registry){let m=(s=(a=(i=M.registry[c].formats)==null?void 0:i.functions)==null?void 0:a.color)==null?void 0:s.id;m&&(h=`Did you mean color(${m})?`)}throw new TypeError(`Cannot parse color(${c}). `+(h||"Missing a plugin?"))}else for(let c of M.all){let f=c.getFormat(l);if(f&&f.type==="function"){let h=1;(f.lastAlpha||Yu(n.parsed.args).alpha)&&(h=n.parsed.args.pop());let m=n.parsed.args,g;return f.coordGrammar&&(g=Object.entries(c.coords).map(([w,k],x)=>{var fe;let C=f.coordGrammar[x],S=(fe=m[x])==null?void 0:fe.type,N=C.find(X=>X==S);if(!N){let X=k.name||w;throw new TypeError(`${S} not allowed for ${X} in ${l}()`)}let W=N.range;S==="<percentage>"&&(W||(W=[0,1]));let te=k.range||k.refRange;return W&&te&&(m[x]=ts(W,te,m[x])),N})),t&&Object.assign(t,{formatId:f.name,types:g}),{spaceId:c.id,coords:m,alpha:h}}}}else for(let l of M.all)for(let c in l.formats){let f=l.formats[c];if(f.type!=="custom"||f.test&&!f.test(n.str))continue;let h=f.parse(n.str);if(h)return h.alpha??(h.alpha=1),t&&(t.formatId=c),h}throw new TypeError(`Could not parse ${e} as a color. Missing a plugin?`)}function Y(e){if(!e)throw new TypeError("Empty color reference");Sr(e)&&(e=Ju(e));let t=e.space||e.spaceId;return t instanceof M||(e.space=M.get(t)),e.alpha===void 0&&(e.alpha=1),e}function Tr(e,t){return t=M.get(t),t.from(e)}function We(e,t){let{space:n,index:r}=M.resolveCoord(t,e.space);return Tr(e,n)[r]}function Xu(e,t,n){return t=M.get(t),e.coords=t.to(e.space,n),e}function Bt(e,t,n){if(e=Y(e),arguments.length===2&&Tt(arguments[1])==="object"){let r=arguments[1];for(let o in r)Bt(e,o,r[o])}else{typeof n=="function"&&(n=n(We(e,t)));let{space:r,index:o}=M.resolveCoord(t,e.space),i=Tr(e,r);i[o]=n,Xu(e,r,i)}return e}var ns=new M({id:"xyz-d50",name:"XYZ D50",white:"D50",base:Ve,fromBase:e=>xo(Ve.white,"D50",e),toBase:e=>xo("D50",Ve.white,e),formats:{color:{}}});const Kf=216/24389,rl=24/116,Or=24389/27;let gi=_e.D50;var Le=new M({id:"lab",name:"Lab",coords:{l:{refRange:[0,100],name:"L"},a:{refRange:[-125,125]},b:{refRange:[-125,125]}},white:gi,base:ns,fromBase(e){let n=e.map((r,o)=>r/gi[o]).map(r=>r>Kf?Math.cbrt(r):(Or*r+16)/116);return[116*n[1]-16,500*(n[0]-n[1]),200*(n[1]-n[2])]},toBase(e){let t=[];return t[1]=(e[0]+16)/116,t[0]=e[1]/500+t[1],t[2]=t[1]-e[2]/200,[t[0]>rl?Math.pow(t[0],3):(116*t[0]-16)/Or,e[0]>8?Math.pow((e[0]+16)/116,3):e[0]/Or,t[2]>rl?Math.pow(t[2],3):(116*t[2]-16)/Or].map((r,o)=>r*gi[o])},formats:{lab:{coords:["<number> | <percentage>","<number> | <percentage>[-1,1]","<number> | <percentage>[-1,1]"]}}});function Zo(e){return(e%360+360)%360}function Jf(e,t){if(e==="raw")return t;let[n,r]=t.map(Zo),o=r-n;return e==="increasing"?o<0&&(r+=360):e==="decreasing"?o>0&&(n+=360):e==="longer"?-180<o&&o<180&&(o>0?n+=360:r+=360):e==="shorter"&&(o>180?n+=360:o<-180&&(r+=360)),[n,r]}var pr=new M({id:"lch",name:"LCH",coords:{l:{refRange:[0,100],name:"Lightness"},c:{refRange:[0,150],name:"Chroma"},h:{refRange:[0,360],type:"angle",name:"Hue"}},base:Le,fromBase(e){let[t,n,r]=e,o;const i=.02;return Math.abs(n)<i&&Math.abs(r)<i?o=NaN:o=Math.atan2(r,n)*180/Math.PI,[t,Math.sqrt(n**2+r**2),Zo(o)]},toBase(e){let[t,n,r]=e;return n<0&&(n=0),isNaN(r)&&(r=0),[t,n*Math.cos(r*Math.PI/180),n*Math.sin(r*Math.PI/180)]},formats:{lch:{coords:["<number> | <percentage>","<number> | <percentage>","<number> | <angle>"]}}});const ol=25**7,Ao=Math.PI,il=180/Ao,nn=Ao/180;function ua(e,t,{kL:n=1,kC:r=1,kH:o=1}={}){let[i,a,s]=Le.from(e),l=pr.from(Le,[i,a,s])[1],[c,f,h]=Le.from(t),m=pr.from(Le,[c,f,h])[1];l<0&&(l=0),m<0&&(m=0);let w=((l+m)/2)**7,k=.5*(1-Math.sqrt(w/(w+ol))),x=(1+k)*a,C=(1+k)*f,S=Math.sqrt(x**2+s**2),N=Math.sqrt(C**2+h**2),W=x===0&&s===0?0:Math.atan2(s,x),te=C===0&&h===0?0:Math.atan2(h,C);W<0&&(W+=2*Ao),te<0&&(te+=2*Ao),W*=il,te*=il;let fe=c-i,X=N-S,V=te-W,ne=W+te,$e=Math.abs(V),ve;S*N===0?ve=0:$e<=180?ve=V:V>180?ve=V-360:V<-180?ve=V+360:console.log("the unthinkable has happened");let lt=2*Math.sqrt(N*S)*Math.sin(ve*nn/2),vt=(i+c)/2,oi=(S+N)/2,xs=Math.pow(oi,7),ct;S*N===0?ct=ne:$e<=180?ct=ne/2:ne<360?ct=(ne+360)/2:ct=(ne-360)/2;let As=(vt-50)**2,gh=1+.015*As/Math.sqrt(20+As),$s=1+.045*oi,On=1;On-=.17*Math.cos((ct-30)*nn),On+=.24*Math.cos(2*ct*nn),On+=.32*Math.cos((3*ct+6)*nn),On-=.2*Math.cos((4*ct-63)*nn);let Cs=1+.015*oi*On,wh=30*Math.exp(-1*((ct-275)/25)**2),vh=2*Math.sqrt(xs/(xs+ol)),bh=-1*Math.sin(2*wh*nn)*vh,qr=(fe/(n*gh))**2;return qr+=(X/(r*$s))**2,qr+=(lt/(o*Cs))**2,qr+=bh*(X/(r*$s))*(lt/(o*Cs)),Math.sqrt(qr)}const Xf=75e-6;function er(e,t=e.space,{epsilon:n=Xf}={}){e=Y(e),t=M.get(t);let r=e.coords;return t!==e.space&&(r=t.from(e)),t.inGamut(r,{epsilon:n})}function mr(e){return{space:e.space,coords:e.coords.slice(),alpha:e.alpha}}function Lt(e,{method:t=st.gamut_mapping,space:n=e.space}={}){if(Sr(arguments[1])&&(n=arguments[1]),n=M.get(n),er(e,n,{epsilon:0}))return Y(e);let r=je(e,n);if(t!=="clip"&&!er(e,n)){let o=Lt(mr(r),{method:"clip",space:n});if(ua(e,o)>2){let i=M.resolveCoord(t),a=i.space,s=i.id,l=je(r,a),f=(i.range||i.refRange)[0],h=.01,m=f,g=We(l,s);for(;g-m>h;){let w=mr(l);w=Lt(w,{space:n,method:"clip"}),ua(l,w)-2<h?m=We(l,s):g=We(l,s),Bt(l,s,(m+g)/2)}r=je(l,n)}else r=o}if(t==="clip"||!er(r,n,{epsilon:0})){let o=Object.values(n.coords).map(i=>i.range||[]);r.coords=r.coords.map((i,a)=>{let[s,l]=o[a];return s!==void 0&&(i=Math.max(s,i)),l!==void 0&&(i=Math.min(i,l)),i})}return n!==e.space&&(r=je(r,e.space)),e.coords=r.coords,e}Lt.returns="color";function je(e,t,{inGamut:n}={}){e=Y(e),t=M.get(t);let r=t.from(e),o={space:t,coords:r,alpha:e.alpha};return n&&(o=Lt(o)),o}je.returns="color";function $o(e,{precision:t=st.precision,format:n="default",inGamut:r=!0,...o}={}){var l;let i;e=Y(e);let a=n;n=e.space.getFormat(n)??e.space.getFormat("default")??M.DEFAULT_FORMAT,r||(r=n.toGamut);let s=e.coords;if(s=s.map(c=>c||0),r&&!er(e)&&(s=Lt(mr(e),r===!0?void 0:r).coords),n.type==="custom")if(o.precision=t,n.serialize)i=n.serialize(s,e.alpha,o);else throw new TypeError(`format ${a} can only be used to parse colors, not for serialization`);else{let c=n.name||"color";n.serializeCoords?s=n.serializeCoords(s,t):t!==null&&(s=s.map(g=>yo(g,t)));let f=[...s];if(c==="color"){let g=n.id||((l=n.ids)==null?void 0:l[0])||e.space.id;f.unshift(g)}let h=e.alpha;t!==null&&(h=yo(h,t));let m=e.alpha<1&&!n.noAlpha?`${n.commas?",":" /"} ${h}`:"";i=`${c}(${f.join(n.commas?", ":" ")}${m})`}return i}const _f=[[.6369580483012914,.14461690358620832,.1688809751641721],[.2627002120112671,.6779980715188708,.05930171646986196],[0,.028072693049087428,1.060985057710791]],e2=[[1.716651187971268,-.355670783776392,-.25336628137366],[-.666684351832489,1.616481236634939,.0157685458139111],[.017639857445311,-.042770613257809,.942103121235474]];var Go=new Me({id:"rec2020-linear",name:"Linear REC.2020",white:"D65",toXYZ_M:_f,fromXYZ_M:e2,formats:{color:{}}});const Dr=1.09929682680944,al=.018053968510807;var _u=new Me({id:"rec2020",name:"REC.2020",base:Go,toBase(e){return e.map(function(t){return t<al*4.5?t/4.5:Math.pow((t+Dr-1)/Dr,1/.45)})},fromBase(e){return e.map(function(t){return t>=al?Dr*Math.pow(t,.45)-(Dr-1):4.5*t})},formats:{color:{}}});const t2=[[.4865709486482162,.26566769316909306,.1982172852343625],[.2289745640697488,.6917385218365064,.079286914093745],[0,.04511338185890264,1.043944368900976]],n2=[[2.493496911941425,-.9313836179191239,-.40271078445071684],[-.8294889695615747,1.7626640603183463,.023624685841943577],[.03584583024378447,-.07617238926804182,.9568845240076872]];var ed=new Me({id:"p3-linear",name:"Linear P3",white:"D65",toXYZ_M:t2,fromXYZ_M:n2});const r2=[[.41239079926595934,.357584339383878,.1804807884018343],[.21263900587151027,.715168678767756,.07219231536073371],[.01933081871559182,.11919477979462598,.9505321522496607]],o2=[[3.2409699419045226,-1.537383177570094,-.4986107602930034],[-.9692436362808796,1.8759675015077202,.04155505740717559],[.05563007969699366,-.20397695888897652,1.0569715142428786]];var td=new Me({id:"srgb-linear",name:"Linear sRGB",white:"D65",toXYZ_M:r2,fromXYZ_M:o2,formats:{color:{}}}),sl={aliceblue:[240/255,248/255,1],antiquewhite:[250/255,235/255,215/255],aqua:[0,1,1],aquamarine:[127/255,1,212/255],azure:[240/255,1,1],beige:[245/255,245/255,220/255],bisque:[1,228/255,196/255],black:[0,0,0],blanchedalmond:[1,235/255,205/255],blue:[0,0,1],blueviolet:[138/255,43/255,226/255],brown:[165/255,42/255,42/255],burlywood:[222/255,184/255,135/255],cadetblue:[95/255,158/255,160/255],chartreuse:[127/255,1,0],chocolate:[210/255,105/255,30/255],coral:[1,127/255,80/255],cornflowerblue:[100/255,149/255,237/255],cornsilk:[1,248/255,220/255],crimson:[220/255,20/255,60/255],cyan:[0,1,1],darkblue:[0,0,139/255],darkcyan:[0,139/255,139/255],darkgoldenrod:[184/255,134/255,11/255],darkgray:[169/255,169/255,169/255],darkgreen:[0,100/255,0],darkgrey:[169/255,169/255,169/255],darkkhaki:[189/255,183/255,107/255],darkmagenta:[139/255,0,139/255],darkolivegreen:[85/255,107/255,47/255],darkorange:[1,140/255,0],darkorchid:[153/255,50/255,204/255],darkred:[139/255,0,0],darksalmon:[233/255,150/255,122/255],darkseagreen:[143/255,188/255,143/255],darkslateblue:[72/255,61/255,139/255],darkslategray:[47/255,79/255,79/255],darkslategrey:[47/255,79/255,79/255],darkturquoise:[0,206/255,209/255],darkviolet:[148/255,0,211/255],deeppink:[1,20/255,147/255],deepskyblue:[0,191/255,1],dimgray:[105/255,105/255,105/255],dimgrey:[105/255,105/255,105/255],dodgerblue:[30/255,144/255,1],firebrick:[178/255,34/255,34/255],floralwhite:[1,250/255,240/255],forestgreen:[34/255,139/255,34/255],fuchsia:[1,0,1],gainsboro:[220/255,220/255,220/255],ghostwhite:[248/255,248/255,1],gold:[1,215/255,0],goldenrod:[218/255,165/255,32/255],gray:[128/255,128/255,128/255],green:[0,128/255,0],greenyellow:[173/255,1,47/255],grey:[128/255,128/255,128/255],honeydew:[240/255,1,240/255],hotpink:[1,105/255,180/255],indianred:[205/255,92/255,92/255],indigo:[75/255,0,130/255],ivory:[1,1,240/255],khaki:[240/255,230/255,140/255],lavender:[230/255,230/255,250/255],lavenderblush:[1,240/255,245/255],lawngreen:[124/255,252/255,0],lemonchiffon:[1,250/255,205/255],lightblue:[173/255,216/255,230/255],lightcoral:[240/255,128/255,128/255],lightcyan:[224/255,1,1],lightgoldenrodyellow:[250/255,250/255,210/255],lightgray:[211/255,211/255,211/255],lightgreen:[144/255,238/255,144/255],lightgrey:[211/255,211/255,211/255],lightpink:[1,182/255,193/255],lightsalmon:[1,160/255,122/255],lightseagreen:[32/255,178/255,170/255],lightskyblue:[135/255,206/255,250/255],lightslategray:[119/255,136/255,153/255],lightslategrey:[119/255,136/255,153/255],lightsteelblue:[176/255,196/255,222/255],lightyellow:[1,1,224/255],lime:[0,1,0],limegreen:[50/255,205/255,50/255],linen:[250/255,240/255,230/255],magenta:[1,0,1],maroon:[128/255,0,0],mediumaquamarine:[102/255,205/255,170/255],mediumblue:[0,0,205/255],mediumorchid:[186/255,85/255,211/255],mediumpurple:[147/255,112/255,219/255],mediumseagreen:[60/255,179/255,113/255],mediumslateblue:[123/255,104/255,238/255],mediumspringgreen:[0,250/255,154/255],mediumturquoise:[72/255,209/255,204/255],mediumvioletred:[199/255,21/255,133/255],midnightblue:[25/255,25/255,112/255],mintcream:[245/255,1,250/255],mistyrose:[1,228/255,225/255],moccasin:[1,228/255,181/255],navajowhite:[1,222/255,173/255],navy:[0,0,128/255],oldlace:[253/255,245/255,230/255],olive:[128/255,128/255,0],olivedrab:[107/255,142/255,35/255],orange:[1,165/255,0],orangered:[1,69/255,0],orchid:[218/255,112/255,214/255],palegoldenrod:[238/255,232/255,170/255],palegreen:[152/255,251/255,152/255],paleturquoise:[175/255,238/255,238/255],palevioletred:[219/255,112/255,147/255],papayawhip:[1,239/255,213/255],peachpuff:[1,218/255,185/255],peru:[205/255,133/255,63/255],pink:[1,192/255,203/255],plum:[221/255,160/255,221/255],powderblue:[176/255,224/255,230/255],purple:[128/255,0,128/255],rebeccapurple:[102/255,51/255,153/255],red:[1,0,0],rosybrown:[188/255,143/255,143/255],royalblue:[65/255,105/255,225/255],saddlebrown:[139/255,69/255,19/255],salmon:[250/255,128/255,114/255],sandybrown:[244/255,164/255,96/255],seagreen:[46/255,139/255,87/255],seashell:[1,245/255,238/255],sienna:[160/255,82/255,45/255],silver:[192/255,192/255,192/255],skyblue:[135/255,206/255,235/255],slateblue:[106/255,90/255,205/255],slategray:[112/255,128/255,144/255],slategrey:[112/255,128/255,144/255],snow:[1,250/255,250/255],springgreen:[0,1,127/255],steelblue:[70/255,130/255,180/255],tan:[210/255,180/255,140/255],teal:[0,128/255,128/255],thistle:[216/255,191/255,216/255],tomato:[1,99/255,71/255],turquoise:[64/255,224/255,208/255],violet:[238/255,130/255,238/255],wheat:[245/255,222/255,179/255],white:[1,1,1],whitesmoke:[245/255,245/255,245/255],yellow:[1,1,0],yellowgreen:[154/255,205/255,50/255]};let ll=Array(3).fill("<percentage> | <number>[0, 255]"),cl=Array(3).fill("<number>[0, 255]");var gr=new Me({id:"srgb",name:"sRGB",base:td,fromBase:e=>e.map(t=>{let n=t<0?-1:1,r=t*n;return r>.0031308?n*(1.055*r**(1/2.4)-.055):12.92*t}),toBase:e=>e.map(t=>{let n=t<0?-1:1,r=t*n;return r<.04045?t/12.92:n*((r+.055)/1.055)**2.4}),formats:{rgb:{coords:ll},rgb_number:{name:"rgb",commas:!0,coords:cl,noAlpha:!0},color:{},rgba:{coords:ll,commas:!0,lastAlpha:!0},rgba_number:{name:"rgba",commas:!0,coords:cl},hex:{type:"custom",toGamut:!0,test:e=>/^#([a-f0-9]{3,4}){1,2}$/i.test(e),parse(e){e.length<=5&&(e=e.replace(/[a-f0-9]/gi,"$&$&"));let t=[];return e.replace(/[a-f0-9]{2}/gi,n=>{t.push(parseInt(n,16)/255)}),{spaceId:"srgb",coords:t.slice(0,3),alpha:t.slice(3)[0]}},serialize:(e,t,{collapse:n=!0}={})=>{t<1&&e.push(t),e=e.map(i=>Math.round(i*255));let r=n&&e.every(i=>i%17===0);return"#"+e.map(i=>r?(i/17).toString(16):i.toString(16).padStart(2,"0")).join("")}},keyword:{type:"custom",test:e=>/^[a-z]+$/i.test(e),parse(e){e=e.toLowerCase();let t={spaceId:"srgb",coords:null,alpha:1};if(e==="transparent"?(t.coords=sl.black,t.alpha=0):t.coords=sl[e],t.coords)return t}}}}),nd=new Me({id:"p3",name:"P3",base:ed,fromBase:gr.fromBase,toBase:gr.toBase,formats:{color:{id:"display-p3"}}});st.display_space=gr;if(typeof CSS<"u"&&CSS.supports)for(let e of[Le,_u,nd]){let t=e.getMinCoords(),r=$o({space:e,coords:t,alpha:1});if(CSS.supports("color",r)){st.display_space=e;break}}function i2(e,{space:t=st.display_space,...n}={}){let r=$o(e,n);if(typeof CSS>"u"||CSS.supports("color",r)||!st.display_space)r=new String(r),r.color=e;else{let o=je(e,t);r=new String($o(o,n)),r.color=o}return r}function rd(e,t,n="lab"){n=M.get(n);let r=n.from(e),o=n.from(t);return Math.sqrt(r.reduce((i,a,s)=>{let l=o[s];return isNaN(a)||isNaN(l)?i:i+(l-a)**2},0))}function a2(e,t){return e=Y(e),t=Y(t),e.space===t.space&&e.alpha===t.alpha&&e.coords.every((n,r)=>n===t.coords[r])}function qt(e){return We(e,[Ve,"y"])}function od(e,t){Bt(e,[Ve,"y"],t)}function s2(e){Object.defineProperty(e.prototype,"luminance",{get(){return qt(this)},set(t){od(this,t)}})}var l2=Object.freeze({__proto__:null,getLuminance:qt,register:s2,setLuminance:od});function c2(e,t){e=Y(e),t=Y(t);let n=Math.max(qt(e),0),r=Math.max(qt(t),0);return r>n&&([n,r]=[r,n]),(n+.05)/(r+.05)}const u2=.56,d2=.57,h2=.62,f2=.65,ul=.022,p2=1.414,m2=.1,g2=5e-4,w2=1.14,dl=.027,v2=1.14;function hl(e){return e>=ul?e:e+(ul-e)**p2}function rn(e){let t=e<0?-1:1,n=Math.abs(e);return t*Math.pow(n,2.4)}function b2(e,t){t=Y(t),e=Y(e);let n,r,o,i,a,s;t=je(t,"srgb"),[i,a,s]=t.coords;let l=rn(i)*.2126729+rn(a)*.7151522+rn(s)*.072175;e=je(e,"srgb"),[i,a,s]=e.coords;let c=rn(i)*.2126729+rn(a)*.7151522+rn(s)*.072175,f=hl(l),h=hl(c),m=h>f;return Math.abs(h-f)<g2?r=0:m?(n=h**u2-f**d2,r=n*w2):(n=h**f2-f**h2,r=n*v2),Math.abs(r)<m2?o=0:r>0?o=r-dl:o=r+dl,o*100}function y2(e,t){e=Y(e),t=Y(t);let n=Math.max(qt(e),0),r=Math.max(qt(t),0);r>n&&([n,r]=[r,n]);let o=n+r;return o===0?0:(n-r)/o}const k2=5e4;function x2(e,t){e=Y(e),t=Y(t);let n=Math.max(qt(e),0),r=Math.max(qt(t),0);return r>n&&([n,r]=[r,n]),r===0?k2:(n-r)/r}function A2(e,t){e=Y(e),t=Y(t);let n=We(e,[Le,"l"]),r=We(t,[Le,"l"]);return Math.abs(n-r)}const $2=216/24389,fl=24/116,Nr=24389/27;let wi=_e.D65;var da=new M({id:"lab-d65",name:"Lab D65",coords:{l:{refRange:[0,100],name:"L"},a:{refRange:[-125,125]},b:{refRange:[-125,125]}},white:wi,base:Ve,fromBase(e){let n=e.map((r,o)=>r/wi[o]).map(r=>r>$2?Math.cbrt(r):(Nr*r+16)/116);return[116*n[1]-16,500*(n[0]-n[1]),200*(n[1]-n[2])]},toBase(e){let t=[];return t[1]=(e[0]+16)/116,t[0]=e[1]/500+t[1],t[2]=t[1]-e[2]/200,[t[0]>fl?Math.pow(t[0],3):(116*t[0]-16)/Nr,e[0]>8?Math.pow((e[0]+16)/116,3):e[0]/Nr,t[2]>fl?Math.pow(t[2],3):(116*t[2]-16)/Nr].map((r,o)=>r*wi[o])},formats:{"lab-d65":{coords:["<number> | <percentage>","<number> | <percentage>[-1,1]","<number> | <percentage>[-1,1]"]}}});const vi=Math.pow(5,.5)*.5+.5;function C2(e,t){e=Y(e),t=Y(t);let n=We(e,[da,"l"]),r=We(t,[da,"l"]),o=Math.abs(Math.pow(n,vi)-Math.pow(r,vi)),i=Math.pow(o,1/vi)*Math.SQRT2-40;return i<7.5?0:i}var oo=Object.freeze({__proto__:null,contrastAPCA:b2,contrastDeltaPhi:C2,contrastLstar:A2,contrastMichelson:y2,contrastWCAG21:c2,contrastWeber:x2});function S2(e,t,n={}){Sr(n)&&(n={algorithm:n});let{algorithm:r,...o}=n;if(!r){let i=Object.keys(oo).map(a=>a.replace(/^contrast/,"")).join(", ");throw new TypeError(`contrast() function needs a contrast algorithm. Please specify one of: ${i}`)}e=Y(e),t=Y(t);for(let i in oo)if("contrast"+r.toLowerCase()===i.toLowerCase())return oo[i](e,t,o);throw new TypeError(`Unknown contrast algorithm: ${r}`)}function id(e){let[t,n,r]=Tr(e,Ve),o=t+15*n+3*r;return[4*t/o,9*n/o]}function ad(e){let[t,n,r]=Tr(e,Ve),o=t+n+r;return[t/o,n/o]}function T2(e){Object.defineProperty(e.prototype,"uv",{get(){return id(this)}}),Object.defineProperty(e.prototype,"xy",{get(){return ad(this)}})}var M2=Object.freeze({__proto__:null,register:T2,uv:id,xy:ad});function E2(e,t){return rd(e,t,"lab")}const I2=Math.PI,pl=I2/180;function B2(e,t,{l:n=2,c:r=1}={}){let[o,i,a]=Le.from(e),[,s,l]=pr.from(Le,[o,i,a]),[c,f,h]=Le.from(t),m=pr.from(Le,[c,f,h])[1];s<0&&(s=0),m<0&&(m=0);let g=o-c,w=s-m,k=i-f,x=a-h,C=k**2+x**2-w**2,S=.511;o>=16&&(S=.040975*o/(1+.01765*o));let N=.0638*s/(1+.0131*s)+.638,W;Number.isNaN(l)&&(l=0),l>=164&&l<=345?W=.56+Math.abs(.2*Math.cos((l+168)*pl)):W=.36+Math.abs(.4*Math.cos((l+35)*pl));let te=Math.pow(s,4),fe=Math.sqrt(te/(te+1900)),X=N*(fe*W+1-fe),V=(g/(n*S))**2;return V+=(w/(r*N))**2,V+=C/X**2,Math.sqrt(V)}const ml=203;var rs=new M({id:"xyz-abs-d65",name:"Absolute XYZ D65",coords:{x:{refRange:[0,9504.7],name:"Xa"},y:{refRange:[0,1e4],name:"Ya"},z:{refRange:[0,10888.3],name:"Za"}},base:Ve,fromBase(e){return e.map(t=>Math.max(t*ml,0))},toBase(e){return e.map(t=>Math.max(t/ml,0))}});const Rr=1.15,Fr=.66,gl=2610/2**14,L2=2**14/2610,wl=3424/2**12,vl=2413/2**7,bl=2392/2**7,q2=1.7*2523/2**5,yl=2**5/(1.7*2523),jr=-.56,bi=16295499532821565e-27,P2=[[.41478972,.579999,.014648],[-.20151,1.120649,.0531008],[-.0166008,.2648,.6684799]],O2=[[1.9242264357876067,-1.0047923125953657,.037651404030618],[.35031676209499907,.7264811939316552,-.06538442294808501],[-.09098281098284752,-.3127282905230739,1.5227665613052603]],D2=[[.5,.5,0],[3.524,-4.066708,.542708],[.199076,1.096799,-1.295875]],N2=[[1,.1386050432715393,.05804731615611886],[.9999999999999999,-.1386050432715393,-.05804731615611886],[.9999999999999998,-.09601924202631895,-.8118918960560388]];var sd=new M({id:"jzazbz",name:"Jzazbz",coords:{jz:{refRange:[0,1],name:"Jz"},az:{refRange:[-.5,.5]},bz:{refRange:[-.5,.5]}},base:rs,fromBase(e){let[t,n,r]=e,o=Rr*t-(Rr-1)*r,i=Fr*n-(Fr-1)*t,s=me(P2,[o,i,r]).map(function(m){let g=wl+vl*(m/1e4)**gl,w=1+bl*(m/1e4)**gl;return(g/w)**q2}),[l,c,f]=me(D2,s);return[(1+jr)*l/(1+jr*l)-bi,c,f]},toBase(e){let[t,n,r]=e,o=(t+bi)/(1+jr-jr*(t+bi)),a=me(N2,[o,n,r]).map(function(m){let g=wl-m**yl,w=bl*m**yl-vl;return 1e4*(g/w)**L2}),[s,l,c]=me(O2,a),f=(s+(Rr-1)*c)/Rr,h=(l+(Fr-1)*f)/Fr;return[f,h,c]},formats:{color:{}}}),ha=new M({id:"jzczhz",name:"JzCzHz",coords:{jz:{refRange:[0,1],name:"Jz"},cz:{refRange:[0,1],name:"Chroma"},hz:{refRange:[0,360],type:"angle",name:"Hue"}},base:sd,fromBase(e){let[t,n,r]=e,o;const i=2e-4;return Math.abs(n)<i&&Math.abs(r)<i?o=NaN:o=Math.atan2(r,n)*180/Math.PI,[t,Math.sqrt(n**2+r**2),Zo(o)]},toBase(e){return[e[0],e[1]*Math.cos(e[2]*Math.PI/180),e[1]*Math.sin(e[2]*Math.PI/180)]},formats:{color:{}}});function R2(e,t){let[n,r,o]=ha.from(e),[i,a,s]=ha.from(t),l=n-i,c=r-a;Number.isNaN(o)&&Number.isNaN(s)?(o=0,s=0):Number.isNaN(o)?o=s:Number.isNaN(s)&&(s=o);let f=o-s,h=2*Math.sqrt(r*a)*Math.sin(f/2*(Math.PI/180));return Math.sqrt(l**2+c**2+h**2)}const ld=3424/4096,cd=2413/128,ud=2392/128,kl=2610/16384,F2=2523/32,j2=16384/2610,xl=32/2523,H2=[[.3592,.6976,-.0358],[-.1922,1.1004,.0755],[.007,.0749,.8434]],U2=[[2048/4096,2048/4096,0],[6610/4096,-13613/4096,7003/4096],[17933/4096,-17390/4096,-543/4096]],V2=[[.9999888965628402,.008605050147287059,.11103437159861648],[1.00001110343716,-.008605050147287059,-.11103437159861648],[1.0000320633910054,.56004913547279,-.3206339100541203]],W2=[[2.0701800566956137,-1.326456876103021,.20661600684785517],[.3649882500326575,.6804673628522352,-.04542175307585323],[-.04959554223893211,-.04942116118675749,1.1879959417328034]];var fa=new M({id:"ictcp",name:"ICTCP",coords:{i:{refRange:[0,1],name:"I"},ct:{refRange:[-.5,.5],name:"CT"},cp:{refRange:[-.5,.5],name:"CP"}},base:rs,fromBase(e){let t=me(H2,e);return z2(t)},toBase(e){let t=Z2(e);return me(W2,t)},formats:{color:{}}});function z2(e){let t=e.map(function(n){let r=ld+cd*(n/1e4)**kl,o=1+ud*(n/1e4)**kl;return(r/o)**F2});return me(U2,t)}function Z2(e){return me(V2,e).map(function(r){let o=Math.max(r**xl-ld,0),i=cd-ud*r**xl;return 1e4*(o/i)**j2})}function G2(e,t){let[n,r,o]=fa.from(e),[i,a,s]=fa.from(t);return 720*Math.sqrt((n-i)**2+.25*(r-a)**2+(o-s)**2)}const Y2=[[.8190224432164319,.3619062562801221,-.12887378261216414],[.0329836671980271,.9292868468965546,.03614466816999844],[.048177199566046255,.26423952494422764,.6335478258136937]],Q2=[[1.2268798733741557,-.5578149965554813,.28139105017721583],[-.04057576262431372,1.1122868293970594,-.07171106666151701],[-.07637294974672142,-.4214933239627914,1.5869240244272418]],K2=[[.2104542553,.793617785,-.0040720468],[1.9779984951,-2.428592205,.4505937099],[.0259040371,.7827717662,-.808675766]],J2=[[.9999999984505198,.39633779217376786,.2158037580607588],[1.0000000088817609,-.10556134232365635,-.06385417477170591],[1.0000000546724108,-.08948418209496575,-1.2914855378640917]];var Co=new M({id:"oklab",name:"Oklab",coords:{l:{refRange:[0,1],name:"L"},a:{refRange:[-.4,.4]},b:{refRange:[-.4,.4]}},white:"D65",base:Ve,fromBase(e){let n=me(Y2,e).map(r=>Math.cbrt(r));return me(K2,n)},toBase(e){let n=me(J2,e).map(r=>r**3);return me(Q2,n)},formats:{oklab:{coords:["<percentage> | <number>","<number> | <percentage>[-1,1]","<number> | <percentage>[-1,1]"]}}});function X2(e,t){let[n,r,o]=Co.from(e),[i,a,s]=Co.from(t),l=n-i,c=r-a,f=o-s;return Math.sqrt(l**2+c**2+f**2)}var So={deltaE76:E2,deltaECMC:B2,deltaE2000:ua,deltaEJz:R2,deltaEITP:G2,deltaEOK:X2};function zn(e,t,n={}){Sr(n)&&(n={method:n});let{method:r=st.deltaE,...o}=n;e=Y(e),t=Y(t);for(let i in So)if("deltae"+r.toLowerCase()===i.toLowerCase())return So[i](e,t,o);throw new TypeError(`Unknown deltaE method: ${r}`)}function _2(e,t=.25){let r=[M.get("oklch","lch"),"l"];return Bt(e,r,o=>o*(1+t))}function ep(e,t=.25){let r=[M.get("oklch","lch"),"l"];return Bt(e,r,o=>o*(1-t))}var tp=Object.freeze({__proto__:null,darken:ep,lighten:_2});function dd(e,t,n=.5,r={}){[e,t]=[Y(e),Y(t)],Tt(n)==="object"&&([n,r]=[.5,n]);let{space:o,outputSpace:i,premultiplied:a}=r;return Mr(e,t,{space:o,outputSpace:i,premultiplied:a})(n)}function hd(e,t,n={}){let r;os(e)&&([r,n]=[e,t],[e,t]=r.rangeArgs.colors);let{maxDeltaE:o,deltaEMethod:i,steps:a=2,maxSteps:s=1e3,...l}=n;r||([e,t]=[Y(e),Y(t)],r=Mr(e,t,l));let c=zn(e,t),f=o>0?Math.max(a,Math.ceil(c/o)+1):a,h=[];if(s!==void 0&&(f=Math.min(f,s)),f===1)h=[{p:.5,color:r(.5)}];else{let m=1/(f-1);h=Array.from({length:f},(g,w)=>{let k=w*m;return{p:k,color:r(k)}})}if(o>0){let m=h.reduce((g,w,k)=>{if(k===0)return 0;let x=zn(w.color,h[k-1].color,i);return Math.max(g,x)},0);for(;m>o;){m=0;for(let g=1;g<h.length&&h.length<s;g++){let w=h[g-1],k=h[g],x=(k.p+w.p)/2,C=r(x);m=Math.max(m,zn(C,w.color),zn(C,k.color)),h.splice(g,0,{p:x,color:r(x)}),g++}}}return h=h.map(m=>m.color),h}function Mr(e,t,n={}){if(os(e)){let[l,c]=[e,t];return Mr(...l.rangeArgs.colors,{...l.rangeArgs.options,...c})}let{space:r,outputSpace:o,progression:i,premultiplied:a}=n;e=Y(e),t=Y(t),e=mr(e),t=mr(t);let s={colors:[e,t],options:n};if(r?r=M.get(r):r=M.registry[st.interpolationSpace]||e.space,o=o?M.get(o):r,e=je(e,r),t=je(t,r),e=Lt(e),t=Lt(t),r.coords.h&&r.coords.h.type==="angle"){let l=n.hue=n.hue||"shorter",c=[r,"h"],[f,h]=[We(e,c),We(t,c)];[f,h]=Jf(l,[f,h]),Bt(e,c,f),Bt(t,c,h)}return a&&(e.coords=e.coords.map(l=>l*e.alpha),t.coords=t.coords.map(l=>l*t.alpha)),Object.assign(l=>{l=i?i(l):l;let c=e.coords.map((m,g)=>{let w=t.coords[g];return ko(m,w,l)}),f=ko(e.alpha,t.alpha,l),h={space:r,coords:c,alpha:f};return a&&(h.coords=h.coords.map(m=>m/f)),o!==r&&(h=je(h,o)),h},{rangeArgs:s})}function os(e){return Tt(e)==="function"&&!!e.rangeArgs}st.interpolationSpace="lab";function np(e){e.defineFunction("mix",dd,{returns:"color"}),e.defineFunction("range",Mr,{returns:"function<color>"}),e.defineFunction("steps",hd,{returns:"array<color>"})}var rp=Object.freeze({__proto__:null,isRange:os,mix:dd,range:Mr,register:np,steps:hd}),fd=new M({id:"hsl",name:"HSL",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,100],name:"Saturation"},l:{range:[0,100],name:"Lightness"}},base:gr,fromBase:e=>{let t=Math.max(...e),n=Math.min(...e),[r,o,i]=e,[a,s,l]=[NaN,0,(n+t)/2],c=t-n;if(c!==0){switch(s=l===0||l===1?0:(t-l)/Math.min(l,1-l),t){case r:a=(o-i)/c+(o<i?6:0);break;case o:a=(i-r)/c+2;break;case i:a=(r-o)/c+4}a=a*60}return[a,s*100,l*100]},toBase:e=>{let[t,n,r]=e;t=t%360,t<0&&(t+=360),n/=100,r/=100;function o(i){let a=(i+t/30)%12,s=n*Math.min(r,1-r);return r-s*Math.max(-1,Math.min(a-3,9-a,1))}return[o(0),o(8),o(4)]},formats:{hsl:{toGamut:!0,coords:["<number> | <angle>","<percentage>","<percentage>"]},hsla:{coords:["<number> | <angle>","<percentage>","<percentage>"],commas:!0,lastAlpha:!0}}}),pd=new M({id:"hsv",name:"HSV",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,100],name:"Saturation"},v:{range:[0,100],name:"Value"}},base:fd,fromBase(e){let[t,n,r]=e;n/=100,r/=100;let o=r+n*Math.min(r,1-r);return[t,o===0?0:200*(1-r/o),100*o]},toBase(e){let[t,n,r]=e;n/=100,r/=100;let o=r*(1-n/2);return[t,o===0||o===1?0:(r-o)/Math.min(o,1-o)*100,o*100]},formats:{color:{toGamut:!0}}}),op=new M({id:"hwb",name:"HWB",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},w:{range:[0,100],name:"Whiteness"},b:{range:[0,100],name:"Blackness"}},base:pd,fromBase(e){let[t,n,r]=e;return[t,r*(100-n)/100,100-r]},toBase(e){let[t,n,r]=e;n/=100,r/=100;let o=n+r;if(o>=1){let s=n/o;return[t,0,s*100]}let i=1-r,a=i===0?0:1-n/i;return[t,a*100,i*100]},formats:{hwb:{toGamut:!0,coords:["<number> | <angle>","<percentage>","<percentage>"]}}});const ip=[[.5766690429101305,.1855582379065463,.1882286462349947],[.29734497525053605,.6273635662554661,.07529145849399788],[.02703136138641234,.07068885253582723,.9913375368376388]],ap=[[2.0415879038107465,-.5650069742788596,-.34473135077832956],[-.9692436362808795,1.8759675015077202,.04155505740717557],[.013444280632031142,-.11836239223101838,1.0151749943912054]];var md=new Me({id:"a98rgb-linear",name:"Linear Adobe® 98 RGB compatible",white:"D65",toXYZ_M:ip,fromXYZ_M:ap}),sp=new Me({id:"a98rgb",name:"Adobe® 98 RGB compatible",base:md,toBase:e=>e.map(t=>Math.pow(Math.abs(t),563/256)*Math.sign(t)),fromBase:e=>e.map(t=>Math.pow(Math.abs(t),256/563)*Math.sign(t)),formats:{color:{id:"a98-rgb"}}});const lp=[[.7977604896723027,.13518583717574031,.0313493495815248],[.2880711282292934,.7118432178101014,8565396060525902e-20],[0,0,.8251046025104601]],cp=[[1.3457989731028281,-.25558010007997534,-.05110628506753401],[-.5446224939028347,1.5082327413132781,.02053603239147973],[0,0,1.2119675456389454]];var gd=new Me({id:"prophoto-linear",name:"Linear ProPhoto",white:"D50",base:ns,toXYZ_M:lp,fromXYZ_M:cp});const up=1/512,dp=16/512;var hp=new Me({id:"prophoto",name:"ProPhoto",base:gd,toBase(e){return e.map(t=>t<dp?t/16:t**1.8)},fromBase(e){return e.map(t=>t>=up?t**(1/1.8):16*t)},formats:{color:{id:"prophoto-rgb"}}}),fp=new M({id:"oklch",name:"Oklch",coords:{l:{refRange:[0,1],name:"Lightness"},c:{refRange:[0,.4],name:"Chroma"},h:{refRange:[0,360],type:"angle",name:"Hue"}},white:"D65",base:Co,fromBase(e){let[t,n,r]=e,o;const i=2e-4;return Math.abs(n)<i&&Math.abs(r)<i?o=NaN:o=Math.atan2(r,n)*180/Math.PI,[t,Math.sqrt(n**2+r**2),Zo(o)]},toBase(e){let[t,n,r]=e,o,i;return isNaN(r)?(o=0,i=0):(o=n*Math.cos(r*Math.PI/180),i=n*Math.sin(r*Math.PI/180)),[t,o,i]},formats:{oklch:{coords:["<number> | <percentage>","<number> | <percentage>[0,1]","<number> | <angle>"]}}});const Al=203,$l=2610/2**14,pp=2**14/2610,mp=2523/2**5,Cl=2**5/2523,Sl=3424/2**12,Tl=2413/2**7,Ml=2392/2**7;var gp=new Me({id:"rec2100pq",name:"REC.2100-PQ",base:Go,toBase(e){return e.map(function(t){return(Math.max(t**Cl-Sl,0)/(Tl-Ml*t**Cl))**pp*1e4/Al})},fromBase(e){return e.map(function(t){let n=Math.max(t*Al/1e4,0),r=Sl+Tl*n**$l,o=1+Ml*n**$l;return(r/o)**mp})},formats:{color:{id:"rec2100-pq"}}});const El=.17883277,Il=.28466892,Bl=.55991073,yi=3.7743;var wp=new Me({id:"rec2100hlg",cssid:"rec2100-hlg",name:"REC.2100-HLG",referred:"scene",base:Go,toBase(e){return e.map(function(t){return t<=.5?t**2/3*yi:(Math.exp((t-Bl)/El)+Il)/12*yi})},fromBase(e){return e.map(function(t){return t/=yi,t<=1/12?Math.sqrt(3*t):El*Math.log(12*t-Il)+Bl})},formats:{color:{id:"rec2100-hlg"}}});const wd={};It.add("chromatic-adaptation-start",e=>{e.options.method&&(e.M=vd(e.W1,e.W2,e.options.method))});It.add("chromatic-adaptation-end",e=>{e.M||(e.M=vd(e.W1,e.W2,e.options.method))});function Yo({id:e,toCone_M:t,fromCone_M:n}){wd[e]=arguments[0]}function vd(e,t,n="Bradford"){let r=wd[n],[o,i,a]=me(r.toCone_M,e),[s,l,c]=me(r.toCone_M,t),f=[[s/o,0,0],[0,l/i,0],[0,0,c/a]],h=me(f,r.toCone_M);return me(r.fromCone_M,h)}Yo({id:"von Kries",toCone_M:[[.40024,.7076,-.08081],[-.2263,1.16532,.0457],[0,0,.91822]],fromCone_M:[[1.8599364,-1.1293816,.2198974],[.3611914,.6388125,-64e-7],[0,0,1.0890636]]});Yo({id:"Bradford",toCone_M:[[.8951,.2664,-.1614],[-.7502,1.7135,.0367],[.0389,-.0685,1.0296]],fromCone_M:[[.9869929,-.1470543,.1599627],[.4323053,.5183603,.0492912],[-.0085287,.0400428,.9684867]]});Yo({id:"CAT02",toCone_M:[[.7328,.4296,-.1624],[-.7036,1.6975,.0061],[.003,.0136,.9834]],fromCone_M:[[1.0961238,-.278869,.1827452],[.454369,.4735332,.0720978],[-.0096276,-.005698,1.0153256]]});Yo({id:"CAT16",toCone_M:[[.401288,.650173,-.051461],[-.250268,1.204414,.045854],[-.002079,.048952,.953127]],fromCone_M:[[1.862067855087233,-1.011254630531685,.1491867754444518],[.3875265432361372,.6214474419314753,-.008973985167612518],[-.01584149884933386,-.03412293802851557,1.04996443687785]]});Object.assign(_e,{A:[1.0985,1,.35585],C:[.98074,1,1.18232],D55:[.95682,1,.92149],D75:[.94972,1,1.22638],E:[1,1,1],F2:[.99186,1,.67393],F7:[.95041,1,1.08747],F11:[1.00962,1,.6435]});_e.ACES=[.32168/.33767,1,(1-.32168-.33767)/.33767];const vp=[[.6624541811085053,.13400420645643313,.1561876870049078],[.27222871678091454,.6740817658111484,.05368951740793705],[-.005574649490394108,.004060733528982826,1.0103391003129971]],bp=[[1.6410233796943257,-.32480329418479,-.23642469523761225],[-.6636628587229829,1.6153315916573379,.016756347685530137],[.011721894328375376,-.008284441996237409,.9883948585390215]];var bd=new Me({id:"acescg",name:"ACEScg",coords:{r:{range:[0,65504],name:"Red"},g:{range:[0,65504],name:"Green"},b:{range:[0,65504],name:"Blue"}},referred:"scene",white:_e.ACES,toXYZ_M:vp,fromXYZ_M:bp,formats:{color:{}}});const Hr=2**-16,ki=-.35828683,Ur=(Math.log2(65504)+9.72)/17.52;var yp=new Me({id:"acescc",name:"ACEScc",coords:{r:{range:[ki,Ur],name:"Red"},g:{range:[ki,Ur],name:"Green"},b:{range:[ki,Ur],name:"Blue"}},referred:"scene",base:bd,toBase(e){const t=-.3013698630136986;return e.map(function(n){return n<=t?(2**(n*17.52-9.72)-Hr)*2:n<Ur?2**(n*17.52-9.72):65504})},fromBase(e){return e.map(function(t){return t<=0?(Math.log2(Hr)+9.72)/17.52:t<Hr?(Math.log2(Hr+t*.5)+9.72)/17.52:(Math.log2(t)+9.72)/17.52})},formats:{color:{}}}),Ll=Object.freeze({__proto__:null,A98RGB:sp,A98RGB_Linear:md,ACEScc:yp,ACEScg:bd,HSL:fd,HSV:pd,HWB:op,ICTCP:fa,JzCzHz:ha,Jzazbz:sd,LCH:pr,Lab:Le,Lab_D65:da,OKLCH:fp,OKLab:Co,P3:nd,P3_Linear:ed,ProPhoto:hp,ProPhoto_Linear:gd,REC_2020:_u,REC_2020_Linear:Go,REC_2100_HLG:wp,REC_2100_PQ:gp,XYZ_ABS_D65:rs,XYZ_D50:ns,XYZ_D65:Ve,sRGB:gr,sRGB_Linear:td});class P{constructor(...t){let n;t.length===1&&(n=Y(t[0]));let r,o,i;n?(r=n.space||n.spaceId,o=n.coords,i=n.alpha):[r,o,i]=t,Object.defineProperty(this,"space",{value:M.get(r),writable:!1,enumerable:!0,configurable:!0}),this.coords=o?o.slice():[0,0,0],this.alpha=i<1?i:1;for(let a=0;a<this.coords.length;a++)this.coords[a]==="NaN"&&(this.coords[a]=NaN);for(let a in this.space.coords)Object.defineProperty(this,a,{get:()=>this.get(a),set:s=>this.set(a,s)})}get spaceId(){return this.space.id}clone(){return new P(this.space,this.coords,this.alpha)}toJSON(){return{spaceId:this.spaceId,coords:this.coords,alpha:this.alpha}}display(...t){let n=i2(this,...t);return n.color=new P(n.color),n}static get(t,...n){return t instanceof P?t:new P(t,...n)}static defineFunction(t,n,r=n){let{instance:o=!0,returns:i}=r,a=function(...s){let l=n(...s);if(i==="color")l=P.get(l);else if(i==="function<color>"){let c=l;l=function(...f){let h=c(...f);return P.get(h)},Object.assign(l,c)}else i==="array<color>"&&(l=l.map(c=>P.get(c)));return l};t in P||(P[t]=a),o&&(P.prototype[t]=function(...s){return a(this,...s)})}static defineFunctions(t){for(let n in t)P.defineFunction(n,t[n],t[n])}static extend(t){if(t.register)t.register(P);else for(let n in t)P.defineFunction(n,t[n])}}P.defineFunctions({get:We,getAll:Tr,set:Bt,setAll:Xu,to:je,equals:a2,inGamut:er,toGamut:Lt,distance:rd,toString:$o});Object.assign(P,{util:Zf,hooks:It,WHITES:_e,Space:M,spaces:M.registry,parse:Ju,defaults:st});for(let e of Object.keys(Ll))M.register(Ll[e]);for(let e in M.registry)pa(e,M.registry[e]);It.add("colorspace-init-end",e=>{var t;pa(e.id,e),(t=e.aliases)==null||t.forEach(n=>{pa(n,e)})});function pa(e,t){Object.keys(t.coords),Object.values(t.coords).map(r=>r.name);let n=e.replace(/-/g,"_");Object.defineProperty(P.prototype,n,{get(){let r=this.getAll(e);return typeof Proxy>"u"?r:new Proxy(r,{has:(o,i)=>{try{return M.resolveCoord([t,i]),!0}catch{}return Reflect.has(o,i)},get:(o,i,a)=>{if(i&&typeof i!="symbol"&&!(i in o)){let{index:s}=M.resolveCoord([t,i]);if(s>=0)return o[s]}return Reflect.get(o,i,a)},set:(o,i,a,s)=>{if(i&&typeof i!="symbol"&&!(i in o)||i>=0){let{index:l}=M.resolveCoord([t,i]);if(l>=0)return o[l]=a,this.setAll(e,o),!0}return Reflect.set(o,i,a,s)}})},set(r){this.setAll(e,r)},configurable:!0,enumerable:!0})}P.extend(So);P.extend({deltaE:zn});Object.assign(P,{deltaEMethods:So});P.extend(tp);P.extend({contrast:S2});P.extend(M2);P.extend(l2);P.extend(rp);P.extend(oo);function yd(e){return ke(e,(t,n)=>n instanceof P?T(n.toString({format:"hex"})):yd(n))}const kp="dodgerblue";function ma(e){const t=Math.abs(e.contrast("white","APCA")),n=Math.abs(e.contrast("black","APCA"));return t>n?"white":"black"}function xi({background:e,foreground:t}){return{background:e??new P(ma(t)),foreground:t??new P(ma(e))}}var To;(function(e){e.Dark="dark",e.Light="light"})(To||(To={}));function xp(e){return e==="black"?"white":"black"}const Ap={black:{foregroundFaint1:new P("#ccc"),foregroundFaint2:new P("#eee")},white:{foregroundFaint1:new P("#ccc"),foregroundFaint2:new P("#eee")}},$p={black:{backgroundFaint1:new P("#666"),backgroundFaint2:new P("#444")},white:{backgroundFaint1:new P("#ccc"),backgroundFaint2:new P("#fafafa")}};function ql({themeColor:e=kp,themeStyle:t=To.Light}={}){const n=new P(e),r=new P(t===To.Dark?"black":"white"),o=ma(r),i=new P(o),a={nav:{hover:xi({background:n.clone().set({"hsl.l":93})}),active:xi({background:n.clone().set({"hsl.l":90})}),selected:xi({background:n.clone().set({"hsl.l":85})})},accent:{icon:n.clone().set({"hsl.l":40})},page:{background:r,...$p[xp(o)],foreground:i,...Ap[o]}};return yd(a)}const Mo=Wa()("element-book-change-route"),Pl="vira-",{defineElement:In,defineElementNoInputs:Bv}=Ja({assertInputs:e=>{if(!e.tagName.startsWith(Pl))throw new Error(`Tag name should start with '${Pl}' but got '${e.tagName}'`)}}),kd=p`
    pointer-events: none;
    opacity: 0.3;
...
`,de=In()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:e})=>!!e.fitContainer},styles:({hostClasses:e})=>p`
    ...
    `,events:{expandChange:oe()},stateInitStatic:{contentHeight:0},renderCallback({state:e,updateState:t,dispatch:n,events:r,inputs:o}){const i=o.expanded?p`
        ...
        `}});const q=wt({"vira-icon-stroke-color":"currentColor","vira-icon-fill-color":"none","vira-icon-stroke-width":"1px"});function v({name:e,svgTemplate:t}){return{name:e,svgTemplate:t}}const Sp=v({name:"CloseX24Icon",svgTemplate:u`
...
`,Ad=v({name:"LoaderAnimated24Icon",svgTemplate:u`
        <style>
            ${Ep}
        </style>
        ${Mp.svgTemplate}
    `}),Ip=v({name:"Options24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <g
                fill=${q["vira-icon-fill-color"].value}
                stroke=${q["vira-icon-stroke-color"].value}
    ...
    `}),$d=v({name:"StatusFailure24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <circle
                cx="12"
                cy="12"
    ...
    `,stateInitStatic:{loadedUrls:{},erroredUrls:{}},renderCallback({inputs:e,state:t,updateState:n,dispatch:r,events:o}){const i=e.imageUrl,a=t.erroredUrls[i]?u`
        ...
        `,stateInitStatic:{forcedInputWidth:0},renderCallback:({inputs:e,dispatch:t,state:n,updateState:r,events:o})=>{const{filtered:i}=Sd({value:e.value??"",allowed:e.allowedInputs,blocked:e.blockedInputs}),a=e.icon?u`
            ...
            <label>
                ...
                <input
                    ...
                    ?disabled=${e.disabled}
                    .value=${i}
                    ${y("input",l=>{Bp({inputs:e,filteredValue:i,event:l,inputBlockedCallback(c){t(new o.inputBlocked(c))},newValueCallback(c){t(new o.valueChange(c))}})})}
    ...
    `,events:{routeChange:oe()},renderCallback({inputs:e,dispatch:t,events:n}){var o,i;function r(a){e.route&&Wo(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new n.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return u`
            ...
            `}}});const{defineElement:Ge,defineElementNoInputs:Lv}=Ja(),Fe=Ge()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>p`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `,renderCallback:({inputs:e,dispatch:t})=>{var r,o;const n=((o=e.router)==null?void 0:o.createRoutesUrl({...(r=e.router)==null?void 0:r.getCurrentRawRoutes(),...e.route}))??"#";return u`
        ...
        `}});function Lp(e,t){return e.entry.entryType===be.Root?!1:!!(e.entry.entryType===be.Page||it(t,e.fullUrlBreadcrumbs.slice(0,-1))||it(t==null?void 0:t.slice(0,-1),e.fullUrlBreadcrumbs.slice(0,-1)))}const ht=Ge()({tagName:"book-nav",cssVars:{"book-nav-internal-indent":"0"},styles:({cssVars:e})=>p`
        :host {
            display: flex;
            flex-direction: column;
            padding: 16px 0;
    ...
    `,renderCallback({inputs:e}){const t=e.flattenedNodes.map(n=>{if(!Lp(n,e.selectedPath))return;const r=p`
        ...
        `}});async function qp(e){await ta(2);const t=e.shadowRoot.querySelector(".selected");if(!t)throw new Error("Failed to find selected nav tree element.");await c1(t)||t.scrollIntoView({behavior:"smooth",block:"center"})}const Pt=Ge()({tagName:"book-error",styles:p`
        :host {
            display: flex;
            flex-direction: column;
            color: red;
    ...
    `,renderCallback({inputs:e}){return(ee(e.message,"array")?e.message:[e.message]).map(n=>u`
                <p>${n}</p>
    ...
    `,renderCallback({inputs:e,dispatch:t,events:n}){return Object.entries(e.config).length?Object.entries(e.config).map(([r,o],i)=>{if(o.controlType===j.Hidden)return"";const a=Pp(e.currentValues[r],o,s=>{const l=ee(e.fullUrlBreadcrumbs,"array")?e.fullUrlBreadcrumbs:e.fullUrlBreadcrumbs[r];if(!l)throw new Error(`Failed to find breadcrumbs from given control name: '${r}'`);t(new n.controlValueChange({fullUrlBreadcrumbs:l,newValues:{...e.currentValues,[r]:s}}))});return u`
                ...
                `}):""}});function Pp(e,t,n){return tn(t,j.Hidden)?"":tn(t,j.Checkbox)?u`
            <input
                type="checkbox"
                .value=${e}
    ...
    `,renderCallback({inputs:e}){const t=e.isTopLevel?u`
              ...
              `,n=[Se.Book,...e.pageNode.fullUrlBreadcrumbs],r=Yc(e.pageNode.entry.errors);return r&&console.error(r),u`
    ...
    `,renderCallback({inputs:e}){return u`
        ...
        `}});function Td(e,t,n,r){const o=aa(n,r),i=[];if(o){const a=Td(e,t,o,r);a&&i.push(a)}if(vn(n,be.Page)&&!e.includes(n)){const a=_a(t,n.fullUrlBreadcrumbs);i.push({config:n.entry.controls,current:a,breadcrumbs:ke(a,()=>n.fullUrlBreadcrumbs)})}return i.reduce((a,s)=>({config:{...a.config,...s.config},current:{...a.current,...s.current},breadcrumbs:{...a.breadcrumbs,...s.breadcrumbs}}),{config:{},current:{},breadcrumbs:{}})}function Op({currentNodes:e,isTopLevel:t,router:n,isSearching:r,controls:o,originalTree:i}){if(!e.length&&r)return[u`
                No results
            `];const a=_i(e,1)?Td(e,o,e[0],i):void 0,s=a&&Object.values(a.config).length&&_i(e,1)?u`
                  <${wr.assign({config:a.config,currentValues:a.current,fullUrlBreadcrumbs:a.breadcrumbs})}></${wr}>
              `:_,l=q1(e,c=>c.fullUrlBreadcrumbs.join(">"),(c,f)=>{if(vn(c,be.Page))return u`
                    <${Nl.assign({isTopLevel:t,pageNode:c,controls:o,router:n})}
                        class="block-entry"
                    ></${Nl}>
                `;if(vn(c,be.ElementExample)){const h=_a(o,c.fullUrlBreadcrumbs.slice(0,-1));return u`
                    <${jl.assign({elementExampleNode:c,currentPageControls:h,router:n})}
                        class="inline-entry"
                    ></${jl}>
                `}else return vn(c,be.Root)?_:u`
                    <${Pt.assign({message:`Unknown entry type for rendering: '${c.entry.entryType}'`})}
                        class="block-entry"
                    ></${Pt}>
    ...
    `,events:{loadingRender:oe()},stateInitStatic:{lastElement:void 0},renderCallback:({inputs:e,dispatch:t,events:n,state:r,updateState:o})=>{const i=sa(e.currentRoute.paths),a=Op({currentNodes:e.currentNodes,isTopLevel:!0,router:e.router,isSearching:!!i,controls:e.controls,originalTree:e.originalTree});return u`
            ...
            ${ye(e.showLoading,u`
                ...
                `,u`
                    ...
                    <slot name=${at.Footer}></slot>
                `)}
        `}});function Dp(e,t,n){const r=Hl(e,t);if(r.length)return r;n(Cn);const o=Hl(e,Cn.paths);if(!o)throw new Error(`Tried to self-correct for invalid path ${t.join("/")}
                        but failed to do so.`);return o}function Hl(e,t){return e.filter(n=>l1({searchFor:t.slice(1),searchIn:n.fullUrlBreadcrumbs}))}const $i=Ou()({tagName:"element-book-app",events:{pathUpdate:oe()},stateInitStatic:{currentRoute:Cn,router:void 0,loading:!0,colors:{config:void 0,theme:ql(void 0)},treeBasedControls:void 0,originalWindowTitle:void 0},styles:p`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{Ul(e,sa(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:n,updateState:r,dispatch:o,events:i})=>{var f,h,m,g,w,k,x;t._debug&&console.info("rendering element-book app");function a(C){return{...e.currentRoute,...C}}function s(C){const S=a(C);return!it(e.currentRoute,S)}function l(C){t.preventWindowTitleChange||(e.originalWindowTitle||r({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,C].filter(we).join(" - "))}function c(C){if(!s(C))return;const S=a(C);e.router?e.router.setRoutes(S):r({currentRoute:{...e.currentRoute,...S}}),t.elementBookRoutePaths&&!it(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(S.paths??[]))}try{if(t.elementBookRoutePaths&&!it(t.elementBookRoutePaths,e.currentRoute.paths)&&c({paths:t.elementBookRoutePaths}),(f=t.internalRouterConfig)!=null&&f.useInternalRouter&&!e.router){const V=Uf(t.internalRouterConfig.basePath);r({router:V}),V.addRouteListener(!0,ne=>{r({currentRoute:ne})})}else!((h=t.internalRouterConfig)!=null&&h.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const C={themeColor:t.themeColor};if(!it(C,(m=e.colors)==null?void 0:m.config)){const V=ql(C);r({colors:{config:C,theme:V}}),zf(n,V)}const S=t._debug??!1,N=Cf({entries:t.entries,debug:S});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),r({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:Fu(N.tree,{children:(w=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:w.children,controls:t.globalValues})}}));const W=sa(e.currentRoute.paths),fe=(W?Lf({flattenedNodes:N.flattenedNodes,searchQuery:W}):void 0)??Dp(N.flattenedNodes,e.currentRoute.paths,c);l((k=fe[0])==null?void 0:k.entry.title);const X=(x=e.treeBasedControls)==null?void 0:x.controls;return X?(t._debug&&console.info({currentControls:X}),u`
                <div
                    class="root"
                    ${y(Mo,async V=>{const ne=V.detail;if(!s(ne))return;if(r({loading:!0}),c(ne),!(n.shadowRoot.querySelector(ht.tagName)instanceof ht))throw new Error(`Failed to find child '${ht.tagName}'`);Ul(n,W,e.currentRoute)})}
                    ${y(wr.events.controlValueChange,V=>{if(!e.treeBasedControls)return;const ne=Tf(X,V.detail.fullUrlBreadcrumbs,V.detail.newValues);r({treeBasedControls:{...e.treeBasedControls,controls:ne}})})}
                >
            ...
            `}}});async function Ul(e,t,n){if(t||n.paths.length<=1)return;const r=e.shadowRoot.querySelector(ht.tagName);if(!(r instanceof ht))throw new Error(`Failed to find child '${ht.tagName}'`);await qp(r)}function Ci(e){return{foregroundColor:e.backgroundColor,backgroundColor:e.foregroundColor}}const Np=(()=>{const e={backgroundColor:p`#ffffff`,foregroundColor:p`#000000`},t={...e,foregroundColor:p`#00D093`},n={...e,foregroundColor:p`#ACADAD`},r={...e,foregroundColor:p`#D6D6D6`},o={foregroundColor:p`#ffffff`,backgroundColor:p`#FF5357`},i={foregroundColor:p`#ffffff`,backgroundColor:p`#01C9A0`},a={foregroundColor:p`#ffffff`,backgroundColor:p`#FFAC00`},s={...t},l={...t,foregroundColor:p`#00A876`},c={...t,foregroundColor:p`#1D6852`},f={...r},h={...e,foregroundColor:p`rgba(0, 0, 0, 0.08)`},m={...e,backgroundColor:p`#D2EEFA`},g=Ci(s),w=Ci(l),k=Ci(c),x=k,C={backgroundColor:p`#F1F3F6`,foregroundColor:e.foregroundColor},S={...C,foregroundColor:p`#9A9A9D`};return{brandPrimary:t,pagePrimary:e,pageSecondary:n,pageTertiary:r,pageInteraction:s,pageInteractionHover:l,pageInteractionActive:c,divider:f,dividerFaint:h,dropShadow:m,pageDarkPrimary:x,accentPrimary:g,accentPrimaryHover:w,accentPrimaryActive:k,accentSecondary:C,accentTertiary:S,colorDanger:o,colorSuccess:i,colorWarning:a}})(),Md=Np;function Vl(e,t){return T(`--toniq-${fo(e)}-${fo(t)}`)}const as=ke(Md,e=>({backgroundColor:Vl(e,"backgroundColor"),foregroundColor:Vl(e,"foregroundColor")}));function Xe(e,t){const n=Md[e][t],r=as[e][t];return p`var(${r}, ${n})`}const b=ke(as,e=>({foregroundColor:Xe(e,"foregroundColor"),backgroundColor:Xe(e,"backgroundColor")}));function F(e){return p`
...
`))}const D=(()=>{const e=p`
    ...
    `,m=p`
        ${Ye("monospaceFont")}
    `;return{toniqFont:e,normalWeightFont:t,boldFont:n,extraBoldFont:r,paragraphFont:o,boldParagraphFont:i,labelFont:a,boldLabelFont:s,h1Font:l,h2Font:c,h3Font:f,h4Font:h,monospaceFont:m}})(),d=wt({"toniq-icon-fill-color":q["vira-icon-fill-color"].default,"toniq-icon-stroke-color":q["vira-icon-stroke-color"].default,"toniq-icon-stroke-width":"2px"}),G=ke(d,(e,t)=>n=>T(`var(${t.name}, ${n})`)),vr={popupShadow:p`
    ...
    `,menuShadow:p`
        ...
        */
        will-change: filter;
    `};function Fp(e,t=!0){const n=T(e),r=e===":host"?p`
                  :host(:hover);
              `:p`
                  ${n}:hover
              `,o=t?p`
    ...
    `}),jp=v({name:"Copy16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${d["toniq-icon-fill-color"].value}
            stroke=${d["toniq-icon-stroke-color"].value}
    ...
    `}),Et=v({name:"InfoCircle16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Up=v({name:"ArrowBarUp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Wp=v({name:"ArrowLoopLeft24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Gp=v({name:"ArrowsSortDescending24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Yp=v({name:"Bell24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Qp=v({name:"Bucket24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Kp=v({name:"BuildingStore24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Xp=v({name:"Cash24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),_p=v({name:"Chain24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Ld=v({name:"CheckMark24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),qd=v({name:"ChevronDown24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),em=v({name:"ChevronUp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),tm=v({name:"Circle24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),om=v({name:"Clock24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),im=v({name:"Code24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),am=v({name:"CreateFile24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),sm=v({name:"DotsVertical24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),lm=v({name:"Download24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),cm=v({name:"Edit24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Dd=v({name:"ExternalLink24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),dm=v({name:"Filter24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),hm=v({name:"Fire24Icon",svgTemplate:u`
        <svg
            width="14"
            height="24"
            viewBox="0 0 14 19"
    ...
    `}),fm=v({name:"Gear24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),pm=v({name:"Geometry24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),mm=v({name:"GridDots24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),ba=v({name:"Infinity24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),wm=v({name:"Info24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),vm=v({name:"LayersLinked24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),bm=v({name:"LayoutGrid24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),ym=v({name:"Lifebuoy24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),km=v({name:"List24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Am=v({name:"Loader24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),$m=v({name:"Lock24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Sm=v({name:"Menu24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Tm=v({name:"Pamphlet24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),Bm=v({name:"Photo24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Lm=v({name:"Refresh24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Nd=v({name:"Rocket24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),qm=v({name:"Send24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Pm=v({name:"ShootingStar24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),Dm=v({name:"Social24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Nm=v({name:"Square24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Rm=v({name:"SquareCheck24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Fm=v({name:"Tag24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),ao=v({name:"Trash24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),jm=v({name:"Upload24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Fd=v({name:"World24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Um=v({name:"WorldUpload24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Wm=v({name:"Folder48Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),jd=v({name:"FolderOff48Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Gm=v({name:"Wallet48Icon",svgTemplate:u`
    ...
    `}),Ym=v({name:"CircleDashes64Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Qm=v({name:"Rocket64Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),Qo=v({name:"CryptoBtc24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),Xm=v({name:"CryptoCkBtc24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
...
`,_m=v({name:"CryptoIcp16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),eg=v({name:"CryptoIcp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),tg=v({name:"WalletBitfinity24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),ng=v({name:"WalletBitfinity64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),rg=v({name:"WalletLeather24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),og=v({name:"WalletLeather64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),ig=v({name:"WalletPlug24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),ag=v({name:"WalletPlug64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),sg=v({name:"WalletStoic24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),lg=v({name:"WalletStoic64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),cg=v({name:"WalletUnisat24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),ug=v({name:"WalletUnisat64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),dg=v({name:"WalletXverse24Icon",svgTemplate:u`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),hg=v({name:"WalletXverse64Icon",svgTemplate:u`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),fg=v({name:"BrandFacebookLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),pg=v({name:"BrandGoogleLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),mg=v({name:"BrandIcScan24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),gg=v({name:"BrandInstagramFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),wg=v({name:"BrandNftgeek24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),vg=v({name:"BrandTiktokFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${G["toniq-icon-fill-color"]("#000")}
    ...
    `}),bg=v({name:"BioniqRobot100Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),yg=v({name:"EntrepotLogo144Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),At={"core-16":[Id,jp,Hp,Et],"core-24":[Up,Vp,ss,Wp,zp,ls,Bd,Zp,Gp,Yp,Qp,Kp,Jp,Xp,_p,Ld,qd,em,tm,Pd,nm,rm,om,im,Od,am,sm,lm,cm,um,Dd,dm,hm,fm,pm,mm,gm,ba,wm,vm,bm,ym,km,xm,Am,cs,$m,Cm,Sm,Tm,Mm,Em,Im,Bm,Lm,Nd,Rd,qm,Pm,Om,Dm,Nm,Rm,Fm,ao,jm,Hm,Fd,Um,Vm],"core-48":[Wm,jd,zm,Zm,Gm],"core-64":[Hd,Ym,Qm],cryptocurrencies:[Km,Qo,Jm,Xm,_m,eg],"external-wallets":[tg,ng,rg,og,ig,ag,sg,lg,cg,ug,dg,hg],"third-party-brands":[Wd,zd,Zd,fg,pg,mg,Gd,gg,Yd,wg,Qd,Kd,vg,Jd,Xd],toniq:[bg,yg]},kg=Cr({discord:nt(void 0,""),distrikt:nt(void 0,""),dscvr:nt(void 0,""),instagram:nt(void 0,""),medium:nt(void 0,""),telegram:nt(void 0,""),tikTok:nt(void 0,""),twitch:nt(void 0,""),twitter:nt(void 0,""),website:nt(void 0,"")}),xg=kg.defaultValue,_d={discord:Wd,instagram:Gd,telegram:Qd,tikTok:Kd,distrikt:zd,twitch:Jd,dscvr:Zd,medium:Yd,twitter:Xd,website:Fd},zl="toniq-",{defineElement:ie,defineElementNoInputs:us}=Ja({assertInputs:e=>{if(!e.tagName.startsWith(zl))throw new Error(`Tag name should start with '${zl}' but got '${e.tagName}'`)}}),Yt=ie()({tagName:"toniq-bold-space",styles:p`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,renderCallback({inputs:e}){const t=e.iconPlacement??"left",n=e.icon?u`
                  <${$.assign({icon:e.icon})}
                      class="icon-template"
                  ></${$}>
              `:"",r=e.text?u`
                  <span class="text-template">${e.text}</span>
              `:"",o=ye(t==="left",n),i=ye(t==="right",n);return u`
            <button ?disabled=${e.disabled}>
                <slot>${o} ${r} ${i}</slot>
            </button>
        `}});function Ag(e,t,n={behavior:"smooth"}){let r=2;const o=t==="up"||t==="down"?"y":"x",i=t==="right"||t==="down"?"+":"-",a=o==="x"?e.scrollWidth-e.offsetWidth:e.scrollHeight-e.offsetHeight,s=ds(e)[o];i==="-"&&(r*=-1);const l=e[o==="x"?"scrollLeft":"scrollTop"]+r,c=s.filter(h=>i==="+"?h>l:h<l).sort((h,m)=>i==="+"?h-m:m-h);let f;return c.length>0?f=c[0]:i==="+"?f=a:f=0,e.scrollTo({...n,[o==="x"?"left":"top"]:f})}function $g(e){const t=window.getComputedStyle(e),n=e.getBoundingClientRect();let r=t.getPropertyValue("scroll-padding-left").replace("auto","0px"),o=t.getPropertyValue("scroll-padding-top").replace("auto","0px"),i=t.getPropertyValue("scroll-padding-right").replace("auto","0px"),a=t.getPropertyValue("scroll-padding-bottom").replace("auto","0px");function s(m,g){let w=parseFloat(m);return/%/.test(m)&&(w/=100,w*=g),w}let l=s(r,n.width),c=s(o,n.height),f=s(i,n.width),h=s(a,n.height);return{x:{before:l,after:f},y:{before:c,after:h}}}function Cg(e,t,n="both"){return n==="x"&&e.right>=t.left&&e.left<=t.right||n==="y"&&e.bottom>=t.top&&e.top<=t.bottom||n==="both"&&e.right>=t.left&&e.left<=t.right&&e.bottom>=t.top&&e.top<=t.bottom}function n0(e){let t=[];for(const n of e.children)t=t.concat(n,n0(n));return t}function Sg(e,t=!0){const n=e.getBoundingClientRect(),r={x:{start:[],center:[],end:[]},y:{start:[],center:[],end:[]}},o=n0(e);for(const i of["x","y"]){const a=i==="x"?"y":"x",s=i==="x"?"left":"top",l=i==="x"?"width":"height",c=i==="x"?"scrollLeft":"scrollTop";for(const f of o){const h=f.getBoundingClientRect();if(t&&!Cg(n,h,a))continue;const m=window.getComputedStyle(f);let[g,w]=m.getPropertyValue("scroll-snap-align").split(" ");typeof w>"u"&&(w=g);const k=i==="x"?w:g,x=h[s]-n[s]+e[c];switch(k){case"none":break;case"start":r[i].start.push(x);break;case"center":r[i].center.push(x+h[l]/2);break;case"end":r[i].end.push(x+h[l]);break}}}return r}function ds(e){const t=e.getBoundingClientRect(),n=$g(e),r=Sg(e),o={x:e.scrollWidth-e.offsetWidth,y:e.scrollHeight-e.offsetHeight},i=(a,s)=>l=>Math.max(a,Math.min(s,l));return{x:Zl([...r.x.start.map(a=>a-n.x.before),...r.x.center.map(a=>a-t.width/2),...r.x.end.map(a=>a-t.width+n.x.after)].map(i(0,o.x))),y:Zl([...r.y.start.map(a=>a-n.y.before),...r.y.center.map(a=>a-t.height/2),...r.y.end.map(a=>a-t.height+n.y.after)].map(i(0,o.y)))}}function Zl(e){return Array.from(new Set(e))}const so="templates-container",Tg=4e3;var ka=(e=>(e.Default="default",e.Banner="banner",e))(ka||{});const Ie=ie()({tagName:"toniq-carousel",hostClasses:{"toniq-carousel-banner-variant":({inputs:e})=>e.variant==="banner"},stateInitStatic:{currentScrollPosition:{left:0,right:1/0},scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({hostClasses:e})=>p`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
    ...
    `,renderCallback({inputs:e}){function t(r){if(e.linkType==="disabled"){r.preventDefault();return}e.linkType==="route-link"&&Wo(r)&&(r.preventDefault(),e.scrollToTop&&window.scrollTo(0,0))}const n=e.linkType==="new-tab";return u`
            <a
                href=${e.url.toString()}
                ${y("click",t)}
    ...
    `,events:{viewMoreButtonClick:oe(),flipCardButtonClick:oe()},renderCallback({inputs:e,dispatch:t,events:n}){const r=e.socialUrls,o=r?le(r).map(i=>{const a=r[i];if(!a)return;const s=_d[i];return u`
    ...
    `,renderCallback({inputs:e,state:t,updateState:n,host:r,dispatch:o,events:i}){var m,g,w,k;const a=e.mainImageSize||Ia,s=ah(a);vo({onElement:r,forCssVar:ot["main-image-size"],toValue:`${a}px`}),vo({onElement:r,forCssVar:ot["secondary-image-size"],toValue:`${s}px`});const l=["View",e.viewButtonTitle].filter(we).join(" "),c=u`
            <h3>${e.cardTitle}</h3>
            ...
            >
                <div class="card-face front" slot="front">
                    ...
                    <div class="all-images">
                        ...
                        <div class="secondary-images">
                            ${e.imageUrls.slice(1).map(x=>{var C;return u`
                                    <div class="secondary-image-wrapper">
                                        ${((C=e.customTemplateCallback)==null?void 0:C.call(e,x))||u`
                ...
                <div class="card-face back" slot="back">
                    ...
                    <div class="paragraphs">
                        ${(w=e.infoParagraphs)==null?void 0:w.map(x=>u`
                                <p>${x}</p>
                            `)}
                    </div>
    ...
    `,renderCallback({inputs:e}){return e.level==="h1"?u`
        ...
        `,renderCallback({inputs:e,dispatch:t,events:n}){const{filtered:r}=Bc({value:e.value??"",allowed:e.allowedInputs,blocked:e.blockedInputs}),o=e.icon?u`
                  <${$.assign({icon:e.icon})}></${$}>
              `:"";return u`
            <label>
                ${o}
                <input
                    ...
                    ?disabled=${e.disabled}
                    .value=${r}
                    ${y("input",i=>{if(!(i instanceof InputEvent))throw new Error(`Input event type mismatch: "${i.constructor.name}"`);const a=i.target;if(!(a instanceof HTMLInputElement))throw new Error("Failed to find input element target from input event.");const s=i.data,l=r;let c=a.value??"";if(s)if(s.length===1)sh({value:s,allowed:e.allowedInputs,blocked:e.blockedInputs})||(c=l,t(new n.inputBlock(s)));else{const{filtered:f,blocked:h}=Bc({value:s,allowed:e.allowedInputs,blocked:e.blockedInputs});c=f,t(new n.inputBlock(h))}a.value!==c&&(a.value=c),l!==c&&t(new n.valueChange(c))})}
                    placeholder=${e.placeholder}
                />
                ${ye(!!e.suffix,u`
                        <div class="suffix">${e.suffix}</div>
    ...
    `,renderCallback:({inputs:e})=>u`
        ...
        `}),Lc="...";function i5(e,t,n=7,r=5){let o;e=wn({value:e,min:1,max:t}),n=wn({value:n,min:r,max:t});const i=n-5,a=n-3;t<=n?o=n:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>n?ji(t-o,t):e>o?ji(Math.min(s.start,t-o),Math.min(s.end,t)):ji(1,Math.min(t,o+1));function c(h,m){return l.length+1!==t?m:[h]}const f=l[l.length-1];if(f&&f<t){const h=c(t,[Lc,t]);return[...l,...h]}else return l[0]!==1?c(1,[1,Lc]).concat(l):l}function ji(e,t){const n=t-e+1;return Array.from({length:n},(r,o)=>e+o)}const Hi=ie()({tagName:"toniq-pagination",styles:p`
        :host {
            display: flex;
        }
    ...
    `,events:{pageChange:oe()},renderCallback({inputs:e,events:t,dispatch:n}){return e.pageCount<=1?u``:u`
                <button
                ...
                ${i5(e.currentPage,e.pageCount,e.pagesShown).map(r=>typeof r=="string"?u`
    ...
    `,stateInitStatic:{canScroll:!1,debouncedResize:ff(()=>Rh(ar.FirstThenWait,{milliseconds:30})),rowStyles:{},isPainting:!1,itemsPainted:0},initCallback({inputs:e,state:t,updateState:n}){const r=e.columns.filter(o=>!o.disabled);n({rowStyles:r.reduce((o,i)=>(o[i.key]={width:void 0,left:void 0},o),t.rowStyles)})},renderCallback({inputs:e,state:t,updateState:n,events:r,dispatch:o}){var h;const i=e.columns.filter(m=>!m.disabled),a=[e.rows[0],...e.rows].filter(we);function s(m){m instanceof HTMLElement&&t.debouncedResize(()=>{n({canScroll:m.scrollWidth>m.clientWidth})})}const l=e.pagination&&((h=e.pagination)==null?void 0:h.pageCount)>1?u`
                      <${Hi.assign({currentPage:e.pagination.currentPage,pageCount:e.pagination.pageCount})}
                          class=${he({"blocked-pagination":!!e.showLoading})}
                          ${y(Hi.events.pageChange,m=>{o(new r.pageChange(m.detail))})}
                      ></${Hi}>
                  `:_;function c(m,g){return u`
                <div
                    class="row-wrapper"
                        ...
                        `;return u`
                            ...
                            >
                                <div
                                    ...
                                    ${ia(fe=>{var lt,vt;const X=fe.closest(".table-list"),V=X==null?void 0:X.getBoundingClientRect().left,ne=X==null?void 0:X.querySelectorAll(".row-item")[k],$e=ne==null?void 0:ne.getBoundingClientRect().left,ve=fe.getBoundingClientRect().width;(!((lt=t.rowStyles[w.key])!=null&&lt.width)||ve>((vt=t.rowStyles[w.key])==null?void 0:vt.width))&&n({rowStyles:{...t.rowStyles,[w.key]:{width:ve,left:V?$e-V:$e}}}),n({itemsPainted:t.itemsPainted+1})})}
                                >
                                    ${x}
                                </div>
                                ${ye(g===0,u`
        ...
        `}});async function a5(e){return navigator.clipboard.writeText(e)}const s5="…";function l5(e,t){const n=e.slice(0,t).trim(),r=e.slice(-1*t).trim();return`${n}${s5}${r}`}function c5(e){return!(e%1)}function u5(e){return e.letterCount==null?4:c5(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const O=ie()({tagName:"toniq-middle-ellipsis",events:{copy:oe()},cssVars:{"toniq-middle-ellipsis-text-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":b.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":b.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>p`
        :host {
            /* 5 frames at 60 fps */
            transition: ${K.interaction};
            ${D.paragraphFont};
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:n,state:r,updateState:o}){if(!e.text)return u``;const i=e.text,a=u5(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,f=c?l5(i,a):i,h=c?i:"",m=s?Dd:l?Od:void 0,g=m?u`
                  <${$.assign({icon:m})}></${$}>
              `:"",w=u`
        ...
        `;return f?s?u`
                ...
                `:l?u`
                    <button
                        ...
                        ${y("click",async()=>{await a5(i),t(new n.copy),r.showCopiedTextTimeoutId!=null&&window.clearTimeout(r.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${w} ${g}
                    </button>
                `:u`
                    ${w}
                `:u``}}),jn=ie()({tagName:"toniq-progress",cssVars:{"toniq-progress-width":"0%"},styles:({cssVars:e})=>p`
        :host {
            position: relative;
            width: 100%;
            display: inline-block;
    ...
    `,renderCallback({inputs:e,cssVars:t,host:n}){const r=wn({value:e.percent,max:100,min:0}),o=`${r}%`;return vo({forCssVar:t["toniq-progress-width"],onElement:n,toValue:o}),n.setAttribute("title",`${o} finished`),r?u`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:ru()})},renderCallback({inputs:e,dispatch:t,events:n,state:r}){return d5(e.entries).map(i=>h5(e.groupName||r.randomGroupName,e.value,i,()=>{t(new n.valueChange(i.value))}))}});function d5(e){const t=Object.fromEntries(e.map(r=>[r.value,r]));return Object.values(t).length!==e.length&&console.error(`${J.tagName} was given duplicate entry values.`),Object.values(t)}function h5(e,t,n,r){const o=t===n.value,i=u`
    ...
    `}function Wi(e,t){const n=e[0],r=e[e.length-1];if(n==null||r==null)return 0;if(t<n)return n;if(t>r)return r;const o=e.findIndex((c,f)=>{const h=e[f+1];return h==null?!0:c<=t&&h>=t});if(o<0)return n;const i=e[o];if(i==null)return n;const a=e[o+1];if(a==null)return i;const s=t-i,l=a-t;return s<l?o:o+1}function f5(e,t,n=100){e>t&&([e,t]=[t,e]),n<2&&(n=2);let r=p5(e);const o=[e];for(;r<t;){const i=Math.pow(10,String(r).length-1),a=r+i;a<t&&o.push(a),r=a}return o.push(t),o.length>n&&(qc(o,n),o.length>n&&qc(o,n)),o}function qc(e,t){const n=e.length-t,r=(e.length-2)/n;for(let o=e.length-2;o>=1;o-=r)e.splice(Math.floor(o),1)}function p5(e){let t=1;if(!e)return e;e<0&&(t=-1,e=e*-1);const n=e.toFixed(0),r=Math.pow(10,n.length-1),o=Number(n[0]||1);return r*o*t}const B={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},Hn={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"},or={hot:"rgb(200,0,0)",medium:"orange",cold:"rgb(0,200,0)"};function ln(e){return p`
        background-color: ${T(or[e])};
        color: ${T(or[e])};
    `}function m5(e){var r,o;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${B.lowerLabelWrapper} .${B.labelPercentMarginWrapper}`),n=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${B.upperLabelWrapper} .${B.labelPercentMarginWrapper}`);if(n instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),a=n.getBoundingClientRect();return{lower:i,upper:a}}else return}function g5(e,t=8){const n=m5(e);if(!n)return 0;const r=n.lower.right-n.upper.left+t;return Math.max(0,r)}function zi({value:e,limits:t,flip:n}){const o=(t.max-e)/(t.max-t.min)*100;return-(n?100-o:o)}function yr(e){return ze(e)&&e.min!==void 0&&e.max!==void 0}function qa(e){var n;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${B.range}`);return(t==null?void 0:t.clientWidth)??0}function Zi(e,t,n){return`${n?o1(e):e} ${t}`}function w5({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function v5({value:e,double:t,min:n,max:r}){return t?yr(e)?{min:wn({value:e.min,min:n,max:Math.min(e.max,r)}),max:wn({value:e.max,min:Math.max(e.min,n),max:r})}:{min:n,max:r}:yr(e)?n:wn({value:e,min:n,max:r})}function b5({actualValue:e,actualLimits:t,logScale:n,logRange:r}){return n?{elementValue:yr(e)?{min:Wi(r,e.min),max:Wi(r,e.max)}:Wi(r,e),elementLimits:{min:0,max:r.length-1}}:{elementValue:e,elementLimits:t}}function Gi(e,t,n){return n?t[e]||0:e}function y5(e){return{actualLimits:w5(e),actualValue:v5(e)}}function k5(e,t){var r,o,i;let n=!1;if(yr(e)){const a=(r=t.shadowRoot)==null?void 0:r.querySelector(`.${B.lowerSlider}`),s=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${B.upperSlider}`);a instanceof HTMLInputElement&&s instanceof HTMLInputElement&&(Number(a.value)!==e.min&&(a.value=String(e.min),n=!0),Number(s.value)!==e.max&&(s.value=String(e.max),n=!0))}else{const a=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${B.slider}`);a instanceof HTMLInputElement&&Number(a.value)!==e&&(a.value=String(e),n=!0)}return n}function lh(e,t){const{actualValue:n,actualLimits:r}=y5({...e}),o=f5(r.min,r.max),i=e.logScale??!1,a=e.suffix??"",{elementValue:s,elementLimits:l}=b5({actualValue:n,actualLimits:r,logScale:i,logRange:o}),c=qa(t);return{actualValue:n,elementLimits:l,elementValue:s,isLogScale:i,logRange:o,rangeWidth:c,suffix:a}}const Ut=16,Pc=p`
    ${Ut}px
`,Oc=p`
...
`,Dc=p`
    transform: scale(1.2);
`;function x5(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Qn(e){requestAnimationFrame(()=>{const t=lh(e.instanceInputs,e).elementValue;k5(t,e)&&(e.setAttribute("disabled","true"),Qn(e))})}const R=ie()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:oe()},styles:p`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Qn(e)}),e.addEventListener("keydown",()=>{Qn(e)}),e.addEventListener("keyup",()=>{Qn(e)})},renderCallback({inputs:e,host:t,events:n,dispatch:r,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:f,elementLimits:h,rangeWidth:m}=lh({...e},t);if(Qn(t),yr(f))return g(a,f,h);return k(a,f,h);function g(x,C,S){const N={left:Vt((m-Ut)*(C.min-S.min)/(S.max-S.min)+Ut/2),right:Vt((m-Ut)*(S.max-C.max)/(S.max-S.min)+Ut/2)},W=Zi(x.min,c,l),te=Zi(x.max,c,l);requestAnimationFrame(()=>{const ve=g5(t);ve!==o.labelOverlap&&i({labelOverlap:ve})});const fe=(S.max-C.max)/(S.max-S.min)>.5,X=zi({value:C.min,limits:{min:S.min,max:C.max},flip:!0}),V=zi({value:C.max,limits:{min:C.min,max:S.max},flip:!1}),ne=o.labelOverlap&&fe?o.labelOverlap:0,$e=o.labelOverlap&&!fe?o.labelOverlap:0;return u`
                <div
                    class="range"
                    ${$n(()=>{i({rangeWidth:qa(t)})})}
                >
                    ...
                    <div class="slider-wrapper">
                        <input
                            ...
                            .max=${S.max}
                            .value=${C.min}
                            ${y("input",ve=>{const lt=ve.target,vt={...x,min:Gi(Number(lt.value),s,l)};w(vt)})}
                        />
                        <input
                            ?disabled=${e.disabled??!1}
                            type="range"
                            ...
                            .value=${C.max}
                            ${dn(Hn.slider)}
                            ${y("input",ve=>{const lt=ve.target,vt={...x,max:Gi(Number(lt.value),s,l)};w(vt)})}
                        />
                    </div>
                </div>
            `}function w(x){i({internalValue:x}),e.disabled||r(new n.valueChange(x))}function k(x,C,S){const N=Vt((m-Ut)*(S.max-C)/(S.max-S.min)+Ut/2),W=Zi(x,c,l),te=zi({value:C,limits:S,flip:!1});return u`
                <div
                ...
                >
                    ...
                    <input
                        ?disabled=${e.disabled??!1}
                        type="range"
                        class="${B.slider} ${e.colorTemperature?x5(Math.abs(te)):""}"
                        step=${e.step}
                        .min=${S.min}
                        .max=${S.max}
                        .value=${C}
            ...
            `}}});var ch=(e=>(e.Default="default",e.TextOnly="text-only",e))(ch||{});const Yi=ie()({tagName:"toniq-toggle-button",hostClasses:{"toniq-toggle-button-text-only":({inputs:e})=>e.variant==="text-only","toniq-toggle-button-disabled":({inputs:e})=>!!e.disabled},styles:({hostClasses:e})=>p`
        :host {
            ${D.boldParagraphFont};
            ${Ze};
            display: inline-flex;
    ...
    `,renderCallback({inputs:e,dispatch:t,events:n}){const r=e.tabs.map(o=>{var l;const i=o.value===e.value,a=o.icon?u`
                ...
                >
                    <${Je.assign({url:((l=o.link)==null?void 0:l.url)||"",linkType:pt.RouteLink})}
                        ...
                        ${y("click",c=>{var f;i||Wo(c)&&((f=o.link)!=null&&f.route&&t(new n.routeChange(o.link.route)),t(new n.valueChange(o.value)))})}
                    >
        ...
        `}}),uh=U({title:"Data",parent:void 0}),Oo=ie()({tagName:"toniq-icon-book-viewer",styles:p`
        :host {
            display: inline-flex;
            padding: 8px;
            border-radius: 8px;
    ...
    `,renderCallback({inputs:e}){return u`
            <${$.assign({icon:e.icon})}></${$}>
        `}}),ti=Object.values(At).reduce((e,t)=>(t.forEach(n=>{if(n.name in e)throw new Error(`Icon name duplicate: '${n.name}'`);e[n.name]=n}),e),{}),A5=Object.keys(ti).sort();function ks(e){return{controlType:j.Dropdown,initValue:e,options:["None",...A5]}}const dh={"CSS color":{controlType:j.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:j.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:j.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:j.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:j.Number,initValue:2}};function ho(e){return Object.entries(e).filter(([,n])=>n!==""&&n!=null).map(([n,r])=>(n.toLowerCase()==="css color"&&(n="color"),ee(r,"number")&&(r=Oa({value:r,suffix:"px"})),`${n}: ${r};`)).join(`
`)}const $5=U({title:"Social Urls",parent:uh,elementExamplesCallback({defineExample:e}){function t({socialName:n,icon:r}){e({title:n,renderCallback(){return u`
                        <${Oo.assign({icon:r})}></${Oo}>
                    `}})}Object.entries(_d).forEach(([n,r])=>{t({socialName:n,icon:r})})}}),ae=U({title:"Elements",parent:void 0}),C5=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:p`
            ${Yt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],S5=U({title:Yt.tagName,parent:ae,elementExamplesCallback({defineExample:e}){C5.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:p`
                    .bold {
                        ${D.boldFont}
                    }
...
`,M5=U({parent:ae,title:Ie.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:Nc,renderCallback(){return u`
                    ...
                    <${Ie.assign({enableAutomaticCycling:!0,templates:At["core-24"].map(t=>{const n=p`
                            ...
                            `;return u`
                                <${$.assign({icon:t})} style=${n}></${$}>
                            `})})}></${Ie}>
                    <${Ie.assign({enableAutomaticCycling:!0,cycleIntervalMs:1e3,templates:At["core-24"].map(t=>{const n=Gh({min:0,max:150}),r=p`
                                padding: 100px ${n}px;
                                border: 1px solid ${b.pageInteraction.foregroundColor};
                                border-radius: 12px;
                            `;return u`
                ...
                `}}),e({title:"banner style",styles:Nc,renderCallback(){const t=p`
                    ...
                    border-radius: 12px;
                `;return u`
                    <${Ie.assign({enableAutomaticCycling:!0,variant:ka.Banner,templates:At["core-24"].map(n=>u`
                                <div style=${t}>
                                    <${$.assign({icon:n})}></${$}>
                                </div>
                            `)})}></${Ie}>
                    <${Ie.assign({enableAutomaticCycling:!0,variant:ka.Banner,templates:[At["core-24"][0]].map(n=>u`
                                <div style=${t}>
                                    <${$.assign({icon:n})}></${$}>
                                </div>
                            `)})}
                    ...
                    ></${Ie}>
                `}})}});function E5(e){const t=Object.keys(e.cssVars).map(n=>[`--${n}`,{controlType:j.Color,initValue:""}]);return Object.fromEntries(t)}function I5(e){const t=Object.entries(e).map(([n,r])=>{if(n.startsWith("--"))return typeof r!="string"||!r?void 0:`${n}: ${r};`}).filter(we);return T(t.join(`
`))}const B5=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],Qi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],L5=U({parent:ae,title:bt.tagName,controls:{Text:{controlType:j.Text,initValue:"Text"},...E5(bt)},elementExamplesCallback({defineExample:e}){B5.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:Qi.map(n=>!!n.inputs.checked),extraEntryStatuses:Qi.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:p`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Qi.map((i,a)=>{const s=(i.extraEntries??[]).map((c,f)=>{var h;return u`
                                    <${bt.assign({...t.inputs,...sr(i.inputs,["checked"]),checked:!!((h=n.extraEntryStatuses[a])!=null&&h[f]),text:c})}
                            ...
                            <div class="checkbox-group" style=${l}>
                                <${bt.assign({...t.inputs,...sr(i.inputs,["checked"]),checked:n.checkedStatuses[a],text:o.Text})}
                                    ${y(bt.events.checkedChange,()=>{const c=[...n.checkedStatuses];c[a]=!c[a],r({checkedStatuses:c})})}
                                ></${bt}>
                                ${s}
                            </div>
                        `})}})})}}),q5=U({parent:ae,title:Mi.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Et}},{inputs:{icon:Et}},{inputs:{},template:u`
                    HTML child
                `},{inputs:{icon:Et},template:u`
                    HTML child
                `},{customStyle:p`
                    width: 150px;
                    height: 24px;
                `,inputs:{text:"custom size"}}];[{title:"default",inputs:{variant:Zn.Default}},{title:"secondary style",inputs:{variant:Zn.Secondary}},{title:"warning style",inputs:{variant:Zn.Warning}},{title:"danger style",inputs:{variant:Zn.Danger}}].forEach(r=>{e({title:r.title,renderCallback(){return t.map(o=>u`
                        <${Mi.assign({...r.inputs,...o.inputs})}
                            style=${o.customStyle}
                        >${ye(!!o.template,o.template)}</${Mi}>
                    `)}})})}}),P5=U({title:Ri.tagName,parent:ae,descriptionParagraphs:["Display a date and / or time in a consistent manner."],elementExamplesCallback({defineExample:e}){const t=oh();[{title:"date and time",inputs:{fullDate:t,parts:{date:!0,time:!0}}},{title:"date only",inputs:{fullDate:t,parts:{date:!0,time:!1}}},{title:"time only",inputs:{fullDate:t,parts:{date:!1,time:!0}}},{title:"relative past date",inputs:{fullDate:Ni(t,{weeks:-1}),parts:{date:!0,time:!0},relativeOptions:{tryRelative:!0}}},{title:"relative future date",inputs:{fullDate:Ni(t,{months:1}),parts:{date:!0,time:!0},relativeOptions:{tryRelative:!0}}},{title:"relative forced unit",inputs:{fullDate:Ni(t,{days:-2}),parts:{date:!0,time:!0},relativeOptions:{tryRelative:!0,blockedRelativeUnits:[I.Days,I.Hours]}}}].forEach(r=>{e({title:r.title,renderCallback(){return u`
                        <${Ri.assign({...r.inputs})}></${Ri}>
                    `}})})}}),Xr=[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3},{label:"Really really super duper long option",value:4}],O5=[{title:"default"},{title:"transparent background",customStyle:p`
        ...
        `},{customStyle:p`
            max-height: 30px;
            min-height: 30px;
        `}],D5=U({title:Kr.tagName,parent:ae,controls:{Selected:{controlType:j.Dropdown,initValue:Xr[0].label,options:Xr.map(e=>e.label)},Direction:{controlType:j.Dropdown,initValue:"Down",options:Xc(Ea)},Icon:ks(Bd.name),Prefix:{controlType:j.Text,initValue:"Sort by: "},"Force open":{controlType:j.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){O5.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Rc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:p`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return Rc.map((i,a)=>{const s=p`
                        ...
                        `;return u`
                            <${Kr.assign({...t.inputs,...i.inputs,options:Xr,value:n.selected[a]??Xr.find(l=>l.label===o.Selected),icon:ti[o.Icon],selectedLabelPrefix:o.Prefix,direction:Ea[o.Direction],_forceOpenState:o["Force open"]||void 0})}
                                style=${s}
                                ${y(Kr.events.selectChange,l=>{const c=[...n.selected];c[a]=l.detail,r({selected:c})})}
                            ></${Kr}>
                        `})}})})}}),N5=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],R5=U({title:Fi.tagName,parent:ae,elementExamplesCallback({defineExample:e}){N5.forEach(t=>{e({title:t.title,renderCallback(){return u`
                        <${Fi}>${t.content}</${Fi}>
                    `}})})}}),Fc="/toniq-labs-design-system";function hh(...e){const n=[globalThis.location.pathname.startsWith(Fc)?Fc:"",...e].filter(we);return lr(...n)}const cn=Array(30).fill(hh("/toniq-labs-logo.png")),mn=["Hello there.","There is stuff here."],_r=mn.concat(Array(30).fill(mn)),F5=U({title:re.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${re.assign({infoParagraphs:_r,imageUrls:cn,socialUrls:xg,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${re}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${re.assign({imageUrls:cn,infoParagraphs:mn,cardTitle:"With custom Template",customTemplateCallback(t){return u`
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${re.assign({imageUrls:cn.map((t,n)=>n%2?"/invalid-image.png":t),infoParagraphs:mn,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return u`
                            ...
                            `}})}></${re}>
                `}})}}),j5=U({title:Gt.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:p`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:n}){return u`
                ...
                `}})}}),H5=U({title:Ee.tagName,parent:ae,elementExamplesCallback({defineExample:e}){_c(hn).forEach(t=>{e({title:t,renderCallback(){return u`
            ...
            `,renderCallback({controls:n}){return t.map(r=>u`
                ...
                `;return At["third-party-brands"].map(o=>u`
                        <${$.assign({icon:o})}
                            style=${ho(n)}
                        ></${$}>
                        <${$.assign({icon:o})}
            ...
            `,renderCallback({controls:n}){return u`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            ...
                            ></${Jr}>
                        `))}})})}});function ni({entries:e,columns:t,createRowObject:n}){const r=Object.fromEntries(t.map(i=>[i.key,""]));return{rows:e.map((i,a)=>{const s=n(i,a);if(!it(Object.keys(r).sort(),Object.keys(s.cells).sort()))throw console.error("broken list table row",{cells:s.cells,columns:r}),new Error("List table row keys does not match expect column keys.");return s}),columns:t}}const fh="https://cdn-bitcoin.bioniq.io",z5=lr(fh,"content"),Z5=lr(fh,"thumbnail"),gn={thumbnail(e){return lr(Z5,e)},content(e){return lr(z5,e)}},G5=Array(5).fill({imageUrl:gn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:u`
        <div
            style=${p`
                display: flex;
                gap: 8px;
    ...
    `}),Y5=[{imageUrl:gn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Payment Sent",price:u`
            <div
                style=${p`
                    display: flex;
                    gap: 8px;
        ...
        `},{imageUrl:gn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Transfer",price:u`
            -
        `,from:u`
            <${O.assign({text:"QP6Wqf97r0ydgw9yxfmptu4krqjgy49kx7m5g3K14U",copyOnClick:!0})}
                style=${p`
        ...
        `},{imageUrl:gn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Accept Offer",price:u`
            -
        `,from:u`
            <${O.assign({text:"QP6Wqf97r0ydgw9yxfmptu4krqjgy49kx7m5g3K14U",copyOnClick:!0})}
                style=${p`
        ...
        `},{imageUrl:gn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Cancel Listing",price:u`
            -
        `,from:u`
            <${O.assign({text:"QP6Wqf97r0ydgw9yxfmptu4krqjgy49kx7m5g3K14U",copyOnClick:!0})}
                style=${p`
        ...
        `}],Q5=[],K5=Array(5).fill({imageUrl:gn.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:u`
        <div
            style=${p`
                display: flex;
                gap: 8px;
    ...
    `}),Ki=ni({entries:G5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE",mobile:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:u`
                    <img
                        style=${p`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),jc=ni({entries:Y5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:u`
                    <img
                        style=${p`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),J5=ni({entries:Q5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:u`
                    <img
                        style=${p`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),X5=ni({entries:K5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME",style:p`
                display: flex;
                justify-content: flex-end;
            `}],createRowObject:e=>({cells:{image:u`
                    <img
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),_5=[{title:"basic"},{title:"with pagination",inputs:{pagination:{currentPage:1,pageCount:10}}},{title:"squished horizontally",styles:p`
            :host {
                width: 200px;
            }
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Hc=us({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const n=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(n)}})}},cleanupCallback({state:e,updateState:t}){var n;(n=e.cleanup)==null||n.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),ev=U({title:Ne.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return u`
                    <${Ne.assign(X5)}></${Ne}>
                `}}),e({title:"takes time to load",stateInitStatic:{tableInputs:{...J5,showLoading:!0,pagination:{currentPage:1,pageCount:5}}},renderCallback({state:t,updateState:n}){return setTimeout(()=>{n({tableInputs:{...t.tableInputs,...jc,showLoading:!1}})},5e3),u`
                    <${Ne.assign(t.tableInputs)}
                        ${y(Ne.events.pageChange,r=>{n({tableInputs:{...t.tableInputs,...jc,pagination:{currentPage:2,pageCount:5}}})})}
                    ></${Ne}>
                `}}),_5.forEach(t=>{var n,r;e({title:t.title,styles:p`
                    ${T(t.styles)}
                `,stateInitStatic:{currentPage:(r=(n=t.inputs)==null?void 0:n.pagination)==null?void 0:r.currentPage},renderCallback({state:o,updateState:i}){var s;const a=(s=t.inputs)!=null&&s.pagination&&o.currentPage?{pagination:{...t.inputs.pagination,currentPage:o.currentPage}}:{};return u`
            ...
            `,stateInitStatic:{tableInputs:{...Ki,rows:Ki.rows.map(t=>({...t,cells:{...t.cells,date:u`
                                    <${Hc}></${Hc}>
                                `}}))}},renderCallback({state:t}){return u`
                    <${Ne.assign(t.tableInputs)}></${Ne}>
                `}})}}),tv=U({title:rr.tagName,parent:ae,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:nr.Small}},{title:"large",inputs:{size:nr.Large}},{title:"whole page",inputs:{size:nr.WholePage},styles:p`
                    :host {
                        width: 500px;
                    }
                `}].forEach(n=>{e({title:n.title,styles:n.styles??p``,renderCallback(){return u`
                        <${rr.assign(n.inputs)}></${rr}>
                    `}})})}}),nv=U({title:O.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
            ...
            `,renderCallback(){return u`
                ...
                `}})}}),rv=U({title:jn.tagName,parent:ae,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:p`
                ${jn} {
                    height: 32px;
                }
                ...
                :`,percent:75}].forEach(n=>{e({title:n.title,styles:n.styles,renderCallback(){return u`
                        <${jn.assign({percent:n.percent})}></${jn}>
                    `}})})}}),Un=[{value:"1",label:"Entry 1"},{value:"2",label:"Entry 2"},{value:"3",label:"Entry 3"}],De={basic:Un,longText:[{value:"first",label:"Entry 1 with really really really really really really really really really long label"},...Un.slice(1)],disabled:[{...Un[0],disabled:!0},...Un.slice(1)],noLabels:Th(Un,e=>({...e,label:void 0}))},ov=U({title:J.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{selectedValue:De.basic[0].value},renderCallback({state:t,updateState:n}){return u`
            ...
            `,renderCallback({state:t,updateState:n}){return u`
                    <${J.assign({entries:De.longText,value:t.selectedValue})}
                        ${y(J.events.valueChange,r=>{n({selectedValue:r.detail})})}
                    ></${J}>
                `}}),e({title:"No labels",stateInitStatic:{selectedValue:De.noLabels[0].value},renderCallback({state:t,updateState:n}){return u`
                    <${J.assign({entries:De.noLabels,value:t.selectedValue})}
                        ${y(J.events.valueChange,r=>{n({selectedValue:r.detail})})}
                    ></${J}>
                `}}),e({title:"Entry 1 disabled",stateInitStatic:{selectedValue:De.disabled[1].value},renderCallback({state:t,updateState:n}){return u`
...
`,Ji={min:10,max:50},iv=U({title:R.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:p`
                ${rt}
            `,renderCallback({state:t,updateState:n}){return u`
            ...
            `,renderCallback({state:t,updateState:n}){return u`
                    <${R.assign({value:t.value,colorTemperature:!0,min:0,max:100})}
                        ${y(R.events.valueChange,r=>{if(typeof r.detail!="number")throw new Error("was expecting a single numeric slider value");n({value:r.detail})})}
                    ></${R}>
                `}})}}),av=[{title:"default",inputs:{}},{title:"text only",inputs:{variant:ch.TextOnly}},{title:"disabled",inputs:{disabled:!0}}],Uc=[{inputs:{icon:void 0}},{inputs:{toggled:!0}},{inputs:{}},{inputs:{text:void 0}}],sv=U({title:Yi.tagName,parent:ae,controls:{Text:{controlType:j.Text,initValue:"Toggle Button"},Icon:ks(Nd.name)},elementExamplesCallback({defineExample:e}){av.forEach(t=>{e({title:t.title,stateInitStatic:{buttonStates:Uc.map(n=>!!n.inputs.toggled)},styles:p`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                    }
                `,renderCallback({state:n,updateState:r,controls:o}){return Uc.map((i,a)=>u`
                            ...
                            ></${Yi}>
                        `)}})})}}),lv=U({parent:ae,title:uo.tagName,elementExamplesCallback({defineExample:e}){function t({title:n,tooltipContent:r,forceShow:o}){e({title:n,styles:p`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),cv=U({parent:ae,title:ir.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${uo.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return u`
                    <${ir}>This is a tooltip.</${ir}>
                `}})}}),uv=[lv,cv],dv=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:p`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:p``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:p``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:ba},{label:"label here",value:2,icon:ba},{label:"",value:3,icon:Et,disabled:!0},{label:"16px icon",value:4,icon:Et},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],hv=U({title:Kn.tagName,parent:ae,elementExamplesCallback({defineExample:e}){dv.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:p`
                ...
                `,renderCallback({state:n,updateState:r}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return u`
                        ...
                        ></${Kn}>
                    `}})})}}),ph=U({title:"Icons",parent:void 0,controls:dh}),fv=Object.entries(At).map(([e,t])=>U({title:e,parent:ph,elementExamplesCallback({defineExample:n}){t.map(r=>n({title:r.name,renderCallback({controls:o}){return u`
                                <${Oo.assign({icon:r})}
                                    style=${ho(o)}
                                ></${Oo}>
                            `}}))}}));function mh(e){const t=pv(e),n=ke(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return le(n).reduce((o,i)=>{const a=n[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function pv(e){typeof e!="string"&&(e=String(e));const r=`{"${Zc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(r);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${r}`),o}}const ri=U({title:"Styles",parent:void 0}),mv=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function gv(e,t,n){const r=mh(F(n));return e({title:t,styles:mv,renderCallback(){return u`
            ...
            `}})}const wv=U({title:"Colors",parent:ri,elementExamplesCallback({defineExample:e}){le(b).map(t=>gv(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),vv=p`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function bv(e,t,n){const r=mh(n);return e({title:t,styles:vv,renderCallback(){return u`
                ...
                <div class="css-vars">
                    ${le(r).map(o=>{const i=r[o];return u`
            ...
            `}})}const yv=U({title:"Fonts",parent:ri,elementExamplesCallback({defineExample:e}){le(D).map(t=>{const n=D[t];return bv(e,t,n)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),kv=U({title:"Shadows",parent:ri,elementExamplesCallback({defineExample:e}){$h(vr).forEach(([t,n])=>{e({title:t,styles:p`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return u`
                            <div></div>
                        `}})})}}),xv=[ae,ph,ri,uh],Av=[...fv,...uv,$5,S5,T5,M5,L5,q5,wv,P5,D5,R5,F5,j5,yv,H5,U5,V5,W5,tv,nv,rv,ov,kv,iv,sv,hv,ev].sort((e,t)=>e.title.localeCompare(t.title)),$v=[...xv,...Av];Vo({tagName:"toniq-design-system-app",styles:p`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return u`
            <${$i.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:$v,themeColor:"#00D093"})}>
