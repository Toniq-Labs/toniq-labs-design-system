...
`,Td=v({name:"LoaderAnimated24Icon",svgTemplate:c`
    ...
    `,events:{routeChange:ie()},renderCallback({inputs:e,dispatch:t,events:r}){var o,i;function n(a){e.route&&Go(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new r.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return c`
            ...
            `}}});const{defineElement:Ye,defineElementNoInputs:W5}=ns(),je=Ye()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>f`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `,renderCallback({inputs:e}){const t=e.flattenedNodes.map(r=>{if(!Rm(r,e.selectedPath))return;const n=f`
            ...
            `});return c`
            <${je.assign({route:Cr,router:e.router})}>
    ...
    `,renderCallback({inputs:e}){return(te(e.message,"array")?e.message:[e.message]).map(r=>c`
                <p>${r}</p>
            `)}}),vn=Ye()({tagName:"book-page-controls",events:{controlValueChange:ie()},hostClasses:{"book-page-controls-has-controls":({inputs:e})=>!!Object.keys(e.config).length},styles:({hostClasses:e})=>f`
        :host {
            display: flex;
            flex-wrap: wrap;
    ...
    `,renderCallback:({inputs:e})=>{const t=e.currentRoute.paths.slice(1);return t.length?t.map((r,n,o)=>{const i=n>=o.length-1,a=o.slice(0,n+1),s=i?"":c`
            ...
            `}):c`
                &nbsp;
            `}}),Si=Ye()({tagName:"book-breadcrumbs-bar",styles:f`
        :host {
    ...
    `,renderCallback({inputs:e}){const t=e.isTopLevel?c`
        ...
        `}}),Vn=Ye()({tagName:"book-element-example-controls",styles:f`
        :host {
            display: flex;
            color: ${Z["element-book-page-foreground-faint-level-1-color"].value};
...
`))}const O=(()=>{const e=f`
    ...
    `}),r2=v({name:"Tag48Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill=${d["toniq-icon-fill-color"].value}
            stroke=${d["toniq-icon-stroke-color"].value}
    ...
    `}),o2=v({name:"CircleDashes64Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),i2=v({name:"Rocket64Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${d["toniq-icon-stroke-color"].value}
            fill=${d["toniq-icon-fill-color"].value}
    ...
    `}),a2=v({name:"CryptoBtc16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),s2=v({name:"CryptoCkBtc16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),l2=v({name:"CryptoCkBtc24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
...
`,c2=v({name:"CryptoIcp16Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),u2=v({name:"CryptoIcp24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),d2=v({name:"WalletBitfinity24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),h2=v({name:"WalletBitfinity64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),f2=v({name:"WalletLeather24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),p2=v({name:"WalletLeather64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),m2=v({name:"WalletPlug24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),g2=v({name:"WalletPlug64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),w2=v({name:"WalletStoic24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),v2=v({name:"WalletStoic64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),b2=v({name:"WalletUnisat24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),y2=v({name:"WalletUnisat64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),k2=v({name:"WalletXverse24Icon",svgTemplate:c`
        <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    `}),x2=v({name:"WalletXverse64Icon",svgTemplate:c`
        <svg
            width="64"
            height="64"
            viewBox="0 0 64 64"
    ...
    `}),$2=v({name:"BrandFacebookLogo24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),C2=v({name:"BrandIcScan24Icon",svgTemplate:c`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),S2=v({name:"BrandInstagramFlat24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),T2=v({name:"BrandNftgeek24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),M2=v({name:"BrandTiktokFlat24Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${G["toniq-icon-fill-color"]("#000")}
    ...
    `}),E2=v({name:"BioniqRobot100Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),I2=v({name:"EntrepotLogo144Icon",svgTemplate:c`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `,renderCallback({inputs:e}){const t=e.iconPlacement??"left",r=e.icon?c`
        ...
        `}});function L2(e,t,r={behavior:"smooth"}){let n=2;const o=t==="up"||t==="down"?"y":"x",i=t==="right"||t==="down"?"+":"-",a=o==="x"?e.scrollWidth-e.offsetWidth:e.scrollHeight-e.offsetHeight,s=vs(e)[o];i==="-"&&(n*=-1);const l=e[o==="x"?"scrollLeft":"scrollTop"]+n,u=s.filter(h=>i==="+"?h>l:h<l).sort((h,m)=>i==="+"?h-m:m-h);let p;return u.length>0?p=u[0]:i==="+"?p=a:p=0,e.scrollTo({...r,[o==="x"?"left":"top"]:p})}function P2(e){const t=window.getComputedStyle(e),r=e.getBoundingClientRect();let n=t.getPropertyValue("scroll-padding-left").replace("auto","0px"),o=t.getPropertyValue("scroll-padding-top").replace("auto","0px"),i=t.getPropertyValue("scroll-padding-right").replace("auto","0px"),a=t.getPropertyValue("scroll-padding-bottom").replace("auto","0px");function s(m,g){let w=parseFloat(m);return/%/.test(m)&&(w/=100,w*=g),w}let l=s(n,r.width),u=s(o,r.height),p=s(i,r.width),h=s(a,r.height);return{x:{before:l,after:p},y:{before:u,after:h}}}function O2(e,t,r="both"){return r==="x"&&e.right>=t.left&&e.left<=t.right||r==="y"&&e.bottom>=t.top&&e.top<=t.bottom||r==="both"&&e.right>=t.left&&e.left<=t.right&&e.bottom>=t.top&&e.top<=t.bottom}function s0(e){let t=[];for(const r of e.children)t=t.concat(r,s0(r));return t}function D2(e,t=!0){const r=e.getBoundingClientRect(),n={x:{start:[],center:[],end:[]},y:{start:[],center:[],end:[]}},o=s0(e);for(const i of["x","y"]){const a=i==="x"?"y":"x",s=i==="x"?"left":"top",l=i==="x"?"width":"height",u=i==="x"?"scrollLeft":"scrollTop";for(const p of o){const h=p.getBoundingClientRect();if(t&&!O2(r,h,a))continue;const m=window.getComputedStyle(p);let[g,w]=m.getPropertyValue("scroll-snap-align").split(" ");typeof w>"u"&&(w=g);const $=i==="x"?w:g,x=h[s]-r[s]+e[u];switch($){case"none":break;case"start":n[i].start.push(x);break;case"center":n[i].center.push(x+h[l]/2);break;case"end":n[i].end.push(x+h[l]);break}}}return n}function vs(e){const t=e.getBoundingClientRect(),r=P2(e),n=D2(e),o={x:e.scrollWidth-e.offsetWidth,y:e.scrollHeight-e.offsetHeight},i=(a,s)=>l=>Math.max(a,Math.min(s,l));return{x:Xl([...n.x.start.map(a=>a-r.x.before),...n.x.center.map(a=>a-t.width/2),...n.x.end.map(a=>a-t.width+r.x.after)].map(i(0,o.x))),y:Xl([...n.y.start.map(a=>a-r.y.before),...n.y.center.map(a=>a-t.height/2),...n.y.end.map(a=>a-t.height+r.y.after)].map(i(0,o.y)))}}function Xl(e){return Array.from(new Set(e))}const co="templates-container",N2=4e3;var uo=(e=>(e.Default="default",e.Banner="banner",e))(uo||{});const ye=ae()({tagName:"toniq-carousel",hostClasses:{"toniq-carousel-banner-variant":({inputs:e})=>e.variant==="banner","toniq-carousel-offset-arrows":({inputs:e})=>!!e.offsetArrows},stateInitStatic:{currentScrollPosition:{left:0,right:1/0},scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({hostClasses:e})=>f`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
    ...
    `,events:{pageChange:ie()},renderCallback({inputs:e,events:t,dispatch:r}){return e.pageCount<=1?c``:c`
                ...
                ${mv(e.currentPage,e.pageCount,e.pagesShown).map(n=>typeof n=="string"?c`
    ...
    `,stateInitStatic:{canScroll:!1,debouncedResize:b1(()=>Vh(sn.FirstThenWait,{milliseconds:30})),rowStyles:{},isPainting:!1,itemsPainted:0,pageCountKey:0},initCallback({inputs:e,state:t,updateState:r}){const n=e.columns.filter(o=>!o.disabled);r({rowStyles:n.reduce((o,i)=>(o[i.key]={width:void 0,left:void 0},o),t.rowStyles)})},renderCallback({inputs:e,state:t,updateState:r,events:n,dispatch:o}){var h;const i=e.columns.filter(m=>!m.disabled),a=[e.rows[0],...e.rows].filter(ve);function s(m){m instanceof HTMLElement&&t.debouncedResize(()=>{r({canScroll:m.scrollWidth>m.clientWidth})})}const l=e.pagination&&((h=e.pagination)==null?void 0:h.pageCount)>1?c`
        ...
        `}});async function gv(e){return navigator.clipboard.writeText(e)}const wv="…";function vv(e,t){const r=e.slice(0,t).trim(),n=e.slice(-1*t).trim();return`${r}${wv}${n}`}function bv(e){return!(e%1)}function yv(e){return e.letterCount==null?4:bv(e.letterCount)?e.letterCount<1?1:e.letterCount:Math.floor(e.letterCount)}const D=ae()({tagName:"toniq-middle-ellipsis",events:{copy:ie()},cssVars:{"toniq-middle-ellipsis-text-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-icon-color":b.pagePrimary.foregroundColor,"toniq-middle-ellipsis-text-hover-color":b.pageInteraction.foregroundColor,"toniq-middle-ellipsis-icon-hover-color":b.pageInteraction.foregroundColor},styles:({hostClasses:e,cssVars:t})=>f`
        :host {
            /* 5 frames at 60 fps */
            transition: ${K.interaction};
            ${O.paragraphFont};
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:r,state:n,updateState:o}){if(!e.text)return c``;const i=e.text,a=yv(e),s=!!e.externalLink,l=!!e.copyOnClick,u=i.length>a*2+2,p=u?vv(i,a):i,h=u?i:"",m=s?Fd:l?Rd:void 0,g=m?c`
                  <${y.assign({icon:m})}></${y}>
              `:"",w=c`
        ...
        `;return p?s?c`
                ...
                `:l?c`
                    <button
                        ...
                        ${k("click",async()=>{await gv(i),t(new r.copy),n.showCopiedTextTimeoutId!=null&&window.clearTimeout(n.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${w} ${g}
                    </button>
                `:c`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:lu()})},renderCallback({inputs:e,dispatch:t,events:r,state:n}){return kv(e.entries).map(i=>xv(e.groupName||n.randomGroupName,e.value,i,()=>{t(new r.valueChange(i.value))}))}});function kv(e){const t=Object.fromEntries(e.map(n=>[n.value,n]));return Object.values(t).length!==e.length&&console.error(`${_.tagName} was given duplicate entry values.`),Object.values(t)}function xv(e,t,r,n){const o=t===r.value,i=c`
...
`,Uc=f`
    transform: scale(1.2);
`;function qv(e){return e>100*(2/3)?"cold":e>100*(1/3)?"medium":"hot"}function Qr(e){requestAnimationFrame(()=>{const t=fh(e.instanceInputs,e).elementValue;Bv(t,e)&&(e.setAttribute("disabled","true"),Qr(e))})}const F=ae()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ie()},styles:f`
        :host {
            display: block;
        }
            ...
            `}function w(x){i({internalValue:x}),e.disabled||n(new r.valueChange(x))}function $(x,C,S){const N=Wt((m-Ut)*(S.max-C)/(S.max-S.min)+Ut/2),R=Ki(x,u,l),J=Qi({value:C,limits:S,flip:!1});return c`
                ...
                >
                    ...
                    <input
                        ?disabled=${e.disabled??!1}
                        type="range"
                        class="${B.slider} ${e.colorTemperature?qv(Math.abs(J)):""}"
                        step=${e.step}
                        .min=${S.min}
                        .max=${S.max}
                        .value=${C}
    ...
    `,renderCallback({inputs:e}){return c`
            <${y.assign({icon:e.icon})}></${y}>
        `}}),oi=Object.values(it).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),Lv=Object.keys(oi).sort();function Ms(e){return{controlType:H.Dropdown,initValue:e,options:["None",...Lv]}}const wh={"CSS color":{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-fill-color"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Color,initValue:""},[String(d["toniq-icon-stroke-width"].name)]:{controlType:H.Number,initValue:2}};function mo(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),te(n,"number")&&(n=ja({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
`)}const Pv=U({title:"Social Urls",parent:gh,elementExamplesCallback({defineExample:e}){function t({socialName:r,icon:n}){e({title:r,renderCallback(){return c`
                        <${Ro.assign({icon:n})}></${Ro}>
                    `}})}Object.entries(o0).forEach(([r,n])=>{t({socialName:r,icon:n})})}}),re=U({title:"Elements",parent:void 0}),Ov=U({parent:re,title:Ii.tagName,elementExamplesCallback({defineExample:e}){[{name:"danger",inputs:{variant:lo.Danger},slot:c`<strong>Alert!</strong>This is an alert, Please be very careful!`},{name:"warning",inputs:{variant:lo.Warning},slot:"This is a warning, proceed with caution 🚧"},{name:"success",inputs:{variant:lo.Success},slot:"You have successfully completed your task!"}].forEach(r=>{e({title:r.name,stateInitStatic:{},styles:f`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
                ...
                `,renderCallback(){return c`
                    ...
                    `}})})}}),Dv=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:f`
            ${Yt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],Nv=U({title:Yt.tagName,parent:re,elementExamplesCallback({defineExample:e}){Dv.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:f`
                    .bold {
                        ${O.boldFont}
                    }
...
`,Fv=U({parent:re,title:ye.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:_i,renderCallback(){return c`
                ...
                `;return c`
                    ...
                    <${ye.assign({enableAutomaticCycling:!1,offsetArrows:!0,variant:uo.Banner,templates:it["core-24"].map(r=>c`
                            ...
                            `)})}></${ye}>
                `}})}});function jv(e){const t=Object.keys(e.cssVars).map(r=>[`--${r}`,{controlType:H.Color,initValue:""}]);return Object.fromEntries(t)}function Hv(e){const t=Object.entries(e).map(([r,n])=>{if(r.startsWith("--"))return typeof n!="string"||!n?void 0:`${r}: ${n};`}).filter(ve);return T(t.join(`
`))}const Uv=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],ea=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],Wv=U({parent:re,title:yt.tagName,controls:{Text:{controlType:H.Text,initValue:"Text"},...jv(yt)},elementExamplesCallback({defineExample:e}){Uv.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:ea.map(r=>!!r.inputs.checked),extraEntryStatuses:ea.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:f`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return ea.map((i,a)=>{const s=(i.extraEntries??[]).map((u,p)=>{var h;return c`
                        ...
                        `})}})})}}),Vv=U({parent:re,title:qi.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Et}},{inputs:{icon:Et}},{inputs:{},template:c`
                    HTML child
        ...
        `}],Gv=U({title:Jn.tagName,parent:re,controls:{Selected:{controlType:H.Dropdown,initValue:_n[0].label,options:_n.map(e=>e.label)},Direction:{controlType:H.Dropdown,initValue:"Down",options:nu(Pa)},Icon:Ms(Od.name),Prefix:{controlType:H.Text,initValue:"Sort by: "},"Force open":{controlType:H.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){Zv.forEach(t=>{e({title:t.title,stateInitStatic:{selected:Wc.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:f`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Wc.map((i,a)=>{const s=f`
                        ...
                        `;return c`
                            ...
                            ></${Jn}>
                        `})}})})}}),Yv=[{title:"empty",content:""},{title:"with text",content:"Error: there was an error"}],Qv=U({title:Wi.tagName,parent:re,elementExamplesCallback({defineExample:e}){Yv.forEach(t=>{e({title:t.title,renderCallback(){return c`
                        <${Wi}>${t.content}</${Wi}>
                    `}})})}}),Vc="/toniq-labs-design-system";function vh(...e){const r=[globalThis.location.pathname.startsWith(Vc)?Vc:"",...e].filter(ve);return cn(...r)}const cr=Array(30).fill(vh("/toniq-labs-logo.png")),mr=["Hello there.","There is stuff here."],eo=mr.concat(Array(30).fill(mr)),Kv=U({title:oe.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${oe.assign({infoParagraphs:eo,imageUrls:cr,socialUrls:q2,cardTitle:"Featured Stuff",viewButtonTitle:"Stuff"})}></${oe}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return c`
                    <${oe.assign({imageUrls:cr.map((t,r)=>r%2?"/invalid-image.png":t),infoParagraphs:mr,cardTitle:"With custom Template Statuses",customTemplateCallback(t){return c`
                            ...
                            `}})}></${oe}>
                `}})}}),Jv=U({title:Gt.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:f`
                .front,
                .back {
                    padding: 32px;
                }
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:r}){return c`
                ...
                `}})}}),Xv=U({title:Ie.tagName,parent:re,elementExamplesCallback({defineExample:e}){ou(hr).forEach(t=>{e({title:t,renderCallback(){return c`
            ...
            `,renderCallback({controls:r}){return c`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),c`
                            ...
                            ></${Xn}>
                        `))}})})}});function ii({entries:e,columns:t,createRowObject:r}){const n=Object.fromEntries(t.map(i=>[i.key,""]));return{rows:e.map((i,a)=>{const s=r(i,a);if(!at(Object.keys(n).sort(),Object.keys(s.cells).sort()))throw console.error("broken list table row",{cells:s.cells,columns:n}),new Error("List table row keys does not match expect column keys.");return s}),columns:t}}const bh="https://cdn-bitcoin.bioniq.io",r5=cn(bh,"content"),n5=cn(bh,"thumbnail"),gr={thumbnail(e){return cn(n5,e)},content(e){return cn(r5,e)}},o5=Array(5).fill({imageUrl:gr.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${f`
                display: flex;
                gap: 8px;
    ...
    `}),i5=[{imageUrl:gr.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),type:"Payment Sent",price:c`
            <div
                style=${f`
                    display: flex;
                    gap: 8px;
        ...
        `}],a5=[],s5=Array(5).fill({imageUrl:gr.thumbnail("b3e3275c0d0793b9f64a86eaa5e9d6bdad1e69282ebfb59cc68ccbcfd4e093a4i0"),price:c`
        <div
            style=${f`
                display: flex;
                gap: 8px;
    ...
    `}),ta=ii({entries:o5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE",mobile:{sticky:!0}},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${f`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),zc=ii({entries:i5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${f`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),l5=ii({entries:a5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"type",title:"TYPE",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME"},{key:"action",title:""}],createRowObject:e=>({cells:{image:c`
                    <img
                        style=${f`
                            width: 24px;
                            height: auto;
                        ...
                        src=${e.imageUrl}
                    />
                `,type:e.type,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time,action:e.action},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),c5=ii({entries:s5,columns:[{key:"image",title:"",mobile:{sticky:!0}},{key:"price",title:"PRICE"},{key:"from",title:"FROM"},{key:"to",title:"TO"},{key:"date",title:"DATE"},{key:"time",title:"TIME",style:f`
                display: flex;
                justify-content: flex-end;
            `}],createRowObject:e=>({cells:{image:c`
                    <img
                        ...
                        src=${e.imageUrl}
                    />
                `,price:e.price,from:e.from,to:e.to,date:e.date,time:e.time},rowActions:{click(){alert("This could be useful on opening specific inscription or transaction")}}})}),u5=[{title:"basic"},{title:"with pagination",inputs:{pagination:{currentPage:1,pageCount:10}}},{title:"squished horizontally",styles:f`
            :host {
                width: 200px;
            }
        ...
        `,inputs:{showLoading:!0,pagination:{currentPage:3,pageCount:10}}}],Zc=ws({tagName:"toniq-test-resize",stateInitStatic:{message:"",cleanup:void 0},initCallback({updateState:e,state:t}){if(!t.cleanup){const r=window.setInterval(()=>{t.message?e({message:""}):e({message:"April 3, 2024 (1:57pm)"})},1e3);e({cleanup(){window.clearInterval(r)}})}},cleanupCallback({state:e,updateState:t}){var r;(r=e.cleanup)==null||r.call(e),t({cleanup:void 0})},renderCallback({state:e}){return e.message}}),d5=U({title:Re.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"no action",renderCallback(){return c`
            ...
            `,stateInitStatic:{tableInputs:{...ta,rows:ta.rows.map(t=>({...t,cells:{...t.cells,date:c`
                ...
                `}})}}),h5=U({title:nn.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:rn.Small}},{title:"large",inputs:{size:rn.Large}},{title:"whole page",inputs:{size:rn.WholePage},styles:f`
                    :host {
                        width: 500px;
                    }
                `}].forEach(r=>{e({title:r.title,styles:r.styles??f``,renderCallback(){return c`
                        <${nn.assign(r.inputs)}></${nn}>
                    `}})})}}),f5=U({title:D.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return c`
            ...
            `,renderCallback(){return c`
                ...
                `}})}}),p5=U({title:jr.tagName,parent:re,elementExamplesCallback({defineExample:e}){[{title:"halfway",percent:50},{title:"nothing",percent:0},{title:"complete",percent:100},{title:"custom height",styles:f`
                ${jr} {
                    height: 32px;
                }
                ...
                :`,percent:75}].forEach(r=>{e({title:r.title,styles:r.styles,renderCallback(){return c`
                    ...
                    `}})})}}),Ur=[{value:"1",label:"Entry 1"},{value:"2",label:"Entry 2"},{value:"3",label:"Entry 3"}],Ne={basic:Ur,longText:[{value:"first",label:"Entry 1 with really really really really really really really really really long label"},...Ur.slice(1)],disabled:[{...Ur[0],disabled:!0},...Ur.slice(1)],noLabels:Lh(Ur,e=>({...e,label:void 0}))},m5=U({title:_.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{selectedValue:Ne.basic[0].value},renderCallback({state:t,updateState:r}){return c`
...
`,ra={min:10,max:50},g5=U({title:F.tagName,parent:re,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:f`
                ${nt}
            `,renderCallback({state:t,updateState:r}){return c`
            ...
            `,renderCallback({state:t,updateState:r}){return c`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Gc.map((i,a)=>c`
                            ...
                            ></${Xi}>
                        `)}})})}}),b5=U({parent:re,title:po.tagName,elementExamplesCallback({defineExample:e}){function t({title:r,tooltipContent:n,forceShow:o}){e({title:r,styles:f`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),y5=U({parent:re,title:an.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${po.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return c`
                    <${an}>This is a tooltip.</${an}>
                `}})}}),k5=[b5,y5],x5=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:f`
            :host {
                width: 500px;
            }
                ...
                `,renderCallback({state:r,updateState:n}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return c`
                    ...
                    `}})})}}),yh=U({title:"Icons",parent:void 0,controls:wh}),A5=Object.entries(it).map(([e,t])=>U({title:e,parent:yh,elementExamplesCallback({defineExample:r}){t.map(n=>r({title:n.name,renderCallback({controls:o}){return c`
                                <${Ro.assign({icon:n})}
                                    style=${mo(o)}
                                ></${Ro}>
                            `}}))}}));function kh(e){const t=C5(e),r=xe(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return le(r).reduce((o,i)=>{const a=r[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function C5(e){typeof e!="string"&&(e=String(e));const n=`{"${Jc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const ai=U({title:"Styles",parent:void 0}),S5=f`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function T5(e,t,r){const n=kh(j(r));return e({title:t,styles:S5,renderCallback(){return c`
            ...
            `}})}const M5=U({title:"Colors",parent:ai,elementExamplesCallback({defineExample:e}){le(b).map(t=>T5(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),E5=f`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function I5(e,t,r){const n=kh(r);return e({title:t,styles:E5,renderCallback(){return c`
            ...
            `}})}const B5=U({title:"Fonts",parent:ai,elementExamplesCallback({defineExample:e}){le(O).map(t=>{const r=O[t];return I5(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),q5=U({title:"Shadows",parent:ai,elementExamplesCallback({defineExample:e}){Ih(bn).forEach(([t,r])=>{e({title:t,styles:f`
                        div {
                            width: 50px;
                            height: 50px;
                            border-radius: 8px;
                    ...
                    `,renderCallback(){return c`
                            <div></div>
                        `}})})}}),L5=[re,yh,ai,gh],P5=[...A5,...k5,Pv,Nv,Ov,Rv,Fv,Wv,Vv,M5,zv,Gv,Qv,Kv,Jv,B5,Xv,_v,e5,t5,h5,f5,p5,m5,q5,g5,v5,$5,d5].sort((e,t)=>e.title.localeCompare(t.title)),O5=[...L5,...P5];Zo({tagName:"toniq-design-system-app",styles:f`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return c`
            <${Ti.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:O5,themeColor:"#00D093"})}>
