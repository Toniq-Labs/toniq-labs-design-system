...
`,Xu=v({name:"LoaderAnimated24Icon",svgTemplate:u`
    ...
    `,events:{routeChange:K()},renderCallback({inputs:e,dispatch:t,events:n}){var o,i;function r(a){e.route&&ko(a)&&(a.preventDefault(),e.route.scrollToTop&&window.scrollTo(0,0),t(new n.routeChange(e.route.route)))}if((o=e.link)!=null&&o.newTab)return u`
            ...
            `}}});const{defineElement:Ve,defineElementNoInputs:u4}=Ca(),Be=Ve()({tagName:"book-route-link",cssVars:{"book-route-link-anchor-padding":""},styles:({cssVars:e})=>m`
        a {
            box-sizing: border-box;
            display: block;
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{vl(e,Li(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:n,updateState:r,dispatch:o,events:i})=>{var d,f,p,g,w,$,k;t._debug&&console.info("rendering element-book app");function a(x){return{...e.currentRoute,...x}}function s(x){const C=a(x);return!ut(e.currentRoute,C)}function l(x){t.preventWindowTitleChange||(e.originalWindowTitle||r({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,x].filter(ke).join(" - "))}function c(x){if(!s(x))return;const C=a(x);e.router?e.router.setRoutes(C):r({currentRoute:{...e.currentRoute,...C}}),t.elementBookRoutePaths&&!ut(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(C.paths??[]))}try{if(t.elementBookRoutePaths&&!ut(t.elementBookRoutePaths,e.currentRoute.paths)&&c({paths:t.elementBookRoutePaths}),(d=t.internalRouterConfig)!=null&&d.useInternalRouter&&!e.router){const Z=Q1(t.internalRouterConfig.basePath);r({router:Z}),Z.addRouteListener(!0,oe=>{r({currentRoute:oe})})}else!((f=t.internalRouterConfig)!=null&&f.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const x={themeColor:t.themeColor};if(!ut(x,(p=e.colors)==null?void 0:p.config)){const Z=cl(x);r({colors:{config:x,theme:Z}}),nf(n,Z)}const C=t._debug??!1,O=D1({entries:t.entries,debug:C});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),r({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:hu(O.tree,{children:(w=(g=e.treeBasedControls)==null?void 0:g.controls)==null?void 0:w.children,controls:t.globalValues})}}));const j=Li(e.currentRoute.paths),he=(j?z1({flattenedNodes:O.flattenedNodes,searchQuery:j}):void 0)??G2(O.flattenedNodes,e.currentRoute.paths,c);l(($=he[0])==null?void 0:$.entry.title);const ce=(k=e.treeBasedControls)==null?void 0:k.controls;return ce?(t._debug&&console.info({currentControls:ce}),u`
                <div
                    ...
                    ${S(er.events.controlValueChange,Z=>{if(!e.treeBasedControls)return;const oe=R1(ce,Z.detail.fullUrlBreadcrumbs,Z.detail.newValues);r({treeBasedControls:{...e.treeBasedControls,controls:oe}})})}
                >
    ...
    `}),bl={interactionDuration:m`--toniq-interaction-transition-duration`,prettyDuration:m`--toniq-pretty-transition-duration`},X={interaction:m`var(${bl.interactionDuration}, 84ms)`,pretty:m`var(${bl.prettyDuration}, 300ms)`};function Qo(e){return{foregroundColor:e.backgroundColor,backgroundColor:e.foregroundColor}}const Lm=(()=>{const e={backgroundColor:m`#ffffff`,foregroundColor:m`#000000`},t={...e,foregroundColor:m`#00D093`},n={...e,foregroundColor:m`#ACADAD`},r={...e,foregroundColor:m`#D6D6D6`},o={...t},i={...t,foregroundColor:m`#00A876`},a={...t,foregroundColor:m`#1D6852`},s={...r},l={...e,foregroundColor:m`#EAFBF7`},c={...e,backgroundColor:m`#D2EEFA`},d=Qo(o),f=Qo(i),p=Qo(a),g=p,w={backgroundColor:m`#F1F3F6`,foregroundColor:e.foregroundColor},$={...w,foregroundColor:m`#9A9A9D`};return{brandPrimary:t,pagePrimary:e,pageSecondary:n,pageTertiary:r,pageInteraction:o,pageInteractionHover:i,pageInteractionActive:a,divider:s,dividerFaint:l,dropShadow:c,pageDarkPrimary:g,accentPrimary:d,accentPrimaryHover:f,accentPrimaryActive:p,accentSecondary:w,accentTertiary:$}})(),cd=Lm;function yl(e,t){return P(`--toniq-${Gr(e)}-${Gr(t)}`)}const Oa=ve(cd,e=>({backgroundColor:yl(e,"backgroundColor"),foregroundColor:yl(e,"foregroundColor")}));function Ge(e,t){const n=cd[e][t],r=Oa[e][t];return m`var(${r}, ${n})`}const b=ve(Oa,e=>({foregroundColor:Ge(e,"foregroundColor"),backgroundColor:Ge(e,"backgroundColor")}));function F(e){return m`
...
`))}const Y=(()=>{const e=m`
    ...
    `,menuShadow:m`
        ...
        */
        will-change: filter;
    `};function Nm(e,t=!0){const n=P(e),r=e===":host"?m`
                  :host(:hover);
              `:m`
                  ${n}:hover
              `,o=t?m`
        ...
        ${o}
    `}const Pm=v({name:"NotificationBell24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
                d="M4.13678 19.55C3.78361 19.55 3.49349 19.4361 3.26641 19.2082C3.03932 18.9802 2.92578 18.6969 2.92578 18.3582C2.92578 18.0194 3.03932 17.7375 3.26641 17.5125C3.49349 17.2875 3.77995 17.175 4.12578 17.175H5.25078V10.225C5.25078 8.69027 5.69661 7.29409 6.58828 6.03647C7.47995 4.77884 8.67578 3.97988 10.1758 3.6396V3.05002C10.1758 2.54169 10.3526 2.11877 10.7064 1.78127C11.0601 1.44377 11.4896 1.27502 11.9949 1.27502C12.5002 1.27502 12.9317 1.44377 13.2893 1.78127C13.647 2.11877 13.8258 2.54169 13.8258 3.05002V3.6396C15.3424 3.97988 16.5508 4.77884 17.4508 6.03647C18.3508 7.29409 18.8008 8.69027 18.8008 10.225V17.175H19.9008C20.2279 17.175 20.5096 17.289 20.7461 17.5169C20.9825 17.7448 21.1008 18.0282 21.1008 18.3669C21.1008 18.7057 20.9825 18.9875 20.7461 19.2125C20.5096 19.4375 20.2279 19.55 19.9008 19.55H4.13678ZM12.0133 22.625C11.4224 22.625 10.906 22.4096 10.4639 21.9788C10.0218 21.5479 9.80078 21.03 9.80078 20.425H14.2258C14.2258 21.0417 14.0072 21.5625 13.57 21.9875C13.1328 22.4125 12.6139 22.625 12.0133 22.625ZM7.60078 17.175H16.4258V10.225C16.4258 8.97502 16.0049 7.92086 15.1633 7.06252C14.3216 6.20419 13.2799 5.77502 12.0383 5.77502C10.7966 5.77502 9.74662 6.20419 8.88828 7.06252C8.02995 7.92086 7.60078 8.97502 7.60078 10.225V17.175Z"
                fill=${h["toniq-icon-stroke-color"].value}
            />
        </svg>
    ...
    `}),Dm=v({name:"People24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Om=v({name:"Person24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),hd=v({name:"Search24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),zm=v({name:"Square24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Zm=v({name:"SquareCheck24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Wm=v({name:"Wallet24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Gm=v({name:"X24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Ym=v({name:"Folder48Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill=${h["toniq-icon-fill-color"].value}
    ...
    `}),Jm=v({name:"Kyc48Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
    ...
    `}),Xm=v({name:"CircleDashes64Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${h["toniq-icon-stroke-color"].value}
            fill="none"
...
`,rp=v({name:"CryptoIcp16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),op=v({name:"CryptoIcp24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill="none"
    ...
    `}),ip=v({name:"BrandFacebookLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),ap=v({name:"BrandGoogleLogo24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),sp=v({name:"BrandIcScan24Icon",svgTemplate:u`
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    `}),cp=v({name:"BrandNftgeek24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            width="24"
    ...
    `}),up=v({name:"BrandTiktokFlat24Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${V["toniq-icon-fill-color"]("#000")}
    ...
    `}),dp=v({name:"BioniqRobot100Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `}),hp=v({name:"EntrepotLogo144Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
    ...
    `}),vt={"core-16":[Y2,J2,Tt],"core-24":[X2,K2,Pa,Q2,em,Ba,nd,tm,nm,rm,om,im,am,sm,rd,od,lm,cm,id,um,dm,hm,ad,sd,fm,mm,pm,gm,ld,wm,vm,bm,ym,zi,km,$m,xm,Tm,Sm,Cm,Mm,Da,Am,Em,Im,Pm,Bm,Dm,Om,Rm,_m,dd,hd,Hm,Fm,Vm,zm,Zm,Fr,jm,Wm,Um,Gm],"core-48":[Ym,fd,Jm],"core-64":[md,Xm,Km],cryptocurrencies:[Qm,ep,tp,np,rp,op],"third-party-brands":[wd,vd,bd,ip,ap,sp,yd,lp,kd,cp,$d,xd,up,Td,Sd],toniq:[dp,hp]},fp=sr({discord:Qe(void 0,""),distrikt:Qe(void 0,""),dscvr:Qe(void 0,""),instagram:Qe(void 0,""),medium:Qe(void 0,""),telegram:Qe(void 0,""),tikTok:Qe(void 0,""),twitch:Qe(void 0,""),twitter:Qe(void 0,""),website:Qe(void 0,"")}),mp=fp.defaultValue,Cd={discord:wd,instagram:yd,telegram:$d,tikTok:xd,distrikt:vd,twitch:Td,dscvr:bd,medium:kd,twitter:Sd,website:ad},kl="toniq-",{defineElement:ne,defineElementNoInputs:pp}=Ca({assertInputs:e=>{if(!e.tagName.startsWith(kl))throw new Error(`Tag name should start with '${kl}' but got '${e.tagName}'`)}}),Vt=ne()({tagName:"toniq-bold-space",styles:m`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,renderCallback({inputs:e}){const t=e.icon?u`
        ...
        `}});function gp(e,t,n={behavior:"smooth"}){let r=2;const o=t==="up"||t==="down"?"y":"x",i=t==="right"||t==="down"?"+":"-",a=o==="x"?e.scrollWidth-e.offsetWidth:e.scrollHeight-e.offsetHeight,s=Ra(e)[o];i==="-"&&(r*=-1);const l=e[o==="x"?"scrollLeft":"scrollTop"]+r,c=s.filter(f=>i==="+"?f>l:f<l).sort((f,p)=>i==="+"?f-p:p-f);let d;return c.length>0?d=c[0]:i==="+"?d=a:d=0,e.scrollTo({...n,[o==="x"?"left":"top"]:d})}function wp(e){const t=window.getComputedStyle(e),n=e.getBoundingClientRect();let r=t.getPropertyValue("scroll-padding-left").replace("auto","0px"),o=t.getPropertyValue("scroll-padding-top").replace("auto","0px"),i=t.getPropertyValue("scroll-padding-right").replace("auto","0px"),a=t.getPropertyValue("scroll-padding-bottom").replace("auto","0px");function s(p,g){let w=parseFloat(p);return/%/.test(p)&&(w/=100,w*=g),w}let l=s(r,n.width),c=s(o,n.height),d=s(i,n.width),f=s(a,n.height);return{x:{before:l,after:d},y:{before:c,after:f}}}function vp(e,t,n="both"){return n==="x"&&e.right>=t.left&&e.left<=t.right||n==="y"&&e.bottom>=t.top&&e.top<=t.bottom||n==="both"&&e.right>=t.left&&e.left<=t.right&&e.bottom>=t.top&&e.top<=t.bottom}function Md(e){let t=[];for(const n of e.children)t=t.concat(n,Md(n));return t}function bp(e,t=!0){const n=e.getBoundingClientRect(),r={x:{start:[],center:[],end:[]},y:{start:[],center:[],end:[]}},o=Md(e);for(const i of["x","y"]){const a=i==="x"?"y":"x",s=i==="x"?"left":"top",l=i==="x"?"width":"height",c=i==="x"?"scrollLeft":"scrollTop";for(const d of o){const f=d.getBoundingClientRect();if(t&&!vp(n,f,a))continue;const p=window.getComputedStyle(d);let[g,w]=p.getPropertyValue("scroll-snap-align").split(" ");typeof w>"u"&&(w=g);const $=i==="x"?w:g,k=f[s]-n[s]+e[c];switch($){case"none":break;case"start":r[i].start.push(k);break;case"center":r[i].center.push(k+f[l]/2);break;case"end":r[i].end.push(k+f[l]);break}}}return r}function Ra(e){const t=e.getBoundingClientRect(),n=wp(e),r=bp(e),o={x:e.scrollWidth-e.offsetWidth,y:e.scrollHeight-e.offsetHeight},i=(a,s)=>l=>Math.max(a,Math.min(s,l));return{x:$l([...r.x.start.map(a=>a-n.x.before),...r.x.center.map(a=>a-t.width/2),...r.x.end.map(a=>a-t.width+n.x.after)].map(i(0,o.x))),y:$l([...r.y.start.map(a=>a-n.y.before),...r.y.center.map(a=>a-t.height/2),...r.y.end.map(a=>a-t.height+n.y.after)].map(i(0,o.y)))}}function $l(e){return Array.from(new Set(e))}const Vr="templates-container",yp=4e3;var ji=(e=>(e.Default="default",e.Banner="banner",e))(ji||{});const Me=ne()({tagName:"toniq-carousel",hostClasses:{"toniq-carousel-banner-variant":({inputs:e})=>e.variant==="banner"},stateInitStatic:{currentScrollPosition:{left:0,right:1/0},scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({hostClasses:e})=>m`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:n,state:r,updateState:o}){if(!e.text)return u``;const i=e.text,a=nw(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,d=c?ew(i,a):i,f=c?i:"",p=s?ld:l?sd:void 0,g=p?u`
                  <${T.assign({icon:p})}></${T}>
              `:"",w=u`
        ...
        `;return d?s?u`
                ...
                `:l?u`
                    <button
                        ...
                        ${S("click",async()=>{await K5(i),t(new n.copy),r.showCopiedTextTimeoutId!=null&&window.clearTimeout(r.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${w} ${g}
                    </button>
                `:u`
                    ${w}
                `:u``}}),lc="...";function rw(e,t,n=7,r=5){let o;e=On({value:e,min:1,max:t}),n=On({value:n,min:r,max:t});const i=n-5,a=n-3;t<=n?o=n:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>n?fi(t-o,t):e>o?fi(Math.min(s.start,t-o),Math.min(s.end,t)):fi(1,Math.min(t,o+1));function c(f,p){return l.length+1!==t?p:[f]}const d=l[l.length-1];if(d&&d<t){const f=c(t,[lc,t]);return[...l,...f]}else return l[0]!==1?c(1,[1,lc]).concat(l):l}function fi(e,t){const n=t-e+1;return Array.from({length:n},(r,o)=>e+o)}ne()({tagName:"toniq-pagination",styles:m`
        :host {
            display: flex;
        }
    ...
    `,events:{pageChange:K()},renderCallback({inputs:e,events:t,dispatch:n}){return e.pageCount<=1?u``:u`
                ...
                ${rw(e.currentPage,e.pageCount,e.pagesShown).map(r=>typeof r=="string"?u`
    ...
    `}function mi(e,t){const n=e[0],r=e[e.length-1];if(n==null||r==null)return 0;if(t<n)return n;if(t>r)return r;const o=e.findIndex((c,d)=>{const f=e[d+1];return f==null?!0:c<=t&&f>=t});if(o<0)return n;const i=e[o];if(i==null)return n;const a=e[o+1];if(a==null)return i;const s=t-i,l=a-t;return s<l?o:o+1}function aw(e,t,n=100){e>t&&([e,t]=[t,e]),n<2&&(n=2);let r=sw(e);const o=[e];for(;r<t;){const i=Math.pow(10,String(r).length-1),a=r+i;a<t&&o.push(a),r=a}return o.push(t),o.length>n&&(cc(o,n),o.length>n&&cc(o,n)),o}function cc(e,t){const n=e.length-t,r=(e.length-2)/n;for(let o=e.length-2;o>=1;o-=r)e.splice(Math.floor(o),1)}function sw(e){let t=1;if(!e)return e;e<0&&(t=-1,e=e*-1);const n=e.toFixed(0),r=Math.pow(10,n.length-1),o=Number(n[0]||1);return r*o*t}const N={lowerLabelWrapper:"lower-label-wrapper",upperLabelWrapper:"upper-label-wrapper",labelPercentMarginWrapper:"label-percent-wrapper",labelPixelMarginWrapper:"label-pixel-wrapper",labelOuterWrapper:"label-outer-wrapper",rightAlignedLabelWrapper:"label-right-wrapper",range:"range",lowerSlider:"lower-slider",upperSlider:"upper-slider",slider:"slider"},En={label:"label",upperLabel:"upper-label",lowerLabel:"upper-label",slider:"slider"};function lw(e){var r,o;const t=(r=e.shadowRoot)==null?void 0:r.querySelector(`.${N.lowerLabelWrapper} .${N.labelPercentMarginWrapper}`),n=(o=e.shadowRoot)==null?void 0:o.querySelector(`.${N.upperLabelWrapper} .${N.labelPercentMarginWrapper}`);if(n instanceof HTMLElement&&t instanceof HTMLElement){const i=t.getBoundingClientRect(),a=n.getBoundingClientRect();return{lower:i,upper:a}}else return}function cw(e,t=8){const n=lw(e);if(!n)return 0;const r=n.lower.right-n.upper.left+t;return Math.max(0,r)}function pi({value:e,limits:t,flip:n}){const o=(t.max-e)/(t.max-t.min)*100;return-(n?100-o:o)}function nr(e){return Xe(e)&&e.min!==void 0&&e.max!==void 0}function oa(e){var n;const t=(n=e.shadowRoot)==null?void 0:n.querySelector(`.${N.range}`);return(t==null?void 0:t.clientWidth)??0}function gi(e,t,n){return`${n?kh(e):e} ${t}`}function uw({min:e,max:t}){return e>t?{min:t,max:e}:{min:e,max:t}}function dw({value:e,double:t,min:n,max:r}){return t?nr(e)?{min:On({value:e.min,min:n,max:Math.min(e.max,r)}),max:On({value:e.max,min:Math.max(e.min,n),max:r})}:{min:n,max:r}:nr(e)?n:On({value:e,min:n,max:r})}function hw({actualValue:e,actualLimits:t,logScale:n,logRange:r}){return n?{elementValue:nr(e)?{min:mi(r,e.min),max:mi(r,e.max)}:mi(r,e),elementLimits:{min:0,max:r.length-1}}:{elementValue:e,elementLimits:t}}function wi(e,t,n){return n?t[e]||0:e}function fw(e){return{actualLimits:uw(e),actualValue:dw(e)}}function mw(e,t){var r,o,i;let n=!1;if(nr(e)){const a=(r=t.shadowRoot)==null?void 0:r.querySelector(`.${N.lowerSlider}`),s=(o=t.shadowRoot)==null?void 0:o.querySelector(`.${N.upperSlider}`);a instanceof HTMLInputElement&&s instanceof HTMLInputElement&&(Number(a.value)!==e.min&&(a.value=String(e.min),n=!0),Number(s.value)!==e.max&&(s.value=String(e.max),n=!0))}else{const a=(i=t.shadowRoot)==null?void 0:i.querySelector(`.${N.slider}`);a instanceof HTMLInputElement&&Number(a.value)!==e&&(a.value=String(e),n=!0)}return n}function N0(e,t){const{actualValue:n,actualLimits:r}=fw({...e}),o=aw(r.min,r.max),i=e.logScale??!1,a=e.suffix??"",{elementValue:s,elementLimits:l}=hw({actualValue:n,actualLimits:r,logScale:i,logRange:o}),c=oa(t);return{actualValue:n,elementLimits:l,elementValue:s,isLogScale:i,logRange:o,rangeWidth:c,suffix:a}}const Dt=16,uc=m`
    ${Dt}px
`,dc=m`
...
`,hc=m`
    transform: scale(1.2);
`;function Bn(e){requestAnimationFrame(()=>{const t=N0(e.instanceInputs,e).elementValue;mw(t,e)&&(e.setAttribute("disabled","true"),Bn(e))})}const _=ne()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:K()},styles:m`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Bn(e)}),e.addEventListener("keydown",()=>{Bn(e)}),e.addEventListener("keyup",()=>{Bn(e)})},renderCallback({inputs:e,host:t,events:n,dispatch:r,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:d,elementLimits:f,rangeWidth:p}=N0({...e},t);if(Bn(t),nr(d))return g(a,d,f);return $(a,d,f);function g(k,x,C){const O={left:Ot((p-Dt)*(x.min-C.min)/(C.max-C.min)+Dt/2),right:Ot((p-Dt)*(C.max-x.max)/(C.max-C.min)+Dt/2)},j=gi(k.min,c,l),re=gi(k.max,c,l);requestAnimationFrame(()=>{const $e=cw(t);$e!==o.labelOverlap&&i({labelOverlap:$e})});const he=(C.max-x.max)/(C.max-C.min)>.5,ce=pi({value:x.min,limits:{min:C.min,max:x.max},flip:!0}),Z=pi({value:x.max,limits:{min:x.min,max:C.max},flip:!1}),oe=o.labelOverlap&&he?o.labelOverlap:0,ze=o.labelOverlap&&!he?o.labelOverlap:0;return u`
                <div
                    class="range"
    ...
    `,renderCallback({inputs:e}){const t=e.icon?u`
        ...
        `}}),zn=pp({tagName:"toniq-tooltip",styles:m`
        :host {
            display: block;
            padding: 4px 8px;
            border-radius: 8px;
    ...
    `,renderCallback({inputs:e}){return u`
            <${T.assign({icon:e.icon})}></${T}>
        `}}),Lo=Object.values(vt).reduce((e,t)=>(t.forEach(n=>{if(n.name in e)throw new Error(`Icon name duplicate: '${n.name}'`);e[n.name]=n}),e),{}),pw=Object.keys(Lo).sort();function Ga(e){return{controlType:B.Dropdown,initValue:e,options:["None",...pw]}}const D0={"CSS color":{controlType:B.Color,initValue:""},[String(h["toniq-icon-stroke-color"].name)]:{controlType:B.Color,initValue:""},[String(h["toniq-icon-fill-color"].name)]:{controlType:B.Color,initValue:""},[String(h["toniq-icon-stroke-width"].name)]:{controlType:B.Color,initValue:""},[String(h["toniq-icon-stroke-width"].name)]:{controlType:B.Number,initValue:2}};function Ur(e){return Object.entries(e).filter(([,n])=>n!==""&&n!=null).map(([n,r])=>(n.toLowerCase()==="css color"&&(n="color"),we(r,"number")&&(r=aa({value:r,suffix:"px"})),`${n}: ${r};`)).join(`
`)}const gw=U({title:"Social Urls",parent:B0,elementExamplesCallback({defineExample:e}){function t({socialName:n,icon:r}){e({title:n,renderCallback(){return u`
                        <${wo.assign({icon:r})}></${wo}>
                    `}})}Object.entries(Cd).forEach(([n,r])=>{t({socialName:n,icon:r})})}}),ae=U({title:"Elements",parent:void 0}),ww=[{title:"basic",text:"Hello there"},{title:"constrained width",text:"Hello there, this text is much longer",extraStyle:m`
            ${Vt} {
                white-space: nowrap;
                overflow: hidden;
                text-overflow: ellipsis;
        ...
        `}],vw=U({title:Vt.tagName,parent:ae,elementExamplesCallback({defineExample:e}){ww.forEach(t=>{e({title:t.title,stateInitStatic:{isBold:!1},styles:m`
                    .bold {
                        ${Y.boldFont}
                    }
                ...
                `,renderCallback({state:n,updateState:r}){return u`
                        ...
                        ></${Vt}>
                        More text
                    `}})})}}),bw=U({parent:ae,title:ue.tagName,elementExamplesCallback({defineExample:e}){[{name:"default",inputs:{}},{name:"Secondary",inputs:{variant:ho.Secondary}},{name:"Outline",inputs:{variant:ho.Outline}},{name:"Disabled",inputs:{disabled:!0}}].forEach(n=>{e({title:n.name,stateInitStatic:{showIcon:!1,timeoutId:void 0},styles:m`
                    :host {
                        display: flex;
                        align-items: flex-start;
                        flex-wrap: wrap;
...
`,yw=U({parent:ae,title:Me.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:fc,renderCallback(){return u`
                ...
                `;return u`
                    ...
                    ></${Me}>
                `}})}});function kw(e){const t=Object.keys(e.cssVars).map(n=>[`--${n}`,{controlType:B.Color,initValue:""}]);return Object.fromEntries(t)}function $w(e){const t=Object.entries(e).map(([n,r])=>{if(n.startsWith("--"))return typeof r!="string"||!r?void 0:`${n}: ${r};`}).filter(ke);return P(t.join(`
`))}const xw=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],bi=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],Tw=U({parent:ae,title:mt.tagName,controls:{Text:{controlType:B.Text,initValue:"Text"},...kw(mt)},elementExamplesCallback({defineExample:e}){xw.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:bi.map(n=>!!n.inputs.checked),extraEntryStatuses:bi.map(n=>(n.extraEntries??[]).map(()=>!1))},styles:m`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return bi.map((i,a)=>{const s=(i.extraEntries??[]).map((c,d)=>{var f;return u`
                        ...
                        `})}})})}}),Sw=U({parent:ae,title:ti.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Tt}},{inputs:{icon:Tt}},{inputs:{},template:u`
                    HTML child
        ...
        `},{customStyle:m`
            max-height: 30px;
            min-height: 30px;
        `}],Aw=U({title:Lr.tagName,parent:ae,controls:{Selected:{controlType:B.Dropdown,initValue:Nr[0].label,options:Nr.map(e=>e.label)},Direction:{controlType:B.Dropdown,initValue:"Down",options:Cc(ea)},Icon:Ga(nd.name),Prefix:{controlType:B.Text,initValue:"Sort by: "},"Force open":{controlType:B.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){Mw.forEach(t=>{e({title:t.title,stateInitStatic:{selected:mc.map(n=>{var r;return(r=n.inputs)==null?void 0:r.value})},styles:m`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return mc.map((i,a)=>{const s=m`
                        ...
                        `;return u`
                            ...
                            ></${Lr}>
                        `})}})})}}),pc="/toniq-labs-design-system";function Ew(...e){const n=[globalThis.location.pathname.startsWith(pc)?pc:"",...e].filter(ke);return gh(...n)}const tn=Array(30).fill(Ew("/toniq-labs-logo.png")),an=["Hello there.","There is stuff here."],Pr=an.concat(Array(30).fill(an)),Iw=U({title:J.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${J.assign({infoParagraphs:Pr,imageUrls:tn,socialUrls:mp,title:"Featured Stuff",viewButtonTitle:"Stuff"})}></${J}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${J.assign({imageUrls:tn.map((t,n)=>n%2?"/invalid-image.png":t),infoParagraphs:an,title:"With custom Template Statuses",customTemplateCallback(t){return u`
                            ...
                            `}})}></${J}>
                `}})}}),Lw=U({title:Ft.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"basic",styles:m`
                .front,
                .back {
                    padding: 32px;
                }
            ...
            `,renderCallback({controls:n}){return u`
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            ...
                            ></${qr}>
                        `))}})})}}),Bw=U({title:hi.tagName,parent:ae,elementExamplesCallback({defineExample:e}){[{title:"small",inputs:{size:jr.Small}},{title:"large",inputs:{size:jr.Large}},{title:"whole page",inputs:{size:jr.WholePage},styles:m`
                    :host {
                        width: 500px;
                    }
                `}].forEach(n=>{e({title:n.title,styles:n.styles??m``,renderCallback(){return u`
                        <${hi.assign(n.inputs)}></${hi}>
                    `}})})}}),Dw=U({title:pe.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Long text",renderCallback(){return u`
...
`,yi={min:10,max:50},Rw=U({title:_.tagName,parent:ae,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:m`
                ${at}
            `,renderCallback({state:t,updateState:n}){return u`
            ...
            `,renderCallback({state:t,updateState:n}){return u`
                ...
                `,renderCallback({state:n,updateState:r,controls:o}){return gc.map((i,a)=>u`
                            ...
                            ></${vi}>
                        `)}})})}}),Fw=U({parent:ae,title:Wr.tagName,elementExamplesCallback({defineExample:e}){function t({title:n,tooltipContent:r,forceShow:o}){e({title:n,styles:m`
                    div {
                        padding: 16px;
                        display: block;
                ...
                <p>another one</p>
            `,forceShow:!0}),t({title:"long tooltip",tooltipContent:"This tooltip is really really long! You probably shouldn't ever have a tooltip this long.",forceShow:!0})}}),Vw=U({parent:ae,title:zn.tagName,descriptionParagraphs:[`This element should almost never be used alone. You should instead use <${Wr.tagName}>, which in turn uses this element.`],elementExamplesCallback({defineExample:e}){e({title:"standalone tooltip",renderCallback(){return u`
                    <${zn}>This is a tooltip.</${zn}>
                `}})}}),zw=[Fw,Vw],Zw=[{title:"basic",inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"wide parent",extraStyles:m`
            :host {
                width: 500px;
            }
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:m``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}},{title:"with icon and disabled",extraStyles:m``,inputs:{value:"hi",tabs:[{label:"hi",value:0},{label:"",value:1,icon:zi},{label:"label here",value:2,icon:zi},{label:"",value:3,icon:Tt,disabled:!0},{label:"16px icon",value:4,icon:Tt},{label:"disabled",value:5,disabled:!0}]}},{title:"with routes",inputs:{value:0,tabs:[{label:"hi",value:0,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"bye",value:1,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"hello",value:2,link:{url:"https://toniqlabs.com",route:{paths:[]}}},{label:"so long",value:3,link:{url:"https://toniqlabs.com",route:{paths:[]}}}]}}],jw=U({title:Dn.tagName,parent:ae,elementExamplesCallback({defineExample:e}){Zw.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:m`
                ...
                `,renderCallback({state:n,updateState:r}){const o=t.inputs.tabs.map(i=>typeof i=="string"?{label:i,value:i}:i);return u`
                        ...
                        ></${Dn}>
                    `}})})}}),O0=U({title:"Icons",parent:void 0,controls:D0}),Ww=Object.entries(vt).map(([e,t])=>U({title:e,parent:O0,elementExamplesCallback({defineExample:n}){t.map(r=>n({title:r.name,renderCallback({controls:o}){return u`
                                <${wo.assign({icon:r})}
                                    style=${Ur(o)}
                                ></${wo}>
                            `}}))}}));function R0(e){const t=Uw(e),n=ve(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return de(n).reduce((o,i)=>{const a=n[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function Uw(e){typeof e!="string"&&(e=String(e));const r=`{"${bc(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(r);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${r}`),o}}const Ya=U({title:"Styles",parent:void 0}),Gw=m`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function Yw(e,t,n){const r=R0(F(n));return e({title:t,styles:Gw,renderCallback(){return u`
            ...
            `}})}const Jw=U({title:"Colors",parent:Ya,elementExamplesCallback({defineExample:e}){de(b).map(t=>Yw(e,t,b[t]))},descriptionParagraphs:['Accessed via the "toniqColors" export.']}),Xw=m`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function Kw(e,t,n){const r=R0(n);return e({title:t,styles:Xw,renderCallback(){return u`
            ...
            `}})}const Qw=U({title:"Fonts",parent:Ya,elementExamplesCallback({defineExample:e}){de(Y).map(t=>{const n=Y[t];return Kw(e,t,n)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),e4=[ae,O0,Ya,B0],t4=[...Ww,...zw,gw,vw,bw,yw,Tw,Sw,Jw,Cw,Aw,Iw,Lw,Qw,qw,Nw,Pw,Bw,Dw,Ow,Rw,Hw,jw].sort((e,t)=>e.title.localeCompare(t.title)),n4=[...e4,...t4];yo({tagName:"toniq-design-system-app",styles:m`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return u`
            <${Ko.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:n4,themeColor:"#00D093"})}>
