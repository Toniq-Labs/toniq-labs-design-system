var wa=Object.freeze,ba=Object.defineProperty;var xu=(e,t,r)=>t in e?ba(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var Vn=(e,t,r)=>(xu(e,typeof t!="symbol"?t+"":t,r),r);var Un=(e,t)=>wa(ba(e,"raw",{value:wa(t||e.slice())}));(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function r(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=r(o);fetch(o.href,i)}})();function Si(e){return!!e}function ku(e){return e.replace(/\n/g," ").trim().replace(/\s{2,}/g," ")}var $a;(function(e){e.Upper="upper",e.Lower="lower"})($a||($a={}));function Il(e){if(!e||e.length===0)return;const t=e[0];return e.length===1&&t?t:new Error(e.map(r=>En(r).trim()).join(`
`))}function En(e){return e?e instanceof Error?e.message:An(e,"message")?String(e.message):String(e):""}function Su(e){return e instanceof Error?e:new Error(En(e))}function ya(e){return!!e&&typeof e=="object"}const Cu=[(e,t)=>t in e,(e,t)=>t in e.constructor.prototype];function An(e,t){return e?Cu.some(r=>{try{return r(e,t)}catch{return!1}}):!1}function El(e,t){return e&&t.every(r=>An(e,r))}function en(e){let t;try{t=Reflect.ownKeys(e)}catch{}return t??[...Object.keys(e),...Object.getOwnPropertySymbols(e)]}function Tu(e){return Array.isArray(e)?"array":typeof e}function Mn(e,t){return Tu(e)===t}function xa({source:e,whitespace:t,errorHandler:r}){try{return JSON.stringify(e,void 0,t)}catch(n){if(r)return r(n);throw n}}const ka="Failed to compare objects using JSON.stringify";function Sa(e,t,r){return xa({source:e,errorHandler(n){if(r)return"";throw n}})===xa({source:t,errorHandler(n){if(r)return"";throw n}})}function We(e,t,r={}){try{return e===t?!0:ya(e)&&ya(t)?Sa(Object.keys(e).sort(),Object.keys(t).sort(),!!(r!=null&&r.ignoreNonSerializableProperties))?Object.keys(e).every(o=>We(e[o],t[o])):!1:Sa(e,t,!!(r!=null&&r.ignoreNonSerializableProperties))}catch(n){const o=Su(n);throw o.message.startsWith(ka)||(o.message=`${ka}: ${o.message}`),o}}function Iu(e,t,r){const n=t;if(e.has(n))return e.get(n);{const o=r();return e.set(n,o),o}}function Eu(e){return en(e).filter(t=>isNaN(Number(t)))}function Au(e){return Eu(e).map(r=>e[r])}function Mu(e,t){return Au(t).includes(e)}function Pu(e,t){return en(e).filter(n=>{const o=e[n];return t(n,o,e)}).reduce((n,o)=>(n[o]=e[o],n),{})}function Bu(e,t){return Pu(e,r=>!t.includes(r))}function tn(e,t){let r=!1;const n=en(e).reduce((o,i)=>{const a=t(i,e[i],e);return a instanceof Promise&&(r=!0),{...o,[i]:a}},{});return r?new Promise(async(o,i)=>{try{await Promise.all(en(n).map(async a=>{const s=await n[a];n[a]=s})),o(n)}catch(a){i(a)}}):n}function _u(e){const t=Ci();return e!==1/0&&setTimeout(()=>{t.resolve()},e<=0?0:e),t.promise}function Ci(){let e,t,r=!1;const n=new Promise((o,i)=>{e=a=>(r=!0,o(a)),t=a=>{r=!0,i(a)}});if(!e||!t)throw new Error(`Reject and resolve callbacks were not set by the promise constructor for ${Ci.name}.`);return{promise:n,resolve:e,reject:t,isSettled(){return r}}}function Ca(e,t){try{return Al(e,t),!0}catch{return!1}}function Al(e,t,r){if(e.length<t)throw new Error(r?`'${r}' is not at least '${t}' in length.`:`Array is not at least '${t}' in length.`)}function Lu(e,t){return An(e,"entryType")&&e.entryType===t}var ie;(function(e){e.ElementExample="element-example",e.Page="page",e.Root="root"})(ie||(ie={}));function bt(e,t){return e.controlType===t}var L;(function(e){e.Checkbox="checkbox",e.Color="color",e.Dropdown="dropdown",e.Hidden="hidden",e.Number="number",e.Text="text"})(L||(L={}));const Ml=Symbol("any-type"),qu={[L.Checkbox]:!1,[L.Color]:"",[L.Dropdown]:"",[L.Hidden]:Ml,[L.Number]:0,[L.Text]:""};function Ru(e,t){if(!e)return[];const r=[];return Object.entries(e).forEach(([n,o])=>{const i=qu[o.controlType];i!==Ml&&(typeof i!=typeof o.initValue&&r.push(new Error(`Control '${n}' in page '${t}' has invalid initValue '${o.initValue}': expected initValue of type ${typeof i} because the control is of type ${o.controlType}.`)),n||r.push(new Error(`'${t}' cannot have an empty control name.`)))}),r}function Ti(e,t){const r=rn(e.title);return e.parent?[...Ti(e.parent,!1),rn(e.parent.title)].concat(t?[r]:[]):t?[r]:[]}function rn(e){return ku(e).toLowerCase().replaceAll(/\s/g,"-")}function Nu({searchFor:e,searchIn:t}){return e.every((r,n)=>t[n]===r)}function U(e){const t={...e,entryType:ie.Page,elementExamples:{},descriptionParagraphs:e.descriptionParagraphs??[],controls:e.controls??{},errors:[]},r=new Set;return e.elementExamplesCallback&&e.elementExamplesCallback({defineExample(n){const o={...n,entryType:ie.ElementExample,parent:t,descriptionParagraphs:n.descriptionParagraphs??[],errors:[r.has(n.title)&&new Error(`Example title '${n.title}' in page '${e.title}' is already taken.`)].filter(Si)};r.add(n.title),t.elementExamples[rn(o.title)]=o}}),t}var _e;(function(e){e.Footer="book-footer",e.NavHeader="book-nav-header"})(_e||(_e={}));async function Lo(e=1){const t=Ci();function r(){requestAnimationFrame(()=>{e--,e?r():t.resolve()})}return r(),t.promise}const Du=globalThis.crypto;function zu(e=16){const t=Math.ceil(e/2),r=new Uint8Array(t);return Du.getRandomValues(r),Array.from(r).map(n=>n.toString(16).padStart(2,"0")).join("").substring(0,e)}async function Ou(e){return ju(e,1)}async function ju(e,t){return new Promise(r=>{new IntersectionObserver((o,i)=>{Al(o,1),i.disconnect(),r(o[0].intersectionRatio>=t)}).observe(e)})}function Cr(e,t){const r=e.currentTarget;if(!(r instanceof t))throw new Error(`Target from event '${e.type}' was not of type '${t.constructor.name}'. Got '${r==null?void 0:r.constructor.name}'.`);return r}/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const La=(e,t,r)=>{const n=new Map;for(let o=t;o<=r;o++)n.set(e[o],o);return n},Ku=rt(class extends je{constructor(e){if(super(e),e.type!==gr.CHILD)throw Error("repeat() can only be used in text expressions")}ct(e,t,r){let n;r===void 0?r=t:t!==void 0&&(n=t);const o=[],i=[];let a=0;for(const s of e)o[a]=n?n(s,a):a,i[a]=r(s,a),a++;return{values:i,keys:o}}render(e,t,r){return this.ct(e,t,r).values}update(e,[t,r,n]){var o;const i=Xu(e),{values:a,keys:s}=this.ct(t,r,n);if(!Array.isArray(i))return this.ut=s,a;const l=(o=this.ut)!==null&&o!==void 0?o:this.ut=[],c=[];let d,h,p=0,v=i.length-1,g=0,w=a.length-1;for(;p<=v&&g<=w;)if(i[p]===null)p++;else if(i[v]===null)v--;else if(l[p]===s[g])c[g]=at(i[p],a[g]),p++,g++;else if(l[v]===s[w])c[w]=at(i[v],a[w]),v--,w--;else if(l[p]===s[w])c[w]=at(i[p],a[w]),Ht(e,c[w+1],i[p]),p++,w--;else if(l[v]===s[g])c[g]=at(i[v],a[g]),Ht(e,i[p],i[v]),v--,g++;else if(d===void 0&&(d=La(s,g,w),h=La(l,p,v)),d.has(l[p]))if(d.has(l[v])){const $=h.get(s[g]),y=$!==void 0?i[$]:null;if(y===null){const k=Ht(e,i[p]);at(k,a[g]),c[g]=k}else c[g]=at(y,a[g]),Ht(e,i[p],y),i[$]=null;g++}else Gn(i[v]),v--;else Gn(i[p]),p++;for(;g<=w;){const $=Ht(e,c[w+1]);at($,a[g]),c[g++]=$}for(;p<=v;){const $=i[p++];$!==null&&Gn($)}return this.ut=s,Ju(e,c),ve}});/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let qo=class extends je{constructor(t){if(super(t),this.et=Y,t.type!==gr.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===Y||t==null)return this.ft=void 0,this.et=t;if(t===ve)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;const r=[t];return r.raw=r,this.ft={_$litType$:this.constructor.resultType,strings:r,values:[]}}};qo.directiveName="unsafeHTML",qo.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let qa=class extends qo{};qa.directiveName="unsafeSVG",qa.resultType=2;/**
 * @license
...
`,te=xr()({tagName:"vira-icon",hostClasses:{"vira-icon-fit-container":({inputs:e})=>!!e.fitContainer},styles:({hostClasses:e})=>m`
        :host {
    ...
    `,renderCallback:({inputs:e})=>e.icon?e.icon.svgTemplate:""});var ti;(function(e){e.Default="vira-button-default",e.Outline="vira-button-outline"})(ti||(ti={}));xr()({tagName:"vira-button",hostClasses:{"vira-button-outline-style":({inputs:e})=>e.buttonStyle===ti.Outline,"vira-button-disabled":({inputs:e})=>!!e.disabled},cssVars:{"vira-button-primary-color":"#0a89ff","vira-button-primary-hover-color":"#59b1ff","vira-button-primary-active-color":"#007ff6","vira-button-secondary-color":"#ffffff","vira-button-padding":"5px 10px","vira-button-internal-foreground-color":"","vira-button-internal-background-color":""},styles:({hostClasses:e,cssVars:t})=>m`
        ...
        button {
            ...
            align-items: center;
            border-radius: ${$n["vira-form-input-border-radius"].value};
    ...
    `,renderCallback:({inputs:e})=>{const t=e.icon?u`
        ...
        `}});var ri;(function(e){e.Header="header"})(ri||(ri={}));xr()({tagName:"vira-collapsible-wrapper",hostClasses:{"vira-collapsible-wrapper-expanded":({inputs:e})=>e.expanded},styles:({hostClasses:e})=>m`
        :host {
            display: flex;
...
`,z1=b({name:"LoaderAnimated24Icon",svgTemplate:u`
    ...
    `,renderCallback:({inputs:e,dispatch:t})=>{var n,o;const r=((o=e.router)==null?void 0:o.createRoutesUrl({...(n=e.router)==null?void 0:n.getCurrentRawRoutes(),...e.route}))??"#";return u`
            <a
                href=${r}
                ${S("click",i=>{(!e.router||Ui(i))&&(i.preventDefault(),window.scrollTo(0,0),t(new bn(e.route)))})}
            >
                <slot></slot>
            </a>
    ...
    `,renderCallback({inputs:e}){const t=e.flattenedNodes.map(r=>{if(!j1(r,e.selectedPath))return;const n=m`
            ...
            `});return u`
            <${$e.assign({route:Lt,router:e.router})}>
                <slot name=${_e.NavHeader}>Book</slot>
            </${$e}>
            <ul>
                ${t}
            </ul>
        `}});async function F1(e){await Lo(2);const t=e.shadowRoot.querySelector(".selected");if(!t)throw new Error("Failed to find selected nav tree element.");await Ou(t)||t.scrollIntoView({behavior:"smooth",block:"center"})}const tt=Te()({tagName:"book-error",styles:m`
        :host {
            display: flex;
            flex-direction: column;
            color: red;
    ...
    `,renderCallback({inputs:e}){return(Mn(e.message,"array")?e.message:[e.message]).map(r=>u`
                    <p>${r}</p>
    ...
    `,renderCallback({inputs:e,dispatch:t,events:r}){return Object.entries(e.config).length?Object.entries(e.config).map(([n,o],i)=>{if(o.controlType===L.Hidden)return"";const a=H1(e.currentValues[n],o,s=>{const l=Mn(e.fullUrlBreadcrumbs,"array")?e.fullUrlBreadcrumbs:e.fullUrlBreadcrumbs[n];if(!l)throw new Error(`Failed to find breadcrumbs from given control name: '${n}'`);t(new r.controlValueChange({fullUrlBreadcrumbs:l,newValues:{...e.currentValues,[n]:s}}))});return u`
    ...
    `,renderCallback:({inputs:e})=>{const t=e.currentRoute.paths.slice(1);return t.length?t.map((r,n,o)=>{const i=n>=o.length-1,a=o.slice(0,n+1),s=i?"":u`
            ...
            `}):u`
                &nbsp;
            `}}),ho=Te()({tagName:"book-breadcrumbs-bar",styles:m`
        :host {
    ...
    `,renderCallback({inputs:e,dispatch:t}){return u`
            ...
            <input
                ...
                ${S("input",async r=>{const n=r.currentTarget;if(!(n instanceof HTMLInputElement))throw new Error("Failed to find input element for search.");const o=n.value;await _u(200),n.value===o&&(n.value?t(new bn({paths:[ce.Search,encodeURIComponent(n.value)]})):t(new bn(Lt)))})}
            />
    ...
    `,renderCallback({inputs:e}){const t=[ce.Book,...e.elementExampleNode.fullUrlBreadcrumbs];return u`
        ...
        `}}),Us=Symbol("unset-internal-state"),Zs=Te()({tagName:"book-element-example-viewer",stateInitStatic:{isUnset:Us},renderCallback({state:e,inputs:t,updateState:r}){try{if(t.elementExampleNode.entry.errors.length)throw Il(t.elementExampleNode.entry.errors);if(!t.elementExampleNode.entry.renderCallback||typeof t.elementExampleNode.entry.renderCallback=="string")throw new Error(`Failed to render example '${t.elementExampleNode.entry.title}': renderCallback is not a function`);e.isUnset===Us&&r({isUnset:void 0,...t.elementExampleNode.entry.stateInitStatic});const n=t.elementExampleNode.entry.renderCallback({state:e,updateState:r,controls:t.currentPageControls});if(n instanceof Promise)throw new Error("renderCallback output cannot be a promise");return u`
            ...
            `}catch(n){return console.error(n),u`
                <${tt.assign({message:`${t.elementExampleNode.entry.title} failed: ${En(n)}`})}></${tt}>
    ...
    `,renderCallback({inputs:e}){return u`
        ...
        `}});function id(e,t,r,n){const o=Uo(r,n),i=[];if(o){const a=id(e,t,o,n);a&&i.push(a)}if(At(r,ie.Page)&&!e.includes(r)){const a=Hi(t,r.fullUrlBreadcrumbs);i.push({config:r.entry.controls,current:a,breadcrumbs:tn(a,()=>r.fullUrlBreadcrumbs)})}return i.reduce((a,s)=>({config:{...a.config,...s.config},current:{...a.current,...s.current},breadcrumbs:{...a.breadcrumbs,...s.breadcrumbs}}),{config:{},current:{},breadcrumbs:{}})}function V1({currentNodes:e,isTopLevel:t,router:r,isSearching:n,controls:o,originalTree:i}){if(!e.length&&n)return[u`
                No results
    ...
    `,events:{loadingRender:Z()},stateInitStatic:{lastElement:void 0},renderCallback:({inputs:e,dispatch:t,events:r,state:n,updateState:o})=>{const i=Zo(e.currentRoute.paths),a=V1({currentNodes:e.currentNodes,isTopLevel:!0,router:e.router,isSearching:!!i,controls:e.controls,originalTree:e.originalTree});return u`
            <${ho.assign({currentSearch:i,currentRoute:e.currentRoute,router:e.router})}></${ho}>

            ${de(e.showLoading,u`
                    <div
                        ${ln(()=>{t(new r.loadingRender(!0))})}
                        class="loading"
                    >
                        <${te.assign({icon:z1})}></${te}>
                    </div>
                    ${de(!!n.lastElement,u`
                            ${n.lastElement}
                ...
                `,u`
                    ...
                    <slot name=${_e.Footer}></slot>
                `)}
        `}});function U1(e,t,r){const n=Gs(e,t);if(n.length)return n;r(Lt);const o=Gs(e,Lt.paths);if(!o)throw new Error(`Tried to self-correct for invalid path ${t.join("/")}
                        but failed to do so.`);return o}function Gs(e,t){return e.filter(r=>Nu({searchFor:t.slice(1),searchIn:r.fullUrlBreadcrumbs}))}const fo=Di()({tagName:"element-book-app",events:{pathUpdate:Z()},stateInitStatic:{currentRoute:Lt,router:void 0,loading:!0,colors:{config:void 0,theme:Ds(void 0)},treeBasedControls:void 0,originalWindowTitle:void 0},styles:m`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{Ys(e,Zo(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.removeAllRouteListeners(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:r,updateState:n,dispatch:o,events:i})=>{var d,h,p,v,g,w,$;t._debug&&console.info("rendering element-book app");function a(y){return{...e.currentRoute,...y}}function s(y){const k=a(y);return!We(e.currentRoute,k)}function l(y){t.preventWindowTitleChange||(e.originalWindowTitle||n({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,y].filter(Si).join(" - "))}function c(y){if(!s(y))return;const k=a(y);e.router?e.router.setRoutes(k):n({currentRoute:{...e.currentRoute,...k}}),t.elementBookRoutePaths&&!We(t.elementBookRoutePaths,e.currentRoute.paths)&&o(new i.pathUpdate(k.paths??[]))}try{if(t.elementBookRoutePaths&&!We(t.elementBookRoutePaths,e.currentRoute.paths)&&c({paths:t.elementBookRoutePaths}),(d=t.internalRouterConfig)!=null&&d.useInternalRouter&&!e.router){const j=jh(t.internalRouterConfig.basePath);n({router:j}),j.addRouteListener(!0,ne=>{n({currentRoute:ne})})}else!((h=t.internalRouterConfig)!=null&&h.useInternalRouter)&&e.router&&e.router.removeAllRouteListeners();const y={themeColor:t.themeColor};if(!We(y,(p=e.colors)==null?void 0:p.config)){const j=Ds(y);n({colors:{config:y,theme:j}}),Vh(r,j)}const k=t._debug??!1,M=ph({entries:t.entries,debug:k});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),n({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:mc(M.tree,{children:(g=(v=e.treeBasedControls)==null?void 0:v.controls)==null?void 0:g.children,controls:t.globalValues})}}));const q=Zo(e.currentRoute.paths),le=(q?yh({flattenedNodes:M.flattenedNodes,searchQuery:q}):void 0)??U1(M.flattenedNodes,e.currentRoute.paths,c);l((w=le[0])==null?void 0:w.entry.title);const re=($=e.treeBasedControls)==null?void 0:$.controls;return re?(t._debug&&console.info({currentControls:re}),u`
                ...
                >
                    ...
                    <${xt.assign({controls:re,currentNodes:le,currentRoute:e.currentRoute,debug:k,originalTree:M.tree,router:e.router,showLoading:e.loading})}
                        ${S(xt.events.loadingRender,async j=>{await Lo();const ne=r.shadowRoot.querySelector(xt.tagName);ne?ne.scroll({top:0,behavior:"instant"}):console.error(`Failed to find '${xt.tagName}' for scrolling.`),await Lo(),n({loading:!j.detail})})}
                    >
                        <slot
                            name=${_e.Footer}
                            slot=${_e.Footer}
    ...
    `}),Mt=b({name:"InfoCircle16Icon",svgTemplate:u`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke=${f["toniq-icon-stroke-color"].value}
            fill=${f["toniq-icon-fill-color"].value}
    ...
    `}),Ks={interactionDuration:m`--toniq-interaction-transition-duration`,prettyDuration:m`--toniq-pretty-transition-duration`},W={interaction:m`var(${Ks.interactionDuration}, 84ms)`,pretty:m`var(${Ks.prettyDuration}, 300ms)`};function ea(){return e=>e}function go(e){return{foregroundColor:e.backgroundColor,backgroundColor:e.foregroundColor}}const ng=(()=>{const e={backgroundColor:m`#ffffff`,foregroundColor:m`#000000`},t={...e,foregroundColor:m`#00D093`},r={...e,foregroundColor:m`#ACADAD`},n={...e,foregroundColor:m`#D6D6D6`},o={...t},i={...t,foregroundColor:m`#00A876`},a={...t,foregroundColor:m`#1D6852`},s={...n},l={...e,foregroundColor:m`#EAFBF7`},c={...e,backgroundColor:m`#D2EEFA`},d=go(o),h=go(i),p=go(a),v=p,g={backgroundColor:m`#F1F3F6`,foregroundColor:e.foregroundColor},w={...g,foregroundColor:m`#9A9A9D`};return ea()({brandPrimary:t,pagePrimary:e,pageSecondary:r,pageTertiary:n,pageInteraction:o,pageInteractionHover:i,pageInteractionActive:a,divider:s,dividerFaint:l,dropShadow:c,pageDarkPrimary:v,accentPrimary:d,accentPrimaryHover:h,accentPrimaryActive:p,accentSecondary:g,accentTertiary:w})})(),wd=ng;function Qs(e,t){return B(`--toniq-${oi(e)}-${oi(t)}`)}const ta=Rt(wd,e=>({backgroundColor:Qs(e,"backgroundColor"),foregroundColor:Qs(e,"foregroundColor")}));function Ae(e,t){const r=wd[e][t],n=ta[e][t];return m`var(${n}, ${r})`}const x=Rt(ta,e=>({foregroundColor:Ae(e,"foregroundColor"),backgroundColor:Ae(e,"backgroundColor")}));function D(e){return m`
...
`))}const V=(()=>{const e=m`
    ...
    `,h=m`
        ${Pe("monospaceFont")}
    `;return ea()({toniqFont:e,normalWeightFont:t,boldFont:r,extraBoldFont:n,paragraphFont:o,boldParagraphFont:i,labelFont:a,boldLabelFont:s,h1Font:l,h2Font:c,h3Font:d,monospaceFont:h})})(),xn={popupShadow:m`
...
`,bg=b({name:"CryptoIcp16Icon",svgTemplate:u`
    ...
    `,renderCallback({inputs:e}){return u`
            <${te.assign(e)}></${te}>
        `}}),ai=m`8px`;var hr=(e=>(e.Default="default",e.Outline="outline",e.Secondary="secondary",e))(hr||{});const G=X()({tagName:"toniq-button",hostClasses:{"toniq-button-secondary":({inputs:e})=>e.buttonStyle==="secondary","toniq-button-outline":({inputs:e})=>e.buttonStyle==="outline","toniq-button-disabled":({inputs:e})=>!!e.disabled},styles:({hostClasses:e})=>m`
        :host {
            ${V.boldParagraphFont};
            display: inline-flex;
            position: relative;
    ...
    `,cleanupCallback:({state:e})=>{window.clearInterval(e.rotationIntervalId)},renderCallback({inputs:e,state:t,updateState:r,host:n}){e.enableAutomaticCycling&&t.rotationIntervalId==null?r({rotationIntervalId:window.setInterval(()=>{wo({host:n,direction:"right",allowWrapping:!0,blockIfHovering:!0})},e.cycleIntervalMs||Lg)}):!e.enableAutomaticCycling&&t.rotationIntervalId!=null&&(window.clearInterval(t.rotationIntervalId),r({rotationIntervalId:void 0}));const o=nl(t.scrollSnapPositions,0),i=nl(t.scrollSnapPositions,-1);return u`
            <div
                ${ir(()=>{r({scrollSnapPositions:ra(li(n)).x})})}
                class=${Jr}
            ...
            >
                <div class="arrow left">
                    <${T.assign({icon:Ki})}
                        ...
                        ${S("click",()=>{wo({allowWrapping:!1,blockIfHovering:!1,direction:"left",host:n})})}
                    ></${T}>
                </div>
                ${e.templates.map(a=>u`
    ...
    `,renderCallback({inputs:e,dispatch:t,events:r}){const n=u`
        ...
        `}});var ci=(e=>(e.Default="default",e.Secondary="secondary",e))(ci||{});const bo=X()({tagName:"toniq-chip",hostClasses:{"toniq-chip-secondary":({inputs:e})=>e.style==="secondary"},styles:({hostClasses:e})=>m`
        :host {
            display: inline-flex;
            vertical-align: middle;
            align-items: center;
    ...
    `,renderCallback({inputs:e}){const t=e.icon?u`
            ...
            ${t}
            <slot>${e.text}</slot>
        `}}),Rg="data-test-id",Ct=rt(class extends je{constructor(e){super(e),this.element=Ng(e,"testId",HTMLElement)}render(e){return this.element.setAttribute(Rg,e),ve}});function Ng(e,t,r){Dg(e,t);const n=e.element;if(!(n instanceof r))throw new Error(`${t} attached to non ${r.name} element.`);return n}function Dg(e,t){if(e.type!==gr.ELEMENT)throw new Error(`${t} directive can only be attached directly to an element.`);if(!e.element)throw new Error(`${t} directive found no element.`)}var di=(e=>(e.Up="up",e.Down="down",e))(di||{});const qr=X()({tagName:"toniq-dropdown",stateInitStatic:{dropdownOpen:!1},events:{selectChange:Z(),openChange:Z()},hostClasses:{"toniq-dropdown-disabled":({inputs:e})=>!!e.disabled},styles:({hostClasses:e})=>m`
        :host {
            display: inline-flex;
            vertical-align: middle;
            width: 288px;
    ...
    `,renderCallback({inputs:e,dispatch:t,events:r}){function n(o){if(e.linkDisabled){o.preventDefault();return}e.treatAsRouteChange&&Ui(o)&&(o.preventDefault(),e.scrollToTop&&window.scrollTo(0,0),t(new r.routeChangeTriggered))}return e.newTab?u`
            ...
            `}}),ui=360,Bd=8;function _d(e){return(e-Bd)/2}const Et=Fe({"main-image-size":ui,"secondary-image-size":_d(ui)}),Ne=X()({tagName:"toniq-featured-flip-card-footer",styles:m`
        :host {
            display: inline-flex;
    ...
    `],[`
        ...
        <\/script>
    `])),e.imageType,r??"",C.Svg,C.Html,C.Image,C.Video,C.Text,C.Json,C.Audio,C.Svg,C.Html,C.Image,C.Video,C.Text,C.Json,C.Audio,vt.FromChild,vt.FromChild,K.ImageElementLoaded,K.FrameReady,K.SendScale,K.SendScalingMethod,K.SendSize,K.ForceSize,K.SizeDetermined,C.Json,C.Text,Dr.y,n,C.Audio),a=u(Tl||(Tl=Un([`
        <!DOCTYPE html>
...
`)}const _m=[C.Html,C.Video,C.Audio,C.Pdf],Lm=[C.Html,C.Text,C.Json];function pl({blockInteractionInput:e,imageType:t,allowScrolling:r}){return typeof e=="boolean"?!e:_m.includes(t)?!0:!!(r&&Lm.includes(t))}const qm=1e4,Rm={imageData:J0({async updateCallback(e,t){if(t.updateTriggered(),!e.imageUrl)return new Promise(()=>{});const r={imageUrl:e.imageUrl,blockAutoPlay:!!e.blockAutoPlay,textTransformer:t.textTransformer,allowPersistentCache:!e.blockPersistentCache,removeConsoleLogs:!e.allowConsoleLogs};let n;try{n=await Gg(e.timeoutMs,fl(r))}catch{await Zg(1e3);try{n=await fl(r)}catch(i){throw i}}if(n)return n;throw new Error("no image data result")}}),error:void 0},zr=Di()({tagName:oa,stateInitStatic:Rm,events:{settled:Z(),imageDataCalculated:Z(),errored:Z()},styles:m`
    ...
    `,cleanupCallback({host:e}){const t=e.shadowRoot.querySelector("iframe"),r=e[Co];t&&r&&(t.srcdoc=r)},renderCallback({state:e,inputs:t,updateState:r,host:n,dispatch:o,events:i}){const a=t.timeoutMs??qm;e.imageData.updateTrigger(Ug({...t,timeoutMs:a},["textTransformer"]),{textTransformer:t.textTransformer,updateTriggered(){e.error&&r({error:void 0}),n.classList.remove(pe.HideLoading),o(new i.settled(!1)),n.classList.remove(pe.VerticallyCenter)}});const s=t.min&&t.max?hi({box:t.min,max:t.max}):t.min,l=t.max,c=t.forcedOriginalImageSize?Od({min:s,max:l,box:t.forcedOriginalImageSize}):void 0,d=Ka(e.imageData,"",$=>{if(o(new i.imageDataCalculated($)),$.imageType===C.Pdf)return u`
                        <iframe
                            src=${$.imageUrl}
                            ${ln(async y=>{try{await du({forcedFinalImageSize:t.forcedFinalImageSize,host:n,iframeElement:y,imageData:$,imageDimensions:l??{width:500,height:500},max:l,min:s,sendSizeMessage:!1,timeoutMs:a}),n[Co]="",o(new i.settled(!0)),n.classList.add(pe.HideLoading)}catch(k){const M=$o(k);if(M instanceof bi)return;console.error(M),r({error:M}),o(new i.errored(M))}})}
                        ></iframe>
                    `;{const y=pl({allowScrolling:t.allowScrolling,blockInteractionInput:t.blockInteraction,imageType:$.imageType})&&!!t.allowScrolling;return u`
                        <iframe
                            ...
                            ${ln(async k=>{try{const M=await Pm({min:s,max:l,host:n,iframeElement:k,imageData:$,forcedFinalImageSize:t.forcedFinalImageSize,forcedOriginalImageSize:c,timeoutMs:a});n[Co]=M,o(new i.settled(!0)),n.classList.add(pe.HideLoading)}catch(M){const q=$o(M);if(q instanceof bi)return;console.error(q),r({error:q}),o(new i.errored(q))}})}
                        ></iframe>
                        <slot name="loaded"></slot>
                    `}},$=>{r({error:$}),o(new i.errored($o($)))}),h=Ka(e.imageData,gl,$=>pl({allowScrolling:t.allowScrolling,blockInteractionInput:t.blockInteraction,imageType:$.imageType})?"":gl,()=>""),p=e.imageData instanceof Error?e.imageData:e.error,v=p?m`
                  max-width: 100%;
                  max-height: 100%;
              `:c?m`
                  width: ${c.width}px;
...
`,Co="latest-frame-srcdoc",ut=X()({tagName:"toniq-flip-card",events:{flippedChange:Z()},styles:m`
        :host {
            max-width: 100%;
            display: inline-flex;
            perspective: 1200px;
    ...
    `,renderCallback({inputs:e,state:t,updateState:r,host:n,dispatch:o,events:i}){var v,g,w;const a=e.mainImageSize||ui,s=_d(a);Oo({onElement:n,forCssVar:Et["main-image-size"],toValue:`${a}px`}),Oo({onElement:n,forCssVar:Et["secondary-image-size"],toValue:`${s}px`});const l=["View",e.viewButtonTitle].filter(Ji).join(" "),c=u`
            <h3>${e.title}</h3>
        `,d=e.imageUrls[0],h=u`
        ...
        `}});function $i({input:e,matcher:t}){return!e||!t?!0:e.length>1?!!e.split("").every(r=>$i({input:r,matcher:t})):t instanceof RegExp?!!e.match(t):t.includes(e)}function uu({value:e,allowed:t,blocked:r}){const n=t?$i({input:e,matcher:t}):!0,o=r?$i({input:e,matcher:r}):!1;return n&&!o}function ml(e){if(!e.value)return{filtered:e.value,blocked:""};const{filtered:t,blocked:r}=e.value.split("").reduce((n,o)=>(uu({...e,value:o})?n.filtered.push(o):n.blocked.push(o),n),{filtered:[],blocked:[]});return{filtered:t.join(""),blocked:r.join("")}}var yi=(e=>(e.Default="default",e.Outline="outline",e))(yi||{});const Or=X()({tagName:"toniq-input",hostClasses:{"toniq-input-outline":({inputs:e})=>e.style==="outline","toniq-input-has-a-value":({inputs:e})=>!!e.value,"toniq-input-disabled":({inputs:e})=>!!e.disabled},events:{valueChange:Z(),inputBlocked:Z()},styles:({hostClasses:e})=>m`
            :host {
                position: relative;
                display: inline-flex;
                width: 224px;
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:r,state:n,updateState:o}){if(!e.text)return u``;const i=e.text,a=jm(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,d=c?zm(i,a):i,h=c?i:"",p=s?pd:l?fd:void 0,v=p?u`
        ...
        `;return d?s?u`
                ...
                `:u`
                    ${g}
                `:u``}}),vl="...";function Fm(e,t,r=7,n=5){let o;e=Qt(e,1,t),r=Qt(r,n,t);const i=r-5,a=r-3;t<=r?o=r:o=e<a||e>t-a?a:i;const s={start:Math.round(e-o/2),end:Math.round(e+o/2)};(s.start-1===1||s.end+1===t)&&(s.start+=1,s.end+=1);const l=e>t-a&&t>r?To(t-o,t):e>o?To(Math.min(s.start,t-o),Math.min(s.end,t)):To(1,Math.min(t,o+1));function c(h,p){return l.length+1!==t?p:[h]}const d=l[l.length-1];if(d&&d<t){const h=c(t,[vl,t]);return[...l,...h]}else return l[0]!==1?c(1,[1,vl]).concat(l):l}function To(e,t){const r=t-e+1;return Array.from({length:r},(n,o)=>e+o)}X()({tagName:"toniq-pagination",styles:m`
        :host {
            display: flex;
        }
...
`,$l=m`
    transform: scale(1.2);
`;function Gt(e){requestAnimationFrame(()=>{const t=hu(e.instanceInputs,e).elementValue;Xm(t,e)&&(e.setAttribute("disabled","true"),Gt(e))})}const R=X()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:Z()},styles:m`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Gt(e)}),e.addEventListener("keydown",()=>{Gt(e)}),e.addEventListener("keyup",()=>{Gt(e)})},renderCallback({inputs:e,host:t,events:r,dispatch:n,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:d,elementLimits:h,rangeWidth:p}=hu({...e},t);if(Gt(t),pr(d))return v(a,d,h);return w(a,d,h);function v($,y,k){const M={left:St((p-st)*(y.min-k.min)/(k.max-k.min)+st/2),right:St((p-st)*(k.max-y.max)/(k.max-k.min)+st/2)},q=Eo($.min,c,l),ee=Eo($.max,c,l);requestAnimationFrame(()=>{const we=Zm(t);we!==o.labelOverlap&&i({labelOverlap:we})});const le=(k.max-y.max)/(k.max-k.min)>.5,re=Io({value:y.min,limits:{min:k.min,max:y.max},flip:!0}),j=Io({value:y.max,limits:{min:y.min,max:k.max},flip:!1}),ne=o.labelOverlap&&le?o.labelOverlap:0,zt=o.labelOverlap&&!le?o.labelOverlap:0;return u`
                <div
                    class="range"
                    ${ir(()=>{i({rangeWidth:xi(t)})})}
                >
                    <div
                        class="progress"
                    ...
                    >
                        <span
                            ...
                            style="margin-left: ${mo(re)}"
                        >
                            <span
                                class="${_.labelPixelMarginWrapper}"
                                style="margin-right: ${St(zt)}"
                                ${Ct(Ut.lowerLabel)}
                            >
                                ${q}
                            </span>
                    ...
                    >
                        <span
                            class="${_.labelPercentMarginWrapper}"
                            style="margin-right: ${mo(j)}"
                        >
                            <span
                                class="${_.labelPixelMarginWrapper}"
                                style="margin-left: ${St(ne)}"
                                ${Ct(Ut.upperLabel)}
                            >
                                ${ee}
                            </span>
                    ...
                    <div class="slider-wrapper">
                        <input
                            ...
                            .max=${k.max}
                            .value=${y.min}
                            ${S("input",we=>{const wt=we.target,Ot={...$,min:Ao(Number(wt.value),s,l)};g(Ot)})}
                        />
                        <input
                            ?disabled=${e.disabled??!1}
                            type="range"
                            ...
                            .value=${y.max}
                            ${Ct(Ut.slider)}
                            ${S("input",we=>{const wt=we.target,Ot={...$,max:Ao(Number(wt.value),s,l)};g(Ot)})}
                        />
                    </div>
                </div>
            `}function g($){i({internalValue:$}),e.disabled||n(new r.valueChange($))}function w($,y,k){const M=St((p-st)*(k.max-y)/(k.max-k.min)+st/2),q=Eo($,c,l),ee=Io({value:y,limits:k,flip:!1});return u`
                <div
                    class="range"
                    ${ir(()=>{i({rangeWidth:xi(t)})})}
                >
                    ...
                    <input
                        ...
                        .value=${y}
                        ${Ct(Ut.slider)}
                        ${S("input",le=>{const re=le.target,j=Ao(Number(re.value),s,l);g(j)})}
                    />
                </div>
            `}}});var fu=(e=>(e.Default="default",e.TextOnly="text-only",e))(fu||{});const Mo=X()({tagName:"toniq-toggle-button",hostClasses:{"toniq-toggle-button-text-only":({inputs:e})=>e.style==="text-only","toniq-toggle-button-disabled":({inputs:e})=>!!e.disabled},styles:({hostClasses:e})=>m`
        :host {
            ${V.boldParagraphFont};
            ${Ce};
            display: inline-flex;
    ...
    `,stateInitStatic:{clickToggled:!1},renderCallback({inputs:e,state:t,updateState:r}){return u`
        ...
        `}}),Yt=X()({tagName:"toniq-top-tabs",events:{valueChange:Z()},cssVars:{"toniq-top-tabs-selected-border-width":"4px","toniq-top-tabs-tab-vertical-padding":"8px"},styles:({cssVars:e})=>m`
        :host {
            display: block;
        }
    ...
    `,renderCallback({inputs:e,dispatch:t,events:r}){return u`
        ...
        `}}),pu=U({title:"Data",parent:void 0}),In=X()({tagName:"toniq-icon-book-viewer",styles:m`
        :host {
            display: inline-flex;
            padding: 8px;
            border-radius: 8px;
    ...
    `,renderCallback({inputs:e}){return u`
            <${T.assign({icon:e.icon})}></${T}>
        `}}),Fn=Object.values(Ze).reduce((e,t)=>(t.forEach(r=>{if(r.name in e)throw new Error(`Icon name duplicate: '${r.name}'`);e[r.name]=r}),e),{}),Km=Object.keys(Fn).sort();function ha(e){return{controlType:L.Dropdown,initValue:e,options:["None",...Km]}}const gu={"CSS color":{controlType:L.Color,initValue:""},[String(f["toniq-icon-stroke-color"].name)]:{controlType:L.Color,initValue:""},[String(f["toniq-icon-fill-color"].name)]:{controlType:L.Color,initValue:""},[String(f["toniq-icon-stroke-width"].name)]:{controlType:L.Color,initValue:""},[String(f["toniq-icon-stroke-width"].name)]:{controlType:L.Number,initValue:2}};function Qr(e){return Object.entries(e).filter(([,r])=>r!==""&&r!=null).map(([r,n])=>(r.toLowerCase()==="css color"&&(r="color"),tp(n,"number")&&(n=op({value:n,suffix:"px"})),`${r}: ${n};`)).join(`
...
`,nv=U({parent:Q,title:he.tagName,descriptionParagraphs:["Carousel that uses native scroll APIs.","Supports differently sized elements, optional automatic scrolling, manual mouse or touch scrolling, click scrolling with buttons, etc."],elementExamplesCallback({defineExample:e}){e({title:"default",styles:yl,renderCallback(){return u`
                ...
                `}}),e({title:"banner style",styles:yl,renderCallback(){return u`
                    <${he.assign({enableAutomaticCycling:!0,style:si.BannerStyle,templates:Ze["core-24"].map(t=>{const r=m`
                            ...
                            `;return u`
                                <${T.assign({icon:t})} style=${r}></${T}>
                            `})})}></${he}>
                    <${he.assign({enableAutomaticCycling:!0,style:si.BannerStyle,templates:[Ze["core-24"][0]].map(t=>{const r=m`
                                /* make sure this width matches the ToniqCarousel width */
                                width: 800px;
                                max-width: 100%;
                                padding: 100px 0;
...
`))}const av=[{title:"default",inputs:{}},{title:"disabled",inputs:{disabled:!0}}],Po=[{inputs:{checked:!1}},{inputs:{checked:!0}},{extraEntries:["With much longer checkbox label string"],inputs:{checked:!1}}],sv=U({parent:Q,title:Ue.tagName,controls:{Text:{controlType:L.Text,initValue:"Text"},...ov(Ue)},elementExamplesCallback({defineExample:e}){av.forEach(t=>{e({title:t.title,stateInitStatic:{checkedStatuses:Po.map(r=>!!r.inputs.checked),extraEntryStatuses:Po.map(r=>(r.extraEntries??[]).map(()=>!1))},styles:m`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Po.map((i,a)=>{const s=(i.extraEntries??[]).map((c,d)=>{var h;return u`
                                    <${Ue.assign({...t.inputs,...ii(i.inputs,["checked"]),checked:!!((h=r.extraEntryStatuses[a])!=null&&h[d]),text:c})}
                                        ${S(Ue.events.checkedChange,()=>{const p=[...r.extraEntryStatuses];p[a][d]=!p[a][d],n({extraEntryStatuses:p})})}
                                    ></${Ue}>
                                `}),l=iv(o);return u`
                            <div class="checkbox-group" style=${l}>
                                <${Ue.assign({...t.inputs,...ii(i.inputs,["checked"]),checked:r.checkedStatuses[a],text:o.Text})}
                                    ${S(Ue.events.checkedChange,()=>{const c=[...r.checkedStatuses];c[a]=!c[a],n({checkedStatuses:c})})}
                                ></${Ue}>
                                ${s}
                            </div>
                        `})}})})}}),lv=U({parent:Q,title:bo.tagName,elementExamplesCallback({defineExample:e}){const t=[{inputs:{text:"text"}},{inputs:{text:"text + icon",icon:Mt}},{inputs:{icon:Mt}},{inputs:{},template:u`
                    HTML child
                ...
                `},{customStyle:m`
                    width: 150px;
                    height: 24px;
                `,inputs:{text:"custom size"}}];[{title:"default",inputs:{style:ci.Default}},{title:"secondary style",inputs:{style:ci.Secondary}}].forEach(n=>{e({title:n.title,renderCallback(){return t.map(o=>u`
                        <${bo.assign({...n.inputs,...o.inputs})}
                            style=${o.customStyle}
                        >${de(!!o.template,o.template)}</${bo}>
        ...
        `},{customStyle:m`
            max-height: 30px;
            min-height: 30px;
        `}],dv=U({title:qr.tagName,parent:Q,controls:{Selected:{controlType:L.Dropdown,initValue:jr[0].label,options:jr.map(e=>e.label)},Direction:{controlType:L.Dropdown,initValue:"Down",options:rp(di)},Icon:ha(ld.name),Prefix:{controlType:L.Text,initValue:"Sort by: "},"Force open":{controlType:L.Checkbox,initValue:!1}},elementExamplesCallback({defineExample:e}){cv.forEach(t=>{e({title:t.title,stateInitStatic:{selected:xl.map(r=>{var n;return(n=r.inputs)==null?void 0:n.value})},styles:m`
                    :host {
                        display: flex;
                        gap: 16px;
                        flex-wrap: wrap;
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return xl.map((i,a)=>{const s=m`
                            ...
                            ${i.customStyle??m``};
                        `;return u`
                            <${qr.assign({...t.inputs,...i.inputs,options:jr,value:r.selected[a]??jr.find(l=>l.label===o.Selected),icon:Fn[o.Icon],selectedLabelPrefix:o.Prefix,direction:di[o.Direction],_forceOpenState:o["Force open"]||void 0})}
                                style=${s}
                                ${S(qr.events.selectChange,l=>{const c=[...r.selected];c[a]=l.detail,n({selected:c})})}
                            ></${qr}>
                        `})}})})}}),kl="/toniq-labs-design-system";function uv(...e){const r=[globalThis.location.pathname.startsWith(kl)?kl:"",...e].filter(Ji);return ip(...r)}const Bo=Array(30).fill(uv("/toniq-labs-logo.png")),ki=["Hello there.","There is stuff here."],Fr=ki.concat(Array(30).fill(ki)),hv=U({title:ae.tagName,parent:Q,elementExamplesCallback({defineExample:e}){e({title:"basic",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${ae.assign({infoParagraphs:Fr,imageUrls:Bo,socialUrls:Eg,title:"Featured Stuff",viewButtonTitle:"Stuff"})}></${ae}>
                `}}),e({title:"with missing inputs",stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${ae.assign({imageUrls:Bo,title:"Featured Stuff",infoParagraphs:void 0})}></${ae}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback(){return u`
                    <${ae.assign({imageUrls:Bo,infoParagraphs:ki,title:"Featured Stuff"})}></${ae}>
            ...
            `,stateInitStatic:{flipped:!1},renderCallback({state:t,updateState:r}){return u`
                ...
                `}})}}),pv=U({parent:Q,title:Ee.tagName,elementExamplesCallback({defineExample:e}){[{title:"default",inputs:{}},{title:"hover styles",inputs:{withHoverStyles:!0}},{title:"route link",inputs:{treatAsRouteChange:!0}},{title:"link disabled",inputs:{linkDisabled:!0}}].forEach(r=>{e({title:r.title,descriptionParagraphs:r.descriptions,renderCallback(){return u`
                    ...
                    `}})})}}),gv=U({title:T.tagName,parent:Q,controls:gu,elementExamplesCallback({defineExample:e}){const t=[{icon:yd},{icon:$d},{icon:ud},{icon:Mt},{icon:void 0}];e({title:"sizes",styles:m`
                :host {
                    display: flex;
                    gap: 16px;
                    align-items: center;
            ...
            `,renderCallback({controls:r}){return u`
                    <${T.assign({icon:Mt,fitContainer:!0})}
                        style=${Qr(r)}
                    ></${T}>
                ...
                `},{customStyles:m`
                    height: 40px;
                    width: 140px;
                `}];[{title:"default",inputs:{style:yi.Default}},{title:"outline",inputs:{style:yi.Outline}},{title:"disabled",inputs:{disabled:!0}}].forEach(n=>{e({title:n.title,stateInitStatic:{value:""},styles:m`
                    :host {
                        display: flex;
                        flex-wrap: wrap;
                        gap: 16px;
                ...
                `,renderCallback({controls:o,state:i,updateState:a}){return t.map(s=>(o["External value"]&&o["External value"]!==i.value&&a({value:o["External value"]}),u`
                            <${Or.assign({...n.inputs,value:o["External value"]||i.value,icon:Fn[o.Icon],placeholder:o.Placeholder,suffix:o.Suffix,disableBrowserHelps:o["No browser helps"],allowedInputs:o["Exclusive characters"],blockedInputs:o["Blocked characters"]})}
            ...
            `,renderCallback(){return u`
                ...
                `}})}}),Zt=[{value:"1",label:"Entry 1"},{value:"2",label:"Entry 2"},{value:"3",label:"Entry 3"}],be={basic:Zt,longText:[{value:"first",label:"Entry 1 with really really really really really really really really really long label"},...Zt.slice(1)],disabled:[{...Zt[0],disabled:!0},...Zt.slice(1)],noLabels:Z1(Zt,e=>({...e,label:void 0}))},wv=U({title:F.tagName,parent:Q,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{selectedValue:be.basic[0].value},renderCallback({state:t,updateState:r}){return u`
...
`,_o={min:10,max:50},bv=U({title:R.tagName,parent:Q,elementExamplesCallback({defineExample:e}){e({title:"Default",stateInitStatic:{value:20},styles:m`
                ${De}
            `,renderCallback({state:t,updateState:r}){return u`
                    <${R.assign({value:t.value,..._o})}
            ...
            `,renderCallback({state:t,updateState:r}){return u`
                ...
                ${De}
            `,renderCallback({state:t,updateState:r}){return u`
                    <${R.assign({value:t.value,..._o,suffix:"ICP"})}
                        ${S(R.events.valueChange,n=>{if(typeof n.detail!="number")throw new Error("was expecting a single numeric slider value");r({value:n.detail})})}
                    ></${R}>
            ...
            `,renderCallback({state:t,updateState:r}){return u`
                ...
                `,renderCallback({state:r,updateState:n,controls:o}){return Sl.map((i,a)=>u`
                            <${Mo.assign({...t.inputs,toggled:r.buttonStates[a],icon:Fn[o.Icon],text:o.Text,...ii(i.inputs,["toggled"])})}
        ...
        `,inputs:{value:"hi",tabs:["hi","bye","hello","so long"]}},{title:"really long tab",extraStyles:m``,inputs:{value:"hi",tabs:["hi","bye","hello","So long, farewell, auf Wiedersehen, adieu. Adieu, adieu, to you and you and you"]}}],Tv=U({title:Yt.tagName,parent:Q,elementExamplesCallback({defineExample:e}){Cv.forEach(t=>{e({title:t.title,stateInitStatic:{selectedTab:t.inputs.value},styles:m`
                    ${t.extraStyles??m``}
                `,renderCallback({state:r,updateState:n}){return u`
                        <${Yt.assign({tabs:t.inputs.tabs.map(o=>({label:o,value:o})),value:r.selectedTab})}
                            ${S(Yt.events.valueChange,o=>{console.log(o),n({selectedTab:o.detail})})}
                        ></${Yt}>
                    `}})})}}),mu=U({title:"Icons",parent:void 0,controls:gu}),Iv=Object.entries(Ze).map(([e,t])=>U({title:e,parent:mu,elementExamplesCallback({defineExample:r}){t.map(n=>r({title:n.name,renderCallback({controls:o}){return u`
                                <${In.assign({icon:n})}
                                    style=${Qr(o)}
                                ></${In}>
                            `}}))}}));function vu(e){const t=Ev(e),r=Rt(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return qe(r).reduce((o,i)=>{const a=r[i];return a&&a[1]&&a[2]&&(o[i]={cssVarName:a[1],defaultValue:a[2]}),o},{})}function Ev(e){typeof e!="string"&&(e=String(e));const n=`{"${G1(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((a,s)=>(a[s]=o[s],a),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const fa=U({title:"Styles",parent:void 0}),Av=m`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function _v(e,t,r){const n=vu(r);return e({title:t,styles:Bv,renderCallback(){return u`
            ...
            `}})}const Lv=U({title:"Fonts",parent:fa,elementExamplesCallback({defineExample:e}){qe(V).map(t=>{const r=V[t];return _v(e,t,r)})},descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),qv=[Q,mu,fa,pu],Rv=[...Iv,rv,nv,sv,lv,dv,hv,fv,pv,gv,mv,vv,wv,bv,yv,...Sv,Qm,Pv,Lv,Tv,tv].sort((e,t)=>e.title.localeCompare(t.title)),Nv=[...qv,...Rv];Ln({tagName:"toniq-design-system-app",styles:m`
        :host {
            display: block;
            height: 100%;
            width: 100%;
    ...
    `,renderCallback(){return u`
            <${fo.assign({internalRouterConfig:{basePath:"toniq-labs-design-system",useInternalRouter:!0},entries:Nv,themeColor:"#00D093"})}>
