...
`,$l=ee({title:"Data",parent:void 0}),Ts="toniq-",{defineElement:oe,defineElementNoInputs:lf}=$a({assertInputs:e=>{if(!e.tagName.startsWith(Ts))throw new Error(`Tag name should start with '${Ts}' but got '${e.tagName}'`)}}),v=oe()({tagName:"toniq-icon",hostClasses:{"icon-fit":!1},styles:({hostClassSelectors:e})=>f`
    ...
    `),Xt={"core-16":[Lu,Bu,Ru,Yt],"core-24":[zu,ju,Jo,Nu,Cl,Xo,$o,Hu,Ou,Du,Fu,Zu,Vu,Wu,Sl,Ml,qu,Uu,Mt,Gu,Yu,Ju,Xu,Al,Il,Ku,Qu,e2,t2,El,r2,n2,o2,i2,s2,a2,l2,c2,d2,u2,h2,p2,f2,Tl,g2,m2,v2,w2,b2,$2,yo,Pl,y2,x2,k2,C2,S2,Jt,M2,A2,I2,E2,T2,P2],"core-32":[Ll],"core-48":[Bl],"core-64":[_l,L2,B2],logos:[_2],"third-party-brands":[Rl,R2,zl,z2,jl,Nl,j2,Hl,Ol]},Nr="templates-container",N2=4e3,V=oe()({tagName:"toniq-carousel",cssVars:{"arrow-margin":"40px"},hostClasses:{"banner-style":!1},stateInit:{currentScrollPosition:{left:0,right:1/0},templatesWrapperHeight:0,scrollSnapPositions:[],rotationIntervalId:void 0,enableRotation:!0},styles:({cssVarValues:e,hostClassSelectors:t})=>f`
        :host {
            display: block;
            position: relative;
            overflow-y: hidden;
    ...
    `,cleanupCallback({host:e}){const t=e.shadowRoot.querySelector("iframe"),r=e[On];t&&r&&(t.srcdoc=r)},renderCallback({state:e,inputs:t,updateState:r,host:n,dispatch:o,events:i}){const s=t.timeoutMs??Th,a=e.imageData instanceof Error?e.imageData:e.error;r({imageData:{createPromise:async()=>{if(e.error&&r({error:void 0}),n.classList.remove(ce.HideLoading),o(new i.settled(!1)),n.classList.remove(ce.VerticallyCenter),!t.imageUrl)return new Promise(async(M,_)=>{await Rs(s),_(new Error("An imageUrl was never provided to vir-resizable-image."))});const y={imageUrl:t.imageUrl,blockAutoPlay:!!t.blockAutoPlay,textTransformer:t.textTransformer};let C;try{C=await Q2(s,Ns(y))}catch{await Rs(1e3);try{C=await Ns(y)}catch(_){throw _}}if(C)return C;throw new Error("no image data result")},trigger:{...X2(t,Lh)}}});const l=t.min&&t.max?Co({box:t.min,max:t.max}):t.min,c=t.max,u=t.forcedOriginalImageSize?Ul({min:l,max:c,box:t.forcedOriginalImageSize}):void 0,d=Ri(e.imageData,"",y=>(o(new i.imageDataCalculated(y)),y.imageType===E.Pdf?h`
                    ...
                    `:h`
                        <iframe
                            ...
                            ${_i(async C=>{try{const M=await Ih({min:l,max:c,host:n,iframeElement:C,imageData:y,forcedFinalImageSize:t.forcedFinalImageSize,forcedOriginalImageSize:u,timeoutMs:s});n[On]=M,o(new i.settled(!0)),n.classList.add(ce.HideLoading)}catch(M){const _=Nn(M);if(_ instanceof So)return;console.error(_),r({error:_}),o(new i.errored(_))}})}
                        ></iframe>
                        <slot name="loaded"></slot>
                    `),y=>{r({error:y}),o(new i.errored(Nn(y)))}),p=Ri(e.imageData,Hs,y=>!t.blockInteraction&&[E.Html,E.Video,E.Audio,E.Pdf].includes(y.imageType)?"":Hs,()=>""),w=a?f`
                  max-width: 100%;
                  max-height: 100%;
              `:u?f`
                  width: ${u.width}px;
        ...
        `;return u?a?h`
                ...
                `:l?h`
                    <button
                        ...
                        ${A("click",async()=>{await Jh(i),t(new r.copied),n.showCopiedTextTimeoutId!=null&&window.clearTimeout(n.showCopiedTextTimeoutId),o({showCopiedTextTimeoutId:window.setTimeout(()=>{o({showCopiedTextTimeoutId:void 0})},5e3)})})}
                    >
                        ${m} ${w}
                    </button>
                `:h`
...
`;function Zt(e){requestAnimationFrame(()=>{const t=fc(e.instanceInputs,e).elementValue;dp(t,e)&&(e.setAttribute("disabled","true"),Zt(e))})}const L=oe()({tagName:"toniq-slider",stateInit:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:ue()},styles:f`
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{Zt(e)}),e.addEventListener("keydown",()=>{Zt(e)}),e.addEventListener("keyup",()=>{Zt(e)})},renderCallback:({inputs:e,host:t,events:r,dispatch:n,state:o,updateState:i})=>{const{actualValue:s,logRange:a,isLogScale:l,suffix:c,elementValue:u,elementLimits:d,rangeWidth:p}=fc({...e},t);if(Zt(t),ar(u))return w(s,u,d);return k(s,u,d);function w(y,C,M){const _={left:St((p-it)*(C.min-M.min)/(M.max-M.min)+it/2),right:St((p-it)*(M.max-C.max)/(M.max-M.min)+it/2)},X=Zn(y.min,c,l),he=Zn(y.max,c,l);requestAnimationFrame(()=>{const pe=ip(t);pe!==o.labelOverlap&&i({labelOverlap:pe})});const Le=(M.max-C.max)/(M.max-M.min)>.5,Fe=Fn({value:C.min,limits:{min:M.min,max:C.max},flip:!0}),ie=Fn({value:C.max,limits:{min:C.min,max:M.max},flip:!1}),tt=o.labelOverlap&&Le?o.labelOverlap:0,br=o.labelOverlap&&!Le?o.labelOverlap:0;return h`
                <div
                    class="range"
                ...
                >
                    ...
                    <div class="slider-wrapper">
                        <input
                            ...
                            .max=${M.max}
                            .value=${C.min}
                            ${A("input",pe=>{const mt=pe.target,Rt={...y,min:Vn(Number(mt.value),a,l)};m(Rt)})}
                        />
                        <input
                            ?disabled=${e.disabled??!1}
                            type="range"
                            ...
                            .value=${C.max}
                            ${At(Ot.slider)}
                            ${A("input",pe=>{const mt=pe.target,Rt={...y,max:Vn(Number(mt.value),a,l)};m(Rt)})}
                        />
                    </div>
                </div>
    ...
    `,renderCallback:({inputs:e})=>{const t=e.icon?h`
        ...
        `}}),up=J({title:"Social Urls",parent:$l,examples:[{title:"Icons",styles:f`
            ...
            `,render(){return h`
                    <${V}
                        ${g(V,{enableAutomaticCycling:!0,cycleIntervalMs:1e3,templates:Xt["core-24"].map(e=>{const t=bh({min:0,max:150}),r=f`
                                    padding: 100px ${t}px;
                                    border: 1px solid ${S.pageInteraction.foregroundColor};
                                    border-radius: 12px;
                                `;return h`
                                ...
                                `})})}
                    ></${V}>
                `}}]}),gp=J({title:V.hostClasses["banner-style"],parent:ei,descriptionParagraphs:[`${V.tagName} style for a single, full-width element.`],examples:[{title:V.hostClasses["banner-style"],styles:f`
                :host {
                    max-width: 100%;
                }
            ...
            `,stateInit:{flipped:!1},render({state:e,updateState:t}){return h`
                ...
                `,render(){return h`
                        <${v}
                            ${g(v,{icon:Mt})}
                        ></${v}>
                    `}}]},(e,t)=>J({title:e,examples:t,parent:$c})),Pp=[$c,...Object.values(Tp)],yc=ee({title:"Input",parent:le}),Lp=J({title:T.tagName,parent:yc,examples:[{title:"Assigned value",stateInit:{value:"init value"},render({state:e,updateState:t}){return h`
                    <${T}
                        ${g(T,{value:e.value})}
...
`,qn={min:10,max:50},Np=J({title:L.tagName,parent:Cc,examples:[{title:"Default",stateInit:{value:20},styles:f`
            ...
            `,render({state:e,updateState:t}){return h`
                ...
                `}}]}const Op=Pe({[ge.tagName]:Ys(""),[ge.hostClasses.textOnly]:Ys(ge.hostClasses.textOnly)},(e,t)=>J({title:e,examples:t,parent:Sc})),Dp=[Sc,...Object.values(Op)],Mc=ee({title:"Icons",parent:void 0}),Fp=Object.entries(Xt).map(([e,t])=>J({title:e,parent:Mc,examples:t.map(r=>({title:r.iconName,render(){return h`
                            <${v} ${g(v,{icon:r})}></${v}>
                        `}}))})),ri=ee({title:"Styles",parent:void 0});function Ac(e){const t=Zp(e),r=Pe(t,(o,i)=>String(i).match(/var\(\s*(--[^,]+),\s*([^\)]+)\s*\)/));return Xe(r).reduce((o,i)=>{const s=r[i];return s&&s[1]&&s[2]&&(o[i]={cssVarName:s[1],defaultValue:s[2]}),o},{})}function Zp(e){typeof e!="string"&&(e=String(e));const n=`{"${du(e.replace(/"/g,'\\"')).replace(/;(?:\s*;)+/g,";").replace(/; /g,'", "').replace(/: /g,'": "').replace(";","")}"}`;try{const o=JSON.parse(n);return Object.keys(o).reduce((s,a)=>(s[a]=o[a],s),{})}catch(o){throw console.error(`Failed to JSON parse: ${n}`),o}}const Vp=f`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function Wp(e,t){const r=Ac(O(t));return{title:e,styles:Vp,render(){return h`
            ...
            `}}}const qp=Xe(S).map(e=>Wp(e,S[e])),Up=J({title:"Colors",parent:ri,examples:qp,descriptionParagraphs:['Accessed via the "toniqColors" export.']}),Gp=f`
    :host {
        display: flex;
        flex-direction: column;
        gap: 16px;
...
`;function Yp(e,t){const r=Ac(t);return{title:e,styles:Gp,render(){return h`
            ...
            `}}}const Jp=Xe(W).map(e=>{const t=W[e];return Yp(e,t)}),Xp=J({title:"Fonts",parent:ri,examples:Jp,descriptionParagraphs:['Accessed via the "toniqFontStyles" export.']}),Kp=[le,Mc,ri,...Fp,...pp,...mp,...wp,...$p,...xp,...Ap,...Ep,...Pp,...Bp,...Rp,...jp,...Hp,...Dp,Up,Xp,$l,up];en({tagName:"toniq-design-system-app",styles:f`
        :host {
            display: block;
            height: 100%;
            width: 100%;
