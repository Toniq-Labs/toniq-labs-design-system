...
import {createReasonableLogarithmicRange, snapToLowerMultipleOfPowerOfTen} from './number';
        ...
        const testCases: {
            ...
            },
            {
                ...
                out: [
                    ...
                    300, 500, 700, 900, 2000, 5000, 7000, 9000, 20000, 40000,
                    60000, 80000, 100000, 300000, 500000, 700000, 900000, 2000000, 4000000, 5432109,
                ],
            },
        ];
